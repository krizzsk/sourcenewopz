...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>> extends Chart<T> {
    ...
    /* renamed from: a */
    private float f52266a = 270.0f;

    /* renamed from: b */
    private float f52267b = 270.0f;
    ...
    public void calculateOffsets() {
        /*
            ...
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C178602.f52269x9c9dbef
            com.github.mikephil.charting.components.Legend r3 = r11.mLegend
        ...
        L_0x0054:
            ...
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C178602.f52270xc926f1ec
            com.github.mikephil.charting.components.Legend r5 = r11.mLegend
        ...
        L_0x0126:
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C178602.f52268x2787f53e
            com.github.mikephil.charting.components.Legend r5 = r11.mLegend
            ...
            goto L_0x014e
        L_0x013c:
            int[] r0 = com.github.mikephil.charting.charts.PieRadarChartBase.C178602.f52270xc926f1ec
            com.github.mikephil.charting.components.Legend r2 = r11.mLegend
            com.github.mikephil.charting.components.Legend$LegendVerticalAlignment r2 = r2.getVerticalAlignment()
            int r2 = r2.ordinal()
            r0 = r0[r2]
    ...
    static /* synthetic */ class C178602 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f52269x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r2 = f52268x2787f53e     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r2 = f52268x2787f53e     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0054:
                int[] r1 = f52270xc926f1ec     // Catch:{ NoSuchFieldError -> 0x005e }
            ...
            L_0x005e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.PieRadarChartBase.C178602.<clinit>():void");
        }
    }

    public float getAngleForPoint(float f, float f2) {
        MPPointF centerOffsets = getCenterOffsets();
        double d = (double) (f - centerOffsets.f52498x);
        double d2 = (double) (f2 - centerOffsets.f52499y);
        float degrees = (float) Math.toDegrees(Math.acos(d2 / Math.sqrt((d * d) + (d2 * d2))));
        if (f > centerOffsets.f52498x) {
    ...
    public float distanceToCenter(float f, float f2) {
        ...
        MPPointF centerOffsets = getCenterOffsets();
        if (f > centerOffsets.f52498x) {
            f3 = f - centerOffsets.f52498x;
        } else {
            f3 = centerOffsets.f52498x - f;
        }
        if (f2 > centerOffsets.f52499y) {
            f4 = f2 - centerOffsets.f52499y;
        } else {
            f4 = centerOffsets.f52499y - f2;
        }
    ...
    public void setRotationAngle(float f) {
        this.f52267b = f;
        this.f52266a = Utils.getNormalizedAngle(f);
    }
