...
public class ShapeAppearanceModel {
    ...
    public static Builder builder(Context context, AttributeSet attributeSet, int i, int i2, CornerSize cornerSize) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C10448R.styleable.MaterialShape, i, i2);
    ...
    private static Builder builder(Context context, int i, int i2, CornerSize cornerSize) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i, C10448R.styleable.ShapeAppearance);
        try {
