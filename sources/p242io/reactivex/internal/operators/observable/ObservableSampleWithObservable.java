...
public final class ObservableSampleWithObservable<T> extends C21211a<T, T> {

    /* renamed from: a */
    final ObservableSource<?> f58921a;

    /* renamed from: b */
    final boolean f58922b;

    public ObservableSampleWithObservable(ObservableSource<T> observableSource, ObservableSource<?> observableSource2, boolean z) {
        super(observableSource);
        this.f58921a = observableSource2;
        this.f58922b = z;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        if (this.f58922b) {
            this.source.subscribe(new SampleMainEmitLast(serializedObserver, this.f58921a));
        } else {
            this.source.subscribe(new SampleMainNoLast(serializedObserver, this.f58921a));
        }
    }
