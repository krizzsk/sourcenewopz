...
public class RoundedCornersDrawable extends ForwardingDrawable implements Rounded {
    ...
    static /* synthetic */ class C175841 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f52061xda0cffae     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.drawee.drawable.RoundedCornersDrawable.C175841.<clinit>():void");
        }
    }

    public void draw(Canvas canvas) {
        this.mBounds.set(getBounds());
        int i = C175841.f52061xda0cffae[this.mType.ordinal()];
        if (i == 1) {
