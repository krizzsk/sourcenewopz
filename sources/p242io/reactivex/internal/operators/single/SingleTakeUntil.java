...
public final class SingleTakeUntil<T, U> extends Single<T> {
    ...
    /* renamed from: a */
    final SingleSource<T> f59166a;

    /* renamed from: b */
    final Publisher<U> f59167b;

    public SingleTakeUntil(SingleSource<T> singleSource, Publisher<U> publisher) {
        this.f59166a = singleSource;
        this.f59167b = publisher;
    }
    ...
    public void subscribeActual(SingleObserver<? super T> singleObserver) {
        ...
        this.f59167b.subscribe(takeUntilMainObserver.other);
        this.f59166a.subscribe(takeUntilMainObserver);
    }
