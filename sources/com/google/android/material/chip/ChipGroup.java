...
public class ChipGroup extends FlowLayout {
    private static final int DEF_STYLE_RES = 2132018245;
    ...
    public ChipGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C10448R.styleable.ChipGroup, i, DEF_STYLE_RES, new int[0]);
