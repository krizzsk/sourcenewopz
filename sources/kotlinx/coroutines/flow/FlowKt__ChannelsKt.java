...
final /* synthetic */ class FlowKt__ChannelsKt {
    ...
    /* renamed from: a */
    public static final <T> Object m45675a(FlowCollector<? super T> flowCollector, ReceiveChannel<? extends T> receiveChannel, Continuation<? super Unit> continuation) {
        Object b = m45682b(flowCollector, receiveChannel, true, continuation);
    ...
    public static final <T> java.lang.Object m45682b(kotlinx.coroutines.flow.FlowCollector<? super T> r7, kotlinx.coroutines.channels.ReceiveChannel<? extends T> r8, boolean r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        /*
        ...
        L_0x0042:
            ...
            java.lang.Object r10 = r10.m48266unboximpl()     // Catch:{ all -> 0x0056 }
            goto L_0x0070
        L_0x0056:
            r9 = move-exception
            goto L_0x009d
        ...
        L_0x005e:
            ...
            java.lang.Object r10 = r8.m48272receiveCatchingJP2dKIU(r0)     // Catch:{ all -> 0x0099 }
        ...
        L_0x0070:
            r2 = 0
            boolean r5 = kotlinx.coroutines.channels.ChannelResult.m48262isClosedimpl(r10)     // Catch:{ all -> 0x0056 }
            if (r5 == 0) goto L_0x0086
            java.lang.Throwable r9 = kotlinx.coroutines.channels.ChannelResult.m48258exceptionOrNullimpl(r10)     // Catch:{ all -> 0x0056 }
        ...
        L_0x0086:
            java.lang.Object r10 = kotlinx.coroutines.channels.ChannelResult.m48260getOrThrowimpl(r10)     // Catch:{ all -> 0x0056 }
        ...
        L_0x00a4:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ChannelsKt.m45682b(kotlinx.coroutines.flow.FlowCollector, kotlinx.coroutines.channels.ReceiveChannel, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: a */
    public static final <T> Flow<T> m45681a(ReceiveChannel<? extends T> receiveChannel) {
        return new C21936c<>(receiveChannel, false, (CoroutineContext) null, 0, (BufferOverflow) null, 28, (DefaultConstructorMarker) null);
    }

    /* renamed from: b */
    public static final <T> Flow<T> m45683b(ReceiveChannel<? extends T> receiveChannel) {
        return new C21936c<>(receiveChannel, true, (CoroutineContext) null, 0, (BufferOverflow) null, 28, (DefaultConstructorMarker) null);
    }

    /* renamed from: a */
    public static /* synthetic */ BroadcastChannel m45678a(Flow flow, CoroutineScope coroutineScope, CoroutineStart coroutineStart, int i, Object obj) {
        if ((i & 2) != 0) {
    ...
    /* renamed from: a */
    public static final <T> BroadcastChannel<T> m45677a(Flow<? extends T> flow, CoroutineScope coroutineScope, CoroutineStart coroutineStart) {
        int i;
    ...
    /* renamed from: a */
    public static final <T> ReceiveChannel<T> m45679a(Flow<? extends T> flow, CoroutineScope coroutineScope) {
        return ChannelFlowKt.asChannelFlow(flow).produceImpl(coroutineScope);
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "'BroadcastChannel' is obsolete and all corresponding operators are deprecated in the favour of StateFlow and SharedFlow")
    /* renamed from: a */
    public static final <T> Flow<T> m45680a(BroadcastChannel<T> broadcastChannel) {
