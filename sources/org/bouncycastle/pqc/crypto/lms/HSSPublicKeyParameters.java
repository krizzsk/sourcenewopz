...
public class HSSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    public static org.bouncycastle.pqc.crypto.lms.HSSPublicKeyParameters getInstance(java.lang.Object r3) throws java.io.IOException {
        ...
        L_0x0041:
            ...
            byte[] r3 = org.bouncycastle.util.p084io.Streams.readAll(r3)
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f6458l != hSSPublicKeyParameters.f6458l) {
            return false;
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.f6458l).bytes(this.lmsPublicKey.getEncoded()).build();
    }
    ...
    public int hashCode() {
        return (this.f6458l * 31) + this.lmsPublicKey.hashCode();
    }
