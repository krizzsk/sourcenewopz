...
public final class FlowableObserveOn<T> extends C21208a<T, T> {

    /* renamed from: a */
    final Scheduler f58369a;

    /* renamed from: b */
    final boolean f58370b;
    ...
    public FlowableObserveOn(Flowable<T> flowable, Scheduler scheduler, boolean z, int i) {
        super(flowable);
        this.f58369a = scheduler;
        this.f58370b = z;
        this.f58371c = i;
    }

    public void subscribeActual(Subscriber<? super T> subscriber) {
        Scheduler.Worker createWorker = this.f58369a.createWorker();
        if (subscriber instanceof ConditionalSubscriber) {
            this.source.subscribe(new ObserveOnConditionalSubscriber((ConditionalSubscriber) subscriber, createWorker, this.f58370b, this.f58371c));
        } else {
            this.source.subscribe(new ObserveOnSubscriber(subscriber, createWorker, this.f58370b, this.f58371c));
        }
    }
