...
class C2403b {
    ...
    /* renamed from: a */
    static String m3290a(String str, HanyuPinyinOutputFormat hanyuPinyinOutputFormat) throws BadHanyuPinyinOutputFormatCombination {
        ...
        if (HanyuPinyinToneType.WITHOUT_TONE == hanyuPinyinOutputFormat.getToneType()) {
            ...
            str = m3289a(str.replaceAll("u:", RavenKey.VERSION));
        }
    ...
    /* renamed from: a */
    private static String m3289a(String str) {
