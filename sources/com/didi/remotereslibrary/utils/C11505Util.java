...
public class C11505Util {
    public static final String TAG = "oneremoteresource";

    /* renamed from: a */
    private static String f33185a;
    ...
    /* renamed from: a */
    private static String m23375a(String str) throws NoSuchAlgorithmException {
        if (str == null || str.length() == 0) {
            return "";
        }
        MessageDigest instance = MessageDigest.getInstance("SHA-1");
        instance.update(str.getBytes());
        return m23376a(instance.digest());
    }

    /* renamed from: a */
    private static String m23376a(byte[] bArr) {
        String str = "";
        for (byte b : bArr) {
