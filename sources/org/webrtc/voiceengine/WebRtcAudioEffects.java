...
public class WebRtcAudioEffects {
    ...
    /* renamed from: ns */
    private NoiseSuppressor f6715ns;
    ...
    public static boolean isAcousticEchoCancelerBlacklisted() {
        ...
        if (contains) {
            Logging.m3804w(TAG, Build.MODEL + " is blacklisted for HW AEC usage!");
        }
        return contains;
    }
    ...
    public static boolean isNoiseSuppressorBlacklisted() {
        ...
        if (contains) {
            Logging.m3804w(TAG, Build.MODEL + " is blacklisted for HW NS usage!");
        }
        return contains;
    }
    ...
    public static boolean canUseAcousticEchoCanceler() {
        ...
        Logging.m3800d(TAG, "canUseAcousticEchoCanceler: " + z);
        return z;
    }
    ...
    public static boolean canUseNoiseSuppressor() {
        ...
        Logging.m3800d(TAG, "canUseNoiseSuppressor: " + z);
        return z;
    }
    ...
    public boolean setNS(boolean z) {
        ...
        if (!canUseNoiseSuppressor()) {
            ...
            return false;
        } else if (this.f6715ns == null || z == this.shouldEnableNs) {
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f6715ns;
