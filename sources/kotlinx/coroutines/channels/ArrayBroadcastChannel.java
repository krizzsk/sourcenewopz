...
public final class ArrayBroadcastChannel<E> extends AbstractSendChannel<E> implements BroadcastChannel<E> {
    ...
    /* renamed from: b */
    private final ReentrantLock f61377b;

    /* renamed from: c */
    private final Object[] f61378c;

    /* renamed from: d */
    private final List<Subscriber<E>> f61379d;
    ...
    public ArrayBroadcastChannel(int i) {
        ...
        this.f61376a = i;
        if (i < 1 ? false : true) {
            this.f61377b = new ReentrantLock();
            this.f61378c = new Object[this.f61376a];
            this._head = 0;
            this._tail = 0;
            this._size = 0;
            this.f61379d = ConcurrentKt.subscriberList();
            return;
        }
    ...
    /* renamed from: a */
    private final long m45537a() {
        return this._head;
    }

    /* renamed from: a */
    private final void m45539a(long j) {
        this._head = j;
    }

    /* access modifiers changed from: private */
    /* renamed from: b */
    public final long m45543b() {
        return this._tail;
    }

    /* renamed from: b */
    private final void m45544b(long j) {
        this._tail = j;
    }

    /* renamed from: c */
    private final int m45545c() {
        return this._size;
    }

    /* renamed from: a */
    private final void m45538a(int i) {
        this._size = i;
    }

    /* access modifiers changed from: protected */
    public boolean isBufferFull() {
        return m45545c() >= this.f61376a;
    }

    public ReceiveChannel<E> openSubscription() {
        Subscriber subscriber = new Subscriber(this);
        m45541a(this, subscriber, (Subscriber) null, 2, (Object) null);
        return subscriber;
    }
    ...
    public final boolean cancel(Throwable th) {
        ...
        for (Subscriber<E> cancelInternal$kotlinx_coroutines_core : this.f61379d) {
    ...
    public Object offerInternal(E e) {
        ...
        try {
            ...
            if (closedForSend == null) {
                ...
                long b = m45543b();
                this.f61378c[(int) (b % ((long) getCapacity()))] = e;
                m45538a(c + 1);
                m45544b(b + 1);
    ...
    /* renamed from: d */
    private final void m45547d() {
        boolean z = false;
        boolean z2 = false;
        for (Subscriber<E> checkOffer : this.f61379d) {
        ...
        if (z || !z2) {
            m45541a(this, (Subscriber) null, (Subscriber) null, 3, (Object) null);
        }
    }

    /* renamed from: a */
    static /* synthetic */ void m45541a(ArrayBroadcastChannel arrayBroadcastChannel, Subscriber subscriber, Subscriber subscriber2, int i, Object obj) {
        if ((i & 1) != 0) {
            subscriber = null;
        }
        if ((i & 2) != 0) {
        ...
        arrayBroadcastChannel.m45540a(subscriber, subscriber2);
    }

    /* renamed from: a */
    private final void m45540a(Subscriber<E> subscriber, Subscriber<E> subscriber2) {
        ...
        while (true) {
            ...
            if (subscriber != null) {
                try {
                    subscriber.setSubHead(m45543b());
                    boolean isEmpty = this.f61379d.isEmpty();
                    this.f61379d.add(subscriber);
                    if (!isEmpty) {
                        return;
                    }
                } finally {
            ...
            if (subscriber2 != null) {
                this.f61379d.remove(subscriber2);
                if (m45537a() != subscriber2.getSubHead()) {
                    lock.unlock();
                    return;
                }
            }
            ...
            while (a < coerceAtMost) {
                this.f61378c[(int) (a % ((long) getCapacity()))] = null;
                boolean z = false;
                ...
                if (z2) {
                    ...
                    this.f61378c[(int) (b % ((long) getCapacity()))] = takeFirstSendOrPeekClosed.getPollResult();
                    m45538a(c + 1);
                    m45544b(b + 1);
                    Unit unit = Unit.INSTANCE;
                    lock.unlock();
    ...
    /* renamed from: e */
    private final long m45548e() {
        long j = Long.MAX_VALUE;
        for (Subscriber<E> subHead : this.f61379d) {
    ...
    private static final class Subscriber<E> extends AbstractChannel<E> implements ReceiveChannel<E> {
        ...
        public boolean isBufferEmpty() {
            return getSubHead() >= this.broadcastChannel.m45543b();
        }
        ...
        public boolean close(Throwable th) {
            ...
            if (close) {
                ArrayBroadcastChannel.m45541a(this.broadcastChannel, (Subscriber) null, this, 1, (Object) null);
                Lock lock = this.subLock;
                lock.lock();
                try {
                    setSubHead(this.broadcastChannel.m45543b());
                    Unit unit = Unit.INSTANCE;
                } finally {
                    lock.unlock();
                }
        ...
        public java.lang.Object pollInternal() {
            ...
            L_0x003f:
                ...
                r2 = 3
                kotlinx.coroutines.channels.ArrayBroadcastChannel.m45541a(r0, r4, r4, r2, r4)
            L_0x0047:
                return r1
            L_0x0048:
                r1 = move-exception
        ...
        public Object pollSelectInternal(SelectInstance<?> selectInstance) {
            ...
            try {
                ...
                if (z) {
                    ArrayBroadcastChannel.m45541a(this.broadcastChannel, (Subscriber) null, (Subscriber) null, 3, (Object) null);
                }
        ...
        private final Object peekUnderLock() {
            ...
            if (subHead < this.broadcastChannel.m45543b()) {
                Object access$elementAt = this.broadcastChannel.m45546c(subHead);
    ...
    public String getBufferDebugString() {
        return "(buffer:capacity=" + this.f61378c.length + ",size=" + m45545c() + VersionRange.RIGHT_OPEN;
    }
}
