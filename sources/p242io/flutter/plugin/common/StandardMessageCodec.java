...
public class StandardMessageCodec implements MessageCodec<Object> {
    ...
    /* renamed from: a */
    private static final String f57761a = "StandardMessageCodec#";

    /* renamed from: b */
    private static final boolean f57762b = (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN);

    /* renamed from: c */
    private static final Charset f57763c = Charset.forName("UTF8");

    /* renamed from: d */
    private static final byte f57764d = 0;

    /* renamed from: e */
    private static final byte f57765e = 1;

    /* renamed from: f */
    private static final byte f57766f = 2;

    /* renamed from: g */
    private static final byte f57767g = 3;

    /* renamed from: h */
    private static final byte f57768h = 4;

    /* renamed from: i */
    private static final byte f57769i = 5;

    /* renamed from: j */
    private static final byte f57770j = 6;

    /* renamed from: k */
    private static final byte f57771k = 7;

    /* renamed from: l */
    private static final byte f57772l = 8;

    /* renamed from: m */
    private static final byte f57773m = 9;

    /* renamed from: n */
    private static final byte f57774n = 10;

    /* renamed from: o */
    private static final byte f57775o = 11;

    /* renamed from: p */
    private static final byte f57776p = 12;

    /* renamed from: q */
    private static final byte f57777q = 13;

    /* renamed from: r */
    private static final byte f57778r = 14;
    ...
    public void writeValue(ByteArrayOutputStream byteArrayOutputStream, Object obj) {
        ...
        if (obj == null || obj.equals((Object) null)) {
            ...
            if ((obj instanceof Integer) || (obj instanceof Short) || (obj instanceof Byte)) {
                ...
                writeBytes(byteArrayOutputStream, ((BigInteger) obj).toString(16).getBytes(f57763c));
            } else {
                throw new IllegalArgumentException("Unsupported Number type: " + obj.getClass());
            }
        } else if (obj instanceof CharSequence) {
            byteArrayOutputStream.write(7);
            writeBytes(byteArrayOutputStream, obj.toString().getBytes(f57763c));
    ...
    public java.lang.Object readValueOfType(byte r5, java.nio.ByteBuffer r6) {
        ...
        L_0x00b3:
            ...
            java.nio.charset.Charset r6 = f57763c
            r0.<init>(r5, r6)
            goto L_0x00fc
        L_0x00bf:
            readAlignment(r6, r2)
        ...
        L_0x00cb:
            ...
            java.nio.charset.Charset r1 = f57763c
            r6.<init>(r5, r1)
            r5 = 16
            r0.<init>(r6, r5)
            goto L_0x00fc
        ...
        L_0x00fc:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p242io.flutter.plugin.common.StandardMessageCodec.readValueOfType(byte, java.nio.ByteBuffer):java.lang.Object");
    }
