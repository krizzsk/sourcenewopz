...
public class BannerItemBinder extends CustomerLogicItemBinder<RvBannerLogic, BannerRvModel, ViewHolder> {
    ...
    public ViewHolder create(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        return new ViewHolder(layoutInflater.inflate(R.layout.entrega_item_rv_banner, viewGroup, false), this.f20667a);
    }
    ...
    public void bind(final ViewHolder viewHolder, final BannerRvModel bannerRvModel) {
        if (bannerRvModel.mDataChanged) {
            ...
            viewHolder.mBanner.setDatas(viewHolder.itemView.getContext(), this.f20667a, arrayList, new OnBannerImageDownLoadListener() {
