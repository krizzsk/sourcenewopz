...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.m38473of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m38470of();
            }
            return DirectedNetworkConnections.m38471of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m38476of();
        } else {
            return UndirectedNetworkConnections.m38477of();
        }
    }
}
