...
public final class ObservableFlatMapSingle<T, R> extends C21211a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends SingleSource<? extends R>> f58824a;

    /* renamed from: b */
    final boolean f58825b;
    ...
    public ObservableFlatMapSingle(ObservableSource<T> observableSource, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z) {
        ...
        this.f58824a = function;
        this.f58825b = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new FlatMapSingleObserver(observer, this.f58824a, this.f58825b));
    }
