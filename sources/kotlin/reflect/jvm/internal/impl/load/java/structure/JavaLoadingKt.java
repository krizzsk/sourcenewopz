...
public final class JavaLoadingKt {
    public static final boolean isObjectMethodInInterface(JavaMember javaMember) {
        ...
        return javaMember.getContainingClass().isInterface() && (javaMember instanceof JavaMethod) && m44685a((JavaMethod) javaMember);
    }
    ...
    private static final boolean m44685a(kotlin.reflect.jvm.internal.impl.load.java.structure.JavaMethod r3) {
        /*
        ...
        L_0x0045:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.load.java.structure.JavaLoadingKt.m44685a(kotlin.reflect.jvm.internal.impl.load.java.structure.JavaMethod):boolean");
    }

    /* renamed from: b */
    private static final boolean m44686b(JavaMethod javaMethod) {
        FqName fqName;
