...
public class BCDSTU4145PrivateKey implements ECPrivateKey, ECPointEncoder, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier {
    ...
    /* renamed from: d */
    private transient BigInteger f6230d;
    ...
    public BCDSTU4145PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        this.algorithm = str;
        this.f6230d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCDSTU4145PrivateKey(ECPrivateKey eCPrivateKey) {
        this.f6230d = eCPrivateKey.getS();
        this.algorithm = eCPrivateKey.getAlgorithm();
        this.ecSpec = eCPrivateKey.getParams();
    }

    public BCDSTU4145PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.f6230d = eCPrivateKeySpec.getS();
    ...
    public BCDSTU4145PrivateKey(BCDSTU4145PrivateKey bCDSTU4145PrivateKey) {
        this.f6230d = bCDSTU4145PrivateKey.f6230d;
    ...
    public BCDSTU4145PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.f6230d = eCPrivateKeySpec.getD();
    ...
    private void populateFromPrivKeyInfo(org.bouncycastle.asn1.pkcs.PrivateKeyInfo r12) throws java.io.IOException {
        /*
            ...
            org.bouncycastle.asn1.x9.X962Parameters r0 = org.bouncycastle.asn1.p075x9.X962Parameters.getInstance(r0)
            ...
            org.bouncycastle.crypto.params.ECDomainParameters r1 = org.bouncycastle.asn1.p074ua.DSTU4145NamedCurves.getByOID(r0)
        ...
        L_0x007d:
            ...
            org.bouncycastle.asn1.ASN1Primitive r0 = r0.getParameters()
            org.bouncycastle.asn1.x9.X9ECParameters r0 = org.bouncycastle.asn1.p075x9.X9ECParameters.getInstance(r0)
        ...
        L_0x00bb:
            ...
            goto L_0x017a
        L_0x00bf:
            org.bouncycastle.asn1.ua.DSTU4145Params r0 = org.bouncycastle.asn1.p074ua.DSTU4145Params.getInstance(r1)
            boolean r1 = r0.isNamedCurve()
        ...
        L_0x00f0:
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r3 = org.bouncycastle.asn1.p074ua.UAObjectIdentifiers.dstu4145le
        ...
        L_0x0146:
            ...
            org.bouncycastle.math.ec.ECPoint r1 = org.bouncycastle.asn1.p074ua.DSTU4145PointEncoder.decodePoint(r10, r1)
    ...
    public byte[] getEncoded() {
        ...
        L_0x003a:
            ...
            org.bouncycastle.math.ec.ECPoint r1 = org.bouncycastle.jcajce.provider.asymmetric.util.EC5Util.convertPoint((org.bouncycastle.math.p082ec.ECCurve) r4, (java.security.spec.ECPoint) r1)
            boolean r3 = r9.withCompression
            r5.<init>((org.bouncycastle.math.p082ec.ECPoint) r1, (boolean) r3)
            java.security.spec.ECParameterSpec r1 = r9.ecSpec
            ...
            org.bouncycastle.asn1.x9.X962Parameters r1 = new org.bouncycastle.asn1.x9.X962Parameters
            r1.<init>((org.bouncycastle.asn1.p075x9.X9ECParameters) r0)
        L_0x0079:
            org.bouncycastle.jcajce.provider.config.ProviderConfiguration r0 = org.bouncycastle.jce.provider.BouncyCastleProvider.CONFIGURATION
        ...
        L_0x00a2:
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = org.bouncycastle.asn1.p074ua.UAObjectIdentifiers.dstu4145be     // Catch:{ IOException -> 0x00dc }
        ...
        L_0x00c1:
            org.bouncycastle.asn1.pkcs.PrivateKeyInfo r0 = new org.bouncycastle.asn1.pkcs.PrivateKeyInfo     // Catch:{ IOException -> 0x00dc }
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r4 = new org.bouncycastle.asn1.x509.AlgorithmIdentifier     // Catch:{ IOException -> 0x00dc }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = org.bouncycastle.asn1.p075x9.X9ObjectIdentifiers.id_ecPublicKey     // Catch:{ IOException -> 0x00dc }
            org.bouncycastle.asn1.ASN1Primitive r1 = r1.toASN1Primitive()     // Catch:{ IOException -> 0x00dc }
            r4.<init>(r5, r1)     // Catch:{ IOException -> 0x00dc }
            org.bouncycastle.asn1.ASN1Primitive r1 = r3.toASN1Primitive()     // Catch:{ IOException -> 0x00dc }
            r0.<init>(r4, r1)     // Catch:{ IOException -> 0x00dc }
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f6230d, engineGetSpec());
    }
}
