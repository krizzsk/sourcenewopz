...
public final class zzejh implements zzecn {
    ...
    public zzejh(byte[] bArr, int i) throws GeneralSecurityException {
        if (i == 12 || i == 16) {
            this.zzimf = i;
    ...
    public final byte[] zzc(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        if (length <= (Integer.MAX_VALUE - i) - 16) {
            ...
            System.arraycopy(zzgb, 0, bArr4, 0, this.zzimf);
            Cipher cipher = zzimb.get();
            cipher.init(1, this.zzily);
            ...
            cipher2.doFinal(bArr, 0, bArr3.length, bArr4, this.zzimf);
            byte[] zza3 = zza(cipher, 2, bArr4, this.zzimf, bArr3.length);
            int length2 = bArr3.length + this.zzimf;
