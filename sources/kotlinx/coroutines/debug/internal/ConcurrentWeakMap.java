...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public ConcurrentWeakMap(boolean z) {
        ...
        this.f61407b = z ? new ReferenceQueue<>() : null;
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public final void m45644a() {
        f61406a.decrementAndGet(this);
    }
    ...
    public V put(K k, V v) {
        ...
        if (putImpl$default == ConcurrentWeakMapKt.f61410c) {
            putImpl$default = m45643a(k, v);
        }
        if (putImpl$default == null) {
            f61406a.incrementAndGet(this);
        }
    ...
    public V remove(Object obj) {
        ...
        if (putImpl$default == ConcurrentWeakMapKt.f61410c) {
            putImpl$default = m45643a(obj, (Object) null);
        }
        if (putImpl$default != null) {
            f61406a.decrementAndGet(this);
        }
    ...
    /* renamed from: a */
    private final synchronized V m45643a(K k, V v) {
        V putImpl$default;
    ...
    public final void runWeakRefQueueCleaningLoopUntilInterrupted() {
        if (this.f61407b != null) {
            while (true) {
                try {
                    Reference<? extends K> remove = this.f61407b.remove();
                    if (remove != null) {
                        m45645a((HashedWeakRef) remove);
                    } else {
    ...
    /* renamed from: a */
    private final void m45645a(HashedWeakRef<?> hashedWeakRef) {
    ...
    private final class Core {
        ...
        public final V getImpl(K k) {
            ...
            while (true) {
                ...
                if (Intrinsics.areEqual((Object) k, obj)) {
                    ...
                    return v instanceof C21839a ? ((C21839a) v).f61438a : v;
                }
                if (obj == null) {
        ...
        private final void removeCleanedAt(int i) {
            ...
            do {
                ...
                if (obj == null || (obj instanceof C21839a)) {
                    return;
                }
            } while (!this.values.compareAndSet(i, obj, (Object) null));
            ConcurrentWeakMap.this.m45644a();
        }
                ...
                if (hashedWeakRef2 != null) {
                    ...
                    if (!z) {
                        do {
                            i = this.load;
                            if (i >= this.threshold) {
                                return ConcurrentWeakMapKt.f61410c;
                            }
                        } while (!load$FU.compareAndSet(this, i, i + 1));
                        z = true;
                    }
                    if (hashedWeakRef == null) {
                        hashedWeakRef = new HashedWeakRef<>(k, ConcurrentWeakMap.this.f61407b);
                    }
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (!(obj2 instanceof C21839a)) {
                            if (this.values.compareAndSet(i2, obj2, ConcurrentWeakMapKt.m45647a(obj2))) {
                                break;
                            }
                        } else {
                            obj2 = ((C21839a) obj2).f61438a;
                            break;
                        }
                    }
                    if (!(obj == null || obj2 == null)) {
                        Object putImpl = core.putImpl(obj, obj2, hashedWeakRef);
                        if (putImpl != ConcurrentWeakMapKt.f61410c) {
        ...
        private final class KeyValueIterator<E> implements Iterator<E>, KMutableIterator {
            ...
            public Void remove() {
                Void unused = ConcurrentWeakMapKt.m45646a();
                throw new KotlinNothingValueException();
            }
        }
    }

    @Metadata(mo175977d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010'\n\u0002\b\u000b\b\u0002\u0018\u0000*\u0004\b\u0002\u0010\u0001*\u0004\b\u0003\u0010\u00022\u000e\u0012\u0004\u0012\u0002H\u0001\u0012\u0004\u0012\u0002H\u00020\u0003B\u0015\u0012\u0006\u0010\u0004\u001a\u00028\u0002\u0012\u0006\u0010\u0005\u001a\u00028\u0003¢\u0006\u0002\u0010\u0006J\u0015\u0010\u000b\u001a\u00028\u00032\u0006\u0010\f\u001a\u00028\u0003H\u0016¢\u0006\u0002\u0010\rR\u0016\u0010\u0004\u001a\u00028\u0002X\u0004¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\u0007\u0010\bR\u0016\u0010\u0005\u001a\u00028\u0003X\u0004¢\u0006\n\n\u0002\u0010\t\u001a\u0004\b\n\u0010\b¨\u0006\u000e"}, mo175978d2 = {"Lkotlinx/coroutines/debug/internal/ConcurrentWeakMap$Entry;", "K", "V", "", "key", "value", "(Ljava/lang/Object;Ljava/lang/Object;)V", "getKey", "()Ljava/lang/Object;", "Ljava/lang/Object;", "getValue", "setValue", "newValue", "(Ljava/lang/Object;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: ConcurrentWeakMap.kt */
    ...
    @Metadata(mo175977d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010)\n\u0000\b\u0004\u0018\u0000*\u0004\b\u0002\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B\u001f\u0012\u0018\u0010\u0003\u001a\u0014\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u0001\u0012\u0004\u0012\u00028\u00020\u0004¢\u0006\u0002\u0010\u0005J\u0015\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00028\u0002H\u0016¢\u0006\u0002\u0010\rJ\u000f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00028\u00020\u000fH\u0002R \u0010\u0003\u001a\u0014\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u0001\u0012\u0004\u0012\u00028\u00020\u0004X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\u00020\u00078VX\u0004¢\u0006\u0006\u001a\u0004\b\b\u0010\t¨\u0006\u0010"}, mo175978d2 = {"Lkotlinx/coroutines/debug/internal/ConcurrentWeakMap$KeyValueSet;", "E", "Lkotlin/collections/AbstractMutableSet;", "factory", "Lkotlin/Function2;", "(Lkotlinx/coroutines/debug/internal/ConcurrentWeakMap;Lkotlin/jvm/functions/Function2;)V", "size", "", "getSize", "()I", "add", "", "element", "(Ljava/lang/Object;)Z", "iterator", "", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: ConcurrentWeakMap.kt */
