...
public enum NotificationLite {
    ...
    static final class ErrorNotification implements Serializable {
        ...
        public String toString() {
            return "NotificationLite.Error[" + this.f59292e + Const.jaRight;
        }

        public int hashCode() {
            return this.f59292e.hashCode();
        }

        public boolean equals(Object obj) {
            if (obj instanceof ErrorNotification) {
                return ObjectHelper.equals(this.f59292e, ((ErrorNotification) obj).f59292e);
            }
            return false;
        }
    }
    ...
    public static Throwable getError(Object obj) {
        return ((ErrorNotification) obj).f59292e;
    }
    ...
    public static <T> boolean accept(Object obj, Subscriber<? super T> subscriber) {
        if (obj == COMPLETE) {
            ...
            subscriber.onError(((ErrorNotification) obj).f59292e);
            return true;
        } else {
    ...
    public static <T> boolean accept(Object obj, Observer<? super T> observer) {
        if (obj == COMPLETE) {
            ...
            observer.onError(((ErrorNotification) obj).f59292e);
            return true;
        } else {
            observer.onNext(obj);
            return false;
