...
public class BCStyle extends AbstractX500NameStyle {
    ...
    /* renamed from: C */
    public static final ASN1ObjectIdentifier f5672C = new ASN1ObjectIdentifier("2.5.4.6").intern();

    /* renamed from: CN */
    public static final ASN1ObjectIdentifier f5673CN = new ASN1ObjectIdentifier("2.5.4.3").intern();
    ...
    /* renamed from: DC */
    public static final ASN1ObjectIdentifier f5674DC = new ASN1ObjectIdentifier("0.9.2342.19200300.100.1.25");
    ...
    /* renamed from: E */
    public static final ASN1ObjectIdentifier f5675E = EmailAddress;
    ...
    /* renamed from: L */
    public static final ASN1ObjectIdentifier f5676L = new ASN1ObjectIdentifier("2.5.4.7").intern();
    public static final ASN1ObjectIdentifier NAME = X509ObjectIdentifiers.id_at_name;
    public static final ASN1ObjectIdentifier NAME_AT_BIRTH = new ASN1ObjectIdentifier("1.3.36.8.3.14").intern();

    /* renamed from: O */
    public static final ASN1ObjectIdentifier f5677O = new ASN1ObjectIdentifier("2.5.4.10").intern();
    public static final ASN1ObjectIdentifier ORGANIZATION_IDENTIFIER = X509ObjectIdentifiers.id_at_organizationIdentifier;

    /* renamed from: OU */
    public static final ASN1ObjectIdentifier f5678OU = new ASN1ObjectIdentifier("2.5.4.11").intern();
    ...
    /* renamed from: SN */
    public static final ASN1ObjectIdentifier f5679SN = new ASN1ObjectIdentifier("2.5.4.5").intern();

    /* renamed from: ST */
    public static final ASN1ObjectIdentifier f5680ST = new ASN1ObjectIdentifier("2.5.4.8").intern();
    ...
    /* renamed from: T */
    public static final ASN1ObjectIdentifier f5681T = new ASN1ObjectIdentifier("2.5.4.12").intern();
    ...
    static {
        DefaultSymbols.put(f5672C, "C");
        DefaultSymbols.put(f5677O, "O");
        DefaultSymbols.put(f5681T, "T");
        DefaultSymbols.put(f5678OU, "OU");
        DefaultSymbols.put(f5673CN, GlobalCountryCode.CHINA);
        DefaultSymbols.put(f5676L, "L");
        DefaultSymbols.put(f5680ST, "ST");
        DefaultSymbols.put(SERIALNUMBER, "SERIALNUMBER");
        DefaultSymbols.put(EmailAddress, ExifInterface.LONGITUDE_EAST);
        DefaultSymbols.put(f5674DC, "DC");
        ...
        DefaultLookUp.put("c", f5672C);
        DefaultLookUp.put("o", f5677O);
        DefaultLookUp.put(RavenKey.TYPE, f5681T);
        DefaultLookUp.put("ou", f5678OU);
        DefaultLookUp.put("cn", f5673CN);
        DefaultLookUp.put("l", f5676L);
        DefaultLookUp.put(UserDataStore.STATE, f5680ST);
        DefaultLookUp.put("sn", SURNAME);
        DefaultLookUp.put("serialnumber", SERIALNUMBER);
        DefaultLookUp.put("street", STREET);
        DefaultLookUp.put("emailaddress", f5675E);
        DefaultLookUp.put("dc", f5674DC);
        DefaultLookUp.put("e", f5675E);
