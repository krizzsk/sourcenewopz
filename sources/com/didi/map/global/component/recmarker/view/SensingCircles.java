...
public class SensingCircles {
    ...
    /* renamed from: g */
    public LatLng f26118g;

    /* renamed from: h */
    private SensingCircle[] f26119h;
    /* access modifiers changed from: private */

    /* renamed from: i */
    public float f26120i;
    ...
    public SensingCircles(Context context, Map map, int i, float f, float f2) {
        this.f26115d = 255;
        this.f26116e = 0.6f;
        this.f26119h = new SensingCircle[2];
        this.f26121j = -1;
        this.f26122k = 50;
        this.f26123l = TIME_PERIOD;
        this.f26124m = 8;
        this.f26126o = new Runnable() {
            public void run() {
                SensingCircles.this.m18518a();
            }
        };
        this.f26113b = context.getApplicationContext();
        this.f26114c = map;
        if (this.f26112a == null) {
            this.f26112a = new Handler(Looper.getMainLooper());
        }
        m18519a(i, f, f2);
    }
    ...
    /* renamed from: a */
    private void m18519a(int i, float f, float f2) {
        Resources resources;
        ...
        if (context != null && (resources = context.getResources()) != null) {
            ...
            paint.setAlpha(102);
            this.f26123l = f;
            this.f26120i = (float) dip2px(this.f26113b, f2);
            this.f26119h[0] = new SensingCircle(new Paint(paint), new CircleActionMeta().setFrames(0));
            this.f26119h[1] = new SensingCircle(new Paint(paint), new Circle2ActionMeta().setFrames(0));
        }
    }
    ...
    /* renamed from: a */
    private void m18521a(String str, float f, float f2) {
        Resources resources;
        Context context = this.f26113b;
        if (context != null && (resources = context.getResources()) != null) {
            Paint paint = new Paint();
    ...
    public void show(LatLng latLng) {
        if (!this.f26117f && this.f26118g != latLng) {
            this.f26117f = true;
            this.f26118g = latLng;
            CircleOptions circleOptions = new CircleOptions();
            circleOptions.center(latLng).radius(0.0d).strokeColor(this.f26119h[0].getPaint().getColor()).strokeWidth(0.1f).zIndex(this.f26125n);
            this.f26119h[0].setCircle(this.f26114c.addCircle(circleOptions));
            CircleOptions circleOptions2 = new CircleOptions();
            circleOptions2.center(latLng).radius(0.0d).strokeColor(this.f26119h[1].getPaint().getColor()).strokeWidth(0.1f).zIndex(this.f26125n);
            this.f26119h[1].setCircle(this.f26114c.addCircle(circleOptions2));
            m18518a();
        }
    }
    ...
    public void showTransientCircles(LatLng latLng) {
        if (!this.f26117f && this.f26118g != latLng) {
            ...
            circleOptions.center(latLng).radius(0.0d).strokeColor(this.f26119h[0].getPaint().getColor()).strokeWidth(0.1f).zIndex(this.f26125n);
            this.f26119h[0].setCircle(this.f26114c.addCircle(circleOptions));
            this.f26119h[0].setAction(new CircleTransientActionMeta().setFrames(0));
            this.f26119h[1] = null;
            m18518a();
            Handler handler = this.f26112a;
            if (handler != null) {
    ...
    public void m18518a() {
        if (this.f26117f) {
            for (SensingCircle sensingCircle : this.f26119h) {
            ...
            Handler handler = this.f26112a;
            if (handler != null) {
                handler.postDelayed(this.f26126o, 50);
            }
        }
    }

    public void updatePosition(LatLng latLng) {
        SensingCircle[] sensingCircleArr = this.f26119h;
        if (sensingCircleArr != null && sensingCircleArr.length > 0) {
            int length = sensingCircleArr.length;
            for (int i = 0; i < length; i++) {
                this.f26119h[i].updatePosition(latLng);
            }
        }
    }
    ...
    public void hide() {
        if (this.f26117f) {
            ...
            Handler handler = this.f26112a;
            if (handler != null) {
                handler.removeCallbacks(this.f26126o);
                this.f26112a = null;
            }
        }
    }
    ...
    private class SensingCircle {
        ...
        public void doAction() {
            /*
                ...
                com.didi.common.map.model.LatLng r1 = r1.f26118g     // Catch:{ all -> 0x0085 }
                if (r1 != 0) goto L_0x0018
                goto L_0x0083
            L_0x0018:
                com.didi.map.global.component.recmarker.view.SensingCircles r1 = com.didi.map.global.component.recmarker.view.SensingCircles.this     // Catch:{ all -> 0x0085 }
                boolean r1 = r1.f26117f     // Catch:{ all -> 0x0085 }
                if (r1 != 0) goto L_0x0022
                monitor-exit(r0)     // Catch:{ all -> 0x0085 }
                return
            L_0x0022:
                com.didi.map.global.component.recmarker.view.SensingCircles r1 = com.didi.map.global.component.recmarker.view.SensingCircles.this     // Catch:{ all -> 0x0085 }
                com.didi.common.map.Map r1 = r1.f26114c     // Catch:{ all -> 0x0085 }
            ...
            L_0x0037:
                ...
                com.didi.common.map.model.LatLng r2 = r2.f26118g     // Catch:{ Exception -> 0x007b }
        ...
        public SensingCircle removeCircle() {
            ...
            synchronized (this.lock) {
                if (this.circle != null) {
                    if (SensingCircles.this.f26114c != null) {
                        SensingCircles.this.f26114c.remove(this.circle);
                    }
                    this.circle = null;
                }
            }
    ...
    private class ActionMeta {
        ...
        private ActionMeta() {
            this.direction = 1;
            this.frames = 0;
            this.total_frames = SensingCircles.this.f26123l / 50.0f;
            float f = SensingCircles.this.f26120i;
        ...
        public void nextFrame() {
            if (((float) this.frames) > this.total_frames + ((float) SensingCircles.this.f26124m)) {
                this.frames = 0;
            }
    ...
    private class Circle2ActionMeta extends ActionMeta {
        ...
        /* access modifiers changed from: protected */
        public float getRadius() {
            if (this.frames >= 0 && this.frames <= SensingCircles.this.f26124m) {
                return (float) SensingCircles.this.f26124m;
            }
            if (this.frames <= SensingCircles.this.f26124m || ((float) this.frames) > this.total_frames + ((float) SensingCircles.this.f26124m)) {
                return 0.0f;
            }
            return this.per * (((float) this.frames) - ((float) SensingCircles.this.f26124m));
        }
        ...
        public int getAlpha() {
            ...
            return (int) (((this.total_frames + ((float) SensingCircles.this.f26124m)) - ((float) this.frames)) * 255.0f * this.alphaPer);
        }
    }
