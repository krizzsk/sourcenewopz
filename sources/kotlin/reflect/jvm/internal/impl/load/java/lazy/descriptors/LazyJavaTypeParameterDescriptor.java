...
public final class LazyJavaTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: a */
    private final LazyJavaResolverContext f60576a;

    /* renamed from: b */
    private final JavaTypeParameter f60577b;
    ...
    /* renamed from: a */
    private final List<KotlinType> m44663a() {
        Collection<JavaClassifierType> upperBounds = this.f60577b.getUpperBounds();
        if (upperBounds.isEmpty()) {
            SimpleType anyType = this.f60576a.getModule().getBuiltIns().getAnyType();
            Intrinsics.checkNotNullExpressionValue(anyType, "c.module.builtIns.anyType");
            SimpleType nullableAnyType = this.f60576a.getModule().getBuiltIns().getNullableAnyType();
        ...
        for (JavaClassifierType transformJavaType : iterable) {
            arrayList.add(this.f60576a.getTypeResolver().transformJavaType(transformJavaType, JavaTypeResolverKt.toAttributes$default(TypeUsage.COMMON, false, this, 1, (Object) null)));
        }
    ...
    public List<KotlinType> processBoundsWithoutCycles(List<? extends KotlinType> list) {
        ...
        return this.f60576a.getComponents().getSignatureEnhancement().enhanceTypeParameterBounds(this, list, this.f60576a);
    }
}
