...
final class C21605xb25049ef extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFPredicate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C21605xb25049ef(String str) {
        super(1);
    ...
    public final void invoke(SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder functionEnhancementBuilder) {
        ...
        functionEnhancementBuilder.parameter(this.$JFPredicate, PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60605b);
