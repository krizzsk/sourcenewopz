...
public final class ObservableSequenceEqual<T> extends Observable<Boolean> {
    ...
    /* renamed from: a */
    final ObservableSource<? extends T> f58926a;

    /* renamed from: b */
    final ObservableSource<? extends T> f58927b;

    /* renamed from: c */
    final BiPredicate<? super T, ? super T> f58928c;
    ...
    public ObservableSequenceEqual(ObservableSource<? extends T> observableSource, ObservableSource<? extends T> observableSource2, BiPredicate<? super T, ? super T> biPredicate, int i) {
        this.f58926a = observableSource;
        this.f58927b = observableSource2;
        this.f58928c = biPredicate;
        this.f58929d = i;
    }

    public void subscribeActual(Observer<? super Boolean> observer) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(observer, this.f58929d, this.f58926a, this.f58927b, this.f58928c);
                ...
                while (!this.cancelled) {
                    ...
                    if (!z || (th2 = equalObserver.error) == null) {
                        ...
                        if (!z2 || (th = equalObserver2.error) == null) {
                            if (this.f58930v1 == null) {
                                this.f58930v1 = spscLinkedArrayQueue.poll();
                            }
                            boolean z3 = this.f58930v1 == null;
                            if (this.f58931v2 == null) {
                                this.f58931v2 = spscLinkedArrayQueue2.poll();
                            }
                            boolean z4 = this.f58931v2 == null;
                            if (z && z2 && z3 && z4) {
                                ...
                                if (!z3 && !z4) {
                                    try {
                                        if (!this.comparer.test(this.f58930v1, this.f58931v2)) {
