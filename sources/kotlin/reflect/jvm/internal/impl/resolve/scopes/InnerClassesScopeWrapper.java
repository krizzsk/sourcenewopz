...
public final class InnerClassesScopeWrapper extends MemberScopeImpl {
    ...
    /* renamed from: a */
    private final MemberScope f60912a;

    public InnerClassesScopeWrapper(MemberScope memberScope) {
        Intrinsics.checkNotNullParameter(memberScope, "workerScope");
        this.f60912a = memberScope;
    }

    public ClassifierDescriptor getContributedClassifier(Name name, LookupLocation lookupLocation) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(lookupLocation, "location");
        ClassifierDescriptor contributedClassifier = this.f60912a.getContributedClassifier(name, lookupLocation);
    ...
    public List<ClassifierDescriptor> getContributedDescriptors(DescriptorKindFilter descriptorKindFilter, Function1<? super Name, Boolean> function1) {
        ...
        for (Object next : this.f60912a.getContributedDescriptors(restrictedToKindsOrNull, function1)) {
    ...
    public Set<Name> getFunctionNames() {
        return this.f60912a.getFunctionNames();
    }

    public Set<Name> getVariableNames() {
        return this.f60912a.getVariableNames();
    }

    public Set<Name> getClassifierNames() {
        return this.f60912a.getClassifierNames();
    }

    public void recordLookup(Name name, LookupLocation lookupLocation) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(lookupLocation, "location");
        this.f60912a.recordLookup(name, lookupLocation);
    }

    public String toString() {
        return Intrinsics.stringPlus("Classes from ", this.f60912a);
    }
}
