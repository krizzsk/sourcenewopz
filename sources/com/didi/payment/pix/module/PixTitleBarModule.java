...
public final class PixTitleBarModule extends BaseModule<TitleBarData> {
    ...
    /* renamed from: d */
    private TextView f31083d;

    /* renamed from: e */
    private TextView f31084e;

    /* renamed from: f */
    private View.OnClickListener f31085f;

    @Metadata(mo175977d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0016\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bJ\u0016\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\n¨\u0006\u000b"}, mo175978d2 = {"Lcom/didi/payment/pix/module/PixTitleBarModule$Companion;", "", "()V", "create", "Lcom/didi/payment/pix/module/PixTitleBarModule;", "pContext", "Landroid/content/Context;", "pParentView", "Landroid/view/ViewGroup;", "pViewStub", "Landroid/view/ViewStub;", "wallet-service-pix_globalRelease"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: PixTitleBarModule.kt */
    ...
    private final void m21864a() {
        ...
        this.f31080a = (LinearLayout) findViewById;
        ...
        this.f31082c = (TextView) findViewById3;
        ...
        this.f31083d = (TextView) findViewById4;
        ...
        this.f31084e = (TextView) findViewById5;
        ...
        view.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PixTitleBarModule.m21865a(PixTitleBarModule.this, view);
            }
        });
    }
    ...
    /* renamed from: a */
    public static final void m21865a(PixTitleBarModule pixTitleBarModule, View view) {
        Intrinsics.checkNotNullParameter(pixTitleBarModule, "this$0");
        View.OnClickListener onClickListener = pixTitleBarModule.f31085f;
    ...
    public void bindData(TitleBarData titleBarData) {
        ...
        TextView textView = this.f31082c;
        View view = null;
        if (textView == null) {
        ...
        TextView textView2 = this.f31083d;
        if (textView2 == null) {
        ...
        TextView textView3 = this.f31084e;
        if (textView3 == null) {
    ...
    public final LinearLayout getToolBar() {
        LinearLayout linearLayout = this.f31080a;
