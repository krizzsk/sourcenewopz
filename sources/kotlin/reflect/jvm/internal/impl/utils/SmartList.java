...
public class SmartList<E> extends AbstractList<E> implements RandomAccess {
    ...
    /* renamed from: a */
    private static /* synthetic */ void m45104a(int i) {
    ...
    public E get(int i) {
        int i2;
        if (i < 0 || i >= (i2 = this.f61200a)) {
            throw new IndexOutOfBoundsException("Index: " + i + ", Size: " + this.f61200a);
        } else if (i2 == 1) {
            return this.f61201b;
        } else {
            return ((Object[]) this.f61201b)[i];
        }
    }
    ...
    public boolean add(E e) {
        ...
        if (i == 0) {
            ...
            this.f61201b = new Object[]{this.f61201b, e};
        } else {
            Object[] objArr = (Object[]) this.f61201b;
            ...
            if (i >= length) {
                ...
                this.f61201b = objArr2;
                System.arraycopy(objArr, 0, objArr2, 0, length);
                objArr = objArr2;
            }
            objArr[this.f61200a] = e;
        }
        this.f61200a++;
        this.modCount++;
        return true;
    ...
    public void add(int i, E e) {
        ...
        if (i2 == 0) {
            ...
            this.f61201b = new Object[]{e, this.f61201b};
        } else {
            int i3 = this.f61200a;
            Object[] objArr = new Object[(i3 + 1)];
            if (i3 == 1) {
                objArr[0] = this.f61201b;
            } else {
                Object[] objArr2 = (Object[]) this.f61201b;
                System.arraycopy(objArr2, 0, objArr, 0, i);
                System.arraycopy(objArr2, i, objArr, i + 1, this.f61200a - i);
            }
            objArr[i] = e;
            this.f61201b = objArr;
        }
    ...
    public E remove(int i) {
        ...
        if (i2 == 1) {
            ...
            E e2 = eArr[i];
            if (i2 == 2) {
                this.f61201b = eArr[1 - i];
            } else {
                int i3 = (i2 - i) - 1;
                if (i3 > 0) {
                    System.arraycopy(eArr, i + 1, eArr, i, i3);
                }
                eArr[this.f61200a - 1] = null;
            }
            e = e2;
        }
        this.f61200a--;
    ...
    public <T> T[] toArray(T[] tArr) {
        ...
        if (i == 1) {
            ...
            T[] copyOf = Arrays.copyOf((Object[]) this.f61201b, i, tArr.getClass());
            if (copyOf == null) {
                m45104a(6);
            }
            return copyOf;
        } else if (i != 0) {
            System.arraycopy(this.f61201b, 0, tArr, 0, i);
        }
        int i2 = this.f61200a;
        if (length > i2) {
            tArr[i2] = null;
