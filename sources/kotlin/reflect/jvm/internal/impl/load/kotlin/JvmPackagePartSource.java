...
public final class JvmPackagePartSource implements DeserializedContainerSource {
    ...
    /* renamed from: a */
    private final JvmClassName f60642a;

    /* renamed from: b */
    private final JvmClassName f60643b;

    /* renamed from: c */
    private final IncompatibleVersionErrorData<JvmMetadataVersion> f60644c;

    /* renamed from: d */
    private final boolean f60645d;

    /* renamed from: e */
    private final DeserializedContainerAbiStability f60646e;

    /* renamed from: f */
    private final KotlinJvmBinaryClass f60647f;
    ...
    public JvmPackagePartSource(JvmClassName jvmClassName, JvmClassName jvmClassName2, ProtoBuf.Package packageR, NameResolver nameResolver, IncompatibleVersionErrorData<JvmMetadataVersion> incompatibleVersionErrorData, boolean z, DeserializedContainerAbiStability deserializedContainerAbiStability, KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        ...
        this.f60642a = jvmClassName;
        this.f60643b = jvmClassName2;
        this.f60644c = incompatibleVersionErrorData;
        this.f60645d = z;
        this.f60646e = deserializedContainerAbiStability;
        this.f60647f = kotlinJvmBinaryClass;
    ...
    public final Name getSimpleName() {
        String internalName = this.f60642a.getInternalName();
    ...
    public final ClassId getClassId() {
        return new ClassId(this.f60642a.getPackageFqName(), getSimpleName());
    }

    public String toString() {
        return getClass().getSimpleName() + ": " + this.f60642a;
    }
