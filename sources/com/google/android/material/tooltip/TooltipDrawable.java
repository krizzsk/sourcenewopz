...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    private static final int DEFAULT_STYLE = 2132018325;
    private static final int DEFAULT_THEME_ATTR = 2130971090;
    ...
    private void loadFromAttributes(AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, C10448R.styleable.Tooltip, i, i2, new int[0]);
