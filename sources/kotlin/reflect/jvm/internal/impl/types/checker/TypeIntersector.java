...
public final class TypeIntersector {
    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> list) {
        ...
        if (!_Assertions.ENABLED || z) {
            ...
            return m45076a((LinkedHashSet) linkedHashSet);
        }
        throw new AssertionError(Intrinsics.stringPlus("Size should be at least 2, but it is ", Integer.valueOf(list.size())));
    }

    /* renamed from: a */
    private final SimpleType m45076a(Set<? extends SimpleType> set) {
        if (set.size() == 1) {
            return (SimpleType) CollectionsKt.single(set);
        }
        Function0 typeIntersector$intersectTypesWithoutIntersectionType$errorMessage$1 = new C21760x7a6103fb(set);
        Collection collection = set;
        Collection<SimpleType> a = m45075a((Collection<? extends SimpleType>) collection, (Function2<? super SimpleType, ? super SimpleType, Boolean>) new C21761x702eebb8(this));
        boolean z = !a.isEmpty();
        if (!_Assertions.ENABLED || z) {
            ...
            Collection<SimpleType> a2 = m45075a((Collection<? extends SimpleType>) a, (Function2<? super SimpleType, ? super SimpleType, Boolean>) new C21762xc97d8c34(NewKotlinTypeChecker.Companion.getDefault()));
    ...
    private final java.util.Collection<kotlin.reflect.jvm.internal.impl.types.SimpleType> m45075a(java.util.Collection<? extends kotlin.reflect.jvm.internal.impl.types.SimpleType> r8, kotlin.jvm.functions.Function2<? super kotlin.reflect.jvm.internal.impl.types.SimpleType, ? super kotlin.reflect.jvm.internal.impl.types.SimpleType, java.lang.Boolean> r9) {
        ...
        L_0x0061:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.reflect.jvm.internal.impl.types.checker.TypeIntersector.m45075a(java.util.Collection, kotlin.jvm.functions.Function2):java.util.Collection");
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public final boolean m45077a(KotlinType kotlinType, KotlinType kotlinType2) {
