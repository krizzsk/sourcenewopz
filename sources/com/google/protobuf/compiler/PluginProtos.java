...
public final class PluginProtos {
    ...
    public static final class CodeGeneratorRequest extends GeneratedMessageV3 implements CodeGeneratorRequestOrBuilder {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return PluginProtos.f53813x36d642;
        }

        /* access modifiers changed from: protected */
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return PluginProtos.f53814xfc149ac0.ensureFieldAccessorsInitialized(CodeGeneratorRequest.class, Builder.class);
        }
    ...
    public static final class CodeGeneratorResponse extends GeneratedMessageV3 implements CodeGeneratorResponseOrBuilder {
        ...
        public static final Descriptors.Descriptor getDescriptor() {
            return PluginProtos.f53817x140ff76a;
        }

        /* access modifiers changed from: protected */
        public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return PluginProtos.f53818x23ee13e8.ensureFieldAccessorsInitialized(CodeGeneratorResponse.class, Builder.class);
        }
        ...
        public static final class File extends GeneratedMessageV3 implements FileOrBuilder {
            ...
            public static final Descriptors.Descriptor getDescriptor() {
                return PluginProtos.f53815xcaba06d7;
            }

            /* access modifiers changed from: protected */
            public GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
                return PluginProtos.f53816xb43c6655.ensureFieldAccessorsInitialized(File.class, Builder.class);
            }
    ...
    static {
        C197071 r1 = new Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        ...
        f53813x36d642 = descriptor2;
        f53814xfc149ac0 = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"FileToGenerate", "Parameter", "ProtoFile"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        f53817x140ff76a = descriptor3;
        f53818x23ee13e8 = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Error", "File"});
        Descriptors.Descriptor descriptor4 = f53817x140ff76a.getNestedTypes().get(0);
        f53815xcaba06d7 = descriptor4;
        f53816xb43c6655 = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"Name", "InsertionPoint", "Content"});
