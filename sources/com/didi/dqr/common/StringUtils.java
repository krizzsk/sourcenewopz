...
public final class StringUtils {
    ...
    /* renamed from: a */
    private static final String f18561a;

    /* renamed from: b */
    private static final String f18562b = "EUC_JP";

    /* renamed from: c */
    private static final String f18563c = "UTF8";

    /* renamed from: d */
    private static final String f18564d = "ISO8859_1";

    /* renamed from: e */
    private static final boolean f18565e;

    static {
        String name = Charset.defaultCharset().name();
        f18561a = name;
        f18565e = "SJIS".equalsIgnoreCase(name) || f18562b.equalsIgnoreCase(f18561a);
    }
    ...
    public static String guessEncoding(byte[] bArr, Map<DecodeHintType, ?> map) {
        ...
        if (z3 && (f18565e || i9 >= 3 || i >= 3)) {
            return "SJIS";
        }
        if (z && z3) {
            return (!(i9 == 2 && i2 == 2) && i10 * 10 < length) ? f18564d : "SJIS";
        }
        if (z) {
            return f18564d;
        }
