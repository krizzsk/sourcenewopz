...
public final class ObservableTimeout<T, U, V> extends C21211a<T, T> {

    /* renamed from: a */
    final ObservableSource<U> f58975a;

    /* renamed from: b */
    final Function<? super T, ? extends ObservableSource<V>> f58976b;

    /* renamed from: c */
    final ObservableSource<? extends T> f58977c;
    ...
    public ObservableTimeout(Observable<T> observable, ObservableSource<U> observableSource, Function<? super T, ? extends ObservableSource<V>> function, ObservableSource<? extends T> observableSource2) {
        super(observable);
        this.f58975a = observableSource;
        this.f58976b = function;
        this.f58977c = observableSource2;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super T> observer) {
        if (this.f58977c == null) {
            TimeoutObserver timeoutObserver = new TimeoutObserver(observer, this.f58976b);
            observer.onSubscribe(timeoutObserver);
            timeoutObserver.startFirstTimeout(this.f58975a);
            this.source.subscribe(timeoutObserver);
            return;
        }
        TimeoutFallbackObserver timeoutFallbackObserver = new TimeoutFallbackObserver(observer, this.f58976b, this.f58977c);
        observer.onSubscribe(timeoutFallbackObserver);
        timeoutFallbackObserver.startFirstTimeout(this.f58975a);
