...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0015, code lost:
        r11 = null;
        r10 = r12.f6242c.getEncoded(org.bouncycastle.asn1.ASN1Encoding.DER);
     */
    ...
    private org.bouncycastle.jcajce.provider.asymmetric.x509.X509CertificateInternal getInternalCertificate() {
        ...
        L_0x000b:
            monitor-exit(r0)     // Catch:{ all -> 0x0042 }
            r0 = 0
            org.bouncycastle.asn1.x509.Certificate r1 = r12.f6242c     // Catch:{ IOException -> 0x0018 }
        ...
        L_0x0020:
            ...
            org.bouncycastle.asn1.x509.Certificate r5 = r12.f6242c
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            if (!this.hashValueSet || !x509CertificateObject.hashValueSet) {
                if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f6242c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f6242c.getSignature())) {
                    return false;
                }
