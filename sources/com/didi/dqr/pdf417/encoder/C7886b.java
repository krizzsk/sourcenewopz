...
final class C7886b {
    ...
    /* renamed from: b */
    static int m14181b(int i) throws WriterException {
        if (i <= 0) {
    ...
    /* renamed from: a */
    static String m14180a(CharSequence charSequence, int i) {
        int a = m14179a(i);
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            while (i3 >= 1) {
                cArr[i3] = (char) ((cArr[i3 - 1] + (929 - ((f18991a[i][i3] * charAt) % 929))) % 929);
                i3--;
            }
            cArr[0] = (char) ((929 - ((charAt * f18991a[i][0]) % 929)) % 929);
        }
