...
public final class UndispatchedKt {
    public static final <T, R> Object startUndispatchedOrReturn(ScopeCoroutine<? super T> scopeCoroutine, R r, Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        if (function2 != null) {
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                th3 = StackTraceRecoveryKt.m45986a(th3, (CoroutineStackFrame) continuation);
            }
            throw th3;
        }
            ...
            if (makeCompletingOnce$kotlinx_coroutines_core instanceof CompletedExceptionally) {
                ...
                if (z) {
                    ...
                    if (DebugKt.getRECOVER_STACK_TRACES() && (continuation2 instanceof CoroutineStackFrame)) {
                        th4 = StackTraceRecoveryKt.m45986a(th4, (CoroutineStackFrame) continuation2);
                    }
                    throw th4;
                }
            } else {
    ...
    /* renamed from: a */
    private static final <T> Object m46007a(ScopeCoroutine<? super T> scopeCoroutine, Function1<? super Throwable, Boolean> function1, Function0<? extends Object> function0) {
        Object obj;
        try {
        ...
        if (function1.invoke(completedExceptionally.cause).booleanValue()) {
            ...
            Continuation<T> continuation = scopeCoroutine.uCont;
            if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                th2 = StackTraceRecoveryKt.m45986a(th2, (CoroutineStackFrame) continuation);
            }
            throw th2;
        } else if (!(obj instanceof CompletedExceptionally)) {
            return obj;
            ...
            Continuation<T> continuation2 = scopeCoroutine.uCont;
            if (DebugKt.getRECOVER_STACK_TRACES() && (continuation2 instanceof CoroutineStackFrame)) {
                th3 = StackTraceRecoveryKt.m45986a(th3, (CoroutineStackFrame) continuation2);
            }
            throw th3;
        }
    }
        ...
        if (function1 != null) {
            try {
                ...
                if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    probeCoroutineCreated.resumeWith(Result.m47688constructorimpl(invoke));
                }
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                probeCoroutineCreated.resumeWith(Result.m47688constructorimpl(ResultKt.createFailure(th)));
            }
        } else {
    ...
    /* renamed from: a */
    private static final <T> void m46008a(Continuation<? super T> continuation, Function1<? super Continuation<? super T>, ? extends Object> function1) {
        Continuation<? super T> probeCoroutineCreated = DebugProbesKt.probeCoroutineCreated(continuation);
        try {
