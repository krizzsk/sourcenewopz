...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    ...
    /* renamed from: a */
    private final Map<TypeConstructor, TypeConstructor> f60860a;

    /* renamed from: b */
    private final KotlinTypeChecker.TypeConstructorEquality f60861b;

    /* renamed from: c */
    private final KotlinTypeRefiner f60862c;
    ...
    public OverridingUtilTypeSystemContext(Map<TypeConstructor, ? extends TypeConstructor> map, KotlinTypeChecker.TypeConstructorEquality typeConstructorEquality, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        this.f60860a = map;
        this.f60861b = typeConstructorEquality;
        this.f60862c = kotlinTypeRefiner;
    }
    ...
    public boolean areEqualTypeConstructors(TypeConstructorMarker typeConstructorMarker, TypeConstructorMarker typeConstructorMarker2) {
        ...
        if (!(typeConstructorMarker instanceof TypeConstructor)) {
            ...
            return ClassicTypeSystemContext.DefaultImpls.areEqualTypeConstructors(this, typeConstructorMarker, typeConstructorMarker2) || m44943a((TypeConstructor) typeConstructorMarker, (TypeConstructor) typeConstructorMarker2);
        } else {
            throw new IllegalArgumentException("Failed requirement.".toString());
        }
    }
    ...
    public AbstractTypeCheckerContext newBaseTypeCheckerContext(boolean z, boolean z2) {
        return new ClassicTypeCheckerContext(z, z2, true, this.f60862c, (KotlinTypePreparator) null, this, 16, (DefaultConstructorMarker) null);
    }

    /* renamed from: a */
    private final boolean m44943a(TypeConstructor typeConstructor, TypeConstructor typeConstructor2) {
        if (this.f60861b.equals(typeConstructor, typeConstructor2)) {
            return true;
        }
        Map<TypeConstructor, TypeConstructor> map = this.f60860a;
        if (map == null) {
            return false;
        }
        TypeConstructor typeConstructor3 = map.get(typeConstructor);
        TypeConstructor typeConstructor4 = this.f60860a.get(typeConstructor2);
