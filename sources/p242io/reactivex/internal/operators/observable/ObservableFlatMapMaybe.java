...
public final class ObservableFlatMapMaybe<T, R> extends C21211a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends MaybeSource<? extends R>> f58822a;

    /* renamed from: b */
    final boolean f58823b;
    ...
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new FlatMapMaybeObserver(observer, this.f58822a, this.f58823b));
    }
