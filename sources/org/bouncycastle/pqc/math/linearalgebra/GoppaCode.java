...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        /* renamed from: h */
        private GF2Matrix f6559h;

        /* renamed from: p */
        private Permutation f6560p;

        /* renamed from: s */
        private GF2Matrix f6561s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f6561s = gF2Matrix;
            this.f6559h = gF2Matrix2;
            this.f6560p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        /* renamed from: g */
        private GF2Matrix f6562g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f6562g = gF2Matrix;
            this.setJ = iArr;
        }
