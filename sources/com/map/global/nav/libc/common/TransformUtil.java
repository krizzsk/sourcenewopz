...
public class TransformUtil {
    ...
    /* renamed from: a */
    private static final int f55714a = 20037508;

    /* renamed from: b */
    private static final int f55715b = 30240971;

    /* renamed from: c */
    private static final double f55716c = 111319.49077777778d;

    /* renamed from: d */
    private static final double f55717d = 0.017453292519943295d;

    /* renamed from: e */
    private static final double f55718e = 0.008726646259971648d;

    /* renamed from: f */
    private static final double f55719f = 114.59155902616465d;

    /* renamed from: a */
    private static double m40138a(double d) {
    ...
    public static double clientX2Longitude(int i) {
        return ((double) (i - f55714a)) / 111319.49077777778d;
    }
    ...
    public static double clientY2Latitude(int i) {
        return (Math.atan(Math.exp((((double) (i - f55715b)) / 111319.49077777778d) * 0.017453292519943295d)) * 114.59155902616465d) - 90.0d;
    }
    ...
    public static double distanceBetween(double d, double d2, double d3, double d4) {
        double a = m40138a(d3 - d);
        double a2 = m40138a(d4 - d2);
        double d5 = a / 2.0d;
        double d6 = a2 / 2.0d;
        double sin = (Math.sin(d5) * Math.sin(d5)) + (Math.sin(d6) * Math.sin(d6) * Math.cos(m40138a(d)) * Math.cos(m40138a(d3)));
