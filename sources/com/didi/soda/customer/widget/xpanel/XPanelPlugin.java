...
public class XPanelPlugin extends CustomerBasePlugin {
    ...
    /* renamed from: a */
    private static final String f42255a = "com.didi.rlab/xpanel_plugin";

    public void onDetachedFromEngine(FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
    }

    public void onAttachedToEngine(FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
        new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), f42255a).setMethodCallHandler(this);
    }
