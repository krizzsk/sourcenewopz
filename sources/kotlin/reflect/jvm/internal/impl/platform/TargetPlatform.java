...
public class TargetPlatform implements Collection<SimplePlatform>, KMappedMarker {
    ...
    /* renamed from: a */
    private final Set<SimplePlatform> f60743a;
    ...
    public boolean contains(SimplePlatform simplePlatform) {
        ...
        return this.f60743a.contains(simplePlatform);
    }

    public boolean containsAll(Collection<? extends Object> collection) {
        Intrinsics.checkNotNullParameter(collection, "elements");
        return this.f60743a.containsAll(collection);
    }
    ...
    public boolean isEmpty() {
        return this.f60743a.isEmpty();
    }

    public Iterator<SimplePlatform> iterator() {
        return this.f60743a.iterator();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof TargetPlatform) && Intrinsics.areEqual((Object) this.f60743a, (Object) ((TargetPlatform) obj).f60743a);
    }
