...
final class LazyJavaTypeParameterResolver$resolve$1 extends Lambda implements Function1<JavaTypeParameter, LazyJavaTypeParameterDescriptor> {
    ...
    public final LazyJavaTypeParameterDescriptor invoke(JavaTypeParameter javaTypeParameter) {
        ...
        Integer num = (Integer) this.this$0.f60500d.get(javaTypeParameter);
        if (num == null) {
            return null;
        }
        LazyJavaTypeParameterResolver lazyJavaTypeParameterResolver = this.this$0;
        return new LazyJavaTypeParameterDescriptor(ContextKt.copyWithNewDefaultTypeQualifiers(ContextKt.child(lazyJavaTypeParameterResolver.f60497a, lazyJavaTypeParameterResolver), lazyJavaTypeParameterResolver.f60498b.getAnnotations()), javaTypeParameter, lazyJavaTypeParameterResolver.f60499c + num.intValue(), lazyJavaTypeParameterResolver.f60498b);
    }
}
