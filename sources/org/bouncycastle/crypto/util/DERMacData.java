...
public final class DERMacData {
    ...
    static /* synthetic */ class C26601 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.crypto.util.DERMacData.C26601.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int i = C26601.$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
            if (i == 1 || i == 2) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.ephemDataU), DerUtil.toByteArray(this.ephemDataV), this.text), (C26601) null);
            } else if (i == 3 || i == 4) {
                return new DERMacData(concatenate(this.type.getHeader(), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.ephemDataV), DerUtil.toByteArray(this.ephemDataU), this.text), (C26601) null);
            } else {
    ...
    /* synthetic */ DERMacData(byte[] bArr, C26601 r2) {
        this(bArr);
    }
