...
public class UnipayTextUtil extends SpannableStringBuilder {
    ...
    /* renamed from: a */
    private static final String f44617a = "(([0-9]*\\.?[0-9]+)*,?[0-9]*)";

    /* renamed from: b */
    private static final String f44618b = "&#10;";

    /* renamed from: c */
    private CharSequence f44619c;
    ...
    public static String getFirstMoneyFromText(String str) {
        ...
        Matcher matcher = Pattern.compile(f44617a).matcher(str);
        if (matcher.find()) {
    ...
    public SpannableStringBuilder spanNumSize(float f) {
        Matcher matcher = Pattern.compile(f44617a).matcher(this.f44619c);
        while (matcher.find()) {
            m31701a(f, matcher.start(), matcher.end());
        }
        return this;
    }

    /* renamed from: a */
    private void m31701a(float f, int i, int i2) {
