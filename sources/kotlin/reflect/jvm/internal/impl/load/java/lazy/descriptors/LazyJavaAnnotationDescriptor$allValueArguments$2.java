...
final class LazyJavaAnnotationDescriptor$allValueArguments$2 extends Lambda implements Function0<Map<Name, ? extends ConstantValue<?>>> {
    ...
    public final Map<Name, ConstantValue<?>> invoke() {
        ...
        for (JavaAnnotationArgument javaAnnotationArgument : this.this$0.f60515c.getArguments()) {
            Name name = javaAnnotationArgument.getName();
            if (name == null) {
                name = JvmAnnotationNames.DEFAULT_ANNOTATION_MEMBER_NAME;
            }
            ConstantValue access$resolveAnnotationArgument = lazyJavaAnnotationDescriptor.m44608a(javaAnnotationArgument);
            Pair pair = access$resolveAnnotationArgument == null ? null : TuplesKt.m42317to(name, access$resolveAnnotationArgument);
            if (pair != null) {
                arrayList.add(pair);
            }
        }
