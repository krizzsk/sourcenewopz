...
public class XCardRenderer {
    ...
    /* renamed from: a */
    XBannerCDNData f51527a;

    /* renamed from: b */
    private Context f51528b;

    /* renamed from: c */
    private float f51529c = ContextLoader.getDensity();
    ...
    public View render(XCardNode xCardNode) {
        ...
        try {
            ...
            if ("card".equals(element.getTagName())) {
                return m36885a(xCardNode, (ViewGroup) null);
            }
    ...
    private android.view.View m36885a(com.didiglobal.xbanner.template.yoga.XCardNode r6, android.view.ViewGroup r7) {
        /*
            r5 = this;
        ...
        L_0x001d:
            ...
            r5.m36885a((com.didiglobal.xbanner.template.yoga.XCardNode) r0, (android.view.ViewGroup) r7)
            goto L_0x001d
        L_0x002d:
            return r7
        L_0x002e:
            ...
            com.didiglobal.xbanner.template.yoga.IParser r2 = r5.m36887a((java.lang.String) r2, (java.util.HashMap<java.lang.String, java.lang.Object>) r3)
        ...
        L_0x005f:
            ...
            r5.m36895a((java.util.HashMap<java.lang.String, java.lang.Object>) r3, (com.didiglobal.xbanner.template.yoga.IParser) r2, (com.facebook.yoga.YogaNode) r1, (java.lang.String) r0)
            r2.onParseEnd()
        ...
        L_0x008c:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didiglobal.xbanner.template.yoga.XCardRenderer.m36885a(com.didiglobal.xbanner.template.yoga.XCardNode, android.view.ViewGroup):android.view.View");
    }

    /* renamed from: a */
    private IParser m36887a(String str, HashMap<String, Object> hashMap) {
        if ("view".equals(str) || "card".equals(str)) {
            XPanelYogaLayout xPanelYogaLayout = new XPanelYogaLayout(this.f51528b);
            if ("card".equals(str)) {
                m36890a((View) xPanelYogaLayout, "", "card");
            }
            return xPanelYogaLayout;
        } else if ("image".equals(str)) {
            if (!TextUtils.isEmpty((String) hashMap.get("url"))) {
                return new XPanelImageView(this.f51528b);
            }
            return null;
        } else if ("label".equals(str)) {
            if (!TextUtils.isEmpty((String) hashMap.get("text"))) {
                return new XPanelTextView(this.f51528b);
            }
            return null;
        } else if ("progressBar".equals(str)) {
            return new XPanelProgressBar(this.f51528b);
        } else {
            if ("scrollview".equals(str)) {
                return new XPanelHorizontalScrollView(this.f51528b);
            }
    ...
    /* renamed from: a */
    private void m36895a(HashMap<String, Object> hashMap, IParser iParser, YogaNode yogaNode, String str) {
        ...
        while (it.hasNext()) {
            ...
            String str9 = str7;
            String str10 = str4;
            if (m36896a(str7, obj, iParser.getView(), yogaNode, corner, border, str)) {
        ...
        String str11 = str4;
        if (str5 != null) {
            m36894a(str5, (XPanelImageView) iParser.getView(), yogaNode, corner, border);
            return;
        }
        String str12 = str11;
        if (!border.isEmpty || str12 != null || (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str3))) {
            Drawable a = m36884a(corner, str2, str3, str12);
            ...
            if ("default".equals(hashMap.get("shadow"))) {
                iParser.getView().setBackground(this.f51528b.getResources().getDrawable(R.drawable.oc_x_panel_card_bg));
            } else {
    ...
    /* renamed from: a */
    private Drawable m36884a(Corner corner, String str, String str2, String str3) {
    ...
    /* renamed from: a */
    private void m36894a(String str, XPanelImageView xPanelImageView, YogaNode yogaNode, Corner corner, Border border) {
        String str2 = str;
        XPanelImageView xPanelImageView2 = xPanelImageView;
        if (this.f51528b != null && !TextUtils.isEmpty(str)) {
            xPanelImageView.setTag(str);
            final Map<String, Object> mapFromAgentData = ImgLoadTracker.getMapFromAgentData(this.f51527a);
            ...
            if (!str.endsWith(".gif")) {
                ...
                Glide.with(this.f51528b).asBitmap().load(str).into(new CustomTarget<Bitmap>() {
            ...
            ((RequestBuilder) Glide.with(this.f51528b).asGif().load(str).diskCacheStrategy(DiskCacheStrategy.DATA)).into((ImageView) xPanelImageView);
        }
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean m36896a(java.lang.String r4, java.lang.String r5, android.view.View r6, com.facebook.yoga.YogaNode r7, com.didiglobal.xbanner.template.yoga.view.Corner r8, com.didiglobal.xbanner.template.yoga.view.Border r9, java.lang.String r10) {
        /*
            r3 = this;
            int r0 = r4.hashCode()
            r1 = 1
        ...
        L_0x01bb:
            ...
            goto L_0x02b6
        L_0x01c4:
            com.facebook.yoga.YogaAlign r4 = r3.m36900c(r5)
            r7.setAlignSelf(r4)
            goto L_0x02b6
        L_0x01cd:
            r3.m36890a((android.view.View) r6, (java.lang.String) r5, (java.lang.String) r10)
            goto L_0x02b6
        L_0x01d2:
            float r4 = java.lang.Float.parseFloat(r5)
        ...
        L_0x0261:
            ...
            goto L_0x02b6
        L_0x0267:
            com.facebook.yoga.YogaPositionType r4 = r3.m36888a((java.lang.String) r5)
            r7.setPositionType(r4)
            goto L_0x02b6
        L_0x026f:
            com.facebook.yoga.YogaEdge r4 = com.facebook.yoga.YogaEdge.BOTTOM
            r3.m36892a((com.facebook.yoga.YogaEdge) r4, (com.facebook.yoga.YogaNode) r7, (java.lang.String) r5, (android.view.View) r6)
            goto L_0x02b6
        L_0x0275:
            com.facebook.yoga.YogaEdge r4 = com.facebook.yoga.YogaEdge.TOP
            r3.m36892a((com.facebook.yoga.YogaEdge) r4, (com.facebook.yoga.YogaNode) r7, (java.lang.String) r5, (android.view.View) r6)
        ...
        L_0x028d:
            com.facebook.yoga.YogaEdge r4 = com.facebook.yoga.YogaEdge.BOTTOM
            r3.m36891a((com.facebook.yoga.YogaEdge) r4, (com.facebook.yoga.YogaNode) r7, (java.lang.String) r5)
            goto L_0x02b6
        L_0x0293:
            com.facebook.yoga.YogaEdge r4 = com.facebook.yoga.YogaEdge.TOP
            r3.m36891a((com.facebook.yoga.YogaEdge) r4, (com.facebook.yoga.YogaNode) r7, (java.lang.String) r5)
        ...
        L_0x02a5:
            ...
            goto L_0x02b6
        L_0x02ab:
            r3.m36893a((com.facebook.yoga.YogaNode) r7, (java.lang.String) r5)
            goto L_0x02b6
        L_0x02af:
            r3.m36899b(r7, r5)
            goto L_0x02b6
    ...
    private void m36891a(YogaEdge yogaEdge, YogaNode yogaNode, String str) {
        ...
        if (str.endsWith("%")) {
            ...
            yogaNode.setMargin(yogaEdge, Float.parseFloat(str) * this.f51529c);
        }
    }

    /* renamed from: a */
    private void m36892a(YogaEdge yogaEdge, YogaNode yogaNode, String str, View view) {
        if (TextUtils.isEmpty(str)) {
            return;
        }
        if (str.endsWith("%")) {
            ...
            m36889a(view, yogaEdge, parseFloat);
        } else {
            int parseFloat2 = (int) (Float.parseFloat(str) * this.f51529c);
            yogaNode.setPadding(yogaEdge, (float) parseFloat2);
            m36889a(view, yogaEdge, parseFloat2);
        }
    }

    /* renamed from: a */
    private void m36889a(View view, YogaEdge yogaEdge, int i) {
        int paddingLeft = view.getPaddingLeft();
        int paddingTop = view.getPaddingTop();
        int paddingRight = view.getPaddingRight();
        int paddingBottom = view.getPaddingBottom();
        switch (C173013.$SwitchMap$com$facebook$yoga$YogaEdge[yogaEdge.ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class C173013 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didiglobal.xbanner.template.yoga.XCardRenderer.C173013.<clinit>():void");
        }
    }

    /* renamed from: b */
    private void m36898b(YogaEdge yogaEdge, YogaNode yogaNode, String str) {
        if (TextUtils.isEmpty(str)) {
            return;
        }
        if (str.endsWith("%")) {
            ...
            yogaNode.setPosition(yogaEdge, Float.parseFloat(str) * this.f51529c);
        }
    }

    /* renamed from: a */
    private void m36890a(final View view, final String str, final String str2) {
        view.setTag(str);
        if (("card".equals(str2) || !TextUtils.isEmpty(str)) && !"scroll".equals(str2)) {
            view.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    AutoTrackHelper.trackViewOnClick(view);
                    if (XCardRenderer.this.f51531e != null) {
                        HashMap hashMap = new HashMap();
                        hashMap.put("url", str);
                        hashMap.put("extension", XCardRenderer.this.f51527a.getExtension());
                        hashMap.put("id", XCardRenderer.this.f51527a.getId());
                        hashMap.put("index", Integer.valueOf(XCardRenderer.this.f51527a.getIndex()));
                        if ("card".equals(str2)) {
                            XCardRenderer.this.f51531e.handleEvent("xpanel_card_ck", str, hashMap);
                        } else if (view.getTag(R.id.cardId) != null) {
                            hashMap.put(Const.BUTTON_ID, (String) view.getTag(R.id.cardId));
                            XCardRenderer.this.f51531e.handleEvent("xpanel_button_ck", str, hashMap);
                        } else {
                            XCardRenderer.this.f51531e.handleEvent("click", str, hashMap);
                        }
                    }
                }
            });
    ...
    /* renamed from: a */
    private YogaPositionType m36888a(String str) {
    ...
    /* renamed from: a */
    private void m36893a(YogaNode yogaNode, String str) {
        if (TextUtils.isEmpty(str)) {
            return;
        }
        if (str.endsWith("%")) {
            ...
            yogaNode.setHeight((float) ((int) (Float.parseFloat(str) * this.f51529c)));
        }
    }

    /* renamed from: b */
    private void m36899b(YogaNode yogaNode, String str) {
        if (TextUtils.isEmpty(str)) {
            return;
        }
        if (str.endsWith("%")) {
            ...
            yogaNode.setWidth((float) ((int) (Float.parseFloat(str) * this.f51529c)));
        }
    }

    /* renamed from: b */
    private float m36897b(String str) {
        if (str.endsWith("%")) {
        ...
        return (float) ((int) (Float.parseFloat(str) * this.f51529c));
    }
    ...
    /* renamed from: c */
    private YogaAlign m36900c(String str) {
        if (TextUtils.isEmpty(str)) {
