package org.bouncycastle.jcajce.provider.asymmetric.p080ec;
...
public class BCECPublicKey implements ECPublicKey, ECPointEncoder, org.bouncycastle.jce.interfaces.ECPublicKey {
    ...
    private void populateFromPubKeyInfo(org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r7) {
        ...
        L_0x003c:
            ...
            r3.<init>()
            int r3 = r3.getByteLength((org.bouncycastle.math.p082ec.ECCurve) r1)
            int r5 = r7.length
            int r5 = r5 - r4
        ...
        L_0x0059:
            ...
            r7.<init>((org.bouncycastle.math.p082ec.ECCurve) r1, (org.bouncycastle.asn1.ASN1OctetString) r2)
            ...
            org.bouncycastle.crypto.params.ECDomainParameters r0 = org.bouncycastle.jcajce.provider.asymmetric.util.ECUtil.getDomainParameters((org.bouncycastle.jcajce.provider.config.ProviderConfiguration) r2, (org.bouncycastle.asn1.p075x9.X962Parameters) r0)
            r1.<init>(r7, r0)
            r6.ecPublicKey = r1
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jcajce.provider.asymmetric.p080ec.BCECPublicKey.populateFromPubKeyInfo(org.bouncycastle.asn1.x509.SubjectPublicKeyInfo):void");
    }
