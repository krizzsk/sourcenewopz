...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m38336is(char c) {
        return new C18710Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m38336is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo149950or(CharMatcher charMatcher) {
        return new C18711Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m38336is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C18711Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C18711Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C18710Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo149950or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo149950or(charMatcher);
        }
