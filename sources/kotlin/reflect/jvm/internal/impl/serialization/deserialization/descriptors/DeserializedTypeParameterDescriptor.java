...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: a */
    public final DeserializationContext f61071a;

    /* renamed from: b */
    private final ProtoBuf.TypeParameter f61072b;

    /* renamed from: c */
    private final DeserializedAnnotations f61073c;
    ...
    public List<KotlinType> resolveUpperBounds() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.f61072b, this.f61071a.getTypeTable());
        ...
        TypeDeserializer typeDeserializer = this.f61071a.getTypeDeserializer();
