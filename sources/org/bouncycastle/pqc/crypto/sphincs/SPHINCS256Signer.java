...
public class SPHINCS256Signer implements MessageSigner {
    ...
    public byte[] crypto_sign(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2) {
        ...
        System.arraycopy(bArr10, 1056, bArr4, C13565R2.styleable.yoga_yg_paddingHorizontal, 32);
        Digest messageHash = hashFunctions2.getMessageHash();
        byte[] bArr11 = new byte[messageHash.getDigestSize()];
        messageHash.update(bArr4, C13565R2.styleable.yoga_yg_paddingHorizontal, 32);
        messageHash.update(bArr3, 0, bArr3.length);
        messageHash.doFinal(bArr11, 0);
        zerobytes(bArr4, C13565R2.styleable.yoga_yg_paddingHorizontal, 32);
        for (int i2 = 0; i2 != 8; i2++) {
            jArr[i2] = Pack.littleEndianToLong(bArr11, i2 * 8);
        }
        long j = jArr[0] & 1152921504606846975L;
        System.arraycopy(bArr11, 16, bArr5, 0, 32);
        System.arraycopy(bArr5, 0, bArr4, C13565R2.styleable.Transition_constraintSetStart, 32);
        Tree.leafaddr leafaddr = new Tree.leafaddr();
        leafaddr.level = 11;
        byte[] bArr12 = bArr10;
        leafaddr.subtree = 0;
        leafaddr.subleaf = 0;
        System.arraycopy(bArr12, 32, bArr4, C13565R2.styleable.TunaAnimateCircle_tunaAnimateCircleSpreadColorBefore, 1024);
        byte[] bArr13 = bArr12;
        byte[] bArr14 = bArr9;
        byte[] bArr15 = bArr8;
        byte[] bArr16 = bArr7;
        Tree.treehash(hashFunctions2, bArr4, C13565R2.styleable.yoga_yg_paddingHorizontal, 5, bArr13, leafaddr, bArr4, C13565R2.styleable.TunaAnimateCircle_tunaAnimateCircleSpreadColorBefore);
        Digest messageHash2 = hashFunctions2.getMessageHash();
        messageHash2.update(bArr4, C13565R2.styleable.Transition_constraintSetStart, 1088);
