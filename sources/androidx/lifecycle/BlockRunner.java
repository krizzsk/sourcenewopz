...
public final class BlockRunner<T> {
    ...
    public final void maybeRun() {
        ...
        if (this.runningJob == null) {
            this.runningJob = C21836d.m45637a(this.scope, (CoroutineContext) null, (CoroutineStart) null, new BlockRunner$maybeRun$1(this, (Continuation) null), 3, (Object) null);
        }
    }

    public final void cancel() {
        if (this.cancellationJob == null) {
            this.cancellationJob = C21836d.m45637a(this.scope, Dispatchers.getMain().getImmediate(), (CoroutineStart) null, new BlockRunner$cancel$1(this, (Continuation) null), 2, (Object) null);
            return;
        }
