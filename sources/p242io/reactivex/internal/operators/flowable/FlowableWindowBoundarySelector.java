...
public final class FlowableWindowBoundarySelector<T, B, V> extends C21208a<T, Flowable<T>> {

    /* renamed from: a */
    final Publisher<B> f58515a;

    /* renamed from: b */
    final Function<? super B, ? extends Publisher<V>> f58516b;
    ...
    public FlowableWindowBoundarySelector(Flowable<T> flowable, Publisher<B> publisher, Function<? super B, ? extends Publisher<V>> function, int i) {
        super(flowable);
        this.f58515a = publisher;
        this.f58516b = function;
        this.f58517c = i;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super Flowable<T>> subscriber) {
        this.source.subscribe(new WindowBoundaryMainSubscriber(new SerializedSubscriber(subscriber), this.f58515a, this.f58516b, this.f58517c));
    }
    ...
    static final class WindowBoundaryMainSubscriber<T, B, V> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        /* renamed from: ws */
        final List<UnicastProcessor<T>> f58519ws;
        ...
        public void onNext(T t) {
            if (!this.done) {
                if (fastEnter()) {
                    for (UnicastProcessor<T> onNext : this.f58519ws) {
                        onNext.onNext(t);
                    }
                    if (leave(-1) == 0) {
                        return;
        ...
        public void drainLoop() {
            ...
            List<UnicastProcessor<T>> list = this.f58519ws;
            int i = 1;
            while (true) {
                boolean z = this.done;
                ...
                if (z && z2) {
                    ...
                    if (windowOperation.f58520w != null) {
                        if (list.remove(windowOperation.f58520w)) {
                            windowOperation.f58520w.onComplete();
                            if (this.windows.decrementAndGet() == 0) {
                                dispose();
                                return;
                            }
        ...
        public void close(OperatorWindowBoundaryCloseSubscriber<T, V> operatorWindowBoundaryCloseSubscriber) {
            ...
            this.queue.offer(new WindowOperation(operatorWindowBoundaryCloseSubscriber.f58518w, null));
            if (enter()) {
                drainLoop();
            }
        }
    ...
    static final class WindowOperation<T, B> {
        ...
        /* renamed from: w */
        final UnicastProcessor<T> f58520w;

        WindowOperation(UnicastProcessor<T> unicastProcessor, B b) {
            this.f58520w = unicastProcessor;
            this.open = b;
        }
    }
    ...
    static final class OperatorWindowBoundaryCloseSubscriber<T, V> extends DisposableSubscriber<V> {
        ...
        /* renamed from: w */
        final UnicastProcessor<T> f58518w;
