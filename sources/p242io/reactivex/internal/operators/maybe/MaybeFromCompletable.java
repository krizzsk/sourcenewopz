...
import p242io.reactivex.internal.fuseable.HasUpstreamCompletableSource;

/* renamed from: io.reactivex.internal.operators.maybe.MaybeFromCompletable */
public final class MaybeFromCompletable<T> extends Maybe<T> implements HasUpstreamCompletableSource {

    /* renamed from: a */
    final CompletableSource f58597a;

    public MaybeFromCompletable(CompletableSource completableSource) {
        this.f58597a = completableSource;
    }
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.f58597a.subscribe(new FromCompletableObserver(maybeObserver));
    }
