...
import org.greenrobot.greendao.p085rx.RxQuery;
...
public class QueryBuilder<T> {
    ...
    public QueryBuilder<T> whereOr(WhereCondition whereCondition, WhereCondition whereCondition2, WhereCondition... whereConditionArr) {
        this.whereCollector.add(mo33907or(whereCondition, whereCondition2, whereConditionArr), new WhereCondition[0]);
        return this;
    }

    /* renamed from: or */
    public WhereCondition mo33907or(WhereCondition whereCondition, WhereCondition whereCondition2, WhereCondition... whereConditionArr) {
    ...
    private void checkLog(String str) {
        if (LOG_SQL) {
            DaoLog.m3753d("Built SQL for query: " + str);
        }
        if (LOG_VALUES) {
            DaoLog.m3753d("Values for query: " + this.values);
        }
    }
