...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m38350or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m38351or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m38349or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m38348in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f53600f;

        /* renamed from: p */
        final Predicate<B> f53601p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f53601p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f53600f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f53601p.apply(this.f53600f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f53600f.equals(compositionPredicate.f53600f) || !this.f53601p.equals(compositionPredicate.f53601p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f53600f.hashCode() ^ this.f53601p.hashCode();
        }

        public String toString() {
            return this.f53601p + "(" + this.f53600f + ")";
        }
    }
