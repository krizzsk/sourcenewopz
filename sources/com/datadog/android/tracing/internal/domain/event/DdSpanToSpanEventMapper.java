...
public final class DdSpanToSpanEventMapper implements Mapper<DDSpan, SpanEvent> {
    ...
    public SpanEvent map(DDSpan dDSpan) {
        ...
        SpanEvent.Metrics a = m2541a(dDSpan);
        SpanEvent.Meta b = m2543b(dDSpan);
    ...
    /* renamed from: a */
    private final SpanEvent.Metrics m2541a(DDSpan dDSpan) {
    ...
    /* renamed from: b */
    private final SpanEvent.Meta m2543b(DDSpan dDSpan) {
        NetworkInfo latestNetworkInfo = this.f4053b.getLatestNetworkInfo();
        SpanEvent.SimCarrier a = m2542a(latestNetworkInfo);
        ...
        SpanEvent.C2211Dd dd = new SpanEvent.C2211Dd((String) null, 1, (DefaultConstructorMarker) null);
    ...
    /* renamed from: a */
    private final SpanEvent.SimCarrier m2542a(NetworkInfo networkInfo) {
        String str = null;
