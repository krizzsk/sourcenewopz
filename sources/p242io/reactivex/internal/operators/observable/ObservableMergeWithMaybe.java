...
public final class ObservableMergeWithMaybe<T> extends C21211a<T, T> {

    /* renamed from: a */
    final MaybeSource<? extends T> f58873a;

    public ObservableMergeWithMaybe(Observable<T> observable, MaybeSource<? extends T> maybeSource) {
        super(observable);
        this.f58873a = maybeSource;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f58873a.subscribe(mergeWithObserver.otherObserver);
    }
