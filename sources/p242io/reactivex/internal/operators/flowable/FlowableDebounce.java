...
public final class FlowableDebounce<T, U> extends C21208a<T, T> {

    /* renamed from: a */
    final Function<? super T, ? extends Publisher<U>> f58252a;

    public FlowableDebounce(Flowable<T> flowable, Function<? super T, ? extends Publisher<U>> function) {
        super(flowable);
        this.f58252a = function;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new DebounceSubscriber(new SerializedSubscriber(subscriber), this.f58252a));
    }
