...
@Metadata(mo175977d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\r\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016J(\u0010\u0006\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\tH\u0016J(\u0010\f\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\r\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\tH\u0016¨\u0006\u000e"}, mo175978d2 = {"com/didi/soda/bill/component/editremark/EditRemarkView$init$4", "Landroid/text/TextWatcher;", "afterTextChanged", "", "s", "Landroid/text/Editable;", "beforeTextChanged", "", "start", "", "count", "after", "onTextChanged", "before", "customer-aar_brazilEmbedRelease"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
...
public final class EditRemarkView$init$4 implements TextWatcher {
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (editable.length() == 0) {
            ...
            CustomerEditTextCompat access$getContentEt$p = this.this$0.f38936a;
        ...
        CustomerEditTextCompat access$getContentEt$p2 = this.this$0.f38936a;
        if (access$getContentEt$p2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("contentEt");
            access$getContentEt$p2 = null;
        }
        if (access$getContentEt$p2.getTypeface() != null) {
            CustomerEditTextCompat access$getContentEt$p3 = this.this$0.f38936a;
            ...
            if (!Intrinsics.areEqual((Object) access$getContentEt$p3.getTypeface(), (Object) ((IToolsService) CustomerServiceManager.getService(IToolsService.class)).getFontTypeFace(IToolsService.FontType.MEDIUM))) {
                ...
                CustomerEditTextCompat access$getContentEt$p4 = this.this$0.f38936a;
