...
public abstract class ByteString implements Iterable<Byte> {
    ...
    /* renamed from: a */
    static final /* synthetic */ boolean f60746a = (!ByteString.class.desiredAssertionStatus());
    ...
    /* renamed from: b */
    public abstract void mo179137b(OutputStream outputStream, int i, int i2) throws IOException;
    ...
    public ByteString concat(ByteString byteString) {
        ...
        if (((long) size) + ((long) size2) < 2147483647L) {
            return RopeByteString.m44821a(this, byteString);
        }
    ...
    public static ByteString copyFrom(Iterable<ByteString> iterable) {
        ...
        return m44775a(collection.iterator(), collection.size());
    }

    /* renamed from: a */
    private static ByteString m44775a(Iterator<ByteString> it, int i) {
        if (!f60746a && i < 1) {
            ...
            int i2 = i >>> 1;
            return m44775a(it, i2).concat(m44775a(it, i - i2));
        }
    }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public void mo179136a(OutputStream outputStream, int i, int i2) throws IOException {
        if (i < 0) {
            StringBuilder sb = new StringBuilder(30);
            sb.append("Source offset < 0: ");
            sb.append(i);
