...
public final class TitleBarData {
    ...
    public static /* synthetic */ TitleBarData copy$default(TitleBarData titleBarData, String str, String str2, String str3, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            str = titleBarData.f31086a;
        }
        if ((i & 2) != 0) {
            str2 = titleBarData.f31087b;
        }
        if ((i & 4) != 0) {
            str3 = titleBarData.f31088c;
        }
        if ((i & 8) != 0) {
            z = titleBarData.f31089d;
        }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.f31086a, (Object) titleBarData.f31086a) && Intrinsics.areEqual((Object) this.f31087b, (Object) titleBarData.f31087b) && Intrinsics.areEqual((Object) this.f31088c, (Object) titleBarData.f31088c) && this.f31089d == titleBarData.f31089d;
    }

    public int hashCode() {
        int hashCode = ((((this.f31086a.hashCode() * 31) + this.f31087b.hashCode()) * 31) + this.f31088c.hashCode()) * 31;
        boolean z = this.f31089d;
        if (z) {
            z = true;
        }
    ...
    public String toString() {
        return "TitleBarData(topTitleTxt=" + this.f31086a + ", mainTitleTxt=" + this.f31087b + ", subTitleTxt=" + this.f31088c + ", isHideBack=" + this.f31089d + VersionRange.RIGHT_OPEN;
    }
