...
public final class DefaultExecutor extends EventLoopImplBase implements Runnable {
    ...
    /* renamed from: a */
    private static final long f61317a = 1000;

    /* renamed from: b */
    private static final long f61318b;

    /* renamed from: c */
    private static final int f61319c = 0;

    /* renamed from: d */
    private static final int f61320d = 1;
    private static volatile int debugStatus = 0;

    /* renamed from: e */
    private static final int f61321e = 2;

    /* renamed from: f */
    private static final int f61322f = 3;

    /* renamed from: a */
    private static /* synthetic */ void m45460a() {
    }
    ...
    static {
        ...
        f61318b = timeUnit.toNanos(l.longValue());
    }

    /* access modifiers changed from: protected */
    public Thread getThread() {
        Thread thread = _thread;
        return thread == null ? m45462c() : thread;
    }

    /* renamed from: b */
    private final boolean m45461b() {
        int i = debugStatus;
        return i == 2 || i == 3;
    }
    ...
    /* renamed from: c */
    private final synchronized Thread m45462c() {
        Thread thread;
        thread = _thread;
        if (thread == null) {
    ...
    /* renamed from: d */
    private final synchronized boolean m45463d() {
        if (m45461b()) {
            return false;
        }
        debugStatus = 1;
    ...
    /* renamed from: e */
    private final synchronized void m45464e() {
        if (m45461b()) {
            debugStatus = 3;
            resetAll();
            notifyAll();
