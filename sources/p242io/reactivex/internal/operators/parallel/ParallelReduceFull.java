...
public final class ParallelReduceFull<T> extends Flowable<T> {
    ...
    /* renamed from: a */
    final ParallelFlowable<? extends T> f59074a;

    /* renamed from: b */
    final BiFunction<T, T, T> f59075b;

    public ParallelReduceFull(ParallelFlowable<? extends T> parallelFlowable, BiFunction<T, T, T> biFunction) {
        this.f59074a = parallelFlowable;
        this.f59075b = biFunction;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ParallelReduceFullMainSubscriber parallelReduceFullMainSubscriber = new ParallelReduceFullMainSubscriber(subscriber, this.f59074a.parallelism(), this.f59075b);
        subscriber.onSubscribe(parallelReduceFullMainSubscriber);
        this.f59074a.subscribe(parallelReduceFullMainSubscriber.subscribers);
    }
