...
final class zzda {
    ...
    public static MessageDigest zzny;
    ...
    private static MessageDigest zzbq() {
        ...
        zzbp();
        try {
            z = zzob.await(2, TimeUnit.SECONDS);
    ...
    static String zzj(zzcf.zza zza, String str) throws GeneralSecurityException, UnsupportedEncodingException {
        ...
        if (((Boolean) zzww.zzra().zzd(zzabq.zzcta)).booleanValue()) {
            ...
            if (zza2 == null || zza2.size() == 0) {
                ...
                bArr = ((zzcf.zzf) ((zzena) zzbm.zzbjv())).toByteArray();
            }
        } else if (zzff.zzzu != null) {
            bArr = ((zzcf.zzf) ((zzena) zzcf.zzf.zzbm().zzi(zzelq.zzt(zzff.zzzu.zzc(byteArray, str != null ? str.getBytes() : new byte[0]))).zza(zzcm.TINK_HYBRID).zzbjv())).toByteArray();
        } else {
    ...
    private static byte[] zza(byte[] bArr, String str, boolean z) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        if (str != null && str.length() > 0) {
            ...
            new zzeld(str.getBytes("UTF-8")).zzs(bArr4);
        }
        return bArr4;
    }
