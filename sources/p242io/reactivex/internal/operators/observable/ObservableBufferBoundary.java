...
public final class ObservableBufferBoundary<T, U extends Collection<? super T>, Open, Close> extends C21211a<T, U> {

    /* renamed from: a */
    final Callable<U> f58723a;

    /* renamed from: b */
    final ObservableSource<? extends Open> f58724b;

    /* renamed from: c */
    final Function<? super Open, ? extends ObservableSource<? extends Close>> f58725c;

    public ObservableBufferBoundary(ObservableSource<T> observableSource, ObservableSource<? extends Open> observableSource2, Function<? super Open, ? extends ObservableSource<? extends Close>> function, Callable<U> callable) {
        super(observableSource);
        this.f58724b = observableSource2;
        this.f58725c = function;
        this.f58723a = callable;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super U> observer) {
        BufferBoundaryObserver bufferBoundaryObserver = new BufferBoundaryObserver(observer, this.f58724b, this.f58725c, this.f58723a);
    ...
    static final class BufferBoundaryObserver<T, C extends Collection<? super T>, Open, Close> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void close(p242io.reactivex.internal.operators.observable.ObservableBufferBoundary.BufferCloseObserver<T, C> r4, long r5) {
            /*
                r3 = this;
                ...
                p242io.reactivex.internal.disposables.DisposableHelper.dispose(r4)
                r4 = 1
                goto L_0x0016
            L_0x0015:
                r4 = 0
            ...
            L_0x0035:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableBufferBoundary.BufferBoundaryObserver.close(io.reactivex.internal.operators.observable.ObservableBufferBoundary$BufferCloseObserver, long):void");
        }
