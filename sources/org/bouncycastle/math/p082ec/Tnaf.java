...
class Tnaf {
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger subtract;
        BigInteger multiply = zTauElement.f6310u.multiply(zTauElement.f6310u);
        BigInteger multiply2 = zTauElement.f6310u.multiply(zTauElement.f6311v);
        BigInteger shiftLeft = zTauElement.f6311v.multiply(zTauElement.f6311v).shiftLeft(1);
        if (b == 1) {
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(add.multiply(round.f6310u)).subtract(BigInteger.valueOf(2).multiply(bigIntegerArr[1]).multiply(round.f6311v)), bigIntegerArr[1].multiply(round.f6310u).subtract(bigIntegerArr[0].multiply(round.f6311v)));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x006f, code lost:
        if (r7.compareTo(org.bouncycastle.math.p082ec.ECConstants.TWO) >= 0) goto L_0x0071;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0081, code lost:
        if (r5.compareTo(org.bouncycastle.math.p082ec.ECConstants.ONE) >= 0) goto L_0x008c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x008a, code lost:
        if (r7.compareTo(MINUS_TWO) < 0) goto L_0x008c;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static org.bouncycastle.math.p082ec.ZTauElement round(org.bouncycastle.math.p082ec.SimpleBigDecimal r7, org.bouncycastle.math.p082ec.SimpleBigDecimal r8, byte r9) {
        /*
            int r0 = r7.getScale()
            int r1 = r8.getScale()
        ...
        L_0x0019:
            ...
            org.bouncycastle.math.ec.SimpleBigDecimal r4 = r7.add((org.bouncycastle.math.p082ec.SimpleBigDecimal) r7)
            if (r9 != r1) goto L_0x0034
            org.bouncycastle.math.ec.SimpleBigDecimal r4 = r4.add((org.bouncycastle.math.p082ec.SimpleBigDecimal) r8)
            goto L_0x0038
        L_0x0034:
            org.bouncycastle.math.ec.SimpleBigDecimal r4 = r4.subtract((org.bouncycastle.math.p082ec.SimpleBigDecimal) r8)
        L_0x0038:
            org.bouncycastle.math.ec.SimpleBigDecimal r5 = r8.add((org.bouncycastle.math.p082ec.SimpleBigDecimal) r8)
            org.bouncycastle.math.ec.SimpleBigDecimal r5 = r5.add((org.bouncycastle.math.p082ec.SimpleBigDecimal) r8)
            org.bouncycastle.math.ec.SimpleBigDecimal r8 = r5.add((org.bouncycastle.math.p082ec.SimpleBigDecimal) r8)
            if (r9 != r1) goto L_0x004f
            org.bouncycastle.math.ec.SimpleBigDecimal r5 = r7.subtract((org.bouncycastle.math.p082ec.SimpleBigDecimal) r5)
            org.bouncycastle.math.ec.SimpleBigDecimal r7 = r7.add((org.bouncycastle.math.p082ec.SimpleBigDecimal) r8)
            goto L_0x0057
        L_0x004f:
            org.bouncycastle.math.ec.SimpleBigDecimal r5 = r7.add((org.bouncycastle.math.p082ec.SimpleBigDecimal) r5)
            org.bouncycastle.math.ec.SimpleBigDecimal r7 = r7.subtract((org.bouncycastle.math.p082ec.SimpleBigDecimal) r8)
        L_0x0057:
            java.math.BigInteger r8 = org.bouncycastle.math.p082ec.ECConstants.ONE
            ...
            goto L_0x0071
        L_0x0069:
            java.math.BigInteger r8 = org.bouncycastle.math.p082ec.ECConstants.TWO
        ...
        L_0x0073:
            ...
            java.math.BigInteger r7 = org.bouncycastle.math.p082ec.ECConstants.ONE
        ...
        L_0x00a7:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p082ec.Tnaf.round(org.bouncycastle.math.ec.SimpleBigDecimal, org.bouncycastle.math.ec.SimpleBigDecimal, byte):org.bouncycastle.math.ec.ZTauElement");
    }
    ...
    public static byte[] tauAdicNaf(byte b, ZTauElement zTauElement) {
        ...
        if (b == 1 || b == -1) {
            ...
            BigInteger bigInteger2 = zTauElement.f6310u;
            BigInteger bigInteger3 = zTauElement.f6311v;
            int i = 0;
            int i2 = 0;
            while (true) {
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        if (b == 1 || b == -1) {
            ...
            BigInteger shiftRight = bigInteger.shiftRight(1);
            BigInteger bigInteger3 = zTauElement.f6310u;
            BigInteger bigInteger4 = zTauElement.f6311v;
            int i = 0;
            while (true) {
                ...
                if (bigInteger3.testBit(0)) {
                    ...
                    if (z) {
                        bigInteger3 = bigInteger3.subtract(zTauElementArr[intValue].f6310u);
                        bigInteger4 = bigInteger4.subtract(zTauElementArr[intValue].f6311v);
                    } else {
                        bigInteger3 = bigInteger3.add(zTauElementArr[intValue].f6310u);
                        bigInteger4 = bigInteger4.add(zTauElementArr[intValue].f6311v);
                    }
                } else {
                    bArr[i] = 0;
                }
