...
public class JsonParser {
    ...
    private Object readObject() throws ParseException {
        consumeWhitespace();
        Scriptable newObject = this.f6651cx.newObject(this.scope);
        int i = this.pos;
    ...
    private Object readArray() throws ParseException {
        ...
        if (i >= this.length || this.src.charAt(i) != ']') {
                ...
                if (i2 < this.length) {
                    ...
                    if (charAt != ',') {
                        if (charAt != ']') {
                            ...
                            this.pos++;
                            return this.f6651cx.newArray(this.scope, arrayList.toArray());
                        } else {
            ...
            this.pos++;
            return this.f6651cx.newArray(this.scope, 0);
        }
    }
