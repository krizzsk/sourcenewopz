...
public final class ObservableSkipUntil<T, U> extends C21211a<T, T> {

    /* renamed from: a */
    final ObservableSource<U> f58948a;

    public ObservableSkipUntil(ObservableSource<T> observableSource, ObservableSource<U> observableSource2) {
        super(observableSource);
        this.f58948a = observableSource2;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f58948a.subscribe(new SkipUntil(arrayCompositeDisposable, skipUntilObserver, serializedObserver));
