...
public class DittoData {
    ...
    public DittoData parse(JSONObject jSONObject) {
        ...
        this.f49892id = jSONObject.optString("id");
    ...
    public String debugInfo() {
        return String.format("{id:%s,template:%s,hasCDN:%s}", new Object[]{this.f49892id, this.template, Boolean.valueOf(!TextUtils.isEmpty(this.cdn))});
    }
}
