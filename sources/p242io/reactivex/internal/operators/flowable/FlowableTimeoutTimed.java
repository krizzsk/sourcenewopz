...
public final class FlowableTimeoutTimed<T> extends C21208a<T, T> {

    /* renamed from: a */
    final long f58495a;

    /* renamed from: b */
    final TimeUnit f58496b;

    /* renamed from: c */
    final Scheduler f58497c;

    /* renamed from: d */
    final Publisher<? extends T> f58498d;
    ...
    public FlowableTimeoutTimed(Flowable<T> flowable, long j, TimeUnit timeUnit, Scheduler scheduler, Publisher<? extends T> publisher) {
        super(flowable);
        this.f58495a = j;
        this.f58496b = timeUnit;
        this.f58497c = scheduler;
        this.f58498d = publisher;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        if (this.f58498d == null) {
            TimeoutSubscriber timeoutSubscriber = new TimeoutSubscriber(subscriber, this.f58495a, this.f58496b, this.f58497c.createWorker());
            subscriber.onSubscribe(timeoutSubscriber);
            timeoutSubscriber.startTimeout(0);
            this.source.subscribe(timeoutSubscriber);
            return;
        }
        TimeoutFallbackSubscriber timeoutFallbackSubscriber = new TimeoutFallbackSubscriber(subscriber, this.f58495a, this.f58496b, this.f58497c.createWorker(), this.f58498d);
