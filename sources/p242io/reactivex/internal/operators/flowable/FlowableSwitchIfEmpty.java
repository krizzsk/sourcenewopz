...
public final class FlowableSwitchIfEmpty<T> extends C21208a<T, T> {

    /* renamed from: a */
    final Publisher<? extends T> f58466a;

    public FlowableSwitchIfEmpty(Flowable<T> flowable, Publisher<? extends T> publisher) {
        super(flowable);
        this.f58466a = publisher;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        SwitchIfEmptySubscriber switchIfEmptySubscriber = new SwitchIfEmptySubscriber(subscriber, this.f58466a);
