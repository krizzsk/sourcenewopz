...
public final class AbstractChannelKt {
    ...
    /* renamed from: a */
    private static final <E> Object m45535a(Object obj) {
        return obj instanceof Closed ? ChannelResult.Companion.m48267closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m48269successJP2dKIU(obj);
    }

    /* renamed from: a */
    private static final <E> Object m45536a(Closed<?> closed) {
        return ChannelResult.Companion.m48267closedJP2dKIU(closed.closeCause);
    }
}
