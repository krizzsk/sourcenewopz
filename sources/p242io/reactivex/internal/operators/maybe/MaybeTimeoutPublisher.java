...
public final class MaybeTimeoutPublisher<T, U> extends C21209a<T, T> {

    /* renamed from: a */
    final Publisher<U> f58629a;

    /* renamed from: b */
    final MaybeSource<? extends T> f58630b;

    public MaybeTimeoutPublisher(MaybeSource<T> maybeSource, Publisher<U> publisher, MaybeSource<? extends T> maybeSource2) {
        super(maybeSource);
        this.f58629a = publisher;
        this.f58630b = maybeSource2;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        TimeoutMainMaybeObserver timeoutMainMaybeObserver = new TimeoutMainMaybeObserver(maybeObserver, this.f58630b);
        maybeObserver.onSubscribe(timeoutMainMaybeObserver);
        this.f58629a.subscribe(timeoutMainMaybeObserver.other);
