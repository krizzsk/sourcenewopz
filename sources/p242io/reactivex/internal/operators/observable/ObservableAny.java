...
public final class ObservableAny<T> extends C21211a<T, Boolean> {

    /* renamed from: a */
    final Predicate<? super T> f58713a;

    public ObservableAny(ObservableSource<T> observableSource, Predicate<? super T> predicate) {
        super(observableSource);
        this.f58713a = predicate;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super Boolean> observer) {
        this.source.subscribe(new AnyObserver(observer, this.f58713a));
    }
