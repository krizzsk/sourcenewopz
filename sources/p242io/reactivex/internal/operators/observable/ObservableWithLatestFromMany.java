...
public final class ObservableWithLatestFromMany<T, R> extends C21211a<T, R> {

    /* renamed from: a */
    final ObservableSource<?>[] f59017a;

    /* renamed from: b */
    final Iterable<? extends ObservableSource<?>> f59018b;

    /* renamed from: c */
    final Function<? super Object[], R> f59019c;
    ...
    public ObservableWithLatestFromMany(ObservableSource<T> observableSource, ObservableSource<?>[] observableSourceArr, Function<? super Object[], R> function) {
        ...
        this.f59017a = observableSourceArr;
        this.f59018b = null;
        this.f59019c = function;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        int i;
        ObservableSource<?>[] observableSourceArr = this.f59017a;
        if (observableSourceArr == null) {
            observableSourceArr = new ObservableSource[8];
            try {
                i = 0;
                for (ObservableSource<?> observableSource : this.f59018b) {
        ...
        WithLatestFromObserver withLatestFromObserver = new WithLatestFromObserver(observer, this.f59019c, i);
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            return ObjectHelper.requireNonNull(ObservableWithLatestFromMany.this.f59019c.apply(new Object[]{t}), "The combiner returned a null value");
        }
    }
}
