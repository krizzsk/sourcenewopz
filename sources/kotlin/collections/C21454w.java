...
class C21454w extends C21453v {
    ...
    /* renamed from: a */
    private static final <K, V> Map<K, V> m43830a() {
        return MapsKt.emptyMap();
    }

    /* renamed from: b */
    private static final <K, V> Map<K, V> m43844b() {
    ...
    /* renamed from: c */
    private static final <K, V> HashMap<K, V> m43848c() {
        return new HashMap<>();
    }
    ...
    /* renamed from: d */
    private static final <K, V> LinkedHashMap<K, V> m43853d() {
        return new LinkedHashMap<>();
    }
    ...
    /* renamed from: a */
    private static final <K, V> Map<K, V> m43832a(Function1<? super Map<K, V>, Unit> function1) {
    ...
    /* renamed from: a */
    private static final <K, V> Map<K, V> m43831a(int i, Function1<? super Map<K, V>, Unit> function1) {
    ...
    /* renamed from: a */
    private static final <K, V> boolean m43840a(Map<? extends K, ? extends V> map) {
        return !map.isEmpty();
    }

    /* renamed from: b */
    private static final <K, V> boolean m43847b(Map<? extends K, ? extends V> map) {
        return map == null || map.isEmpty();
    }

    /* renamed from: c */
    private static final <K, V> Map<K, V> m43849c(Map<K, ? extends V> map) {
    ...
    private static final <M extends java.util.Map<?, ?> & R, R> R m43829a(M r1, kotlin.jvm.functions.Function0<? extends R> r2) {
        /*
        ...
        L_0x000a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.collections.C21454w.m43829a(java.util.Map, kotlin.jvm.functions.Function0):java.lang.Object");
    }

    /* renamed from: a */
    private static final <K, V> boolean m43841a(Map<? extends K, ? extends V> map, K k) {
        Intrinsics.checkNotNullParameter(map, "$this$contains");
        return map.containsKey(k);
    }

    /* renamed from: b */
    private static final <K, V> V m43843b(Map<? extends K, ? extends V> map, K k) {
        Intrinsics.checkNotNullParameter(map, "$this$get");
        return map.get(k);
    }

    /* renamed from: a */
    private static final <K, V> void m43834a(Map<K, V> map, K k, V v) {
        Intrinsics.checkNotNullParameter(map, "$this$set");
        map.put(k, v);
    }

    /* renamed from: c */
    private static final <K> boolean m43851c(Map<? extends K, ?> map, K k) {
        if (map != null) {
            return map.containsKey(k);
        }
    ...
    /* renamed from: d */
    private static final <K, V> boolean m43854d(Map<K, ? extends V> map, V v) {
        return map.containsValue(v);
    }

    /* renamed from: e */
    private static final <K, V> V m43855e(Map<? extends K, V> map, K k) {
        if (map != null) {
    ...
    /* renamed from: a */
    private static final <K, V> K m43827a(Map.Entry<? extends K, ? extends V> entry) {
        Intrinsics.checkNotNullParameter(entry, "$this$component1");
        return entry.getKey();
    }

    /* renamed from: b */
    private static final <K, V> V m43842b(Map.Entry<? extends K, ? extends V> entry) {
        Intrinsics.checkNotNullParameter(entry, "$this$component2");
        return entry.getValue();
    }

    /* renamed from: c */
    private static final <K, V> Pair<K, V> m43850c(Map.Entry<? extends K, ? extends V> entry) {
        return new Pair<>(entry.getKey(), entry.getValue());
    }

    /* renamed from: a */
    private static final <K, V> V m43828a(Map<K, ? extends V> map, K k, Function0<? extends V> function0) {
        V v = map.get(k);
    ...
    /* renamed from: d */
    private static final <K, V> Iterator<Map.Entry<K, V>> m43852d(Map<? extends K, ? extends V> map) {
        Intrinsics.checkNotNullParameter(map, "$this$iterator");
        return map.entrySet().iterator();
    }

    /* renamed from: e */
    private static final <K, V> Iterator<Map.Entry<K, V>> m43856e(Map<K, V> map) {
        Intrinsics.checkNotNullParameter(map, "$this$iterator");
        return map.entrySet().iterator();
    }
    ...
    /* renamed from: a */
    private static final <K, V> void m43836a(Map<? super K, ? super V> map, Pair<? extends K, ? extends V> pair) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        map.put(pair.getFirst(), pair.getSecond());
    }

    /* renamed from: a */
    private static final <K, V> void m43833a(Map<? super K, ? super V> map, Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        MapsKt.putAll(map, iterable);
    }

    /* renamed from: a */
    private static final <K, V> void m43839a(Map<? super K, ? super V> map, Pair<? extends K, ? extends V>[] pairArr) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        MapsKt.putAll(map, pairArr);
    }

    /* renamed from: a */
    private static final <K, V> void m43837a(Map<? super K, ? super V> map, Sequence<? extends Pair<? extends K, ? extends V>> sequence) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        MapsKt.putAll(map, sequence);
    }

    /* renamed from: a */
    private static final <K, V> void m43835a(Map<? super K, ? super V> map, Map<K, ? extends V> map2) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        map.putAll(map2);
    }
    ...
    /* renamed from: f */
    private static final <K, V> void m43857f(Map<K, V> map, K k) {
        Intrinsics.checkNotNullParameter(map, "$this$minusAssign");
        map.remove(k);
    }

    /* renamed from: b */
    private static final <K, V> void m43845b(Map<K, V> map, Iterable<? extends K> iterable) {
        Intrinsics.checkNotNullParameter(map, "$this$minusAssign");
        CollectionsKt.removeAll(map.keySet(), iterable);
    }

    /* renamed from: a */
    private static final <K, V> void m43838a(Map<K, V> map, K[] kArr) {
        Intrinsics.checkNotNullParameter(map, "$this$minusAssign");
        CollectionsKt.removeAll(map.keySet(), (T[]) kArr);
    }

    /* renamed from: b */
    private static final <K, V> void m43846b(Map<K, V> map, Sequence<? extends K> sequence) {
        Intrinsics.checkNotNullParameter(map, "$this$minusAssign");
