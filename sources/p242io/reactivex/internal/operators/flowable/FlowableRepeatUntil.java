...
public final class FlowableRepeatUntil<T> extends C21208a<T, T> {

    /* renamed from: a */
    final BooleanSupplier f58412a;

    public FlowableRepeatUntil(Flowable<T> flowable, BooleanSupplier booleanSupplier) {
        super(flowable);
        this.f58412a = booleanSupplier;
    }

    public void subscribeActual(Subscriber<? super T> subscriber) {
        SubscriptionArbiter subscriptionArbiter = new SubscriptionArbiter(false);
        subscriber.onSubscribe(subscriptionArbiter);
        new RepeatSubscriber(subscriber, this.f58412a, subscriptionArbiter, this.source).subscribeNext();
    }
    ...
    static final class RepeatSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        /* renamed from: sa */
        final SubscriptionArbiter f58413sa;
        ...
        RepeatSubscriber(Subscriber<? super T> subscriber, BooleanSupplier booleanSupplier, SubscriptionArbiter subscriptionArbiter, Publisher<? extends T> publisher) {
            ...
            this.f58413sa = subscriptionArbiter;
            this.source = publisher;
            this.stop = booleanSupplier;
        }

        public void onSubscribe(Subscription subscription) {
            this.f58413sa.setSubscription(subscription);
        }
        ...
        public void subscribeNext() {
            if (getAndIncrement() == 0) {
                int i = 1;
                while (!this.f58413sa.isCancelled()) {
                    long j = this.produced;
                    if (j != 0) {
                        this.produced = 0;
                        this.f58413sa.produced(j);
                    }
