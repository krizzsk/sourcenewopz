...
final class SigUtil {
    ...
    public static void validateEcdsaParams(EcdsaParams ecdsaParams) throws GeneralSecurityException {
        ...
        int i = C193881.$SwitchMap$com$google$crypto$tink$proto$EcdsaSignatureEncoding[encoding.ordinal()];
        if (i == 1 || i == 2) {
            int i2 = C193881.$SwitchMap$com$google$crypto$tink$proto$EllipticCurveType[curve.ordinal()];
            if (i2 != 1) {
                if (i2 != 2) {
                    if (i2 != 3) {
    ...
    static /* synthetic */ class C193881 {
        ...
        static {
            ...
            L_0x0068:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.signature.SigUtil.C193881.<clinit>():void");
        }
    }

    public static Enums.HashType toHashType(HashType hashType) throws GeneralSecurityException {
        int i = C193881.$SwitchMap$com$google$crypto$tink$proto$HashType[hashType.ordinal()];
        if (i == 1) {
    ...
    public static EllipticCurves.CurveType toCurveType(EllipticCurveType ellipticCurveType) throws GeneralSecurityException {
        int i = C193881.$SwitchMap$com$google$crypto$tink$proto$EllipticCurveType[ellipticCurveType.ordinal()];
        if (i == 1) {
    ...
    public static EllipticCurves.EcdsaEncoding toEcdsaEncoding(EcdsaSignatureEncoding ecdsaSignatureEncoding) throws GeneralSecurityException {
        int i = C193881.$SwitchMap$com$google$crypto$tink$proto$EcdsaSignatureEncoding[ecdsaSignatureEncoding.ordinal()];
        if (i == 1) {
