...
@Metadata(mo175977d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00010\u0002H@"}, mo175978d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;"}, mo175979k = 3, mo175980mv = {1, 5, 1}, mo175982xi = 48)
@DebugMetadata(mo176686c = "kotlinx.coroutines.channels.TickerChannelsKt$ticker$3", mo176687f = "TickerChannels.kt", mo176688i = {}, mo176689l = {72, 73}, mo176690m = "invokeSuspend", mo176691n = {}, mo176692s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (i2 == 1) {
                ...
                this.label = 1;
                if (TickerChannelsKt.m45558a(j, j2, channel, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else if (i2 == 2) {
                this.label = 2;
                if (TickerChannelsKt.m45559b(this.$delayMillis, this.$initialDelayMillis, producerScope.getChannel(), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else if (i == 1 || i == 2) {
