...
public class CenterCropStrategy extends PreviewScalingStrategy {
    ...
    /* renamed from: a */
    private static final String f45382a = "CenterCropStrategy";
    ...
    public Rect scalePreview(Size size, Size size2) {
        Size scaleCrop = size.scaleCrop(size2);
        SystemUtils.log(4, f45382a, "Preview: " + size + "; Scaled: " + scaleCrop + "; Want: " + size2, (Throwable) null, "com.didi.zxing.barcodescanner.camera.CenterCropStrategy", 72);
