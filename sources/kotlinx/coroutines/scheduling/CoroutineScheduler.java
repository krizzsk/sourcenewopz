...
public final class CoroutineScheduler implements Closeable, Executor {
    ...
    /* renamed from: a */
    static final /* synthetic */ AtomicLongFieldUpdater f61571a;

    /* renamed from: b */
    private static final /* synthetic */ AtomicLongFieldUpdater f61572b;

    /* renamed from: c */
    private static final /* synthetic */ AtomicIntegerFieldUpdater f61573c;

    /* renamed from: d */
    private static final int f61574d = -1;

    /* renamed from: e */
    private static final int f61575e = 0;

    /* renamed from: f */
    private static final int f61576f = 1;

    /* renamed from: g */
    private static final int f61577g = 21;

    /* renamed from: h */
    private static final long f61578h = 2097151;

    /* renamed from: i */
    private static final long f61579i = 4398044413952L;

    /* renamed from: j */
    private static final int f61580j = 42;

    /* renamed from: k */
    private static final long f61581k = 9223367638808264704L;

    /* renamed from: l */
    private static final long f61582l = 2097151;

    /* renamed from: m */
    private static final long f61583m = -2097152;

    /* renamed from: n */
    private static final long f61584n = 2097152;
    ...
    @Metadata(mo175977d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0007\b\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, mo175978d2 = {"Lkotlinx/coroutines/scheduling/CoroutineScheduler$WorkerState;", "", "(Ljava/lang/String;I)V", "CPU_ACQUIRED", "BLOCKING", "PARKING", "DORMANT", "TERMINATED", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: CoroutineScheduler.kt */
    ...
    /* renamed from: a */
    private final int m46040a(long j) {
        return (int) (j & 2097151);
    }

    /* renamed from: b */
    private final int m46048b(long j) {
        return (int) ((j & f61579i) >> 21);
    }

    public final int availableCpuPermits(long j) {
        return (int) ((j & f61581k) >> 42);
    }
    ...
    public final boolean parkedWorkersStackPush(Worker worker) {
        ...
        } while (!f61572b.compareAndSet(this, j, ((long) indexInArray) | j2));
        return true;
    }

    /* renamed from: a */
    private final int m46041a(Worker worker) {
    ...
    /* renamed from: b */
    private final int m46047b() {
        return (int) (this.controlState & 2097151);
    }

    /* renamed from: c */
    private final int m46049c() {
        return (int) ((this.controlState & f61581k) >> 42);
    }

    /* renamed from: d */
    private final int m46051d() {
        return (int) (f61571a.incrementAndGet(this) & 2097151);
    }

    /* renamed from: e */
    private final int m46052e() {
        return (int) (f61571a.getAndDecrement(this) & 2097151);
    }

    /* renamed from: f */
    private final long m46053f() {
        return f61571a.addAndGet(this, 2097152);
    }

    /* renamed from: g */
    private final void m46054g() {
        f61571a.addAndGet(this, f61583m);
    }

    /* renamed from: i */
    private final long m46056i() {
        return f61571a.addAndGet(this, 4398046511104L);
    }
    ...
    @Metadata(mo175977d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u00020\u000e8\u0006X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0010\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0012\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000¨\u0006\u0014"}, mo175978d2 = {"Lkotlinx/coroutines/scheduling/CoroutineScheduler$Companion;", "", "()V", "BLOCKING_MASK", "", "BLOCKING_SHIFT", "", "CLAIMED", "CPU_PERMITS_MASK", "CPU_PERMITS_SHIFT", "CREATED_MASK", "MAX_SUPPORTED_POOL_SIZE", "MIN_SUPPORTED_POOL_SIZE", "NOT_IN_STACK", "Lkotlinx/coroutines/internal/Symbol;", "PARKED", "PARKED_INDEX_MASK", "PARKED_VERSION_INC", "PARKED_VERSION_MASK", "TERMINATED", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: CoroutineScheduler.kt */
    ...
    static {
        ...
        f61572b = AtomicLongFieldUpdater.newUpdater(cls, "parkedWorkersStack");
        f61571a = AtomicLongFieldUpdater.newUpdater(cls, "controlState");
        f61573c = AtomicIntegerFieldUpdater.newUpdater(cls, "_isTerminated");
    }
    ...
    public final void shutdown(long j) {
        ...
        Task task;
        boolean z = false;
        if (f61573c.compareAndSet(this, 0, 1)) {
            Worker l = m46059l();
            ...
            if (DebugKt.getASSERTIONS_ENABLED()) {
                if (((int) ((this.controlState & f61581k) >> 42)) == this.corePoolSize) {
                    z = true;
                }
                if (!z) {
                    throw new AssertionError();
    ...
    public final void signalCpuWork() {
        if (!m46057j() && !m46045a(this, 0, 1, (Object) null)) {
            m46057j();
        }
    }

    /* renamed from: a */
    static /* synthetic */ boolean m46045a(CoroutineScheduler coroutineScheduler, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = coroutineScheduler.controlState;
        }
        return coroutineScheduler.m46050c(j);
    }

    /* renamed from: c */
    private final boolean m46050c(long j) {
        if (RangesKt.coerceAtLeast(((int) (2097151 & j)) - ((int) ((j & f61579i) >> 21)), 0) < this.corePoolSize) {
            int k = m46058k();
    ...
    private final int m46058k() {
        synchronized (this.workers) {
            ...
            int i = (int) (j & 2097151);
            boolean z = false;
            int coerceAtLeast = RangesKt.coerceAtLeast(i - ((int) ((j & f61579i) >> 21)), 0);
            ...
            if (i2 > 0 && this.workers.get(i2) == null) {
                ...
                if (i2 == ((int) (2097151 & f61571a.incrementAndGet(this)))) {
                    z = true;
                }
                if (z) {
                    worker.start();
    ...
    /* renamed from: a */
    private final Task m46043a(Worker worker, Task task, boolean z) {
    ...
    public final class Worker extends Thread {
        ...
        private final boolean tryAcquireCpuPermit() {
            ...
            if (this.state != WorkerState.CPU_ACQUIRED) {
                ...
                while (true) {
                    ...
                    if (((int) ((CoroutineScheduler.f61581k & j) >> 42)) != 0) {
                        if (CoroutineScheduler.f61571a.compareAndSet(coroutineScheduler, j, j - 4398046511104L)) {
                            z = true;
                            break;
                        }
                    } else {
        ...
        public final boolean tryReleaseCpu(WorkerState workerState) {
            ...
            if (z) {
                CoroutineScheduler.f61571a.addAndGet(CoroutineScheduler.this, 4398046511104L);
            }
        ...
        private final void afterTask(int i) {
            if (i != 0) {
                CoroutineScheduler.f61571a.addAndGet(CoroutineScheduler.this, CoroutineScheduler.f61583m);
                ...
                if (!coroutineScheduler.isTerminated()) {
                    if (((int) (coroutineScheduler.controlState & 2097151)) > coroutineScheduler.corePoolSize) {
                        if (workerCtl$FU.compareAndSet(this, -1, 1)) {
                            ...
                            int andDecrement = (int) (CoroutineScheduler.f61571a.getAndDecrement(coroutineScheduler) & 2097151);
    ...
    /* renamed from: a */
    private final boolean m46046a(Task task) {
        boolean z = true;
    ...
    public final void parkedWorkersStackTopUpdate(Worker worker, int i, int i2) {
        while (true) {
            ...
            long j2 = (2097152 + j) & f61583m;
            if (i3 == i) {
                i3 = i2 == 0 ? m46041a(worker) : i2;
            }
            if (i3 >= 0) {
                if (f61572b.compareAndSet(this, j, j2 | ((long) i3))) {
                    return;
                }
            }
        }
    ...
    private final Worker m46042a() {
        while (true) {
            ...
            long j2 = (2097152 + j) & f61583m;
            int a = m46041a(worker);
            if (a >= 0) {
                if (f61572b.compareAndSet(this, j, ((long) a) | j2)) {
    ...
    /* renamed from: h */
    private final boolean m46055h() {
        long j;
        do {
            j = this.controlState;
            if (((int) ((f61581k & j) >> 42)) == 0) {
                return false;
            }
        } while (!f61571a.compareAndSet(this, j, j - 4398046511104L));
        return true;
    }

    /* renamed from: a */
    private final void m46044a(boolean z) {
        long addAndGet = f61571a.addAndGet(this, 2097152);
        if (!z && !m46057j() && !m46050c(addAndGet)) {
            m46057j();
        }
    }
}
