...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    final Observable<T> f58697a;

    /* renamed from: b */
    final Function<? super T, ? extends SingleSource<? extends R>> f58698b;

    /* renamed from: c */
    final boolean f58699c;
    ...
    public ObservableSwitchMapSingle(Observable<T> observable, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z) {
        this.f58697a = observable;
        this.f58698b = function;
        this.f58699c = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        if (!C21210a.m41821b(this.f58697a, this.f58698b, observer)) {
            this.f58697a.subscribe(new SwitchMapSingleMainObserver(observer, this.f58698b, this.f58699c));
        }
    }
