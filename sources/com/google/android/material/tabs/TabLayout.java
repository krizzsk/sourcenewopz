...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C10448R.styleable.TabLayout, i, DEF_STYLE_RES, 23);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(23, 2132017898);
        this.tabTextAppearance = resourceId;
        TypedArray obtainStyledAttributes2 = context2.obtainStyledAttributes(resourceId, C10448R.styleable.TextAppearance);
        try {
    ...
    public Tab newTab() {
        ...
        if (createTabFromPool.f52610id != -1) {
            createTabFromPool.view.setId(createTabFromPool.f52610id);
        }
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        private void updateOrRecreateIndicatorAnimation(boolean z, final int i, int i2) {
            ...
            C181511 r2 = new ValueAnimator.AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
