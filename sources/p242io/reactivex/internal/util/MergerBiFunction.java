...
public final class MergerBiFunction<T> implements BiFunction<List<T>, List<T>, List<T>> {
    ...
    /* renamed from: a */
    final Comparator<? super T> f59291a;

    public MergerBiFunction(Comparator<? super T> comparator) {
        this.f59291a = comparator;
    }
    ...
    public java.util.List<T> apply(java.util.List<T> r6, java.util.List<T> r7) throws java.lang.Exception {
        ...
        L_0x0037:
            ...
            java.util.Comparator<? super T> r4 = r5.f59291a
        ...
        L_0x0085:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.util.MergerBiFunction.apply(java.util.List, java.util.List):java.util.List");
    }
}
