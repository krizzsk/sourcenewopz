...
public final class NewCapturedTypeKt {
    public static final SimpleType captureFromArguments(SimpleType simpleType, CaptureStatus captureStatus) {
        ...
        List<TypeProjection> a = m45072a(unwrappedType, captureStatus);
        if (a == null) {
            return null;
        }
        return m45073a(unwrappedType, (List<? extends TypeProjection>) a);
    }

    /* renamed from: a */
    private static final SimpleType m45073a(UnwrappedType unwrappedType, List<? extends TypeProjection> list) {
    ...
    /* renamed from: a */
    private static final List<TypeProjection> m45072a(UnwrappedType unwrappedType, CaptureStatus captureStatus) {
