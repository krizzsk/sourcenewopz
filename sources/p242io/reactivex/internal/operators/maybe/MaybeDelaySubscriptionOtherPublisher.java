...
public final class MaybeDelaySubscriptionOtherPublisher<T, U> extends C21209a<T, T> {

    /* renamed from: a */
    final Publisher<U> f58563a;

    public MaybeDelaySubscriptionOtherPublisher(MaybeSource<T> maybeSource, Publisher<U> publisher) {
        super(maybeSource);
        this.f58563a = publisher;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.f58563a.subscribe(new OtherSubscriber(maybeObserver, this.source));
    }
