...
class C21512e extends C21511d {
    ...
    /* renamed from: a */
    private static final int m44401a(IntRange intRange) {
        return RangesKt.random(intRange, (Random) Random.Default);
    }

    /* renamed from: a */
    private static final long m44402a(LongRange longRange) {
        return RangesKt.random(longRange, (Random) Random.Default);
    }

    /* renamed from: a */
    private static final char m44400a(CharRange charRange) {
    ...
    /* renamed from: b */
    private static final Integer m44407b(IntRange intRange) {
        return RangesKt.randomOrNull(intRange, (Random) Random.Default);
    }

    /* renamed from: b */
    private static final Long m44408b(LongRange longRange) {
        return RangesKt.randomOrNull(longRange, (Random) Random.Default);
    }

    /* renamed from: b */
    private static final Character m44406b(CharRange charRange) {
