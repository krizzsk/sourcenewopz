...
public final class BlockingFlowableIterable<T> implements Iterable<T> {
    ...
    /* renamed from: a */
    final Flowable<T> f58168a;

    /* renamed from: b */
    final int f58169b;

    public BlockingFlowableIterable(Flowable<T> flowable, int i) {
        this.f58168a = flowable;
        this.f58169b = i;
    }

    public Iterator<T> iterator() {
        BlockingFlowableIterator blockingFlowableIterator = new BlockingFlowableIterator(this.f58169b);
        this.f58168a.subscribe(blockingFlowableIterator);
