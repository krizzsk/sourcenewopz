...
public final class ObservableConcatMap<T, U> extends C21211a<T, U> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<? extends U>> f58763a;

    /* renamed from: b */
    final int f58764b;

    /* renamed from: c */
    final ErrorMode f58765c;

    public ObservableConcatMap(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<? extends U>> function, int i, ErrorMode errorMode) {
        super(observableSource);
        this.f58763a = function;
        this.f58765c = errorMode;
        this.f58764b = Math.max(8, i);
    }

    public void subscribeActual(Observer<? super U> observer) {
        if (!ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f58763a)) {
            if (this.f58765c == ErrorMode.IMMEDIATE) {
                this.source.subscribe(new SourceObserver(new SerializedObserver(observer), this.f58763a, this.f58764b));
            } else {
                this.source.subscribe(new ConcatMapDelayErrorObserver(observer, this.f58763a, this.f58764b, this.f58765c == ErrorMode.END));
            }
        }
    }
