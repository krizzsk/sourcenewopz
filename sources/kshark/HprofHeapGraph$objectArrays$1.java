...
@Metadata(mo175976bv = {1, 0, 3}, mo175977d1 = {"\u0000\u0016\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0012\u0010\u0002\u001a\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00050\u0003H\n¢\u0006\u0002\b\u0006"}, mo175978d2 = {"<anonymous>", "Lkshark/HeapObject$HeapObjectArray;", "it", "Lkotlin/Pair;", "", "Lkshark/internal/IndexedObject$IndexedObjectArray;", "invoke"}, mo175979k = 3, mo175980mv = {1, 1, 15})
...
final class HprofHeapGraph$objectArrays$1 extends Lambda implements Function1<Pair<? extends Long, ? extends IndexedObject.IndexedObjectArray>, HeapObject.HeapObjectArray> {
    ...
    public final HeapObject.HeapObjectArray invoke(Pair<Long, IndexedObject.IndexedObjectArray> pair) {
        ...
        return new HeapObject.HeapObjectArray(this.this$0, second, longValue, this.this$0.f4552e.getPrimitiveWrapperTypes().contains(Long.valueOf(second.getArrayClassId())));
    }
}
