...
public final class ObservableBufferBoundarySupplier<T, U extends Collection<? super T>, B> extends C21211a<T, U> {

    /* renamed from: a */
    final Callable<? extends ObservableSource<B>> f58726a;

    /* renamed from: b */
    final Callable<U> f58727b;
    ...
    public ObservableBufferBoundarySupplier(ObservableSource<T> observableSource, Callable<? extends ObservableSource<B>> callable, Callable<U> callable2) {
        ...
        this.f58726a = callable;
        this.f58727b = callable2;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super U> observer) {
        this.source.subscribe(new BufferBoundarySupplierObserver(new SerializedObserver(observer), this.f58727b, this.f58726a));
    }
    ...
    static final class BufferBoundarySupplierObserver<T, U extends Collection<? super T>, B> extends QueueDrainObserver<T, U, U> implements Observer<T>, Disposable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x0019, code lost:
            p242io.reactivex.internal.util.QueueDrainHelper.drainLoop(r3.queue, r3.downstream, false, r3, r3);
         */
        ...
        public void onComplete() {
            ...
            L_0x0007:
                ...
                r2 = 0
                p242io.reactivex.internal.util.QueueDrainHelper.drainLoop(r0, r1, r2, r3, r3)
            L_0x0021:
                return
            L_0x0022:
                r0 = move-exception
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableBufferBoundarySupplier.BufferBoundarySupplierObserver.onComplete():void");
        }
