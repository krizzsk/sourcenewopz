...
public final class zzbrn implements zzesa<zzbzl<zzve>> {
    ...
    private zzbrn(zzesn<zzclp> zzesn, zzesn<Executor> zzesn2, zzesn<zzcqv> zzesn3) {
        this.zzgab = zzesn;
        this.zzeyl = zzesn2;
        this.zzgac = zzesn3;
    }

    public static zzbrn zzk(zzesn<zzclp> zzesn, zzesn<Executor> zzesn2, zzesn<zzcqv> zzesn3) {
        return new zzbrn(zzesn, zzesn2, zzesn3);
    }
