...
public final class DriverOrderMoneyGetReqV2 extends Message {
    ...
    private DriverOrderMoneyGetReqV2(Builder builder) {
        this(builder.phone, builder.token, builder.order_type, builder.f43983id, builder.info, builder.plutus_data);
        setBuilder(builder);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!equals((Object) this.phone, (Object) driverOrderMoneyGetReqV2.phone) || !equals((Object) this.token, (Object) driverOrderMoneyGetReqV2.token) || !equals((Object) this.order_type, (Object) driverOrderMoneyGetReqV2.order_type) || !equals((Object) this.f43982id, (Object) driverOrderMoneyGetReqV2.f43982id) || !equals((List<?>) this.info, (List<?>) driverOrderMoneyGetReqV2.info) || !equals((Object) this.plutus_data, (Object) driverOrderMoneyGetReqV2.plutus_data)) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder extends Message.Builder<DriverOrderMoneyGetReqV2> {
        ...
        public Builder(DriverOrderMoneyGetReqV2 driverOrderMoneyGetReqV2) {
            ...
            if (driverOrderMoneyGetReqV2 != null) {
                ...
                this.f43983id = driverOrderMoneyGetReqV2.f43982id;
        ...
        /* renamed from: id */
        public Builder mo109463id(String str) {
            this.f43983id = str;
            return this;
        }
