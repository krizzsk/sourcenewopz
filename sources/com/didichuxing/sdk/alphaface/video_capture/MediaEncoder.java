...
public abstract class MediaEncoder implements Runnable {
    ...
    /* renamed from: a */
    private static final boolean f48819a = true;

    /* renamed from: b */
    private static final String f48820b = "MediaEncoder";

    /* renamed from: c */
    private int f48821c;

    /* renamed from: d */
    private MediaCodec.BufferInfo f48822d;

    /* renamed from: e */
    private long f48823e = 0;
    ...
    public MediaEncoder(com.didichuxing.sdk.alphaface.video_capture.MediaMuxerWrapper r3, com.didichuxing.sdk.alphaface.video_capture.MediaEncoder.MediaEncoderListener r4) {
        /*
            ...
            r0.<init>(r3)
            r2.mWeakMuxer = r0
            r3.mo120692a((com.didichuxing.sdk.alphaface.video_capture.MediaEncoder) r2)
            r2.mListener = r4
            ...
            r2.f48822d = r4     // Catch:{ all -> 0x003f }
    ...
    public void run() {
        /*
            ...
            r10.f48821c = r1     // Catch:{ all -> 0x0081 }
        ...
        L_0x000e:
            ...
            int r4 = r10.f48821c     // Catch:{ all -> 0x0048 }
        ...
        L_0x001b:
            ...
            int r5 = r10.f48821c     // Catch:{ all -> 0x0048 }
            int r5 = r5 - r0
            r10.f48821c = r5     // Catch:{ all -> 0x0048 }
        L_0x0022:
    ...
    public void startRecording() {
        SystemUtils.log(2, f48820b, "startRecording", (Throwable) null, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 172);
        synchronized (this.mSync) {
    ...
    public void mo120682b() {
        ...
        L_0x0025:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.sdk.alphaface.video_capture.MediaEncoder.mo120682b():void");
    }

    /* access modifiers changed from: protected */
    public void release() {
        SystemUtils.log(3, f48820b, "release:", (Throwable) null, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 203);
        try {
            this.mListener.onStopped(this);
        } catch (Exception e) {
            SystemUtils.log(6, f48820b, "failed onStopped", e, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 207);
        ...
        if (mediaCodec != null) {
            try {
                ...
                SystemUtils.log(6, f48820b, "failed releasing MediaCodec", e2, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 219);
        ...
        if (this.mMuxerStarted) {
            ...
            if (mediaMuxerWrapper != null) {
                try {
                    mediaMuxerWrapper.mo120694b();
                } catch (Exception e3) {
                    SystemUtils.log(6, f48820b, "failed stopping muxer", e3, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 231);
    ...
    public void signalEndOfInputStream() {
        SystemUtils.log(3, f48820b, "sending EOS to encoder", (Throwable) null, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 242);
        ...
        if (this.mIsCapturing) {
            ...
            while (this.mIsCapturing) {
                ...
                if (dequeueInputBuffer >= 0) {
                    ...
                    if (i <= 0) {
                        this.mIsEOS = true;
                        SystemUtils.log(4, f48820b, "send BUFFER_FLAG_END_OF_STREAM", (Throwable) null, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 271);
    ...
    public void drain() {
        ...
        L_0x0025:
            ...
            android.media.MediaCodec$BufferInfo r5 = r13.f48822d     // Catch:{ Exception -> 0x0130 }
        ...
        L_0x0058:
            ...
            int r4 = r1.mo120690a((android.media.MediaFormat) r4)     // Catch:{ Exception -> 0x0130 }
            r13.mTrackIndex = r4     // Catch:{ Exception -> 0x0130 }
            r4 = 1
            r13.mMuxerStarted = r4     // Catch:{ Exception -> 0x0130 }
            boolean r4 = r1.mo120693a()     // Catch:{ Exception -> 0x0130 }
            if (r4 != 0) goto L_0x0025
        ...
        L_0x00be:
            ...
            android.media.MediaCodec$BufferInfo r6 = r13.f48822d     // Catch:{ Exception -> 0x0130 }
        ...
        L_0x00db:
            ...
            android.media.MediaCodec$BufferInfo r3 = r13.f48822d     // Catch:{ Exception -> 0x0130 }
            ...
            android.media.MediaCodec$BufferInfo r6 = r13.f48822d     // Catch:{ Exception -> 0x0130 }
            r1.mo120691a(r3, r5, r6)     // Catch:{ Exception -> 0x0130 }
            android.media.MediaCodec$BufferInfo r3 = r13.f48822d     // Catch:{ Exception -> 0x0130 }
            long r5 = r3.presentationTimeUs     // Catch:{ Exception -> 0x0130 }
            r13.f48823e = r5     // Catch:{ Exception -> 0x0130 }
            r3 = 0
            goto L_0x0104
        L_0x00fc:
            java.lang.RuntimeException r0 = new java.lang.RuntimeException     // Catch:{ Exception -> 0x0130 }
        ...
        L_0x0104:
            ...
            android.media.MediaCodec$BufferInfo r4 = r13.f48822d     // Catch:{ Exception -> 0x0130 }
