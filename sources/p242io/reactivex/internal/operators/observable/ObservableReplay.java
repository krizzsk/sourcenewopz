...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements ResettableConnectable, HasUpstreamObservableSource<T> {
    ...
    /* renamed from: e */
    static final BufferSupplier f58907e = new UnBoundedFactory();

    /* renamed from: a */
    final ObservableSource<T> f58908a;

    /* renamed from: b */
    final AtomicReference<ReplayObserver<T>> f58909b;

    /* renamed from: c */
    final BufferSupplier<T> f58910c;

    /* renamed from: d */
    final ObservableSource<T> f58911d;
    ...
    public static <T> ConnectableObservable<T> createFrom(ObservableSource<? extends T> observableSource) {
        return m41831a(observableSource, f58907e);
    }
    ...
    public static <T> ConnectableObservable<T> create(ObservableSource<T> observableSource, int i) {
        ...
        return m41831a(observableSource, new ReplayBufferSupplier(i));
    }
    ...
    public static <T> ConnectableObservable<T> create(ObservableSource<T> observableSource, long j, TimeUnit timeUnit, Scheduler scheduler, int i) {
        return m41831a(observableSource, new ScheduledReplaySupplier(i, j, timeUnit, scheduler));
    }

    /* renamed from: a */
    static <T> ConnectableObservable<T> m41831a(ObservableSource<T> observableSource, BufferSupplier<T> bufferSupplier) {
    ...
    private ObservableReplay(ObservableSource<T> observableSource, ObservableSource<T> observableSource2, AtomicReference<ReplayObserver<T>> atomicReference, BufferSupplier<T> bufferSupplier) {
        this.f58911d = observableSource;
        this.f58908a = observableSource2;
        this.f58909b = atomicReference;
        this.f58910c = bufferSupplier;
    }
    ...
    public void resetIf(Disposable disposable) {
        this.f58909b.compareAndSet((ReplayObserver) disposable, (Object) null);
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super T> observer) {
        this.f58911d.subscribe(observer);
    }
    ...
    public void connect(p242io.reactivex.functions.Consumer<? super p242io.reactivex.disposables.Disposable> r5) {
        /*
            r4 = this;
        L_0x0000:
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver<T>> r0 = r4.f58909b
            java.lang.Object r0 = r0.get()
            io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver r0 = (p242io.reactivex.internal.operators.observable.ObservableReplay.ReplayObserver) r0
            if (r0 == 0) goto L_0x0010
            boolean r1 = r0.isDisposed()
            if (r1 == 0) goto L_0x0025
        L_0x0010:
            io.reactivex.internal.operators.observable.ObservableReplay$BufferSupplier<T> r1 = r4.f58910c
            ...
            r2.<init>(r1)
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservableReplay$ReplayObserver<T>> r1 = r4.f58909b
        ...
        L_0x003a:
            ...
            io.reactivex.ObservableSource<T> r5 = r4.f58908a
            r5.subscribe(r0)
        L_0x0044:
            return
        L_0x0045:
        ...
        L_0x004d:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableReplay.connect(io.reactivex.functions.Consumer):void");
    }
    ...
    static final class SizeAndTimeBoundReplayBuffer<T> extends BoundedReplayBuffer<T> {
        ...
        public void truncateFinal() {
            /*
                ...
                io.reactivex.internal.operators.observable.ObservableReplay$Node r2 = (p242io.reactivex.internal.operators.observable.ObservableReplay.Node) r2
                java.lang.Object r3 = r2.get()
                io.reactivex.internal.operators.observable.ObservableReplay$Node r3 = (p242io.reactivex.internal.operators.observable.ObservableReplay.Node) r3
                r4 = 0
            L_0x0018:
                r9 = r3
                r3 = r2
            ...
            L_0x0041:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableReplay.SizeAndTimeBoundReplayBuffer.truncateFinal():void");
        }
    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:0:0x0000 A[LOOP_START, MTH_ENTER_BLOCK] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void subscribe(p242io.reactivex.Observer<? super T> r4) {
            /*
                r3 = this;
            L_0x0000:
            ...
            L_0x0035:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableReplay.ReplaySource.subscribe(io.reactivex.Observer):void");
        }
    }
    ...
    static final class Replay<T> extends ConnectableObservable<T> {
        ...
        /* renamed from: co */
        private final ConnectableObservable<T> f58912co;
        private final Observable<T> observable;

        Replay(ConnectableObservable<T> connectableObservable, Observable<T> observable2) {
            this.f58912co = connectableObservable;
            this.observable = observable2;
        }

        public void connect(Consumer<? super Disposable> consumer) {
            this.f58912co.connect(consumer);
        }
