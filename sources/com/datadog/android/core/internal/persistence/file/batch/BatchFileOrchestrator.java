...
public final class BatchFileOrchestrator implements FileOrchestrator {
    ...
    public java.io.File getReadableFile(java.util.Set<? extends java.io.File> r7) {
        /*
            ...
            boolean r0 = r6.m2354a()
            r1 = 0
            if (r0 != 0) goto L_0x000d
            return r1
        L_0x000d:
            r6.m2357c()
            java.util.List r0 = r6.m2359e()
    ...
    /* renamed from: a */
    private final File m2353a(int i) {
        File file = (File) CollectionsKt.lastOrNull(m2359e());
        if (file == null) {
            return null;
        }
        ...
        boolean a = m2355a(file, this.f3564f);
    ...
    /* renamed from: a */
    private final boolean m2355a(File file, long j) {
    ...
    /* renamed from: c */
    private final void m2357c() {
        for (File delete : SequencesKt.filter(CollectionsKt.asSequence(m2359e()), new BatchFileOrchestrator$deleteObsoleteFiles$1(System.currentTimeMillis() - this.f3560b.getOldFileThreshold()))) {
            delete.delete();
        }
    }

    /* renamed from: d */
    private final void m2358d() {
        Iterable<File> e = m2359e();
        long j = 0;
    ...
    /* renamed from: e */
    private final List<File> m2359e() {
    ...
    @Metadata(mo175977d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0016¨\u0006\u0007"}, mo175978d2 = {"Lcom/datadog/android/core/internal/persistence/file/batch/BatchFileOrchestrator$BatchFileFilter;", "Ljava/io/FileFilter;", "()V", "accept", "", "file", "Ljava/io/File;", "dd-sdk-android_release"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: BatchFileOrchestrator.kt */
    ...
    @Metadata(mo175977d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, mo175978d2 = {"Lcom/datadog/android/core/internal/persistence/file/batch/BatchFileOrchestrator$Companion;", "", "()V", "ERROR_CANT_CREATE_ROOT", "", "ERROR_DISK_FULL", "ERROR_LARGE_DATA", "ERROR_ROOT_NOT_DIR", "ERROR_ROOT_NOT_WRITABLE", "batchFileNameRegex", "Lkotlin/text/Regex;", "dd-sdk-android_release"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: BatchFileOrchestrator.kt */
