...
public class BackgroundDrawable extends Drawable {
    ...
    public static class Shadow {
        ...
        /* renamed from: dx */
        public float f39331dx;

        /* renamed from: dy */
        public float f39332dy;
        public float radius;
    ...
    private void drawShadow(Canvas canvas) {
        ...
        this.mShadowPaint.setShadowLayer(this.shadow.radius, this.shadow.f39331dx, this.shadow.f39332dy, this.shadow.color);
        if (this.border.hasRadius()) {
            this.mOuterBoundsPath.reset();
            this.mOuterBoundsPath.addRoundRect(this.mOuterBoundsRect, this.mOuterRadii, Path.Direction.CW);
    ...
    private void drawShadowBelow_9_0(Canvas canvas) {
        ...
        try {
            ...
            float f = (float) i;
            canvas2.translate((-this.shadow.f39331dx) + f, (-this.shadow.f39332dy) + f);
            this.mShadowPaint.setColor(-1);
            this.mShadowPaint.setStyle(Paint.Style.FILL);
            this.mShadowPaint.setShadowLayer(this.shadow.radius, this.shadow.f39331dx, this.shadow.f39332dy, this.shadow.color);
            if (this.border.hasRadius()) {
            ...
            canvas.drawBitmap(createBitmap, this.shadow.f39331dx - f, this.shadow.f39332dy - f, (Paint) null);
