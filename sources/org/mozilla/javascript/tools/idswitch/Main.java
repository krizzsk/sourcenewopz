...
public class Main {
    ...
    /* renamed from: P */
    private CodePrinter f6668P;

    /* renamed from: R */
    private ToolErrorReporter f6669R;
    ...
    private void process_file() {
        ...
        L_0x005a:
            ...
            org.mozilla.javascript.tools.idswitch.CodePrinter r3 = r14.f6668P
        ...
        L_0x0094:
            ...
            org.mozilla.javascript.tools.ToolErrorReporter r2 = r14.f6669R
    ...
    private void generate_java_code() {
        ...
        switchGenerator.setReporter(this.f6669R);
        switchGenerator.setCodePrinter(this.f6668P);
        ...
        if (look_for_slash_slash != i2) {
            ...
            if (skip_white_space3 != i2 && cArr[skip_white_space3] == '#') {
                ...
                if (!(i5 == i2 || (skip_white_space = skip_white_space(cArr, i5, i2)) == i2 || (((c = cArr[skip_white_space]) != '=' && c != '#') || (i3 = get_tag_id(cArr, i4, i5, z2)) == 0))) {
                    ...
                    if (str != null) {
                        throw this.f6669R.runtimeError(ToolErrorReporter.getMessage(str, tag_name(i3)), this.source_file, this.body.getLineNumber(), (String) null, 0);
                    }
                }
            }
        }
    ...
    private int exec(String[] strArr) {
        this.f6669R = new ToolErrorReporter(true, System.err);
        ...
        if (process_options == 0) {
            ...
            this.f6668P = codePrinter;
            codePrinter.setIndentStep(4);
            this.f6668P.setIndentTabSize(0);
            try {
