...
public final class AesEaxJce implements Aead {
    ...
    /* renamed from: b */
    private final byte[] f53756b;
    private final int ivSizeInBytes;
    private final SecretKeySpec keySpec;

    /* renamed from: p */
    private final byte[] f53757p;
    ...
    public AesEaxJce(byte[] bArr, int i) throws GeneralSecurityException {
        if (i == 12 || i == 16) {
            ...
            this.f53756b = multiplyByX;
            this.f53757p = multiplyByX(multiplyByX);
            return;
        }
    ...
    private byte[] pad(byte[] bArr) {
        if (bArr.length == 16) {
            return xor(bArr, this.f53756b);
        }
        byte[] copyOf = Arrays.copyOf(this.f53757p, 16);
    ...
    private byte[] omac(Cipher cipher, int i, byte[] bArr, int i2, int i3) throws IllegalBlockSizeException, BadPaddingException {
        ...
        bArr2[15] = (byte) i;
        if (i3 == 0) {
            return cipher.doFinal(xor(bArr2, this.f53756b));
        }
