...
public class MapSerializeUtil {
    ...
    /* renamed from: a */
    private static final String f55709a = "UTF-16LE";

    /* renamed from: b */
    private ByteArrayOutputStream f55710b = new ByteArrayOutputStream();
    ...
    public void appendByteArray(byte[] bArr) {
        this.f55710b.write(bArr, 0, bArr.length);
    }

    public void appendByte(byte b) {
        this.f55710b.write(b);
    }
