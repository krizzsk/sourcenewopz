...
public final class ChainedMemberScope implements MemberScope {
    ...
    /* renamed from: b */
    public final MemberScope[] f60893b;
    ...
    private ChainedMemberScope(String str, MemberScope[] memberScopeArr) {
        this.f60892a = str;
        this.f60893b = memberScopeArr;
    }

    public ClassifierDescriptor getContributedClassifier(Name name, LookupLocation lookupLocation) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(lookupLocation, "location");
        MemberScope[] memberScopeArr = this.f60893b;
    ...
    public Set<Name> getClassifierNames() {
        return MemberScopeKt.flatMapClassifierNamesOrNull(ArraysKt.asIterable((T[]) this.f60893b));
    }

    public void recordLookup(Name name, LookupLocation lookupLocation) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(lookupLocation, "location");
        for (MemberScope recordLookup : this.f60893b) {
            ...
            for (MemberScope memberScope : iterable) {
                if (memberScope != MemberScope.Empty.INSTANCE) {
                    if (memberScope instanceof ChainedMemberScope) {
                        CollectionsKt.addAll(smartList, (T[]) ((ChainedMemberScope) memberScope).f60893b);
                    } else {
