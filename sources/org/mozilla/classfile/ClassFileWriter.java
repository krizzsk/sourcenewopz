...
public class ClassFileWriter {
    ...
    public void addPush(String str) {
        ...
        while (true) {
            ...
            addInvoke(182, "java/lang/StringBuilder", AgentOptions.APPEND, "(Ljava/lang/String;)Ljava/lang/StringBuilder;");
            add(87);
            if (utfEncodingLimit == length) {
    ...
    public byte[] toByteArray() {
        ...
        int putInt16 = putInt16(this.itsInterfaces.size(), bArr, putInt16(this.itsSuperClassIndex, bArr, putInt16(this.itsThisClassIndex, bArr, putInt16(this.itsFlags, bArr, this.itsConstantPool.write(bArr, putInt16(MajorVersion, bArr, putInt16(MinorVersion, bArr, putInt32(-889275714, bArr, 0))))))));
