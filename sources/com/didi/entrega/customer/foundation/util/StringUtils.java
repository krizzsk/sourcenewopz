...
public final class StringUtils {
    ...
    /* renamed from: a */
    private static String f20155a = "^([hH][tT]{2}[pP]://|[hH][tT]{2}[pP][sS]://)(([A-Za-z0-9-~]+).)+([A-Za-z0-9-~\\/])+$";
    ...
    public static String getSubStr(String str, int i, String str2) {
        if (!TextUtils.isEmpty(str) && m14848b(str) <= i) {
            return str;
        }
        return "";
    }
    ...
    public static boolean isUrlValid(String str) {
        return Pattern.compile(f20155a).matcher(str).matches();
    }

    public static void highlightText(TextView textView, String str, String str2) {
        m14847a(textView, str, new String[]{str2}, R.color.rf_color_brands_1_100);
    }

    public static void highlightText(TextView textView, String str, String[] strArr) {
        m14847a(textView, str, strArr, R.color.rf_color_brands_1_100);
    }
    ...
    /* renamed from: a */
    private static void m14847a(TextView textView, String str, String[] strArr, int i) {
        if (textView != null) {
            ...
            for (String str2 : strArr) {
                if (!isEmpty(str2)) {
                    Matcher matcher = Pattern.compile(m14845a(str2.trim()), 2).matcher(str);
                    while (matcher.find()) {
                        if (matcher.start() > -1) {
    ...
    /* renamed from: a */
    private static String m14845a(String str) {
        if (!isEmpty(str)) {
    ...
    /* renamed from: b */
    private static int m14848b(String str) {
        ...
        try {
            ...
            LogUtil.m14763e("StringUtils", e.getMessage());
            return 0;
        }
    }

    /* renamed from: a */
    private String m14846a(String str, int i) {
        int length = str.length();
        int i2 = 1;
        int i3 = 0;
        while (i2 < length) {
            i3 += m14848b(str.substring(i2 - 1, i2));
            if (i3 >= i) {
                break;
            }
            i2++;
