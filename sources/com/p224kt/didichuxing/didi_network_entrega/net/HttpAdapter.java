package com.p224kt.didichuxing.didi_network_entrega.net;
...
public class HttpAdapter {
    ...
    /* renamed from: b */
    private static final HttpAdapter f55490b = new HttpAdapter();

    /* renamed from: a */
    final RpcClient<HttpRpcRequest, HttpRpcResponse> f55491a = new RpcServiceFactory(GLEDidiNetworkPlugin.mContext).getRpcClient("http");
    ...
    public <T> Object sendRequest(NetParam netParam, ResponseListener<T> responseListener) {
        ...
        RpcClient.Builder<HttpRpcRequest, HttpRpcResponse> newBuilder = this.f55491a.newBuilder();
        HttpRpcRequest.Builder builder = new HttpRpcRequest.Builder();
        m40034a(netParam, builder);
        HttpRpcRequest build = builder.build();
        newBuilder.build().newRpc(build).enqueue(m40031a(netParam, responseListener));
        return build.getTag();
    }

    /* renamed from: a */
    private <T> Rpc.Callback<HttpRpcRequest, HttpRpcResponse> m40031a(final NetParam netParam, final ResponseListener<T> responseListener) {
        return new Rpc.Callback<HttpRpcRequest, HttpRpcResponse>() {
            public void onSuccess(HttpRpcResponse httpRpcResponse) {
                HttpAdapter.this.m40035a(responseListener, httpRpcResponse, netParam);
            }
    ...
    /* renamed from: a */
    public <T> void m40035a(ResponseListener<T> responseListener, HttpRpcResponse httpRpcResponse, NetParam netParam) {
        Object obj;
        if (responseListener != null) {
            ...
            try {
                ...
                m40036a(responseListener, netParam, obj);
            } catch (Exception e) {
                e.printStackTrace();
                if (responseListener != null) {
    ...
    /* renamed from: a */
    private <T> void m40036a(ResponseListener<T> responseListener, NetParam netParam, Object obj) {
        if (responseListener != null) {
            if (responseListener != null) {
    ...
    /* renamed from: a */
    private void m40034a(NetParam netParam, HttpRpcRequest.Builder builder) {
        m40038b(netParam);
        m40039b(netParam, builder);
        m40040c(netParam, builder);
    }

    /* renamed from: b */
    private void m40039b(NetParam netParam, HttpRpcRequest.Builder builder) {
    ...
    static /* synthetic */ class C202994 {
        ...
        static {
            /*
                com.kt.didichuxing.didi_network_entrega.net.RequestType[] r0 = com.p224kt.didichuxing.didi_network_entrega.net.RequestType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f55492x84fc7cbc = r0
                com.kt.didichuxing.didi_network_entrega.net.RequestType r1 = com.p224kt.didichuxing.didi_network_entrega.net.RequestType.REQUEST_TYPE_GET     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f55492x84fc7cbc     // Catch:{ NoSuchFieldError -> 0x001d }
                com.kt.didichuxing.didi_network_entrega.net.RequestType r1 = com.p224kt.didichuxing.didi_network_entrega.net.RequestType.REQUEST_TYPE_POST     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p224kt.didichuxing.didi_network_entrega.net.HttpAdapter.C202994.<clinit>():void");
        }
    }

    /* renamed from: c */
    private void m40040c(NetParam netParam, HttpRpcRequest.Builder builder) {
        int i = C202994.f55492x84fc7cbc[netParam.getRequestType().ordinal()];
        if (i == 1) {
            builder.get(m40032a(netParam));
        } else if (i == 2) {
            if (!(netParam.mPostGetParams == null || netParam.mPostGetParams.size() == 0)) {
                builder.post(netParam.mUrl + m40037b(netParam.mPostGetParams), m40030a(netParam.mQueryParams));
            }
            builder.post(netParam.mUrl, m40030a(netParam.mQueryParams));
        }
    }

    /* renamed from: a */
    private HttpBody m40030a(final Map<String, Object> map) {
    ...
    /* renamed from: a */
    private String m40032a(NetParam netParam) {
        if (netParam == null) {
            return null;
        }
        ...
        String b = m40037b(netParam.mQueryParams);
    ...
    /* renamed from: b */
    private String m40037b(Map<String, Object> map) {
    ...
    /* renamed from: b */
    private void m40038b(NetParam netParam) {
        if (netParam != null) {
