...
public final class zzcls implements zzesa<zzbzl<zzbsz>> {
    ...
    private zzcls(zzesn<zzclr> zzesn, zzesn<Executor> zzesn2, zzesn<zzcqx> zzesn3) {
        this.zzgab = zzesn;
        this.zzeyl = zzesn2;
        this.zzgac = zzesn3;
    }

    public static zzcls zzs(zzesn<zzclr> zzesn, zzesn<Executor> zzesn2, zzesn<zzcqx> zzesn3) {
        return new zzcls(zzesn, zzesn2, zzesn3);
    }
