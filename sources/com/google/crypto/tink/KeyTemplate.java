...
public final class KeyTemplate {
    ...
    /* renamed from: kt */
    private final com.google.crypto.tink.proto.KeyTemplate f53669kt;
    ...
    private static OutputPrefixType fromProto(com.google.crypto.tink.proto.OutputPrefixType outputPrefixType) {
        int i = C192051.$SwitchMap$com$google$crypto$tink$proto$OutputPrefixType[outputPrefixType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C192051 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.KeyTemplate.C192051.<clinit>():void");
        }
    }

    private static com.google.crypto.tink.proto.OutputPrefixType toProto(OutputPrefixType outputPrefixType) {
        int i = C192051.$SwitchMap$com$google$crypto$tink$KeyTemplate$OutputPrefixType[outputPrefixType.ordinal()];
        if (i == 1) {
    ...
    private KeyTemplate(com.google.crypto.tink.proto.KeyTemplate keyTemplate) {
        this.f53669kt = keyTemplate;
    }

    /* access modifiers changed from: package-private */
    public com.google.crypto.tink.proto.KeyTemplate getProto() {
        return this.f53669kt;
    }

    public String getTypeUrl() {
        return this.f53669kt.getTypeUrl();
    }

    public byte[] getValue() {
        return this.f53669kt.getValue().toByteArray();
    }

    public OutputPrefixType getOutputPrefixType() {
        return fromProto(this.f53669kt.getOutputPrefixType());
    }
}
