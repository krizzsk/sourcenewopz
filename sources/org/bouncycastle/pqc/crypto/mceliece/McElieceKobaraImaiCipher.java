...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f6504n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f6503k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f6506t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f6504n = mcElieceCCA2PublicKeyParameters.getN();
        this.f6503k = mcElieceCCA2PublicKeyParameters.getK();
        this.f6506t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            this.f6505sr = parametersWithRandom.getRandom();
            ...
            this.f6505sr = CryptoServicesRegistrar.getSecureRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        if (!this.forEncryption) {
            ...
            if (bArr.length >= i) {
                ...
                int i2 = this.f6503k >> 3;
                int bitLength = (IntegerFunctions.binomial(this.f6504n, this.f6506t).bitLength() - 1) >> 3;
                ...
                GF2Vector[] decryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f6504n, bArr));
                byte[] encoded = decryptionPrimitive[0].getEncoded();
                GF2Vector gF2Vector = decryptionPrimitive[1];
                if (encoded.length > i2) {
                    encoded = ByteUtils.subArray(encoded, 0, i2);
                }
                byte[] decode = Conversions.decode(this.f6504n, this.f6506t, gF2Vector);
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        if (this.forEncryption) {
            ...
            byte[] encoded = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.f6503k, bArr9), Conversions.encode(this.f6504n, this.f6506t, bArr8)).getEncoded();
