...
public class DescriptorUtils {
    ...
    /* renamed from: a */
    static final /* synthetic */ boolean f60849a = (!DescriptorUtils.class.desiredAssertionStatus());

    /* renamed from: a */
    private static /* synthetic */ void m44917a(int i) {
        String str;
        int i2;
        Throwable th;
        switch (i) {
    ...
    public static FqNameUnsafe getFqName(DeclarationDescriptor declarationDescriptor) {
        ...
        FqName a = m44916a(declarationDescriptor);
        return a != null ? a.toUnsafe() : m44921b(declarationDescriptor);
    }
    ...
    public static FqName getFqNameSafe(DeclarationDescriptor declarationDescriptor) {
        ...
        FqName a = m44916a(declarationDescriptor);
        if (a == null) {
            a = m44921b(declarationDescriptor).toSafe();
        }
        if (a == null) {
            m44917a(4);
        }
    ...
    /* renamed from: a */
    private static FqName m44916a(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            m44917a(5);
        }
    ...
    /* renamed from: b */
    private static FqNameUnsafe m44921b(DeclarationDescriptor declarationDescriptor) {
        if (declarationDescriptor == null) {
            m44917a(6);
        }
        DeclarationDescriptor containingDeclaration = declarationDescriptor.getContainingDeclaration();
        if (f60849a || containingDeclaration != null) {
    ...
    public static ModuleDescriptor getContainingModule(DeclarationDescriptor declarationDescriptor) {
        ...
        if (f60849a || containingModuleOrNull != null) {
    ...
    public static boolean isDirectSubclass(ClassDescriptor classDescriptor, ClassDescriptor classDescriptor2) {
        ...
        for (KotlinType a : classDescriptor.getTypeConstructor().getSupertypes()) {
            if (m44920a(a, (DeclarationDescriptor) classDescriptor2.getOriginal())) {
                return true;
            }
        }
        return false;
    ...
    /* renamed from: a */
    private static boolean m44920a(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        if (kotlinType == null) {
            m44917a(30);
        }
        if (declarationDescriptor == null) {
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        if (m44920a(kotlinType, declarationDescriptor)) {
            return true;
        }
    ...
    public static boolean isCompanionObject(DeclarationDescriptor declarationDescriptor) {
        return m44919a(declarationDescriptor, ClassKind.OBJECT) && ((ClassDescriptor) declarationDescriptor).isCompanionObject();
    }

    public static boolean isSealedClass(DeclarationDescriptor declarationDescriptor) {
        return (m44919a(declarationDescriptor, ClassKind.CLASS) || m44919a(declarationDescriptor, ClassKind.INTERFACE)) && ((ClassDescriptor) declarationDescriptor).getModality() == Modality.SEALED;
    }
    ...
    /* renamed from: a */
    private static boolean m44919a(DeclarationDescriptor declarationDescriptor, ClassKind classKind) {
        if (classKind == null) {
            m44917a(37);
        }
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        if (f60849a || (declarationDescriptor instanceof ClassDescriptor)) {
    ...
    public static DescriptorVisibility getDefaultConstructorVisibility(ClassDescriptor classDescriptor, boolean z) {
        ...
        } else if (f60849a || kind == ClassKind.CLASS || kind == ClassKind.INTERFACE || kind == ClassKind.ANNOTATION_CLASS) {
    ...
    public static <D extends CallableDescriptor> Set<D> getAllOverriddenDescriptors(D d) {
        ...
        m44918a(d.getOriginal(), linkedHashSet);
        return linkedHashSet;
    }

    /* renamed from: a */
    private static <D extends CallableDescriptor> void m44918a(D d, Set<D> set) {
        if (d == null) {
            m44917a(70);
        }
        if (set == null) {
