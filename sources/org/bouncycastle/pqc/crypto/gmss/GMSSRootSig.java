...
public class GMSSRootSig {
    ...
    private void oneStep() {
        ...
        if (8 % i2 == 0) {
            ...
            if (i3 == 0) {
                ...
                if (i4 < this.mdsize) {
                    byte[] bArr = this.hash;
                    this.test = bArr[i4] & this.f6452k;
                    bArr[i4] = (byte) (bArr[i4] >>> this.f6454w);
                } else {
                    int i5 = this.checksum;
                    this.test = this.f6452k & i5;
                    this.checksum = i5 >>> this.f6454w;
                }
            } else if (i3 > 0) {
        ...
        if (i2 < 8) {
            ...
            if (i9 == 0) {
                ...
                if (i10 % 8 == 0 && this.f6451ii < (i = this.mdsize)) {
                    this.big8 = 0;
                    if (i10 < ((i / i2) << 3)) {
                        for (int i11 = 0; i11 < this.f6454w; i11++) {
                            long j2 = this.big8;
                            byte[] bArr6 = this.hash;
                            int i12 = this.f6451ii;
                            this.big8 = j2 ^ ((long) ((bArr6[i12] & 255) << (i11 << 3)));
                            this.f6451ii = i12 + 1;
                        }
                    } else {
                        for (int i13 = 0; i13 < this.mdsize % this.f6454w; i13++) {
                            long j3 = this.big8;
                            byte[] bArr7 = this.hash;
                            int i14 = this.f6451ii;
                ...
                this.test = (int) (this.big8 & ((long) this.f6452k));
                this.privateKeyOTS = this.gmssRandom.nextSeed(this.seed);
            } else if (i9 > 0) {
            ...
            if (j4 == 0) {
                ...
                if (i19 < i20) {
                    ...
                    long j5 = j >>> i18;
                    this.big8 = j5;
                    this.test8 = j5 & ((long) this.f6452k);
                } else {
                    int i23 = this.checksum;
                    this.test8 = (long) (this.f6452k & i23);
    ...
    public int[] getStatInt() {
        return new int[]{this.counter, this.test, this.f6451ii, this.f6453r, this.steps, this.keysize, this.height, this.f6454w, this.checksum};
    }
    ...
    public void initSign(byte[] bArr, byte[] bArr2) {
        ...
        int log = getLog((this.messagesize << this.f6454w) + 1);
        int i4 = this.f6454w;
        int i5 = 8;
        if (8 % i4 == 0) {
            int i6 = 8 / i4;
            ...
            for (int i7 = 0; i7 < this.mdsize; i7++) {
                for (int i8 = 0; i8 < i6; i8++) {
                    i += bArr5[i7] & this.f6452k;
                    bArr5[i7] = (byte) (bArr5[i7] >>> this.f6454w);
                }
            }
            int i9 = (this.messagesize << this.f6454w) - i;
            this.checksum = i9;
            int i10 = 0;
            while (i10 < log) {
                i += this.f6452k & i9;
            ...
            while (i13 < i12) {
                long j = 0;
                for (int i16 = 0; i16 < this.f6454w; i16++) {
                    j ^= (long) ((bArr5[i14] & 255) << (i16 << 3));
                    i14++;
                }
                int i17 = 0;
                while (i17 < i5) {
                    i15 += (int) (((long) this.f6452k) & j);
                    j >>>= this.f6454w;
                    i17++;
                    i12 = i12;
                    i5 = 8;
            ...
            int i19 = this.mdsize % this.f6454w;
            long j2 = 0;
            ...
            int i22 = 0;
            while (i22 < i21) {
                i15 += (int) (((long) this.f6452k) & j2);
                int i23 = this.f6454w;
                j2 >>>= i23;
                i22 += i23;
            }
            int i24 = (this.messagesize << this.f6454w) - i15;
            this.checksum = i24;
            int i25 = i15;
            int i26 = 0;
            while (i26 < log) {
                i25 = i + (this.f6452k & i24);
                int i27 = this.f6454w;
                i24 >>>= i27;
                i26 += i27;
            }
            ...
            while (true) {
                ...
                i29 = (int) (((long) i29) + ((j3 >>> i31) & ((long) this.f6452k)));
            }
            int i35 = i28 >>> 3;
            if (i35 < i2) {
                int i36 = i28 % 8;
                ...
                i29 = (int) (((long) i29) + ((j4 >>> i36) & ((long) this.f6452k)));
            }
            int i38 = (this.messagesize << this.f6454w) - i29;
            this.checksum = i38;
            int i39 = i29;
            int i40 = 0;
            while (i40 < log) {
                i39 = i + (this.f6452k & i38);
                int i41 = this.f6454w;
                i38 >>>= i41;
                i40 += i41;
            }
        ...
        int ceil = this.messagesize + ((int) Math.ceil(((double) log) / ((double) this.f6454w)));
        this.keysize = ceil;
