...
public class FusionResourceManager {
    ...
    /* renamed from: a */
    private static final String f29696a = "FusionResourceManager";
    ...
    public static FusionResource fetchResourceFromNet(String str, Map<String, String> map, boolean z) {
        ...
        if (fusionHttpClient.connect() == 0 && 200 == fusionHttpClient.getResponseCode()) {
            return m20852a(fusionHttpClient, z);
        }
        return null;
    }

    /* renamed from: a */
    private static FusionResource m20852a(FusionHttpClient fusionHttpClient, boolean z) {
    ...
    /* renamed from: a */
    private static FusionResource m20853a(String str, Map<String, String> map, boolean z) {
        FusionCacheClient fusionCacheClient = FusionCacheClient.sInstance;
        ...
        if (!TextUtils.isEmpty(str2) && (z2 || !str2.contains("text/html"))) {
            ...
            if (fusionResource != null && z) {
                m20854a(str, map, fusionCacheClient.getHeaderForRequest(str));
            }
        }
    ...
    /* renamed from: a */
    private static void m20854a(final String str, final Map<String, String> map, final Map<String, String> map2) {
        FusionAsynDispatcher.Instance.asynRunTask(new Runnable() {
            public void run() {
                FusionCacheClient fusionCacheClient = FusionCacheClient.sInstance;
