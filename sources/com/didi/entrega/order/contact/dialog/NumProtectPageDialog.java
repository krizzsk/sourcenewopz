...
public final class NumProtectPageDialog implements INumProtect {
    ...
    /* renamed from: b */
    private final ScopeContext f20873b;
    ...
    public void showNumProtectDialog(NumProtectModel numProtectModel, String str, int i) {
        ...
        DialogUtil.showNumProtectDialog(new CustomerNumProtectDialog(this.f20872a, numProtectModel, new NumProtectPageDialog$showNumProtectDialog$numProtectDialog$1(this, str, i)), this.f20873b.getNavigator());
    }
    ...
    public void showProtectNumDegradeDialog(Context context, String str, String str2, RFDialogInterface.OnClickListener onClickListener) {
        Intrinsics.checkNotNullParameter(context, "context");
        DialogUtil.showProtectNumDegradeDialog(context, this.f20873b.getNavigator(), str, onClickListener == null, onClickListener);
    }

    public void showToast(String str) {
        ToastUtil.showCustomerToast(this.f20873b, str);
    }

    public void bindRpcLife(Rpc<?, ?> rpc) {
        Intrinsics.checkNotNullParameter(rpc, "rpc");
        this.f20873b.getLiveHandler().bind(new Cancelable() {
            public final void cancel() {
                NumProtectPageDialog.m15289a(Rpc.this);
            }
        });
    }
    ...
    /* renamed from: a */
    public static final void m15289a(Rpc rpc) {
        Intrinsics.checkNotNullParameter(rpc, "$rpc");
        rpc.cancel();
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public final void m15287a(CustomerNumProtectDialog customerNumProtectDialog, int i) {
        CountryListDialog.show(this.f20873b, (OnCountrySelectListener) new OnCountrySelectListener() {
            public final void onSelect(String str, int i) {
                NumProtectPageDialog.m15288a(CustomerNumProtectDialog.this, str, i);
            }
        }, i, ((ILocaleService) CustomerServiceManager.getService(ILocaleService.class)).getLangTag(), CustomerSystemUtil.getImmersiveStatusBarHeight(this.f20872a), GlobalContext.isBrazil() ? R.style.NovaAssemblyCountryStyleYellow : R.style.NovaAssemblyCountryStyleOrange);
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public static final void m15288a(CustomerNumProtectDialog customerNumProtectDialog, String str, int i) {
