...
public class Core {
    ...
    public static MinMaxLocResult minMaxLoc(Mat mat, Mat mat2) {
        ...
        minMaxLocResult.minLoc.f6684x = n_minMaxLocManual[2];
        minMaxLocResult.minLoc.f6685y = n_minMaxLocManual[3];
        minMaxLocResult.maxLoc.f6684x = n_minMaxLocManual[4];
        minMaxLocResult.maxLoc.f6685y = n_minMaxLocManual[5];
