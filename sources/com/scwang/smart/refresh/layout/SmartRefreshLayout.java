...
public class SmartRefreshLayout extends ViewGroup implements NestedScrollingParent, RefreshLayout {
    ...
    public SmartRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C10448R.styleable.SmartRefreshLayout);
    ...
    public void onMeasure(int r18, int r19) {
        ...
        L_0x001a:
            ...
            r11 = 2131434249(0x7f0b1b09, float:1.8490307E38)
    ...
    public void setStateLoading(final boolean z) {
        C204591 r0 = new AnimatorListenerAdapter() {
    ...
    public void setStateRefreshing(final boolean z) {
        C204612 r0 = new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animator) {
                if (animator == null || animator.getDuration() != 0) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C10448R.styleable.SmartRefreshLayout_Layout);
                ...
                if (onFinish < Integer.MAX_VALUE) {
                    ...
                    SmartRefreshLayout.this.mHandler.postDelayed(new Runnable() {
                        public void run() {
                            ...
                            C204681 r2 = new AnimatorListenerAdapter() {
                                public void onAnimationEnd(Animator animator) {
                                    if (animator == null || animator.getDuration() != 0) {
                                        SmartRefreshLayout.this.mFooterLocked = false;
                                        if (z2) {
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshKernel setState(RefreshState refreshState) {
            switch (C2046010.$SwitchMap$com$scwang$smart$refresh$layout$constant$RefreshState[refreshState.ordinal()]) {
                case 1:
        ...
        public RefreshKernel startTwoLevel(boolean z) {
            if (z) {
                C204751 r4 = new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animator) {
                        if (animator == null || animator.getDuration() != 0) {
    ...
    static /* synthetic */ class C2046010 {
        ...
        static {
            ...
            L_0x0090:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.scwang.smart.refresh.layout.SmartRefreshLayout.C2046010.<clinit>():void");
        }
    }
}
