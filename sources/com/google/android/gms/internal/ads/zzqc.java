...
final class zzqc extends HandlerThread implements SurfaceTexture.OnFrameAvailableListener, Handler.Callback {
    private Handler handler;
    private final int[] zzbli = new int[1];
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i == 1) {
            try {
                ...
                zzpg.checkState(EGL14.eglChooseConfig(eglGetDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12327, 12344, 12339, 4, 12344}, 0, eGLConfigArr, 0, 1, iArr2, 0) && iArr2[0] > 0 && eGLConfigArr2[0] != null, "eglChooseConfig failed");
                ...
                SystemUtils.log(6, "DummySurface", "Failed to initialize dummy surface", e, "com.google.android.gms.internal.ads.zzqc", 60);
                this.zzbll = e;
                synchronized (this) {
                    notify();
                }
                ...
                try {
                    SystemUtils.log(6, "DummySurface", "Failed to initialize dummy surface", e2, "com.google.android.gms.internal.ads.zzqc", 66);
                    this.zzblk = e2;
                    synchronized (this) {
                        notify();
                    }
            ...
            try {
                ...
                try {
                    SystemUtils.log(6, "DummySurface", "Failed to release dummy surface", th2, "com.google.android.gms.internal.ads.zzqc", 91);
                } finally {
                    quit();
                }
            }
