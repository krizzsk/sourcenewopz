...
public abstract class AbstractExtractFileTask<T> extends AsyncZipTask<T> {
    ...
    /* renamed from: a */
    private ZipModel f5031a;

    /* renamed from: b */
    private UnzipParameters f5032b;
    ...
    public AbstractExtractFileTask(ZipModel zipModel, UnzipParameters unzipParameters, AsyncZipTask.AsyncTaskParameters asyncTaskParameters) {
        ...
        this.f5031a = zipModel;
        this.f5032b = unzipParameters;
    }
    ...
    public void extractFile(ZipInputStream zipInputStream, FileHeader fileHeader, String str, String str2, ProgressMonitor progressMonitor, byte[] bArr) throws IOException {
        if (!m3214a(fileHeader) || this.f5032b.isExtractSymbolicLinks()) {
            ...
            if (a.getCanonicalPath().startsWith(new File(str).getCanonicalPath() + File.separator)) {
                m3212a(zipInputStream, fileHeader);
                if (fileHeader.isDirectory()) {
                    if (!a.exists() && !a.mkdirs()) {
                        throw new ZipException("Could not create directory: " + a);
                    }
                } else if (m3214a(fileHeader)) {
                    m3213a(zipInputStream, fileHeader, a, progressMonitor);
                } else {
                    m3210a(a);
                    m3211a(zipInputStream, a, progressMonitor, bArr);
                }
    ...
    /* renamed from: a */
    private boolean m3214a(FileHeader fileHeader) {
    ...
    private void m3211a(net.lingala.zip4j.p067io.inputstream.ZipInputStream r4, java.io.File r5, net.lingala.zip4j.progress.ProgressMonitor r6, byte[] r7) throws java.io.IOException {
        /*
            r3 = this;
        ...
        L_0x0032:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: net.lingala.zip4j.tasks.AbstractExtractFileTask.m3211a(net.lingala.zip4j.io.inputstream.ZipInputStream, java.io.File, net.lingala.zip4j.progress.ProgressMonitor, byte[]):void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void m3213a(net.lingala.zip4j.p067io.inputstream.ZipInputStream r2, net.lingala.zip4j.model.FileHeader r3, java.io.File r4, net.lingala.zip4j.progress.ProgressMonitor r5) throws java.io.IOException {
        /*
            r1 = this;
            java.lang.String r0 = new java.lang.String
            byte[] r2 = r1.m3215a((net.lingala.zip4j.p067io.inputstream.ZipInputStream) r2, (net.lingala.zip4j.model.FileHeader) r3, (net.lingala.zip4j.progress.ProgressMonitor) r5)
            r0.<init>(r2)
        ...
        L_0x0052:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: net.lingala.zip4j.tasks.AbstractExtractFileTask.m3213a(net.lingala.zip4j.io.inputstream.ZipInputStream, net.lingala.zip4j.model.FileHeader, java.io.File, net.lingala.zip4j.progress.ProgressMonitor):void");
    }

    /* renamed from: a */
    private byte[] m3215a(ZipInputStream zipInputStream, FileHeader fileHeader, ProgressMonitor progressMonitor) throws IOException {
    ...
    /* renamed from: a */
    private void m3212a(ZipInputStream zipInputStream, FileHeader fileHeader) throws IOException {
    ...
    /* renamed from: a */
    private void m3210a(File file) throws ZipException {
    ...
    /* renamed from: a */
    private File m3208a(FileHeader fileHeader, String str, String str2) {
        if (!Zip4jUtil.isStringNotNullAndNotEmpty(str2)) {
            str2 = m3209a(fileHeader.getFileName());
        }
        return new File(str + InternalZipConstants.FILE_SEPARATOR + str2);
    }

    /* renamed from: a */
    private String m3209a(String str) {
