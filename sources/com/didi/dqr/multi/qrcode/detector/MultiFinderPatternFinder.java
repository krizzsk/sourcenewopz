...
final class MultiFinderPatternFinder extends FinderPatternFinder {
    ...
    /* renamed from: a */
    private static final FinderPatternInfo[] f18664a = new FinderPatternInfo[0];

    /* renamed from: b */
    private static final float f18665b = 180.0f;

    /* renamed from: c */
    private static final float f18666c = 9.0f;

    /* renamed from: d */
    private static final float f18667d = 0.05f;

    /* renamed from: e */
    private static final float f18668e = 0.5f;
    ...
    /* renamed from: a */
    private FinderPattern[][] m13875a() throws NotFoundException {
                ...
                if (finderPattern != null) {
                    ...
                    while (i3 < size - 1) {
                        ...
                        if (finderPattern2 != null) {
                            ...
                            float f = f18667d;
                            float f2 = 0.5f;
                            if (abs > 0.5f && estimatedModuleSize >= f18667d) {
                                break;
                            }
                            int i4 = i3 + 1;
                            while (i4 < size) {
    ...
    /* renamed from: a */
    public FinderPatternInfo[] mo58366a(Map<DecodeHintType, ?> map) throws NotFoundException {
