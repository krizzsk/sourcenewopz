...
public final class ReflectJavaWildcardType extends ReflectJavaType implements JavaWildcardType {
    ...
    /* renamed from: a */
    private final WildcardType f60360a;

    /* renamed from: b */
    private final Collection<JavaAnnotation> f60361b = CollectionsKt.emptyList();

    /* renamed from: c */
    private final boolean f60362c;

    public ReflectJavaWildcardType(WildcardType wildcardType) {
        Intrinsics.checkNotNullParameter(wildcardType, "reflectType");
        this.f60360a = wildcardType;
    }
