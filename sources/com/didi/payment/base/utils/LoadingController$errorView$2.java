...
final class LoadingController$errorView$2 extends Lambda implements Function0<View> {
    ...
    public final View invoke() {
        if (this.this$0.f29991b.getErrorLayoutId() == 0) {
            return this.this$0.f29991b.getErrorLayoutView();
        }
        return View.inflate(this.this$0.f29990a.getContext(), this.this$0.f29991b.getErrorLayoutId(), (ViewGroup) null);
    }
}
