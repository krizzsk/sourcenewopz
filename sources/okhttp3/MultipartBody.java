...
public final class MultipartBody extends RequestBody {
    ...
    /* renamed from: a */
    private static final byte[] f5188a = {58, 32};

    /* renamed from: b */
    private static final byte[] f5189b = {Ascii.f53584CR, 10};

    /* renamed from: c */
    private static final byte[] f5190c = {45, 45};

    /* renamed from: d */
    private final ByteString f5191d;

    /* renamed from: e */
    private final MediaType f5192e;

    /* renamed from: f */
    private final MediaType f5193f;

    /* renamed from: g */
    private final List<Part> f5194g;

    /* renamed from: h */
    private long f5195h = -1;

    MultipartBody(ByteString byteString, MediaType mediaType, List<Part> list) {
        this.f5191d = byteString;
        this.f5192e = mediaType;
        this.f5193f = MediaType.get(mediaType + "; boundary=" + byteString.utf8());
        this.f5194g = C2434Util.immutableList(list);
    }
    ...
    public long contentLength() throws IOException {
        ...
        long a = m3368a((BufferedSink) null, true);
        this.f5195h = a;
        return a;
    }

    public void writeTo(BufferedSink bufferedSink) throws IOException {
        m3368a(bufferedSink, false);
    }
    ...
    private long m3368a(@javax.annotation.Nullable okio.BufferedSink r13, boolean r14) throws java.io.IOException {
        /*
            r12 = this;
        ...
        L_0x0009:
            r0 = 0
        L_0x000a:
            java.util.List<okhttp3.MultipartBody$Part> r1 = r12.f5194g
            int r1 = r1.size()
            r2 = 0
            r3 = 0
            r5 = 0
        L_0x0014:
            ...
            java.util.List<okhttp3.MultipartBody$Part> r6 = r12.f5194g
        ...
        L_0x00c4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.MultipartBody.m3368a(okio.BufferedSink, boolean):long");
    }

    /* renamed from: a */
    static StringBuilder m3369a(StringBuilder sb, String str) {
    ...
    public static final class Part {
        ...
        public static Part createFormData(String str, @Nullable String str2, RequestBody requestBody) {
            if (str != null) {
                ...
                MultipartBody.m3369a(sb, str);
                if (str2 != null) {
                    sb.append("; filename=");
                    MultipartBody.m3369a(sb, str2);
                }
                return create(Headers.m3355of("Content-Disposition", sb.toString()), requestBody);
            }
