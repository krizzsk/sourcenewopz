...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    private final class Data extends KDeclarationContainerImpl.Data {
        ...
        static {
            ...
            $$delegatedProperties = new KProperty[]{C21490Reflection.property1(new PropertyReference1Impl(C21490Reflection.getOrCreateKotlinClass(cls), "kotlinClass", "getKotlinClass()Lorg/jetbrains/kotlin/descriptors/runtime/components/ReflectKotlinClass;")), C21490Reflection.property1(new PropertyReference1Impl(C21490Reflection.getOrCreateKotlinClass(cls), "scope", "getScope()Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;")), C21490Reflection.property1(new PropertyReference1Impl(C21490Reflection.getOrCreateKotlinClass(cls), "multifileFacade", "getMultifileFacade()Ljava/lang/Class;")), C21490Reflection.property1(new PropertyReference1Impl(C21490Reflection.getOrCreateKotlinClass(cls), AdminPermission.METADATA, "getMetadata()Lkotlin/Triple;")), C21490Reflection.property1(new PropertyReference1Impl(C21490Reflection.getOrCreateKotlinClass(cls), "members", "getMembers()Ljava/util/Collection;"))};
        }
    ...
    public Class<?> getMethodOwner() {
        Class<?> multifileFacade = this.f60035a.invoke().getMultifileFacade();
        return multifileFacade != null ? multifileFacade : getJClass();
    }

    /* renamed from: a */
    private final MemberScope m44445a() {
        return this.f60035a.invoke().getScope();
    }

    public Collection<KCallable<?>> getMembers() {
        return this.f60035a.invoke().getMembers();
    }
    ...
    public Collection<PropertyDescriptor> getProperties(Name name) {
        ...
        return m44445a().getContributedVariables(name, NoLookupLocation.FROM_REFLECTION);
    }

    public Collection<FunctionDescriptor> getFunctions(Name name) {
        Intrinsics.checkNotNullParameter(name, "name");
        return m44445a().getContributedFunctions(name, NoLookupLocation.FROM_REFLECTION);
    }

    public PropertyDescriptor getLocalProperty(int i) {
        Triple<JvmNameResolver, ProtoBuf.Package, JvmMetadataVersion> metadata = this.f60035a.invoke().getMetadata();
        if (metadata == null) {
            return null;
        }
