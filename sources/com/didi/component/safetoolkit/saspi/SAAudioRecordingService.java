...
public class SAAudioRecordingService implements ISFTripRecordingService {
    ...
    /* renamed from: a */
    public GlobalDialog f15408a = new GlobalDialog();
    ...
    public void showDialog(final FragmentActivity fragmentActivity, String str, String str2, String str3, String str4, final View.OnClickListener onClickListener) {
        if (this.f15408a.isPendingDismiss() || !this.f15408a.isVisible()) {
            this.f15408a.build().title(str2).actions(new GlobalDialog.IButtonAction[]{new GlobalDialog.PositiveButtonAction() {
                ...
                public Runnable getAction() {
                    return new Runnable() {
                        public void run() {
                            ...
                            SAAudioRecordingService.this.f15408a.dismiss();
                        }
                    };
                }
