...
final class zzabe extends zzabf<Boolean> {
    zzabe(int i, String str, Boolean bool) {
        super(i, str, bool, (zzabe) null);
    }
    ...
    public final /* synthetic */ Object zzb(JSONObject jSONObject) {
        return Boolean.valueOf(jSONObject.optBoolean(getKey(), ((Boolean) zzsh()).booleanValue()));
    }

    public final /* synthetic */ Object zza(SharedPreferences sharedPreferences) {
        return Boolean.valueOf(sharedPreferences.getBoolean(getKey(), ((Boolean) zzsh()).booleanValue()));
    }
}
