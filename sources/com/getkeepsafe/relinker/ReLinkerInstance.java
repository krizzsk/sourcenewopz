...
public class ReLinkerInstance {
    ...
    /* renamed from: a */
    private static final String f52218a = "lib";
    ...
    protected ReLinkerInstance() {
        this(new C17824a(), new ApkLibraryInstaller());
    }
    ...
    public void loadLibrary(Context context, String str, String str2, ReLinker.LoadListener loadListener) {
        if (context == null) {
        ...
        } else if (!C17825b.m37256a(str)) {
            log("Beginning load of %s...", str);
            if (loadListener == null) {
                m37254a(context, str, str2);
                return;
            }
            ...
            new Thread(new Runnable() {
                public void run() {
                    try {
                        ReLinkerInstance.this.m37254a(context2, str3, str4);
    ...
    /* renamed from: a */
    public void m37254a(Context context, String str, String str2) {
        ElfParser elfParser;
    ...
    public File getWorkaroundLibDir(Context context) {
        return context.getDir(f52218a, 0);
    }
