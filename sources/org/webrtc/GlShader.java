...
public class GlShader {
    ...
    private static int compileShader(int i, String str) {
        ...
        if (glCreateShader != 0) {
            ...
            Logging.m3801e(TAG, "Compile error " + GLES20.glGetShaderInfoLog(glCreateShader) + " in shader:\n" + str);
    ...
    public GlShader(String str, String str2) {
        ...
        if (glCreateProgram != 0) {
            ...
            Logging.m3801e(TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
    ...
    public void release() {
        Logging.m3800d(TAG, "Deleting shader.");
        int i = this.program;
        if (i != -1) {
