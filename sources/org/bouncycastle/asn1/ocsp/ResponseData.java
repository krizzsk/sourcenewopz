...
public class ResponseData extends ASN1Object {
    ...
    /* renamed from: V1 */
    private static final ASN1Integer f5654V1 = new ASN1Integer(0);
    ...
    public ResponseData(ResponderID responderID2, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, Extensions extensions) {
        this(f5654V1, responderID2, aSN1GeneralizedTime, aSN1Sequence, extensions);
    }
    ...
    public ResponseData(ResponderID responderID2, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, X509Extensions x509Extensions) {
        this(f5654V1, responderID2, ASN1GeneralizedTime.getInstance(aSN1GeneralizedTime), aSN1Sequence, Extensions.getInstance(x509Extensions));
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.versionPresent || !this.version.equals((ASN1Primitive) f5654V1)) {
