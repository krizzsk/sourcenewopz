...
public class LMSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    /* renamed from: I */
    private final byte[] f6474I;

    /* renamed from: T1 */
    private final byte[] f6475T1;
    ...
    public LMSPublicKeyParameters(LMSigParameters lMSigParameters, LMOtsParameters lMOtsParameters, byte[] bArr, byte[] bArr2) {
        ...
        this.f6474I = Arrays.clone(bArr2);
        this.f6475T1 = Arrays.clone(bArr);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.parameterSet.equals(lMSPublicKeyParameters.parameterSet) && this.lmOtsType.equals(lMSPublicKeyParameters.lmOtsType) && Arrays.areEqual(this.f6474I, lMSPublicKeyParameters.f6474I)) {
            return Arrays.areEqual(this.f6475T1, lMSPublicKeyParameters.f6475T1);
        }
        return false;
    }
    ...
    public LMSContext generateOtsContext(LMSSignature lMSSignature) {
        ...
        if (lMSSignature.getOtsSignature().getType().getType() == type) {
            return new LMOtsPublicKey(LMOtsParameters.getParametersForType(type), this.f6474I, lMSSignature.getQ(), (byte[]) null).createOtsContext(lMSSignature);
        }
    ...
    public byte[] getI() {
        return Arrays.clone(this.f6474I);
    }
    ...
    public byte[] getT1() {
        return Arrays.clone(this.f6475T1);
    }

    public int hashCode() {
        return (((((this.parameterSet.hashCode() * 31) + this.lmOtsType.hashCode()) * 31) + Arrays.hashCode(this.f6474I)) * 31) + Arrays.hashCode(this.f6475T1);
    }

    /* access modifiers changed from: package-private */
    public boolean matchesT1(byte[] bArr) {
        return Arrays.constantTimeAreEqual(this.f6475T1, bArr);
    }
    ...
    public byte[] toByteArray() {
        return Composer.compose().u32str(this.parameterSet.getType()).u32str(this.lmOtsType.getType()).bytes(this.f6474I).bytes(this.f6475T1).build();
    }
