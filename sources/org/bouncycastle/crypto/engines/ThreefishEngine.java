...
public class ThreefishEngine implements BlockCipher {
    ...
    private static final class Threefish256Cipher extends ThreefishCipher {
        ...
        public void decryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f6014kw;
            long[] jArr4 = this.f6015t;
    ...
    private static abstract class ThreefishCipher {
        ...
        /* renamed from: kw */
        protected final long[] f6014kw;

        /* renamed from: t */
        protected final long[] f6015t;
    ...
    private void setKey(long[] jArr) {
        if (jArr.length == this.blocksizeWords) {
            ...
            while (true) {
                ...
                if (i < i2) {
                    long[] jArr2 = this.f6012kw;
                    jArr2[i] = jArr[i];
                    j ^= jArr2[i];
                    i++;
                } else {
                    long[] jArr3 = this.f6012kw;
                    jArr3[i2] = j;
