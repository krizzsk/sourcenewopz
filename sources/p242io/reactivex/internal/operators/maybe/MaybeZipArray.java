...
public final class MaybeZipArray<T, R> extends Maybe<R> {
    ...
    /* renamed from: a */
    final MaybeSource<? extends T>[] f58644a;

    /* renamed from: b */
    final Function<? super Object[], ? extends R> f58645b;

    public MaybeZipArray(MaybeSource<? extends T>[] maybeSourceArr, Function<? super Object[], ? extends R> function) {
        this.f58644a = maybeSourceArr;
        this.f58645b = function;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        MaybeSource<? extends T>[] maybeSourceArr = this.f58644a;
        ...
        ZipCoordinator zipCoordinator = new ZipCoordinator(maybeObserver, length, this.f58645b);
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            return ObjectHelper.requireNonNull(MaybeZipArray.this.f58645b.apply(new Object[]{t}), "The zipper returned a null value");
        }
    }
}
