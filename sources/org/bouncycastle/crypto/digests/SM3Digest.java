...
public class SM3Digest extends GeneralDigest {
    ...
    /* renamed from: T */
    private static final int[] f5884T = new int[64];

    /* renamed from: V */
    private int[] f5885V = new int[8];

    /* renamed from: W */
    private int[] f5886W = new int[68];
    ...
    static {
        ...
        while (true) {
            ...
            f5884T[i2] = (2043430169 >>> (32 - i2)) | (2043430169 << i2);
            i2++;
        }
        for (i = 16; i < 64; i++) {
            int i3 = i % 32;
            f5884T[i] = (2055708042 >>> (32 - i3)) | (2055708042 << i3);
        }
    }
    ...
    /* renamed from: P0 */
    private int m3685P0(int i) {
        return (i ^ ((i << 9) | (i >>> 23))) ^ ((i << 17) | (i >>> 15));
    }

    /* renamed from: P1 */
    private int m3686P1(int i) {
        return (i ^ ((i << 15) | (i >>> 17))) ^ ((i << 23) | (i >>> 9));
    }

    private void copyIn(SM3Digest sM3Digest) {
        int[] iArr = sM3Digest.f5885V;
        int[] iArr2 = this.f5885V;
    ...
    public int doFinal(byte[] bArr, int i) {
        finish();
        Pack.intToBigEndian(this.f5885V, bArr, i);
        reset();
        return 32;
    }
    ...
    public void processBlock() {
        ...
        while (true) {
            ...
            this.f5886W[i2] = this.inwords[i2];
            i2++;
        }
        for (int i3 = 16; i3 < 68; i3++) {
            ...
            int i5 = (i4 >>> 17) | (i4 << 15);
            int i6 = iArr[i3 - 13];
            iArr[i3] = (m3686P1(i5 ^ (iArr[i3 - 16] ^ iArr[i3 - 9])) ^ ((i6 >>> 25) | (i6 << 7))) ^ this.f5886W[i3 - 6];
        }
        int[] iArr2 = this.f5885V;
        int i7 = iArr2[0];
        int i8 = iArr2[1];
        ...
        for (i = 16; i16 < i; i = 16) {
            int i17 = (i7 << 12) | (i7 >>> 20);
            int i18 = i17 + i11 + f5884T[i16];
            int i19 = (i18 << 7) | (i18 >>> 25);
            int[] iArr3 = this.f5886W;
            int i20 = iArr3[i16];
            int i21 = (i8 << 9) | (i8 >>> 23);
            int i22 = (i12 << 19) | (i12 >>> 13);
            i16++;
            i12 = i11;
            i11 = m3685P0(GG0(i11, i12, i15) + i14 + i19 + i20);
            i10 = i9;
            i9 = i21;
            i14 = i15;
            i15 = i22;
        ...
        while (i30 < 64) {
            ...
            int i32 = i31 + i24 + f5884T[i30];
            int i33 = (i32 << 7) | (i32 >>> 25);
            int[] iArr4 = this.f5886W;
            int i34 = iArr4[i30];
            int i35 = (i28 >>> 23) | (i28 << 9);
            int i36 = (i12 << 19) | (i12 >>> 13);
            i30++;
            i12 = i24;
            i24 = m3685P0(GG1(i24, i12, i25) + i23 + i33 + i34);
            i26 = i27;
            i27 = i35;
            i28 = i29;
