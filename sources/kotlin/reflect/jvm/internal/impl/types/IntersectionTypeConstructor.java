...
public final class IntersectionTypeConstructor implements TypeConstructor, IntersectionTypeConstructorMarker {
    ...
    /* renamed from: a */
    private KotlinType f61115a;

    /* renamed from: b */
    private final LinkedHashSet<KotlinType> f61116b;
    ...
    public IntersectionTypeConstructor(Collection<? extends KotlinType> collection) {
        ...
        if (!_Assertions.ENABLED || z) {
            ...
            this.f61116b = linkedHashSet;
            this.f61117c = linkedHashSet.hashCode();
            return;
        }
    ...
    public final MemberScope createScopeForKotlinType() {
        return TypeIntersectionScope.Companion.create("member scope for intersection type", this.f61116b);
    }

    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = ((KotlinType) this.f61116b.iterator().next()).getConstructor().getBuiltIns();
    ...
    public final String makeDebugNameForIntersectionType(Function1<? super KotlinType, ? extends Object> function1) {
        ...
        return CollectionsKt.joinToString$default(CollectionsKt.sortedWith(this.f61116b, new C21752x55fe5063(function1)), " & ", Const.joLeft, "}", 0, (CharSequence) null, new IntersectionTypeConstructor$makeDebugNameForIntersectionType$3(function1), 24, (Object) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.f61116b, (Object) ((IntersectionTypeConstructor) obj).f61116b);
    }
    ...
    public final IntersectionTypeConstructor setAlternative(KotlinType kotlinType) {
        return new IntersectionTypeConstructor(this.f61116b, kotlinType);
    }
