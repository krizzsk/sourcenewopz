...
public final class LazyScopeAdapter extends AbstractScopeAdapter {
    ...
    /* renamed from: a */
    private final NotNullLazyValue<MemberScope> f60913a;
    ...
    public LazyScopeAdapter(StorageManager storageManager, Function0<? extends MemberScope> function0) {
        ...
        Intrinsics.checkNotNullParameter(function0, "getScope");
        this.f60913a = storageManager.createLazyValue(new LazyScopeAdapter$lazyScope$1(function0));
    }

    /* access modifiers changed from: protected */
    public MemberScope getWorkerScope() {
        return (MemberScope) this.f60913a.invoke();
    }
}
