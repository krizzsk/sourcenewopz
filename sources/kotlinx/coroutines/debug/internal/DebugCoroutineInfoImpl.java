...
public final class DebugCoroutineInfoImpl {
    ...
    /* renamed from: a */
    private final StackTraceFrame f61421a;

    /* renamed from: b */
    private final WeakReference<CoroutineContext> f61422b;

    /* renamed from: c */
    private String f61423c = DebugCoroutineInfoImplKt.CREATED;

    /* renamed from: d */
    private WeakReference<CoroutineStackFrame> f61424d;
    ...
    public DebugCoroutineInfoImpl(CoroutineContext coroutineContext, StackTraceFrame stackTraceFrame, long j) {
        this.f61421a = stackTraceFrame;
        this.sequenceNumber = j;
        this.f61422b = new WeakReference<>(coroutineContext);
    }
    ...
    public final CoroutineContext getContext() {
        return (CoroutineContext) this.f61422b.get();
    }
    ...
    public final CoroutineStackFrame getLastObservedFrame$kotlinx_coroutines_core() {
        WeakReference<CoroutineStackFrame> weakReference = this.f61424d;
    ...
    public final void setLastObservedFrame$kotlinx_coroutines_core(CoroutineStackFrame coroutineStackFrame) {
        this.f61424d = coroutineStackFrame == null ? null : new WeakReference<>(coroutineStackFrame);
    }
    ...
    /* renamed from: a */
    private final List<StackTraceElement> m45649a() {
        StackTraceFrame stackTraceFrame = this.f61421a;
    ...
    public final java.lang.Object m45648a(kotlin.sequences.SequenceScope<? super java.lang.StackTraceElement> r6, kotlin.coroutines.jvm.internal.CoroutineStackFrame r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r5 = this;
        ...
        L_0x006a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl.m45648a(kotlin.sequences.SequenceScope, kotlin.coroutines.jvm.internal.CoroutineStackFrame, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public final void updateState$kotlinx_coroutines_core(String str, Continuation<?> continuation) {
        Thread thread;
        if (!Intrinsics.areEqual((Object) this.f61423c, (Object) str) || !Intrinsics.areEqual((Object) str, (Object) DebugCoroutineInfoImplKt.SUSPENDED) || getLastObservedFrame$kotlinx_coroutines_core() == null) {
            this.f61423c = str;
