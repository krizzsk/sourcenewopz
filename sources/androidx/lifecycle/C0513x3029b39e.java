...
@Metadata(mo175976bv = {1, 0, 3}, mo175977d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0016¨\u0006\b¸\u0006\u0000"}, mo175978d2 = {"androidx/lifecycle/WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$observer$1", "Landroidx/lifecycle/LifecycleEventObserver;", "onStateChanged", "", "source", "Landroidx/lifecycle/LifecycleOwner;", "event", "Landroidx/lifecycle/Lifecycle$Event;", "lifecycle-runtime-ktx_release"}, mo175979k = 1, mo175980mv = {1, 4, 1})
    ...
    public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        if (event == Lifecycle.Event.upTo(this.$state$inlined)) {
            ...
            try {
                ...
                obj = Result.m47688constructorimpl(function0.invoke());
            } catch (Throwable th) {
            ...
            this.$co.resumeWith(Result.m47688constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
        }
    }
}
