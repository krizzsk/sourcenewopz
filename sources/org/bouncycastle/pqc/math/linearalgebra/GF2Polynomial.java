...
public class GF2Polynomial {
    ...
    public GF2Polynomial(int i, String str) {
        ...
        if (str.equalsIgnoreCase("ZERO")) {
            ...
            randomize();
        } else if (str.equalsIgnoreCase(C16471q.f49112a)) {
            assignX();
    ...
    public boolean isIrreducible() {
        ...
        GF2Polynomial gF2Polynomial2 = new GF2Polynomial(gF2Polynomial.len, C16471q.f49112a);
        for (int i2 = 1; i2 <= (i >> 1); i2++) {
            gF2Polynomial2.squareThisPreCalc();
            gF2Polynomial2 = gF2Polynomial2.remainder(gF2Polynomial);
            GF2Polynomial add = gF2Polynomial2.add(new GF2Polynomial(32, C16471q.f49112a));
