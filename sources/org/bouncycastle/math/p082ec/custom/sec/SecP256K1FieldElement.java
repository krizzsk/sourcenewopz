...
public class SecP256K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f6365Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F"));

    /* renamed from: x */
    protected int[] f6366x;

    public SecP256K1FieldElement() {
        this.f6366x = Nat256.create();
    }

    public SecP256K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f6365Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP256K1FieldElement");
        }
        this.f6366x = SecP256K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP256K1Field.add(this.f6366x, ((SecP256K1FieldElement) eCFieldElement).f6366x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        SecP256K1Field.addOne(this.f6366x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.inv(((SecP256K1FieldElement) eCFieldElement).f6366x, create);
        SecP256K1Field.multiply(create, this.f6366x, create);
        return new SecP256K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat256.m3739eq(this.f6366x, ((SecP256K1FieldElement) obj).f6366x);
    }
    ...
    public int getFieldSize() {
        return f6365Q.bitLength();
    }

    public int hashCode() {
        return f6365Q.hashCode() ^ Arrays.hashCode(this.f6366x, 0, 8);
    }

    public ECFieldElement invert() {
        int[] create = Nat256.create();
        SecP256K1Field.inv(this.f6366x, create);
        return new SecP256K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat256.isOne(this.f6366x);
    }

    public boolean isZero() {
        return Nat256.isZero(this.f6366x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.multiply(this.f6366x, ((SecP256K1FieldElement) eCFieldElement).f6366x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat256.create();
        SecP256K1Field.negate(this.f6366x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f6366x;
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        SecP256K1Field.square(this.f6366x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.subtract(this.f6366x, ((SecP256K1FieldElement) eCFieldElement).f6366x, create);
        return new SecP256K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat256.getBit(this.f6366x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f6366x);
    }
}
