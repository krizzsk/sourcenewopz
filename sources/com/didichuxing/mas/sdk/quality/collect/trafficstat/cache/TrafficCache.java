...
public class TrafficCache {
    ...
    /* renamed from: b */
    private static TrafficCache f48213b;

    /* renamed from: a */
    private File f48214a;
    ...
    private TrafficCache() {
        this.f48214a = null;
        this.f48215c = "new_traffic.log";
        this.f48214a = new File(TrafficUtils.getTrafficCacheDir(), this.f48215c);
    }
    ...
    public static synchronized TrafficCache getTrafficCacheInstance() {
        ...
        synchronized (TrafficCache.class) {
            if (f48213b == null) {
                f48213b = new TrafficCache();
            }
            trafficCache = f48213b;
        }
        return trafficCache;
    }
    ...
    public java.util.Map<java.lang.String, java.lang.Object> readMapDataFromFile() {
        /*
            ...
            goto L_0x00cb
        L_0x0018:
            java.io.File r1 = r8.f48214a     // Catch:{ Exception -> 0x00a6 }
            ...
            java.io.File r5 = r8.f48214a     // Catch:{ all -> 0x0096 }
        ...
        L_0x0048:
            ...
            java.util.Map r4 = r8.m34360a(r4, r6)     // Catch:{ all -> 0x00a2 }
        L_0x0070:
        ...
        L_0x0074:
            ...
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m34418e(r2)     // Catch:{ all -> 0x00a2 }
            goto L_0x0027
        L_0x008e:
            monitor-exit(r1)     // Catch:{ all -> 0x00a2 }
            r3.close()     // Catch:{ IOException -> 0x00b8 }
            r8.m34361a()     // Catch:{ IOException -> 0x00b8 }
            goto L_0x00bc
        L_0x0096:
            r3 = move-exception
            r7 = r3
        ...
        L_0x00bd:
            ...
            r8.m34361a()     // Catch:{ IOException -> 0x00c6 }
            goto L_0x00ca
        L_0x00c6:
            r1 = move-exception
            r1.printStackTrace()
    ...
    /* renamed from: a */
    private Map<String, Object> m34360a(Map<String, Object> map, Map<String, Object> map2) {
    ...
    public void writeCacheFileAsync(java.util.Map<java.lang.String, java.lang.Object> r7) {
        ...
        L_0x001a:
            ...
            java.io.File r4 = r6.f48214a     // Catch:{ Exception -> 0x0058 }
            r5 = 1
        ...
        L_0x004c:
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m34424w(r7)     // Catch:{ all -> 0x0078 }
            goto L_0x006a
        L_0x0050:
            r7 = move-exception
            r1 = r2
        ...
        L_0x0072:
            ...
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m34424w(r1)     // Catch:{ all -> 0x0078 }
        L_0x0077:
    ...
    private void m34361a() {
        /*
            ...
            java.lang.String r2 = r6.f48215c
            r0.<init>(r1, r2)
            r6.f48214a = r0
            monitor-enter(r0)
            r1 = 0
            ...
            java.io.File r4 = r6.f48214a     // Catch:{ FileNotFoundException -> 0x0047, IOException -> 0x0038, all -> 0x0033 }
        ...
        L_0x0064:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.mas.sdk.quality.collect.trafficstat.cache.TrafficCache.m34361a():void");
    }
}
