...
public final class ObservableSampleTimed<T> extends C21211a<T, T> {

    /* renamed from: a */
    final long f58917a;

    /* renamed from: b */
    final TimeUnit f58918b;

    /* renamed from: c */
    final Scheduler f58919c;
    ...
    public ObservableSampleTimed(ObservableSource<T> observableSource, long j, TimeUnit timeUnit, Scheduler scheduler, boolean z) {
        ...
        this.f58917a = j;
        this.f58918b = timeUnit;
        this.f58919c = scheduler;
        this.f58920d = z;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        if (this.f58920d) {
            this.source.subscribe(new SampleTimedEmitLast(serializedObserver, this.f58917a, this.f58918b, this.f58919c));
        } else {
            this.source.subscribe(new SampleTimedNoLast(serializedObserver, this.f58917a, this.f58918b, this.f58919c));
        }
    }
