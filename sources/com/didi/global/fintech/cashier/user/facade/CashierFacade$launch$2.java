...
final class CashierFacade$launch$2 extends Lambda implements Function1<Boolean, Unit> {
    ...
    CashierFacade$launch$2(CashierLaunchListener cashierLaunchListener, CashierFacade cashierFacade, Fragment fragment, CashierParam cashierParam) {
        super(1);
    ...
    public final void invoke(boolean z) {
        ...
        if (cashierFacade != null) {
            ...
            if (access$getCashierProcessor$p != null) {
                access$getCashierProcessor$p.launch(fragment, (Intent) null, (Integer) null, cashierParam);
            }
        }
    }
}
