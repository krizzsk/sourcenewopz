...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    public KDFCounterBytesGenerator(Mac mac) {
        ...
        this.f6034h = macSize;
        this.f6035k = new byte[macSize];
    }

    private void generateNext() {
        int i = (this.generatedBytes / this.f6034h) + 1;
        byte[] bArr = this.ios;
        ...
        this.prf.doFinal(this.f6035k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f6035k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f6034h, i8);
            System.arraycopy(this.f6035k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        if (derivationParameters instanceof KDFCounterParameters) {
            ...
            BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf((long) this.f6034h));
