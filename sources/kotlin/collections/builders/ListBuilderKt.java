...
public final class ListBuilderKt {
    ...
    /* renamed from: a */
    public static final <T> String m42651a(T[] tArr, int i, int i2) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public static final <T> int m42653b(T[] tArr, int i, int i2) {
        int i3 = 1;
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public static final <T> boolean m42652a(T[] tArr, int i, int i2, List<?> list) {
        if (i2 != list.size()) {
            return false;
        }
        for (int i3 = 0; i3 < i2; i3++) {
