...
public class ISO9796d2Signer implements SignerWithRecovery {
    ...
    public void updateWithRecoveredMessage(byte[] bArr) throws InvalidCipherTextException {
        ...
        if (((processBlock[0] & 192) ^ 64) != 0) {
        ...
        } else if (((processBlock[processBlock.length - 1] & Ascii.f53593SI) ^ Ascii.f53586FF) == 0) {
            int i = 2;
            ...
            int i2 = 0;
            while (i2 != processBlock.length && ((processBlock[i2] & Ascii.f53593SI) ^ 10) != 0) {
                i2++;
            }
            int i3 = i2 + 1;
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if (((bArr2[bArr2.length - 1] & Ascii.f53593SI) ^ Ascii.f53586FF) != 0) {
            return returnFalse(bArr2);
        }
        int i = 2;
        ...
        int i2 = 0;
        while (i2 != bArr2.length && ((bArr2[i2] & Ascii.f53593SI) ^ 10) != 0) {
            i2++;
        }
        int i3 = i2 + 1;
        int digestSize = this.digest.getDigestSize();
