...
public class BCElGamalPublicKey implements DHPublicKey, ElGamalPublicKey {
    ...
    BCElGamalPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f6236y = dHPublicKeySpec.getY();
    ...
    BCElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f6236y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    BCElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f6236y = elGamalPublicKeyParameters.getY();
    ...
    BCElGamalPublicKey(ElGamalPublicKey elGamalPublicKey) {
        this.f6236y = elGamalPublicKey.getY();
        this.elSpec = elGamalPublicKey.getParameters();
    }

    BCElGamalPublicKey(ElGamalPublicKeySpec elGamalPublicKeySpec) {
        this.f6236y = elGamalPublicKeySpec.getY();
    ...
    public byte[] getEncoded() {
        try {
            return new SubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), (ASN1Encodable) new ASN1Integer(this.f6236y)).getEncoded(ASN1Encoding.DER);
        } catch (IOException unused) {
            return null;
        }
    }
