...
public final class FlowableSkipLastTimed<T> extends C21208a<T, T> {

    /* renamed from: a */
    final long f58456a;

    /* renamed from: b */
    final TimeUnit f58457b;

    /* renamed from: c */
    final Scheduler f58458c;

    /* renamed from: d */
    final int f58459d;

    /* renamed from: e */
    final boolean f58460e;

    public FlowableSkipLastTimed(Flowable<T> flowable, long j, TimeUnit timeUnit, Scheduler scheduler, int i, boolean z) {
        super(flowable);
        this.f58456a = j;
        this.f58457b = timeUnit;
        this.f58458c = scheduler;
        this.f58459d = i;
        this.f58460e = z;
    }
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new SkipLastTimedSubscriber(subscriber, this.f58456a, this.f58457b, this.f58458c, this.f58459d, this.f58460e));
    }
