...
public class XPanelYogaLayout extends YogaLayout implements IParser, IView {
    ...
    /* renamed from: b */
    private YogaNode f49689b;

    /* renamed from: c */
    private boolean f49690c;

    /* renamed from: d */
    private Path f49691d;

    /* renamed from: e */
    private Paint f49692e;

    /* renamed from: f */
    private RectF f49693f;

    /* renamed from: g */
    private float f49694g;

    /* renamed from: h */
    private float[] f49695h;
    ...
    public XPanelYogaLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f49695h = new float[8];
        this.f49688a = context;
        this.f49689b = getYogaNode();
        this.f49693f = new RectF();
        this.f49691d = new Path();
        Paint paint = new Paint();
        this.f49692e = paint;
        paint.setAntiAlias(true);
        this.f49692e.setColor(0);
        this.f49692e.setStyle(Paint.Style.STROKE);
    }
    ...
    public void parse(XmlPullParser xmlPullParser) {
        ...
        if (!TextUtils.isEmpty(attributeValue)) {
            this.f49689b.setFlexDirection(getFlexDirection(attributeValue));
        }
        if (!TextUtils.isEmpty(attributeValue2)) {
            this.f49689b.setWrap(getFlexWrap(attributeValue2));
        }
        if (!TextUtils.isEmpty(attributeValue3)) {
            this.f49689b.setJustifyContent(getJustifyContent(attributeValue3));
        }
        if (!TextUtils.isEmpty(attributeValue4)) {
            this.f49689b.setAlignItems(getAlignItems(attributeValue4));
        }
        if (!TextUtils.isEmpty(attributeValue5)) {
            this.f49689b.setAlignContent(getAlignContent(attributeValue5));
        }
    }
    ...
    public void parse(java.lang.String r2, java.lang.String r3, com.facebook.yoga.YogaNode r4) {
        ...
        L_0x0052:
            ...
            throw r3
        L_0x0069:
            com.facebook.yoga.YogaNode r2 = r1.f49689b
    ...
    public void setBorder(Border border) {
        ...
        this.f49694g = borderWidth;
        this.f49692e.setStrokeWidth(borderWidth);
        this.f49692e.setColor(border.getBorderColor());
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.f49690c) {
            this.f49691d.reset();
            this.f49693f.left = this.f49694g / 2.0f;
            this.f49693f.top = this.f49694g / 2.0f;
            this.f49693f.right = ((float) getMeasuredWidth()) - (this.f49694g / 2.0f);
            this.f49693f.bottom = ((float) getMeasuredHeight()) - (this.f49694g / 2.0f);
            this.f49691d.addRoundRect(this.f49693f, this.f49695h, Path.Direction.CW);
            canvas.drawPath(this.f49691d, this.f49692e);
        }
    }

    public void setCorner(Corner corner) {
        float[] fArr = this.f49695h;
        float leftTopCorner = corner.getLeftTopCorner();
        fArr[1] = leftTopCorner;
        fArr[0] = leftTopCorner;
        float[] fArr2 = this.f49695h;
        float rightTopCorner = corner.getRightTopCorner();
        fArr2[3] = rightTopCorner;
        fArr2[2] = rightTopCorner;
        float[] fArr3 = this.f49695h;
        float rightBottomCorner = corner.getRightBottomCorner();
        fArr3[5] = rightBottomCorner;
        fArr3[4] = rightBottomCorner;
        float[] fArr4 = this.f49695h;
