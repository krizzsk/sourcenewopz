...
abstract class BinaryReader implements Reader {
    ...
    /* synthetic */ BinaryReader(C193371 r1) {
        this();
    }
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        private Object readField(WireFormat.FieldType fieldType, Class<?> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            switch (C193371.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
                case 1:
            ...
            if (i2 != i) {
                ...
                if (b2 >= 0) {
                    ...
                    if (b3 < 0) {
                        ...
                        int i5 = i4 + 1;
                        byte b4 = b3 ^ (bArr[i4] << Ascii.f53594SO);
                        if (b4 >= 0) {
                            b = b4 ^ 16256;
                        } else {
                            i4 = i5 + 1;
                            ...
                            if (b5 < 0) {
                                ...
                                i5 = i4 + 1;
                                byte b6 = bArr[i4];
                                b = (b5 ^ (b6 << Ascii.f53587FS)) ^ 266354560;
                                if (b6 < 0) {
                                    i4 = i5 + 1;
                                    if (bArr[i5] < 0) {
                                        i5 = i4 + 1;
            ...
            if (i3 != i2) {
                ...
                if (b2 >= 0) {
                    ...
                    if (b3 < 0) {
                        ...
                        int i6 = i5 + 1;
                        byte b4 = b3 ^ (bArr[i5] << Ascii.f53594SO);
                        if (b4 >= 0) {
                            i = i6;
                            j = (long) (b4 ^ 16256);
                        } else {
    ...
    static /* synthetic */ class C193371 {
        ...
        static {
            ...
            L_0x00cc:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.BinaryReader.C193371.<clinit>():void");
        }
    }
}
