...
public class ECNamedCurveSpec extends ECParameterSpec {
    ...
    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.bouncycastle.math.p082ec.ECPoint eCPoint, BigInteger bigInteger) {
        super(convertCurve(eCCurve, (byte[]) null), EC5Util.convertPoint(eCPoint), bigInteger, 1);
        this.name = str;
    }

    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.bouncycastle.math.p082ec.ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2) {
        super(convertCurve(eCCurve, (byte[]) null), EC5Util.convertPoint(eCPoint), bigInteger, bigInteger2.intValue());
        this.name = str;
    }

    public ECNamedCurveSpec(String str, ECCurve eCCurve, org.bouncycastle.math.p082ec.ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
