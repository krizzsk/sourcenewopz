...
public class XAxisRenderer extends AxisRenderer {
    ...
    /* renamed from: a */
    float[] f52487a = new float[4];

    /* renamed from: b */
    private Path f52488b = new Path();
    ...
    public void computeAxis(float f, float f2, boolean z) {
        ...
        if (this.mViewPortHandler.contentWidth() > 10.0f && !this.mViewPortHandler.isFullyZoomedOutX()) {
            ...
            if (z) {
                f3 = (float) valuesByTouchPoint2.f52495x;
                d = valuesByTouchPoint.f52495x;
            } else {
                f3 = (float) valuesByTouchPoint.f52495x;
                d = valuesByTouchPoint2.f52495x;
            }
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mXAxis.isEnabled() && this.mXAxis.isDrawLabelsEnabled()) {
            ...
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP) {
                instance.f52498x = 0.5f;
                instance.f52499y = 1.0f;
    ...
    public void renderLimitLineLine(Canvas canvas, LimitLine limitLine, float[] fArr) {
        float[] fArr2 = this.f52487a;
        fArr2[0] = fArr[0];
        fArr2[1] = this.mViewPortHandler.contentTop();
        float[] fArr3 = this.f52487a;
        fArr3[2] = fArr[0];
        fArr3[3] = this.mViewPortHandler.contentBottom();
        this.f52488b.reset();
        Path path = this.f52488b;
        float[] fArr4 = this.f52487a;
        path.moveTo(fArr4[0], fArr4[1]);
        Path path2 = this.f52488b;
        float[] fArr5 = this.f52487a;
        path2.lineTo(fArr5[2], fArr5[3]);
        this.mLimitLinePaint.setStyle(Paint.Style.STROKE);
        this.mLimitLinePaint.setColor(limitLine.getLineColor());
        this.mLimitLinePaint.setStrokeWidth(limitLine.getLineWidth());
        this.mLimitLinePaint.setPathEffect(limitLine.getDashPathEffect());
        canvas.drawPath(this.f52488b, this.mLimitLinePaint);
    }
