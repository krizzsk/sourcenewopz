...
class Camera2Session implements CameraSession {
    ...
    private class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m3800d(Camera2Session.TAG, "Camera opened.");
        ...
        public void onClosed(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m3800d(Camera2Session.TAG, "Camera device closed.");
    ...
    private class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m3800d(Camera2Session.TAG, "Camera capture session configured.");
            ...
            try {
                ...
                Logging.m3800d(Camera2Session.TAG, "Camera device successfully started.");
        ...
        public /* synthetic */ void lambda$onConfigured$0$Camera2Session$CaptureSessionCallback(VideoFrame videoFrame) {
            ...
            if (Camera2Session.this.state != SessionState.RUNNING) {
                Logging.m3800d(Camera2Session.TAG, "Texture frame captured but camera is no longer running.");
                return;
            }
        ...
        private void chooseStabilizationMode(CaptureRequest.Builder builder) {
            ...
            if (iArr != null) {
                for (int i : iArr) {
                    if (i == 1) {
                        ...
                        Logging.m3800d(Camera2Session.TAG, "Using optical stabilization.");
                        return;
                    }
                }
            }
            for (int i2 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES)) {
                if (i2 == 1) {
                    ...
                    Logging.m3800d(Camera2Session.TAG, "Using video stabilization.");
                    return;
                }
            }
            Logging.m3800d(Camera2Session.TAG, "Stabilization not available.");
        }
        ...
        private void chooseFocusMode(CaptureRequest.Builder builder) {
            for (int i : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i == 3) {
                    ...
                    Logging.m3800d(Camera2Session.TAG, "Using continuous video auto-focus.");
                    return;
                }
            }
            Logging.m3800d(Camera2Session.TAG, "Auto-focus is not available.");
        }
    }
    ...
    private static class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            Logging.m3800d(Camera2Session.TAG, "Capture failed: " + captureFailure);
        }
    }
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events2, Context context, CameraManager cameraManager2, SurfaceTextureHelper surfaceTextureHelper2, String str, int i, int i2, int i3) {
        Logging.m3800d(TAG, "Create new camera2 session on camera " + str);
    ...
    private void findCaptureFormat() {
        ...
        Logging.m3800d(TAG, "Available preview sizes: " + supportedSizes);
        Logging.m3800d(TAG, "Available fps ranges: " + convertFramerates);
        ...
        Logging.m3800d(TAG, "Using capture format: " + this.captureFormat);
    }

    private void openCamera() {
        checkIsOnCameraThread();
        Logging.m3800d(TAG, "Opening camera " + this.cameraId);
    ...
    public void stop() {
        Logging.m3800d(TAG, "Stop camera2 session on camera " + this.cameraId);
        checkIsOnCameraThread();
    ...
    public void stopInternal() {
        Logging.m3800d(TAG, "Stop internal");
        checkIsOnCameraThread();
        ...
        Logging.m3800d(TAG, "Stop done");
    }

    /* access modifiers changed from: private */
    public void reportError(String str) {
        checkIsOnCameraThread();
        Logging.m3801e(TAG, "Error: " + str);
