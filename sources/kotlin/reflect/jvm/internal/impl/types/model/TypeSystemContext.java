...
public interface TypeSystemContext extends TypeSystemOptimizationContext {
    ...
    public static final class DefaultImpls {
        ...
        public static TypeArgumentMarker get(TypeSystemContext typeSystemContext, TypeArgumentListMarker typeArgumentListMarker, int i) {
            ...
            throw new IllegalStateException(("unknown type argument list type: " + typeArgumentListMarker + ", " + C21490Reflection.getOrCreateKotlinClass(typeArgumentListMarker.getClass())).toString());
        }
