...
public final class HeapValue {
    ...
    public final Boolean getAsBoolean() {
        ValueHolder valueHolder = this.f4540b;
    ...
    public final Long getAsNonNullObjectId() {
        ...
        return Long.valueOf(((ValueHolder.ReferenceHolder) this.f4540b).getValue());
    }
    ...
    public final HeapObject getAsObject() {
        ...
        return this.f4539a.findObjectById(((ValueHolder.ReferenceHolder) this.f4540b).getValue());
    }
    ...
    public final String readAsJavaString() {
        ...
        ValueHolder valueHolder = this.f4540b;
        if (!(valueHolder instanceof ValueHolder.ReferenceHolder) || ((ValueHolder.ReferenceHolder) valueHolder).isNull() || (findObjectByIdOrNull = this.f4539a.findObjectByIdOrNull(((ValueHolder.ReferenceHolder) this.f4540b).getValue())) == null || (asInstance = findObjectByIdOrNull.getAsInstance()) == null) {
            return null;
        }
