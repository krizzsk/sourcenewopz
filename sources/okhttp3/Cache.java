...
public final class Cache implements Closeable, Flushable {
    ...
    /* renamed from: e */
    private static final int f5085e = 201105;
    ...
    /* renamed from: h */
    private static final int f5088h = 2;

    /* renamed from: a */
    final InternalCache f5089a;

    /* renamed from: b */
    final DiskLruCache f5090b;
    ...
    Cache(File file, long j, FileSystem fileSystem) {
        this.f5089a = new InternalCache() {
            public Response get(Request request) throws IOException {
                return Cache.this.mo24602a(request);
            }

            public CacheRequest put(Response response) throws IOException {
                return Cache.this.mo24603a(response);
            }

            public void remove(Request request) throws IOException {
                Cache.this.mo24607b(request);
            }

            public void update(Response response, Response response2) {
                Cache.this.mo24605a(response, response2);
            }
            ...
            public void trackResponse(CacheStrategy cacheStrategy) {
                Cache.this.mo24606a(cacheStrategy);
            }
        };
        this.f5090b = DiskLruCache.create(fileSystem, file, f5085e, 2, j);
    }
    ...
    @Nullable
    /* renamed from: a */
    public Response mo24602a(Request request) {
        try {
            DiskLruCache.Snapshot snapshot = this.f5090b.get(key(request.url()));
            if (snapshot == null) {
                return null;
            }
            try {
                ...
                C2434Util.closeQuietly((Closeable) snapshot);
                return null;
            }
    ...
    @Nullable
    /* renamed from: a */
    public CacheRequest mo24603a(Response response) {
        DiskLruCache.Editor editor;
        String method = response.request().method();
        if (HttpMethod.invalidatesCache(response.request().method())) {
            try {
                mo24607b(response.request());
            } catch (IOException unused) {
            }
            return null;
            ...
            try {
                editor = this.f5090b.edit(key(response.request().url()));
                if (editor == null) {
                    return null;
                }
                try {
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public void mo24607b(Request request) throws IOException {
        this.f5090b.remove(key(request.url()));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public void mo24605a(Response response, Response response2) {
        DiskLruCache.Editor editor;
    ...
    /* renamed from: a */
    private void m3312a(@Nullable DiskLruCache.Editor editor) {
        if (editor != null) {
            try {
                editor.abort();
            } catch (IOException unused) {
    ...
    public void evictAll() throws IOException {
        this.f5090b.evictAll();
    }

    public Iterator<String> urls() throws IOException {
        return new Iterator<String>() {
            boolean canRemove;
            final Iterator<DiskLruCache.Snapshot> delegate = Cache.this.f5090b.snapshots();
            @Nullable
            String nextUrl;
    ...
    public File directory() {
        return this.f5090b.getDirectory();
    }

    public boolean isClosed() {
        return this.f5090b.isClosed();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public synchronized void mo24606a(CacheStrategy cacheStrategy) {
        this.f5095k++;
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public synchronized void mo24604a() {
        this.f5094j++;
    }
        ...
        public void abort() {
            synchronized (Cache.this) {
                if (!this.done) {
                    this.done = true;
                    Cache.this.f5092d++;
                    C2434Util.closeQuietly((Closeable) this.cacheOut);
                    try {
                        this.editor.abort();
                    } catch (IOException unused) {
                    }
    ...
    private static final class Entry {
        ...
        private List<Certificate> readCertificateList(BufferedSource bufferedSource) throws IOException {
            int a = Cache.m3311a(bufferedSource);
            if (a == -1) {
    ...
    /* renamed from: a */
    static int m3311a(BufferedSource bufferedSource) throws IOException {
        try {
