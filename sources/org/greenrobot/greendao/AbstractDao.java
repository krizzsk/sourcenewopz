...
import org.greenrobot.greendao.p085rx.RxDao;
...
public abstract class AbstractDao<T, K> {
    ...
    /* renamed from: db */
    protected final Database f6569db;
    ...
    public AbstractDao(DaoConfig daoConfig, AbstractDaoSession abstractDaoSession) {
        ...
        Database database = daoConfig.f6573db;
        this.f6569db = database;
    ...
    public T load(K k) {
        ...
        return loadUniqueAndCloseCursor(this.f6569db.rawQuery(this.statements.getSelectByKey(), new String[]{k.toString()}));
    }

    public T loadByRowId(long j) {
        return loadUniqueAndCloseCursor(this.f6569db.rawQuery(this.statements.getSelectByRowId(), new String[]{Long.toString(j)}));
    }
    ...
    public List<T> loadAll() {
        return loadAllAndCloseCursor(this.f6569db.rawQuery(this.statements.getSelectAll(), (String[]) null));
    }
    ...
    private void executeInsertInTx(DatabaseStatement databaseStatement, Iterable<T> iterable, boolean z) {
        ...
        try {
            ...
            this.f6569db.setTransactionSuccessful();
        } finally {
            this.f6569db.endTransaction();
        }
    }
    ...
    private long executeInsert(T t, DatabaseStatement databaseStatement, boolean z) {
        long j;
        if (this.f6569db.isDbLockedByCurrentThread()) {
    ...
    public void updateKeyAfterInsertAndAttach(T t, long j, boolean z) {
        if (j != -1) {
            ...
            DaoLog.m3761w("Could not insert row (executeInsert returned -1)");
        }
    }
    ...
    public java.util.List<T> loadAllFromCursor(android.database.Cursor r7) {
        ...
        L_0x002d:
            ...
            org.greenrobot.greendao.DaoLog.m3753d(r3)
        L_0x004d:
            r3 = 0
        L_0x004e:
    ...
    public List<T> queryRaw(String str, String... strArr) {
        Database database = this.f6569db;
    ...
    public void refresh(T t) {
        ...
        Cursor rawQuery = this.f6569db.rawQuery(this.statements.getSelectByKey(), new String[]{keyVerified.toString()});
        try {
    ...
    public void updateInTx(Iterable<T> iterable) {
        ...
        try {
            ...
            try {
                ...
                DaoLog.m3762w("Could not end transaction (rethrowing initial exception)", e3);
                throw e;
            }
        } catch (Throwable th) {
            try {
