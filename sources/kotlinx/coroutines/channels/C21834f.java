...
final class C21834f<E> extends C21829a<E> implements SelectClause2<E, SendChannel<? super E>> {

    /* renamed from: a */
    private Continuation<? super Unit> f61399a;

    public C21834f(CoroutineContext coroutineContext, Channel<E> channel, Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        super(coroutineContext, channel, false);
        this.f61399a = IntrinsicsKt.createCoroutineUnintercepted(function2, this, this);
    }

    /* access modifiers changed from: protected */
    public void onStart() {
        CancellableKt.startCoroutineCancellable(this.f61399a, (Continuation<?>) this);
    }
    ...
    public Object m48277trySendJP2dKIU(E e) {
        start();
        return super.m48249trySendJP2dKIU(e);
    }
