...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m38358on(" ").omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m38510of(String str, ClassLoader classLoader) {
    ...
    public static final class ClassInfo extends ResourceInfo {
        ...
        public String getPackageName() {
            return C19100Reflection.getPackageName(this.className);
        }
    ...
    static abstract class Scanner {
        ...
        static com.google.common.collect.ImmutableList<java.net.URL> parseJavaClassPath() {
            /*
                ...
                com.google.common.base.Splitter r1 = com.google.common.base.Splitter.m38358on((java.lang.String) r1)
    ...
    static final class DefaultScanner extends Scanner {
        ...
        public ImmutableSet<ResourceInfo> getResources() {
            ...
            for (Map.Entry next : this.resources.entries()) {
                builder.add((Object) ResourceInfo.m38510of((String) next.getValue(), (ClassLoader) next.getKey()));
            }
            return builder.build();
        }
