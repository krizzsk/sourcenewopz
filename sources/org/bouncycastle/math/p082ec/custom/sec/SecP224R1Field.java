...
public class SecP224R1Field {
    ...
    /* renamed from: M */
    private static final long f6357M = 4294967295L;

    /* renamed from: P */
    static final int[] f6358P = {1, 0, 0, -1, -1, -1, -1};

    /* renamed from: P6 */
    private static final int f6359P6 = -1;
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat224.add(iArr, iArr2, iArr3) != 0 || (iArr3[6] == -1 && Nat224.gte(iArr3, f6358P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(7, iArr, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f6358P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[6] == -1 && Nat224.gte(fromBigInteger, f6358P)) {
            Nat224.subFrom(f6358P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(7, iArr2, Nat224.add(iArr, f6358P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f6358P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(7, iArr, f6358P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        iArr3[3] = (int) j20;
        if (((j20 >> 32) != 0 && Nat.incAt(7, iArr3, 4) != 0) || (iArr3[6] == -1 && Nat224.gte(iArr3, f6358P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if ((j != 0 && Nat.incAt(7, iArr, 4) != 0) || (iArr[6] == -1 && Nat224.gte(iArr, f6358P))) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(7, iArr, 0, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f6358P))) {
            addPInvTo(iArr2);
        }
    }
}
