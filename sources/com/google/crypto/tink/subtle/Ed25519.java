...
final class Ed25519 {
    ...
    /* renamed from: eq */
    private static int m38517eq(int i, int i2) {
        int i3 = (~(i ^ i2)) & 255;
        int i4 = i3 & (i3 << 4);
        int i5 = i4 & (i4 << 2);
        return ((i5 & (i5 << 1)) >> 7) & 1;
    ...
    private static class XYZ {
        ...
        XYZ(XYZ xyz) {
            this.f53761x = Arrays.copyOf(xyz.f53761x, 10);
            this.f53762y = Arrays.copyOf(xyz.f53762y, 10);
            this.f53763z = Arrays.copyOf(xyz.f53763z, 10);
        }
        ...
        static XYZ fromPartialXYZT(XYZ xyz, PartialXYZT partialXYZT) {
            Field25519.mult(xyz.f53761x, partialXYZT.xyz.f53761x, partialXYZT.f53760t);
            Field25519.mult(xyz.f53762y, partialXYZT.xyz.f53762y, partialXYZT.xyz.f53763z);
            Field25519.mult(xyz.f53763z, partialXYZT.xyz.f53763z, partialXYZT.f53760t);
            return xyz;
        }
        ...
        public byte[] toBytes() {
            ...
            Field25519.inverse(jArr, this.f53763z);
            Field25519.mult(jArr2, this.f53761x, jArr);
            Field25519.mult(jArr3, this.f53762y, jArr);
        ...
        public boolean isOnCurve() {
            long[] jArr = new long[10];
            Field25519.square(jArr, this.f53761x);
            long[] jArr2 = new long[10];
            Field25519.square(jArr2, this.f53762y);
            long[] jArr3 = new long[10];
            Field25519.square(jArr3, this.f53763z);
            ...
            Field25519.mult(jArr6, jArr6, Ed25519Constants.f53766D);
    ...
    private static class XYZT {
        ...
        public static XYZT fromPartialXYZT(XYZT xyzt, PartialXYZT partialXYZT) {
            Field25519.mult(xyzt.xyz.f53761x, partialXYZT.xyz.f53761x, partialXYZT.f53760t);
            Field25519.mult(xyzt.xyz.f53762y, partialXYZT.xyz.f53762y, partialXYZT.xyz.f53763z);
            Field25519.mult(xyzt.xyz.f53763z, partialXYZT.xyz.f53763z, partialXYZT.f53760t);
            Field25519.mult(xyzt.f53764t, partialXYZT.xyz.f53761x, partialXYZT.xyz.f53762y);
            return xyzt;
        }
        ...
        public static XYZT fromBytesNegateVarTime(byte[] bArr) throws GeneralSecurityException {
            ...
            Field25519.mult(jArr5, jArr4, Ed25519Constants.f53766D);
    ...
    private static class PartialXYZT {
        ...
        PartialXYZT(PartialXYZT partialXYZT) {
            ...
            this.f53760t = Arrays.copyOf(partialXYZT.f53760t, 10);
        }
    }
    ...
    private static class CachedXYZT extends CachedXYT {
        ...
        CachedXYZT(XYZT xyzt) {
            this();
            Field25519.sum(this.yPlusX, xyzt.xyz.f53762y, xyzt.xyz.f53761x);
            Field25519.sub(this.yMinusX, xyzt.xyz.f53762y, xyzt.xyz.f53761x);
            System.arraycopy(xyzt.xyz.f53763z, 0, this.f53759z, 0, 10);
            Field25519.mult(this.t2d, xyzt.f53764t, Ed25519Constants.f53767D2);
        }
        ...
        public void multByZ(long[] jArr, long[] jArr2) {
            Field25519.mult(jArr, jArr2, this.f53759z);
        }
    }

    private static void add(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        long[] jArr = new long[10];
        Field25519.sum(partialXYZT.xyz.f53761x, xyzt.xyz.f53762y, xyzt.xyz.f53761x);
        Field25519.sub(partialXYZT.xyz.f53762y, xyzt.xyz.f53762y, xyzt.xyz.f53761x);
        Field25519.mult(partialXYZT.xyz.f53762y, partialXYZT.xyz.f53762y, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.xyz.f53763z, partialXYZT.xyz.f53761x, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.f53760t, xyzt.f53764t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f53761x, xyzt.xyz.f53763z);
        Field25519.sum(jArr, partialXYZT.xyz.f53761x, partialXYZT.xyz.f53761x);
        Field25519.sub(partialXYZT.xyz.f53761x, partialXYZT.xyz.f53763z, partialXYZT.xyz.f53762y);
        Field25519.sum(partialXYZT.xyz.f53762y, partialXYZT.xyz.f53763z, partialXYZT.xyz.f53762y);
        Field25519.sum(partialXYZT.xyz.f53763z, jArr, partialXYZT.f53760t);
        Field25519.sub(partialXYZT.f53760t, jArr, partialXYZT.f53760t);
    }
    ...
    private static void sub(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        ...
        Field25519.sum(partialXYZT.xyz.f53761x, xyzt.xyz.f53762y, xyzt.xyz.f53761x);
        Field25519.sub(partialXYZT.xyz.f53762y, xyzt.xyz.f53762y, xyzt.xyz.f53761x);
        Field25519.mult(partialXYZT.xyz.f53762y, partialXYZT.xyz.f53762y, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.xyz.f53763z, partialXYZT.xyz.f53761x, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.f53760t, xyzt.f53764t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f53761x, xyzt.xyz.f53763z);
        Field25519.sum(jArr, partialXYZT.xyz.f53761x, partialXYZT.xyz.f53761x);
        Field25519.sub(partialXYZT.xyz.f53761x, partialXYZT.xyz.f53763z, partialXYZT.xyz.f53762y);
        Field25519.sum(partialXYZT.xyz.f53762y, partialXYZT.xyz.f53763z, partialXYZT.xyz.f53762y);
        Field25519.sub(partialXYZT.xyz.f53763z, jArr, partialXYZT.f53760t);
        Field25519.sum(partialXYZT.f53760t, jArr, partialXYZT.f53760t);
    }

    private static void doubleXYZ(PartialXYZT partialXYZT, XYZ xyz) {
        long[] jArr = new long[10];
        Field25519.square(partialXYZT.xyz.f53761x, xyz.f53761x);
        Field25519.square(partialXYZT.xyz.f53763z, xyz.f53762y);
        Field25519.square(partialXYZT.f53760t, xyz.f53763z);
        Field25519.sum(partialXYZT.f53760t, partialXYZT.f53760t, partialXYZT.f53760t);
        Field25519.sum(partialXYZT.xyz.f53762y, xyz.f53761x, xyz.f53762y);
        Field25519.square(jArr, partialXYZT.xyz.f53762y);
        Field25519.sum(partialXYZT.xyz.f53762y, partialXYZT.xyz.f53763z, partialXYZT.xyz.f53761x);
        Field25519.sub(partialXYZT.xyz.f53763z, partialXYZT.xyz.f53763z, partialXYZT.xyz.f53761x);
        Field25519.sub(partialXYZT.xyz.f53761x, jArr, partialXYZT.xyz.f53762y);
        Field25519.sub(partialXYZT.f53760t, partialXYZT.f53760t, partialXYZT.xyz.f53763z);
    }
    ...
    private static void select(CachedXYT cachedXYT, int i, byte b) {
        int i2 = (b & 255) >> 7;
        int i3 = b - (((-i2) & b) << 1);
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][0], m38517eq(i3, 1));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][1], m38517eq(i3, 2));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][2], m38517eq(i3, 3));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][3], m38517eq(i3, 4));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][4], m38517eq(i3, 5));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][5], m38517eq(i3, 6));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][6], m38517eq(i3, 7));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][7], m38517eq(i3, 8));
    ...
    private static XYZ doubleScalarMultVarTime(byte[] bArr, XYZT xyzt, byte[] bArr2) {
        ...
        while (i2 >= 0) {
            ...
            if (slide2[i2] > 0) {
                add(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f53765B2[slide2[i2] / 2]);
            } else if (slide2[i2] < 0) {
                sub(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f53765B2[(-slide2[i2]) / 2]);
            }
            i2--;
        }
