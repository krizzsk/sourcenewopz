...
class LongArray implements Cloneable {
    ...
    private static final int[] INTERLEAVE3_TABLE = {0, 1, 8, 9, 64, 65, 72, 73, 512, 513, 520, 521, 576, 577, 584, 585, 4096, 4097, 4104, 4105, 4160, 4161, 4168, 4169, 4608, 4609, 4616, 4617, 4672, 4673, 4680, 4681, 32768, 32769, 32776, 32777, 32832, 32833, 32840, 32841, 33280, 33281, 33288, 33289, 33344, 33345, 33352, 33353, 36864, 36865, 36872, 36873, 36928, 36929, 36936, 36937, C13565R2.styleable.Constraint_animateCircleAngleTo, C13565R2.styleable.Constraint_animateRelativeTo, C13565R2.styleable.Constraint_constraint_referenced_tags, C13565R2.styleable.Constraint_drawPath, C13565R2.styleable.Constraint_layout_constraintTop_toBottomOf, C13565R2.styleable.Constraint_layout_constraintTop_toTopOf, C13565R2.styleable.Constraint_layout_constraintWidth_min, C13565R2.styleable.Constraint_layout_constraintWidth_percent, 262144, 262145, 262152, 262153, 262208, 262209, 262216, 262217, 262656, 262657, 262664, 262665, 262720, 262721, 262728, 262729, 266240, 266241, 266248, 266249, 266304, 266305, 266312, 266313, 266752, 266753, 266760, 266761, 266816, 266817, 266824, 266825, 294912, 294913, 294920, 294921, 294976, 294977, 294984, 294985, 295424, 295425, 295432, 295433, 295488, 295489, 295496, 295497, 299008, 299009, 299016, 299017, 299072, 299073, 299080, 299081, 299520, 299521, 299528, 299529, 299584, 299585, 299592, 299593};
    ...
    private static int bitLength(long r3) {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p082ec.LongArray.bitLength(long):int");
    }
