...
public final class PollVM$pollPixKeyStatus$1 extends WNetCallback<PollStatusResp> {
    ...
    public void onSuccess(PollStatusResp pollStatusResp) {
        ...
        if (pollStatusResp.errno != 60201) {
            ...
            this.this$0.f30940c.schedule(new Runnable(this.$keyType, this.$keyVal, this.$pollType, this.$callback) {
                ...
                public final void run() {
                    PollVM$pollPixKeyStatus$1.m46581onSuccess$lambda0(PollVM.this, this.f$1, this.f$2, this.f$3, this.f$4);
                }
            }, 1, TimeUnit.SECONDS);
        } else {
            this.this$0.isLoading().setValue(false);
    ...
    public static final void m46581onSuccess$lambda0(PollVM pollVM, int i, String str, int i2, IPollResultCallback iPollResultCallback) {
