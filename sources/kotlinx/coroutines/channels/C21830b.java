...
class C21830b<E> extends AbstractCoroutine<Unit> implements BroadcastChannel<E>, ProducerScope<E> {
    ...
    public void cancelInternal(Throwable th) {
        ...
        this.f61398a.cancel(cancellationException$default);
    ...
    public void onCompleted(Unit unit) {
        SendChannel.DefaultImpls.close$default(this.f61398a, (Throwable) null, 1, (Object) null);
    }

    /* access modifiers changed from: protected */
    public void onCancelled(Throwable th, boolean z) {
        if (!this.f61398a.close(th) && !z) {
            CoroutineExceptionHandlerKt.handleCoroutineException(getContext(), th);
        }
    }

    public boolean close(Throwable th) {
        boolean close = this.f61398a.close(th);
        start();
        return close;
    }
