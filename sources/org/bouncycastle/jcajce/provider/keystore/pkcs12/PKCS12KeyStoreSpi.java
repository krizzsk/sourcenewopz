...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    private class CertId {
        ...
        CertId(PublicKey publicKey) {
            this.f6243id = PKCS12KeyStoreSpi.this.createSubjectKeyId(publicKey).getKeyIdentifier();
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Arrays.areEqual(this.f6243id, ((CertId) obj).f6243id);
        }

        public int hashCode() {
            return Arrays.hashCode(this.f6243id);
        }
    }
    ...
    public byte[] cryptData(boolean z, AlgorithmIdentifier algorithmIdentifier, char[] cArr, boolean z2, byte[] bArr) throws IOException {
        ...
        int i = z ? 1 : 2;
        if (algorithm.mo27791on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
