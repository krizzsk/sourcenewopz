...
public final class ObservableWindowBoundarySupplier<T, B> extends C21211a<T, Observable<T>> {

    /* renamed from: a */
    final Callable<? extends ObservableSource<B>> f59004a;
    ...
    public ObservableWindowBoundarySupplier(ObservableSource<T> observableSource, Callable<? extends ObservableSource<B>> callable, int i) {
        ...
        this.f59004a = callable;
        this.f59005b = i;
    }

    public void subscribeActual(Observer<? super Observable<T>> observer) {
        this.source.subscribe(new WindowBoundaryMainObserver(observer, this.f59005b, this.f59004a));
    }
