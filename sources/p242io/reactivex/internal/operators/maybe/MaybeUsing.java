...
public final class MaybeUsing<T, D> extends Maybe<T> {
    ...
    /* renamed from: a */
    final Callable<? extends D> f58640a;

    /* renamed from: b */
    final Function<? super D, ? extends MaybeSource<? extends T>> f58641b;

    /* renamed from: c */
    final Consumer<? super D> f58642c;

    /* renamed from: d */
    final boolean f58643d;
    ...
    public MaybeUsing(Callable<? extends D> callable, Function<? super D, ? extends MaybeSource<? extends T>> function, Consumer<? super D> consumer, boolean z) {
        this.f58640a = callable;
        this.f58641b = function;
        this.f58642c = consumer;
        this.f58643d = z;
    }
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        try {
            Object call = this.f58640a.call();
            try {
                ((MaybeSource) ObjectHelper.requireNonNull(this.f58641b.apply(call), "The sourceSupplier returned a null MaybeSource")).subscribe(new UsingObserver(maybeObserver, call, this.f58642c, this.f58643d));
            } catch (Throwable th) {
