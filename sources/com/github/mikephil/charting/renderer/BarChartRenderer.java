...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    /* renamed from: a */
    private RectF f52457a = new RectF();
    ...
    public void drawDataSet(Canvas canvas, IBarDataSet iBarDataSet, int i) {
        ...
        if (this.mChart.isDrawBarShadowEnabled()) {
            ...
            for (int i4 = 0; i4 < min; i4++) {
                ...
                this.f52457a.left = x - barWidth;
                this.f52457a.right = x + barWidth;
                transformer.rectValueToPixel(this.f52457a);
                if (!this.mViewPortHandler.isInBoundsLeft(this.f52457a.right)) {
                    Canvas canvas2 = canvas;
                } else if (!this.mViewPortHandler.isInBoundsRight(this.f52457a.left)) {
                    break;
                } else {
                    this.f52457a.top = this.mViewPortHandler.contentTop();
                    this.f52457a.bottom = this.mViewPortHandler.contentBottom();
                    canvas.drawRect(this.f52457a, this.mShadowPaint);
                }
            }
        }
                        ...
                        while (((float) i6) < ((float) barBuffer.buffer.length) * this.mAnimator.getPhaseX()) {
                            ...
                            if (!this.mViewPortHandler.isInBoundsY(barBuffer.buffer[i7]) || !this.mViewPortHandler.isInBoundsLeft(f13)) {
                                ...
                                if (barEntry3.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                    ...
                                    Utils.drawImage(canvas, icon, (int) (f8 + mPPointF2.f52498x), (int) ((y >= 0.0f ? barBuffer.buffer[i7] + f11 : barBuffer.buffer[i4 + 3] + f12) + mPPointF2.f52499y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                                }
                            }
                            i6 = i4 + 4;
                            instance = mPPointF2;
                            ...
                            if (yVals != null) {
                                ...
                                while (i15 < length) {
                                    ...
                                    if (!this.mViewPortHandler.isInBoundsY(f22) || !this.mViewPortHandler.isInBoundsLeft(f16)) {
                                        ...
                                        if (barEntry.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                            ...
                                            Utils.drawImage(canvas, icon2, (int) (f4 + mPPointF.f52498x), (int) (f5 + mPPointF.f52499y), icon2.getIntrinsicWidth(), icon2.getIntrinsicHeight());
                                        }
                                    }
                                    i15 = i3 + 2;
                                    fArr4 = fArr2;
                                ...
                                if (!this.mViewPortHandler.isInBoundsY(barBuffer.buffer[i17]) || !this.mViewPortHandler.isInBoundsLeft(f15)) {
                                    ...
                                    if (barEntry2.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                        ...
                                        Utils.drawImage(canvas, icon3, (int) (mPPointF.f52498x + f7), (int) (barBuffer.buffer[i17] + (barEntry2.getY() >= 0.0f ? f11 : f12) + mPPointF.f52499y), icon3.getIntrinsicWidth(), icon3.getIntrinsicHeight());
                                    }
                                }
                            }
