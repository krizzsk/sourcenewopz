...
import com.google.maps.android.p219ui.IconGenerator;
import com.google.maps.android.p219ui.SquareTextView;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public DefaultClusterRenderer(Context context, GoogleMap googleMap, ClusterManager<T> clusterManager) {
        ...
        this.mIconGenerator.setTextAppearance(2132018352);
    ...
    private static double distanceSquared(Point point, Point point2) {
        return ((point.f53781x - point2.f53781x) * (point.f53781x - point2.f53781x)) + ((point.f53782y - point2.f53782y) * (point.f53782y - point2.f53782y));
    }
    ...
    private class AnimationTask extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            LatLng unused = this.markerWithPosition.position = this.f53780to;
        }
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            double d2 = ((this.f53780to.latitude - this.from.latitude) * d) + this.from.latitude;
            double d3 = this.f53780to.longitude - this.from.longitude;
