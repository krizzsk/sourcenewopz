...
public final class CliSealedClassInheritorsProvider extends SealedClassInheritorsProvider {
    ...
    public Collection<ClassDescriptor> computeSealedSubclasses(ClassDescriptor classDescriptor, boolean z) {
        ...
        if (declarationDescriptor instanceof PackageFragmentDescriptor) {
            m44910a(classDescriptor, linkedHashSet, ((PackageFragmentDescriptor) declarationDescriptor).getMemberScope(), z);
        }
        ...
        m44910a(classDescriptor, linkedHashSet, unsubstitutedInnerClassesScope, true);
        return linkedHashSet;
    }

    /* renamed from: a */
    private static final void m44910a(ClassDescriptor classDescriptor, LinkedHashSet<ClassDescriptor> linkedHashSet, MemberScope memberScope, boolean z) {
            ...
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptor2 != null) {
                    ...
                    if (z) {
                        ...
                        m44910a(classDescriptor, linkedHashSet, unsubstitutedInnerClassesScope, z);
                    }
                }
            }
        }
