...
public final class HomeLeftImageBinderRoot extends BinderRoot<LeftImageBusinessItemWidget, ComponentModel> {
    ...
    public LeftImageBusinessItemWidget createView(Context context, ComponentModel componentModel) {
        ...
        Buildable renderViewWithData = BlocksEngine.Companion.getInstance$default(BlocksEngine.Companion, (String) null, 1, (Object) null).renderViewWithData(context, this.f42754a, componentModel.getWidgetNodeModel(), getConfig());
    ...
    public void bind(LeftImageBusinessItemWidget leftImageBusinessItemWidget, ComponentModel componentModel, int i) {
        ...
        BlocksEngine.Companion.getInstance$default(BlocksEngine.Companion, (String) null, 1, (Object) null).bindDataOnWidget(this.f42754a, buildable, componentModel.getWidgetNodeModel(), getConfig());
    }
}
