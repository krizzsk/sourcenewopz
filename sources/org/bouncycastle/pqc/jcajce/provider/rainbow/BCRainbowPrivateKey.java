...
public class BCRainbowPrivateKey implements PrivateKey {
    ...
    /* renamed from: b1 */
    private short[] f6543b1;

    /* renamed from: b2 */
    private short[] f6544b2;
    ...
    public boolean equals(Object obj) {
        ...
        boolean z = ((((RainbowUtil.equals(this.A1inv, bCRainbowPrivateKey.getInvA1())) && RainbowUtil.equals(this.A2inv, bCRainbowPrivateKey.getInvA2())) && RainbowUtil.equals(this.f6543b1, bCRainbowPrivateKey.getB1())) && RainbowUtil.equals(this.f6544b2, bCRainbowPrivateKey.getB2())) && Arrays.equals(this.f6545vi, bCRainbowPrivateKey.getVi());
    ...
    public int hashCode() {
        int length = (((((((((this.layers.length * 37) + org.bouncycastle.util.Arrays.hashCode(this.A1inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f6543b1)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.A2inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f6544b2)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f6545vi);
