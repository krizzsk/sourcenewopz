...
public class DHPublicKeyParameters extends DHKeyParameters {
    ...
    /* renamed from: y */
    private BigInteger f6152y;

    public DHPublicKeyParameters(BigInteger bigInteger, DHParameters dHParameters) {
        super(false, dHParameters);
        this.f6152y = validate(bigInteger, dHParameters);
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof DHPublicKeyParameters) && ((DHPublicKeyParameters) obj).getY().equals(this.f6152y) && super.equals(obj);
    }
    ...
    public int hashCode() {
        return this.f6152y.hashCode() ^ super.hashCode();
    }
}
