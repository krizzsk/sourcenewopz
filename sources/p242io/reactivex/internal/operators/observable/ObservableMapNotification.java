...
public final class ObservableMapNotification<T, R> extends C21211a<T, ObservableSource<? extends R>> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<? extends R>> f58869a;

    /* renamed from: b */
    final Function<? super Throwable, ? extends ObservableSource<? extends R>> f58870b;

    /* renamed from: c */
    final Callable<? extends ObservableSource<? extends R>> f58871c;
    ...
    public ObservableMapNotification(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<? extends R>> function, Function<? super Throwable, ? extends ObservableSource<? extends R>> function2, Callable<? extends ObservableSource<? extends R>> callable) {
        ...
        this.f58869a = function;
        this.f58870b = function2;
        this.f58871c = callable;
    }

    public void subscribeActual(Observer<? super ObservableSource<? extends R>> observer) {
        this.source.subscribe(new MapNotificationObserver(observer, this.f58869a, this.f58870b, this.f58871c));
    }
