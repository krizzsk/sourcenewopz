    ...
    public static void init(Context context) {
        ...
        Fly.setmImagePerformanceListener(new ImagePerformanceListener() {
            public void onImagePerformance(ImagePerformance imagePerformance) {
                ...
                LogUtil.m14761d("onImagePerformance", " type: " + imagePerformance.type + " totalTime: " + imagePerformance.totalTime + " isFromMemoryCache: " + imagePerformance.isFromMemoryCache + " imageCacheType: " + imageCacheType + " url: " + imagePerformance.url);
