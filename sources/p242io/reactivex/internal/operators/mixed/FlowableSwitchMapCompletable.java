...
public final class FlowableSwitchMapCompletable<T> extends Completable {
    ...
    /* renamed from: a */
    final Flowable<T> f58664a;

    /* renamed from: b */
    final Function<? super T, ? extends CompletableSource> f58665b;

    /* renamed from: c */
    final boolean f58666c;

    public FlowableSwitchMapCompletable(Flowable<T> flowable, Function<? super T, ? extends CompletableSource> function, boolean z) {
        this.f58664a = flowable;
        this.f58665b = function;
        this.f58666c = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(CompletableObserver completableObserver) {
        this.f58664a.subscribe(new SwitchMapCompletableObserver(completableObserver, this.f58665b, this.f58666c));
    }
