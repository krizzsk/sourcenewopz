...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    /* renamed from: T1 */
    private static CacheKey f6471T1;
    private static CacheKey[] internedKeys;

    /* renamed from: I */
    private final byte[] f6472I;
    ...
    private LMSPrivateKeyParameters(LMSPrivateKeyParameters lMSPrivateKeyParameters, int i, int i2) {
        ...
        this.f6473q = i;
        this.f6472I = lMSPrivateKeyParameters.f6472I;
        this.maxQ = i2;
    ...
    public static org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters getInstance(java.lang.Object r8) throws java.io.IOException {
        ...
        L_0x009a:
            ...
            byte[] r8 = org.bouncycastle.util.p084io.Streams.readAll(r8)
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f6473q != lMSPrivateKeyParameters.f6473q || this.maxQ != lMSPrivateKeyParameters.maxQ || !Arrays.areEqual(this.f6472I, lMSPrivateKeyParameters.f6472I)) {
            return false;
        }
    ...
    public LMSPrivateKeyParameters extractKeyShard(int i) {
        ...
        synchronized (this) {
            if (this.f6473q + i < this.maxQ) {
                lMSPrivateKeyParameters = new LMSPrivateKeyParameters(this, this.f6473q, this.f6473q + i);
                this.f6473q += i;
            } else {
    ...
    public LMOtsPrivateKey getCurrentOTSKey() {
        ...
        synchronized (this) {
            if (this.f6473q < this.maxQ) {
                lMOtsPrivateKey = new LMOtsPrivateKey(this.otsParameters, this.f6472I, this.f6473q, this.masterSecret);
            } else {
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(0).u32str(this.parameters.getType()).u32str(this.otsParameters.getType()).bytes(this.f6472I).u32str(this.f6473q).u32str(this.maxQ).u32str(this.masterSecret.length).bytes(this.masterSecret).build();
    }

    public byte[] getI() {
        return Arrays.clone(this.f6472I);
    }
    ...
    public LMSPublicKeyParameters getPublicKey() {
        ...
        synchronized (this) {
            if (this.publicKey == null) {
                this.publicKey = new LMSPublicKeyParameters(this.parameters, this.otsParameters, findT(f6471T1), this.f6472I);
            }
    ...
    public long getUsagesRemaining() {
        return (long) (this.maxQ - this.f6473q);
    }

    public int hashCode() {
        int hashCode = ((this.f6473q * 31) + Arrays.hashCode(this.f6472I)) * 31;
        LMSigParameters lMSigParameters = this.parameters;
        int i = 0;
