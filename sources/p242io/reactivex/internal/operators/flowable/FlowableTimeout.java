...
public final class FlowableTimeout<T, U, V> extends C21208a<T, T> {

    /* renamed from: a */
    final Publisher<U> f58492a;

    /* renamed from: b */
    final Function<? super T, ? extends Publisher<V>> f58493b;

    /* renamed from: c */
    final Publisher<? extends T> f58494c;
    ...
    public FlowableTimeout(Flowable<T> flowable, Publisher<U> publisher, Function<? super T, ? extends Publisher<V>> function, Publisher<? extends T> publisher2) {
        super(flowable);
        this.f58492a = publisher;
        this.f58493b = function;
        this.f58494c = publisher2;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        if (this.f58494c == null) {
            TimeoutSubscriber timeoutSubscriber = new TimeoutSubscriber(subscriber, this.f58493b);
            subscriber.onSubscribe(timeoutSubscriber);
            timeoutSubscriber.startFirstTimeout(this.f58492a);
            this.source.subscribe(timeoutSubscriber);
            return;
        }
        TimeoutFallbackSubscriber timeoutFallbackSubscriber = new TimeoutFallbackSubscriber(subscriber, this.f58493b, this.f58494c);
        subscriber.onSubscribe(timeoutFallbackSubscriber);
        timeoutFallbackSubscriber.startFirstTimeout(this.f58492a);
