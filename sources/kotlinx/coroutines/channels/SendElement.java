...
public class SendElement<E> extends Send {
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        this.cont.resumeWith(Result.m47688constructorimpl(ResultKt.createFailure(sendException)));
    }
