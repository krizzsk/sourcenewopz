...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    static {
        ...
        f61395f = symbol;
        f61396g = new State<>(symbol, (Subscriber<E>[]) null);
        f61391b = AtomicReferenceFieldUpdater.newUpdater(cls, Object.class, "_state");
        f61392c = AtomicIntegerFieldUpdater.newUpdater(cls, "_updating");
        f61393d = AtomicReferenceFieldUpdater.newUpdater(cls, Object.class, "onCloseHandler");
    }

    @Metadata(mo175977d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0002\u0018\u0000*\u0004\b\u0001\u0010\u00012\u00020\u0002B%\u0012\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002\u0012\u0014\u0010\u0004\u001a\u0010\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00010\u0006\u0018\u00010\u0005¢\u0006\u0002\u0010\u0007R \u0010\u0004\u001a\u0010\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00010\u0006\u0018\u00010\u00058\u0006X\u0004¢\u0006\u0004\n\u0002\u0010\bR\u0012\u0010\u0003\u001a\u0004\u0018\u00010\u00028\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, mo175978d2 = {"Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$State;", "E", "", "value", "subscribers", "", "Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Subscriber;", "(Ljava/lang/Object;[Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Subscriber;)V", "[Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Subscriber;", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: ConflatedBroadcastChannel.kt */
    ...
    @Metadata(mo175977d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0007\b\u0002\u0018\u00002\u00020\u0001B\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004R\u0012\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006X\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007R\u0011\u0010\b\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\t\u0010\u0007¨\u0006\n"}, mo175978d2 = {"Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Closed;", "", "closeCause", "", "(Ljava/lang/Throwable;)V", "sendException", "getSendException", "()Ljava/lang/Throwable;", "valueException", "getValueException", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: ConflatedBroadcastChannel.kt */
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        do {
            ...
            if (obj instanceof Closed) {
                ...
                state = (State) obj;
                if (state.value != f61395f) {
                    subscriber.offerInternal(state.value);
                }
            } else {
                throw new IllegalStateException(Intrinsics.stringPlus("Invalid state ", obj).toString());
            }
        } while (!f61391b.compareAndSet(this, obj, new State(state.value, m45556a(state.subscribers, subscriber))));
        return subscriber;
    }

    /* renamed from: a */
    private final Subscriber<E>[] m45556a(Subscriber<E>[] subscriberArr, Subscriber<E> subscriber) {
    ...
    /* renamed from: b */
    private final Subscriber<E>[] m45557b(Subscriber<E>[] subscriberArr, Subscriber<E> subscriber) {
    ...
    /* renamed from: a */
    private final void m45553a(Throwable th) {
        Object obj = this.onCloseHandler;
        if (obj != null && obj != AbstractChannelKt.HANDLER_INVOKED && f61393d.compareAndSet(this, obj, AbstractChannelKt.HANDLER_INVOKED)) {
            ((Function1) TypeIntrinsics.beforeCheckcastToFunctionOfArity(obj, 1)).invoke(th);
        }
    }

    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        if (!f61393d.compareAndSet(this, (Object) null, function1)) {
            Object obj = this.onCloseHandler;
        ...
        if ((obj2 instanceof Closed) && f61393d.compareAndSet(this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object m48270trySendJP2dKIU(E e) {
        Closed a = m45552a(e);
        if (a == null) {
            return ChannelResult.Companion.m48269successJP2dKIU(Unit.INSTANCE);
        }
        return ChannelResult.Companion.m48267closedJP2dKIU(a.getSendException());
    }

    /* renamed from: a */
    private final Closed m45552a(E e) {
        Object obj;
        if (!f61392c.compareAndSet(this, 0, 1)) {
            return null;
        }
        do {
            try {
        ...
        } while (!f61391b.compareAndSet(this, obj, new State(e, ((State) obj).subscribers)));
    ...
    /* renamed from: a */
    public final <R> void m45555a(SelectInstance<? super R> selectInstance, E e, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> function2) {
    ...
    private static final class Subscriber<E> extends ConflatedChannel<E> implements ReceiveChannel<E> {
        ...
        public void onCancelIdempotent(boolean z) {
            if (z) {
                this.broadcastChannel.m45554a(this);
            }
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public final void m45554a(Subscriber<E> subscriber) {
        Object obj;
        Object obj2;
        ...
        } while (!f61391b.compareAndSet(this, obj, new State(obj2, m45557b(subscriberArr, subscriber))));
    }
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!f61391b.compareAndSet(this, obj, th == null ? f61394e : new Closed(th)));
        Subscriber<E>[] subscriberArr = ((State) obj).subscribers;
        if (subscriberArr != null) {
