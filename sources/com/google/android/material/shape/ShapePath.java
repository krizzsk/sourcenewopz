...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f52608x = f;
        float unused2 = pathLineOperation.f52609y = f2;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f52609y - this.startY), (double) (this.operation.f52608x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f52609y - this.startY) / (this.operation.f52608x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        /* renamed from: x */
        public float f52608x;
        /* access modifiers changed from: private */

        /* renamed from: y */
        public float f52609y;

        public void applyToPath(Matrix matrix, Path path) {
            Matrix matrix2 = this.matrix;
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f52608x, this.f52609y);
