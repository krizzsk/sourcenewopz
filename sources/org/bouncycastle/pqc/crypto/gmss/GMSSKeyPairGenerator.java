...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            treehashArr[i5] = new Treehash[(iArr2[i5] - this.f6444K[i5])];
            if (i5 > 0) {
                int i7 = i5 - 1;
                int i8 = iArr2[i5];
                int[] iArr3 = new int[2];
                ...
                treehashArr2[i7] = new Treehash[(this.heightOfTrees[i5] - this.f6444K[i5])];
            }
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f6444K[i], this.digestProvider);
        ...
        while (true) {
            ...
            if (i5 == i3 && i4 < iArr[i] - this.f6444K[i]) {
    ...
    private GMSSRootCalc generateNextAuthpathAndRoot(Vector vector, byte[] bArr, int i) {
        ...
        while (true) {
            ...
            if (i2 == i4 && i3 < iArr[i] - this.f6444K[i]) {
