...
public abstract class SerpentEngineBase implements BlockCipher {
    ...
    /* renamed from: X0 */
    protected int f6003X0;

    /* renamed from: X1 */
    protected int f6004X1;

    /* renamed from: X2 */
    protected int f6005X2;

    /* renamed from: X3 */
    protected int f6006X3;
    ...
    /* renamed from: LT */
    public final void mo28943LT() {
        int rotateLeft = rotateLeft(this.f6003X0, 13);
        int rotateLeft2 = rotateLeft(this.f6005X2, 3);
        this.f6004X1 = rotateLeft((this.f6004X1 ^ rotateLeft) ^ rotateLeft2, 1);
        int rotateLeft3 = rotateLeft((this.f6006X3 ^ rotateLeft2) ^ (rotateLeft << 3), 7);
        this.f6006X3 = rotateLeft3;
        this.f6003X0 = rotateLeft((rotateLeft ^ this.f6004X1) ^ rotateLeft3, 5);
        this.f6005X2 = rotateLeft((this.f6006X3 ^ rotateLeft2) ^ (this.f6004X1 << 7), 22);
    }
    ...
    public final void ib1(int i, int i2, int i3, int i4) {
        ...
        int i11 = ~i10;
        int i12 = i9 ^ i8;
        this.f6003X0 = i11 ^ i12;
        this.f6005X2 = (i11 | i12) ^ i7;
    }
    ...
    public final void ib2(int i, int i2, int i3, int i4) {
        ...
        int i11 = ~i8;
        int i12 = i10 | i9;
        this.f6004X1 = i11 ^ i12;
        this.f6005X2 = (i12 ^ i7) ^ (i4 & i11);
    }
    ...
    public final void ib5(int i, int i2, int i3, int i4) {
        ...
        this.f6006X3 = i8;
        int i9 = i8 | i2;
        this.f6004X1 = i6 ^ (i & i9);
        int i10 = i4 | i;
        this.f6003X0 = (i5 ^ i9) ^ i10;
        this.f6005X2 = ((i ^ i3) | i7) ^ (i2 & i10);
    }
    ...
    public final void inverseLT() {
        int rotateRight = (rotateRight(this.f6005X2, 22) ^ this.f6006X3) ^ (this.f6004X1 << 7);
        int rotateRight2 = rotateRight(this.f6003X0, 5) ^ this.f6004X1;
        int i = this.f6006X3;
        int i2 = rotateRight2 ^ i;
        int rotateRight3 = rotateRight(i, 7);
        int rotateRight4 = rotateRight(this.f6004X1, 1);
        this.f6006X3 = (rotateRight3 ^ rotateRight) ^ (i2 << 3);
        this.f6004X1 = (rotateRight4 ^ i2) ^ rotateRight;
        this.f6005X2 = rotateRight(rotateRight, 3);
        this.f6003X0 = rotateRight(i2, 13);
    }
    ...
    public final void sb1(int i, int i2, int i3, int i4) {
        ...
        this.f6006X3 = i10;
        int i11 = i8 ^ i6;
        this.f6004X1 = i10 ^ i11;
        this.f6003X0 = i6 ^ (i11 & i9);
    }
    ...
    public final void sb3(int i, int i2, int i3, int i4) {
        ...
        this.f6003X0 = i12;
        int i13 = i12 & i10;
        this.f6004X1 = i11 ^ i13;
        this.f6006X3 = (i2 | i4) ^ (i8 ^ i13);
    }
    ...
    public final void sb5(int i, int i2, int i3, int i4) {
        ...
        this.f6004X1 = i10;
        int i11 = i7 ^ (i8 | i5);
        this.f6005X2 = (i6 | i9) ^ i11;
        this.f6006X3 = (i11 & i10) ^ (i2 ^ i9);
    }
