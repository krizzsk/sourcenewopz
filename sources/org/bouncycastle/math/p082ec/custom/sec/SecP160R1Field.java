...
public class SecP160R1Field {
    ...
    /* renamed from: M */
    private static final long f6330M = 4294967295L;

    /* renamed from: P */
    static final int[] f6331P = {Integer.MAX_VALUE, -1, -1, -1, -1};

    /* renamed from: P4 */
    private static final int f6332P4 = -1;
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f6331P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f6331P))) {
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[4] == -1 && Nat160.gte(fromBigInteger, f6331P)) {
            Nat160.subFrom(f6331P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(5, iArr2, Nat160.add(iArr, f6331P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f6331P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(5, iArr, f6331P) == 0);
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        if ((i != 0 && Nat160.mulWordsAdd(PInv, i, iArr, 0) != 0) || (iArr[4] == -1 && Nat160.gte(iArr, f6331P))) {
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f6331P))) {
            Nat.addWordTo(5, PInv, iArr2);
        }
    }
}
