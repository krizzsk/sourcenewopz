...
public abstract class ShellConsole {
    ...
    private static class JLineShellConsoleV1 extends ShellConsole {
        ...
        /* renamed from: in */
        private final InputStream f6677in;
        private final Object reader;

        JLineShellConsoleV1(Object obj, Charset charset) {
            this.reader = obj;
            this.f6677in = new ConsoleInputStream(this, charset);
        }
    ...
    private static class JLineShellConsoleV2 extends ShellConsole {
        ...
        /* renamed from: in */
        private final InputStream f6678in;
        private final Object reader;

        JLineShellConsoleV2(Object obj, Charset charset) {
            this.reader = obj;
            this.f6678in = new ConsoleInputStream(this, charset);
        }
    ...
    private static class ConsoleInputStream extends InputStream {
        ...
        private int readNextLine() throws IOException {
            ...
            if (readLine != null) {
                byte[] bytes = readLine.getBytes(this.f6676cs);
                this.buffer = bytes;
                return bytes.length;
            }
            this.buffer = EMPTY;
