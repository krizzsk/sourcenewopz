...
public class LockBasedStorageManager implements StorageManager {
    ...
    private static abstract class LockBasedLazyValueWithPostCompute<T> extends LockBasedLazyValue<T> {
        private volatile C21746a<T> valuePostCompute;
        ...
        public T invoke() {
            C21746a<T> aVar = this.valuePostCompute;
            if (aVar == null || !aVar.mo179969a()) {
                return super.invoke();
            }
            return aVar.mo179970b();
        }

        /* access modifiers changed from: protected */
        public final void postCompute(T t) {
            this.valuePostCompute = new C21746a<>(t);
            try {
                doPostCompute(t);
            } finally {
                this.valuePostCompute = null;
