...
public final class ParallelDoOnNextTry<T> extends ParallelFlowable<T> {
    ...
    /* renamed from: a */
    final ParallelFlowable<T> f59035a;

    /* renamed from: b */
    final Consumer<? super T> f59036b;

    /* renamed from: c */
    final BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> f59037c;

    public ParallelDoOnNextTry(ParallelFlowable<T> parallelFlowable, Consumer<? super T> consumer, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
        this.f59035a = parallelFlowable;
        this.f59036b = consumer;
        this.f59037c = biFunction;
    }
        ...
        if (validate(subscriberArr)) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (conditionalSubscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i] = new ParallelDoOnNextConditionalSubscriber(conditionalSubscriber, this.f59036b, this.f59037c);
                } else {
                    subscriberArr2[i] = new ParallelDoOnNextSubscriber(conditionalSubscriber, this.f59036b, this.f59037c);
                }
            }
            this.f59035a.subscribe(subscriberArr2);
        }
    }

    public int parallelism() {
        return this.f59035a.parallelism();
    }
    ...
    static final class ParallelDoOnNextSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.Object r6 = p242io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x004b }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p242io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x004b }
                int[] r7 = p242io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C212121.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x004b:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static /* synthetic */ class C212121 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C212121.<clinit>():void");
        }
    }
    ...
    static final class ParallelDoOnNextConditionalSubscriber<T> implements ConditionalSubscriber<T>, Subscription {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0014:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p242io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x004c }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p242io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x004c }
                int[] r7 = p242io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.C212121.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x004c:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.parallel.ParallelDoOnNextTry.ParallelDoOnNextConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
