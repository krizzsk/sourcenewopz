...
public final class ObservableMergeWithCompletable<T> extends C21211a<T, T> {

    /* renamed from: a */
    final CompletableSource f58872a;

    public ObservableMergeWithCompletable(Observable<T> observable, CompletableSource completableSource) {
        super(observable);
        this.f58872a = completableSource;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f58872a.subscribe(mergeWithObserver.otherObserver);
    }
