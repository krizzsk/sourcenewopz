...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f5724b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f5725g;
    ...
    /* renamed from: p */
    private final BigInteger f5726p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f5727q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1 */
    private BigInteger f5728x1;

    /* renamed from: x2 */
    private BigInteger f5729x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest2, SecureRandom secureRandom) {
        ...
        if (cArr.length != 0) {
            ...
            this.f5726p = jPAKEPrimeOrderGroup.getP();
            this.f5727q = jPAKEPrimeOrderGroup.getQ();
            this.f5725g = jPAKEPrimeOrderGroup.getG();
            this.digest = digest2;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f5726p, this.f5727q, this.gx4, this.f5729x2, calculateS, this.f5724b);
            this.f5728x1 = null;
            this.f5729x2 = null;
            this.f5724b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        if (this.state < 10) {
            this.f5728x1 = JPAKEUtil.generateX1(this.f5727q, this.random);
            this.f5729x2 = JPAKEUtil.generateX2(this.f5727q, this.random);
            this.gx1 = JPAKEUtil.calculateGx(this.f5726p, this.f5725g, this.f5728x1);
            this.gx2 = JPAKEUtil.calculateGx(this.f5726p, this.f5725g, this.f5729x2);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f5726p, this.f5727q, this.f5725g, this.gx1, this.f5728x1, this.participantId, this.digest, this.random);
            BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f5726p, this.f5727q, this.f5725g, this.gx2, this.f5729x2, this.participantId, this.digest, this.random);
            this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (i >= 30) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f5726p, this.gx1, this.gx3, this.gx4);
            BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f5727q, this.f5729x2, JPAKEUtil.calculateS(this.password));
            BigInteger calculateA = JPAKEUtil.calculateA(this.f5726p, this.f5727q, calculateGA, calculateX2s);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f5726p, this.f5727q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
            this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        if (this.state < 20) {
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f5726p, this.f5727q, this.f5725g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
            JPAKEUtil.validateZeroKnowledgeProof(this.f5726p, this.f5727q, this.f5725g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
            this.state = 20;
            return;
        }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        if (i >= 40) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f5726p, this.gx3, this.gx1, this.gx2);
            this.f5724b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f5726p, this.f5727q, calculateGA, this.f5724b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        } else {
