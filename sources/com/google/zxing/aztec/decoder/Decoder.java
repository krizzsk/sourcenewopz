...
public final class Decoder {
    ...
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", Constants.FILE_ANR_KEY, "b", "c", "d", "e", "f", DomainConstants.DOMAIN_SUFFIX_G, "h", "i", "j", "k", "l", "m", CampaignValue.f40469b, "o", RavenConfigKey.PHONE, "q", "r", RavenKey.STACK, RavenKey.TYPE, "u", RavenKey.VERSION, "w", "x", SameLayerRenderingUtil.KEY_COMP_Y, "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = {"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", "\u0005", "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", StringUtils.f5622CR, "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", "_", "`", "|", "~", "", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = {"", StringUtils.f5622CR, "\r\n", ". ", ", ", ": ", "!", Const.jsQuote, RConfigConstants.KEYWORD_COLOR_SIGN, "$", "%", ParamKeys.SIGN_AND, "'", "(", ")", "*", "+", ",", "-", ".", "/", ":", ";", IMTextUtils.STREET_IMAGE_TAG_START, "=", IMTextUtils.STREET_IMAGE_TAG_END, "?", Const.jaLeft, Const.jaRight, Const.joLeft, "}", "CTRL_UL"};
    private static final String[] UPPER_TABLE = {"CTRL_PS", " ", ExifInterface.GPS_MEASUREMENT_IN_PROGRESS, "B", "C", "D", ExifInterface.LONGITUDE_EAST, "F", "G", "H", "I", "J", "K", "L", "M", "N", "O", "P", "Q", "R", ExifInterface.LATITUDE_SOUTH, "T", "U", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, ExifInterface.LONGITUDE_WEST, C16471q.f49112a, C16471q.f49113b, "Z", "CTRL_LL", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    ...
    static /* synthetic */ class C197191 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.aztec.decoder.Decoder.C197191.<clinit>():void");
        }
    }

    private static String getCharacter(Table table, int i) {
        int i2 = C197191.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
