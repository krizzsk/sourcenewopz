...
public final class HomeTopImageBinderRoot extends BinderRoot<TopImageBusinessItemWidget, ComponentModel> {
    ...
    public TopImageBusinessItemWidget createView(Context context, ComponentModel componentModel) {
        ...
        Buildable renderViewWithData = BlocksEngine.Companion.getInstance$default(BlocksEngine.Companion, (String) null, 1, (Object) null).renderViewWithData(context, this.f42760a, componentModel.getWidgetNodeModel(), getConfig());
    ...
    public void bind(TopImageBusinessItemWidget topImageBusinessItemWidget, ComponentModel componentModel, int i) {
        ...
        BlocksEngine.Companion.getInstance$default(BlocksEngine.Companion, (String) null, 1, (Object) null).bindDataOnWidget(this.f42760a, buildable, componentModel.getWidgetNodeModel(), getConfig());
    }
}
