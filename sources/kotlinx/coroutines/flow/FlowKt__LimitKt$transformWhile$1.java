...
@DebugMetadata(mo176686c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", mo176687f = "Limit.kt", mo176688i = {0}, mo176689l = {154}, mo176690m = "invokeSuspend", mo176691n = {"collector$iv"}, mo176692s = {"L$0"})
...
final class FlowKt__LimitKt$transformWhile$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        C21870xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T> flow = this.$this_transformWhile;
            C21870xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$12 = new C21870xdf1aa1b6(this.$transform, (FlowCollector) this.L$0);
            try {
            ...
            flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (C21870xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);
