...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f6269c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f6269c.equals(((X509CRLEntryObject) obj).f6269c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f6269c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f6269c.getRevocationDate().getDate();
    }

    public BigInteger getSerialNumber() {
        return this.f6269c.getUserCertificate().getValue();
    }

    public boolean hasExtensions() {
        return this.f6269c.getExtensions() != null;
    }
