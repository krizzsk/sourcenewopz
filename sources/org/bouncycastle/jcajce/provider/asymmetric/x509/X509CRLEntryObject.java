...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f6240c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.hashValueSet || !x509CRLEntryObject.hashValueSet || this.hashValue == x509CRLEntryObject.hashValue) {
            return this.f6240c.equals(x509CRLEntryObject.f6240c);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f6240c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f6240c.getRevocationDate().getDate();
    }

    public BigInteger getSerialNumber() {
        return this.f6240c.getUserCertificate().getValue();
    }

    public boolean hasExtensions() {
        return this.f6240c.getExtensions() != null;
    }
