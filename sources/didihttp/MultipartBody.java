...
public final class MultipartBody extends RequestBody {
    ...
    /* renamed from: a */
    private static final byte[] f56470a = {58, 32};

    /* renamed from: b */
    private static final byte[] f56471b = {Ascii.f53584CR, 10};

    /* renamed from: c */
    private static final byte[] f56472c = {45, 45};

    /* renamed from: d */
    private final ByteString f56473d;

    /* renamed from: e */
    private final MediaType f56474e;

    /* renamed from: f */
    private final MediaType f56475f;

    /* renamed from: g */
    private final List<Part> f56476g;

    /* renamed from: h */
    private long f56477h = -1;

    MultipartBody(ByteString byteString, MediaType mediaType, List<Part> list) {
        this.f56473d = byteString;
        this.f56474e = mediaType;
        this.f56475f = MediaType.parse(mediaType + "; boundary=" + byteString.utf8());
        this.f56476g = C20747Util.immutableList(list);
    }
    ...
    public String boundary() {
        return this.f56473d.utf8();
    }

    public int size() {
        return this.f56476g.size();
    }
    ...
    public long contentLength() throws IOException {
        ...
        long a = m40629a((BufferedSink) null, true);
        this.f56477h = a;
        return a;
    }

    public void writeTo(BufferedSink bufferedSink) throws IOException {
        m40629a(bufferedSink, false);
    }
    ...
    private long m40629a(okio.BufferedSink r13, boolean r14) throws java.io.IOException {
        /*
            r12 = this;
        ...
        L_0x0009:
            r0 = 0
        L_0x000a:
            java.util.List<didihttp.MultipartBody$Part> r1 = r12.f56476g
            int r1 = r1.size()
            r2 = 0
            r3 = 0
            r5 = 0
        L_0x0014:
            ...
            java.util.List<didihttp.MultipartBody$Part> r6 = r12.f56476g
            ...
            byte[] r8 = f56472c
            r13.write((byte[]) r8)
            okio.ByteString r8 = r12.f56473d
        ...
        L_0x00a6:
            byte[] r1 = f56472c
            r13.write((byte[]) r1)
            okio.ByteString r1 = r12.f56473d
        ...
        L_0x00c4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: didihttp.MultipartBody.m40629a(okio.BufferedSink, boolean):long");
    }

    /* renamed from: a */
    static StringBuilder m40630a(StringBuilder sb, String str) {
    ...
    public static final class Part {
        ...
        public static Part createFormData(String str, String str2, RequestBody requestBody) {
            if (str != null) {
                ...
                MultipartBody.m40630a(sb, str);
                if (str2 != null) {
                    sb.append("; filename=");
                    MultipartBody.m40630a(sb, str2);
                }
                return create(Headers.m40613of("Content-Disposition", sb.toString()), requestBody);
            }
