...
public class BCECGOST3410PrivateKey implements ECPrivateKey, ECPointEncoder, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier {
    ...
    /* renamed from: d */
    private transient BigInteger f6232d;
    ...
    public BCECGOST3410PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        this.algorithm = str;
        this.f6232d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCECGOST3410PrivateKey(ECPrivateKey eCPrivateKey) {
        this.f6232d = eCPrivateKey.getS();
        this.algorithm = eCPrivateKey.getAlgorithm();
        this.ecSpec = eCPrivateKey.getParams();
    }

    public BCECGOST3410PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.f6232d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410PrivateKey(BCECGOST3410PrivateKey bCECGOST3410PrivateKey) {
        this.f6232d = bCECGOST3410PrivateKey.f6232d;
    ...
    public BCECGOST3410PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.f6232d = eCPrivateKeySpec.getD();
    ...
    public byte[] getEncoded() {
        ...
        L_0x0065:
            ...
            org.bouncycastle.math.ec.ECPoint r3 = org.bouncycastle.jcajce.provider.asymmetric.util.EC5Util.convertPoint((org.bouncycastle.math.p082ec.ECCurve) r4, (java.security.spec.ECPoint) r3)
            boolean r6 = r9.withCompression
            r5.<init>((org.bouncycastle.math.p082ec.ECPoint) r3, (boolean) r6)
            java.security.spec.ECParameterSpec r3 = r9.ecSpec
            ...
            org.bouncycastle.asn1.x9.X962Parameters r3 = new org.bouncycastle.asn1.x9.X962Parameters
            r3.<init>((org.bouncycastle.asn1.p075x9.X9ECParameters) r0)
        L_0x00a4:
            org.bouncycastle.jcajce.provider.config.ProviderConfiguration r0 = org.bouncycastle.jce.provider.BouncyCastleProvider.CONFIGURATION
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f6232d, engineGetSpec());
    }
}
