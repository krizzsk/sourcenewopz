...
import p242io.reactivex.CompletableEmitter;
import p242io.reactivex.CompletableObserver;
import p242io.reactivex.CompletableOnSubscribe;
...
public final class CompletableCreate extends Completable {
    ...
    /* renamed from: a */
    final CompletableOnSubscribe f58098a;

    public CompletableCreate(CompletableOnSubscribe completableOnSubscribe) {
        this.f58098a = completableOnSubscribe;
    }
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        ...
        try {
            this.f58098a.subscribe(emitter);
        } catch (Throwable th) {
