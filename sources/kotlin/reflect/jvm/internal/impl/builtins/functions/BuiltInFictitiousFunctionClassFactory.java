...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    /* renamed from: a */
    private final StorageManager f60113a;

    /* renamed from: b */
    private final ModuleDescriptor f60114b;
    ...
    public BuiltInFictitiousFunctionClassFactory(StorageManager storageManager, ModuleDescriptor moduleDescriptor) {
        ...
        this.f60113a = storageManager;
        this.f60114b = moduleDescriptor;
    }
    ...
    public ClassDescriptor createClass(ClassId classId) {
        ...
        for (Object next : this.f60114b.getPackage(packageFqName).getFragments()) {
        ...
        return new FunctionClassDescriptor(this.f60113a, (BuiltInsPackageFragment) obj, component1, component2);
    }
