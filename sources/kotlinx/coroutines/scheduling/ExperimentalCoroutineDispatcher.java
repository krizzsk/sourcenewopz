...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    /* renamed from: e */
    private CoroutineScheduler f61590e;
    ...
    public void dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        try {
            CoroutineScheduler.dispatch$default(this.f61590e, runnable, (TaskContext) null, false, 6, (Object) null);
    ...
    public void dispatchYield(CoroutineContext coroutineContext, Runnable runnable) {
        try {
            CoroutineScheduler.dispatch$default(this.f61590e, runnable, (TaskContext) null, true, 2, (Object) null);
        } catch (RejectedExecutionException unused) {
    ...
    public String toString() {
        return super.toString() + "[scheduler = " + this.f61590e + VersionRange.RIGHT_CLOSED;
    }
    ...
    public final CoroutineDispatcher blocking(int i) {
        if (i > 0) {
            return new C21991a(this, i, (String) null, 1);
        }
    ...
    public final CoroutineDispatcher limited(int i) {
        ...
        if (i > 0) {
            ...
            if (z) {
                return new C21991a(this, i, (String) null, 0);
            }
            throw new IllegalArgumentException(("Expected parallelism level lesser than core pool size (" + this.f61586a + "), but have " + i).toString());
        }
        throw new IllegalArgumentException(Intrinsics.stringPlus("Expected positive parallelism level, but have ", Integer.valueOf(i)).toString());
    }
    ...
    public final void dispatchWithContext$kotlinx_coroutines_core(Runnable runnable, TaskContext taskContext, boolean z) {
        try {
            this.f61590e.dispatch(runnable, taskContext, z);
        } catch (RejectedExecutionException unused) {
            DefaultExecutor.INSTANCE.enqueue(this.f61590e.createTask(runnable, taskContext));
        }
    }

    /* renamed from: a */
    private final CoroutineScheduler m46060a() {
        return new CoroutineScheduler(this.f61586a, this.f61587b, this.f61588c, this.f61589d);
    }

    public final synchronized void usePrivateScheduler$kotlinx_coroutines_core() {
        this.f61590e.shutdown(1000);
        this.f61590e = m46060a();
    }

    public final synchronized void shutdown$kotlinx_coroutines_core(long j) {
        this.f61590e.shutdown(j);
    }
