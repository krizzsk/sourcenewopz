...
public class WebpUtil {
    ...
    private static Pair<Integer, Integer> getVP8LDimension(InputStream inputStream) throws IOException {
        ...
        return new Pair<>(Integer.valueOf(((((byte) inputStream.read()) & 255) | ((read & Utf8.REPLACEMENT_BYTE) << 8)) + 1), Integer.valueOf(((((((byte) inputStream.read()) & 255) & Ascii.f53593SI) << 10) | ((((byte) inputStream.read()) & 255) << 2) | ((read & 192) >> 6)) + 1));
    }
