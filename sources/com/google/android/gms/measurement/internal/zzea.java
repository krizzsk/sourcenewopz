...
public final class zzea {
    ...
    static {
        ...
        zzl = zzb("measurement.upload.max_public_events_per_day", valueOf, valueOf, zzaw.zza);
        Long valueOf2 = Long.valueOf(GlobalBubbleShowHelper.ONE_WEEK);
        zzy = zzb("measurement.upload.refresh_blacklisted_config_interval", valueOf2, valueOf2, zzbk.zza);
        Double valueOf3 = Double.valueOf(-3.0d);
        zzN = zzb("measurement.test.double_flag", valueOf3, valueOf3, zzbx.zza);
        zzQ = zzb("measurement.sdk.attribution.cache.ttl", valueOf2, valueOf2, zzca.zza);
    }
