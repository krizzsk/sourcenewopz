...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    private final Utils f61874utils;
    ...
    private Task<InstallationTokenResult> addGetAuthTokenListener() {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        addStateListeners(new GetAuthTokenListener(this.f61874utils, taskCompletionSource));
        return taskCompletionSource.getTask();
    }
    ...
    public void lambda$doRegistrationOrRefresh$2$FirebaseInstallations(boolean r3) {
        ...
        L_0x0011:
            ...
            com.google.firebase.installations.Utils r3 = r2.f61874utils     // Catch:{ FirebaseInstallationsException -> 0x005f }
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C194473.f53772xc38d2559[createFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
            return persistedInstallationEntry.withRegisteredFid(createFirebaseInstallation.getFid(), createFirebaseInstallation.getRefreshToken(), this.f61874utils.currentTimeInSecs(), createFirebaseInstallation.getAuthToken().getToken(), createFirebaseInstallation.getAuthToken().getTokenExpirationTimestamp());
        } else if (i == 2) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C194473.f53773xe5baa01a[generateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
            return persistedInstallationEntry.withAuthToken(generateAuthToken.getToken(), generateAuthToken.getTokenExpirationTimestamp(), this.f61874utils.currentTimeInSecs());
        } else if (i == 2) {
            return persistedInstallationEntry.withFisError("BAD CONFIG");
        } else {
            if (i == 3) {
    ...
    static /* synthetic */ class C194473 {
        ...
        static {
            /*
                ...
                f53773xe5baa01a = r0
                r1 = 1
                com.google.firebase.installations.remote.TokenResult$ResponseCode r2 = com.google.firebase.installations.remote.TokenResult.ResponseCode.f53775OK     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                r0 = 2
                int[] r2 = f53773xe5baa01a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r2 = f53773xe5baa01a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                ...
                int[] r2 = new int[r2]
                f53772xc38d2559 = r2
                com.google.firebase.installations.remote.InstallationResponse$ResponseCode r3 = com.google.firebase.installations.remote.InstallationResponse.ResponseCode.f53774OK     // Catch:{ NoSuchFieldError -> 0x0039 }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x0039 }
                r2[r3] = r1     // Catch:{ NoSuchFieldError -> 0x0039 }
            L_0x0039:
                int[] r1 = f53772xc38d2559     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.C194473.<clinit>():void");
        }
    }
