...
public final class CompletableMergeIterable extends Completable {
    ...
    /* renamed from: a */
    final Iterable<? extends CompletableSource> f58133a;
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        ...
        try {
            Iterator it = (Iterator) ObjectHelper.requireNonNull(this.f58133a.iterator(), "The source iterator returned is null");
