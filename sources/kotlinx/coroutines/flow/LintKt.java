...
public final class LintKt {
    ...
    /* renamed from: a */
    private static final <T> Flow<T> m45687a(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m48279catch(sharedFlow, function3);
    }

    /* renamed from: a */
    static /* synthetic */ Flow m45686a(SharedFlow sharedFlow, long j, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Long.MAX_VALUE;
        }
        if ((i & 2) != 0) {
    ...
    /* renamed from: a */
    private static final <T> Flow<T> m45685a(SharedFlow<? extends T> sharedFlow, long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        return FlowKt.retry(sharedFlow, j, function2);
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "SharedFlow never completes, so this operator has no effect.", replaceWith = @ReplaceWith(expression = "this", imports = {}))
    /* renamed from: a */
    private static final <T> Flow<T> m45688a(SharedFlow<? extends T> sharedFlow, Function4<? super FlowCollector<? super T>, ? super Throwable, ? super Long, ? super Continuation<? super Boolean>, ? extends Object> function4) {
    ...
    /* renamed from: a */
    private static final <T> Object m45684a(SharedFlow<? extends T> sharedFlow, Continuation<? super List<? extends T>> continuation) {
        InlineMarker.mark(0);
        Object list$default = C21942i.m45772a((Flow) sharedFlow, (List) null, (Continuation) continuation, 1, (Object) null);
        InlineMarker.mark(1);
        return list$default;
    }
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "SharedFlow never completes, so this terminal operation never completes.")
    /* renamed from: b */
    private static final <T> Object m45689b(SharedFlow<? extends T> sharedFlow, Continuation<? super Set<? extends T>> continuation) {
        InlineMarker.mark(0);
        Object set$default = C21942i.m45774a((Flow) sharedFlow, (Set) null, (Continuation) continuation, 1, (Object) null);
        InlineMarker.mark(1);
        return set$default;
    }
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "SharedFlow never completes, so this terminal operation never completes.")
    /* renamed from: c */
    private static final <T> Object m45690c(SharedFlow<? extends T> sharedFlow, Continuation<? super Integer> continuation) {
        InlineMarker.mark(0);
