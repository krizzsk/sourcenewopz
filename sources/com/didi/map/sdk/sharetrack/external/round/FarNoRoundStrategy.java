...
@Metadata(mo175976bv = {1, 0, 3}, mo175977d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016J\b\u0010\u0005\u001a\u00020\u0006H\u0016J\b\u0010\u0007\u001a\u00020\u0006H\u0016J\b\u0010\b\u001a\u00020\u0006H\u0016¨\u0006\t"}, mo175978d2 = {"Lcom/didi/map/sdk/sharetrack/external/round/FarNoRoundStrategy;", "Lcom/didi/map/sdk/sharetrack/external/round/BaseRoundStrategy;", "()V", "checkArriveStatus", "", "getArriveThreshold", "", "getDriveAwayThreshold", "getRoundType", "CommonShareTrack_release"}, mo175979k = 1, mo175980mv = {1, 1, 16})
    ...
    public void checkArriveStatus() {
        if (!getMHasArrived()) {
            ...
            if (meda >= 0 && arriveThreshold > meda) {
                DLog.m7384d(BaseRoundStrategy.TAG, "far arrive: YES", new Object[0]);
                setMIsNeverArrived(false);
                handleArrive(true);
            } else if (getMEDA() < 200) {
                DLog.m7384d(BaseRoundStrategy.TAG, "EDA: " + getMEDA() + ", far arrive: NO", new Object[0]);
            }
        }
    }
}
