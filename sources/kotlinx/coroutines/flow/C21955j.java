...
final /* synthetic */ class C21955j {
    ...
    /* renamed from: a */
    public static final <T> Flow<T> m45784a(Flow<? extends T> flow, int i, BufferOverflow bufferOverflow) {
    ...
    /* renamed from: a */
    public static /* synthetic */ Flow m45783a(Flow flow, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = -2;
        }
        return m45785a(flow, i, (BufferOverflow) null, 2, (Object) null);
    }

    /* renamed from: a */
    public static final <T> Flow<T> m45781a(Flow<? extends T> flow) {
        return m45785a(flow, -1, (BufferOverflow) null, 2, (Object) null);
    }

    /* renamed from: a */
    public static final <T> Flow<T> m45786a(Flow<? extends T> flow, CoroutineContext coroutineContext) {
        m45789a(coroutineContext);
    ...
    /* renamed from: b */
    public static final <T> Flow<T> m45790b(Flow<? extends T> flow) {
        return flow instanceof CancellableFlow ? flow : new C21935b<>(flow);
    }

    /* renamed from: a */
    public static /* synthetic */ Flow m45788a(Flow flow, CoroutineContext coroutineContext, int i, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = -2;
        }
    ...
    /* renamed from: a */
    public static final <T, R> Flow<R> m45787a(Flow<? extends T> flow, CoroutineContext coroutineContext, int i, Function1<? super Flow<? extends T>, ? extends Flow<? extends R>> function1) {
        m45789a(coroutineContext);
        return new FlowKt__ContextKt$flowWith$$inlined$unsafeFlow$1(flow, i, function1, coroutineContext);
    }

    /* renamed from: a */
    private static final void m45789a(CoroutineContext coroutineContext) {
