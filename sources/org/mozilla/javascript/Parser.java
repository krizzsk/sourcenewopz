...
public class Parser {
    ...
    public void addStrictWarning(String str, String str2) {
        int i;
        TokenStream tokenStream = this.f6605ts;
        int i2 = -1;
        if (tokenStream != null) {
            i2 = tokenStream.tokenBeg;
            i = this.f6605ts.tokenEnd - this.f6605ts.tokenBeg;
        } else {
            i = -1;
        }
    ...
    public void addWarning(String str, String str2, int i, int i2) {
        ...
        if (ideErrorReporter != null) {
            ...
            this.errorReporter.warning(lookupMessage, this.sourceURI, this.f6605ts.getLineno(), this.f6605ts.getLine(), this.f6605ts.getOffset());
        }
    }

    /* access modifiers changed from: package-private */
    public void addError(String str) {
        addError(str, this.f6605ts.tokenBeg, this.f6605ts.tokenEnd - this.f6605ts.tokenBeg);
    }
    ...
    public void addError(String str, String str2) {
        addError(str, str2, this.f6605ts.tokenBeg, this.f6605ts.tokenEnd - this.f6605ts.tokenBeg);
    }
    ...
    public void addError(String str, String str2, int i, int i2) {
        ...
        if (tokenStream != null) {
            ...
            str3 = this.f6605ts.getLine();
            i3 = this.f6605ts.getOffset();
            i4 = lineno;
        } else {
            str3 = "";
            i4 = 1;
    ...
    public void reportError(String str, String str2) {
        ...
        if (tokenStream == null) {
            ...
            reportError(str, str2, tokenStream.tokenBeg, this.f6605ts.tokenEnd - this.f6605ts.tokenBeg);
        }
    }
    ...
    private void recordComment(int i, String str) {
        ...
        Comment comment = new Comment(this.f6605ts.tokenBeg, this.f6605ts.getTokenLength(), this.f6605ts.commentType, str);
        if (this.f6605ts.commentType == Token.CommentType.JSDOC && this.compilerEnv.isRecordingLocalJsDocComments()) {
    ...
    private int peekToken() throws IOException {
        ...
        int lineno = this.f6605ts.getLineno();
        int token = this.f6605ts.getToken();
        int i = 0;
        boolean z = false;
        while (true) {
            ...
            if (token == 1) {
                ...
                String andResetCurrentComment = this.f6605ts.getAndResetCurrentComment();
                recordComment(lineno, andResetCurrentComment);
                lineno += getNumberOfEols(andResetCurrentComment);
            }
            token = this.f6605ts.getToken();
        }
    ...
    private boolean mustMatchToken(int i, String str) throws IOException {
        return mustMatchToken(i, str, this.f6605ts.tokenBeg, this.f6605ts.tokenEnd - this.f6605ts.tokenBeg);
    }
    ...
    public AstRoot parse(Reader reader, String str, int i) throws IOException {
        if (this.parseFinished) {
            ...
            try {
                this.sourceURI = str;
                this.f6605ts = new TokenStream(this, reader, (String) null, i);
                return parse();
            } finally {
    ...
    private AstRoot parse() throws IOException {
        ...
        while (true) {
            try {
                ...
                if (!this.compilerEnv.isIdeMode()) {
                    throw Context.reportRuntimeError(lookupMessage, this.sourceURI, this.f6605ts.lineno, (String) null, 0);
                }
            } catch (Throwable th) {
        ...
        astRoot.setEndLineno(this.f6605ts.lineno);
        return astRoot;
    }
    ...
    private org.mozilla.javascript.ast.AstNode parseFunctionBody() throws java.io.IOException {
        ...
        L_0x001d:
            ...
            org.mozilla.javascript.TokenStream r7 = r11.f6605ts     // Catch:{ ParserException -> 0x0095, all -> 0x008c }
        ...
        L_0x0095:
            ...
            r11.nestingOfFunction = r1
            r11.inUseStrictDirective = r5
            org.mozilla.javascript.TokenStream r1 = r11.f6605ts
            int r1 = r1.tokenEnd
            ...
            if (r0 == 0) goto L_0x00b1
            org.mozilla.javascript.TokenStream r0 = r11.f6605ts
            int r1 = r0.tokenEnd
        L_0x00b1:
            int r1 = r1 - r3
            r4.setLength(r1)
    ...
    private void parseFunctionParams(FunctionNode functionNode) throws IOException {
        if (matchToken(88)) {
            functionNode.setRp(this.f6605ts.tokenBeg - functionNode.getPosition());
            return;
        }
        ...
        do {
            ...
            if (peekToken == 83 || peekToken == 85) {
                ...
                String string = this.f6605ts.getString();
    ...
    private FunctionNode function(int i) throws IOException {
        Name name;
        String str;
        int i2 = this.f6605ts.lineno;
        int i3 = this.f6605ts.tokenBeg;
        ...
        int i4 = this.currentToken == 87 ? this.f6605ts.tokenBeg : -1;
        ...
        try {
            ...
            functionNode.setEncodedSourceBounds(i3, this.f6605ts.tokenEnd);
            functionNode.setLength(this.f6605ts.tokenEnd - i3);
            ...
            functionNode.setEndLineno(this.f6605ts.lineno);
            if (this.compilerEnv.isIdeMode()) {
    ...
    private AstNode statements(AstNode astNode) throws IOException {
        ...
        int i = this.f6605ts.tokenBeg;
        if (astNode == null) {
            astNode = new Block(i);
        }
        astNode.setLineno(this.f6605ts.lineno);
        while (true) {
            int peekToken = peekToken();
            if (peekToken <= 0 || peekToken == 86) {
                astNode.setLength(this.f6605ts.tokenBeg - i);
            } else {
    ...
    private ConditionData condition() throws IOException {
        ...
        if (mustMatchToken(87, "msg.no.paren.cond")) {
            conditionData.f6606lp = this.f6605ts.tokenBeg;
        }
        conditionData.condition = expr();
        if (mustMatchToken(88, "msg.no.paren.after.cond")) {
            conditionData.f6607rp = this.f6605ts.tokenBeg;
        }
    ...
    private AstNode statement() throws IOException {
        ...
        return new EmptyStatement(i, this.f6605ts.tokenBeg - i);
    }
            ...
            if (peekToken != 4) {
                if (peekToken == 39) {
                    ...
                    if (peekToken == 109) {
                        ...
                        if (peekToken == 160) {
                            consumeToken();
                            astNode = new KeywordLiteral(this.f6605ts.tokenBeg, this.f6605ts.tokenEnd - this.f6605ts.tokenBeg, peekToken);
                            astNode.setLineno(this.f6605ts.lineno);
                            ...
                            if (peekToken == 82) {
                                consumeToken();
                                int i2 = this.f6605ts.tokenBeg;
                                EmptyStatement emptyStatement = new EmptyStatement(i2, this.f6605ts.tokenEnd - i2);
                                emptyStatement.setLineno(this.f6605ts.lineno);
                                ...
                                consumeToken();
                                int i4 = this.f6605ts.lineno;
                                astNode = variables(this.currentToken, this.f6605ts.tokenBeg, true);
    ...
    private void autoInsertSemicolon(AstNode astNode) throws IOException {
        ...
        if (!(i == -1 || i == 0)) {
            if (i == 82) {
                consumeToken();
                astNode.setLength(this.f6605ts.tokenEnd - position);
                return;
            } else if (i != 86) {
    ...
    private IfStatement ifStatement() throws IOException {
        ...
        ifStatement.setParens(condition.f6606lp - i, condition.f6607rp - i);
    ...
    private org.mozilla.javascript.ast.SwitchStatement switchStatement() throws java.io.IOException {
        ...
        L_0x0009:
            ...
            org.mozilla.javascript.TokenStream r2 = r11.f6605ts
            int r2 = r2.tokenBeg
            int r2 = r2 - r0
            r1.setLp(r2)
        L_0x0027:
            ...
            org.mozilla.javascript.TokenStream r2 = r11.f6605ts     // Catch:{ all -> 0x00bf }
        ...
        L_0x0052:
            ...
            org.mozilla.javascript.TokenStream r4 = r11.f6605ts     // Catch:{ all -> 0x00bf }
            int r4 = r4.tokenBeg     // Catch:{ all -> 0x00bf }
            org.mozilla.javascript.TokenStream r5 = r11.f6605ts     // Catch:{ all -> 0x00bf }
        ...
        L_0x0088:
            ...
            org.mozilla.javascript.TokenStream r3 = r11.f6605ts     // Catch:{ all -> 0x00bf }
    ...
    private WhileLoop whileLoop() throws IOException {
        ...
        whileLoop.setLineno(this.f6605ts.lineno);
        enterLoop(whileLoop);
        try {
            ConditionData condition = condition();
            whileLoop.setCondition(condition.condition);
            whileLoop.setParens(condition.f6606lp - i, condition.f6607rp - i);
            AstNode statement = statement();
    ...
    private DoLoop doLoop() throws IOException {
        ...
        doLoop.setLineno(this.f6605ts.lineno);
        enterLoop(doLoop);
        try {
            AstNode statement = statement();
            mustMatchToken(117, "msg.no.while.do");
            doLoop.setWhilePosition(this.f6605ts.tokenBeg - i);
            ConditionData condition = condition();
            doLoop.setCondition(condition.condition);
            doLoop.setParens(condition.f6606lp - i, condition.f6607rp - i);
            int nodeEnd = getNodeEnd(statement);
            doLoop.setBody(statement);
            exitLoop();
            if (matchToken(82)) {
                nodeEnd = this.f6605ts.tokenEnd;
            }
    ...
    private org.mozilla.javascript.ast.Loop forLoop() throws java.io.IOException {
        ...
        L_0x000b:
            r17.consumeToken()
            org.mozilla.javascript.TokenStream r0 = r1.f6605ts
            int r0 = r0.tokenBeg
            org.mozilla.javascript.TokenStream r2 = r1.f6605ts
            int r2 = r2.lineno
            r3 = 0
            ...
            org.mozilla.javascript.TokenStream r10 = r1.f6605ts     // Catch:{ all -> 0x0138 }
            java.lang.String r10 = r10.getString()     // Catch:{ all -> 0x0138 }
            boolean r5 = r5.equals(r10)     // Catch:{ all -> 0x0138 }
            if (r5 == 0) goto L_0x0041
            org.mozilla.javascript.TokenStream r5 = r1.f6605ts     // Catch:{ all -> 0x0138 }
        ...
        L_0x0046:
            ...
            org.mozilla.javascript.TokenStream r6 = r1.f6605ts     // Catch:{ all -> 0x0138 }
        ...
        L_0x0055:
            ...
            org.mozilla.javascript.TokenStream r7 = r1.f6605ts     // Catch:{ all -> 0x0138 }
        ...
        L_0x0074:
            ...
            org.mozilla.javascript.TokenStream r14 = r1.f6605ts     // Catch:{ all -> 0x0138 }
        ...
        L_0x0096:
            ...
            org.mozilla.javascript.TokenStream r12 = r1.f6605ts     // Catch:{ all -> 0x0138 }
        ...
        L_0x00bf:
            ...
            org.mozilla.javascript.TokenStream r8 = r1.f6605ts     // Catch:{ all -> 0x0138 }
    ...
    private AstNode forLoopInit(int i) throws IOException {
        ...
        try {
            this.inForInit = true;
            if (i == 82) {
                astNode = new EmptyExpression(this.f6605ts.tokenBeg, 1);
                astNode.setLineno(this.f6605ts.lineno);
            } else {
                if (i != 122) {
                    if (i != 153) {
                ...
                consumeToken();
                astNode = variables(i, this.f6605ts.tokenBeg, false);
            }
    ...
    private TryStatement tryStatement() throws IOException {
        ...
        int i4 = this.f6605ts.tokenBeg;
        int i5 = this.f6605ts.lineno;
        int i6 = 85;
        if (peekToken() != 85) {
        ...
        if (peekToken == 124) {
            ...
            for (int i7 = 124; matchToken(i7); i7 = 124) {
                int i8 = this.f6605ts.lineno;
                if (z) {
                    reportError("msg.catch.unreachable");
                }
                int i9 = this.f6605ts.tokenBeg;
                int i10 = mustMatchToken(87, "msg.no.paren.catch") ? this.f6605ts.tokenBeg : -1;
                ...
                int i11 = mustMatchToken(88, "msg.bad.catchcond") ? this.f6605ts.tokenBeg : -1;
                ...
                nodeEnd = mustMatchToken(86, "msg.no.brace.after.body") ? this.f6605ts.tokenEnd : nodeEnd2;
    ...
    private LabeledStatement matchJumpLabelName() throws IOException {
        ...
        if (peekTokenOrEOL() == 39) {
            ...
            if (map != null) {
                labeledStatement = map.get(this.f6605ts.getString());
            }
            if (labeledStatement == null) {
    ...
    private WithStatement withStatement() throws IOException {
        ...
        int i2 = this.f6605ts.tokenBeg;
        int i3 = -1;
        int i4 = mustMatchToken(87, "msg.no.paren.with") ? this.f6605ts.tokenBeg : -1;
        AstNode expr = expr();
    ...
    private AstNode block() throws IOException {
        ...
        scope.setLineno(this.f6605ts.lineno);
        pushScope(scope);
        try {
            statements(scope);
            mustMatchToken(86, "msg.no.brace.block");
            scope.setLength(this.f6605ts.tokenEnd - i);
            return scope;
        } finally {
            popScope();
        }
    ...
    private AstNode defaultXmlNamespace() throws IOException {
        ...
        int i = this.f6605ts.lineno;
        int i2 = this.f6605ts.tokenBeg;
        if (!matchToken(39) || !"xml".equals(this.f6605ts.getString())) {
            reportError("msg.bad.namespace");
        }
        if (!matchToken(39) || !"namespace".equals(this.f6605ts.getString())) {
            reportError("msg.bad.namespace");
        }
        if (!matchToken(90)) {
            reportError("msg.bad.namespace");
    ...
    private org.mozilla.javascript.ast.AstNode nameOrLabel() throws java.io.IOException {
        /*
            ...
            org.mozilla.javascript.TokenStream r0 = r8.f6605ts
            int r0 = r0.tokenBeg
        ...
        L_0x002d:
            ...
            org.mozilla.javascript.TokenStream r2 = r8.f6605ts
            int r2 = r2.lineno
            r4.setLineno(r2)
        L_0x003e:
            int r2 = r8.peekToken()
    ...
    private VariableDeclaration variables(int i, int i2, boolean z) throws IOException {
        ...
        variableDeclaration.setLineno(this.f6605ts.lineno);
        Comment andResetJsDoc = getAndResetJsDoc();
        if (andResetJsDoc != null) {
        ...
        do {
            ...
            if (peekToken == 83 || peekToken == 85) {
                ...
                Name createNameNode = createNameNode();
                createNameNode.setLineno(this.f6605ts.getLineno());
                if (this.inUseStrictDirective) {
                    String string = this.f6605ts.getString();
                    if ("eval".equals(string) || "arguments".equals(this.f6605ts.getString())) {
                        reportError("msg.bad.id.strict", string);
                    }
                }
                defineSymbol(i, this.f6605ts.getString(), this.inForInit);
                i3 = i5;
                name = createNameNode;
                astNode = null;
            }
            int i6 = this.f6605ts.lineno;
    ...
    private AstNode let(boolean z, int i) throws IOException {
        ...
        letNode.setLineno(this.f6605ts.lineno);
        if (mustMatchToken(87, "msg.no.paren.after.let")) {
            letNode.setLp(this.f6605ts.tokenBeg - i);
        }
        pushScope(letNode);
        try {
            letNode.setVariables(variables(153, this.f6605ts.tokenBeg, z));
            if (mustMatchToken(88, "msg.no.paren.let")) {
                letNode.setRp(this.f6605ts.tokenBeg - i);
            }
            if (!z || peekToken() != 85) {
                AstNode expr = expr();
                ...
                statements.setLength(this.f6605ts.tokenEnd - i2);
                letNode.setLength(this.f6605ts.tokenEnd - i);
    ...
    private AstNode assignExpr() throws IOException {
        ...
        if (90 <= peekToken2 && peekToken2 <= 101) {
            ...
            Assignment assignment = new Assignment(peekToken2, condExpr, assignExpr(), this.f6605ts.tokenBeg);
            if (andResetJsDoc != null) {
    ...
    private AstNode orExpr() throws IOException {
        ...
        return new InfixExpression(104, andExpr, orExpr(), this.f6605ts.tokenBeg);
    }
    ...
    private AstNode andExpr() throws IOException {
        ...
        return new InfixExpression(105, bitOrExpr, andExpr(), this.f6605ts.tokenBeg);
    }

    private AstNode bitOrExpr() throws IOException {
        AstNode bitXorExpr = bitXorExpr();
        while (matchToken(9)) {
            bitXorExpr = new InfixExpression(9, bitXorExpr, bitXorExpr(), this.f6605ts.tokenBeg);
        }
        return bitXorExpr;
    }
    ...
    private AstNode bitXorExpr() throws IOException {
        ...
        while (matchToken(10)) {
            bitAndExpr = new InfixExpression(10, bitAndExpr, bitAndExpr(), this.f6605ts.tokenBeg);
        }
        return bitAndExpr;
    }
    ...
    private AstNode bitAndExpr() throws IOException {
        ...
        while (matchToken(11)) {
            eqExpr = new InfixExpression(11, eqExpr, eqExpr(), this.f6605ts.tokenBeg);
        }
        return eqExpr;
    }
        ...
        if (peekToken != -1) {
            if (peekToken != 14) {
                if (peekToken != 126) {
                    if (peekToken == 21) {
                        consumeToken();
                        UnaryExpression unaryExpression = new UnaryExpression(28, this.f6605ts.tokenBeg, unaryExpr());
                        unaryExpression.setLineno(i);
                        return unaryExpression;
                    } else if (peekToken == 22) {
                        consumeToken();
                        UnaryExpression unaryExpression2 = new UnaryExpression(29, this.f6605ts.tokenBeg, unaryExpr());
                        unaryExpression2.setLineno(i);
                        return unaryExpression2;
                    } else if (!(peekToken == 26 || peekToken == 27)) {
                        if (peekToken == 31) {
                            consumeToken();
                            UnaryExpression unaryExpression3 = new UnaryExpression(peekToken, this.f6605ts.tokenBeg, unaryExpr());
                            unaryExpression3.setLineno(i);
                            return unaryExpression3;
                        } else if (peekToken != 32) {
                            if (peekToken == 106 || peekToken == 107) {
                                consumeToken();
                                UnaryExpression unaryExpression4 = new UnaryExpression(peekToken, this.f6605ts.tokenBeg, memberExpr(true));
                ...
                consumeToken();
                UnaryExpression unaryExpression5 = new UnaryExpression(peekToken, this.f6605ts.tokenBeg, unaryExpr());
            ...
            consumeToken();
            UnaryExpression unaryExpression6 = new UnaryExpression(peekTokenOrEOL, this.f6605ts.tokenBeg, memberExpr, true);
    ...
    private AstNode xmlInitializer() throws IOException {
        ...
        int i = this.f6605ts.tokenBeg;
        int firstXMLToken = this.f6605ts.getFirstXMLToken();
        if (firstXMLToken == 145 || firstXMLToken == 148) {
            XmlLiteral xmlLiteral = new XmlLiteral(i);
            xmlLiteral.setLineno(this.f6605ts.lineno);
            while (firstXMLToken == 145) {
                xmlLiteral.addFragment(new XmlString(this.f6605ts.tokenBeg, this.f6605ts.getString()));
                mustMatchToken(85, "msg.syntax");
                int i2 = this.f6605ts.tokenBeg;
                AstNode emptyExpression = peekToken() == 86 ? new EmptyExpression(i2, this.f6605ts.tokenEnd - i2) : expr();
                mustMatchToken(86, "msg.syntax");
                XmlExpression xmlExpression = new XmlExpression(i2, emptyExpression);
                xmlExpression.setIsXmlAttribute(this.f6605ts.isXMLAttribute());
                xmlExpression.setLength(this.f6605ts.tokenEnd - i2);
                xmlLiteral.addFragment(xmlExpression);
                firstXMLToken = this.f6605ts.getNextXMLToken();
            }
    ...
    private org.mozilla.javascript.ast.AstNode memberExprTail(boolean r9, org.mozilla.javascript.ast.AstNode r10) throws java.io.IOException {
        ...
        L_0x0023:
            r8.consumeToken()
            org.mozilla.javascript.TokenStream r1 = r8.f6605ts
            int r1 = r1.tokenBeg
            org.mozilla.javascript.TokenStream r2 = r8.f6605ts
            int r2 = r2.lineno
            r8.mustHaveXML()
            ...
            org.mozilla.javascript.TokenStream r3 = r8.f6605ts
            int r3 = r3.tokenBeg
            org.mozilla.javascript.TokenStream r5 = r8.f6605ts
            int r5 = r5.tokenEnd
        L_0x004e:
        ...
        L_0x0075:
            ...
            r2.setTarget(r10)
            r2.setLineno(r1)
            org.mozilla.javascript.TokenStream r10 = r8.f6605ts
    ...
    private AstNode propertyAccess(int i, AstNode astNode) throws IOException {
        ...
        if (!this.compilerEnv.isXmlAvailable()) {
            if (nextToken() != 39 && (!this.compilerEnv.isReservedKeywordAsIdentifier() || !TokenStream.isKeyword(this.f6605ts.getString()))) {
        ...
        if (nextToken == 23) {
            saveNameTokenData(this.f6605ts.tokenBeg, "*", this.f6605ts.lineno);
            astNode2 = propertyName(-1, "*", i2);
        } else if (nextToken == 39) {
            astNode2 = propertyName(-1, this.f6605ts.getString(), i2);
        } else if (nextToken == 50) {
            saveNameTokenData(this.f6605ts.tokenBeg, "throw", this.f6605ts.lineno);
            ...
            saveNameTokenData(this.f6605ts.tokenBeg, keywordToName, this.f6605ts.lineno);
    ...
    private AstNode attributeAccess() throws IOException {
        ...
        if (nextToken == 23) {
            ...
            return propertyName(i, this.f6605ts.getString(), 0);
        } else {
            if (nextToken == 83) {
    ...
    private AstNode propertyName(int i, String str, int i2) throws IOException {
        Name name;
        int i3;
        int i4 = i != -1 ? i : this.f6605ts.tokenBeg;
        int i5 = this.f6605ts.lineno;
                    ...
                    if (i != 100) {
                        ...
                        if (i == 127) {
                            ...
                            switch (i) {
                                ...
                                case 40:
                                    String string = this.f6605ts.getString();
                                    if (this.inUseStrictDirective && this.f6605ts.isNumberOctal()) {
                                        reportError("msg.no.octal.strict");
                                    }
                                    if (this.f6605ts.isNumberOctal()) {
                                        string = "0" + string;
                                    }
                                    if (this.f6605ts.isNumberHex()) {
                                        string = "0x" + string;
                                    }
                                    return new NumberLiteral(this.f6605ts.tokenBeg, string, this.f6605ts.getNumber());
                                case 41:
                                ...
                                case 45:
                                    int i2 = this.f6605ts.tokenBeg;
                                    return new KeywordLiteral(i2, this.f6605ts.tokenEnd - i2, i);
                                default:
                                    reportError("msg.syntax");
                                    break;
                            }
                        } else {
                            return let(false, this.f6605ts.tokenBeg);
                        }
                    }
                }
                this.f6605ts.readRegExp(i);
                int i3 = this.f6605ts.tokenBeg;
                RegExpLiteral regExpLiteral = new RegExpLiteral(i3, this.f6605ts.tokenEnd - i3);
                regExpLiteral.setValue(this.f6605ts.getString());
                regExpLiteral.setFlags(this.f6605ts.readAndClearRegExpFlags());
    ...
    private AstNode parenExpr() throws IOException {
        ...
        try {
            ...
            parenthesizedExpression.setLength(this.f6605ts.tokenEnd - parenthesizedExpression.getPosition());
    ...
    private AstNode name(int i, int i2) throws IOException {
        ...
        Label label = new Label(i3, this.f6605ts.tokenEnd - i3);
        label.setName(string);
        label.setLineno(this.f6605ts.lineno);
        return label;
    }
    ...
    private AstNode arrayLiteral() throws IOException {
        ...
        while (true) {
            ...
            while (true) {
                ...
                consumeToken();
                i5 = this.f6605ts.tokenEnd;
                if (i3 == 0) {
                    i3 = 1;
                } else {
                    arrayList.add(new EmptyExpression(this.f6605ts.tokenBeg, 1));
                    i4++;
                }
            }
            if (peekToken == 84) {
                consumeToken();
                i2 = this.f6605ts.tokenEnd;
    ...
    private AstNode arrayComprehension(AstNode astNode, int i) throws IOException {
        ...
        if (peekToken() == 112) {
            consumeToken();
            i2 = this.f6605ts.tokenBeg - i;
            conditionData = condition();
        }
        mustMatchToken(84, "msg.no.bracket.arg");
        ArrayComprehension arrayComprehension = new ArrayComprehension(i, this.f6605ts.tokenEnd - i);
        ...
        if (conditionData != null) {
            ...
            arrayComprehension.setFilterLp(conditionData.f6606lp - i);
            arrayComprehension.setFilterRp(conditionData.f6607rp - i);
        }
    ...
    private org.mozilla.javascript.ast.ArrayComprehensionLoop arrayComprehensionLoop() throws java.io.IOException {
        ...
        L_0x000b:
            ...
            org.mozilla.javascript.TokenStream r3 = r11.f6605ts     // Catch:{ all -> 0x00c7 }
        ...
        L_0x003a:
            ...
            org.mozilla.javascript.TokenStream r4 = r11.f6605ts     // Catch:{ all -> 0x00c7 }
        ...
        L_0x006d:
            ...
            org.mozilla.javascript.TokenStream r7 = r11.f6605ts     // Catch:{ all -> 0x00c7 }
        ...
        L_0x007f:
            ...
            org.mozilla.javascript.TokenStream r2 = r11.f6605ts     // Catch:{ all -> 0x00c7 }
        ...
        L_0x0090:
            ...
            org.mozilla.javascript.TokenStream r9 = r11.f6605ts     // Catch:{ all -> 0x00c7 }
        ...
        L_0x00a4:
            r9 = -1
        L_0x00a5:
            org.mozilla.javascript.TokenStream r10 = r11.f6605ts     // Catch:{ all -> 0x00c7 }
    ...
    private AstNode generatorExpression(AstNode astNode, int i, boolean z) throws IOException {
        ...
        GeneratorExpression generatorExpression = new GeneratorExpression(i, this.f6605ts.tokenEnd - i);
        ...
        if (conditionData != null) {
            ...
            generatorExpression.setFilterLp(conditionData.f6606lp - i);
            generatorExpression.setFilterRp(conditionData.f6607rp - i);
        }
    ...
    private GeneratorExpressionLoop generatorExpressionLoop() throws IOException {
        ...
        try {
            int i2 = -1;
            int i3 = mustMatchToken(87, "msg.no.paren.for") ? this.f6605ts.tokenBeg - i : -1;
            AstNode astNode = null;
            int peekToken = peekToken();
            if (peekToken == 39) {
                consumeToken();
            ...
            if (astNode.getType() == 39) {
                defineSymbol(153, this.f6605ts.getString(), true);
            }
            int i4 = mustMatchToken(52, "msg.in.after.for.name") ? this.f6605ts.tokenBeg - i : -1;
            AstNode expr = expr();
            if (mustMatchToken(88, "msg.no.paren.for.ctrl")) {
                i2 = this.f6605ts.tokenBeg - i;
            }
            generatorExpressionLoop.setLength(this.f6605ts.tokenEnd - i);
    ...
    private org.mozilla.javascript.ast.ObjectLiteral objectLiteral() throws java.io.IOException {
        /*
            r16 = this;
            r0 = r16
            org.mozilla.javascript.TokenStream r1 = r0.f6605ts
            int r1 = r1.tokenBeg
            org.mozilla.javascript.TokenStream r2 = r0.f6605ts
            int r2 = r2.lineno
        ...
        L_0x0047:
            ...
            goto L_0x00bc
        L_0x004a:
            org.mozilla.javascript.TokenStream r5 = r0.f6605ts
            java.lang.String r5 = r5.getString()
            org.mozilla.javascript.TokenStream r8 = r0.f6605ts
            int r8 = r8.tokenBeg
            r16.consumeToken()
        ...
        L_0x0099:
            ...
            goto L_0x00bc
        L_0x009e:
            org.mozilla.javascript.TokenStream r10 = r0.f6605ts
    ...
    private AstNode objliteralProperty() throws IOException {
        switch (peekToken()) {
            ...
            case 40:
                return new NumberLiteral(this.f6605ts.tokenBeg, this.f6605ts.getString(), this.f6605ts.getNumber());
            case 41:
                return createStringLiteral();
            default:
                if (!this.compilerEnv.isReservedKeywordAsIdentifier() || !TokenStream.isKeyword(this.f6605ts.getString())) {
                    return null;
                }
                return createNameNode();
        }
    ...
    private ObjectProperty plainProperty(AstNode astNode, int i) throws IOException {
        ...
        objectProperty2.setOperatorPosition(this.f6605ts.tokenBeg);
    ...
    private org.mozilla.javascript.ast.Name createNameNode(boolean r6, int r7) {
        /*
            r5 = this;
            org.mozilla.javascript.TokenStream r0 = r5.f6605ts
            int r0 = r0.tokenBeg
            org.mozilla.javascript.TokenStream r1 = r5.f6605ts
            java.lang.String r1 = r1.getString()
            org.mozilla.javascript.TokenStream r2 = r5.f6605ts
            int r2 = r2.lineno
    ...
    private StringLiteral createStringLiteral() {
        int i = this.f6605ts.tokenBeg;
        StringLiteral stringLiteral = new StringLiteral(i, this.f6605ts.tokenEnd - i);
        stringLiteral.setLineno(this.f6605ts.lineno);
        stringLiteral.setValue(this.f6605ts.getString());
        stringLiteral.setQuoteCharacter(this.f6605ts.getQuoteChar());
    ...
    private ErrorNode makeErrorNode() {
        ErrorNode errorNode = new ErrorNode(this.f6605ts.tokenBeg, this.f6605ts.tokenEnd - this.f6605ts.tokenBeg);
        errorNode.setLineno(this.f6605ts.lineno);
        return errorNode;
    }
    ...
    private void warnMissingSemi(int i, int i2) {
        if (this.compilerEnv.isStrictMode()) {
            int[] iArr = new int[2];
            String line = this.f6605ts.getLine(i2, iArr);
            if (this.compilerEnv.isIdeMode()) {
    ...
    private RuntimeException codeBug() throws RuntimeException {
        throw Kit.codeBug("ts.cursor=" + this.f6605ts.cursor + ", ts.tokenBeg=" + this.f6605ts.tokenBeg + ", currentToken=" + this.currentToken);
    }
}
