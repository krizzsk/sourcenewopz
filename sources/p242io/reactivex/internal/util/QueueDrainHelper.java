...
public final class QueueDrainHelper {
    ...
    /* renamed from: a */
    static final long f59299a = Long.MIN_VALUE;

    /* renamed from: b */
    static final long f59300b = Long.MAX_VALUE;
    ...
    public static <T> boolean postCompleteRequest(long j, Subscriber<? super T> subscriber, Queue<T> queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        ...
        m41869a(j3 | Long.MIN_VALUE, subscriber, queue, atomicLong, booleanSupplier);
        return true;
    }

    /* renamed from: a */
    static boolean m41870a(BooleanSupplier booleanSupplier) {
        try {
    ...
    /* renamed from: a */
    static <T> boolean m41869a(long j, Subscriber<? super T> subscriber, Queue<T> queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        long j2 = j & Long.MIN_VALUE;
        while (true) {
            if (j2 != j) {
                if (m41870a(booleanSupplier)) {
                    return true;
                }
                T poll = queue.poll();
                if (poll == null) {
                ...
                j2++;
            } else if (m41870a(booleanSupplier)) {
                return true;
            } else {
                if (queue.isEmpty()) {
                    subscriber.onComplete();
    ...
    public static <T> void postComplete(Subscriber<? super T> subscriber, Queue<T> queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        ...
        if (queue.isEmpty()) {
            subscriber.onComplete();
        } else if (!m41869a(atomicLong.get(), subscriber, queue, atomicLong, booleanSupplier)) {
            do {
                j = atomicLong.get();
            ...
            if (j != 0) {
                m41869a(j2, subscriber, queue, atomicLong, booleanSupplier);
            }
        }
    }
}
