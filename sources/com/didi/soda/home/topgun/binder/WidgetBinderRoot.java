...
public final class WidgetBinderRoot extends BinderRoot<Buildable, ComponentModel> {
    ...
    public Buildable createView(Context context, ComponentModel componentModel) {
        ...
        Buildable renderViewWithData = BlocksEngine.Companion.getInstance$default(BlocksEngine.Companion, (String) null, 1, (Object) null).renderViewWithData(context, this.f42767a, componentModel.getWidgetNodeModel(), getConfig());
    ...
    public void bind(Buildable buildable, ComponentModel componentModel, int i) {
        ...
        BlocksEngine.bindDataOnWidget$default(BlocksEngine.Companion.getInstance$default(BlocksEngine.Companion, (String) null, 1, (Object) null), this.f42767a, buildable, componentModel.getWidgetNodeModel(), (BinderRootConfig) null, 8, (Object) null);
    }
}
