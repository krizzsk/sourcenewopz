...
public final class TypeUtil {
    ...
    /* renamed from: a */
    static boolean m14790a(Object obj, Object obj2) {
        return obj == obj2 || (obj != null && obj.equals(obj2));
    }

    /* access modifiers changed from: private */
    /* renamed from: c */
    public static <T> T m14794c(T t) {
        if (t != null) {
            return t;
        }
        throw null;
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public static void m14792b(Type type) {
        m14793b(!(type instanceof Class) || !((Class) type).isPrimitive());
    }

    /* access modifiers changed from: private */
    /* renamed from: b */
    public static void m14793b(boolean z) {
        if (!z) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: d */
    public static int m14795d(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public static final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            while (true) {
                ...
                if (i < typeArr2.length) {
                    Object unused = TypeUtil.m14794c(typeArr2[i]);
                    TypeUtil.m14792b(this.mTypeArguments[i]);
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ParameterizedType) {
                ...
                return TypeUtil.m14790a(this.mRawType, parameterizedType.getRawType()) && TypeUtil.m14790a(this.mOwnerType, parameterizedType.getOwnerType()) && Arrays.equals(this.mTypeArguments, parameterizedType.getActualTypeArguments());
            }
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.mTypeArguments) ^ this.mRawType.hashCode()) ^ TypeUtil.m14795d(this.mOwnerType);
        }
