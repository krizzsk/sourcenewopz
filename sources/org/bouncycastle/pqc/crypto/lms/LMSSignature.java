...
class LMSSignature implements Encodable {
    ...
    /* renamed from: q */
    private final int f6476q;

    /* renamed from: y */
    private final byte[][] f6477y;
    ...
    public static org.bouncycastle.pqc.crypto.lms.LMSSignature getInstance(java.lang.Object r7) throws java.io.IOException {
        ...
        L_0x0062:
            ...
            byte[] r7 = org.bouncycastle.util.p084io.Streams.readAll(r7)
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f6476q != lMSSignature.f6476q) {
            return false;
        }
        ...
        if (lMSigParameters == null ? lMSSignature.parameter == null : lMSigParameters.equals(lMSSignature.parameter)) {
            return Arrays.deepEquals(this.f6477y, lMSSignature.f6477y);
        }
        return false;
    }

    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.f6476q).bytes(this.otsSignature.getEncoded()).u32str(this.parameter.getType()).bytes(this.f6477y).build();
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode + i2) * 31) + Arrays.deepHashCode(this.f6477y);
    }
}
