...
final class C21613xb2505175 extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFBiFunction;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C21613xb2505175(String str) {
        super(1);
    ...
    public final void invoke(SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder functionEnhancementBuilder) {
        ...
        functionEnhancementBuilder.parameter(this.$JFBiFunction, PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60605b);
    }
}
