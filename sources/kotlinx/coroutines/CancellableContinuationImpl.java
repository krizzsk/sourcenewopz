...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CoroutineStackFrame, CancellableContinuation<T> {
    ...
    public final boolean resetStateReusable() {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(obj instanceof NotCompleted))) {
            throw new AssertionError();
        } else if (!(obj instanceof C21973h) || ((C21973h) obj).f61507d == null) {
            this._decision = 0;
            this._state = C21818a.f61360a;
            return true;
        } else {
    ...
    public final Object getResult() {
        ...
        if (state$kotlinx_coroutines_core instanceof CompletedExceptionally) {
            ...
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (continuation instanceof CoroutineStackFrame) {
                    th = StackTraceRecoveryKt.m45986a(th, (CoroutineStackFrame) continuation);
                }
            }
            throw th;
            ...
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (continuation2 instanceof CoroutineStackFrame) {
                    cancellationException = StackTraceRecoveryKt.m45986a(cancellationException, (CoroutineStackFrame) continuation2);
                }
            }
        ...
        while (true) {
            ...
            if (obj instanceof C21818a) {
                ...
                if (z) {
                    ...
                    return;
                } else if (obj instanceof C21973h) {
                    C21973h hVar = (C21973h) obj;
                    if (hVar.f61505b != null) {
                        multipleHandlersError(function1, obj);
                    }
                    if (!(makeCancelHandler instanceof BeforeResumeCancelHandler)) {
                        if (hVar.mo181101a()) {
                            callCancelHandler(function1, hVar.f61508e);
                            return;
                        }
                        if (_state$FU.compareAndSet(this, obj, C21973h.m45941a(hVar, (Object) null, makeCancelHandler, (Function1) null, (Object) null, (Throwable) null, 29, (Object) null))) {
                            return;
                        }
                    } else {
                        return;
                    ...
                    if (_state$FU.compareAndSet(this, obj, new C21973h(obj, makeCancelHandler, (Function1) null, (Object) null, (Throwable) null, 28, (DefaultConstructorMarker) null))) {
                        return;
                    }
                } else {
                    return;
    ...
    private final CancelHandler makeCancelHandler(Function1<? super Throwable, Unit> function1) {
        return function1 instanceof CancelHandler ? (CancelHandler) function1 : new C21986o(function1);
    }
    ...
    private final Object resumedState(NotCompleted notCompleted, Object obj, int i, Function1<? super Throwable, Unit> function1, Object obj2) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return new C21973h(obj, notCompleted instanceof CancelHandler ? (CancelHandler) notCompleted : null, function1, obj2, (Throwable) null, 16, (DefaultConstructorMarker) null);
        }
    }
    ...
    public <T> T getSuccessfulResult$kotlinx_coroutines_core(Object obj) {
        return obj instanceof C21973h ? ((C21973h) obj).f61504a : obj;
    }
    ...
    public Throwable getExceptionalResult$kotlinx_coroutines_core(Object obj) {
        ...
        return (!DebugKt.getRECOVER_STACK_TRACES() || !(delegate$kotlinx_coroutines_core instanceof CoroutineStackFrame)) ? exceptionalResult$kotlinx_coroutines_core : StackTraceRecoveryKt.m45986a(exceptionalResult$kotlinx_coroutines_core, (CoroutineStackFrame) delegate$kotlinx_coroutines_core);
    }
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object obj, Throwable th) {
        while (true) {
            ...
            if (obj2 instanceof NotCompleted) {
                ...
                if (obj2 instanceof C21973h) {
                    C21973h hVar = (C21973h) obj2;
                    if (!hVar.mo181101a()) {
                        if (_state$FU.compareAndSet(this, obj2, C21973h.m45941a(hVar, (Object) null, (CancelHandler) null, (Function1) null, (Object) null, th, 15, (Object) null))) {
                            hVar.mo181100a(this, th);
                            return;
                        }
                    } else {
                        throw new IllegalStateException("Must be called at most once".toString());
                    }
                } else if (_state$FU.compareAndSet(this, obj2, new C21973h(obj2, (CancelHandler) null, (Function1) null, (Object) null, th, 14, (DefaultConstructorMarker) null))) {
                    return;
                }
            } else {
                return;
    ...
    private final Symbol tryResumeImpl(Object obj, Object obj2, Function1<? super Throwable, Unit> function1) {
        ...
        do {
            ...
            } else if (!(obj3 instanceof C21973h)) {
                return null;
            } else {
                if (obj2 != null) {
                    C21973h hVar = (C21973h) obj3;
                    if (hVar.f61507d == obj2) {
                        if (!DebugKt.getASSERTIONS_ENABLED() || Intrinsics.areEqual(hVar.f61504a, obj)) {
