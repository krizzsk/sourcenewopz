...
public class SwitchGenerator {
    ...
    /* renamed from: P */
    private CodePrinter f6670P;

    /* renamed from: R */
    private ToolErrorReporter f6671R;
    ...
    String v_c = "c";
    String v_guess = C16471q.f49112a;
    String v_id = "id";
    String v_label = "L";
    ...
    private void generate_body(int i, int i2, int i3) {
        this.f6670P.indent(i3);
        this.f6670P.mo36102p(this.v_switch_label);
        this.f6670P.mo36102p(": { ");
        this.f6670P.mo36102p(this.v_id);
        this.f6670P.mo36102p(" = ");
        this.f6670P.mo36102p(this.default_value);
        this.f6670P.mo36102p("; String ");
        this.f6670P.mo36102p(this.v_guess);
        this.f6670P.mo36102p(" = null;");
        this.c_was_defined = false;
        int offset = this.f6670P.getOffset();
        this.f6670P.mo36102p(" int ");
        this.f6670P.mo36102p(this.v_c);
        this.f6670P.mo36100p(';');
        int offset2 = this.f6670P.getOffset();
        this.f6670P.mo36099nl();
        int i4 = i3 + 1;
        generate_length_switch(i, i2, i4);
        if (!this.c_was_defined) {
            this.f6670P.erase(offset, offset2);
        }
        this.f6670P.indent(i4);
        this.f6670P.mo36102p("if (");
        this.f6670P.mo36102p(this.v_guess);
        this.f6670P.mo36102p("!=null && ");
        this.f6670P.mo36102p(this.v_guess);
        this.f6670P.mo36102p("!=");
        this.f6670P.mo36102p(this.v_s);
        this.f6670P.mo36102p(" && !");
        this.f6670P.mo36102p(this.v_guess);
        this.f6670P.mo36102p(".equals(");
        this.f6670P.mo36102p(this.v_s);
        this.f6670P.mo36102p(")) ");
        this.f6670P.mo36102p(this.v_id);
        this.f6670P.mo36102p(" = ");
    ...
    private void generate_length_switch(int r12, int r13, int r14) {
        /*
            ...
            org.mozilla.javascript.tools.idswitch.CodePrinter r1 = r11.f6670P
            r1.indent(r14)
            org.mozilla.javascript.tools.idswitch.CodePrinter r1 = r11.f6670P
            java.lang.String r4 = "int "
            r1.mo36102p((java.lang.String) r4)
            org.mozilla.javascript.tools.idswitch.CodePrinter r1 = r11.f6670P
        ...
        L_0x0093:
            ...
            org.mozilla.javascript.tools.idswitch.CodePrinter r6 = r11.f6670P
            r6.indent(r14)
            if (r5 == r12) goto L_0x00a3
            org.mozilla.javascript.tools.idswitch.CodePrinter r6 = r11.f6670P
            java.lang.String r7 = "else "
            r6.mo36102p((java.lang.String) r7)
        L_0x00a3:
            org.mozilla.javascript.tools.idswitch.CodePrinter r6 = r11.f6670P
        ...
        L_0x00d0:
            org.mozilla.javascript.tools.idswitch.CodePrinter r6 = r11.f6670P
            r6.mo36101p((int) r4)
            org.mozilla.javascript.tools.idswitch.CodePrinter r4 = r11.f6670P
            java.lang.String r6 = ") {"
            r4.mo36102p((java.lang.String) r6)
            goto L_0x00f5
        L_0x00dd:
            org.mozilla.javascript.tools.idswitch.CodePrinter r6 = r11.f6670P
            r6.indent(r14)
        ...
        L_0x00f5:
            ...
            org.mozilla.javascript.tools.idswitch.CodePrinter r5 = r11.f6670P
            r5.mo36102p((java.lang.String) r4)
            org.mozilla.javascript.tools.idswitch.CodePrinter r5 = r11.f6670P
            r5.mo36099nl()
            goto L_0x0129
        L_0x010f:
            ...
            r5.mo36102p((java.lang.String) r6)
            org.mozilla.javascript.tools.idswitch.CodePrinter r5 = r11.f6670P
        ...
        L_0x0129:
            ...
            org.mozilla.javascript.tools.idswitch.CodePrinter r12 = r11.f6670P
            r12.indent(r14)
            org.mozilla.javascript.tools.idswitch.CodePrinter r12 = r11.f6670P
            r12.mo36102p((java.lang.String) r4)
            org.mozilla.javascript.tools.idswitch.CodePrinter r12 = r11.f6670P
            r12.mo36099nl()
        L_0x013c:
            return
    ...
    private boolean generate_letter_switch_r(int i, int i2, int i3, int i4, boolean z, boolean z2) {
        ...
        if (i6 + 1 == i7) {
            ...
            if (i8 > this.char_tail_test_threshold) {
                this.f6670P.mo36102p(this.v_guess);
                this.f6670P.mo36102p("=");
                this.f6670P.qstring(idValuePair.f6667id);
                this.f6670P.mo36102p(";");
                this.f6670P.mo36102p(this.v_id);
                this.f6670P.mo36102p("=");
                this.f6670P.mo36102p(idValuePair.value);
                this.f6670P.mo36102p(";");
            } else if (i8 == 0) {
                this.f6670P.mo36102p(this.v_id);
                this.f6670P.mo36102p("=");
                ...
                this.f6670P.mo36102p(this.v_s);
                this.f6670P.mo36102p(".charAt(");
                this.f6670P.mo36101p(i10);
                this.f6670P.mo36102p(")==");
                this.f6670P.qchar(idValuePair.f6667id.charAt(i10));
                for (int i11 = 1; i11 != i8; i11++) {
                    this.f6670P.mo36102p(" && ");
                    int i12 = this.columns[i11];
                    this.f6670P.mo36102p(this.v_s);
                    this.f6670P.mo36102p(".charAt(");
                    this.f6670P.mo36101p(i12);
                    this.f6670P.mo36102p(")==");
                    this.f6670P.qchar(idValuePair.f6667id.charAt(i12));
                }
                this.f6670P.mo36102p(") {");
                this.f6670P.mo36102p(this.v_id);
                this.f6670P.mo36102p("=");
        ...
        if (count_different_chars <= this.use_if_threshold) {
            ...
            this.f6670P.mo36102p(this.v_s);
            this.f6670P.mo36102p(".charAt(");
            this.f6670P.mo36101p(i13);
            this.f6670P.mo36102p(");");
            z4 = z;
            z3 = true;
        } else {
            if (!z) {
                this.f6670P.mo36102p(this.v_label);
                this.f6670P.mo36102p(": ");
                z5 = true;
            } else {
                z5 = z;
            }
            this.f6670P.mo36102p("switch (");
            this.f6670P.mo36102p(this.v_s);
            this.f6670P.mo36102p(".charAt(");
            this.f6670P.mo36101p(i13);
            this.f6670P.mo36102p(")) {");
        ...
        char charAt = this.pairs[i6].f6667id.charAt(i13);
        int i15 = i6;
        int i16 = i15;
        char c = 0;
        while (true) {
            int i17 = i16 + 1;
            if (i17 == i7 || (c = this.pairs[i17].f6667id.charAt(i13)) != charAt) {
                char c2 = c;
                if (z3) {
                    this.f6670P.mo36099nl();
                    this.f6670P.indent(i9);
                    if (i15 != i6) {
                        this.f6670P.mo36102p("else ");
                    }
                    this.f6670P.mo36102p("if (");
                    this.f6670P.mo36102p(this.v_c);
                    this.f6670P.mo36102p("==");
                    this.f6670P.qchar(charAt);
                    this.f6670P.mo36102p(") {");
                } else {
                    this.f6670P.mo36099nl();
                    this.f6670P.indent(i9);
                    this.f6670P.mo36102p("case ");
                    this.f6670P.qchar(charAt);
                    this.f6670P.mo36102p(":");
                }
                int i18 = i17;
    ...
    private int count_different_chars(int i, int i2, int i3) {
        ...
        char c = 65535;
        while (i != i2) {
            char charAt = this.pairs[i].f6667id.charAt(i3);
            if (charAt != c) {
                i4++;
                c = charAt;
            }
        ...
        if (i != i2) {
            ...
            while (true) {
                ...
                if (i != i2) {
                    ...
                    if (!idValuePair.f6667id.equals(idValuePair2.f6667id)) {
    ...
    private EvaluatorException on_same_pair_fail(IdValuePair idValuePair, IdValuePair idValuePair2) {
        ...
        return this.f6671R.runtimeError(ToolErrorReporter.getMessage("msg.idswitch.same_string", idValuePair.f6667id, new Integer(lineNumber)), this.source_file, i, (String) null, 0);
    }
    ...
    private static boolean bigger(IdValuePair idValuePair, IdValuePair idValuePair2, int i) {
        if (i < 0) {
            ...
            if (idValuePair.f6667id.compareTo(idValuePair2.f6667id) > 0) {
                return true;
            }
            return false;
        } else if (idValuePair.f6667id.charAt(i) > idValuePair2.f6667id.charAt(i)) {
            return true;
        } else {
            return false;
        }
