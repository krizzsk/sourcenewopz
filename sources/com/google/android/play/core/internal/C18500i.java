...
public final class C18500i {
    /* renamed from: a */
    private static int m37921a(int i) {
        if (i == 513) {
            return 1;
        }
        if (i == 514) {
    ...
    /* renamed from: a */
    public static long m37922a(ByteBuffer byteBuffer) {
        m37939c(byteBuffer);
        return m37923a(byteBuffer, byteBuffer.position() + 16);
    }

    /* renamed from: a */
    private static long m37923a(ByteBuffer byteBuffer, int i) {
        return ((long) byteBuffer.getInt(i)) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
    }

    /* renamed from: a */
    static Pair<ByteBuffer, Long> m37924a(RandomAccessFile randomAccessFile) throws IOException {
        if (randomAccessFile.length() < 22) {
            return null;
        }
        Pair<ByteBuffer, Long> a = m37925a(randomAccessFile, 0);
        return a != null ? a : m37925a(randomAccessFile, 65535);
    }

    /* renamed from: a */
    private static Pair<ByteBuffer, Long> m37925a(RandomAccessFile randomAccessFile, int i) throws IOException {
        int i2;
    ...
    /* renamed from: a */
    public static String m37926a(String str, String str2) {
    ...
    /* renamed from: a */
    public static String m37927a(String str, String str2, String str3) {
    ...
    /* renamed from: a */
    private static void m37928a(int i, byte[] bArr) {
        bArr[1] = (byte) (i & 255);
        bArr[2] = (byte) ((i >>> 8) & 255);
    ...
    /* renamed from: a */
    public static void m37929a(ByteBuffer byteBuffer, long j) {
        m37939c(byteBuffer);
    ...
    /* renamed from: a */
    private static void m37930a(Map<Integer, byte[]> map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            C18495d dVar = new C18495d(fileChannel, 0, j);
            C18495d dVar2 = new C18495d(fileChannel, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j4 = j;
            m37929a(duplicate, j);
            C18452b bVar = new C18452b(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] a = m37932a(iArr, new C18479c[]{dVar, dVar2, bVar});
                while (i < size) {
                    int i3 = iArr[i];
                    ...
                    if (MessageDigest.isEqual(map.get(Integer.valueOf(i3)), a[i])) {
                        ...
                        throw new SecurityException(m37936b(i3).concat(" digest of contents did not verify"));
                    }
                }
    ...
    private static java.security.cert.X509Certificate[] m37931a(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        /*
            java.nio.ByteBuffer r0 = m37940d(r22)
            java.nio.ByteBuffer r1 = m37940d(r22)
            byte[] r2 = m37941e(r22)
        ...
        L_0x0016:
            ...
            int r8 = r8 + 1
            java.nio.ByteBuffer r10 = m37940d(r1)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
        ...
        L_0x0046:
            ...
            int r11 = m37921a((int) r5)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            int r12 = m37921a((int) r7)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            if (r11 == r15) goto L_0x0016
            if (r12 == r15) goto L_0x0055
            goto L_0x0016
        L_0x0055:
            byte[] r7 = m37941e(r10)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            r9 = r7
            r7 = r5
            goto L_0x0016
        L_0x005c:
        ...
        L_0x014e:
            ...
            r0.clear()
            java.nio.ByteBuffer r1 = m37940d(r0)
        ...
        L_0x0164:
            ...
            int r5 = r5 + r15
            java.nio.ByteBuffer r8 = m37940d(r1)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            ...
            byte[] r6 = m37941e(r8)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            goto L_0x0164
        L_0x0187:
        ...
        L_0x0278:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.internal.C18500i.m37931a(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }

    /* renamed from: a */
    private static byte[][] m37932a(int[] iArr, C18479c[] cVarArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (cVarArr[i2].mo149104a() + 1048575) / 1048576;
            i2++;
        }
        if (j3 < 2097151) {
            int i3 = (int) j3;
            ...
            while (true) {
                ...
                byte[] bArr2 = new byte[((m37938c(iArr2[i4]) * i3) + 5)];
                bArr2[0] = 90;
                m37928a(i3, bArr2);
                bArr[i4] = bArr2;
                i4++;
            ...
            int i8 = 0;
            for (i = 3; i6 < i; i = 3) {
                C18479c cVar = cVarArr[i6];
                long j4 = j2;
                int i9 = i6;
                long a = cVar.mo149104a();
                while (a > j2) {
                    ...
                    long j5 = j4;
                    try {
                        cVar.mo149105a(messageDigestArr, j5, min);
                        int i11 = 0;
    ...
    /* renamed from: a */
    public static X509Certificate[][] m37933a(String str) throws C18497f, SecurityException, IOException {
        ByteBuffer byteBuffer;
        int limit;
        int position;
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair<ByteBuffer, Long> a = m37924a(randomAccessFile);
            if (a != null) {
                ...
                if (j >= 0) {
                    ...
                    if (randomAccessFile.readInt() == 1347094023) {
                        throw new C18497f("ZIP64 APK not supported");
                    }
                }
                long a2 = m37922a(byteBuffer2);
                if (a2 >= longValue) {
                    ...
                    sb.append(longValue);
                    throw new C18497f(sb.toString());
                } else if (m37935b(byteBuffer2) + a2 != longValue) {
                    throw new C18497f("ZIP Central Directory is not immediately followed by End of Central Directory");
                } else if (a2 >= 32) {
                    ...
                    if (allocate.getLong(8) == 2334950737559900225L && allocate.getLong(16) == 3617552046287187010L) {
                        ...
                        if (j2 < ((long) allocate.capacity()) || j2 > 2147483639) {
                            ...
                            sb2.append(j2);
                            throw new C18497f(sb2.toString());
                        }
                        int i3 = (int) (8 + j2);
                        long j3 = a2 - ((long) i3);
                        if (j3 >= 0) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= i) {
                                                    ...
                                                    if (j5 < 4 || j5 > 2147483647L) {
                                                        ...
                                                        sb3.append(j5);
                                                        throw new C18497f(sb3.toString());
                                                    }
                                                    int i4 = (int) j5;
                                                    ...
                                                    if (i4 > slice.remaining()) {
                                                        ...
                                                        throw new C18497f(sb4.toString());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        X509Certificate[][] a3 = m37934a(randomAccessFile.getChannel(), new C18496e(m37937b(slice, i4 - 4), longValue2, a2, longValue, byteBuffer2));
                                                    ...
                                                    sb5.append(i2);
                                                    throw new C18497f(sb5.toString());
                                                }
                                            }
                                            throw new C18497f("No APK Signature Scheme v2 block in APK Signing Block");
                                        }
                ...
                sb11.append(length);
                sb11.append(" bytes");
                throw new C18497f(sb11.toString());
            }
        } catch (Throwable th) {
            try {
                randomAccessFile.close();
    ...
    /* renamed from: a */
    private static X509Certificate[][] m37934a(FileChannel fileChannel, C18496e eVar) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer d = m37940d(eVar.f53183a);
                int i = 0;
                while (d.hasRemaining()) {
                    i++;
                    try {
                        arrayList.add(m37931a(m37940d(d), (Map<Integer, byte[]>) hashMap, instance));
                ...
                if (i <= 0) {
                    ...
                    m37930a(hashMap, fileChannel, eVar.f53184b, eVar.f53185c, eVar.f53186d, eVar.f53187e);
    ...
    /* renamed from: b */
    public static long m37935b(ByteBuffer byteBuffer) {
        m37939c(byteBuffer);
        return m37923a(byteBuffer, byteBuffer.position() + 12);
    }

    /* renamed from: b */
    private static String m37936b(int i) {
        if (i == 1) {
            return "SHA-256";
        }
        if (i == 2) {
    ...
    /* renamed from: b */
    private static ByteBuffer m37937b(ByteBuffer byteBuffer, int i) throws BufferUnderflowException {
        if (i >= 0) {
    ...
    /* renamed from: c */
    private static int m37938c(int i) {
        if (i == 1) {
            return 32;
        }
        if (i == 2) {
    ...
    /* renamed from: c */
    private static void m37939c(ByteBuffer byteBuffer) {
        if (byteBuffer.order() != ByteOrder.LITTLE_ENDIAN) {
            throw new IllegalArgumentException("ByteBuffer byte order must be little endian");
        }
    }
    ...
    /* renamed from: d */
    private static ByteBuffer m37940d(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer.remaining() >= 4) {
            int i = byteBuffer.getInt();
            if (i < 0) {
                throw new IllegalArgumentException("Negative length");
            } else if (i <= byteBuffer.remaining()) {
                return m37937b(byteBuffer, i);
            } else {
    ...
    /* renamed from: e */
    private static byte[] m37941e(ByteBuffer byteBuffer) throws IOException {
        int i = byteBuffer.getInt();
        if (i < 0) {
