...
public class GCFBBlockCipher extends StreamBlockCipher {
    ...
    /* renamed from: C */
    private static final byte[] f6096C = {105, 0, 114, 34, 100, -55, 4, 35, -115, 58, -37, -106, 70, -23, 42, -60, Ascii.CAN, -2, -84, -108, 0, -19, 7, Ascii.DC2, -64, -122, -36, -62, -17, 76, -87, 43};
    ...
    public byte calculateByte(byte b) {
        ...
        if (j > 0 && j % 1024 == 0) {
            ...
            underlyingCipher.processBlock(f6096C, 0, bArr, 0);
            underlyingCipher.processBlock(f6096C, 8, bArr, 8);
            underlyingCipher.processBlock(f6096C, 16, bArr, 16);
            underlyingCipher.processBlock(f6096C, 24, bArr, 24);
