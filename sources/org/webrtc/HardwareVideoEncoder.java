...
class HardwareVideoEncoder implements VideoEncoder {
            ...
            synchronized (this.countLock) {
                ...
                while (this.count > 0) {
                    try {
                        ...
                        Logging.m3802e(HardwareVideoEncoder.TAG, "Interrupted while waiting on busy count", e);
                        z = true;
                    }
                }
            }
    ...
    public VideoCodecStatus initEncode(VideoEncoder.Settings settings, VideoEncoder.Callback callback2) {
        ...
        Logging.m3800d(TAG, "initEncode: " + this.width + " x " + this.height + ". @ " + settings.startBitrate + "kbps. Fps: " + settings.maxFramerate + " Use surface mode: " + this.useSurfaceMode);
            ...
            try {
                ...
                if (this.codecType == VideoCodecType.H264) {
                    ...
                    if (c == 0) {
                        ...
                        Logging.m3804w(TAG, "Unknown profile level id: " + str);
                    }
                }
                ...
                Logging.m3802e(TAG, "initEncodeInternal failed", e);
                release();
                return VideoCodecStatus.FALLBACK_SOFTWARE;
            }
        } catch (IOException | IllegalArgumentException unused) {
            Logging.m3801e(TAG, "Cannot create media encoder " + this.codecName);
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
    }
    ...
    public VideoCodecStatus release() {
        ...
        if (this.outputThread == null) {
            videoCodecStatus = VideoCodecStatus.f6712OK;
        } else {
            this.running = false;
            if (!ThreadUtils.joinUninterruptibly(this.outputThread, 5000)) {
                ...
                Logging.m3802e(TAG, "Media encoder release exception", this.shutdownException);
    ...
    public VideoCodecStatus encode(VideoFrame videoFrame, VideoEncoder.EncodeInfo encodeInfo) {
        ...
        if ((width2 != this.width || height2 != this.height || z2 != this.useSurfaceMode) && (resetCodec = resetCodec(width2, height2, z2)) != VideoCodecStatus.f6712OK) {
            return resetCodec;
        }
        if (this.outputBuilders.size() > 2) {
            Logging.m3801e(TAG, "Dropped frame, encoder queue full");
        ...
        if (videoCodecStatus != VideoCodecStatus.f6712OK) {
    ...
    private VideoCodecStatus encodeTextureBuffer(VideoFrame videoFrame) {
        ...
        try {
            ...
            Logging.m3802e(TAG, "encodeTexture failed", e);
    ...
    private VideoCodecStatus encodeByteBuffer(VideoFrame videoFrame, VideoFrame.Buffer buffer, int i) {
        ...
        try {
            ...
            if (dequeueInputBuffer == -1) {
                Logging.m3800d(TAG, "Dropped frame, no input buffers available");
                return VideoCodecStatus.NO_OUTPUT;
            }
            try {
    ...
    private VideoCodecStatus resetCodec(int i, int i2, boolean z) {
        ...
        if (release != VideoCodecStatus.f6712OK) {
            return release;
        }
        this.width = i;
        this.height = i2;
    ...
    private void requestKeyFrame(long j) {
        ...
        try {
            ...
            Logging.m3802e(TAG, "requestKeyFrame failed", e);
        }
    }
        ...
        try {
            ...
            if (dequeueOutputBuffer >= 0) {
                ...
                if (!z || this.codecType != VideoCodecType.H264) {
                    ...
                    Logging.m3800d(TAG, "Prepending config frame of size " + this.configBuffer.capacity() + " to output buffer with offset " + bufferInfo.offset + ", size " + bufferInfo.size);
            ...
            Logging.m3802e(TAG, "deliverOutput failed", e);
        }
    }
    ...
    public void releaseCodecOnOutputThread() {
        ...
        try {
            ...
            Logging.m3802e(TAG, "Media encoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            Logging.m3802e(TAG, "Media encoder release failed", e2);
    ...
    private VideoCodecStatus updateBitrate() {
        ...
        try {
            ...
            Logging.m3802e(TAG, "updateBitrate failed", e);
            return VideoCodecStatus.ERROR;
        }
    }
