            ...
            synchronized (this.zzf) {
                ...
                if (map2 == null) {
                    ...
                    try {
                        ...
                        try {
                            SystemUtils.log(6, "ConfigurationContentLoader", "PhenotypeFlag unable to load ContentProvider, using default values", (Throwable) null, "com.google.android.gms.internal.measurement.zzha", 4);
                            StrictMode.setThreadPolicy(allowThreadDiskReads);
                            map = null;
                        } catch (Throwable th) {
                            StrictMode.setThreadPolicy(allowThreadDiskReads);
