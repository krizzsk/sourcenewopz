...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    /* renamed from: a */
    final ParallelFlowable<T> f59040a;

    /* renamed from: b */
    final Predicate<? super T> f59041b;

    /* renamed from: c */
    final BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> f59042c;
    ...
    public ParallelFilterTry(ParallelFlowable<T> parallelFlowable, Predicate<? super T> predicate, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
        this.f59040a = parallelFlowable;
        this.f59041b = predicate;
        this.f59042c = biFunction;
    }
        ...
        if (validate(subscriberArr)) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (conditionalSubscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i] = new ParallelFilterConditionalSubscriber(conditionalSubscriber, this.f59041b, this.f59042c);
                } else {
                    subscriberArr2[i] = new ParallelFilterSubscriber(conditionalSubscriber, this.f59041b, this.f59042c);
                }
            }
            this.f59040a.subscribe(subscriberArr2);
        }
    }

    public int parallelism() {
        return this.f59040a.parallelism();
    }
    ...
    static final class ParallelFilterSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0017:
                ...
                java.lang.Object r6 = p242io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x004e }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p242io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x004e }
                int[] r7 = p242io.reactivex.internal.operators.parallel.ParallelFilterTry.C212131.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x0063:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.parallel.ParallelFilterTry.ParallelFilterSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static /* synthetic */ class C212131 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.parallel.ParallelFilterTry.C212131.<clinit>():void");
        }
    }
    ...
    static final class ParallelFilterConditionalSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x001a:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p242io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x0051 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p242io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x0051 }
                int[] r7 = p242io.reactivex.internal.operators.parallel.ParallelFilterTry.C212131.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r0) goto L_0x0007
            ...
            L_0x0066:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.parallel.ParallelFilterTry.ParallelFilterConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
