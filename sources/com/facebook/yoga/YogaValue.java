...
public class YogaValue {
    ...
    static /* synthetic */ class C178021 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.yoga.YogaValue.C178021.<clinit>():void");
        }
    }

    public String toString() {
        int i = C178021.$SwitchMap$com$facebook$yoga$YogaUnit[this.unit.ordinal()];
        if (i == 1) {
            return "undefined";
        }
        if (i == 2) {
