...
import p242io.flutter.embedding.engine.dart.PlatformMessageHandler;
...
public class FlutterJNI {
    ...
    public void loadLibrary() {
        if (loadLibraryCalled) {
            Log.m41142w(TAG, "FlutterJNI.loadLibrary called more than once");
        }
    ...
    public void prefetchDefaultFontManager() {
        if (prefetchDefaultFontManagerCalled) {
            Log.m41142w(TAG, "FlutterJNI.prefetchDefaultFontManager called more than once");
        }
    ...
    public void init(Context context, String[] strArr, String str, String str2, String str3, long j) {
        if (initCalled) {
            Log.m41142w(TAG, "FlutterJNI.init called more than once");
        }
    ...
    public static Bitmap decodeImage(ByteBuffer byteBuffer, long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                ...
                Log.m41137e(TAG, "Failed to decode image", e);
            }
        }
        return null;
    }
    ...
    public void dispatchEmptyPlatformMessage(String str, int i) {
        ...
        Log.m41142w(TAG, "Tried to send a platform message to Flutter, but FlutterJNI was detached from native C++. Could not send. Channel: " + str + ". Response ID: " + i);
    }
    ...
    public void dispatchPlatformMessage(String str, ByteBuffer byteBuffer, int i, int i2) {
        ...
        Log.m41142w(TAG, "Tried to send a platform message to Flutter, but FlutterJNI was detached from native C++. Could not send. Channel: " + str + ". Response ID: " + i2);
    }
    ...
    public void invokePlatformMessageEmptyResponseCallback(int i) {
        ...
        try {
            if (isAttached()) {
                ...
                Log.m41142w(TAG, "Tried to send a platform message response, but FlutterJNI was detached from native C++. Could not send. Response ID: " + i);
            }
        } finally {
    ...
    public void requestDartDeferredLibrary(int i) {
        ...
        if (deferredComponentManager2 != null) {
            ...
            Log.m41136e(TAG, "No DeferredComponentManager found. Android setup must be completed before using split AOT deferred components.");
        }
    }
