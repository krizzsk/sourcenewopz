...
public class FusionCacheClient {
    ...
    /* renamed from: a */
    private static final String f18323a = "hybridfile";

    /* renamed from: b */
    private static final long f18324b = 52428800;

    /* renamed from: c */
    private static final AtomicBoolean f18325c = new AtomicBoolean(false);
    /* access modifiers changed from: private */

    /* renamed from: f */
    public static File f18326f;
    public static FusionCacheClient sInstance;

    /* renamed from: d */
    private DiskLruCache f18327d;

    /* renamed from: e */
    private final Context f18328e;

    /* renamed from: g */
    private CookieManager f18329g;

    public static void init(Context context) {
        if (f18325c.compareAndSet(false, true)) {
    ...
    private FusionCacheClient(Context context) {
        ...
        try {
            DiskLruCache open = DiskLruCache.open(C7819Util.getDiskCacheDir(context, f18323a), WsgSafeUtil.getAppVersionCode(context), 1, 52428800);
            this.f18327d = open;
            ...
            f18326f = this.f18327d.getDirectory();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean isValid() {
        return (this.f18327d == null || f18326f == null) ? false : true;
    }
    ...
    public boolean isCacheExist(String str) {
        ...
        try {
            snapshot = this.f18327d.get(m13625b(str));
    ...
    public void saveBody(String str, ByteArrayOutputStream byteArrayOutputStream) {
        if (isValid()) {
            ...
            try {
                DiskLruCache.Editor edit = this.f18327d.edit(m13625b(str));
    ...
    public void saveBody(String str, BufferedInputStream bufferedInputStream) {
        if (isValid()) {
            String b = m13625b(str);
            try {
                DiskLruCache.Editor edit = this.f18327d.edit(b);
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public static String m13625b(String str) {
    ...
    public InputStream getBodyAsStream(String str) {
        try {
            DiskLruCache.Snapshot snapshot = this.f18327d.get(m13625b(str));
            if (snapshot != null) {
    ...
    /* renamed from: b */
    private synchronized CookieManager m13624b() {
        if (this.f18329g == null) {
            this.f18329g = CookieManager.getInstance();
        }
        return this.f18329g;
    }
    ...
    private static class FusionCacheDataHelper {
        ...
        public String getFilePath(String str) {
            return FusionCacheClient.f18326f.getAbsolutePath() + File.separator + str + ".0";
        }
        ...
        public void setHeaders(String str, Map<String, List<String>> map) {
            ...
            edit.putString("fusion_cache_pre_headers_" + FusionCacheClient.m13625b(str), jSONObject.toString());
            edit.apply();
        }
        ...
        public Map<String, String> getHeadersForRequest(String str) {
            HashMap hashMap = new HashMap();
            String string = this.sharedPreferences.getString("fusion_cache_pre_headers_" + FusionCacheClient.m13625b(str), "");
        ...
        public Map<String, String> getHeadersForResponse(String str) {
            HashMap hashMap = new HashMap();
            String a = FusionCacheClient.m13625b(str);
