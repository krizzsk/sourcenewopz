...
public class DSTU7564Digest implements ExtendedDigest, Memoable {
    ...
    private void processBlock(byte[] bArr, int i) {
        ...
        m3634P(this.tempState1);
        m3635Q(this.tempState2);
