...
public final class FlowableScanSeed<T, R> extends C21208a<T, R> {

    /* renamed from: a */
    final BiFunction<R, ? super T, R> f58435a;

    /* renamed from: b */
    final Callable<R> f58436b;

    public FlowableScanSeed(Flowable<T> flowable, Callable<R> callable, BiFunction<R, ? super T, R> biFunction) {
        super(flowable);
        this.f58435a = biFunction;
        this.f58436b = callable;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super R> subscriber) {
        try {
            this.source.subscribe(new ScanSeedSubscriber(subscriber, this.f58435a, ObjectHelper.requireNonNull(this.f58436b.call(), "The seed supplied is null"), bufferSize()));
        } catch (Throwable th) {
