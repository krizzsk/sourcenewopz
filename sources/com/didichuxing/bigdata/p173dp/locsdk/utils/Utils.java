...
public class Utils {
    ...
    /* renamed from: a */
    private static int f46181a = 0;

    /* renamed from: b */
    private static int f46182b = 0;

    /* renamed from: c */
    private static boolean f46183c = false;

    /* renamed from: d */
    private static boolean f46184d = false;

    /* renamed from: e */
    private static volatile String f46185e;

    /* renamed from: f */
    private static String[] f46186f;
    ...
    public static boolean locCorrect(DIDILocation dIDILocation) {
        ...
        if (longitude == 0.0d && latitude == 0.0d) {
            DLog.m32737d("invalid loc all zero");
            return false;
        } else if (longitude > 180.0d || latitude > 90.0d) {
            DLog.m32737d("invalid loc lon:lat : " + longitude + ":" + latitude);
            return false;
    ...
    public static String[] getMccMnc(TelephonyManager telephonyManager) {
        ...
        if (!strArr2[0].equals("0") && !strArr2[1].equals("0")) {
            f46186f = strArr2;
            return strArr2;
        } else if (!strArr2[0].equals("0") || !strArr2[1].equals("0") || (strArr = f46186f) == null) {
            return strArr2;
        } else {
    ...
    static /* synthetic */ class C151751 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f46187xbd3682fa     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f46187xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f46187xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p173dp.locsdk.utils.Utils.C151751.<clinit>():void");
        }
    }

    public static boolean isPermissionStrategyAllowed(Context context) {
        int i = C151751.f46187xbd3682fa[Config.sPermissionStrategy.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
    ...
    /* renamed from: a */
    static boolean m33161a(Location location) {
    ...
    public static String getChipInfo() {
        if (f46185e == null) {
            f46185e = executeShell("getprop", "ro.board.platform");
        }
        return f46185e;
    }
