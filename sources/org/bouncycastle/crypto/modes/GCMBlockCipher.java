...
public class GCMBlockCipher implements AEADBlockCipher {
    ...
    private void initCipher() {
        ...
        if (this.atLengthPre > 0) {
            System.arraycopy(this.S_atPre, 0, this.f6099S, 0, 16);
        }
    }
    ...
    private void processBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        if (bArr2.length - i2 >= 16) {
            ...
            if (this.forEncryption) {
                ...
                gHASHBlock(this.f6099S, bArr3);
                System.arraycopy(bArr3, 0, bArr2, i2, 16);
            } else {
                gHASHBlock(this.f6099S, bArr, i);
    ...
    private void processPartial(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (this.forEncryption) {
            ...
            gHASHPartial(this.f6099S, bArr, i, i2);
        } else {
            gHASHPartial(this.f6099S, bArr, i, i2);
            GCMUtil.xor(bArr, i, bArr3, 0, i2);
        }
    ...
    private void reset(boolean z) {
        ...
        this.atLength = 0;
        this.atLengthPre = 0;
        this.counter = Arrays.clone(this.f6098J0);
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, InvalidCipherTextException {
        ...
        if (j2 > this.atLengthPre) {
            ...
            if (this.exp == null) {
                ...
                basicGCMExponentiator.init(this.f6097H);
            }
            this.exp.exponentiateX(j3, bArr2);
            GCMUtil.multiply(this.S_at, bArr2);
            GCMUtil.xor(this.f6099S, this.S_at);
        }
        byte[] bArr3 = new byte[16];
        ...
        this.cipher.processBlock(this.f6098J0, 0, bArr4, 0);
        GCMUtil.xor(bArr4, this.f6099S);
        int i5 = this.macSize;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (keyParameter != null) {
            ...
            this.multiplier.init(this.f6097H);
            this.exp = null;
