...
public final class TestCoroutineContext implements CoroutineContext {
    ...
    /* renamed from: b */
    public final List<Throwable> f61640b;

    /* renamed from: c */
    private final Dispatcher f61641c;

    /* renamed from: d */
    private final CoroutineExceptionHandler f61642d;
    /* access modifiers changed from: private */

    /* renamed from: e */
    public final ThreadSafeHeap<C21999a> f61643e;

    /* renamed from: f */
    private long f61644f;

    /* renamed from: g */
    private long f61645g;
    ...
    public TestCoroutineContext(String str) {
        this.f61639a = str;
        this.f61640b = new ArrayList();
        this.f61641c = new Dispatcher();
        this.f61642d = new C21998x227a8509(CoroutineExceptionHandler.Key, this);
        this.f61643e = new ThreadSafeHeap<>();
    }
    ...
    public <R> R fold(R r, Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
        return function2.invoke(function2.invoke(r, this.f61641c), this.f61642d);
    }

    public <E extends CoroutineContext.Element> E get(CoroutineContext.Key<E> key) {
        if (key == ContinuationInterceptor.Key) {
            return (CoroutineContext.Element) this.f61641c;
        }
        if (key == CoroutineExceptionHandler.Key) {
            return (CoroutineContext.Element) this.f61642d;
        }
        return null;
    }
    ...
    public final long now(TimeUnit timeUnit) {
        return timeUnit.convert(this.f61645g, TimeUnit.NANOSECONDS);
    }
    ...
    public final long advanceTimeBy(long j, TimeUnit timeUnit) {
        long j2 = this.f61645g;
        advanceTimeTo(timeUnit.toNanos(j) + j2, TimeUnit.NANOSECONDS);
        return timeUnit.convert(this.f61645g - j2, TimeUnit.NANOSECONDS);
    }
    ...
    public final void advanceTimeTo(long j, TimeUnit timeUnit) {
        ...
        m46108a(nanos);
        if (nanos > this.f61645g) {
            this.f61645g = nanos;
        }
    }

    public final void triggerActions() {
        m46108a(this.f61645g);
    }
    ...
    public final void assertUnhandledException(String str, Function1<? super Throwable, Boolean> function1) {
        if (this.f61640b.size() != 1 || !function1.invoke(this.f61640b.get(0)).booleanValue()) {
    ...
    public final void assertAllUnhandledExceptions(String str, Function1<? super Throwable, Boolean> function1) {
        Iterable iterable = this.f61640b;
        boolean z = true;
    ...
    public final void assertExceptions(String str, Function1<? super List<? extends Throwable>, Boolean> function1) {
        if (function1.invoke(this.f61640b).booleanValue()) {
            this.f61640b.clear();
            return;
        }
        throw new AssertionError(str);
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public final void m46109a(Runnable runnable) {
        ThreadSafeHeap<C21999a> threadSafeHeap = this.f61643e;
        long j = this.f61644f;
        this.f61644f = 1 + j;
        threadSafeHeap.addLast(new C21999a(runnable, j, 0, 4, (DefaultConstructorMarker) null));
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public final C21999a m46107a(Runnable runnable, long j) {
        long j2 = this.f61644f;
        this.f61644f = 1 + j2;
        C21999a aVar = new C21999a(runnable, j2, this.f61645g + TimeUnit.MILLISECONDS.toNanos(j));
        this.f61643e.addLast(aVar);
        return aVar;
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public final long m46106a() {
        C21999a peek = this.f61643e.peek();
        if (peek != null) {
            m46108a(peek.f61646a);
        }
        return this.f61643e.isEmpty() ? Long.MAX_VALUE : 0;
    }

    /* renamed from: a */
    private final void m46108a(long j) {
        ThreadSafeHeapNode threadSafeHeapNode;
        while (true) {
            ThreadSafeHeap<C21999a> threadSafeHeap = this.f61643e;
            synchronized (threadSafeHeap) {
                C21999a firstImpl = threadSafeHeap.firstImpl();
                threadSafeHeapNode = null;
                if (firstImpl != null) {
                    if (firstImpl.f61646a <= j) {
            ...
            C21999a aVar = (C21999a) threadSafeHeapNode;
            if (aVar != null) {
                if (aVar.f61646a != 0) {
                    this.f61645g = aVar.f61646a;
                }
                aVar.run();
            } else {
                return;
    ...
    @Metadata(mo175977d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0004\u0018\u00002\u00020\u00012\u00020\u0002B\u0005¢\u0006\u0002\u0010\u0003J\u001c\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\n\u0010\b\u001a\u00060\tj\u0002`\nH\u0016J$\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\n\u0010\b\u001a\u00060\tj\u0002`\n2\u0006\u0010\u0006\u001a\u00020\u0007H\u0016J\b\u0010\u000f\u001a\u00020\u000eH\u0016J\u001e\u0010\u0010\u001a\u00020\u00052\u0006\u0010\r\u001a\u00020\u000e2\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00050\u0012H\u0016J\b\u0010\u0013\u001a\u00020\u0014H\u0016J\b\u0010\u0015\u001a\u00020\u0016H\u0016¨\u0006\u0017"}, mo175978d2 = {"Lkotlinx/coroutines/test/TestCoroutineContext$Dispatcher;", "Lkotlinx/coroutines/EventLoop;", "Lkotlinx/coroutines/Delay;", "(Lkotlinx/coroutines/test/TestCoroutineContext;)V", "dispatch", "", "context", "Lkotlin/coroutines/CoroutineContext;", "block", "Ljava/lang/Runnable;", "Lkotlinx/coroutines/Runnable;", "invokeOnTimeout", "Lkotlinx/coroutines/DisposableHandle;", "timeMillis", "", "processNextEvent", "scheduleResumeAfterDelay", "continuation", "Lkotlinx/coroutines/CancellableContinuation;", "shouldBeProcessedFromContext", "", "toString", "", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: TestCoroutineContext.kt */
    private final class Dispatcher extends EventLoop implements Delay {
        ...
        public void dispatch(CoroutineContext coroutineContext, Runnable runnable) {
            TestCoroutineContext.this.m46109a(runnable);
        }

        public void scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
            C21999a unused = TestCoroutineContext.this.m46107a(new C21997xe7664c50(cancellableContinuation, this), j);
        }

        public DisposableHandle invokeOnTimeout(long j, Runnable runnable, CoroutineContext coroutineContext) {
            return new TestCoroutineContext$Dispatcher$invokeOnTimeout$1(TestCoroutineContext.this, TestCoroutineContext.this.m46107a(runnable, j));
        }

        public long processNextEvent() {
            return TestCoroutineContext.this.m46106a();
        }
