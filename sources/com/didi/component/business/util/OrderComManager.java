...
public class OrderComManager {
    ...
    /* renamed from: a */
    private static volatile OrderComManager f11391a;

    /* renamed from: b */
    private OrderCom f11392b;
    ...
    public static synchronized com.didi.component.business.util.OrderComManager getInstance() {
        /*
            ...
            monitor-enter(r0)
            com.didi.component.business.util.OrderComManager r1 = f11391a     // Catch:{ all -> 0x001c }
            if (r1 != 0) goto L_0x0018
            monitor-enter(r0)     // Catch:{ all -> 0x001c }
            com.didi.component.business.util.OrderComManager r1 = f11391a     // Catch:{ all -> 0x0015 }
