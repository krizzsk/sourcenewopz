...
final class CodedOutputStreamWriter implements Writer {
    ...
    static /* synthetic */ class C193451 {
        ...
        static {
            ...
            L_0x0090:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.CodedOutputStreamWriter.C193451.<clinit>():void");
        }
    }

    private <K, V> void writeDeterministicMap(int i, MapEntryLite.Metadata<K, V> metadata, Map<K, V> map) throws IOException {
        switch (C193451.$SwitchMap$com$google$protobuf$WireFormat$FieldType[metadata.keyType.ordinal()]) {
            case 1:
