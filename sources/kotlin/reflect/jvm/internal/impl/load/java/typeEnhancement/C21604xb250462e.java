...
final class C21604xb250462e extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ SignatureBuildingComponents $this_signatures;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C21604xb250462e(SignatureBuildingComponents signatureBuildingComponents) {
        super(1);
    ...
    public final void invoke(SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder functionEnhancementBuilder) {
        ...
        functionEnhancementBuilder.returns(this.$this_signatures.javaUtil("Spliterator"), PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60605b);
    }
}
