...
public abstract class Segment<S extends Segment<S>> extends ConcurrentLinkedListNode<S> {
    ...
    public final boolean decPointers$kotlinx_coroutines_core() {
        return f61538b.addAndGet(this, -65536) == getMaxSlots() && !isTail();
    }

    public final void onSlotCleaned() {
        if (f61538b.incrementAndGet(this) == getMaxSlots() && !isTail()) {
            remove();
        }
    }
    ...
    public final boolean tryIncPointers$kotlinx_coroutines_core() {
        ...
        } while (!f61538b.compareAndSet(this, i, 65536 + i));
        return true;
    }
}
