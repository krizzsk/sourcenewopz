...
final class C21616xb2505178 extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFBiFunction;
    final /* synthetic */ String $JLObject;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C21616xb2505178(String str, String str2) {
        super(1);
        this.$JLObject = str;
    ...
    public final void invoke(SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder functionEnhancementBuilder) {
        ...
        functionEnhancementBuilder.parameter(this.$JFBiFunction, PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60606c, PredefinedEnhancementInfoKt.f60604a);
