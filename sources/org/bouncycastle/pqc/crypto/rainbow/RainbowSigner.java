...
public class RainbowSigner implements MessageSigner {
    ...
    /* renamed from: cf */
    private ComputeInField f6537cf = new ComputeInField();
    RainbowKeyParameters key;
    private SecureRandom random;
    int signableDocumentLength;

    /* renamed from: x */
    private short[] f6538x;

    private short[] initSign(Layer[] layerArr, short[] sArr) {
        short[] sArr2 = new short[sArr.length];
        short[] multiplyMatrix = this.f6537cf.multiplyMatrix(((RainbowPrivateKeyParameters) this.key).getInvA1(), this.f6537cf.addVect(((RainbowPrivateKeyParameters) this.key).getB1(), sArr));
        for (int i = 0; i < layerArr[0].getVi(); i++) {
            this.f6538x[i] = (short) this.random.nextInt();
            short[] sArr3 = this.f6538x;
    ...
    public byte[] generateSignature(byte[] r15) {
        ...
        L_0x003f:
            ...
            goto L_0x003f
        L_0x0050:
            org.bouncycastle.pqc.crypto.rainbow.util.ComputeInField r10 = r14.f6537cf     // Catch:{ Exception -> 0x00aa }
            r11 = r0[r7]     // Catch:{ Exception -> 0x00aa }
            short[] r12 = r14.f6538x     // Catch:{ Exception -> 0x00aa }
        ...
        L_0x0061:
            ...
            short[] r11 = r14.f6538x     // Catch:{ Exception -> 0x00aa }
        ...
        L_0x007f:
            org.bouncycastle.pqc.crypto.rainbow.util.ComputeInField r6 = r14.f6537cf     // Catch:{ Exception -> 0x00aa }
            ...
            short[] r8 = r14.f6538x     // Catch:{ Exception -> 0x00aa }
            short[] r6 = r6.addVect(r7, r8)     // Catch:{ Exception -> 0x00aa }
            org.bouncycastle.pqc.crypto.rainbow.util.ComputeInField r7 = r14.f6537cf     // Catch:{ Exception -> 0x00aa }
