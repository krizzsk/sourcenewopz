...
class AccessibilityViewEmbedder {
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i) {
        ...
        if (viewAndId == null || !this.embeddedViewToDisplayBounds.containsKey(viewAndId.view) || viewAndId.view.getAccessibilityNodeProvider() == null || (createAccessibilityNodeInfo = viewAndId.view.getAccessibilityNodeProvider().createAccessibilityNodeInfo(viewAndId.f57961id)) == null) {
            return null;
        }
    ...
    public boolean performAction(int i, int i2, Bundle bundle) {
        ...
        return accessibilityNodeProvider.performAction(viewAndId.f57961id, i2, bundle);
    }
    ...
    private static class ViewAndId {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.f57961id != viewAndId.f57961id || !this.view.equals(viewAndId.view)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return ((this.view.hashCode() + 31) * 31) + this.f57961id;
        }
    }
    ...
    private static class ReflectionAccessors {
        ...
        private ReflectionAccessors() {
            ...
            L_0x0012:
                ...
                p242io.flutter.Log.m41142w(r1, r4)
                r4 = r3
            L_0x0018:
            ...
            L_0x0021:
                ...
                p242io.flutter.Log.m41142w(r1, r0)
                r0 = r3
            L_0x0027:
            ...
            L_0x0039:
                ...
                p242io.flutter.Log.m41142w(r1, r5)
                r5 = r3
            L_0x003f:
            ...
            L_0x004f:
                ...
                p242io.flutter.Log.m41142w(r1, r2)
                r1 = r3
                r2 = r1
            L_0x0056:
                r3 = r5
            ...
            L_0x0080:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.flutter.view.AccessibilityViewEmbedder.ReflectionAccessors.<init>():void");
        }
        ...
        public Long getSourceNodeId(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            try {
                ...
                Log.m41143w(AccessibilityViewEmbedder.TAG, "Failed to access getSourceNodeId method.", e);
                return null;
            } catch (InvocationTargetException e2) {
                Log.m41143w(AccessibilityViewEmbedder.TAG, "The getSourceNodeId method threw an exception when invoked.", e2);
                return null;
            }
        }
        ...
        public Long getChildId(AccessibilityNodeInfo accessibilityNodeInfo, int i) {
            ...
            if (method != null) {
                try {
                    ...
                    Log.m41143w(AccessibilityViewEmbedder.TAG, "Failed to access getChildId method.", e);
                    return null;
                } catch (InvocationTargetException e2) {
                    Log.m41143w(AccessibilityViewEmbedder.TAG, "The getChildId method threw an exception when invoked.", e2);
                    return null;
                }
            } else {
                try {
                    ...
                    Log.m41143w(AccessibilityViewEmbedder.TAG, "Failed to access longArrayGetIndex method or the childNodeId field.", e3);
                    return null;
                } catch (ArrayIndexOutOfBoundsException | InvocationTargetException e4) {
                    Log.m41143w(AccessibilityViewEmbedder.TAG, "The longArrayGetIndex method threw an exception when invoked.", e4);
                    return null;
                }
            }
        }
        ...
        public Long getParentNodeId(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (method != null) {
                try {
                    ...
                    Log.m41143w(AccessibilityViewEmbedder.TAG, "Failed to access getParentNodeId method.", e);
                } catch (InvocationTargetException e2) {
                    Log.m41143w(AccessibilityViewEmbedder.TAG, "The getParentNodeId method threw an exception when invoked.", e2);
                }
            }
        ...
        private static Long yoinkParentIdFromParcel(AccessibilityNodeInfo accessibilityNodeInfo) {
            Long l = null;
            if (Build.VERSION.SDK_INT < 26) {
                Log.m41142w(AccessibilityViewEmbedder.TAG, "Unexpected Android version. Unable to find the parent ID.");
                return null;
            }
        ...
        public Long getRecordSourceNodeId(AccessibilityRecord accessibilityRecord) {
            ...
            try {
                ...
                Log.m41143w(AccessibilityViewEmbedder.TAG, "Failed to access the getRecordSourceNodeId method.", e);
                return null;
            } catch (InvocationTargetException e2) {
                Log.m41143w(AccessibilityViewEmbedder.TAG, "The getRecordSourceNodeId method threw an exception when invoked.", e2);
                return null;
            }
        }
    }
