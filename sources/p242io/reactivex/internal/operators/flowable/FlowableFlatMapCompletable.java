...
public final class FlowableFlatMapCompletable<T> extends C21208a<T, T> {

    /* renamed from: a */
    final Function<? super T, ? extends CompletableSource> f58297a;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new FlatMapCompletableMainSubscriber(subscriber, this.f58297a, this.f58299c, this.f58298b));
    }
