...
public final class TypeAliasConstructorDescriptorImpl extends FunctionDescriptorImpl implements TypeAliasConstructorDescriptor {
    ...
    /* renamed from: a */
    static final /* synthetic */ KProperty<Object>[] f60304a = {C21490Reflection.property1(new PropertyReference1Impl(C21490Reflection.getOrCreateKotlinClass(TypeAliasConstructorDescriptorImpl.class), "withDispatchReceiver", "getWithDispatchReceiver()Lorg/jetbrains/kotlin/descriptors/impl/TypeAliasConstructorDescriptor;"))};

    /* renamed from: b */
    private final StorageManager f60305b;

    /* renamed from: c */
    private final TypeAliasDescriptor f60306c;

    /* renamed from: d */
    private final NullableLazyValue f60307d;

    /* renamed from: e */
    private ClassConstructorDescriptor f60308e;
    ...
    private TypeAliasConstructorDescriptorImpl(StorageManager storageManager, TypeAliasDescriptor typeAliasDescriptor, ClassConstructorDescriptor classConstructorDescriptor, TypeAliasConstructorDescriptor typeAliasConstructorDescriptor, Annotations annotations, CallableMemberDescriptor.Kind kind, SourceElement sourceElement) {
        ...
        this.f60305b = storageManager;
        this.f60306c = typeAliasDescriptor;
        setActual(getTypeAliasDescriptor().isActual());
        this.f60307d = this.f60305b.createNullableLazyValue(new TypeAliasConstructorDescriptorImpl$withDispatchReceiver$2(this, classConstructorDescriptor));
        this.f60308e = classConstructorDescriptor;
    }
    ...
    public TypeAliasConstructorDescriptor substitute(TypeSubstitutor typeSubstitutor) {
        ...
        if (substitute != null) {
            ...
            typeAliasConstructorDescriptorImpl.f60308e = substitute2;
    ...
    public TypeAliasConstructorDescriptorImpl createSubstitutedCopy(DeclarationDescriptor declarationDescriptor, FunctionDescriptor functionDescriptor, CallableMemberDescriptor.Kind kind, Name name, Annotations annotations, SourceElement sourceElement) {
        ...
        if (!_Assertions.ENABLED || z2) {
            ...
            if (!_Assertions.ENABLED || z) {
                return new TypeAliasConstructorDescriptorImpl(this.f60305b, getTypeAliasDescriptor(), getUnderlyingConstructorDescriptor(), this, annotations, CallableMemberDescriptor.Kind.DECLARATION, sourceElement);
            }
