...
public class Converters {
    ...
    public static Mat vector_Point_to_Mat(List<Point> list, int i) {
        ...
        if (i == 4) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                int i4 = i3 * 2;
                iArr[i4] = (int) point.f6684x;
                iArr[i4 + 1] = (int) point.f6685y;
            }
            mat.put(0, 0, iArr);
            return mat;
        } else if (i == 5) {
            ...
            for (int i5 = 0; i5 < i2; i5++) {
                ...
                int i6 = i5 * 2;
                fArr[i6] = (float) point2.f6684x;
                fArr[i6 + 1] = (float) point2.f6685y;
            }
            mat2.put(0, 0, fArr);
            return mat2;
        } else if (i == 6) {
            ...
            for (int i7 = 0; i7 < i2; i7++) {
                ...
                int i8 = i7 * 2;
                dArr[i8] = point3.f6684x;
                dArr[i8 + 1] = point3.f6685y;
            }
            mat3.put(0, 0, dArr);
            return mat3;
        } else {
    ...
    public static Mat vector_Point3_to_Mat(List<Point3> list, int i) {
        ...
        if (i == 4) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                int i4 = i3 * 3;
                iArr[i4] = (int) point3.f6686x;
                iArr[i4 + 1] = (int) point3.f6687y;
                iArr[i4 + 2] = (int) point3.f6688z;
            }
            mat.put(0, 0, iArr);
            return mat;
        } else if (i == 5) {
            ...
            for (int i5 = 0; i5 < i2; i5++) {
                ...
                int i6 = i5 * 3;
                fArr[i6] = (float) point32.f6686x;
                fArr[i6 + 1] = (float) point32.f6687y;
                fArr[i6 + 2] = (float) point32.f6688z;
            }
            mat2.put(0, 0, fArr);
            return mat2;
        } else if (i == 6) {
            ...
            for (int i7 = 0; i7 < i2; i7++) {
                ...
                int i8 = i7 * 3;
                dArr[i8] = point33.f6686x;
                dArr[i8 + 1] = point33.f6687y;
                dArr[i8 + 2] = point33.f6688z;
            }
            mat3.put(0, 0, dArr);
            return mat3;
        } else {
    ...
    public static Mat vector_Rect2d_to_Mat(List<Rect2d> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int i2 = i * 4;
            dArr[i2] = rect2d.f6691x;
            dArr[i2 + 1] = rect2d.f6692y;
    ...
    public static Mat vector_KeyPoint_to_Mat(List<KeyPoint> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int i2 = i * 7;
            dArr[i2] = keyPoint.f6683pt.f6684x;
            dArr[i2 + 1] = keyPoint.f6683pt.f6685y;
