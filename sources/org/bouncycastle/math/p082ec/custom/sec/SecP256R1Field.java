...
public class SecP256R1Field {
    ...
    /* renamed from: M */
    private static final long f6368M = 4294967295L;

    /* renamed from: P */
    static final int[] f6369P = {-1, -1, -1, 0, 0, 0, 1, -1};

    /* renamed from: P7 */
    private static final int f6370P7 = -1;
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f6369P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f6369P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[7] == -1 && Nat256.gte(fromBigInteger, f6369P)) {
            Nat256.subFrom(f6369P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(8, iArr2, Nat256.add(iArr, f6369P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f6369P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f6369P) == 0);
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (j != 0 || (iArr[7] == -1 && Nat256.gte(iArr, f6369P))) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f6369P))) {
            addPInvTo(iArr2);
        }
    }
}
