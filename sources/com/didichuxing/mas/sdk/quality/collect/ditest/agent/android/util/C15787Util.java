...
public class C15787Util {

    /* renamed from: a */
    private static final Random f48069a = new Random();

    /* renamed from: b */
    private static final Pattern f48070b = Pattern.compile("http(s)*://([a-z]|[A-Z]|[0-9]|\\.|/|_|-)+(?=[\\?|#]*)");
    ...
    public static String getUrlPath(String str) {
        ...
        Matcher matcher = f48070b.matcher(str);
        if (matcher.find()) {
            return matcher.group();
        }
        return null;
