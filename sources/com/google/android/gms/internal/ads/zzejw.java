...
public final class zzejw {
    ...
    public static ECParameterSpec zza(zzejy zzejy) throws NoSuchAlgorithmException {
        int i = zzejz.zzina[zzejy.ordinal()];
        if (i == 1) {
        ...
        String valueOf = String.valueOf(zzejy);
    ...
    public static ECPublicKey zza(zzejy zzejy, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec zza = zza(zzejy);
