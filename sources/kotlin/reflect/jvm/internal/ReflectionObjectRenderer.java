...
public final class ReflectionObjectRenderer {
    ...
    /* renamed from: a */
    private final void m44456a(StringBuilder sb, ReceiverParameterDescriptor receiverParameterDescriptor) {
    ...
    /* renamed from: a */
    private final void m44455a(StringBuilder sb, CallableDescriptor callableDescriptor) {
    ...
    /* renamed from: a */
    private final String m44454a(CallableDescriptor callableDescriptor) {
    ...
    public final String renderProperty(PropertyDescriptor propertyDescriptor) {
        ...
        INSTANCE.m44455a(sb, (CallableDescriptor) propertyDescriptor);
        DescriptorRenderer descriptorRenderer = f60068a;
    ...
    public final String renderFunction(FunctionDescriptor functionDescriptor) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("fun ");
        INSTANCE.m44455a(sb, (CallableDescriptor) functionDescriptor);
        DescriptorRenderer descriptorRenderer = f60068a;
    ...
    public final String renderParameter(KParameterImpl kParameterImpl) {
        ...
        sb.append(" of ");
        sb.append(INSTANCE.m44454a(kParameterImpl.getCallable().getDescriptor()));
        String sb2 = sb.toString();
        Intrinsics.checkNotNullExpressionValue(sb2, "StringBuilder().apply(builderAction).toString()");
        return sb2;
    }
    ...
    public final String renderType(KotlinType kotlinType) {
        ...
        return f60068a.renderType(kotlinType);
    }
}
