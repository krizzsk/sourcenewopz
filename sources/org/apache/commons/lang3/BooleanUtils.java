...
public class BooleanUtils {
    ...
    public static String toStringYesNo(Boolean bool) {
        return toString(bool, "yes", LoginOmegaUtil.NO_EMAIL, (String) null);
    }
    ...
    public static String toStringYesNo(boolean z) {
        return toString(z, "yes", LoginOmegaUtil.NO_EMAIL);
    }
    ...
    /* renamed from: or */
    public static boolean m3616or(boolean... zArr) {
        if (zArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (zArr.length != 0) {
            for (boolean z : zArr) {
    ...
    /* renamed from: or */
    public static Boolean m3615or(Boolean... boolArr) {
        if (boolArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (boolArr.length != 0) {
            try {
                return m3616or(ArrayUtils.toPrimitive(boolArr)) ? Boolean.TRUE : Boolean.FALSE;
            } catch (NullPointerException unused) {
                throw new IllegalArgumentException("The array must not contain any null elements");
            }
        } else {
