...
public class ConfigProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        if (intValue == 1) {
            ...
            if ("s_seq".equals(asString)) {
                str = str + ServiceConfig.getInstanse().getLongValueSync(asString, contentValues.getAsLong(EXTRA_VALUE).longValue());
            } else {
                str = str + ServiceConfig.getInstanse().getLongValue(asString, contentValues.getAsLong(EXTRA_VALUE).longValue());
            }
        }
    ...
    private static void safeUpdate(ContentValues contentValues) {
        try {
            ...
            OLog.m34763e("safeUpdate() : " + e.getMessage());
        }
    }
    ...
    private static Uri safeInsert(ContentValues contentValues) {
        try {
            ...
            e.printStackTrace();
            OLog.m34763e("safeInsert() : " + e.getMessage());
            return null;
        }
    }
    ...
    public static void removeKey(String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                OLog.m34763e("removeKey() : " + e.getMessage());
            }
        }
    }
