...
public abstract class BaseEncoding {
    private static final BaseEncoding BASE16 = new Base16Encoding("base16()", C2382a.f4810a);
    ...
    static final class Base64Encoding extends StandardBaseEncoding {
        ...
        public void encodeTo(Appendable appendable, byte[] bArr, int i, int i2) throws IOException {
            ...
            while (i2 >= 3) {
                ...
                appendable.append(this.alphabet.encode((b >>> Ascii.f53586FF) & 63));
        ...
        return new Reader() {
            ...
            public int read() throws java.io.IOException {
                ...
                L_0x0012:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.common.p218io.BaseEncoding.C190643.read():int");
            }
