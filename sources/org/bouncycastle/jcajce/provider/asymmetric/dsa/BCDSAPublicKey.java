...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f6229y;

    BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f6229y = dSAPublicKey.getY();
        DSAParams params = dSAPublicKey.getParams();
        this.dsaSpec = params;
        this.lwKeyParams = new DSAPublicKeyParameters(this.f6229y, DSAUtil.toDSAParameters(params));
    }

    BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f6229y = dSAPublicKeySpec.getY();
        ...
        this.lwKeyParams = new DSAPublicKeyParameters(this.f6229y, DSAUtil.toDSAParameters(dSAParameterSpec));
    }

    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f6229y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
            ...
            this.lwKeyParams = new DSAPublicKeyParameters(this.f6229y, DSAUtil.toDSAParameters(this.dsaSpec));
    ...
    BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f6229y = dSAPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        ...
        if (this.dsaSpec == null) {
            ...
            aSN1Integer = new ASN1Integer(this.f6229y);
        } else {
    ...
    public String toString() {
        ...
        stringBuffer.append(DSAUtil.generateKeyFingerprint(this.f6229y, getParams()));
