...
public final class GlideOptions extends RequestOptions implements Cloneable {
    ...
    /* renamed from: a */
    private static GlideOptions f37593a;

    /* renamed from: b */
    private static GlideOptions f37594b;

    /* renamed from: c */
    private static GlideOptions f37595c;

    /* renamed from: d */
    private static GlideOptions f37596d;

    /* renamed from: e */
    private static GlideOptions f37597e;

    /* renamed from: f */
    private static GlideOptions f37598f;
    ...
    public static GlideOptions fitCenterTransform() {
        if (f37593a == null) {
            f37593a = new GlideOptions().fitCenter().autoClone();
        }
        return f37593a;
    }
    ...
    public static GlideOptions centerInsideTransform() {
        if (f37594b == null) {
            f37594b = new GlideOptions().centerInside().autoClone();
        }
        return f37594b;
    }
    ...
    public static GlideOptions centerCropTransform() {
        if (f37595c == null) {
            f37595c = new GlideOptions().centerCrop().autoClone();
        }
        return f37595c;
    }
    ...
    public static GlideOptions circleCropTransform() {
        if (f37596d == null) {
            f37596d = new GlideOptions().circleCrop().autoClone();
        }
        return f37596d;
    }
    ...
    public static GlideOptions noTransformation() {
        if (f37597e == null) {
            f37597e = new GlideOptions().dontTransform().autoClone();
        }
        return f37597e;
    }
    ...
    public static GlideOptions noAnimation() {
        if (f37598f == null) {
            f37598f = new GlideOptions().dontAnimate().autoClone();
        }
        return f37598f;
    }
