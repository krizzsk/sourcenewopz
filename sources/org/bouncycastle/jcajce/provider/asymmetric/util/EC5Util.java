...
import org.bouncycastle.asn1.p075x9.ECNamedCurveTable;
import org.bouncycastle.asn1.p075x9.X9ECParameters;
import org.bouncycastle.crypto.p076ec.CustomNamedCurves;
...
public class EC5Util {
    ...
    static {
        ...
        customCurves.put(new ECCurve.C2746Fp(curve.getField().getCharacteristic(), curve.getA().toBigInteger(), curve.getB().toBigInteger(), curve.getOrder(), curve.getCofactor()), curve);
    }
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.C2746Fp fp = new ECCurve.C2746Fp(((ECFieldFp) field).getP(), a, b);
    ...
    public static ECPoint convertPoint(org.bouncycastle.math.p082ec.ECPoint eCPoint) {
        org.bouncycastle.math.p082ec.ECPoint normalize = eCPoint.normalize();
        return new ECPoint(normalize.getAffineXCoord().toBigInteger(), normalize.getAffineYCoord().toBigInteger());
    }

    public static org.bouncycastle.math.p082ec.ECPoint convertPoint(ECParameterSpec eCParameterSpec, ECPoint eCPoint) {
        return convertPoint(convertCurve(eCParameterSpec.getCurve()), eCPoint);
    }

    public static org.bouncycastle.math.p082ec.ECPoint convertPoint(ECCurve eCCurve, ECPoint eCPoint) {
    ...
    public static org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec) {
        ...
        org.bouncycastle.math.p082ec.ECPoint convertPoint = convertPoint(convertCurve, eCParameterSpec.getGenerator());
    ...
    public static java.security.spec.ECParameterSpec convertToSpec(org.bouncycastle.asn1.p075x9.X962Parameters r8, org.bouncycastle.math.p082ec.ECCurve r9) {
        /*
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r0 = (org.bouncycastle.asn1.p075x9.X9ECParameters) r0
        L_0x0024:
            byte[] r1 = r0.getSeed()
        ...
        L_0x0051:
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r8 = org.bouncycastle.asn1.p075x9.X9ECParameters.getInstance(r8)
            byte[] r0 = r8.getSeed()
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static org.bouncycastle.math.p082ec.ECCurve getCurve(org.bouncycastle.jcajce.provider.config.ProviderConfiguration r2, org.bouncycastle.asn1.p075x9.X962Parameters r3) {
        /*
        ...
        L_0x004c:
            ...
            org.bouncycastle.asn1.x9.X9ECParameters r2 = org.bouncycastle.asn1.p075x9.X9ECParameters.getInstance(r2)
            goto L_0x0073
        L_0x0066:
            r3 = 0
