...
public class GlobalPayOmegaUtils {
    public static void trackPayMethodSelectPIXCK(Context context, int i) {
        ...
        hashMap.put("uid", m25719a(context));
    ...
    public static void trackPayMethodSelectPaypayCK(Context context, int i, int i2, int i3) {
        ...
        hashMap.put("passenger_id", m25719a(context));
        hashMap.put("city_id", m25720b(context));
    ...
    public static void trackPayMethodSelectPageSwitchPayMethod(Context context, DidiGlobalPayMethodListData.Entrance entrance) {
        HashMap hashMap = new HashMap();
        hashMap.put("source", Integer.valueOf(m25718a(entrance)));
        hashMap.put("passenger_id", m25719a(context));
        hashMap.put("city_id", m25720b(context));
    ...
    static /* synthetic */ class C123101 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f36349x8a3a0836     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f36349x8a3a0836     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f36349x8a3a0836     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f36349x8a3a0836     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didi.sdk.global.sign.view.helper.GlobalPayOmegaUtils.C123101.<clinit>():void");
        }
    }

    /* renamed from: a */
    private static int m25718a(DidiGlobalPayMethodListData.Entrance entrance) {
        int i = C123101.f36349x8a3a0836[entrance.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return 3;
            }
    ...
    /* renamed from: a */
    private static String m25719a(Context context) {
        return context == null ? "" : PayCommonParamsUtil.getInstance().getUid(context);
    }

    /* renamed from: b */
    private static String m25720b(Context context) {
