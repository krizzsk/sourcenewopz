...
public final class StandardMethodCodec implements MethodCodec {
    ...
    /* renamed from: a */
    private final StandardMessageCodec f57779a;

    public StandardMethodCodec(StandardMessageCodec standardMessageCodec) {
        this.f57779a = standardMessageCodec;
    }
    ...
    public ByteBuffer encodeMethodCall(MethodCall methodCall) {
        ...
        this.f57779a.writeValue(exposedByteArrayOutputStream, methodCall.method);
        this.f57779a.writeValue(exposedByteArrayOutputStream, methodCall.arguments);
    ...
    public MethodCall decodeMethodCall(ByteBuffer byteBuffer) {
        ...
        Object readValue = this.f57779a.readValue(byteBuffer);
        Object readValue2 = this.f57779a.readValue(byteBuffer);
    ...
    public ByteBuffer encodeSuccessEnvelope(Object obj) {
        ...
        this.f57779a.writeValue(exposedByteArrayOutputStream, obj);
        ByteBuffer allocateDirect = ByteBuffer.allocateDirect(exposedByteArrayOutputStream.size());
        allocateDirect.put(exposedByteArrayOutputStream.buffer(), 0, exposedByteArrayOutputStream.size());
        return allocateDirect;
    }
    ...
    public ByteBuffer encodeErrorEnvelope(String str, String str2, Object obj) {
        ...
        this.f57779a.writeValue(exposedByteArrayOutputStream, str);
        this.f57779a.writeValue(exposedByteArrayOutputStream, str2);
        if (obj instanceof Throwable) {
            this.f57779a.writeValue(exposedByteArrayOutputStream, m41525a((Throwable) obj));
        } else {
            this.f57779a.writeValue(exposedByteArrayOutputStream, obj);
        }
        ByteBuffer allocateDirect = ByteBuffer.allocateDirect(exposedByteArrayOutputStream.size());
    ...
    public ByteBuffer encodeErrorEnvelopeWithStacktrace(String str, String str2, Object obj, String str3) {
        ...
        this.f57779a.writeValue(exposedByteArrayOutputStream, str3);
        ByteBuffer allocateDirect = ByteBuffer.allocateDirect(exposedByteArrayOutputStream.size());
        allocateDirect.put(exposedByteArrayOutputStream.buffer(), 0, exposedByteArrayOutputStream.size());
        return allocateDirect;
    }
    ...
    public java.lang.Object decodeEnvelope(java.nio.ByteBuffer r5) {
        /*
            ...
            goto L_0x001e
        L_0x0011:
            io.flutter.plugin.common.StandardMessageCodec r0 = r4.f57779a
        ...
        L_0x001e:
            io.flutter.plugin.common.StandardMessageCodec r0 = r4.f57779a
            java.lang.Object r0 = r0.readValue(r5)
            io.flutter.plugin.common.StandardMessageCodec r1 = r4.f57779a
            java.lang.Object r1 = r1.readValue(r5)
            io.flutter.plugin.common.StandardMessageCodec r2 = r4.f57779a
        ...
        L_0x004a:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p242io.flutter.plugin.common.StandardMethodCodec.decodeEnvelope(java.nio.ByteBuffer):java.lang.Object");
    }

    /* renamed from: a */
    private static String m41525a(Throwable th) {
