...
public final class BigIntegerMath {
    ...
    public static int log2(BigInteger bigInteger, RoundingMode roundingMode) {
        ...
        switch (C190811.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class C190811 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.BigIntegerMath.C190811.<clinit>():void");
        }
    }
    ...
    public static BigInteger factorial(int i) {
        int i2 = i;
        MathPreconditions.checkNonNegative(CampaignValue.f40469b, i2);
