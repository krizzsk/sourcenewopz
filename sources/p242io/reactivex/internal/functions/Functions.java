package p242io.reactivex.internal.functions;
...
public final class Functions {
    ...
    /* renamed from: a */
    static final Function<Object, Object> f58037a = new Identity();

    /* renamed from: b */
    static final Consumer<Object> f58038b = new EmptyConsumer();

    /* renamed from: c */
    static final Predicate<Object> f58039c = new TruePredicate();

    /* renamed from: d */
    static final Predicate<Object> f58040d = new FalsePredicate();

    /* renamed from: e */
    static final Callable<Object> f58041e = new NullCallable();

    /* renamed from: f */
    static final Comparator<Object> f58042f = new NaturalObjectComparator();
    ...
    static final class Array2Func<T1, T2, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final BiFunction<? super T1, ? super T2, ? extends R> f58043f;

        Array2Func(BiFunction<? super T1, ? super T2, ? extends R> biFunction) {
            this.f58043f = biFunction;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 2) {
                return this.f58043f.apply(objArr[0], objArr[1]);
            }
    ...
    static final class Array3Func<T1, T2, T3, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function3<T1, T2, T3, R> f58044f;

        Array3Func(Function3<T1, T2, T3, R> function3) {
            this.f58044f = function3;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 3) {
                return this.f58044f.apply(objArr[0], objArr[1], objArr[2]);
            }
    ...
    static final class Array4Func<T1, T2, T3, T4, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function4<T1, T2, T3, T4, R> f58045f;

        Array4Func(Function4<T1, T2, T3, T4, R> function4) {
            this.f58045f = function4;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 4) {
                return this.f58045f.apply(objArr[0], objArr[1], objArr[2], objArr[3]);
            }
    ...
    static final class Array5Func<T1, T2, T3, T4, T5, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        private final Function5<T1, T2, T3, T4, T5, R> f58046f;

        Array5Func(Function5<T1, T2, T3, T4, T5, R> function5) {
            this.f58046f = function5;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 5) {
                return this.f58046f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4]);
            }
    ...
    static final class Array6Func<T1, T2, T3, T4, T5, T6, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function6<T1, T2, T3, T4, T5, T6, R> f58047f;

        Array6Func(Function6<T1, T2, T3, T4, T5, T6, R> function6) {
            this.f58047f = function6;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 6) {
                return this.f58047f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5]);
            }
    ...
    static final class Array7Func<T1, T2, T3, T4, T5, T6, T7, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function7<T1, T2, T3, T4, T5, T6, T7, R> f58048f;

        Array7Func(Function7<T1, T2, T3, T4, T5, T6, T7, R> function7) {
            this.f58048f = function7;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 7) {
                return this.f58048f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6]);
            }
    ...
    static final class Array8Func<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f58049f;

        Array8Func(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> function8) {
            this.f58049f = function8;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 8) {
                return this.f58049f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7]);
            }
    ...
    static final class Array9Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function<Object[], R> {
        ...
        /* renamed from: f */
        final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f58050f;

        Array9Func(Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function9) {
            this.f58050f = function9;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 9) {
                return this.f58050f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7], objArr[8]);
            }
