...
final class JvmBuiltInClassDescriptorFactory$cloneable$2 extends Lambda implements Function0<ClassDescriptorImpl> {
    ...
    public final ClassDescriptorImpl invoke() {
        ClassDescriptorImpl classDescriptorImpl = new ClassDescriptorImpl((DeclarationDescriptor) this.this$0.f60146c.invoke(this.this$0.f60145b), JvmBuiltInClassDescriptorFactory.f60143f, Modality.ABSTRACT, ClassKind.INTERFACE, CollectionsKt.listOf(this.this$0.f60145b.getBuiltIns().getAnyType()), SourceElement.NO_SOURCE, false, this.$storageManager);
