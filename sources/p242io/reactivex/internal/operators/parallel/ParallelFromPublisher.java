...
public final class ParallelFromPublisher<T> extends ParallelFlowable<T> {
    ...
    /* renamed from: a */
    final Publisher<? extends T> f59049a;
    ...
    public void subscribe(Subscriber<? super T>[] subscriberArr) {
        if (validate(subscriberArr)) {
            this.f59049a.subscribe(new ParallelDispatcher(subscriberArr, this.f59051c));
        }
    }
        ...
        final class RailSubscription implements Subscription {
            ...
            public void request(long j) {
                ...
                if (SubscriptionHelper.validate(j)) {
                    ...
                    do {
                        j2 = atomicLongArray.get(this.f59052j);
                        if (j2 != Long.MAX_VALUE) {
                        } else {
                            return;
                        }
                    } while (!atomicLongArray.compareAndSet(this.f59052j, j2, BackpressureHelper.addCap(j2, j)));
                    if (ParallelDispatcher.this.subscriberCount.get() == this.f59053m) {
            ...
            public void cancel() {
                if (ParallelDispatcher.this.requests.compareAndSet(this.f59052j + this.f59053m, 0, 1)) {
