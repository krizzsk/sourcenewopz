...
public final class FlowableRange extends Flowable<Integer> {
    ...
    public void subscribeActual(Subscriber<? super Integer> subscriber) {
        if (subscriber instanceof ConditionalSubscriber) {
            subscriber.onSubscribe(new RangeConditionalSubscription((ConditionalSubscriber) subscriber, this.f58391a, this.f58392b));
        } else {
            subscriber.onSubscribe(new RangeSubscription(subscriber, this.f58391a, this.f58392b));
        }
    }
