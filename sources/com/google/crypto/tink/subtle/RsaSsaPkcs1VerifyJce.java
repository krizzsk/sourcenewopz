...
public final class RsaSsaPkcs1VerifyJce implements PublicKeyVerify {
    ...
    static /* synthetic */ class C194041 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.subtle.RsaSsaPkcs1VerifyJce.C194041.<clinit>():void");
        }
    }

    private byte[] toAsnPrefix(Enums.HashType hashType) throws GeneralSecurityException {
        int i = C194041.$SwitchMap$com$google$crypto$tink$subtle$Enums$HashType[hashType.ordinal()];
        if (i == 1) {
