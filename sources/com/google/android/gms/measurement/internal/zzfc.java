...
final class zzfc implements Runnable {
    ...
    public final void run() {
        ...
        bundle.putString(GlobalCashierCoreModule.PACKAGE_NAME, zza2);
        Bundle bundle2 = null;
        try {
                ...
                if (string == null || string.isEmpty()) {
                    ...
                    if (zzi == null) {
                        ...
                        if (j == zzfe.zza.zzd().zzd.zza()) {
                            ...
                            zzfe.zza.zzk().zzs(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN, zzi);
                        }
                    }
                }
            }
