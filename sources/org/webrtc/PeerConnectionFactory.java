...
public class PeerConnectionFactory {
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        Logging.m3800d(TAG, "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    private static void printStackTrace(ThreadInfo threadInfo, boolean z) {
        if (threadInfo != null) {
            ...
            if (stackTrace.length > 0) {
                Logging.m3804w(TAG, name + " stacktrace:");
                for (StackTraceElement stackTraceElement : stackTrace) {
                    Logging.m3804w(TAG, stackTraceElement.toString());
                }
            }
            if (z) {
                Logging.m3804w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
                Logging.m3804w(TAG, "pid: " + Process.myPid() + ", tid: " + threadInfo.tid + ", name: " + name + "  >>> WebRTC <<<");
