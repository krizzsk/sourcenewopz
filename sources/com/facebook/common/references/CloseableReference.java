...
public final class CloseableReference<T> implements Closeable, Cloneable {
    ...
    /* renamed from: of */
    public static <T extends Closeable> CloseableReference<T> m37162of(T t) {
        if (t == null) {
            return null;
        }
    ...
    /* renamed from: of */
    public static <T> CloseableReference<T> m37163of(T t, ResourceReleaser<T> resourceReleaser) {
        if (t == null) {
            return null;
        }
    ...
    public void finalize() throws Throwable {
        try {
            synchronized (this) {
                ...
                FLog.m37136w((Class<?>) TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(this.mSharedReference)), this.mSharedReference.get().getClass().getName());
                close();
                super.finalize();
            }
        } catch (Throwable th) {
