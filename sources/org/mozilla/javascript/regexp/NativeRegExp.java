...
public class NativeRegExp extends IdScriptableObject implements Function {
    ...
    public static void init(Context context, Scriptable scriptable, boolean z) {
        ...
        nativeRegExp.f6654re = compileRE(context, "", (String) null, false);
    ...
    public Scriptable compile(Context context, Scriptable scriptable, Object[] objArr) {
        if (objArr.length <= 0 || !(objArr[0] instanceof NativeRegExp)) {
            this.f6654re = compileRE(context, (objArr.length == 0 || (objArr[0] instanceof Undefined)) ? "" : escapeRegExp(objArr[0]), (objArr.length <= 1 || objArr[1] == Undefined.instance) ? null : ScriptRuntime.toString(objArr[1]), false);
            this.lastIndex = Double.valueOf(0.0d);
            return this;
        } else if (objArr.length <= 1 || objArr[1] == Undefined.instance) {
            NativeRegExp nativeRegExp = objArr[0];
            this.f6654re = nativeRegExp.f6654re;
    ...
    public String toString() {
        ...
        if (this.f6654re.source.length != 0) {
            sb.append(this.f6654re.source);
        } else {
            sb.append("(?:)");
        }
        sb.append(IOUtils.DIR_SEPARATOR_UNIX);
        if ((this.f6654re.flags & 1) != 0) {
            sb.append('g');
        }
        if ((this.f6654re.flags & 2) != 0) {
            sb.append('i');
        }
        if ((this.f6654re.flags & 4) != 0) {
            sb.append('m');
        }
        return sb.toString();
    }
    ...
    private Object execSub(Context context, Scriptable scriptable, Object[] objArr, int i) {
        ...
        String str2 = str;
        double d = 0.0d;
        double integer = (this.f6654re.flags & 1) != 0 ? ScriptRuntime.toInteger(this.lastIndex) : 0.0d;
    ...
    static RECompiled compileRE(Context context, String str, String str2, boolean z) {
        ...
        if (b == 2) {
            ...
            if (rENode.kid.f6659op == 2 && rENode.kid2.f6659op == 2) {
                rECompiled.anchorCh = -2;
            }
        }
        return rECompiled;
    ...
    private static boolean parseDisjunction(CompilerState compilerState) {
        ...
        int i = compilerState.f6652cp;
        if (i != cArr.length && cArr[i] == '|') {
            compilerState.f6652cp++;
            ...
            if (rENode.kid.f6659op == 14 && rENode.kid2.f6659op == 14) {
                rENode.f6659op = (compilerState.flags & 2) == 0 ? REOP_ALTPREREQ : REOP_ALTPREREQi;
                rENode.chr = rENode.kid.chr;
                rENode.index = rENode.kid2.chr;
                compilerState.progLength += 13;
            } else if (rENode.kid.f6659op == 22 && rENode.kid.index < 256 && rENode.kid2.f6659op == 14 && (compilerState.flags & 2) == 0) {
                rENode.f6659op = REOP_ALTPREREQ2;
                rENode.chr = rENode.kid2.chr;
                rENode.index = rENode.kid.index;
                compilerState.progLength += 13;
            } else if (rENode.kid.f6659op == 14 && rENode.kid2.f6659op == 22 && rENode.kid2.index < 256 && (compilerState.flags & 2) == 0) {
                rENode.f6659op = REOP_ALTPREREQ2;
                rENode.chr = rENode.kid.chr;
    ...
    private static boolean parseAlternative(CompilerState compilerState) {
        ...
        RENode rENode = null;
        RENode rENode2 = null;
        while (compilerState.f6652cp != compilerState.cpend && cArr[compilerState.f6652cp] != '|' && (compilerState.parenNesting == 0 || cArr[compilerState.f6652cp] != ')')) {
    ...
    /* JADX WARNING: type inference failed for: r1v7, types: [char, int] */
    /* JADX WARNING: type inference failed for: r12v7, types: [char, int] */
    /* JADX WARNING: type inference failed for: r12v9, types: [char, int] */
    /* JADX WARNING: type inference failed for: r1v14, types: [char] */
    /* JADX WARNING: type inference failed for: r8v9, types: [char] */
    /* JADX WARNING: type inference failed for: r8v11, types: [char, int] */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0074, code lost:
        r12 = r14;
     */
    /* JADX WARNING: Incorrect type for immutable var: ssa=char, code=int, for r1v7, types: [char, int] */
    ...
    private static int getDecimalValue(char c, CompilerState compilerState, int i, String str) {
        int i2 = compilerState.f6652cp;
        char[] cArr = compilerState.cpbegin;
        int i3 = c - '0';
        boolean z = false;
        while (compilerState.f6652cp != compilerState.cpend) {
            char c2 = cArr[compilerState.f6652cp];
            if (!isDigit(c2)) {
                break;
            }
        ...
        if (z) {
            reportError(str, String.valueOf(cArr, i2, compilerState.f6652cp - i2));
        }
        return i3;
    }
    ...
    private static boolean parseTerm(org.mozilla.javascript.regexp.CompilerState r16) {
        ...
        L_0x01e1:
            ...
            org.mozilla.javascript.Context r14 = r0.f6653cx
        ...
        L_0x022d:
            ...
            goto L_0x0345
        L_0x0247:
            org.mozilla.javascript.Context r2 = r0.f6653cx
    ...
    private static int emitREBytecode(CompilerState compilerState, RECompiled rECompiled, int i, RENode rENode) {
        ...
        while (rENode != null) {
            int i3 = i + 1;
            bArr[i] = rENode.f6659op;
            byte b = rENode.f6659op;
            boolean z = true;
            if (b != 1) {
                if (b != 22) {
                    if (b == 25) {
                        ...
                        if (b != 31) {
                            if (b == 13) {
                                ...
                                if (rENode.flatIndex != -1) {
                                    while (rENode.next != null && rENode.next.f6659op == 14 && rENode.flatIndex + rENode.length == rENode.next.flatIndex) {
    ...
    private static void pushBackTrackState(REGlobalData rEGlobalData, byte b, int i) {
        REProgState rEProgState = rEGlobalData.stateStackTop;
        rEGlobalData.backTrackStackTop = new REBackTrackData(rEGlobalData, b, i, rEGlobalData.f6658cp, rEProgState.continuationOp, rEProgState.continuationPc);
    }
    ...
    private static boolean flatNMatcher(REGlobalData rEGlobalData, int i, int i2, String str, int i3) {
        if (rEGlobalData.f6658cp + i2 > i3) {
            return false;
        }
        for (int i4 = 0; i4 < i2; i4++) {
            if (rEGlobalData.regexp.source[i + i4] != str.charAt(rEGlobalData.f6658cp + i4)) {
                return false;
            }
        }
        rEGlobalData.f6658cp += i2;
        return true;
    }
    ...
    private static boolean flatNIMatcher(REGlobalData rEGlobalData, int i, int i2, String str, int i3) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            char c = cArr[i + i4];
            char charAt = str.charAt(rEGlobalData.f6658cp + i4);
    ...
    private static boolean backrefMatcher(REGlobalData rEGlobalData, int i, String str, int i2) {
        ...
        if (rEGlobalData.f6658cp + parensLength > i2) {
            return false;
        }
        if ((rEGlobalData.regexp.flags & 2) != 0) {
            for (int i3 = 0; i3 < parensLength; i3++) {
                char charAt = str.charAt(parensIndex + i3);
                char charAt2 = str.charAt(rEGlobalData.f6658cp + i3);
                if (charAt != charAt2 && upcase(charAt) != upcase(charAt2)) {
                    return false;
                }
            }
        } else if (!str.regionMatches(parensIndex, str, rEGlobalData.f6658cp, parensLength)) {
            return false;
        }
        rEGlobalData.f6658cp += parensLength;
        return true;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:105:0x01f6, code lost:
        if (isLineTerm(r4.charAt(r3.f6658cp - 1)) == false) goto L_0x01fa;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:81:0x01a3, code lost:
        if (isWord(r4.charAt(r3.f6658cp)) != false) goto L_0x01cb;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:91:0x01c9, code lost:
        if (isWord(r4.charAt(r3.f6658cp)) != false) goto L_0x01cc;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:99:0x01e0, code lost:
        if (isLineTerm(r4.charAt(r3.f6658cp)) == false) goto L_0x01fa;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:178:0x03fa, code lost:
        pushProgState(r23, r12, r2, r7.f6658cp, (org.mozilla.javascript.regexp.REBackTrackData) null, r17, r16);
     */
    ...
    public java.lang.Object executeRegExp(org.mozilla.javascript.Context r17, org.mozilla.javascript.Scriptable r18, org.mozilla.javascript.regexp.RegExpImpl r19, java.lang.String r20, int[] r21, int r22) {
        ...
        L_0x0018:
            r13 = r2
        L_0x0019:
            org.mozilla.javascript.regexp.RECompiled r3 = r0.f6654re
        ...
        L_0x0058:
            org.mozilla.javascript.regexp.RECompiled r15 = r0.f6654re
        ...
        L_0x0065:
            ...
            r15 = 0
        L_0x006e:
            org.mozilla.javascript.regexp.RECompiled r11 = r0.f6654re
    ...
    public Object getInstanceIdValue(int i) {
        ...
        if (i == 2) {
            return new String(this.f6654re.source);
        }
        if (i == 3) {
            if ((this.f6654re.flags & 1) == 0) {
                z = false;
