...
final class zzab implements ObjectEncoderContext {
    ...
    public final ObjectEncoderContext nested(String str) throws IOException {
        return nested(FieldDescriptor.m38524of(str));
    }
