...
public class Subdiv2D {
    ...
    public Subdiv2D(Rect rect) {
        this.nativeObj = Subdiv2D_0(rect.f6689x, rect.f6690y, rect.width, rect.height);
    }
    ...
    public int findNearest(Point point, Point point2) {
        double[] dArr = new double[2];
        int findNearest_0 = findNearest_0(this.nativeObj, point.f6684x, point.f6685y, dArr);
        if (point2 != null) {
            point2.f6684x = dArr[0];
            point2.f6685y = dArr[1];
        }
        return findNearest_0;
    }

    public int findNearest(Point point) {
        return findNearest_1(this.nativeObj, point.f6684x, point.f6685y);
    }
    ...
    public int insert(Point point) {
        return insert_0(this.nativeObj, point.f6684x, point.f6685y);
    }

    public int locate(Point point, int[] iArr, int[] iArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        int locate_0 = locate_0(this.nativeObj, point.f6684x, point.f6685y, dArr, dArr2);
        if (iArr != null) {
            iArr[0] = (int) dArr[0];
        }
        if (iArr2 != null) {
    ...
    public void initDelaunay(Rect rect) {
        initDelaunay_0(this.nativeObj, rect.f6689x, rect.f6690y, rect.width, rect.height);
    }
