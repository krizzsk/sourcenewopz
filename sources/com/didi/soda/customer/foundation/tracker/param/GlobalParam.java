...
public class GlobalParam {
    ...
    /* renamed from: a */
    private ExternalGlobalParam f41105a;

    public String getActivityId() {
        ExternalGlobalParam externalGlobalParam = this.f41105a;
    ...
    public void setExternalGlobalParam(ExternalGlobalParam externalGlobalParam) {
        this.f41105a = externalGlobalParam;
    }

    public static class ExternalGlobalParam extends C13761a {
    ...
    public class InternalGlobalParam extends C13761a {
