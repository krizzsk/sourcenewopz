...
public final class ObservableObserveOn<T> extends C21211a<T, T> {

    /* renamed from: a */
    final Scheduler f58875a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        Scheduler scheduler = this.f58875a;
        if (scheduler instanceof TrampolineScheduler) {
            this.source.subscribe(observer);
            return;
        }
        this.source.subscribe(new ObserveOnObserver(observer, scheduler.createWorker(), this.f58876b, this.f58877c));
    }
