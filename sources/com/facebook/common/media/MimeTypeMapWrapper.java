...
public class MimeTypeMapWrapper {
    private static final Map<String, String> sExtensionToMimeTypeMap = ImmutableMap.m37071of("heif", "image/heif", "heic", "image/heic");
    private static final MimeTypeMap sMimeTypeMap = MimeTypeMap.getSingleton();
    private static final Map<String, String> sMimeTypeToExtensionMap = ImmutableMap.m37071of("image/heif", "heif", "image/heic", "heic");
