...
public class Layer {
    ...
    public Layer(int i, int i2, SecureRandom secureRandom) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            for (int i9 = 0; i9 < this.f6525oi; i9++) {
                for (int i10 = 0; i10 < this.f6526vi; i10++) {
                    this.coeff_alpha[i8][i9][i10] = (short) (secureRandom.nextInt() & 255);
                }
            }
        }
        for (int i11 = 0; i11 < i7; i11++) {
            for (int i12 = 0; i12 < this.f6526vi; i12++) {
                for (int i13 = 0; i13 < this.f6526vi; i13++) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f6526vi == layer.getVi() && this.viNext == layer.getViNext() && this.f6525oi == layer.getOi() && RainbowUtil.equals(this.coeff_alpha, layer.getCoeffAlpha()) && RainbowUtil.equals(this.coeff_beta, layer.getCoeffBeta()) && RainbowUtil.equals(this.coeff_gamma, layer.getCoeffGamma()) && RainbowUtil.equals(this.coeff_eta, layer.getCoeffEta());
    }
    ...
    public int hashCode() {
        return (((((((((((this.f6526vi * 37) + this.viNext) * 37) + this.f6525oi) * 37) + Arrays.hashCode(this.coeff_alpha)) * 37) + Arrays.hashCode(this.coeff_beta)) * 37) + Arrays.hashCode(this.coeff_gamma)) * 37) + Arrays.hashCode(this.coeff_eta);
    }
    ...
    public short[][] plugInVinegars(short[] sArr) {
        ...
        short[] sArr3 = new short[this.f6525oi];
        for (int i3 = 0; i3 < this.f6525oi; i3++) {
            for (int i4 = 0; i4 < this.f6526vi; i4++) {
                for (int i5 = 0; i5 < this.f6526vi; i5++) {
                    sArr3[i3] = GF2Field.addElem(sArr3[i3], GF2Field.multElem(GF2Field.multElem(this.coeff_beta[i3][i4][i5], sArr[i4]), sArr[i5]));
                }
            }
        }
        for (int i6 = 0; i6 < this.f6525oi; i6++) {
            for (int i7 = 0; i7 < this.f6525oi; i7++) {
                for (int i8 = 0; i8 < this.f6526vi; i8++) {
        ...
        for (int i11 = 0; i11 < this.f6525oi; i11++) {
            for (int i12 = this.f6526vi; i12 < this.viNext; i12++) {
                short[] sArr4 = sArr2[i11];
                int i13 = this.f6526vi;
                sArr4[i12 - i13] = GF2Field.addElem(this.coeff_gamma[i11][i12], sArr2[i11][i12 - i13]);
            }
        }
        for (int i14 = 0; i14 < this.f6525oi; i14++) {
            sArr3[i14] = GF2Field.addElem(sArr3[i14], this.coeff_eta[i14]);
        }
        while (true) {
            int i15 = this.f6525oi;
            if (i2 >= i15) {
                return sArr2;
            }
