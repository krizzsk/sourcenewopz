...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    /* renamed from: x */
    private BigInteger f6223x;

    protected BCDHPrivateKey() {
    }

    BCDHPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f6223x = dHPrivateKey.getX();
        this.dhSpec = dHPrivateKey.getParams();
    }

    BCDHPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f6223x = dHPrivateKeySpec.getX();
    ...
    public BCDHPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f6223x = ((ASN1Integer) privateKeyInfo.parsePrivateKey()).getValue();
        if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement)) {
            ...
            if (instance2.getL() != null) {
                ...
                dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f6223x, new DHParameters(instance2.getP(), instance2.getG(), (BigInteger) null, instance2.getL().intValue()));
            } else {
                this.dhSpec = new DHParameterSpec(instance2.getP(), instance2.getG());
                dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f6223x, new DHParameters(instance2.getP(), instance2.getG()));
            }
            ...
            dHPrivateKeyParameters = new DHPrivateKeyParameters(this.f6223x, new DHParameters(instance3.getP(), instance3.getG(), instance3.getQ(), instance3.getJ(), (DHValidationParameters) null));
        } else {
    ...
    BCDHPrivateKey(DHPrivateKeyParameters dHPrivateKeyParameters) {
        this.f6223x = dHPrivateKeyParameters.getX();
    ...
    public DHPrivateKeyParameters engineGetKeyParameters() {
        ...
        return dHParameterSpec instanceof DHDomainParameterSpec ? new DHPrivateKeyParameters(this.f6223x, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters()) : new DHPrivateKeyParameters(this.f6223x, new DHParameters(dHParameterSpec.getP(), this.dhSpec.getG(), (BigInteger) null, this.dhSpec.getL()));
    }
    ...
    public String toString() {
        return DHUtil.privateKeyToString("DH", this.f6223x, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }
}
