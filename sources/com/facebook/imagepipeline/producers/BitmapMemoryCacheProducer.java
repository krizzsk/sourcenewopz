    ...
    public void produceResults(Consumer<CloseableReference<CloseableImage>> consumer, ProducerContext producerContext) {
        ...
        try {
            ...
            if (closeableReference != null) {
                ...
                if (isOfFullQuality) {
                    listener.onProducerFinishWithSuccess(id, getProducerName(), listener.requiresExtraMap(id) ? ImmutableMap.m37070of("cached_value_found", "true") : null);
            ...
            if (producerContext.getLowestPermittedRequestLevel().getValue() >= ImageRequest.RequestLevel.BITMAP_MEMORY_CACHE.getValue()) {
                listener.onProducerFinishWithSuccess(id, getProducerName(), listener.requiresExtraMap(id) ? ImmutableMap.m37070of("cached_value_found", SDKConsts.BOOLEAN_FALSE) : null);
            ...
            if (listener.requiresExtraMap(id)) {
                map = ImmutableMap.m37070of("cached_value_found", SDKConsts.BOOLEAN_FALSE);
            }
