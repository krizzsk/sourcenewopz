...
public class Zuc256CoreEngine extends Zuc128CoreEngine {
    ...
    public void setKeyAndIV(int[] iArr, byte[] bArr, byte[] bArr2) {
        ...
        if (bArr3 == null || bArr3.length != 32) {
            ...
            iArr[14] = MAKEU31(bArr3[14], (byte) (this.theD[14] | ((bArr3[31] >>> 4) & Ascii.f53593SI)), bArr4[16], bArr4[9]);
            iArr[15] = MAKEU31(bArr3[15], (byte) (this.theD[15] | (bArr3[31] & Ascii.f53593SI)), bArr3[30], bArr3[29]);
        }
    }
}
