...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    /* renamed from: a */
    private static final /* synthetic */ AtomicReferenceFieldUpdater f61518a = AtomicReferenceFieldUpdater.newUpdater(DispatchedContinuation.class, Object.class, "_reusableCancellableContinuation");
    private volatile /* synthetic */ Object _reusableCancellableContinuation = null;
    public Object _state = DispatchedContinuationKt.f61519a;
    ...
    /* renamed from: a */
    private final CancellableContinuationImpl<?> m45957a() {
    ...
    public final void release() {
        awaitReusability();
        CancellableContinuationImpl<?> a = m45957a();
        if (a != null) {
    ...
    public Object takeState$kotlinx_coroutines_core() {
        ...
        if (DebugKt.getASSERTIONS_ENABLED()) {
            if (!(obj != DispatchedContinuationKt.f61519a)) {
                throw new AssertionError();
            }
        }
        this._state = DispatchedContinuationKt.f61519a;
        return obj;
    }
    ...
    public final void resumeCancellableWith(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        try {
            ...
            if (job == null || job.isActive()) {
                ...
                resumeWith(Result.m47688constructorimpl(ResultKt.createFailure(cancellationException)));
                z = true;
            }
            if (!z) {
                Continuation<T> continuation2 = this.continuation;
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation() {
        while (true) {
            ...
            if (obj == null) {
                ...
                if (f61518a.compareAndSet(this, obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                    return (CancellableContinuationImpl) obj;
                }
        ...
        do {
            ...
            if (obj != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (!(obj instanceof Throwable)) {
                    throw new IllegalStateException(Intrinsics.stringPlus("Inconsistent state ", obj).toString());
                } else if (f61518a.compareAndSet(this, obj, (Object) null)) {
                    return (Throwable) obj;
                } else {
                    throw new IllegalArgumentException("Failed requirement.".toString());
                }
            }
        } while (!f61518a.compareAndSet(this, DispatchedContinuationKt.REUSABLE_CLAIMED, cancellableContinuation));
        return null;
    }
    ...
    public final boolean postponeCancellation(Throwable th) {
        while (true) {
            ...
            if (Intrinsics.areEqual(obj, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (f61518a.compareAndSet(this, DispatchedContinuationKt.REUSABLE_CLAIMED, th)) {
                    return true;
                }
            } else if (obj instanceof Throwable) {
                return true;
            } else {
                if (f61518a.compareAndSet(this, obj, (Object) null)) {
                    return false;
                }
            }
        }
