...
class ErrorCorrection {
    ...
    static short LDDecode(int i, int i2, int i3, int i4) {
        return (short) (((((m3741g(i) + m3741g(i2)) + m3741g(i3)) + m3741g(i4)) - 98312) >>> 31);
    }
    ...
    /* renamed from: f */
    static int m3740f(int[] iArr, int i, int i2, int i3) {
        int i4 = (i3 * 2730) >> 25;
    ...
    static void helpRec(short[] sArr, short[] sArr2, byte[] bArr, byte b) {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            int i5 = i + 512;
            int i6 = i + 768;
            int f = (24577 - (((m3740f(iArr, 0, 4, (sArr2[i2] * 8) + i3) + m3740f(iArr, 1, 5, (sArr2[i4] * 8) + i3)) + m3740f(iArr, 2, 6, (sArr2[i5] * 8) + i3)) + m3740f(iArr, 3, 7, (sArr2[i6] * 8) + i3))) >> 31;
            int i7 = ~f;
