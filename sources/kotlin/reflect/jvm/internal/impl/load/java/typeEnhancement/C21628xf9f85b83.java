...
final class C21628xf9f85b83 extends Lambda implements Function1<CallableMemberDescriptor, KotlinType> {

    /* renamed from: $p */
    final /* synthetic */ ValueParameterDescriptor f60613$p;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C21628xf9f85b83(ValueParameterDescriptor valueParameterDescriptor) {
        super(1);
        this.f60613$p = valueParameterDescriptor;
    }
    ...
    public final KotlinType invoke(CallableMemberDescriptor callableMemberDescriptor) {
        ...
        KotlinType type = callableMemberDescriptor.getValueParameters().get(this.f60613$p.getIndex()).getType();
