...
public final class SignaturePemKeysetReader implements KeysetReader {
    ...
    public static final class Builder {
        ...
        public Builder addPem(String str, PemKeyType pemKeyType) {
            PemKey pemKey = new PemKey((C193891) null);
    ...
    static /* synthetic */ class C193891 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.signature.SignaturePemKeysetReader.C193891.<clinit>():void");
        }
    }

    private static HashType getHashType(PemKeyType pemKeyType) {
        int i = C193891.$SwitchMap$com$google$crypto$tink$subtle$Enums$HashType[pemKeyType.hash.ordinal()];
        if (i == 1) {
