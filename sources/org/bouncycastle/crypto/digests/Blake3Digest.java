...
public class Blake3Digest implements ExtendedDigest, Xof, Memoable {
    ...
    /* renamed from: IV */
    private static final int[] f5769IV = {1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225};
    ...
    private static final byte[] ROTATE = {16, Ascii.f53586FF, 8, 7};
    private static final int ROUNDS = 7;
    private static final byte[] SIGMA = {2, 6, 3, 10, 7, 0, 4, Ascii.f53584CR, 1, 11, Ascii.f53586FF, 5, 9, Ascii.f53594SO, Ascii.f53593SI, 8};
    ...
    private void initChunkBlock(int i, boolean z) {
        ...
        System.arraycopy(f5769IV, 0, this.theV, 8, 4);
        int[] iArr = this.theV;
        long j = this.theCounter;
        iArr[12] = (int) j;
        iArr[13] = (int) (j >> 32);
    ...
    private void initNullKey() {
        System.arraycopy(f5769IV, 0, this.theK, 0, 8);
    }
