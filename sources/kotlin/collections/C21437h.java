...
class C21437h extends C21436g {
    ...
    /* renamed from: a */
    private static final <T> List<T> m43226a() {
        return CollectionsKt.emptyList();
    }

    /* renamed from: b */
    private static final <T> List<T> m43233b() {
        return new ArrayList<>();
    }

    /* renamed from: c */
    private static final <T> ArrayList<T> m43236c() {
        return new ArrayList<>();
    }

    public static final <T> List<T> mutableListOf(T... tArr) {
        Intrinsics.checkNotNullParameter(tArr, "elements");
        return tArr.length == 0 ? new ArrayList<>() : new ArrayList<>(new C21423a(tArr, true));
    }
    ...
    /* renamed from: a */
    private static final <T> List<T> m43227a(int i, Function1<? super Integer, ? extends T> function1) {
    ...
    /* renamed from: b */
    private static final <T> List<T> m43234b(int i, Function1<? super Integer, ? extends T> function1) {
        ArrayList arrayList = new ArrayList(i);
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(function1.invoke(Integer.valueOf(i2)));
        }
    ...
    /* renamed from: a */
    private static final <E> List<E> m43229a(Function1<? super List<E>, Unit> function1) {
    ...
    /* renamed from: c */
    private static final <E> List<E> m43238c(int i, Function1<? super List<E>, Unit> function1) {
    ...
    /* renamed from: a */
    private static final <T> boolean m43231a(Collection<? extends T> collection) {
        return !collection.isEmpty();
    }

    /* renamed from: b */
    private static final <T> boolean m43235b(Collection<? extends T> collection) {
        return collection == null || collection.isEmpty();
    }

    /* renamed from: c */
    private static final <T> Collection<T> m43237c(Collection<? extends T> collection) {
        return collection != null ? collection : CollectionsKt.emptyList();
    }

    /* renamed from: a */
    private static final <T> List<T> m43228a(List<? extends T> list) {
    ...
    private static final <C extends java.util.Collection<?> & R, R> R m43225a(C r1, kotlin.jvm.functions.Function0<? extends R> r2) {
        /*
        ...
        L_0x000a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.collections.C21437h.m43225a(java.util.Collection, kotlin.jvm.functions.Function0):java.lang.Object");
    }

    /* renamed from: a */
    private static final <T> boolean m43232a(Collection<? extends T> collection, Collection<? extends T> collection2) {
    ...
    /* renamed from: a */
    private static final void m43230a(int i, int i2, int i3) {
        if (i2 > i3) {
