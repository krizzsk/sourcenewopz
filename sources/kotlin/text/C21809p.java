...
class C21809p extends C21808o {
    ...
    /* renamed from: a */
    private static final String m45342a(String str) {
        if (str != null) {
    ...
    /* renamed from: b */
    private static final String m45359b(String str) {
        if (str != null) {
    ...
    /* renamed from: c */
    private static final String m45366c(String str) {
        if (str != null) {
    ...
    /* renamed from: a */
    private static final boolean m45355a(CharSequence charSequence) {
        return charSequence == null || charSequence.length() == 0;
    }

    /* renamed from: b */
    private static final boolean m45364b(CharSequence charSequence) {
        return charSequence.length() == 0;
    }

    /* renamed from: c */
    private static final boolean m45367c(CharSequence charSequence) {
        return charSequence.length() > 0;
    }

    /* renamed from: d */
    private static final boolean m45369d(CharSequence charSequence) {
        return !StringsKt.isBlank(charSequence);
    }

    /* renamed from: e */
    private static final boolean m45370e(CharSequence charSequence) {
    ...
    private static final <C extends java.lang.CharSequence & R, R> R m45337a(C r1, kotlin.jvm.functions.Function0<? extends R> r2) {
        /*
            int r0 = r1.length()
        ...
        L_0x000f:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.C21809p.m45337a(java.lang.CharSequence, kotlin.jvm.functions.Function0):java.lang.Object");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final <C extends java.lang.CharSequence & R, R> R m45357b(C r1, kotlin.jvm.functions.Function0<? extends R> r2) {
        /*
        ...
        L_0x000a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.C21809p.m45357b(java.lang.CharSequence, kotlin.jvm.functions.Function0):java.lang.Object");
    }
    ...
    /* renamed from: a */
    private static final CharSequence m45336a(String str, int i, int i2) {
        return str.subSequence(i, i2);
    }

    /* renamed from: a */
    private static final String m45338a(CharSequence charSequence, int i, int i2) {
        return charSequence.subSequence(i, i2).toString();
    }

    /* renamed from: a */
    static /* synthetic */ String m45339a(CharSequence charSequence, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
    ...
    /* renamed from: a */
    private static final String m45343a(String str, int i, int i2, CharSequence charSequence) {
        if (str != null) {
    ...
    /* renamed from: a */
    private static final String m45346a(String str, IntRange intRange, CharSequence charSequence) {
        if (str != null) {
    ...
    /* renamed from: b */
    private static final String m45360b(String str, int i, int i2) {
        if (str != null) {
    ...
    /* renamed from: a */
    private static final String m45345a(String str, IntRange intRange) {
        if (str != null) {
    ...
    /* renamed from: a */
    private static final String m45340a(CharSequence charSequence, Regex regex, String str) {
        return regex.replace(charSequence, str);
    }

    /* renamed from: a */
    private static final String m45341a(CharSequence charSequence, Regex regex, Function1<? super MatchResult, ? extends CharSequence> function1) {
        return regex.replace(charSequence, function1);
    }

    /* renamed from: b */
    private static final String m45358b(CharSequence charSequence, Regex regex, String str) {
        return regex.replaceFirst(charSequence, str);
    }

    /* renamed from: a */
    private static final String m45344a(String str, Function1<? super Character, Character> function1) {
        if (!(str.length() > 0)) {
            return str;
        }
    ...
    /* renamed from: b */
    private static final String m45361b(String str, Function1<? super Character, ? extends CharSequence> function1) {
        if (!(str.length() > 0)) {
            return str;
        }
        StringBuilder sb = new StringBuilder();
    ...
    /* renamed from: a */
    private static final boolean m45356a(CharSequence charSequence, Regex regex) {
    ...
    /* renamed from: a */
    static /* synthetic */ int m45335a(CharSequence charSequence, CharSequence charSequence2, int i, int i2, boolean z, boolean z2, int i3, Object obj) {
        return m45334a(charSequence, charSequence2, i, i2, z, (i3 & 16) != 0 ? false : z2);
    }

    /* renamed from: a */
    private static final int m45334a(CharSequence charSequence, CharSequence charSequence2, int i, int i2, boolean z, boolean z2) {
    ...
    /* renamed from: a */
    public static final Pair<Integer, String> m45350a(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
        Object obj;
        Object obj2;
                ...
                if (step < 0 ? first >= last : first <= last) {
                    while (true) {
                        ...
                        if (str2 == null) {
                            ...
                            return TuplesKt.m42317to(Integer.valueOf(first), str2);
                        }
                    }
                }
            } else {
                ...
                if (step2 < 0 ? first2 >= last2 : first2 <= last2) {
                    while (true) {
                        ...
                        if (str4 == null) {
                            ...
                            return TuplesKt.m42317to(Integer.valueOf(first2), str4);
                        }
                    }
                }
            }
        ...
        return TuplesKt.m42317to(Integer.valueOf(indexOf$default), str5);
    }
    ...
    public static final Pair<Integer, String> findAnyOf(CharSequence charSequence, Collection<String> collection, int i, boolean z) {
        ...
        return m45350a(charSequence, collection, i, z, false);
    }
    ...
    public static final Pair<Integer, String> findLastAnyOf(CharSequence charSequence, Collection<String> collection, int i, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(collection, "strings");
        return m45350a(charSequence, collection, i, z, true);
    }
    ...
    public static final int indexOfAny(CharSequence charSequence, Collection<String> collection, int i, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(charSequence, "$this$indexOfAny");
        Intrinsics.checkNotNullParameter(collection, "strings");
        Pair<Integer, String> a = m45350a(charSequence, collection, i, z, false);
    ...
    public static final int lastIndexOfAny(CharSequence charSequence, Collection<String> collection, int i, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(charSequence, "$this$lastIndexOfAny");
        Intrinsics.checkNotNullParameter(collection, "strings");
        Pair<Integer, String> a = m45350a(charSequence, collection, i, z, true);
        if (a == null || (first = a.getFirst()) == null) {
            return -1;
        }
        return first.intValue();
    ...
    public static final int indexOf(CharSequence charSequence, String str, int i, boolean z) {
        ...
        return m45335a(charSequence, str, i, charSequence.length(), z, false, 16, (Object) null);
    }
    ...
    public static final int lastIndexOf(CharSequence charSequence, String str, int i, boolean z) {
        ...
        return m45334a(charSequence, str, i, 0, z, true);
    }
    ...
    public static final boolean contains(CharSequence charSequence, CharSequence charSequence2, boolean z) {
        ...
        if (charSequence2 instanceof String) {
            ...
            if (m45335a(charSequence, charSequence2, 0, charSequence.length(), z, false, 16, (Object) null) >= 0) {
                return true;
            }
        }
        return false;
    ...
    /* renamed from: b */
    private static final boolean m45365b(CharSequence charSequence, Regex regex) {
        Intrinsics.checkNotNullParameter(charSequence, "$this$contains");
        return regex.containsMatchIn(charSequence);
    }

    /* renamed from: a */
    static /* synthetic */ Sequence m45352a(CharSequence charSequence, char[] cArr, int i, boolean z, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m45351a(charSequence, cArr, i, z, i2);
    }

    /* renamed from: a */
    private static final Sequence<IntRange> m45351a(CharSequence charSequence, char[] cArr, int i, boolean z, int i2) {
        StringsKt.requireNonNegativeLimit(i2);
        return new C21796c(charSequence, i, i2, new StringsKt__StringsKt$rangesDelimitedBy$1(cArr, z));
    }

    /* renamed from: a */
    static /* synthetic */ Sequence m45354a(CharSequence charSequence, String[] strArr, int i, boolean z, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m45353a(charSequence, strArr, i, z, i2);
    }

    /* renamed from: a */
    private static final Sequence<IntRange> m45353a(CharSequence charSequence, String[] strArr, int i, boolean z, int i2) {
        StringsKt.requireNonNegativeLimit(i2);
        return new C21796c(charSequence, i, i2, new StringsKt__StringsKt$rangesDelimitedBy$2(ArraysKt.asList((T[]) strArr), z));
    }
    ...
    public static final Sequence<String> splitToSequence(CharSequence charSequence, String[] strArr, boolean z, int i) {
        ...
        return SequencesKt.map(m45354a(charSequence, strArr, 0, z, i, 2, (Object) null), new StringsKt__StringsKt$splitToSequence$1(charSequence));
    }
    ...
    public static final List<String> split(CharSequence charSequence, String[] strArr, boolean z, int i) {
        ...
        if (strArr.length == 1) {
            ...
            if (!z2) {
                return m45347a(charSequence, str, z, i);
            }
        }
        Iterable<IntRange> asIterable = SequencesKt.asIterable(m45354a(charSequence, strArr, 0, z, i, 2, (Object) null));
    ...
    public static final Sequence<String> splitToSequence(CharSequence charSequence, char[] cArr, boolean z, int i) {
        ...
        return SequencesKt.map(m45352a(charSequence, cArr, 0, z, i, 2, (Object) null), new StringsKt__StringsKt$splitToSequence$2(charSequence));
    }
    ...
    public static final List<String> split(CharSequence charSequence, char[] cArr, boolean z, int i) {
        ...
        Intrinsics.checkNotNullParameter(cArr, "delimiters");
        if (cArr.length == 1) {
            return m45347a(charSequence, String.valueOf(cArr[0]), z, i);
        }
        Iterable<IntRange> asIterable = SequencesKt.asIterable(m45352a(charSequence, cArr, 0, z, i, 2, (Object) null));
        Collection arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(asIterable, 10));
        for (IntRange substring : asIterable) {
            arrayList.add(StringsKt.substring(charSequence, substring));
        }
    ...
    /* renamed from: a */
    private static final List<String> m45347a(CharSequence charSequence, String str, boolean z, int i) {
    ...
    /* renamed from: a */
    private static final List<String> m45348a(CharSequence charSequence, Regex regex, int i) {
        return regex.split(charSequence, i);
    }

    /* renamed from: a */
    static /* synthetic */ List m45349a(CharSequence charSequence, Regex regex, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = 0;
        }
        return regex.split(charSequence, i);
    ...
    /* renamed from: b */
    private static final Sequence<String> m45362b(CharSequence charSequence, Regex regex, int i) {
        return regex.splitToSequence(charSequence, i);
    }

    /* renamed from: b */
    static /* synthetic */ Sequence m45363b(CharSequence charSequence, Regex regex, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = 0;
        }
        return regex.splitToSequence(charSequence, i);
