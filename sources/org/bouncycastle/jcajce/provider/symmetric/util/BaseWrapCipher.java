...
public abstract class BaseWrapCipher extends CipherSpi implements PBE {
    ...
    public byte[] engineGetIV() {
        return Arrays.clone(this.f6250iv);
    }
    ...
    public AlgorithmParameters engineGetParameters() {
        if (this.engineParams == null && this.f6250iv != null) {
            ...
            try {
                ...
                createParametersInstance.init(new IvParameterSpec(this.f6250iv));
            } catch (Exception e) {
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (key instanceof BCPBEKey) {
            ...
            if (algorithmParameterSpec instanceof PBEParameterSpec) {
                parametersWithIV = PBE.C2737Util.makePBEParameters(bCPBEKey, algorithmParameterSpec, this.wrapEngine.getAlgorithmName());
        ...
        if ((parametersWithIV instanceof KeyParameter) && this.ivSize != 0 && (i == 3 || i == 1)) {
            ...
            parametersWithIV = new ParametersWithIV(parametersWithIV, this.f6250iv);
        }
