...
public class FileVideoCapturer implements VideoCapturer {
    ...
    private static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (read == -1) {
                    ...
                    Logging.m3800d(TAG, "Color space: " + str2);
                    if (!str2.equals("420") && !str2.equals("420mpeg2")) {
                        ...
                        this.frameWidth = i;
                        this.frameHeight = i2;
                        Logging.m3800d(TAG, "frame dim: (" + i + ", " + i2 + ")");
                        return;
                    }
                } else {
                    sb.append((char) read);
        ...
        public void close() {
            try {
                ...
                Logging.m3802e(TAG, "Problem closing file", e);
            }
        }
    }
    ...
    public FileVideoCapturer(String str) throws IOException {
        try {
            ...
            Logging.m3800d(TAG, "Could not open video file: " + str);
            throw e;
        }
    }
