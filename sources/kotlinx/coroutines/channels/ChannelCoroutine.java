...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object receiveOrNull(Continuation<? super E> continuation) {
        return this.f61385a.receiveOrNull(continuation);
    }

    public Object send(E e, Continuation<? super Unit> continuation) {
        return this.f61385a.send(e, continuation);
    }

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public Object m48248tryReceivePtdJZtk() {
        return this.f61385a.m48273tryReceivePtdJZtk();
    }

    /* renamed from: trySend-JP2dKIU  reason: not valid java name */
    public Object m48249trySendJP2dKIU(E e) {
        return this.f61385a.m48275trySendJP2dKIU(e);
    }
    ...
    public void cancelInternal(Throwable th) {
        ...
        this.f61385a.cancel(cancellationException$default);
