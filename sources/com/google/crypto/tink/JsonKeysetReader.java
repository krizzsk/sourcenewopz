...
public final class JsonKeysetReader implements KeysetReader {
    ...
    public Keyset read() throws IOException {
        try {
            ...
            Keyset keysetFromJson2 = keysetFromJson(new JSONObject(new String(C19211Util.readAll(this.inputStream), UTF_8)));
    ...
    public EncryptedKeyset readEncrypted() throws IOException {
        try {
            ...
            EncryptedKeyset encryptedKeysetFromJson2 = encryptedKeysetFromJson(new JSONObject(new String(C19211Util.readAll(this.inputStream), UTF_8)));
            InputStream inputStream3 = this.inputStream;
            if (inputStream3 != null && this.closeStreamAfterReading) {
                inputStream3.close();
            }
