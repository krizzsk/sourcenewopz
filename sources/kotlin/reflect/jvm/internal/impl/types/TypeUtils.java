...
public class TypeUtils {
    ...
    /* renamed from: a */
    static final /* synthetic */ boolean f61141a = (!TypeUtils.class.desiredAssertionStatus());

    /* renamed from: a */
    private static /* synthetic */ void m45064a(int i) {
        String str;
        int i2;
        Throwable th;
        int i3 = i;
    ...
    public static boolean contains(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1) {
        ...
        return m45065a(kotlinType, function1, (Function1<KotlinType, Boolean>) null, (SmartSet<KotlinType>) null);
    }
    ...
    public static boolean containsStoppingAt(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1, Function1<KotlinType, Boolean> function12) {
        ...
        return m45065a(kotlinType, function1, function12, (SmartSet<KotlinType>) null);
    }

    /* renamed from: a */
    private static boolean m45065a(KotlinType kotlinType, Function1<UnwrappedType, Boolean> function1, Function1<KotlinType, Boolean> function12, SmartSet<KotlinType> smartSet) {
        if (function1 == null) {
            m45064a(46);
        }
        if (kotlinType == null) {
        ...
        if (flexibleType != null && (m45065a(flexibleType.getLowerBound(), function1, function12, smartSet) || m45065a(flexibleType.getUpperBound(), function1, function12, smartSet))) {
            return true;
        }
        if ((unwrap instanceof DefinitelyNotNullType) && m45065a(((DefinitelyNotNullType) unwrap).getOriginal(), function1, function12, smartSet)) {
            return true;
        }
        TypeConstructor constructor = kotlinType.getConstructor();
        if (constructor instanceof IntersectionTypeConstructor) {
            for (KotlinType a : ((IntersectionTypeConstructor) constructor).getSupertypes()) {
                if (m45065a(a, function1, function12, smartSet)) {
                    return true;
                }
            }
            return false;
        ...
        for (TypeProjection next : kotlinType.getArguments()) {
            if (!next.isStarProjection()) {
                if (m45065a(next.getType(), function1, function12, smartSet)) {
                    return true;
                }
            }
        }
