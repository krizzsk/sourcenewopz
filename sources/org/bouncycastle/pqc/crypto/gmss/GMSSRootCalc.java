...
public class GMSSRootCalc {
    ...
    private Vector[] retain = new Vector[(this.f6450K - 1)];
    ...
    public void initialize(Vector vector) {
        int i;
        this.treehash = new Treehash[(this.heightOfTree - this.f6450K)];
        int i2 = 0;
        while (true) {
            i = this.heightOfTree;
            if (i2 >= i - this.f6450K) {
        ...
        this.retain = new Vector[(this.f6450K - 1)];
        for (int i4 = 0; i4 < this.f6450K - 1; i4++) {
    ...
    public void update(byte[] bArr) {
        if (this.isFinished) {
            ...
            } else if (iArr[0] == 3 && this.heightOfTree > this.f6450K) {
                this.treehash[0].setFirstNode(bArr);
            }
            int[] iArr2 = this.index;
            if ((iArr2[0] - 3) % 2 == 0 && iArr2[0] >= 3 && this.heightOfTree == this.f6450K) {
            ...
            while (this.tailStack.size() > 0 && i3 == ((Integer) this.heightOfNodes.lastElement()).intValue()) {
                ...
                if (i3 < this.heightOfTree) {
                    ...
                    if (i3 >= this.heightOfTree - this.f6450K) {
                        if (i3 == 0) {
                            System.out.println("M���P");
                        }
                        int[] iArr4 = this.index;
                        if ((iArr4[i3] - 3) % 2 == 0 && iArr4[i3] >= 3) {
                            this.retain[i3 - (this.heightOfTree - this.f6450K)].insertElementAt(bArr2, 0);
                        }
    ...
    public void update(byte[] bArr, byte[] bArr2) {
        ...
        if (i < this.heightOfTree - this.f6450K && this.indexForNextSeed - 2 == this.index[0]) {
