...
public final class ObservableAll<T> extends C21211a<T, Boolean> {

    /* renamed from: a */
    final Predicate<? super T> f58708a;

    public ObservableAll(ObservableSource<T> observableSource, Predicate<? super T> predicate) {
        super(observableSource);
        this.f58708a = predicate;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super Boolean> observer) {
        this.source.subscribe(new AllObserver(observer, this.f58708a));
    }
