...
public final class zzbrf implements zzesa<zzbzl<zzbtc>> {
    ...
    private zzbrf(zzesn<zzclp> zzesn, zzesn<Executor> zzesn2, zzesn<zzcqv> zzesn3) {
        this.zzgab = zzesn;
        this.zzeyl = zzesn2;
        this.zzgac = zzesn3;
    }

    public static zzbrf zzh(zzesn<zzclp> zzesn, zzesn<Executor> zzesn2, zzesn<zzcqv> zzesn3) {
        return new zzbrf(zzesn, zzesn2, zzesn3);
    }
