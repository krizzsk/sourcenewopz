...
public class Curve25519Field {
    ...
    /* renamed from: M */
    private static final long f6313M = 4294967295L;

    /* renamed from: P */
    static final int[] f6314P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};

    /* renamed from: P7 */
    private static final int f6315P7 = Integer.MAX_VALUE;
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        while (Nat256.gte(fromBigInteger, f6314P)) {
            Nat256.subFrom(f6314P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        ...
        Nat256.add(iArr, f6314P, iArr2);
        Nat.shiftDownBit(8, iArr2, 0);
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f6314P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f6314P) == 0);
    }
