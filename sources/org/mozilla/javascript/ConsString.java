...
public class ConsString implements Serializable, CharSequence {
    ...
    /* renamed from: s1 */
    private CharSequence f6593s1;

    /* renamed from: s2 */
    private CharSequence f6594s2;

    public ConsString(CharSequence charSequence, CharSequence charSequence2) {
        this.f6593s1 = charSequence;
        this.f6594s2 = charSequence2;
    ...
    public String toString() {
        return this.depth == 0 ? (String) this.f6593s1 : flatten();
    }
    ...
    private synchronized String flatten() {
        if (this.depth > 0) {
            ...
            appendTo(sb);
            this.f6593s1 = sb.toString();
            this.f6594s2 = "";
            this.depth = 0;
        }
        return (String) this.f6593s1;
    }

    private synchronized void appendTo(StringBuilder sb) {
        appendFragment(this.f6593s1, sb);
        appendFragment(this.f6594s2, sb);
    }
    ...
    public char charAt(int i) {
        return (this.depth == 0 ? (String) this.f6593s1 : flatten()).charAt(i);
    }

    public CharSequence subSequence(int i, int i2) {
        return (this.depth == 0 ? (String) this.f6593s1 : flatten()).substring(i, i2);
    }
}
