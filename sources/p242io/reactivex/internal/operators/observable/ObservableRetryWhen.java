...
public final class ObservableRetryWhen<T> extends C21211a<T, T> {

    /* renamed from: a */
    final Function<? super Observable<Throwable>, ? extends ObservableSource<?>> f58916a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.f58916a.apply(serialized), "The handler returned a null ObservableSource");
