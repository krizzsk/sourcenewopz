...
public class MaterialDialogs {
    ...
    public static Rect getDialogBackgroundInsets(Context context, int i, int i2) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, (AttributeSet) null, C10448R.styleable.MaterialAlertDialog, i, i2, new int[0]);
