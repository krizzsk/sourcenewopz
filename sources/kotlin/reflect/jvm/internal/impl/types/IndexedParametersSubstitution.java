...
public final class IndexedParametersSubstitution extends TypeSubstitution {
    ...
    /* renamed from: a */
    private final TypeParameterDescriptor[] f61112a;

    /* renamed from: b */
    private final TypeProjection[] f61113b;
    ...
    public IndexedParametersSubstitution(TypeParameterDescriptor[] typeParameterDescriptorArr, TypeProjection[] typeProjectionArr, boolean z) {
        ...
        this.f61112a = typeParameterDescriptorArr;
        this.f61113b = typeProjectionArr;
        this.f61114c = z;
    ...
    public TypeProjection get(KotlinType kotlinType) {
        ...
        TypeParameterDescriptor[] typeParameterDescriptorArr = this.f61112a;
