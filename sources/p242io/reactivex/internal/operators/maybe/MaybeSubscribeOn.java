...
public final class MaybeSubscribeOn<T> extends C21209a<T, T> {

    /* renamed from: a */
    final Scheduler f58621a;

    public MaybeSubscribeOn(MaybeSource<T> maybeSource, Scheduler scheduler) {
        super(maybeSource);
        this.f58621a = scheduler;
    }
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        ...
        subscribeOnMaybeObserver.task.replace(this.f58621a.scheduleDirect(new SubscribeTask(subscribeOnMaybeObserver, this.source)));
    }
