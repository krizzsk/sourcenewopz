...
public class EncodedImage implements RefCounted {
    ...
    public static class Builder {
        ...
        public EncodedImage createEncodedImage() {
            return new EncodedImage(this.buffer, this.supportsRetain, this.releaseCallback, this.encodedWidth, this.encodedHeight, this.captureTimeNs, this.frameType, this.rotation, this.completeFrame, this.f6705qp);
        }
    }
}
