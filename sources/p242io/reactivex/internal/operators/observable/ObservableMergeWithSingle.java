...
public final class ObservableMergeWithSingle<T> extends C21211a<T, T> {

    /* renamed from: a */
    final SingleSource<? extends T> f58874a;

    public ObservableMergeWithSingle(Observable<T> observable, SingleSource<? extends T> singleSource) {
        super(observable);
        this.f58874a = singleSource;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f58874a.subscribe(mergeWithObserver.otherObserver);
    }
