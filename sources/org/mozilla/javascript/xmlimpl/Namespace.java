...
class Namespace extends IdScriptableObject {
    ...
    /* renamed from: ns */
    private XmlNode.Namespace f6682ns;
    ...
    public String uri() {
        return this.f6682ns.getUri();
    }

    public String prefix() {
        return this.f6682ns.getPrefix();
    }
    ...
    public Object getInstanceIdValue(int i) {
        ...
        if (maxInstanceId != 1) {
            ...
            return this.f6682ns.getUri();
        } else if (this.f6682ns.getPrefix() == null) {
    ...
    private String js_toSource() {
        ...
        toSourceImpl(this.f6682ns.getPrefix(), this.f6682ns.getUri(), sb);
