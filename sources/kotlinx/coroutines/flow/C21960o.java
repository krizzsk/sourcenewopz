...
final /* synthetic */ class C21960o {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m45825a() {
    }

    /* renamed from: a */
    public static /* synthetic */ Flow m45824a(Flow flow, Flow flow2, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
    ...
    /* renamed from: a */
    public static final <T> Flow<T> m45823a(Flow<? extends T> flow, Flow<? extends T> flow2, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m48279catch(flow, new FlowKt__ErrorsKt$onErrorCollect$2(function1, flow2, (Continuation<? super FlowKt__ErrorsKt$onErrorCollect$2>) null));
    }

    /* renamed from: a */
    public static /* synthetic */ Flow m45820a(Flow flow, long j, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Long.MAX_VALUE;
        }
        if ((i & 2) != 0) {
    ...
    /* renamed from: a */
    public static final <T> Flow<T> m45819a(Flow<? extends T> flow, long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        if (j > 0) {
    ...
    /* renamed from: a */
    public static /* synthetic */ Flow m45818a(Flow flow, int i, Function1 function1, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i2 & 2) != 0) {
        ...
        return m45817a(flow, i, function1);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "binary compatibility with retries: Int preview version")
    /* renamed from: a */
    public static final /* synthetic */ Flow m45817a(Flow flow, int i, Function1 function1) {
        if (i > 0) {
    ...
    public static final <T> java.lang.Object m45816a(kotlinx.coroutines.flow.Flow<? extends T> r4, kotlinx.coroutines.flow.FlowCollector<? super T> r5, kotlin.coroutines.Continuation<? super java.lang.Throwable> r6) {
        /*
        ...
        L_0x0056:
            ...
            boolean r4 = m45826a((java.lang.Throwable) r5, (java.lang.Throwable) r4)
            if (r4 != 0) goto L_0x006b
            kotlin.coroutines.CoroutineContext r4 = r0.getContext()
            boolean r4 = m45827a((java.lang.Throwable) r5, (kotlin.coroutines.CoroutineContext) r4)
            if (r4 != 0) goto L_0x006b
            return r5
        L_0x006b:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.C21960o.m45816a(kotlinx.coroutines.flow.Flow, kotlinx.coroutines.flow.FlowCollector, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: a */
    private static final boolean m45827a(Throwable th, CoroutineContext coroutineContext) {
        Job job = (Job) coroutineContext.get(Job.Key);
        if (job == null || !job.isCancelled()) {
            return false;
        }
        return m45826a(th, (Throwable) job.getCancellationException());
    }

    /* renamed from: a */
    public static final <T> Flow<T> m45821a(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return new FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1(flow, function3);
    }

    /* renamed from: a */
    public static final <T> Flow<T> m45822a(Flow<? extends T> flow, Function4<? super FlowCollector<? super T>, ? super Throwable, ? super Long, ? super Continuation<? super Boolean>, ? extends Object> function4) {
        return new FlowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$1(flow, function4);
    }

    /* renamed from: a */
    private static final boolean m45826a(Throwable th, Throwable th2) {
        if (th2 != null) {
