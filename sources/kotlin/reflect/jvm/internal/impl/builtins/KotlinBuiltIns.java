...
public abstract class KotlinBuiltIns {
    ...
    /* renamed from: a */
    static final /* synthetic */ boolean f60087a = (!KotlinBuiltIns.class.desiredAssertionStatus());
    /* access modifiers changed from: private */

    /* renamed from: b */
    public ModuleDescriptorImpl f60088b;

    /* renamed from: c */
    private NotNullLazyValue<ModuleDescriptorImpl> f60089c;

    /* renamed from: d */
    private final NotNullLazyValue<Primitives> f60090d;

    /* renamed from: e */
    private final NotNullLazyValue<Collection<PackageViewDescriptor>> f60091e;

    /* renamed from: f */
    private final MemoizedFunctionToNotNull<Name, ClassDescriptor> f60092f;

    /* renamed from: g */
    private final StorageManager f60093g;

    /* renamed from: a */
    private static /* synthetic */ void m44482a(int i) {
        String str;
        int i2;
        Throwable th;
        switch (i) {
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.f60093g = storageManager;
        this.f60091e = storageManager.createLazyValue(new Function0<Collection<PackageViewDescriptor>>() {
        ...
        this.f60090d = storageManager.createLazyValue(new Function0<Primitives>() {
            public Primitives invoke() {
                EnumMap enumMap = new EnumMap(PrimitiveType.class);
                HashMap hashMap = new HashMap();
                HashMap hashMap2 = new HashMap();
                for (PrimitiveType primitiveType : PrimitiveType.values()) {
                    SimpleType a = KotlinBuiltIns.this.m44485b(primitiveType.getTypeName().asString());
                    SimpleType a2 = KotlinBuiltIns.this.m44485b(primitiveType.getArrayTypeName().asString());
        ...
        this.f60092f = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() {
    ...
    public void createBuiltInsModule(boolean z) {
        ModuleDescriptorImpl moduleDescriptorImpl = new ModuleDescriptorImpl(BUILTINS_MODULE_NAME, this.f60093g, this, (TargetPlatform) null);
        this.f60088b = moduleDescriptorImpl;
        moduleDescriptorImpl.initialize(BuiltInsLoader.Companion.getInstance().createPackageFragmentProvider(this.f60093g, this.f60088b, getClassDescriptorFactories(), getPlatformDependentDeclarationFilter(), getAdditionalClassPartsProvider(), z));
        ModuleDescriptorImpl moduleDescriptorImpl2 = this.f60088b;
    ...
    public void setBuiltInsModule(final ModuleDescriptorImpl moduleDescriptorImpl) {
        ...
        this.f60093g.compute(new Function0<Void>() {
            public Void invoke() {
                if (KotlinBuiltIns.this.f60088b == null) {
                    ModuleDescriptorImpl unused = KotlinBuiltIns.this.f60088b = moduleDescriptorImpl;
                    return null;
                }
                throw new AssertionError("Built-ins module is already set: " + KotlinBuiltIns.this.f60088b + " (attempting to reset to " + moduleDescriptorImpl + ")");
            }
        });
    }
    ...
    public Iterable<ClassDescriptorFactory> getClassDescriptorFactories() {
        List singletonList = Collections.singletonList(new BuiltInFictitiousFunctionClassFactory(this.f60093g, getBuiltInsModule()));
    ...
    public StorageManager getStorageManager() {
        StorageManager storageManager = this.f60093g;
        if (storageManager == null) {
            m44482a(6);
        }
    ...
    public ModuleDescriptorImpl getBuiltInsModule() {
        if (!f60087a && this.f60088b == null && this.f60089c == null) {
            throw new AssertionError("Uninitialized built-ins module");
        }
        if (this.f60088b == null) {
            this.f60088b = (ModuleDescriptorImpl) this.f60089c.invoke();
        }
        ModuleDescriptorImpl moduleDescriptorImpl = this.f60088b;
        if (moduleDescriptorImpl == null) {
            m44482a(7);
        }
    ...
    public ClassDescriptor getBuiltInClassByFqName(FqName fqName) {
        ...
        if (f60087a || resolveClassByFqName != null) {
    ...
    /* renamed from: a */
    private ClassDescriptor m44476a(String str) {
        if (str == null) {
            m44482a(14);
        }
        ClassDescriptor invoke = this.f60092f.invoke(Name.identifier(str));
        if (invoke == null) {
            m44482a(15);
        }
        return invoke;
    ...
    public ClassDescriptor getNothing() {
        return m44476a("Nothing");
    }

    /* renamed from: a */
    private ClassDescriptor m44477a(PrimitiveType primitiveType) {
        if (primitiveType == null) {
            m44482a(16);
        }
        return m44476a(primitiveType.getTypeName().asString());
    }

    public ClassDescriptor getArray() {
        return m44476a("Array");
    }

    public ClassDescriptor getNumber() {
        return m44476a("Number");
    }
    ...
    public ClassDescriptor getFunction(int i) {
        return m44476a(StandardNames.getFunctionName(i));
    }
    ...
    public ClassDescriptor getString() {
        return m44476a("String");
    }

    public ClassDescriptor getComparable() {
        return m44476a("Comparable");
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public SimpleType m44485b(String str) {
        if (str == null) {
            m44482a(46);
        }
        SimpleType defaultType = m44476a(str).getDefaultType();
        if (defaultType == null) {
            m44482a(47);
        }
        return defaultType;
    ...
    public SimpleType getPrimitiveKotlinType(PrimitiveType primitiveType) {
        ...
        SimpleType defaultType = m44477a(primitiveType).getDefaultType();
        if (defaultType == null) {
            m44482a(54);
        }
        return defaultType;
    ...
    public KotlinType getArrayElementType(KotlinType kotlinType) {
        ...
        if (!isArray(kotlinType)) {
            ...
            KotlinType kotlinType2 = ((Primitives) this.f60090d.invoke()).kotlinArrayTypeToPrimitiveKotlinType.get(makeNotNullable);
            if (kotlinType2 != null) {
                if (kotlinType2 == null) {
                    m44482a(69);
                }
            ...
            if (containingModuleOrNull == null || (a = m44480a(makeNotNullable, containingModuleOrNull)) == null) {
    ...
    /* renamed from: a */
    private static KotlinType m44480a(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ClassId classId;
    ...
    public SimpleType getPrimitiveArrayKotlinType(PrimitiveType primitiveType) {
        ...
        SimpleType simpleType = ((Primitives) this.f60090d.invoke()).primitiveTypeToArrayKotlinType.get(primitiveType);
        if (simpleType == null) {
            m44482a(74);
        }
        return simpleType;
    ...
    public static boolean isArray(KotlinType kotlinType) {
        ...
        return m44484a(kotlinType, StandardNames.FqNames.array);
    }
    ...
    public static boolean isArrayOrPrimitiveArray(ClassDescriptor classDescriptor) {
        ...
        return m44483a((ClassifierDescriptor) classDescriptor, StandardNames.FqNames.array) || getPrimitiveArrayType(classDescriptor) != null;
    }
    ...
    /* renamed from: a */
    private static boolean m44484a(KotlinType kotlinType, FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            m44482a(97);
        }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (declarationDescriptor instanceof ClassDescriptor) && m44483a(declarationDescriptor, fqNameUnsafe);
    }

    /* renamed from: a */
    private static boolean m44483a(ClassifierDescriptor classifierDescriptor, FqNameUnsafe fqNameUnsafe) {
    ...
    /* renamed from: b */
    private static boolean m44486b(KotlinType kotlinType, FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            m44482a(105);
        }
        if (fqNameUnsafe == null) {
        ...
        return !kotlinType.isMarkedNullable() && m44484a(kotlinType, fqNameUnsafe);
    }
    ...
    public static boolean isSpecialClassWithNoSupertypes(ClassDescriptor classDescriptor) {
        ...
        return m44483a((ClassifierDescriptor) classDescriptor, StandardNames.FqNames.any) || m44483a((ClassifierDescriptor) classDescriptor, StandardNames.FqNames.nothing);
    }
    ...
    public static boolean isAny(ClassDescriptor classDescriptor) {
        ...
        return m44483a((ClassifierDescriptor) classDescriptor, StandardNames.FqNames.any);
    }
    ...
    public static boolean isUByteArray(KotlinType kotlinType) {
        ...
        return m44487c(kotlinType, StandardNames.FqNames.uByteArrayFqName.toUnsafe());
    }
    ...
    public static boolean isUShortArray(KotlinType kotlinType) {
        ...
        return m44487c(kotlinType, StandardNames.FqNames.uShortArrayFqName.toUnsafe());
    }
    ...
    public static boolean isUIntArray(KotlinType kotlinType) {
        ...
        return m44487c(kotlinType, StandardNames.FqNames.uIntArrayFqName.toUnsafe());
    }
    ...
    public static boolean isULongArray(KotlinType kotlinType) {
        ...
        return m44487c(kotlinType, StandardNames.FqNames.uLongArrayFqName.toUnsafe());
    }
    ...
    /* renamed from: c */
    private static boolean m44487c(KotlinType kotlinType, FqNameUnsafe fqNameUnsafe) {
        if (kotlinType == null) {
            m44482a(134);
        }
        if (fqNameUnsafe == null) {
        ...
        return m44484a(kotlinType, fqNameUnsafe) && !kotlinType.isMarkedNullable();
    }
    ...
    public static boolean isNothingOrNullableNothing(KotlinType kotlinType) {
        ...
        return m44484a(kotlinType, StandardNames.FqNames.nothing);
    }
    ...
    public static boolean isAnyOrNullableAny(KotlinType kotlinType) {
        ...
        return m44484a(kotlinType, StandardNames.FqNames.any);
    }
    ...
    public static boolean isUnit(KotlinType kotlinType) {
        ...
        return m44486b(kotlinType, StandardNames.FqNames.unit);
    }

    public static boolean isString(KotlinType kotlinType) {
        return kotlinType != null && m44486b(kotlinType, StandardNames.FqNames.string);
    }
    ...
    public static boolean isKClass(ClassDescriptor classDescriptor) {
        ...
        return m44483a((ClassifierDescriptor) classDescriptor, StandardNames.FqNames.kClass);
    }
