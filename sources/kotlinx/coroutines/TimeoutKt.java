...
public final class TimeoutKt {
    public static final <T> Object withTimeout(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        if (j > 0) {
            Object a = m45523a(new C21824af(j, continuation), function2);
    ...
    public static final <T> Object m48240withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m48239toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super T> r10) {
        ...
        L_0x0049:
            ...
            java.lang.Object r7 = m45523a(r4, r9)     // Catch:{ TimeoutCancellationException -> 0x0074 }
    ...
    public static final <T> Object m48241withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m48239toDelayMillisLRDsOJo(j), function2, continuation);
    }

    /* renamed from: a */
    private static final <U, T extends U> Object m45523a(C21824af<U, ? super T> afVar, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        JobKt.disposeOnCompletion(afVar, DelayKt.getDelay(afVar.uCont.getContext()).invokeOnTimeout(afVar.f61367a, afVar, afVar.getContext()));
