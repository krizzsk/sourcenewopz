...
public class Approximator {
    public float[] reduceWithDouglasPeucker(float[] fArr, float f) {
        ...
        return mo132104a(reduceWithDouglasPeucker, Arrays.copyOfRange(reduceWithDouglasPeucker2, 2, reduceWithDouglasPeucker2.length));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public float[] mo132104a(float[]... fArr) {
        int i = 0;
    ...
    private class Line {
        ...
        /* renamed from: dx */
        private float f52406dx;

        /* renamed from: dy */
        private float f52407dy;
        private float exsy;
        ...
        public float distance(float f, float f2) {
            return Math.abs((((this.f52407dy * f) - (this.f52406dx * f2)) + this.sxey) - this.exsy) / this.length;
        }
