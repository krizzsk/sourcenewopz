...
public final class ObservableSwitchMap<T, R> extends C21211a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<? extends R>> f58952a;

    /* renamed from: b */
    final int f58953b;

    /* renamed from: c */
    final boolean f58954c;
    ...
    public void subscribeActual(Observer<? super R> observer) {
        if (!ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f58952a)) {
            this.source.subscribe(new SwitchMapObserver(observer, this.f58952a, this.f58953b, this.f58954c));
        }
    }
    ...
    static final class SwitchMapObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void drain() {
            ...
            L_0x0052:
                java.lang.Object r5 = r1.get()
                io.reactivex.internal.operators.observable.ObservableSwitchMap$SwitchMapInnerObserver r5 = (p242io.reactivex.internal.operators.observable.ObservableSwitchMap.SwitchMapInnerObserver) r5
            ...
            L_0x00e9:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableSwitchMap.SwitchMapObserver.drain():void");
        }
