...
final class zzeu extends BroadcastReceiver {
    ...
    public final void zza() {
        ...
        if (!this.zzc) {
            try {
                this.zzb.zzax().registerReceiver(this, new IntentFilter(NetWorkStateReceiver.ANDROID_NET_CHANGE_ACTION));
            } catch (Exception e) {
        ...
        if (this.zzc) {
            ...
            try {
                ...
                try {
                    ...
                    this.zzb.zzau().zzb().zzb("Failed to unregister the network broadcast receiver", e2);
                }
            }
        }
    }
