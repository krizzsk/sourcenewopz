...
public class WebTitleBar extends CommonTitleBar {
    ...
    /* renamed from: a */
    private RelativeLayout f30047a;

    /* renamed from: a */
    private void m21039a(Context context) {
    }
    ...
    public WebTitleBar(Context context, AttributeSet attributeSet) {
        ...
        this.f30047a = (RelativeLayout) findViewById(R.id.title_bar_layout_above);
    }
    ...
    public void updateTitleBar(String str, String str2, int i, int i2) {
        if (!TextUtils.isEmpty(str)) {
            this.f30047a.setBackground(new ColorDrawable(Color.parseColor(str)));
        ...
        m21040a(this.mLeftImg1, i);
        m21040a(this.mLeftImg, i);
        m21040a(this.mMoreIv, i);
    }

    /* renamed from: a */
    private void m21040a(ImageView imageView, int i) {
        Drawable drawable;
        try {
