...
public class ContextFactory {
    ...
    public static ContextFactory f61856global = new ContextFactory();
            ...
            if (!hasCustomGlobal) {
                ...
                r1 = new GlobalSetter() {
                    public void setContextFactoryGlobal(ContextFactory contextFactory) {
                        ...
                        ContextFactory unused = ContextFactory.f61856global = contextFactory;
                    }

                    public ContextFactory getContextFactoryGlobal() {
                        return ContextFactory.f61856global;
                    }
                };
            } else {
                throw new IllegalStateException();
