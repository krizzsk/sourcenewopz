...
import org.bouncycastle.asn1.p075x9.X9IntegerConverter;
...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public static class C2695DH extends KeyAgreementSpi {
        public C2695DH() {
    ...
    private void initFromKey(java.security.Key r6, java.security.spec.AlgorithmParameterSpec r7) throws java.security.InvalidKeyException, java.security.InvalidAlgorithmParameterException {
        ...
        L_0x0039:
            ...
            org.bouncycastle.crypto.params.AsymmetricKeyParameter r6 = org.bouncycastle.jcajce.provider.asymmetric.p080ec.ECUtils.generatePublicKeyParameter(r6)
            r4 = r6
        ...
        L_0x0063:
            ...
            java.security.PublicKey r1 = r7.getEphemeralPublicKey()
            org.bouncycastle.crypto.params.AsymmetricKeyParameter r1 = org.bouncycastle.jcajce.provider.asymmetric.p080ec.ECUtils.generatePublicKeyParameter(r1)
            r4 = r1
            org.bouncycastle.crypto.params.ECPublicKeyParameters r4 = (org.bouncycastle.crypto.params.ECPublicKeyParameters) r4
        L_0x0088:
            r5.mqvParameters = r7
        ...
        L_0x0146:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jcajce.provider.asymmetric.p080ec.KeyAgreementSpi.initFromKey(java.security.Key, java.security.spec.AlgorithmParameterSpec):void");
    }
