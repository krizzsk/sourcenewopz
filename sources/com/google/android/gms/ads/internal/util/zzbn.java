...
public final class zzbn {
    ...
    public static org.json.JSONObject zza(android.content.Context r16, android.view.View r17) {
        ...
        L_0x005b:
            ...
            int r14 = r17.getMeasuredWidth()     // Catch:{ Exception -> 0x00dd }
            int r14 = zzd(r0, r14)     // Catch:{ Exception -> 0x00dd }
        ...
        L_0x00b6:
            ...
            int r6 = zzd(r0, r6)     // Catch:{ Exception -> 0x00dd }
            r9.put(r5, r6)     // Catch:{ Exception -> 0x00dd }
            r5 = r12[r10]     // Catch:{ Exception -> 0x00dd }
            int r0 = zzd(r0, r5)     // Catch:{ Exception -> 0x00dd }
        ...
        L_0x00e2:
            com.google.android.gms.internal.ads.zzabf<java.lang.Boolean> r0 = com.google.android.gms.internal.ads.zzabq.zzcyv
        ...
        if (!(map == null || view == null)) {
            ...
            while (it.hasNext()) {
                ...
                if (view2 != null) {
                    ...
                    try {
                        jSONObject4.put("width", zzd(context2, view2.getMeasuredWidth()));
                        jSONObject4.put("height", zzd(context2, view2.getMeasuredHeight()));
                        jSONObject4.put("x", zzd(context2, zzu2[0] - zzu[0]));
                        jSONObject4.put(SameLayerRenderingUtil.KEY_COMP_Y, zzd(context2, zzu2[1] - zzu[1]));
                        ...
                        if (view2.getLocalVisibleRect(rect)) {
                            ...
                            jSONObject.put("x", zzd(context2, zzu2[0] - zzu[0]));
                            jSONObject.put(SameLayerRenderingUtil.KEY_COMP_Y, zzd(context2, zzu2[1] - zzu[1]));
                            jSONObject.put(str4, str3);
                        }
                        jSONObject3.put("visible_bounds", jSONObject);
                        if (view2 instanceof TextView) {
                            TextView textView = (TextView) view2;
                            jSONObject3.put(BlocksConst.WIDGET_PARAMS_TEXT_COLOR, textView.getCurrentTextColor());
                            str2 = str3;
                            str = str4;
                            try {
    ...
    private static JSONObject zza(Context context, Point point, Point point2) {
        ...
        try {
            ...
            jSONObject.put(SameLayerRenderingUtil.KEY_COMP_Y, zzd(context, point2.y));
    ...
    public static boolean zza(Context context, zzdot zzdot) {
        if (!zzdot.zzhmp) {
            return false;
        }
        ...
        if (!str.isEmpty() && context != null) {
            ...
            for (String equals : zzdyh.zza(zzdxr.zzb(';')).zza((CharSequence) str)) {
    ...
    private static JSONObject zza(Context context, Rect rect) throws JSONException {
        ...
        jSONObject.put(SameLayerRenderingUtil.KEY_COMP_Y, zzd(context, rect.top));
