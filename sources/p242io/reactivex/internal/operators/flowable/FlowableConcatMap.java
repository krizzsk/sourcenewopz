...
public final class FlowableConcatMap<T, R> extends C21208a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends Publisher<? extends R>> f58230a;

    /* renamed from: b */
    final int f58231b;

    /* renamed from: c */
    final ErrorMode f58232c;
    ...
    public FlowableConcatMap(Flowable<T> flowable, Function<? super T, ? extends Publisher<? extends R>> function, int i, ErrorMode errorMode) {
        super(flowable);
        this.f58230a = function;
        this.f58231b = i;
        this.f58232c = errorMode;
    }
    ...
    static /* synthetic */ class C212051 {
        ...
        static {
            /*
                io.reactivex.internal.util.ErrorMode[] r0 = p242io.reactivex.internal.util.ErrorMode.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$io$reactivex$internal$util$ErrorMode = r0
                io.reactivex.internal.util.ErrorMode r1 = p242io.reactivex.internal.util.ErrorMode.BOUNDARY     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$reactivex$internal$util$ErrorMode     // Catch:{ NoSuchFieldError -> 0x001d }
                io.reactivex.internal.util.ErrorMode r1 = p242io.reactivex.internal.util.ErrorMode.END     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.flowable.FlowableConcatMap.C212051.<clinit>():void");
        }
    }
    ...
    public static <T, R> Subscriber<T> subscribe(Subscriber<? super R> subscriber, Function<? super T, ? extends Publisher<? extends R>> function, int i, ErrorMode errorMode) {
        int i2 = C212051.$SwitchMap$io$reactivex$internal$util$ErrorMode[errorMode.ordinal()];
        if (i2 == 1) {
    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        if (!FlowableScalarXMap.tryScalarXMapSubscribe(this.source, subscriber, this.f58230a)) {
            this.source.subscribe(subscribe(subscriber, this.f58230a, this.f58231b, this.f58232c));
        }
    }
