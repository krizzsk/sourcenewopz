...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        /* renamed from: to */
        List<String> f52071to;

        private Result(Bundle bundle) {
            this.requestId = bundle.getString("request");
            this.f52071to = new ArrayList();
            while (true) {
                if (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, new Object[]{Integer.valueOf(this.f52071to.size())}))) {
                    List<String> list = this.f52071to;
