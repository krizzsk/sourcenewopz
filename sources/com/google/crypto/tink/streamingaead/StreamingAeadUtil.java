...
class StreamingAeadUtil {
    ...
    static /* synthetic */ class C193951 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.streamingaead.StreamingAeadUtil.C193951.<clinit>():void");
        }
    }

    public static String toHmacAlgo(HashType hashType) throws NoSuchAlgorithmException {
        int i = C193951.$SwitchMap$com$google$crypto$tink$proto$HashType[hashType.ordinal()];
        if (i == 1) {
            return "HmacSha1";
        }
        if (i == 2) {
