...
public final class ObservableAmb<T> extends Observable<T> {
    ...
    /* renamed from: a */
    final ObservableSource<? extends T>[] f58711a;

    /* renamed from: b */
    final Iterable<? extends ObservableSource<? extends T>> f58712b;

    public ObservableAmb(ObservableSource<? extends T>[] observableSourceArr, Iterable<? extends ObservableSource<? extends T>> iterable) {
        this.f58711a = observableSourceArr;
        this.f58712b = iterable;
    }

    public void subscribeActual(Observer<? super T> observer) {
        int i;
        ObservableSource<? extends T>[] observableSourceArr = this.f58711a;
        if (observableSourceArr == null) {
            observableSourceArr = new Observable[8];
            try {
                i = 0;
                for (ObservableSource<? extends T> observableSource : this.f58712b) {
