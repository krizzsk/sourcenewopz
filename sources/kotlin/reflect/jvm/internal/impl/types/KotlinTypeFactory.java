...
public final class KotlinTypeFactory {
    ...
    /* renamed from: a */
    private static final Function1<KotlinTypeRefiner, SimpleType> f61118a = KotlinTypeFactory$EMPTY_REFINED_TYPE_FACTORY$1.INSTANCE;

    private KotlinTypeFactory() {
    }

    /* renamed from: a */
    private final MemberScope m45036a(TypeConstructor typeConstructor, List<? extends TypeProjection> list, KotlinTypeRefiner kotlinTypeRefiner) {
    ...
    public static final SimpleType simpleType(Annotations annotations, TypeConstructor typeConstructor, List<? extends TypeProjection> list, boolean z, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (!annotations.isEmpty() || !list.isEmpty() || z || typeConstructor.getDeclarationDescriptor() == null) {
            return simpleTypeWithNonTrivialMemberScope(annotations, typeConstructor, list, z, INSTANCE.m45036a(typeConstructor, list, kotlinTypeRefiner), new KotlinTypeFactory$simpleType$1(typeConstructor, list, annotations, z));
        }
        ClassifierDescriptor declarationDescriptor = typeConstructor.getDeclarationDescriptor();
    ...
    /* renamed from: a */
    public final ExpandedTypeOrRefinedConstructor m45037a(TypeConstructor typeConstructor, KotlinTypeRefiner kotlinTypeRefiner, List<? extends TypeProjection> list) {
    ...
    public static final SimpleType simpleTypeWithNonTrivialMemberScope(Annotations annotations, TypeConstructor typeConstructor, List<? extends TypeProjection> list, boolean z, MemberScope memberScope) {
        ...
        C21765d dVar = new C21765d(typeConstructor2, list2, z, memberScope, new KotlinTypeFactory$simpleTypeWithNonTrivialMemberScope$1(typeConstructor2, list2, annotations, z, memberScope));
        if (annotations.isEmpty()) {
            return dVar;
        }
        return new C21755a(dVar, annotations);
    }
    ...
    public static final SimpleType simpleTypeWithNonTrivialMemberScope(Annotations annotations, TypeConstructor typeConstructor, List<? extends TypeProjection> list, boolean z, MemberScope memberScope, Function1<? super KotlinTypeRefiner, ? extends SimpleType> function1) {
        ...
        C21765d dVar = new C21765d(typeConstructor, list, z, memberScope, function1);
        if (annotations.isEmpty()) {
            return dVar;
        }
        return new C21755a(dVar, annotations);
