...
import org.bouncycastle.math.p082ec.WTauNafMultiplier;
...
public class SecT571K1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT571K1Curve() {
        super(571, 2, 5, 10);
        this.f6292a = fromBigInteger(BigInteger.valueOf(0));
        this.f6293b = fromBigInteger(BigInteger.valueOf(1));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawXCoord()).f6390x, 0, jArr, i3);
            int i5 = i3 + 9;
            Nat576.copy64(((SecT571FieldElement) eCPoint.getRawYCoord()).f6390x, 0, jArr, i5);
            i3 = i5 + 9;
        }
