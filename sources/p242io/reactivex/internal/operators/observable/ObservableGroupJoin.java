...
public final class ObservableGroupJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends C21211a<TLeft, R> {

    /* renamed from: a */
    final ObservableSource<? extends TRight> f58843a;

    /* renamed from: b */
    final Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> f58844b;

    /* renamed from: c */
    final Function<? super TRight, ? extends ObservableSource<TRightEnd>> f58845c;

    /* renamed from: d */
    final BiFunction<? super TLeft, ? super Observable<TRight>, ? extends R> f58846d;
    ...
    public ObservableGroupJoin(ObservableSource<TLeft> observableSource, ObservableSource<? extends TRight> observableSource2, Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> function, Function<? super TRight, ? extends ObservableSource<TRightEnd>> function2, BiFunction<? super TLeft, ? super Observable<TRight>, ? extends R> biFunction) {
        ...
        this.f58843a = observableSource2;
        this.f58844b = function;
        this.f58845c = function2;
        this.f58846d = biFunction;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        GroupJoinDisposable groupJoinDisposable = new GroupJoinDisposable(observer, this.f58844b, this.f58845c, this.f58846d);
        ...
        this.f58843a.subscribe(leftRightObserver2);
    }
