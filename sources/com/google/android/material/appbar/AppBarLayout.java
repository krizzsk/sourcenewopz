...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = 2132018196;
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C10448R.styleable.AppBarLayout, i, DEF_STYLE_RES, new int[0]);
    ...
    public int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? R.attr.state_liftable : -2130970914;
        iArr[1] = (!this.liftable || !this.lifted) ? -2130970915 : R.attr.state_lifted;
        iArr[2] = this.liftable ? R.attr.state_collapsible : -2130970912;
        iArr[3] = (!this.liftable || !this.lifted) ? -2130970911 : R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C10448R.styleable.AppBarLayout_Layout);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C10448R.styleable.ScrollingViewBehavior_Layout);
