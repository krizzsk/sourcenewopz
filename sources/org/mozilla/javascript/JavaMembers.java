...
class JavaMembers {
    ...
    private Constructor<?>[] getAccessibleConstructors(boolean z) {
        if (z && this.f6597cl != ScriptRuntime.ClassClass) {
            try {
                Constructor<?>[] declaredConstructors = this.f6597cl.getDeclaredConstructors();
                AccessibleObject.setAccessible(declaredConstructors, true);
                return declaredConstructors;
            } catch (SecurityException unused) {
                Context.reportWarning("Could not access constructor  of class " + this.f6597cl.getName() + " due to lack of privileges.");
            }
        }
        return this.f6597cl.getConstructors();
    }
    ...
    private Field[] getAccessibleFields(boolean z, boolean z2) {
        if (z2 || z) {
            try {
                ...
                for (Class cls = this.f6597cl; cls != null; cls = cls.getSuperclass()) {
    ...
    public RuntimeException reportMemberNotFound(String str) {
        return Context.reportRuntimeError2("msg.java.member.not.found", this.f6597cl.getName(), str);
    }
}
