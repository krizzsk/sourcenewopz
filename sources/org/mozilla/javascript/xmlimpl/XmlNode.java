...
class XmlNode implements Serializable {
    ...
    public void removeNamespace(Namespace namespace) {
        if (!namespace.mo36542is(getNodeNamespace())) {
            NamedNodeMap attributes = this.dom.getAttributes();
            int i = 0;
            while (i < attributes.getLength()) {
                if (!namespace.mo36542is(createImpl(attributes.item(i)).getNodeNamespace())) {
                    i++;
                } else {
                    return;
                }
    ...
    static class Namespace implements Serializable {
        ...
        public boolean mo36542is(org.mozilla.javascript.xmlimpl.XmlNode.Namespace r3) {
            /*
                r2 = this;
            ...
            L_0x001b:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: org.mozilla.javascript.xmlimpl.XmlNode.Namespace.mo36542is(org.mozilla.javascript.xmlimpl.XmlNode$Namespace):boolean");
        }
