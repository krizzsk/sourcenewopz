...
public class Logging {
    ...
    public static void log(Severity severity, String str, String str2) {
        ...
        if (str == null || str2 == null) {
            ...
            int i = C29741.$SwitchMap$org$webrtc$Logging$Severity[severity.ordinal()];
            if (i == 1) {
                level = Level.SEVERE;
            } else if (i == 2) {
                level = Level.WARNING;
    ...
    static /* synthetic */ class C29741 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.webrtc.Logging.C29741.<clinit>():void");
        }
    }

    /* renamed from: d */
    public static void m3800d(String str, String str2) {
        log(Severity.LS_INFO, str, str2);
    }

    /* renamed from: e */
    public static void m3801e(String str, String str2) {
        log(Severity.LS_ERROR, str, str2);
    }

    /* renamed from: w */
    public static void m3804w(String str, String str2) {
        log(Severity.LS_WARNING, str, str2);
    }

    /* renamed from: e */
    public static void m3802e(String str, String str2, Throwable th) {
        log(Severity.LS_ERROR, str, str2);
    ...
    /* renamed from: w */
    public static void m3805w(String str, String str2, Throwable th) {
        log(Severity.LS_WARNING, str, str2);
    ...
    /* renamed from: v */
    public static void m3803v(String str, String str2) {
