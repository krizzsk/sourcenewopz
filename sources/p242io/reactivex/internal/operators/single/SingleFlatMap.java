...
public final class SingleFlatMap<T, R> extends Single<R> {
    ...
    /* renamed from: a */
    final SingleSource<? extends T> f59132a;

    /* renamed from: b */
    final Function<? super T, ? extends SingleSource<? extends R>> f59133b;

    public SingleFlatMap(SingleSource<? extends T> singleSource, Function<? super T, ? extends SingleSource<? extends R>> function) {
        this.f59133b = function;
        this.f59132a = singleSource;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(SingleObserver<? super R> singleObserver) {
        this.f59132a.subscribe(new SingleFlatMapCallback(singleObserver, this.f59133b));
    }
