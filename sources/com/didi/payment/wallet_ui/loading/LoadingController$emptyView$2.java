...
final class LoadingController$emptyView$2 extends Lambda implements Function0<View> {
    ...
    public final View invoke() {
        if (this.this$0.f33011b.getEmptyLayoutId() == 0) {
            return this.this$0.f33011b.getEmptyLayoutView();
        }
        return View.inflate(this.this$0.f33010a.getContext(), this.this$0.f33011b.getEmptyLayoutId(), (ViewGroup) null);
    }
}
