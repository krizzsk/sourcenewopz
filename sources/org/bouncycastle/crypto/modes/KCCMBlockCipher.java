...
public class KCCMBlockCipher implements AEADBlockCipher {
    ...
    public KCCMBlockCipher(BlockCipher blockCipher, int i) {
        ...
        this.f6105G1 = new byte[blockCipher.getBlockSize()];
        this.buffer = new byte[blockCipher.getBlockSize()];
        this.f6106s = new byte[blockCipher.getBlockSize()];
    ...
    private void ProcessBlock(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        while (true) {
            ...
            byte[] bArr4 = this.f6106s;
            bArr4[i4] = (byte) (bArr4[i4] + bArr3[i4]);
            i4++;
        }
        this.engine.processBlock(this.f6106s, 0, this.buffer, 0);
    ...
    private void processAAD(byte[] bArr, int i, int i2, int i3) {
        if (i2 - i < this.engine.getBlockSize()) {
            ...
            System.arraycopy(bArr2, 0, this.f6105G1, 0, (bArr2.length - this.Nb_) - 1);
            intToBytes(i3, this.buffer, 0);
            System.arraycopy(this.buffer, 0, this.f6105G1, (this.nonce.length - this.Nb_) - 1, 4);
            byte[] bArr3 = this.f6105G1;
            bArr3[bArr3.length - 1] = getFlag(true, this.macSize);
            this.engine.processBlock(this.f6105G1, 0, this.macBlock, 0);
        ...
        if (bArr.length - i < i2) {
            ...
            if (this.forEncryption) {
                if (i2 % this.engine.getBlockSize() == 0) {
                    ...
                    this.engine.processBlock(this.nonce, 0, this.f6106s, 0);
                    int i5 = i2;
                    while (i5 > 0) {
    ...
    public void reset() {
        Arrays.fill(this.f6105G1, (byte) 0);
