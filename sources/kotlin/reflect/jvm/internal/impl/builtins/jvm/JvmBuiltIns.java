...
public final class JvmBuiltIns extends KotlinBuiltIns {
    ...
    /* renamed from: b */
    static final /* synthetic */ KProperty<Object>[] f60148b = {C21490Reflection.property1(new PropertyReference1Impl(C21490Reflection.getOrCreateKotlinClass(JvmBuiltIns.class), "customizer", "getCustomizer()Lorg/jetbrains/kotlin/builtins/jvm/JvmBuiltInsCustomizer;"))};

    /* renamed from: c */
    private final Kind f60149c;
    /* access modifiers changed from: private */

    /* renamed from: d */
    public Function0<Settings> f60150d;

    /* renamed from: e */
    private final NotNullLazyValue f60151e;
    ...
    public JvmBuiltIns(StorageManager storageManager, Kind kind) {
        ...
        this.f60149c = kind;
        this.f60151e = storageManager.createLazyValue(new JvmBuiltIns$customizer$2(this, storageManager));
        int i = WhenMappings.$EnumSwitchMapping$0[this.f60149c.ordinal()];
        if (i == 2) {
    ...
    public final void setPostponedSettingsComputation(Function0<Settings> function0) {
        ...
        boolean z = this.f60150d == null;
        if (!_Assertions.ENABLED || z) {
            this.f60150d = function0;
            return;
        }
    ...
    public final JvmBuiltInsCustomizer getCustomizer() {
        return (JvmBuiltInsCustomizer) StorageKt.getValue(this.f60151e, (Object) this, (KProperty<?>) f60148b[0]);
    }
