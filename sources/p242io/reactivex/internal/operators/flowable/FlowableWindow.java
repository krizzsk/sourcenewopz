...
public final class FlowableWindow<T> extends C21208a<T, Flowable<T>> {
    ...
    public void subscribeActual(Subscriber<? super Flowable<T>> subscriber) {
        long j = this.f58511b;
        long j2 = this.f58510a;
        if (j == j2) {
            this.source.subscribe(new WindowExactSubscriber(subscriber, this.f58510a, this.f58512c));
        } else if (j > j2) {
            this.source.subscribe(new WindowSkipSubscriber(subscriber, this.f58510a, this.f58511b, this.f58512c));
        } else {
            this.source.subscribe(new WindowOverlapSubscriber(subscriber, this.f58510a, this.f58511b, this.f58512c));
        }
    }
