...
public class ChanceRecord extends Record {
    ...
    public void addScreenshot(android.graphics.Bitmap r4) {
        /*
            ...
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m34424w(r4)     // Catch:{ all -> 0x0024 }
        ...
        L_0x0025:
            ...
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m34424w(r4)     // Catch:{ all -> 0x0030 }
    ...
    public void imageDeepCompress() {
        try {
                ...
                for (byte[] bArr : list) {
                    ...
                    if (decodeByteArray != null) {
                        ...
                        if (!createBitmap.compress(Bitmap.CompressFormat.JPEG, MASConfig.PIC_COMPRESS_QUALITY, byteArrayOutputStream)) {
                            OLog.m34424w("addScreenshot(): Bitmap compress fail! when deep compressed");
                            return;
                        }
            ...
            OLog.m34425w("imageDeepCompress fail!", th);
        }
    }
