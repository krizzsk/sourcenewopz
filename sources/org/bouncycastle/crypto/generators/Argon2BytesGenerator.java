...
public class Argon2BytesGenerator {
    ...
    private static class Block {
        ...
        private Block() {
            this.f6025v = new long[128];
        }

        /* access modifiers changed from: private */
        public void copyBlock(Block block) {
            System.arraycopy(block.f6025v, 0, this.f6025v, 0, 128);
        }

        /* access modifiers changed from: private */
        public void xor(Block block, Block block2) {
            long[] jArr = this.f6025v;
            long[] jArr2 = block.f6025v;
            long[] jArr3 = block2.f6025v;
            for (int i = 0; i < 128; i++) {
        ...
        public void fromBytes(byte[] bArr) {
            if (bArr.length >= 1024) {
                Pack.littleEndianToLong(bArr, 0, this.f6025v);
                return;
            }
        ...
        public void toBytes(byte[] bArr) {
            if (bArr.length >= 1024) {
                Pack.longToLittleEndian(this.f6025v, bArr, 0);
                return;
            }
    ...
    private static class FillBlock {
        ...
        private FillBlock() {
            this.f6026R = new Block();
            this.f6027Z = new Block();
        ...
        private void applyBlake() {
            for (int i = 0; i < 8; i++) {
                int i2 = i * 16;
                Argon2BytesGenerator.roundFunction(this.f6027Z, i2, i2 + 1, i2 + 2, i2 + 3, i2 + 4, i2 + 5, i2 + 6, i2 + 7, i2 + 8, i2 + 9, i2 + 10, i2 + 11, i2 + 12, i2 + 13, i2 + 14, i2 + 15);
            }
            for (int i3 = 0; i3 < 8; i3++) {
                int i4 = i3 * 2;
                Argon2BytesGenerator.roundFunction(this.f6027Z, i4, i4 + 1, i4 + 16, i4 + 17, i4 + 32, i4 + 33, i4 + 48, i4 + 49, i4 + 64, i4 + 65, i4 + 80, i4 + 81, i4 + 96, i4 + 97, i4 + 112, i4 + 113);
            }
        }

        /* access modifiers changed from: private */
        public void fillBlock(Block block, Block block2) {
            this.f6027Z.copyBlock(block);
            applyBlake();
            block2.xor(block, this.f6027Z);
        }

        /* access modifiers changed from: private */
        public void fillBlock(Block block, Block block2, Block block3) {
            this.f6026R.xor(block, block2);
            this.f6027Z.copyBlock(this.f6026R);
            applyBlake();
            block3.xor(this.f6026R, this.f6027Z);
        }
        ...
        public void fillBlockWithXor(Block block, Block block2, Block block3) {
            ...
            this.f6027Z.copyBlock(this.f6026R);
            applyBlake();
            block3.xorWith(this.f6026R, this.f6027Z);
        }
    }
    ...
    /* renamed from: F */
    private static void m3725F(long[] jArr, int i, int i2, int i3, int i4) {
    ...
    private long getPseudoRandom(FillBlock fillBlock, int i, Block block, Block block2, int i2, boolean z) {
        if (!z) {
            return this.memory[i2].f6025v[0];
        }
        int i3 = i % 128;
        if (i3 == 0) {
            nextAddresses(fillBlock, block2, block);
        }
        return block.f6025v[i3];
    }
    ...
    private void initAddressBlocks(FillBlock fillBlock, Position position, Block block, Block block2) {
        block.f6025v[0] = intToLong(position.pass);
        block.f6025v[1] = intToLong(position.lane);
        block.f6025v[2] = intToLong(position.slice);
        block.f6025v[3] = intToLong(this.memory.length);
        block.f6025v[4] = intToLong(this.parameters.getIterations());
        block.f6025v[5] = intToLong(this.parameters.getType());
    ...
    public static void roundFunction(Block block, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        ...
        int i31 = i16;
        long[] access$400 = block.f6025v;
        m3725F(access$400, i17, i5, i24, i28);
        m3725F(access$400, i18, i21, i25, i29);
        m3725F(access$400, i19, i22, i26, i30);
        long[] jArr = access$400;
        int i32 = i4;
        m3725F(jArr, i32, i23, i27, i31);
        m3725F(jArr, i17, i21, i26, i31);
        m3725F(jArr, i18, i22, i27, i28);
        m3725F(jArr, i19, i23, i24, i29);
        m3725F(jArr, i32, i5, i25, i30);
    }
