...
public final class ObservableRetryBiPredicate<T> extends C21211a<T, T> {

    /* renamed from: a */
    final BiPredicate<? super Integer, ? super Throwable> f58913a;

    public ObservableRetryBiPredicate(Observable<T> observable, BiPredicate<? super Integer, ? super Throwable> biPredicate) {
        super(observable);
        this.f58913a = biPredicate;
    }

    public void subscribeActual(Observer<? super T> observer) {
        SequentialDisposable sequentialDisposable = new SequentialDisposable();
        observer.onSubscribe(sequentialDisposable);
        new RetryBiObserver(observer, this.f58913a, sequentialDisposable, this.source).subscribeNext();
    }
