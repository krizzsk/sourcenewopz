...
public class KGCMBlockCipher implements AEADBlockCipher {
    ...
    public KGCMBlockCipher(BlockCipher blockCipher) {
        ...
        this.f6109iv = new byte[blockSize2];
        this.multiplier = createDefaultMultiplier(blockSize2);
        this.f6108b = new long[(this.blockSize >>> 3)];
        this.macBlock = null;
    }
    ...
    private void calculateMac(byte[] bArr, int i, int i2, int i3) {
        int i4 = i + i2;
        while (i < i4) {
            xorWithInput(this.f6108b, bArr, i);
            this.multiplier.multiplyH(this.f6108b);
            i += this.blockSize;
        }
        long j = (InternalZipConstants.ZIP_64_SIZE_LIMIT & ((long) i2)) << 3;
        long[] jArr = this.f6108b;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            byte[] bArr = this.f6109iv;
            Arrays.fill(bArr, (byte) 0);
            System.arraycopy(nonce, 0, this.f6109iv, bArr.length - nonce.length, nonce.length);
            ...
            byte[] bArr3 = this.f6109iv;
            Arrays.fill(bArr3, (byte) 0);
            System.arraycopy(iv, 0, this.f6109iv, bArr3.length - iv.length, iv.length);
        ...
        this.ctrEngine.init(true, new ParametersWithIV(keyParameter, this.f6109iv));
