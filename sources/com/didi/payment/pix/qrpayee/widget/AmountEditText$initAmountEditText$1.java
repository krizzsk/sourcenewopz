...
@Metadata(mo175977d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\r\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\u0016J*\u0010\u0006\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\tH\u0016J*\u0010\f\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\r\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\tH\u0016¨\u0006\u000e"}, mo175978d2 = {"com/didi/payment/pix/qrpayee/widget/AmountEditText$initAmountEditText$1", "Landroid/text/TextWatcher;", "afterTextChanged", "", "s", "Landroid/text/Editable;", "beforeTextChanged", "", "start", "", "count", "after", "onTextChanged", "before", "wallet-service-pix_globalRelease"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
...
public final class AmountEditText$initAmountEditText$1 implements TextWatcher {
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if (TextUtils.isEmpty(charSequence)) {
            AmountEditText.IValueValidator access$getInnerWatcher$p = this.this$0.f31180a;
        ...
        if (StringsKt.startsWith$default(valueOf, "0", false, 2, (Object) null)) {
            String str = this.this$0.f31184e.decimalSeperatorBySys;
            Intrinsics.checkNotNullExpressionValue(str, "floatInputHelper.decimalSeperatorBySys");
            if (StringsKt.indexOf$default(charSequence, str, 0, false, 6, (Object) null) == -1) {
                AmountEditText.IValueValidator access$getInnerWatcher$p2 = this.this$0.f31180a;
        ...
        float parseFloatValue = amountEditText.f31184e.parseFloatValue(valueOf);
        if (parseFloatValue <= 0.0f) {
            AmountEditText.IValueValidator access$getInnerWatcher$p3 = amountEditText.f31180a;
        ...
        if (MathUtil.dollarToCent(parseFloatValue) > amountEditText.getConfig().getUserAvailableAmount()) {
            amountEditText.f31183d.setVisibility(0);
            amountEditText.f31182c.setTextColor(amountEditText.getResources().getColor(R.color.global_red));
            AmountEditText.IValueValidator access$getInnerWatcher$p4 = amountEditText.f31180a;
        ...
        amountEditText.f31182c.setTextColor(-16777216);
        AmountEditText.IValueValidator access$getInnerWatcher$p5 = amountEditText.f31180a;
