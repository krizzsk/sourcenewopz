...
public final class ObservableBuffer<T, U extends Collection<? super T>> extends C21211a<T, U> {
    ...
    /* renamed from: c */
    final Callable<U> f58722c;

    public ObservableBuffer(ObservableSource<T> observableSource, int i, int i2, Callable<U> callable) {
        super(observableSource);
        this.f58720a = i;
        this.f58721b = i2;
        this.f58722c = callable;
    }
    ...
    public void subscribeActual(Observer<? super U> observer) {
        ...
        int i2 = this.f58720a;
        if (i == i2) {
            BufferExactObserver bufferExactObserver = new BufferExactObserver(observer, i2, this.f58722c);
        ...
        this.source.subscribe(new BufferSkipObserver(observer, this.f58720a, this.f58721b, this.f58722c));
    }
