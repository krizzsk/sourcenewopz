...
public final class QRCodeWriter implements Writer {
    ...
    /* renamed from: a */
    private static final int f19014a = 4;
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) throws WriterException {
        if (str.isEmpty()) {
            ...
            return m14199a(Encoder.encode(str, errorCorrectionLevel, map), i, i2, i3);
        }
    }
    ...
    public BitMatrix encode(byte[] bArr, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) throws WriterException {
        if (bArr == null || bArr.length == 0) {
            ...
            return m14199a(Encoder.encode(bArr, errorCorrectionLevel, map), i, i2, i3);
        }
    }

    /* renamed from: a */
    private static BitMatrix m14199a(QRCode qRCode, int i, int i2, int i3) {
