...
@Metadata(mo175977d1 = {"\u00000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\u001a\"\u0010\n\u001a\u00020\u00012\n\u0010\u000b\u001a\u0006\u0012\u0002\b\u00030\f2\f\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u00070\u000eH\u0003\u001a\u0010\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0001H\u0002\u001a\u0016\u0010\u0012\u001a\u00020\u0001*\u00020\u00022\b\b\u0002\u0010\u0013\u001a\u00020\u0014H\u0003\"\u001e\u0010\u0000\u001a\u00020\u0001*\u00020\u00028FX\u0004¢\u0006\f\u0012\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006\"\u001e\u0010\u0000\u001a\u00020\u0001*\u00020\u00078BX\u0004¢\u0006\f\u0012\u0004\b\u0003\u0010\b\u001a\u0004\b\u0005\u0010\t¨\u0006\u0015"}, mo175978d2 = {"javaType", "Ljava/lang/reflect/Type;", "Lkotlin/reflect/KType;", "getJavaType$annotations", "(Lkotlin/reflect/KType;)V", "getJavaType", "(Lkotlin/reflect/KType;)Ljava/lang/reflect/Type;", "Lkotlin/reflect/KTypeProjection;", "(Lkotlin/reflect/KTypeProjection;)V", "(Lkotlin/reflect/KTypeProjection;)Ljava/lang/reflect/Type;", "createPossiblyInnerType", "jClass", "Ljava/lang/Class;", "arguments", "", "typeToString", "", "type", "computeJavaType", "forceWrapper", "", "kotlin-stdlib"}, mo175979k = 2, mo175980mv = {1, 5, 1})
...
public final class TypesJVMKt {
    ...
    /* renamed from: a */
    private static /* synthetic */ void m44419a(KTypeProjection kTypeProjection) {
    }
    ...
    public static final Type getJavaType(KType kType) {
        ...
        if (!(kType instanceof KTypeBase) || (javaType = ((KTypeBase) kType).getJavaType()) == null) {
            return m44418a(kType, false, 1, (Object) null);
        }
        return javaType;
    }

    /* renamed from: a */
    static /* synthetic */ Type m44418a(KType kType, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = false;
        }
        return m44417a(kType, z);
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public static final Type m44417a(KType kType, boolean z) {
        int i;
        KClassifier classifier = kType.getClassifier();
        if (classifier instanceof KTypeParameter) {
            return new C21519d((KTypeParameter) classifier);
        }
        if (classifier instanceof KClass) {
            ...
            if (!javaObjectType.isArray()) {
                return m44416a((Class<?>) javaObjectType, arguments);
            }
            ...
            if (kTypeProjection != null) {
                ...
                if (i == 2 || i == 3) {
                    ...
                    Type a = m44418a(component2, false, 1, (Object) null);
    ...
    /* renamed from: a */
    private static final Type m44416a(Class<?> cls, List<KTypeProjection> list) {
        Class<?> declaringClass = cls.getDeclaringClass();
        if (declaringClass == null) {
            Iterable<KTypeProjection> iterable = list;
            Collection arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(iterable, 10));
            for (KTypeProjection b : iterable) {
                arrayList.add(m44420b(b));
            }
            return new C21517b(cls, (Type) null, (List) arrayList);
        } else if (Modifier.isStatic(cls.getModifiers())) {
            Type type = declaringClass;
            Iterable<KTypeProjection> iterable2 = list;
            Collection arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(iterable2, 10));
            for (KTypeProjection b2 : iterable2) {
                arrayList2.add(m44420b(b2));
            }
            return new C21517b(cls, type, (List) arrayList2);
        } else {
            int length = cls.getTypeParameters().length;
            Type a = m44416a(declaringClass, list.subList(length, list.size()));
            ...
            for (KTypeProjection b3 : subList) {
                arrayList3.add(m44420b(b3));
            }
            return new C21517b(cls, a, (List) arrayList3);
        }
    }

    /* renamed from: b */
    private static final Type m44420b(KTypeProjection kTypeProjection) {
        KVariance variance = kTypeProjection.getVariance();
        if (variance == null) {
            return WildcardTypeImpl.f60010a.getSTAR();
        }
        KType type = kTypeProjection.getType();
        Intrinsics.checkNotNull(type);
        int i = WhenMappings.$EnumSwitchMapping$1[variance.ordinal()];
        if (i == 1) {
            return m44417a(type, true);
        }
        if (i == 2) {
            return new WildcardTypeImpl((Type) null, m44417a(type, true));
        }
        if (i == 3) {
            return new WildcardTypeImpl(m44417a(type, true), (Type) null);
        }
        throw new NoWhenBranchMatchedException();
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public static final String m44415a(Type type) {
        String str;
