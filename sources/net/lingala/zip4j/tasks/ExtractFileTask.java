...
import net.lingala.zip4j.p067io.inputstream.SplitInputStream;
...
public class ExtractFileTask extends AbstractExtractFileTask<ExtractFileTaskParameters> {
    ...
    /* renamed from: b */
    private SplitInputStream f5039b;
    ...
    public void executeTask(net.lingala.zip4j.tasks.ExtractFileTask.ExtractFileTaskParameters r11, net.lingala.zip4j.progress.ProgressMonitor r12) throws java.io.IOException {
        /*
            ...
            net.lingala.zip4j.io.inputstream.ZipInputStream r0 = r10.m3225a(r0, r1)     // Catch:{ all -> 0x005e }
            net.lingala.zip4j.model.FileHeader r1 = r11.fileHeader     // Catch:{ all -> 0x0050 }
            java.util.List r1 = r10.m3224a(r1)     // Catch:{ all -> 0x0050 }
        ...
        L_0x001e:
            ...
            java.lang.String r6 = r10.m3223a(r2, r3, r4)     // Catch:{ all -> 0x0050 }
        ...
        L_0x0048:
            net.lingala.zip4j.io.inputstream.SplitInputStream r11 = r10.f5039b
        ...
        L_0x005e:
            r11 = move-exception
            net.lingala.zip4j.io.inputstream.SplitInputStream r12 = r10.f5039b
    ...
    public long calculateTotalWork(ExtractFileTaskParameters extractFileTaskParameters) {
        return HeaderUtil.getTotalUncompressedSizeOfAllFileHeaders(m3224a(extractFileTaskParameters.fileHeader));
    }

    /* renamed from: a */
    private List<FileHeader> m3224a(FileHeader fileHeader) {
    ...
    /* renamed from: a */
    private ZipInputStream m3225a(FileHeader fileHeader, Zip4jConfig zip4jConfig) throws IOException {
        SplitInputStream createSplitInputStream = UnzipUtil.createSplitInputStream(getZipModel());
        this.f5039b = createSplitInputStream;
        createSplitInputStream.prepareExtractionForFileHeader(fileHeader);
        return new ZipInputStream((InputStream) this.f5039b, this.f5038a, zip4jConfig);
    }

    /* renamed from: a */
    private String m3223a(String str, FileHeader fileHeader, FileHeader fileHeader2) {
