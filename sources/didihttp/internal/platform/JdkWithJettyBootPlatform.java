...
class JdkWithJettyBootPlatform extends Platform {
    ...
    /* renamed from: b */
    private final Method f56880b;

    /* renamed from: c */
    private final Method f56881c;

    /* renamed from: d */
    private final Class<?> f56882d;

    /* renamed from: e */
    private final Class<?> f56883e;

    public JdkWithJettyBootPlatform(Method method, Method method2, Method method3, Class<?> cls, Class<?> cls2) {
        this.f56879a = method;
        this.f56880b = method2;
        this.f56881c = method3;
        this.f56882d = cls;
        this.f56883e = cls2;
    }
    ...
    public void configureTlsExtensions(SSLSocket sSLSocket, String str, List<Protocol> list) {
        ...
        try {
            Object newProxyInstance = Proxy.newProxyInstance(Platform.class.getClassLoader(), new Class[]{this.f56882d, this.f56883e}, new JettyNegoProvider(alpnProtocolNames));
            this.f56879a.invoke((Object) null, new Object[]{sSLSocket, newProxyInstance});
    ...
    public void afterHandshake(SSLSocket sSLSocket) {
        try {
            this.f56881c.invoke((Object) null, new Object[]{sSLSocket});
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        try {
            JettyNegoProvider jettyNegoProvider = (JettyNegoProvider) Proxy.getInvocationHandler(this.f56880b.invoke((Object) null, new Object[]{sSLSocket}));
    ...
    /* renamed from: a */
    public static Platform m40826a() {
        try {
    ...
    private static class JettyNegoProvider implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            ...
            if (objArr == null) {
                objArr = C20747Util.EMPTY_STRING_ARRAY;
            }
