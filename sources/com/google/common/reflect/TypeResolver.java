...
public final class TypeResolver {
    ...
    private static class TypeTable {
        ...
        TypeTable() {
            this.map = ImmutableMap.m38392of();
        }
    ...
    private static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f53668id;
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f53668id.incrementAndGet() + "-of ? extends " + Joiner.m38342on((char) Typography.amp).join((Object[]) typeArr), typeArr);
        }

        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this.f53668id) {
                /* access modifiers changed from: package-private */
                public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
