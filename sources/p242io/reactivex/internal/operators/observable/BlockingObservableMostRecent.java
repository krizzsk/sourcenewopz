...
import p242io.reactivex.observers.DefaultObserver;

/* renamed from: io.reactivex.internal.operators.observable.BlockingObservableMostRecent */
public final class BlockingObservableMostRecent<T> implements Iterable<T> {

    /* renamed from: a */
    final ObservableSource<T> f58705a;

    /* renamed from: b */
    final T f58706b;

    public BlockingObservableMostRecent(ObservableSource<T> observableSource, T t) {
        this.f58705a = observableSource;
        this.f58706b = t;
    }

    public Iterator<T> iterator() {
        MostRecentObserver mostRecentObserver = new MostRecentObserver(this.f58706b);
        this.f58705a.subscribe(mostRecentObserver);
