...
public class GF2Vector extends Vector {
    ...
    public GF2Vector(int i, SecureRandom secureRandom) {
        this.length = i;
        int i2 = (i + 31) >> 5;
        this.f6556v = new int[i2];
        int i3 = i2 - 1;
        for (int i4 = i3; i4 >= 0; i4--) {
            this.f6556v[i4] = secureRandom.nextInt();
        }
        int i5 = i & 31;
        if (i5 != 0) {
            int[] iArr = this.f6556v;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f6556v = IntUtils.clone(gF2Vector.f6556v);
    }
    ...
    public Vector add(Vector vector) {
        if (vector instanceof GF2Vector) {
            ...
            if (this.length == gF2Vector.length) {
                int[] clone = IntUtils.clone(gF2Vector.f6556v);
                for (int length = clone.length - 1; length >= 0; length--) {
                    clone[length] = clone[length] ^ this.f6556v[length];
                }
    ...
    public boolean equals(Object obj) {
        ...
        return this.length == gF2Vector.length && IntUtils.equals(this.f6556v, gF2Vector.f6556v);
    }
    ...
    public GF2Vector extractLeftVector(int i) {
        if (i > this.length) {
            ...
            int i2 = i >> 5;
            int i3 = i & 31;
            System.arraycopy(this.f6556v, 0, gF2Vector.f6556v, 0, i2);
            if (i3 != 0) {
                gF2Vector.f6556v[i2] = ((1 << i3) - 1) & this.f6556v[i2];
            }
            return gF2Vector;
        }
    }
        ...
        if (i > this.length) {
            ...
            if (i4 != 0) {
                while (true) {
                    ...
                    int[] iArr = gF2Vector.f6556v;
                    int[] iArr2 = this.f6556v;
                    int i7 = i3 + 1;
                    iArr[i6] = (iArr2[i3] >>> i4) | (iArr2[i7] << (32 - i4));
                    i6++;
                    i3 = i7;
                }
                int[] iArr3 = gF2Vector.f6556v;
                int[] iArr4 = this.f6556v;
                int i8 = i3 + 1;
                ...
                System.arraycopy(this.f6556v, i3, gF2Vector.f6556v, 0, i5);
            }
            return gF2Vector;
        }
    }
    ...
    public GF2Vector extractVector(int[] iArr) {
        ...
        if (iArr[length - 1] <= this.length) {
            ...
            for (int i = 0; i < length; i++) {
                if ((this.f6556v[iArr[i] >> 5] & (1 << (iArr[i] & 31))) != 0) {
                    int[] iArr2 = gF2Vector.f6556v;
                    int i2 = i >> 5;
    ...
    public int getBit(int i) {
        if (i < this.length) {
            int i2 = i >> 5;
            int i3 = i & 31;
            return (this.f6556v[i2] & (1 << i3)) >>> i3;
        }
        throw new IndexOutOfBoundsException();
    }

    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f6556v, (this.length + 7) >> 3);
    }
    ...
    public int hashCode() {
        return (this.length * 31) + Arrays.hashCode(this.f6556v);
    }

    public boolean isZero() {
        for (int length = this.f6556v.length - 1; length >= 0; length--) {
            if (this.f6556v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public Vector multiply(Permutation permutation) {
        ...
        if (this.length == vector.length) {
            ...
            for (int i = 0; i < vector.length; i++) {
                if ((this.f6556v[vector[i] >> 5] & (1 << (vector[i] & 31))) != 0) {
                    int[] iArr = gF2Vector.f6556v;
                    int i2 = i >> 5;
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.length; i++) {
            ...
            stringBuffer.append((this.f6556v[i >> 5] & (1 << (i & 31))) == 0 ? '0' : '1');
        }
