...
public class HeaderUtil {
    public static FileHeader getFileHeader(ZipModel zipModel, String str) throws ZipException {
        FileHeader a = m3100a(zipModel, str);
        if (a != null) {
            return a;
        }
        String replaceAll = str.replaceAll("\\\\", "/");
        FileHeader a2 = m3100a(zipModel, replaceAll);
        return a2 == null ? m3100a(zipModel, replaceAll.replaceAll("/", "\\\\")) : a2;
    }
    ...
    /* renamed from: a */
    private static FileHeader m3100a(ZipModel zipModel, String str) throws ZipException {
        if (zipModel == null) {
