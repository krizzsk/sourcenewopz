...
final class C7884h {
    ...
    /* renamed from: a */
    private static final float[][] f18953a;
    ...
    static {
        ...
        iArr[1] = 8;
        iArr[0] = length;
        f18953a = (float[][]) Array.newInstance(float.class, iArr);
    ...
    /* renamed from: a */
    static int m14156a(int[] iArr) {
        int c = m14158c(m14157b(iArr));
        if (c != -1) {
            return c;
        }
        return m14160e(iArr);
    ...
    /* renamed from: b */
    private static int[] m14157b(int[] iArr) {
    ...
    /* renamed from: c */
    private static int m14158c(int[] iArr) {
        int d = m14159d(iArr);
    ...
    /* renamed from: d */
    private static int m14159d(int[] iArr) {
        long j = 0;
    ...
    /* renamed from: e */
    private static int m14160e(int[] iArr) {
