...
public class TypeUtil {
    ...
    public static final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            while (true) {
                ...
                if (i < typeArr2.length) {
                    Object unused = TypeUtil.m15636c(typeArr2[i]);
                    TypeUtil.m15634b(this.mTypeArguments[i]);
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ParameterizedType) {
                ...
                return TypeUtil.m15632a(this.mRawType, parameterizedType.getRawType()) && TypeUtil.m15632a(this.mOwnerType, parameterizedType.getOwnerType()) && Arrays.equals(this.mTypeArguments, parameterizedType.getActualTypeArguments());
            }
        }

        public int hashCode() {
            return (Arrays.hashCode(this.mTypeArguments) ^ this.mRawType.hashCode()) ^ TypeUtil.m15637d(this.mOwnerType);
        }
    ...
    /* renamed from: a */
    static boolean m15632a(Object obj, Object obj2) {
        return obj == obj2 || (obj != null && obj.equals(obj2));
    }

    /* access modifiers changed from: private */
    /* renamed from: c */
    public static <T> T m15636c(T t) {
        if (t != null) {
            return t;
        }
        throw null;
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public static void m15634b(Type type) {
        m15635b(!(type instanceof Class) || !((Class) type).isPrimitive());
    }

    /* access modifiers changed from: private */
    /* renamed from: b */
    public static void m15635b(boolean z) {
        if (!z) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: d */
    public static int m15637d(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
