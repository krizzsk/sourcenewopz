...
public enum TriState {
    ...
    static /* synthetic */ class C175561 {
        ...
        static {
            ...
            L_0x0012:
                ...
                com.facebook.common.util.TriState r1 = com.facebook.common.util.TriState.f52059NO     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.common.util.TriState.C175561.<clinit>():void");
        }
    }

    public boolean asBoolean() {
        int i = C175561.$SwitchMap$com$facebook$common$util$TriState[ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
