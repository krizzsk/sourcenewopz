...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    public String[] getDeviceNames() {
        try {
            ...
            Logging.m3801e(TAG, "Camera access exception: " + e);
            return new String[0];
        }
    }
    ...
    static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager2, String str) {
        ...
        synchronized (cachedSupportedFormats) {
            ...
            Logging.m3800d(TAG, "Get supported formats for camera index " + str + ".");
            ...
            try {
                ...
                for (Size next : supportedSizes) {
                    ...
                    Logging.m3800d(TAG, "Format: " + next.width + "x" + next.height + "@" + i);
                }
                cachedSupportedFormats.put(str, arrayList);
                long elapsedRealtime2 = SystemClock.elapsedRealtime();
                Logging.m3800d(TAG, "Get supported formats for camera index " + str + " done. Time spent: " + (elapsedRealtime2 - elapsedRealtime) + " ms.");
                return arrayList;
            } catch (Exception e) {
                Logging.m3801e(TAG, "getCameraCharacteristics(): " + e);
