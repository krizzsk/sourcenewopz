...
public class ExifInterface {
    ...
    private static final ExifTag[] EXIF_POINTER_TAGS = {new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, C13565R2.styleable.yoga_yg_paddingAll, 4), new ExifTag(TAG_ORF_CAMERA_SETTINGS_IFD_POINTER, 8224, 1), new ExifTag(TAG_ORF_IMAGE_PROCESSING_IFD_POINTER, 8256, 1)};
    ...
    private static final ExifTag[] IFD_EXIF_TAGS = {new ExifTag(TAG_EXPOSURE_TIME, 33434, 5), new ExifTag(TAG_F_NUMBER, 33437, 5), new ExifTag(TAG_EXPOSURE_PROGRAM, 34850, 3), new ExifTag(TAG_SPECTRAL_SENSITIVITY, 34852, 2), new ExifTag(TAG_PHOTOGRAPHIC_SENSITIVITY, 34855, 3), new ExifTag(TAG_OECF, 34856, 7), new ExifTag(TAG_SENSITIVITY_TYPE, 34864, 3), new ExifTag(TAG_STANDARD_OUTPUT_SENSITIVITY, 34865, 4), new ExifTag(TAG_RECOMMENDED_EXPOSURE_INDEX, 34866, 4), new ExifTag(TAG_ISO_SPEED, 34867, 4), new ExifTag(TAG_ISO_SPEED_LATITUDE_YYY, 34868, 4), new ExifTag(TAG_ISO_SPEED_LATITUDE_ZZZ, 34869, 4), new ExifTag(TAG_EXIF_VERSION, 36864, 2), new ExifTag(TAG_DATETIME_ORIGINAL, 36867, 2), new ExifTag(TAG_DATETIME_DIGITIZED, 36868, 2), new ExifTag(TAG_OFFSET_TIME, 36880, 2), new ExifTag(TAG_OFFSET_TIME_ORIGINAL, 36881, 2), new ExifTag(TAG_OFFSET_TIME_DIGITIZED, 36882, 2), new ExifTag(TAG_COMPONENTS_CONFIGURATION, 37121, 7), new ExifTag(TAG_COMPRESSED_BITS_PER_PIXEL, 37122, 5), new ExifTag(TAG_SHUTTER_SPEED_VALUE, C13565R2.styleable.Constraint_animateRelativeTo, 10), new ExifTag(TAG_APERTURE_VALUE, C13565R2.styleable.Constraint_animate_relativeTo, 5), new ExifTag(TAG_BRIGHTNESS_VALUE, C13565R2.styleable.Constraint_barrierAllowsGoneWidgets, 10), new ExifTag(TAG_EXPOSURE_BIAS_VALUE, C13565R2.styleable.Constraint_barrierDirection, 10), new ExifTag(TAG_MAX_APERTURE_VALUE, C13565R2.styleable.Constraint_barrierMargin, 5), new ExifTag(TAG_SUBJECT_DISTANCE, C13565R2.styleable.Constraint_chainUseRtl, 5), new ExifTag(TAG_METERING_MODE, C13565R2.styleable.Constraint_constraint_referenced_ids, 3), new ExifTag(TAG_LIGHT_SOURCE, C13565R2.styleable.Constraint_constraint_referenced_tags, 3), new ExifTag(TAG_FLASH, C13565R2.styleable.Constraint_drawPath, 3), new ExifTag(TAG_FOCAL_LENGTH, C13565R2.styleable.Constraint_flow_firstHorizontalBias, 5), new ExifTag(TAG_SUBJECT_AREA, C13565R2.styleable.Constraint_flow_lastVerticalBias, 3), new ExifTag(TAG_MAKER_NOTE, C13565R2.styleable.ConstraintLayout_Layout_barrierMargin, 7), new ExifTag(TAG_USER_COMMENT, C13565R2.styleable.ConstraintLayout_Layout_flow_firstHorizontalBias, 7), new ExifTag(TAG_SUBSEC_TIME, C13565R2.styleable.ConstraintLayout_Layout_flow_lastVerticalBias, 2), new ExifTag(TAG_SUBSEC_TIME_ORIGINAL, C13565R2.styleable.ConstraintLayout_Layout_flow_lastVerticalStyle, 2), new ExifTag(TAG_SUBSEC_TIME_DIGITIZED, C13565R2.styleable.ConstraintLayout_Layout_flow_maxElementsWrap, 2), new ExifTag(TAG_FLASHPIX_VERSION, C13565R2.styleable.yoga_yg_maxHeight, 7), new ExifTag(TAG_COLOR_SPACE, C13565R2.styleable.yoga_yg_maxWidth, 3), new ExifTag(TAG_PIXEL_X_DIMENSION, C13565R2.styleable.yoga_yg_minHeight, 3, 4), new ExifTag(TAG_PIXEL_Y_DIMENSION, C13565R2.styleable.yoga_yg_minWidth, 3, 4), new ExifTag(TAG_RELATED_SOUND_FILE, C13565R2.styleable.yoga_yg_overflow, 2), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, C13565R2.styleable.yoga_yg_paddingAll, 4), new ExifTag(TAG_FLASH_ENERGY, 41483, 5), new ExifTag(TAG_SPATIAL_FREQUENCY_RESPONSE, 41484, 7), new ExifTag(TAG_FOCAL_PLANE_X_RESOLUTION, 41486, 5), new ExifTag(TAG_FOCAL_PLANE_Y_RESOLUTION, 41487, 5), new ExifTag(TAG_FOCAL_PLANE_RESOLUTION_UNIT, 41488, 3), new ExifTag(TAG_SUBJECT_LOCATION, 41492, 3), new ExifTag(TAG_EXPOSURE_INDEX, 41493, 5), new ExifTag(TAG_SENSING_METHOD, 41495, 3), new ExifTag(TAG_FILE_SOURCE, 41728, 7), new ExifTag(TAG_SCENE_TYPE, 41729, 7), new ExifTag(TAG_CFA_PATTERN, 41730, 7), new ExifTag(TAG_CUSTOM_RENDERED, 41985, 3), new ExifTag(TAG_EXPOSURE_MODE, 41986, 3), new ExifTag(TAG_WHITE_BALANCE, 41987, 3), new ExifTag(TAG_DIGITAL_ZOOM_RATIO, 41988, 5), new ExifTag(TAG_FOCAL_LENGTH_IN_35MM_FILM, 41989, 3), new ExifTag(TAG_SCENE_CAPTURE_TYPE, 41990, 3), new ExifTag(TAG_GAIN_CONTROL, 41991, 3), new ExifTag(TAG_CONTRAST, 41992, 3), new ExifTag(TAG_SATURATION, 41993, 3), new ExifTag(TAG_SHARPNESS, 41994, 3), new ExifTag(TAG_DEVICE_SETTING_DESCRIPTION, 41995, 7), new ExifTag(TAG_SUBJECT_DISTANCE_RANGE, 41996, 3), new ExifTag(TAG_IMAGE_UNIQUE_ID, 42016, 2), new ExifTag("CameraOwnerName", 42032, 2), new ExifTag(TAG_BODY_SERIAL_NUMBER, 42033, 2), new ExifTag(TAG_LENS_SPECIFICATION, 42034, 5), new ExifTag(TAG_LENS_MAKE, 42035, 2), new ExifTag(TAG_LENS_MODEL, 42036, 2), new ExifTag(TAG_GAMMA, 42240, 5), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, Ascii.f53584CR, 10, Ascii.SUB, 10};
