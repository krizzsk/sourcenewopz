...
public class NetWorkReceiver extends BroadcastReceiver {
    ...
    /* renamed from: b */
    private static NetWorkReceiver f36857b;
    public static int netStatus;

    /* renamed from: a */
    private List<NetWorkChangedListener> f36858a = new ArrayList();
    ...
    public void register(NetWorkChangedListener netWorkChangedListener) {
        synchronized (this.f36858a) {
            this.f36858a.add(netWorkChangedListener);
        }
    }

    public void unRegister(NetWorkChangedListener netWorkChangedListener) {
        synchronized (this.f36858a) {
            this.f36858a.remove(netWorkChangedListener);
        }
    }
    ...
    public void onReceive(android.content.Context r20, android.content.Intent r21) {
        ...
        L_0x0115:
            netStatus = r3
        L_0x0117:
            java.util.List<com.didi.sdk.netreceiver.NetWorkReceiver$NetWorkChangedListener> r2 = r1.f36858a
            monitor-enter(r2)
        L_0x011a:
            java.util.List<com.didi.sdk.netreceiver.NetWorkReceiver$NetWorkChangedListener> r0 = r1.f36858a     // Catch:{ all -> 0x0134 }
