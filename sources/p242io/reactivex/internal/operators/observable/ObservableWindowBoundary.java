...
public final class ObservableWindowBoundary<T, B> extends C21211a<T, Observable<T>> {

    /* renamed from: a */
    final ObservableSource<B> f58996a;
    ...
    public ObservableWindowBoundary(ObservableSource<T> observableSource, ObservableSource<B> observableSource2, int i) {
        ...
        this.f58996a = observableSource2;
        this.f58997b = i;
    }

    public void subscribeActual(Observer<? super Observable<T>> observer) {
        WindowBoundaryMainObserver windowBoundaryMainObserver = new WindowBoundaryMainObserver(observer, this.f58997b);
        observer.onSubscribe(windowBoundaryMainObserver);
        this.f58996a.subscribe(windowBoundaryMainObserver.boundaryObserver);
