...
public class ASN1OutputStream {
    ...
    /* renamed from: os */
    private OutputStream f5640os;

    public ASN1OutputStream(OutputStream outputStream) {
        this.f5640os = outputStream;
    }
    ...
    public static ASN1OutputStream create(OutputStream outputStream, String str) {
        return str.equals(ASN1Encoding.DER) ? new DEROutputStream(outputStream) : str.equals(ASN1Encoding.f5639DL) ? new DLOutputStream(outputStream) : new ASN1OutputStream(outputStream);
    }
    ...
    public DEROutputStream getDERSubStream() {
        return new DEROutputStream(this.f5640os);
    }

    /* access modifiers changed from: package-private */
    public ASN1OutputStream getDLSubStream() {
        return new DLOutputStream(this.f5640os);
    }

    /* access modifiers changed from: package-private */
    public final void write(int i) throws IOException {
        this.f5640os.write(i);
    }

    /* access modifiers changed from: package-private */
    public final void write(byte[] bArr, int i, int i2) throws IOException {
        this.f5640os.write(bArr, i, i2);
    }
