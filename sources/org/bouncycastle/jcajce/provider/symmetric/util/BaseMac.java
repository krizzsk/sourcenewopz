            ...
            if (key instanceof PKCS12Key) {
                try {
                    ...
                    try {
                        ...
                        cipherParameters = PBE.C2737Util.makePBEMacParameters(secretKey, 2, i, i2, pBEParameterSpec);
                ...
                if (bCPBEKey.getParam() != null) {
                    ...
                    cipherParameters = PBE.C2737Util.makePBEMacParameters(bCPBEKey, algorithmParameterSpec);
                } else {
