...
public final class ExecutionData {
    ...
    public void assertCompatibility(long j, String str, int i) throws IllegalStateException {
        if (this.f24386id != j) {
            throw new IllegalStateException(String.format("Different ids (%016x and %016x).", new Object[]{Long.valueOf(this.f24386id), Long.valueOf(j)}));
    ...
    public String toString() {
        return String.format("ExecutionData[name=%s, id=%016x]", new Object[]{this.name, Long.valueOf(this.f24386id)});
    }
}
