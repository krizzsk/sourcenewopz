...
public class WebRtcAudioRecord {
    ...
    private class AudioRecordThread extends Thread {
        ...
        public void run() {
            ...
            Logging.m3800d(WebRtcAudioRecord.TAG, "AudioRecordThread" + WebRtcAudioUtils.getThreadInfo());
    ...
    private boolean enableBuiltInAEC(boolean z) {
        Logging.m3800d(TAG, "enableBuiltInAEC(" + z + VersionRange.RIGHT_OPEN);
        WebRtcAudioEffects webRtcAudioEffects = this.effects;
        if (webRtcAudioEffects != null) {
            return webRtcAudioEffects.setAEC(z);
        }
        Logging.m3801e(TAG, "Built-in AEC is not supported on this platform");
        return false;
    }

    private boolean enableBuiltInNS(boolean z) {
        Logging.m3800d(TAG, "enableBuiltInNS(" + z + VersionRange.RIGHT_OPEN);
        WebRtcAudioEffects webRtcAudioEffects = this.effects;
        if (webRtcAudioEffects != null) {
            return webRtcAudioEffects.setNS(z);
        }
        Logging.m3801e(TAG, "Built-in NS is not supported on this platform");
        return false;
    }
    ...
    public static synchronized void setAudioSource(int i) {
        synchronized (WebRtcAudioRecord.class) {
            Logging.m3804w(TAG, "Audio source is changed from: " + audioSource + " to " + i);
            audioSource = i;
        }
    }
