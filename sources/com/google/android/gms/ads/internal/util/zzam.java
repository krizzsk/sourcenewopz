...
public final class zzam {
    ...
    private static String zzh(Context context, String str, String str2) {
        ...
        try {
            return (String) zzb.get((long) ((Integer) zzww.zzra().zzd(zzabq.zzcvv)).intValue(), TimeUnit.MILLISECONDS);
        } catch (TimeoutException e) {
            String valueOf = String.valueOf(str);
            zzd.zzc(valueOf.length() != 0 ? "Timeout while retriving a response from: ".concat(valueOf) : new String("Timeout while retriving a response from: "), e);
            zzb.cancel(true);
            return null;
        } catch (InterruptedException e2) {
            String valueOf2 = String.valueOf(str);
            zzd.zzc(valueOf2.length() != 0 ? "Interrupted while retriving a response from: ".concat(valueOf2) : new String("Interrupted while retriving a response from: "), e2);
            zzb.cancel(true);
            return null;
        } catch (Exception e3) {
