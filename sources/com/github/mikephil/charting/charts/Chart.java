...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    /* renamed from: a */
    private boolean f52239a = true;

    /* renamed from: b */
    private float f52240b = 0.9f;

    /* renamed from: c */
    private String f52241c = "No chart data available.";

    /* renamed from: d */
    private OnChartGestureListener f52242d;

    /* renamed from: e */
    private float f52243e = 0.0f;

    /* renamed from: f */
    private float f52244f = 0.0f;

    /* renamed from: g */
    private float f52245g = 0.0f;

    /* renamed from: h */
    private float f52246h = 0.0f;

    /* renamed from: i */
    private boolean f52247i = false;
    ...
    public void onDraw(Canvas canvas) {
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.f52241c)) {
                MPPointF center = getCenter();
                canvas.drawText(this.f52241c, center.f52498x, center.f52499y, this.mInfoPaint);
            }
        } else if (!this.f52247i) {
            calculateOffsets();
            this.f52247i = true;
        }
    }
    ...
    public void setOnChartGestureListener(OnChartGestureListener onChartGestureListener) {
        this.f52242d = onChartGestureListener;
    }
    ...
    public void setExtraTopOffset(float f) {
        this.f52243e = Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraRightOffset(float f) {
        this.f52244f = Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraBottomOffset(float f) {
        this.f52245g = Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraLeftOffset(float f) {
        this.f52246h = Utils.convertDpToPixel(f);
    }
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) {
        ...
        int i2 = C178582.$SwitchMap$android$graphics$Bitmap$CompressFormat[compressFormat.ordinal()];
    ...
    static /* synthetic */ class C178582 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.Chart.C178582.<clinit>():void");
        }
    }
    ...
    /* renamed from: a */
    private void m37260a(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            while (true) {
                ...
                if (i < viewGroup.getChildCount()) {
                    m37260a(viewGroup.getChildAt(i));
                    i++;
                } else {
