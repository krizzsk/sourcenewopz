...
public class PropertySetterDescriptorImpl extends PropertyAccessorDescriptorImpl implements PropertySetterDescriptor {
    ...
    /* renamed from: b */
    static final /* synthetic */ boolean f60296b = (!PropertySetterDescriptorImpl.class.desiredAssertionStatus());

    /* renamed from: c */
    private ValueParameterDescriptor f60297c;

    /* renamed from: d */
    private final PropertySetterDescriptor f60298d;

    /* renamed from: a */
    private static /* synthetic */ void m44545a(int i) {
        String str;
        int i2;
        Throwable th;
        switch (i) {
    ...
    public void initialize(ValueParameterDescriptor valueParameterDescriptor) {
        ...
        if (f60296b || this.f60297c == null) {
            this.f60297c = valueParameterDescriptor;
            return;
        }
    ...
    public List<ValueParameterDescriptor> getValueParameters() {
        ValueParameterDescriptor valueParameterDescriptor = this.f60297c;
        if (valueParameterDescriptor != null) {
    ...
    public PropertySetterDescriptor getOriginal() {
        PropertySetterDescriptor propertySetterDescriptor = this.f60298d;
        if (propertySetterDescriptor == null) {
            m44545a(13);
        }
