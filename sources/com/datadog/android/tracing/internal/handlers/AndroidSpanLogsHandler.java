...
public final class AndroidSpanLogsHandler implements LogHandler {
    ...
    public void log(String str, DDSpan dDSpan) {
        ...
        m2550a(dDSpan, MapsKt.mutableMapOf(TuplesKt.m42317to("event", str)), (Long) null);
    }

    public void log(long j, String str, DDSpan dDSpan) {
        Intrinsics.checkNotNullParameter(str, "event");
        Intrinsics.checkNotNullParameter(dDSpan, "span");
        m2550a(dDSpan, MapsKt.mutableMapOf(TuplesKt.m42317to("event", str)), Long.valueOf(j));
    }
    ...
    public void log(Map<String, ?> map, DDSpan dDSpan) {
        ...
        m2551a(mutableMap, dDSpan);
        m2549a(this, dDSpan, mutableMap, (Long) null, 4, (Object) null);
    }
    ...
    public void log(long j, Map<String, ?> map, DDSpan dDSpan) {
        ...
        Map<String, ?> mutableMap = MapsKt.toMutableMap(map);
        m2551a(mutableMap, dDSpan);
        m2550a(dDSpan, mutableMap, Long.valueOf(j));
    }

    /* renamed from: a */
    private final Long m2548a(Long l) {
        if (l == null) {
            return null;
        }
    ...
    /* renamed from: a */
    static /* synthetic */ void m2549a(AndroidSpanLogsHandler androidSpanLogsHandler, DDSpan dDSpan, Map map, Long l, int i, Object obj) {
        if ((i & 4) != 0) {
            l = null;
        }
        androidSpanLogsHandler.m2550a(dDSpan, map, l);
    }
    ...
    private final void m2550a(com.datadog.opentracing.DDSpan r9, java.util.Map<java.lang.String, java.lang.Object> r10, java.lang.Long r11) {
        /*
            r8 = this;
        ...
        L_0x0014:
            ...
            r3 = 2
            r5 = 0
            java.lang.Long r7 = r8.m2548a(r11)
            r6 = r10
            r2.internalLog$dd_sdk_android_release(r3, r4, r5, r6, r7)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.datadog.android.tracing.internal.handlers.AndroidSpanLogsHandler.m2550a(com.datadog.opentracing.DDSpan, java.util.Map, java.lang.Long):void");
    }

    /* renamed from: a */
    private final void m2551a(Map<String, ?> map, DDSpan dDSpan) {
        String str;
        String str2;
        String str3;
        Class<?> cls;
    ...
    @Metadata(mo175977d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo175978d2 = {"Lcom/datadog/android/tracing/internal/handlers/AndroidSpanLogsHandler$Companion;", "", "()V", "DEFAULT_EVENT_MESSAGE", "", "dd-sdk-android_release"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: AndroidSpanLogsHandler.kt */
