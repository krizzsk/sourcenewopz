...
public final class MaybeDelayOtherPublisher<T, U> extends C21209a<T, T> {

    /* renamed from: a */
    final Publisher<U> f58562a;

    public MaybeDelayOtherPublisher(MaybeSource<T> maybeSource, Publisher<U> publisher) {
        super(maybeSource);
        this.f58562a = publisher;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.source.subscribe(new DelayMaybeObserver(maybeObserver, this.f58562a));
    }
