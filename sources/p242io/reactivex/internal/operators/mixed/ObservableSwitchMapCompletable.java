...
public final class ObservableSwitchMapCompletable<T> extends Completable {
    ...
    /* renamed from: a */
    final Observable<T> f58691a;

    /* renamed from: b */
    final Function<? super T, ? extends CompletableSource> f58692b;

    /* renamed from: c */
    final boolean f58693c;

    public ObservableSwitchMapCompletable(Observable<T> observable, Function<? super T, ? extends CompletableSource> function, boolean z) {
        this.f58691a = observable;
        this.f58692b = function;
        this.f58693c = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(CompletableObserver completableObserver) {
        if (!C21210a.m41819a((Object) this.f58691a, this.f58692b, completableObserver)) {
            this.f58691a.subscribe(new SwitchMapCompletableObserver(completableObserver, this.f58692b, this.f58693c));
        }
    }
