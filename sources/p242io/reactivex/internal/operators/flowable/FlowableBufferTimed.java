...
import p242io.reactivex.internal.subscribers.QueueDrainSubscriber;
...
public final class FlowableBufferTimed<T, U extends Collection<? super T>> extends C21208a<T, U> {
    ...
    /* renamed from: c */
    final TimeUnit f58198c;

    /* renamed from: d */
    final Scheduler f58199d;

    /* renamed from: e */
    final Callable<U> f58200e;

    /* renamed from: f */
    final int f58201f;

    /* renamed from: g */
    final boolean f58202g;

    public FlowableBufferTimed(Flowable<T> flowable, long j, long j2, TimeUnit timeUnit, Scheduler scheduler, Callable<U> callable, int i, boolean z) {
        super(flowable);
        this.f58196a = j;
        this.f58197b = j2;
        this.f58198c = timeUnit;
        this.f58199d = scheduler;
        this.f58200e = callable;
        this.f58201f = i;
        this.f58202g = z;
    }
    ...
    public void subscribeActual(Subscriber<? super U> subscriber) {
        if (this.f58196a == this.f58197b && this.f58201f == Integer.MAX_VALUE) {
            this.source.subscribe(new BufferExactUnboundedSubscriber(new SerializedSubscriber(subscriber), this.f58200e, this.f58196a, this.f58198c, this.f58199d));
            return;
        }
        Scheduler.Worker createWorker = this.f58199d.createWorker();
        if (this.f58196a == this.f58197b) {
            this.source.subscribe(new BufferExactBoundedSubscriber(new SerializedSubscriber(subscriber), this.f58200e, this.f58196a, this.f58198c, this.f58201f, this.f58202g, createWorker));
        } else {
            this.source.subscribe(new BufferSkipBoundedSubscriber(new SerializedSubscriber(subscriber), this.f58200e, this.f58196a, this.f58197b, this.f58198c, createWorker));
        }
    }
    ...
    static final class BufferExactUnboundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Disposable, Runnable, Subscription {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x001e, code lost:
            p242io.reactivex.internal.util.QueueDrainHelper.drainMaxLoop(r4.queue, r4.downstream, false, (p242io.reactivex.disposables.Disposable) null, r4);
         */
        ...
        public void onComplete() {
            /*
                ...
                p242io.reactivex.internal.disposables.DisposableHelper.dispose(r0)
                monitor-enter(r4)
            ...
            L_0x000c:
                ...
                r3 = 0
                p242io.reactivex.internal.util.QueueDrainHelper.drainMaxLoop(r0, r2, r3, r1, r4)
            L_0x0026:
                return
            L_0x0027:
                r0 = move-exception
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.flowable.FlowableBufferTimed.BufferExactUnboundedSubscriber.onComplete():void");
        }
    ...
    static final class BufferSkipBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Runnable, Subscription {
        ...
        /* renamed from: w */
        final Scheduler.Worker f58204w;
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.upstream, subscription)) {
                ...
                try {
                    ...
                    this.downstream.onSubscribe(this);
                    subscription.request(Long.MAX_VALUE);
                    Scheduler.Worker worker = this.f58204w;
                    long j = this.timeskip;
                    worker.schedulePeriodically(this, j, j, this.unit);
                    this.f58204w.schedule(new RemoveFromBuffer(collection), this.timespan, this.unit);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    this.f58204w.dispose();
                    subscription.cancel();
                    EmptySubscription.error(th, this.downstream);
                }
            }
        ...
        public void onComplete() {
            ...
            this.done = true;
            if (enter()) {
                QueueDrainHelper.drainMaxLoop(this.queue, this.downstream, false, this.f58204w, this);
            }
        }
        ...
        final class RemoveFromBuffer implements Runnable {
            ...
            public void run() {
                ...
                bufferSkipBoundedSubscriber.fastPathOrderedEmitMax(this.buffer, false, bufferSkipBoundedSubscriber.f58204w);
            }
        }
    }
    ...
    static final class BufferExactBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Disposable, Runnable, Subscription {
        ...
        /* renamed from: w */
        final Scheduler.Worker f58203w;
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.upstream, subscription)) {
                ...
                try {
                    this.buffer = (Collection) ObjectHelper.requireNonNull(this.bufferSupplier.call(), "The supplied buffer is null");
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f58203w;
                    long j = this.timespan;
                    this.timer = worker.schedulePeriodically(this, j, j, this.unit);
                    subscription.request(Long.MAX_VALUE);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    this.f58203w.dispose();
                    subscription.cancel();
                    EmptySubscription.error(th, this.downstream);
                }
            }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
            r8 = (java.util.Collection) p242io.reactivex.internal.functions.ObjectHelper.requireNonNull(r7.bufferSupplier.call(), "The supplied buffer is null");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:30:0x005a, code lost:
            p242io.reactivex.exceptions.Exceptions.throwIfFatal(r8);
            cancel();
        ...
        public void onNext(T r8) {
            ...
            L_0x0028:
                ...
                java.lang.Object r8 = p242io.reactivex.internal.functions.ObjectHelper.requireNonNull(r8, (java.lang.String) r0)     // Catch:{ all -> 0x0059 }
                ...
                io.reactivex.Scheduler$Worker r0 = r7.f58203w
                long r4 = r7.timespan
            ...
            L_0x0066:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.flowable.FlowableBufferTimed.BufferExactBoundedSubscriber.onNext(java.lang.Object):void");
        }
        ...
        public boolean isDisposed() {
            return this.f58203w.isDisposed();
        }
