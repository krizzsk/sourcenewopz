...
public final class SingleZipArray<T, R> extends Single<R> {
    ...
    /* renamed from: a */
    final SingleSource<? extends T>[] f59185a;

    /* renamed from: b */
    final Function<? super Object[], ? extends R> f59186b;

    public SingleZipArray(SingleSource<? extends T>[] singleSourceArr, Function<? super Object[], ? extends R> function) {
        this.f59185a = singleSourceArr;
        this.f59186b = function;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(SingleObserver<? super R> singleObserver) {
        SingleSource<? extends T>[] singleSourceArr = this.f59185a;
        ...
        ZipCoordinator zipCoordinator = new ZipCoordinator(singleObserver, length, this.f59186b);
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            return ObjectHelper.requireNonNull(SingleZipArray.this.f59186b.apply(new Object[]{t}), "The zipper returned a null value");
        }
    }
}
