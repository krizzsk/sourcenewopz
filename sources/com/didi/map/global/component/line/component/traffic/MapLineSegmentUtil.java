...
public class MapLineSegmentUtil {
    ...
    /* renamed from: a */
    static final String f25775a = "MapLineSegmentUtil";

    /* renamed from: b */
    static final int f25776b = 100;

    /* renamed from: c */
    static final int f25777c = 6;

    /* renamed from: d */
    static final int f25778d = 30;
        ...
        if (!CollectionUtil.isEmpty((Collection<?>) list) && list6 != null) {
            ...
            while (i2 < size) {
                ...
                if (trafficData4 == null || i2 >= trafficData4.toIndex) {
                    ...
                    trafficData = m18377a(list7, i3, i2);
                    if (trafficData != null) {
                ...
                latLng = m18376a(list6, latLng, latLng3, a);
    ...
    public static void insertPoints(List<LatLng> list, List<LatLng> list2) {
        if (!CollectionUtil.isEmpty((Collection<?>) list) && list2 != null) {
            ...
            while (i < size) {
                ...
                i++;
                latLng = m18376a(list2, latLng, list.get(i), a);
            }
    ...
    /* renamed from: a */
    private static LatLng m18376a(List<LatLng> list, LatLng latLng, LatLng latLng2, double d) {
        ...
        return m18376a(list, interpolate, latLng2, d);
    }
    ...
    /* renamed from: a */
    private static TrafficData m18377a(List<TrafficData> list, int i, int i2) {
        int size = list.size();
        while (i < size) {
    ...
    /* renamed from: a */
    private static double m18375a(List<LatLng> list) {
        int size = list.size() - 1;
        double d = 0.0d;
        int i = 0;
        while (i < size) {
