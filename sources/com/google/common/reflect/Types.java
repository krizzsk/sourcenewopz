...
final class Types {
    ...
    public static final Joiner COMMA_JOINER = Joiner.m38343on(", ").useForNull("null");
    /* access modifiers changed from: private */
    ...
    private static <D extends GenericDeclaration> TypeVariable<D> newTypeVariableImpl(D d, String str, Type[] typeArr) {
        return (TypeVariable) C19100Reflection.newProxy(TypeVariable.class, new TypeVariableInvocationHandler(new TypeVariableImpl(d, str, typeArr)));
    }
    ...
    static final class NativeTypeVariableEquals<X> {
        ...
        static {
            ...
            NATIVE_TYPE_VARIABLE_ONLY = !cls.getTypeParameters()[0].equals(Types.newArtificialTypeVariable(cls, C16471q.f49112a, new Type[0]));
        }
    }
