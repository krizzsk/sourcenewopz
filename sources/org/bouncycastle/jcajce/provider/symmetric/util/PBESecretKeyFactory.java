...
public class PBESecretKeyFactory extends BaseSecretKeyFactory implements PBE {
    ...
    public SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof PBEKeySpec) {
            ...
            return new BCPBEKey(this.algName, this.algOid, this.scheme, this.digest, this.keySize, this.ivSize, pBEKeySpec, this.forCipher ? PBE.C2737Util.makePBEParameters(pBEKeySpec, this.scheme, this.digest, this.keySize, this.ivSize) : PBE.C2737Util.makePBEMacParameters(pBEKeySpec, this.scheme, this.digest, this.keySize));
        }
