...
public class HkdfPrfKeyManager extends KeyTypeManager<HkdfPrfKey> {
    ...
    static /* synthetic */ class C192524 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.prf.HkdfPrfKeyManager.C192524.<clinit>():void");
        }
    }

    /* access modifiers changed from: private */
    public static Enums.HashType convertHash(HashType hashType) throws GeneralSecurityException {
        int i = C192524.$SwitchMap$com$google$crypto$tink$proto$HashType[hashType.ordinal()];
        if (i == 1) {
