...
public class DescriptorFactory {
    /* renamed from: a */
    private static /* synthetic */ void m44914a(int i) {
    ...
    public static boolean isEnumValuesMethod(FunctionDescriptor functionDescriptor) {
        ...
        return functionDescriptor.getName().equals(StandardNames.ENUM_VALUES) && m44915a(functionDescriptor);
    }
    ...
    public static boolean isEnumValueOfMethod(FunctionDescriptor functionDescriptor) {
        ...
        return functionDescriptor.getName().equals(StandardNames.ENUM_VALUE_OF) && m44915a(functionDescriptor);
    }

    /* renamed from: a */
    private static boolean m44915a(FunctionDescriptor functionDescriptor) {
        if (functionDescriptor == null) {
            m44914a(28);
        }
