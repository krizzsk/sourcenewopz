...
public final class MaybeEqualSingle<T> extends Single<Boolean> {
    ...
    /* renamed from: a */
    final MaybeSource<? extends T> f58569a;

    /* renamed from: b */
    final MaybeSource<? extends T> f58570b;

    /* renamed from: c */
    final BiPredicate<? super T, ? super T> f58571c;

    public MaybeEqualSingle(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, BiPredicate<? super T, ? super T> biPredicate) {
        this.f58569a = maybeSource;
        this.f58570b = maybeSource2;
        this.f58571c = biPredicate;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(SingleObserver<? super Boolean> singleObserver) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(singleObserver, this.f58571c);
        singleObserver.onSubscribe(equalCoordinator);
        equalCoordinator.subscribe(this.f58569a, this.f58570b);
    }
