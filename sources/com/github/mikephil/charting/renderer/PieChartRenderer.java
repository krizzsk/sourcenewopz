...
public class PieChartRenderer extends DataRenderer {
    ...
    /* renamed from: a */
    private TextPaint f52477a;

    /* renamed from: b */
    private Paint f52478b;

    /* renamed from: c */
    private StaticLayout f52479c;

    /* renamed from: d */
    private CharSequence f52480d;

    /* renamed from: e */
    private RectF f52481e = new RectF();

    /* renamed from: f */
    private RectF[] f52482f = {new RectF(), new RectF(), new RectF()};

    /* renamed from: g */
    private Path f52483g = new Path();

    /* renamed from: h */
    private RectF f52484h = new RectF();

    /* renamed from: i */
    private Path f52485i = new Path();
    ...
    public PieChartRenderer(PieChart pieChart, ChartAnimator chartAnimator, ViewPortHandler viewPortHandler) {
        ...
        this.f52477a = textPaint;
        textPaint.setColor(-16777216);
        this.f52477a.setTextSize(Utils.convertDpToPixel(12.0f));
        ...
        this.f52478b = paint3;
        paint3.setColor(-1);
        this.f52478b.setTextAlign(Paint.Align.CENTER);
        this.f52478b.setTextSize(Utils.convertDpToPixel(13.0f));
    ...
    public float calculateMinimumRadiusForSpacedSlice(MPPointF mPPointF, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        float cos = mPPointF2.f52498x + (((float) Math.cos(d)) * f);
        float sin = mPPointF2.f52499y + (((float) Math.sin(d)) * f);
        double d2 = (double) ((f5 + (f6 / 2.0f)) * 0.017453292f);
        return (float) (((double) (f - ((float) ((Math.sqrt(Math.pow((double) (cos - f3), 2.0d) + Math.pow((double) (sin - f4), 2.0d)) / 2.0d) * Math.tan(((180.0d - ((double) f2)) / 2.0d) * 0.017453292519943295d))))) - Math.sqrt(Math.pow((double) ((mPPointF2.f52498x + (((float) Math.cos(d2)) * f)) - ((cos + f3) / 2.0f)), 2.0d) + Math.pow((double) ((mPPointF2.f52499y + (((float) Math.sin(d2)) * f)) - ((sin + f4) / 2.0f)), 2.0d)));
    }
    ...
    public void drawDataSet(Canvas canvas, IPieDataSet iPieDataSet) {
        ...
        while (i9 < entryCount) {
            ...
            if (Math.abs(iPieDataSet2.getEntryForIndex(i9).getY()) > Utils.FLOAT_EPSILON && (!pieChartRenderer.mChart.needsHighlight(i9) || z2)) {
                ...
                pieChartRenderer.f52483g.reset();
                if (z2) {
                    ...
                    i = entryCount;
                    fArr = drawAngles;
                    float cos = centerCircleBox.f52498x + (((float) Math.cos(d)) * f16);
                    float sin = centerCircleBox.f52499y + (f16 * ((float) Math.sin(d)));
                ...
                f3 = rotationAngle;
                f2 = phaseX;
                float cos2 = centerCircleBox.f52498x + (((float) Math.cos(d2)) * radius);
                float sin2 = centerCircleBox.f52499y + (((float) Math.sin(d2)) * radius);
                int i10 = (f15 > 360.0f ? 1 : (f15 == 360.0f ? 0 : -1));
                if (i10 < 0 || f15 % 360.0f > Utils.FLOAT_EPSILON) {
                    if (z2) {
                        pieChartRenderer.f52483g.arcTo(rectF7, f14 + 180.0f, -180.0f);
                    }
                    pieChartRenderer.f52483g.arcTo(circleBox, f14, f15);
                } else {
                    pieChartRenderer.f52483g.addCircle(centerCircleBox.f52498x, centerCircleBox.f52499y, radius, Path.Direction.CW);
                }
                float f17 = f15;
                pieChartRenderer.f52484h.set(centerCircleBox.f52498x - holeRadius, centerCircleBox.f52499y - holeRadius, centerCircleBox.f52498x + holeRadius, centerCircleBox.f52499y + holeRadius);
                if (!z) {
                    f8 = holeRadius;
                    f9 = radius;
                    ...
                    if (i10 < 0 || f10 % 360.0f > Utils.FLOAT_EPSILON) {
                        ...
                        if (z2) {
                            ...
                            float cos3 = mPPointF2.f52498x + (((float) Math.cos(d3)) * f23);
                            float sin3 = mPPointF2.f52499y + (f23 * ((float) Math.sin(d3)));
                            rectF3 = rectF6;
                            rectF3.set(cos3 - holeRadius2, sin3 - holeRadius2, cos3 + holeRadius2, sin3 + holeRadius2);
                            pieChartRenderer.f52483g.arcTo(rectF3, f22, 180.0f);
                        } else {
                            rectF3 = rectF6;
                            double d4 = (double) (f22 * 0.017453292f);
                            pieChartRenderer.f52483g.lineTo(mPPointF2.f52498x + (((float) Math.cos(d4)) * holeRadius), mPPointF2.f52499y + (holeRadius * ((float) Math.sin(d4))));
                        }
                        pieChartRenderer.f52483g.arcTo(pieChartRenderer.f52484h, f22, -f21);
                    } else {
                        pieChartRenderer = this;
                        pieChartRenderer.f52483g.addCircle(mPPointF2.f52498x, mPPointF2.f52499y, holeRadius, Path.Direction.CCW);
                        rectF3 = rectF6;
                    }
                    mPPointF = mPPointF2;
                    rectF2 = rectF3;
                    pieChartRenderer.f52483g.close();
                    pieChartRenderer.mBitmapCanvas.drawPath(pieChartRenderer.f52483g, pieChartRenderer.mRenderPaint);
                    f11 += f12 * f2;
                } else {
                    f8 = holeRadius;
                    f9 = radius;
                ...
                if (f6 % f7 > Utils.FLOAT_EPSILON) {
                    if (z3) {
                        ...
                        pieChartRenderer.f52483g.lineTo(mPPointF.f52498x + (((float) Math.cos(d5)) * calculateMinimumRadiusForSpacedSlice2), mPPointF.f52499y + (calculateMinimumRadiusForSpacedSlice2 * ((float) Math.sin(d5))));
                    } else {
                        rectF2 = rectF3;
                        pieChartRenderer.f52483g.lineTo(mPPointF.f52498x, mPPointF.f52499y);
                    }
                    pieChartRenderer.f52483g.close();
                    pieChartRenderer.mBitmapCanvas.drawPath(pieChartRenderer.f52483g, pieChartRenderer.mRenderPaint);
                    f11 += f12 * f2;
    ...
    public void drawValues(android.graphics.Canvas r53) {
        ...
        L_0x0226:
            ...
            android.graphics.Paint r2 = r6.f52478b
            android.graphics.Paint$Align r10 = android.graphics.Paint.Align.RIGHT
            r2.setTextAlign(r10)
        L_0x0278:
            float r2 = r0 - r22
        ...
        L_0x027e:
            ...
            android.graphics.Paint r0 = r6.f52478b
            android.graphics.Paint$Align r2 = android.graphics.Paint.Align.LEFT
            r0.setTextAlign(r2)
        L_0x0290:
            float r0 = r43 + r22
        ...
        L_0x0336:
            float r0 = r35 * r46
            r10 = r50
            float r1 = r10.f52498x
            float r12 = r0 + r1
            float r0 = r35 * r29
            float r1 = r10.f52499y
            float r13 = r0 + r1
            android.graphics.Paint r0 = r6.mValuePaint
        ...
        L_0x0393:
            ...
            float r0 = r35 + r0
            float r0 = r0 * r46
            float r2 = r10.f52498x
            float r0 = r0 + r2
            float r2 = r7.f52499y
            float r2 = r35 + r2
            float r2 = r2 * r29
            float r3 = r10.f52499y
            float r2 = r2 + r3
            float r3 = r7.f52498x
            float r2 = r2 + r3
            int r3 = (int) r0
    ...
    public void drawEntryLabel(Canvas canvas, String str, float f, float f2) {
        canvas.drawText(str, f, f2, this.f52478b);
    }
    ...
    public void drawHole(Canvas canvas) {
        if (this.mChart.isDrawHoleEnabled() && this.mBitmapCanvas != null) {
            ...
            if (Color.alpha(this.mHolePaint.getColor()) > 0) {
                this.mBitmapCanvas.drawCircle(centerCircleBox.f52498x, centerCircleBox.f52499y, holeRadius, this.mHolePaint);
            }
            if (Color.alpha(this.mTransparentCirclePaint.getColor()) > 0 && this.mChart.getTransparentCircleRadius() > this.mChart.getHoleRadius()) {
                ...
                this.f52485i.reset();
                this.f52485i.addCircle(centerCircleBox.f52498x, centerCircleBox.f52499y, transparentCircleRadius, Path.Direction.CW);
                this.f52485i.addCircle(centerCircleBox.f52498x, centerCircleBox.f52499y, holeRadius, Path.Direction.CCW);
                this.mBitmapCanvas.drawPath(this.f52485i, this.mTransparentCirclePaint);
    ...
    public void drawCenterText(Canvas canvas) {
        ...
        if (this.mChart.isDrawCenterTextEnabled() && centerText != null) {
            ...
            float f2 = centerCircleBox.f52498x + centerTextOffset.f52498x;
            float f3 = centerCircleBox.f52499y + centerTextOffset.f52499y;
            ...
            RectF rectF = this.f52482f[0];
            rectF.left = f2 - f;
            rectF.top = f3 - f;
            rectF.right = f2 + f;
            rectF.bottom = f3 + f;
            RectF rectF2 = this.f52482f[1];
            rectF2.set(rectF);
            float centerTextRadiusPercent = this.mChart.getCenterTextRadiusPercent() / 100.0f;
            if (((double) centerTextRadiusPercent) > 0.0d) {
                rectF2.inset((rectF2.width() - (rectF2.width() * centerTextRadiusPercent)) / 2.0f, (rectF2.height() - (rectF2.height() * centerTextRadiusPercent)) / 2.0f);
            }
            if (!centerText.equals(this.f52480d) || !rectF2.equals(this.f52481e)) {
                this.f52481e.set(rectF2);
                this.f52480d = centerText;
                mPPointF = centerTextOffset;
                StaticLayout staticLayout = r3;
                StaticLayout staticLayout2 = new StaticLayout(centerText, 0, centerText.length(), this.f52477a, (int) Math.max(Math.ceil((double) this.f52481e.width()), 1.0d), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                this.f52479c = staticLayout;
            } else {
                mPPointF = centerTextOffset;
            }
            float height = (float) this.f52479c.getHeight();
            canvas.save();
            ...
            while (i4 < highlightArr2.length) {
                ...
                if (x < drawAngles.length && (dataSetByIndex = ((PieData) this.mChart.getData()).getDataSetByIndex(highlightArr2[i4].getDataSetIndex())) != null && dataSetByIndex.isHighlightEnabled()) {
                    ...
                    if (i8 < 0 || f17 % 360.0f > Utils.FLOAT_EPSILON) {
                        ...
                        i3 = i5;
                        z = z2;
                        this.f52483g.moveTo(centerCircleBox.f52498x + (((float) Math.cos(d)) * f10), centerCircleBox.f52499y + (f10 * ((float) Math.sin(d))));
                        this.f52483g.arcTo(rectF2, f18, f19);
                    } else {
                        this.f52483g.addCircle(centerCircleBox.f52498x, centerCircleBox.f52499y, f10, Path.Direction.CW);
                        fArr2 = drawAngles;
                        f6 = f4;
                        i3 = i5;
                        z = z2;
                    ...
                    if (z3) {
                        ...
                        mPPointF = centerCircleBox;
                        fArr = fArr2;
                        f7 = calculateMinimumRadiusForSpacedSlice(centerCircleBox, radius, f9 * phaseY, (((float) Math.cos(d2)) * radius) + centerCircleBox.f52498x, centerCircleBox.f52499y + (((float) Math.sin(d2)) * radius), f15, f17);
                    } else {
                        rectF = rectF2;
                        mPPointF = centerCircleBox;
                        i = i7;
                    ...
                    this.f52484h.set(mPPointF.f52498x - f2, mPPointF.f52499y - f2, mPPointF.f52498x + f2, mPPointF.f52499y + f2);
                    if (!z || (f2 <= 0.0f && !z3)) {
                        f3 = phaseX;
                        f = phaseY;
                        if (f17 % 360.0f > Utils.FLOAT_EPSILON) {
                            if (z3) {
                                ...
                                this.f52483g.lineTo(mPPointF.f52498x + (((float) Math.cos(d3)) * f7), mPPointF.f52499y + (f7 * ((float) Math.sin(d3))));
                            } else {
                                this.f52483g.lineTo(mPPointF.f52498x, mPPointF.f52499y);
                            }
                        }
                    } else {
                        if (z3) {
                        ...
                        if (i8 < 0 || f17 % 360.0f > Utils.FLOAT_EPSILON) {
                            ...
                            f3 = phaseX;
                            f = phaseY;
                            this.f52483g.lineTo(mPPointF.f52498x + (((float) Math.cos(d4)) * f8), mPPointF.f52499y + (f8 * ((float) Math.sin(d4))));
                            this.f52483g.arcTo(this.f52484h, f23, -f22);
                        } else {
                            this.f52483g.addCircle(mPPointF.f52498x, mPPointF.f52499y, f8, Path.Direction.CCW);
                            f3 = phaseX;
                            f = phaseY;
                        }
                    }
                    this.f52483g.close();
                    this.mBitmapCanvas.drawPath(this.f52483g, this.mRenderPaint);
                } else {
                    i = i4;
                    rectF = rectF2;
                    f2 = holeRadius;
            ...
            if (dataSet.isVisible()) {
                ...
                while (i < dataSet.getEntryCount()) {
                    ...
                    if (Math.abs(dataSet.getEntryForIndex(i).getY()) > Utils.FLOAT_EPSILON) {
                        ...
                        fArr = drawAngles;
                        f2 = rotationAngle;
                        float cos = (float) (((double) centerCircleBox.f52498x) + (Math.cos(Math.toRadians(d2)) * d));
                        float sin = (float) ((d * Math.sin(Math.toRadians(d2))) + ((double) centerCircleBox.f52499y));
