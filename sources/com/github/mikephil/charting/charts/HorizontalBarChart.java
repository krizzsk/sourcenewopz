...
public class HorizontalBarChart extends BarChart {
    ...
    /* renamed from: a */
    private RectF f52251a = new RectF();
    ...
    public void calculateOffsets() {
        calculateLegendOffsets(this.f52251a);
        float f = this.f52251a.left + 0.0f;
        float f2 = this.f52251a.top + 0.0f;
        float f3 = this.f52251a.right + 0.0f;
        float f4 = this.f52251a.bottom + 0.0f;
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f52496y);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f52496y);
    }
