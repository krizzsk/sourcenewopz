...
public final class MaybeTakeUntilPublisher<T, U> extends C21209a<T, T> {

    /* renamed from: a */
    final Publisher<U> f58626a;

    public MaybeTakeUntilPublisher(MaybeSource<T> maybeSource, Publisher<U> publisher) {
        super(maybeSource);
        this.f58626a = publisher;
    }
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        ...
        this.f58626a.subscribe(takeUntilMainMaybeObserver.other);
