    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (key instanceof SecretKey) {
            if (key instanceof PKCS12Key) {
                ...
                parametersWithIV = PBE.C2737Util.makePBEParameters(pKCS12Key.getEncoded(), 2, this.digest, this.keySizeInBits, this.ivLength * 8, this.pbeSpec, this.cipher.getAlgorithmName());
            } else {
                if (key instanceof BCPBEKey) {
                    ...
                    if (bCPBEKey.getParam() != null) {
                        ...
                        CipherParameters makePBEParameters = PBE.C2737Util.makePBEParameters(bCPBEKey, algorithmParameterSpec, this.cipher.getAlgorithmName());
