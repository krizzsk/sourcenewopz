...
public final class EditTipItemView extends RelativeLayout implements ITipItemView {
    ...
    public EditTipItemView(Context context, AttributeSet attributeSet, int i, BillTipModel billTipModel) {
        ...
        this.f19609b = (EditText) findViewById;
        ...
        this.f19610c = (CustomerAppCompatTextView) findViewById2;
        ...
        this.f19611d = (CustomerAppCompatTextView) findViewById3;
        ...
        this.f19613f = (CustomerAppCompatTextView) findViewById4;
        setOnClickListener(new View.OnClickListener(context, this) {
            ...
            public final void onClick(View view) {
                EditTipItemView.m14634a(this.f$0, this.f$1, view);
            }
        });
        TextWatcher tipTextWatcher = new TipTextWatcher(this);
        this.f19612e = tipTextWatcher;
        this.f19609b.addTextChangedListener(tipTextWatcher);
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public static final void m14634a(Context context, EditTipItemView editTipItemView, View view) {
        Intrinsics.checkNotNullParameter(editTipItemView, "this$0");
        KeyboardUtils.showSoftInput(context, editTipItemView.f19609b);
    }

    public final void setBillTipEditCallback(BillTipEditCallback billTipEditCallback) {
        this.f19614g = billTipEditCallback;
    }
    ...
    public final void setData(BillTipModel billTipModel, String str) {
        ...
        if (billTipModel.isPercent()) {
            this.f19610c.setText(ResourceHelper.getString(R.string.entrega_global_blank));
            this.f19611d.setText("%");
        } else if (LocalizationUtils.CurrencyUtils.isJPYLocalLang(str)) {
            this.f19610c.setText(ResourceHelper.getString(R.string.entrega_global_blank));
            this.f19611d.setText(LocalizationUtils.CurrencyUtils.getCurrencySymbol(str));
        } else {
            this.f19610c.setText(LocalizationUtils.CurrencyUtils.getCurrencySymbol(str));
            this.f19611d.setText(ResourceHelper.getString(R.string.entrega_global_blank));
        }
        this.f19610c.setVisibility(8);
        this.f19611d.setVisibility(8);
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public final void m14633a() {
        if (this.f19608a.isPercent()) {
            this.f19609b.setHint("0%");
            this.f19610c.setVisibility(8);
        } else if (LocalizationUtils.CurrencyUtils.isJPYLocalLang(this.f19615h)) {
            this.f19610c.setVisibility(8);
            this.f19609b.setHint(Intrinsics.stringPlus("0", LocalizationUtils.CurrencyUtils.getCurrencySymbol(this.f19615h)));
        } else {
            this.f19610c.setVisibility(0);
            this.f19610c.setTextColor(ResourceHelper.getColor(R.color.rf_color_gery_4_80_CCCCCC));
            this.f19609b.setHint("0");
        }
        this.f19611d.setVisibility(8);
        m14635a(true);
    ...
    /* renamed from: b */
    private final void m14636b() {
        this.f19609b.setHint("");
        this.f19610c.setVisibility(8);
        this.f19611d.setVisibility(8);
        this.f19613f.setVisibility(0);
        this.f19609b.removeTextChangedListener(this.f19612e);
        this.f19609b.setText("");
        this.f19609b.clearFocus();
        KeyboardUtils.hideSoftInput(getContext(), this.f19609b);
    }

    /* renamed from: c */
    private final void m14637c() {
        m14633a();
        this.f19613f.setVisibility(8);
        TextWatcher tipTextWatcher = new TipTextWatcher(this);
        this.f19612e = tipTextWatcher;
        this.f19609b.addTextChangedListener(tipTextWatcher);
        KeyboardUtils.showSoftInput(getContext(), this.f19609b);
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public final void m14635a(boolean z) {
        if (z) {
            ((IToolsService) CustomerServiceManager.getService(IToolsService.class)).setTypeface(this.f19610c, IToolsService.FontType.LIGHT);
            ((IToolsService) CustomerServiceManager.getService(IToolsService.class)).setTypeface(this.f19611d, IToolsService.FontType.LIGHT);
            ((IToolsService) CustomerServiceManager.getService(IToolsService.class)).setTypeface(this.f19609b, IToolsService.FontType.LIGHT);
            return;
        }
        ((IToolsService) CustomerServiceManager.getService(IToolsService.class)).setTypeface(this.f19610c, IToolsService.FontType.MEDIUM);
        ((IToolsService) CustomerServiceManager.getService(IToolsService.class)).setTypeface(this.f19611d, IToolsService.FontType.MEDIUM);
        ((IToolsService) CustomerServiceManager.getService(IToolsService.class)).setTypeface(this.f19609b, IToolsService.FontType.MEDIUM);
    }

    @Metadata(mo175977d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\r\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\bH\u0016J*\u0010\t\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000e\u001a\u00020\fH\u0016J*\u0010\u000f\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\u0010\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\fH\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000¨\u0006\u0011"}, mo175978d2 = {"Lcom/didi/entrega/bill/widgets/tip/EditTipItemView$TipTextWatcher;", "Landroid/text/TextWatcher;", "(Lcom/didi/entrega/bill/widgets/tip/EditTipItemView;)V", "isChanged", "", "afterTextChanged", "", "s", "Landroid/text/Editable;", "beforeTextChanged", "", "start", "", "count", "after", "onTextChanged", "before", "entrega-aar_brazilEmbedRelease"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: EditTipItemView.kt */
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (valueOf != null) {
                ...
                if (charSequence == null || charSequence.length() == 0) {
                    this.this$0.m14633a();
                    BillTipEditCallback access$getCallback$p = this.this$0.f19614g;
                ...
                this.this$0.f19610c.setVisibility(0);
                this.this$0.f19610c.setTextColor(ResourceHelper.getColor(R.color.color_333333));
                this.this$0.f19611d.setVisibility(0);
                this.this$0.f19609b.setHint("");
                this.this$0.m14635a(false);
                if (this.this$0.getBillTipModel().isPercent()) {
                    if (Integer.parseInt(obj) > this.this$0.getBillTipModel().getMaxTipFeeRate()) {
                        ...
                        if (obj != null) {
                            ...
                            if (substring != null) {
                                ...
                                this.this$0.f19609b.setText(obj2);
                                this.this$0.f19609b.setSelection(obj.length() - 1);
                                BillTipEditCallback access$getCallback$p2 = this.this$0.f19614g;
                                if (access$getCallback$p2 != null) {
                                    access$getCallback$p2.updateTipAmount(Long.parseLong(obj2), true);
                                }
                                BillTipEditCallback access$getCallback$p3 = this.this$0.f19614g;
                    ...
                    BillTipEditCallback access$getCallback$p4 = this.this$0.f19614g;
                    ...
                    if (obj != null) {
                        ...
                        if (substring2 != null) {
                            ...
                            this.this$0.f19609b.setText(obj3);
                            this.this$0.f19609b.setSelection(obj.length() - 1);
                            BillTipEditCallback access$getCallback$p5 = this.this$0.f19614g;
                            if (access$getCallback$p5 != null) {
                                access$getCallback$p5.updateTipAmount(Long.parseLong(obj3) * ((long) 100), true);
                            }
                            BillTipEditCallback access$getCallback$p6 = this.this$0.f19614g;
                    ...
                    BillTipEditCallback access$getCallback$p7 = this.this$0.f19614g;
