...
class VariableModel implements TreeTableModel {
    ...
    public Object getValue(VariableNode variableNode) {
        try {
            return this.debugger.getObjectProperty(variableNode.object, variableNode.f6666id);
    ...
    private static class VariableNode {
        ...
        public String toString() {
            Object obj = this.f6666id;
            if (obj instanceof String) {
                return (String) obj;
            }
            return Const.jaLeft + ((Integer) this.f6666id).intValue() + Const.jaRight;
        }
    }
}
