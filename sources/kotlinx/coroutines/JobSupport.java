...
public class JobSupport implements ChildJob, Job, ParentJob, SelectClause0 {
    ...
    public JobSupport(boolean z) {
        this._state = z ? JobSupportKt.f61355i : JobSupportKt.f61354h;
    ...
    /* renamed from: a */
    private final Void m45487a(Function1<Object, Unit> function1) {
        while (true) {
    ...
    /* renamed from: a */
    private final Object m45485a(Finishing finishing, Object obj) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && !(!finishing.isSealed())) {
            ...
            synchronized (finishing) {
                ...
                a = m45486a(finishing, (List<? extends Throwable>) sealLocked);
                if (a != null) {
                    m45491a(a, (List<? extends Throwable>) sealLocked);
                }
            }
            if (!(a == null || a == th)) {
            ...
            if (a != null) {
                if (!m45497a(a) && !handleJobException(a)) {
                    z = false;
                }
                if (z) {
                    if (obj != null) {
            ...
            boolean compareAndSet = f61346a.compareAndSet(this, finishing, JobSupportKt.boxIncomplete(obj));
            if (!DebugKt.getASSERTIONS_ENABLED() || compareAndSet) {
                m45504b((Incomplete) finishing, obj);
                return obj;
            }
            throw new AssertionError();
        } else {
    ...
    private final java.lang.Throwable m45486a(kotlinx.coroutines.JobSupport.Finishing r6, java.util.List<? extends java.lang.Throwable> r7) {
        /*
            r5 = this;
        ...
        L_0x006b:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.JobSupport.m45486a(kotlinx.coroutines.JobSupport$Finishing, java.util.List):java.lang.Throwable");
    }

    /* renamed from: a */
    private final void m45491a(Throwable th, List<? extends Throwable> list) {
        if (list.size() > 1) {
    ...
    /* renamed from: a */
    private final boolean m45498a(Incomplete incomplete, Object obj) {
        if (DebugKt.getASSERTIONS_ENABLED()) {
            if (!((incomplete instanceof C21984m) || (incomplete instanceof JobNode))) {
                throw new AssertionError();
            }
        }
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(obj instanceof CompletedExceptionally))) {
            throw new AssertionError();
        } else if (!f61346a.compareAndSet(this, incomplete, JobSupportKt.boxIncomplete(obj))) {
            return false;
        } else {
            onCancelling((Throwable) null);
            onCompletionInternal(obj);
            m45504b(incomplete, obj);
            return true;
        }
    }

    /* renamed from: b */
    private final void m45504b(Incomplete incomplete, Object obj) {
    ...
    /* renamed from: a */
    private final void m45493a(NodeList nodeList, Throwable th) {
        onCancelling(th);
    ...
    /* renamed from: a */
    private final boolean m45497a(Throwable th) {
    ...
    /* renamed from: c */
    private final /* synthetic */ <T extends JobNode> void m45509c(NodeList nodeList, Throwable th) {
        Throwable th2;
        LockFreeLinkedListHead lockFreeLinkedListHead = nodeList;
        CompletionHandlerException completionHandlerException = null;
        for (LockFreeLinkedListNode lockFreeLinkedListNode = (LockFreeLinkedListNode) lockFreeLinkedListHead.getNext(); !Intrinsics.areEqual((Object) lockFreeLinkedListNode, (Object) lockFreeLinkedListHead); lockFreeLinkedListNode = lockFreeLinkedListNode.getNextNode()) {
    ...
    /* renamed from: a */
    private final int m45482a(Object obj) {
        if (obj instanceof C21984m) {
            if (((C21984m) obj).isActive()) {
                return 0;
            }
            if (!f61346a.compareAndSet(this, obj, JobSupportKt.f61355i)) {
                return -1;
            }
            onStart();
            return 1;
            ...
            if (!f61346a.compareAndSet(this, obj, ((InactiveNodeList) obj).getList())) {
                return -1;
            }
            onStart();
            return 1;
    ...
    public final DisposableHandle invokeOnCompletion(boolean z, boolean z2, Function1<? super Throwable, Unit> function1) {
        JobNode a = m45489a(function1, z);
        while (true) {
            Object state$kotlinx_coroutines_core = getState$kotlinx_coroutines_core();
            if (state$kotlinx_coroutines_core instanceof C21984m) {
                C21984m mVar = (C21984m) state$kotlinx_coroutines_core;
                if (!mVar.isActive()) {
                    m45494a(mVar);
                } else if (f61346a.compareAndSet(this, state$kotlinx_coroutines_core, a)) {
                    return a;
                }
            } else {
                Throwable th = null;
                if (state$kotlinx_coroutines_core instanceof Incomplete) {
                    ...
                    if (list != null) {
                        ...
                        if (z && (state$kotlinx_coroutines_core instanceof Finishing)) {
                            synchronized (state$kotlinx_coroutines_core) {
                                ...
                                if (th == null || ((function1 instanceof ChildHandleNode) && !((Finishing) state$kotlinx_coroutines_core).isCompleting())) {
                                    if (m45496a(state$kotlinx_coroutines_core, list, a)) {
                                        if (th == null) {
                        ...
                        } else if (m45496a(state$kotlinx_coroutines_core, list, a)) {
                            return a;
                        }
                    } else if (state$kotlinx_coroutines_core != null) {
                        m45492a((JobNode) state$kotlinx_coroutines_core);
                    } else {
    ...
    /* renamed from: a */
    private final JobNode m45489a(Function1<? super Throwable, Unit> function1, boolean z) {
    ...
    /* renamed from: a */
    private final boolean m45496a(Object obj, NodeList nodeList, JobNode jobNode) {
        int tryCondAddNext;
    ...
    /* renamed from: a */
    private final void m45494a(C21984m mVar) {
        NodeList nodeList = new NodeList();
        f61346a.compareAndSet(this, mVar, mVar.isActive() ? nodeList : new InactiveNodeList(nodeList));
    }

    /* renamed from: a */
    private final void m45492a(JobNode jobNode) {
        jobNode.addOneIfEmpty(new NodeList());
        f61346a.compareAndSet(this, jobNode, jobNode.getNextNode());
    }
    ...
    public final boolean cancelImpl$kotlinx_coroutines_core(Object obj) {
        Object access$getCOMPLETING_ALREADY$p = JobSupportKt.f61347a;
        if (getOnCancelComplete$kotlinx_coroutines_core() && (access$getCOMPLETING_ALREADY$p = m45501b(obj)) == JobSupportKt.COMPLETING_WAITING_CHILDREN) {
            return true;
        }
        if (access$getCOMPLETING_ALREADY$p == JobSupportKt.f61347a) {
            access$getCOMPLETING_ALREADY$p = m45511d(obj);
        }
        if (access$getCOMPLETING_ALREADY$p == JobSupportKt.f61347a || access$getCOMPLETING_ALREADY$p == JobSupportKt.COMPLETING_WAITING_CHILDREN) {
            return true;
        }
        if (access$getCOMPLETING_ALREADY$p == JobSupportKt.f61349c) {
            return false;
        }
    ...
    public CancellationException getChildJobCancellationCause() {
        ...
        return cancellationException == null ? new JobCancellationException(Intrinsics.stringPlus("Parent job is ", m45513f(state$kotlinx_coroutines_core)), th, this) : cancellationException;
    }

    /* renamed from: c */
    private final Throwable m45508c(Object obj) {
    ...
    /* renamed from: a */
    private final NodeList m45490a(Incomplete incomplete) {
        NodeList list = incomplete.getList();
        if (list != null) {
            return list;
        }
        if (incomplete instanceof C21984m) {
            return new NodeList();
        }
        if (incomplete instanceof JobNode) {
            m45492a((JobNode) incomplete);
            return null;
        }
    ...
    /* renamed from: a */
    private final boolean m45499a(Incomplete incomplete, Throwable th) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(incomplete instanceof Finishing))) {
            ...
            NodeList a = m45490a(incomplete);
            if (a == null) {
                return false;
            }
            if (!f61346a.compareAndSet(this, incomplete, new Finishing(a, false, th))) {
                return false;
            }
            m45493a(a, th);
            return true;
    ...
    /* renamed from: a */
    private final Object m45483a(Object obj, Object obj2) {
        if (!(obj instanceof Incomplete)) {
            return JobSupportKt.f61347a;
        }
        if ((!(obj instanceof C21984m) && !(obj instanceof JobNode)) || (obj instanceof ChildHandleNode) || (obj2 instanceof CompletedExceptionally)) {
            return m45507c((Incomplete) obj, obj2);
        }
        if (m45498a((Incomplete) obj, obj2)) {
            return obj2;
        }
        return JobSupportKt.f61348b;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x0082, code lost:
        if (m45500a(r1, r7, r8) == false) goto L_0x0087;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x008b, code lost:
        return m45485a(r1, r8);
     */
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final java.lang.Object m45507c(kotlinx.coroutines.Incomplete r7, java.lang.Object r8) {
        /*
            r6 = this;
            kotlinx.coroutines.NodeList r0 = r6.m45490a((kotlinx.coroutines.Incomplete) r7)
            if (r0 != 0) goto L_0x000b
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.JobSupportKt.f61348b
            return r7
        L_0x000b:
        ...
        L_0x001d:
            ...
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.JobSupportKt.f61347a     // Catch:{ all -> 0x008c }
            monitor-exit(r1)
            return r7
        L_0x002a:
            r3 = 1
            ...
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r4 = f61346a     // Catch:{ all -> 0x008c }
            boolean r4 = r4.compareAndSet(r6, r7, r1)     // Catch:{ all -> 0x008c }
            if (r4 != 0) goto L_0x003e
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.JobSupportKt.f61348b     // Catch:{ all -> 0x008c }
            monitor-exit(r1)
            return r7
        L_0x003e:
        ...
        L_0x006f:
            ...
            goto L_0x0078
        L_0x0075:
            r6.m45493a((kotlinx.coroutines.NodeList) r0, (java.lang.Throwable) r2)
        L_0x0078:
            kotlinx.coroutines.ChildHandleNode r7 = r6.m45503b((kotlinx.coroutines.Incomplete) r7)
            if (r7 == 0) goto L_0x0087
            boolean r7 = r6.m45500a((kotlinx.coroutines.JobSupport.Finishing) r1, (kotlinx.coroutines.ChildHandleNode) r7, (java.lang.Object) r8)
            if (r7 == 0) goto L_0x0087
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.JobSupportKt.COMPLETING_WAITING_CHILDREN
            return r7
        L_0x0087:
            java.lang.Object r7 = r6.m45485a((kotlinx.coroutines.JobSupport.Finishing) r1, (java.lang.Object) r8)
            return r7
        L_0x008c:
            r7 = move-exception
            monitor-exit(r1)
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.JobSupport.m45507c(kotlinx.coroutines.Incomplete, java.lang.Object):java.lang.Object");
    }

    /* renamed from: e */
    private final Throwable m45512e(Object obj) {
        CompletedExceptionally completedExceptionally = obj instanceof CompletedExceptionally ? (CompletedExceptionally) obj : null;
        if (completedExceptionally == null) {
            return null;
        }
    ...
    /* renamed from: b */
    private final ChildHandleNode m45503b(Incomplete incomplete) {
        ...
        return m45488a((LockFreeLinkedListNode) list);
    }

    /* renamed from: a */
    private final boolean m45500a(Finishing finishing, ChildHandleNode childHandleNode, Object obj) {
        while (Job.DefaultImpls.invokeOnCompletion$default(childHandleNode.childJob, false, false, new ChildCompletion(this, finishing, childHandleNode, obj), 1, (Object) null) == NonDisposableHandle.INSTANCE) {
            childHandleNode = m45488a((LockFreeLinkedListNode) childHandleNode);
            if (childHandleNode == null) {
                return false;
            }
        }
    ...
    /* renamed from: b */
    public final void m45505b(Finishing finishing, ChildHandleNode childHandleNode, Object obj) {
        if (DebugKt.getASSERTIONS_ENABLED()) {
            if (!(getState$kotlinx_coroutines_core() == finishing)) {
                throw new AssertionError();
            }
        }
        ChildHandleNode a = m45488a((LockFreeLinkedListNode) childHandleNode);
        if (a == null || !m45500a(finishing, a, obj)) {
            afterCompletion(m45485a(finishing, obj));
        }
    }

    /* renamed from: a */
    private final ChildHandleNode m45488a(LockFreeLinkedListNode lockFreeLinkedListNode) {
    ...
    public final String toDebugString() {
        return nameString$kotlinx_coroutines_core() + '{' + m45513f(getState$kotlinx_coroutines_core()) + '}';
    }
    ...
    /* renamed from: f */
    private final String m45513f(Object obj) {
    ...
    @Metadata(mo175977d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\b\u0013\n\u0002\u0018\u0002\n\u0002\u0018\u0002\b\u0002\u0018\u00002\u00060\u0018j\u0002`,2\u00020-B!\u0012\u0006\u0010\u0002\u001a\u00020\u0001\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\u0007\u0010\bJ\u0015\u0010\u000b\u001a\u00020\n2\u0006\u0010\t\u001a\u00020\u0005¢\u0006\u0004\b\u000b\u0010\fJ\u001f\u0010\u000f\u001a\u0012\u0012\u0004\u0012\u00020\u00050\rj\b\u0012\u0004\u0012\u00020\u0005`\u000eH\u0002¢\u0006\u0004\b\u000f\u0010\u0010J\u001d\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00050\u00122\b\u0010\u0011\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\u0013\u0010\u0014J\u000f\u0010\u0016\u001a\u00020\u0015H\u0016¢\u0006\u0004\b\u0016\u0010\u0017R(\u0010\u001e\u001a\u0004\u0018\u00010\u00182\b\u0010\u0019\u001a\u0004\u0018\u00010\u00188B@BX\u000e¢\u0006\f\u001a\u0004\b\u001a\u0010\u001b\"\u0004\b\u001c\u0010\u001dR\u0014\u0010\u001f\u001a\u00020\u00038VX\u0004¢\u0006\u0006\u001a\u0004\b\u001f\u0010 R\u0011\u0010!\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b!\u0010 R$\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0019\u001a\u00020\u00038F@FX\u000e¢\u0006\f\u001a\u0004\b\u0004\u0010 \"\u0004\b\"\u0010#R\u0011\u0010$\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b$\u0010 R\u001a\u0010\u0002\u001a\u00020\u00018\u0016X\u0004¢\u0006\f\n\u0004\b\u0002\u0010%\u001a\u0004\b&\u0010'R(\u0010\u0006\u001a\u0004\u0018\u00010\u00052\b\u0010\u0019\u001a\u0004\u0018\u00010\u00058F@FX\u000e¢\u0006\f\u001a\u0004\b(\u0010)\"\u0004\b*\u0010\f¨\u0006+"}, mo175978d2 = {"Lkotlinx/coroutines/JobSupport$Finishing;", "Lkotlinx/coroutines/NodeList;", "list", "", "isCompleting", "", "rootCause", "<init>", "(Lkotlinx/coroutines/NodeList;ZLjava/lang/Throwable;)V", "exception", "", "addExceptionLocked", "(Ljava/lang/Throwable;)V", "Ljava/util/ArrayList;", "Lkotlin/collections/ArrayList;", "allocateList", "()Ljava/util/ArrayList;", "proposedException", "", "sealLocked", "(Ljava/lang/Throwable;)Ljava/util/List;", "", "toString", "()Ljava/lang/String;", "", "value", "getExceptionsHolder", "()Ljava/lang/Object;", "setExceptionsHolder", "(Ljava/lang/Object;)V", "exceptionsHolder", "isActive", "()Z", "isCancelling", "setCompleting", "(Z)V", "isSealed", "Lkotlinx/coroutines/NodeList;", "getList", "()Lkotlinx/coroutines/NodeList;", "getRootCause", "()Ljava/lang/Throwable;", "setRootCause", "kotlinx-coroutines-core", "Lkotlinx/coroutines/internal/SynchronizedObject;", "Lkotlinx/coroutines/Incomplete;"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: JobSupport.kt */
    private static final class Finishing implements Incomplete {
        ...
        public final boolean isSealed() {
            return getExceptionsHolder() == JobSupportKt.f61353g;
        }
        ...
        public final List<Throwable> sealLocked(Throwable th) {
            ...
            setExceptionsHolder(JobSupportKt.f61353g);
            return arrayList;
        }
    ...
    /* renamed from: c */
    private final boolean m45510c(Incomplete incomplete) {
        return (incomplete instanceof Finishing) && ((Finishing) incomplete).isCancelling();
    }

    @Metadata(mo175977d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0002\u0018\u00002\u00020\u0001B'\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\b\u0010\b\u001a\u0004\u0018\u00010\t¢\u0006\u0002\u0010\nJ\u0013\u0010\u000b\u001a\u00020\f2\b\u0010\r\u001a\u0004\u0018\u00010\u000eH\u0002R\u000e\u0010\u0006\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u0004\u0018\u00010\tX\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, mo175978d2 = {"Lkotlinx/coroutines/JobSupport$ChildCompletion;", "Lkotlinx/coroutines/JobNode;", "parent", "Lkotlinx/coroutines/JobSupport;", "state", "Lkotlinx/coroutines/JobSupport$Finishing;", "child", "Lkotlinx/coroutines/ChildHandleNode;", "proposedUpdate", "", "(Lkotlinx/coroutines/JobSupport;Lkotlinx/coroutines/JobSupport$Finishing;Lkotlinx/coroutines/ChildHandleNode;Ljava/lang/Object;)V", "invoke", "", "cause", "", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: JobSupport.kt */
    private static final class ChildCompletion extends JobNode {
        ...
        public void invoke(Throwable th) {
            this.parent.m45505b(this.state, this.child, this.proposedUpdate);
        }
    }

    @Metadata(mo175977d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0002\u0018\u0000*\u0004\b\u0000\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B\u001b\u0012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00000\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0010\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016J\b\u0010\f\u001a\u00020\rH\u0014R\u000e\u0010\u0005\u001a\u00020\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\u000e"}, mo175978d2 = {"Lkotlinx/coroutines/JobSupport$AwaitContinuation;", "T", "Lkotlinx/coroutines/CancellableContinuationImpl;", "delegate", "Lkotlin/coroutines/Continuation;", "job", "Lkotlinx/coroutines/JobSupport;", "(Lkotlin/coroutines/Continuation;Lkotlinx/coroutines/JobSupport;)V", "getContinuationCancellationCause", "", "parent", "Lkotlinx/coroutines/Job;", "nameString", "", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: JobSupport.kt */
    ...
    public final Throwable getCompletionExceptionOrNull() {
        Object state$kotlinx_coroutines_core = getState$kotlinx_coroutines_core();
        if (!(state$kotlinx_coroutines_core instanceof Incomplete)) {
            return m45512e(state$kotlinx_coroutines_core);
        }
        ...
        do {
            ...
            if (!(state$kotlinx_coroutines_core instanceof Incomplete)) {
                ...
                if (!DebugKt.getRECOVER_STACK_TRACES()) {
                    ...
                    throw StackTraceRecoveryKt.m45986a(th, (CoroutineStackFrame) continuation);
                }
            }
        } while (m45482a(state$kotlinx_coroutines_core) < 0);
        return m45502b(continuation);
    }

    /* access modifiers changed from: private */
    /* renamed from: b */
    public final Object m45502b(Continuation<Object> continuation) {
        AwaitContinuation awaitContinuation = new AwaitContinuation(IntrinsicsKt.intercepted(continuation), this);
        awaitContinuation.initCancellability();
        CancellableContinuationKt.disposeOnCancellation(awaitContinuation, invokeOnCompletion(new C22002w(awaitContinuation)));
    ...
    /* renamed from: b */
    private final void m45506b(NodeList nodeList, Throwable th) {
        LockFreeLinkedListHead lockFreeLinkedListHead = nodeList;
        CompletionHandlerException completionHandlerException = null;
        for (LockFreeLinkedListNode lockFreeLinkedListNode = (LockFreeLinkedListNode) lockFreeLinkedListHead.getNext(); !Intrinsics.areEqual((Object) lockFreeLinkedListNode, (Object) lockFreeLinkedListHead); lockFreeLinkedListNode = lockFreeLinkedListNode.getNextNode()) {
    ...
    public final boolean start() {
        int a;
        do {
            a = m45482a(getState$kotlinx_coroutines_core());
            if (a == 0) {
                return false;
            }
        } while (a != 1);
    ...
    /* renamed from: a */
    private final boolean mo180739a() {
        Object state$kotlinx_coroutines_core;
        do {
            state$kotlinx_coroutines_core = getState$kotlinx_coroutines_core();
            if (!(state$kotlinx_coroutines_core instanceof Incomplete)) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public final Object m45484a(Continuation<? super Unit> continuation) {
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        cancellableContinuationImpl.initCancellability();
        CancellableContinuation cancellableContinuation = cancellableContinuationImpl;
        CancellableContinuationKt.disposeOnCancellation(cancellableContinuation, invokeOnCompletion(new C22003x(cancellableContinuation)));
    ...
    public final <R> void registerSelectClause0(SelectInstance<? super R> selectInstance, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        ...
        selectInstance.disposeOnSelect(invokeOnCompletion(new C21819aa(selectInstance, function1)));
    }
    ...
    public final void removeNode$kotlinx_coroutines_core(kotlinx.coroutines.JobNode r4) {
        ...
        L_0x0000:
            ...
            return
        L_0x000b:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r1 = f61346a
            kotlinx.coroutines.m r2 = kotlinx.coroutines.JobSupportKt.f61355i
    ...
    /* renamed from: b */
    private final Object m45501b(Object obj) {
        Object a;
        do {
            Object state$kotlinx_coroutines_core = getState$kotlinx_coroutines_core();
            ...
            a = m45483a(state$kotlinx_coroutines_core, (Object) new CompletedExceptionally(m45508c(obj), false, 2, (DefaultConstructorMarker) null));
        } while (a == JobSupportKt.f61348b);
        return a;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0041, code lost:
        m45493a(((kotlinx.coroutines.JobSupport.Finishing) r2).getList(), r0);
     */
    ...
    /* renamed from: d */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final java.lang.Object m45511d(java.lang.Object r7) {
        /*
            r6 = this;
            r0 = 0
            r1 = r0
        L_0x0002:
            ...
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.JobSupportKt.f61349c     // Catch:{ all -> 0x004f }
            monitor-exit(r2)
            return r7
        L_0x001a:
            r3 = r2
        ...
        L_0x0025:
            ...
            java.lang.Throwable r1 = r6.m45508c((java.lang.Object) r7)     // Catch:{ all -> 0x004f }
        L_0x002b:
            r7 = r2
        ...
        L_0x0041:
            ...
            r6.m45493a((kotlinx.coroutines.NodeList) r7, (java.lang.Throwable) r0)
        L_0x004a:
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.JobSupportKt.f61347a
            return r7
        L_0x004f:
            r7 = move-exception
            monitor-exit(r2)
        ...
        L_0x0052:
            ...
            java.lang.Throwable r1 = r6.m45508c((java.lang.Object) r7)
        L_0x005c:
            r3 = r2
            kotlinx.coroutines.Incomplete r3 = (kotlinx.coroutines.Incomplete) r3
            boolean r4 = r3.isActive()
            if (r4 == 0) goto L_0x0070
            boolean r2 = r6.m45499a((kotlinx.coroutines.Incomplete) r3, (java.lang.Throwable) r1)
        ...
        L_0x0070:
            ...
            r5 = 2
            r3.<init>(r1, r4, r5, r0)
            java.lang.Object r3 = r6.m45483a((java.lang.Object) r2, (java.lang.Object) r3)
            kotlinx.coroutines.internal.Symbol r4 = kotlinx.coroutines.JobSupportKt.f61347a
            if (r3 == r4) goto L_0x008a
            kotlinx.coroutines.internal.Symbol r2 = kotlinx.coroutines.JobSupportKt.f61348b
        ...
        L_0x008a:
            ...
            throw r0
        L_0x009c:
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.JobSupportKt.f61349c
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.JobSupport.m45511d(java.lang.Object):java.lang.Object");
    }

    public final boolean makeCompleting$kotlinx_coroutines_core(Object obj) {
        Object a;
        do {
            a = m45483a(getState$kotlinx_coroutines_core(), obj);
            if (a == JobSupportKt.f61347a) {
                return false;
            }
    ...
    public final Object makeCompletingOnce$kotlinx_coroutines_core(Object obj) {
        ...
        do {
            a = m45483a(getState$kotlinx_coroutines_core(), obj);
            if (a == JobSupportKt.f61347a) {
                throw new IllegalStateException("Job " + this + " is already complete or completing, but is being completed with " + obj, m45512e(obj));
            }
        } while (a == JobSupportKt.f61348b);
        return a;
    }
    ...
    public final <T, R> void registerSelectClause1Internal$kotlinx_coroutines_core(SelectInstance<? super R> selectInstance, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        ...
        selectInstance.disposeOnSelect(invokeOnCompletion(new C22005z(selectInstance, function2)));
    }
}
