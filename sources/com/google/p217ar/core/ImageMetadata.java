...
public class ImageMetadata {
    ...
    private final C18627a sketchEntry;

    /* renamed from: com.google.ar.core.ImageMetadata$a */
    static class C18627a {
    ...
    public byte getByte(int i) {
        ...
        if (this.sketchEntry.f53446b == 0 && this.sketchEntry.f53447c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public int getInt(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 1 && this.sketchEntry.f53447c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public float getFloat(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 2 && this.sketchEntry.f53447c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public long getLong(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 3 && this.sketchEntry.f53447c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            return nativeGetLongFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", new Object[]{Integer.valueOf(i), Integer.valueOf(this.sketchEntry.f53446b), Integer.valueOf(this.sketchEntry.f53447c)}));
    }

    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 4 && this.sketchEntry.f53447c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public Rational getRational(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 5 && this.sketchEntry.f53447c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public byte[] getByteArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public int[] getIntArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public float[] getFloatArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public long[] getLongArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public double[] getDoubleArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    public Rational[] getRationalArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f53446b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f53445a);
    ...
    private void getMetdataEntry(int i, C18627a aVar) {
        aVar.f53445a = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        if (aVar.f53445a != 0) {
            aVar.f53446b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, aVar.f53445a);
            aVar.f53447c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, aVar.f53445a);
            return;
        }
