...
public final class StarProjectionImplKt {
    /* renamed from: a */
    private static final KotlinType m45041a(List<? extends TypeConstructor> list, List<? extends KotlinType> list2, KotlinBuiltIns kotlinBuiltIns) {
    ...
    public static final KotlinType starProjectionType(TypeParameterDescriptor typeParameterDescriptor) {
        ...
        if (containingDeclaration instanceof ClassifierDescriptorWithTypeParameters) {
            ...
            return m45041a((List) arrayList, upperBounds, DescriptorUtilsKt.getBuiltIns(typeParameterDescriptor));
            ...
            return m45041a((List) arrayList2, upperBounds2, DescriptorUtilsKt.getBuiltIns(typeParameterDescriptor));
        } else {
