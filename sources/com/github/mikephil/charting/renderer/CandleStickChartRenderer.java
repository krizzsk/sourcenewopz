...
public class CandleStickChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    /* renamed from: a */
    private float[] f52461a = new float[8];

    /* renamed from: b */
    private float[] f52462b = new float[4];

    /* renamed from: c */
    private float[] f52463c = new float[4];

    /* renamed from: d */
    private float[] f52464d = new float[4];

    /* renamed from: e */
    private float[] f52465e = new float[4];
        ...
        for (int i6 = this.mXBounds.min; i6 <= this.mXBounds.range + this.mXBounds.min; i6++) {
            ...
            if (candleEntry == null) {
                ...
                if (showCandleBar) {
                    ...
                    transformer.pointValuesToPixel(this.f52461a);
                    ...
                    canvas.drawLines(this.f52461a, this.mRenderPaint);
                    float[] fArr2 = this.f52462b;
                    ...
                    if (i7 > 0) {
                        ...
                        float[] fArr5 = this.f52462b;
                        canvas.drawLine(fArr5[0], fArr5[1], fArr5[2], fArr5[3], this.mRenderPaint);
                    }
                } else {
                    Canvas canvas3 = canvas;
                    float[] fArr6 = this.f52463c;
                    fArr6[0] = x;
                    fArr6[1] = high * phaseY;
                    fArr6[2] = x;
                    fArr6[3] = low * phaseY;
                    float[] fArr7 = this.f52464d;
                    fArr7[0] = (x - 0.5f) + barSpace;
                    float f = open * phaseY;
                    fArr7[1] = f;
                    fArr7[2] = x;
                    fArr7[3] = f;
                    float[] fArr8 = this.f52465e;
                    ...
                    transformer.pointValuesToPixel(this.f52464d);
                    transformer.pointValuesToPixel(this.f52465e);
                    if (open > close) {
                        if (iCandleDataSet.getDecreasingColor() == 1122867) {
                    ...
                    while (i2 < generateTransformedValuesCandle.length) {
                        ...
                        if (!this.mViewPortHandler.isInBoundsLeft(f2) || !this.mViewPortHandler.isInBoundsY(f3)) {
                            ...
                            if (candleEntry.getIcon() != null && iCandleDataSet.isDrawIconsEnabled()) {
                                ...
                                Utils.drawImage(canvas, icon, (int) (f2 + instance.f52498x), (int) (f + instance.f52499y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                            }
                        }
                        i2 += 2;
        ...
        for (Highlight highlight : highlightArr) {
            ...
            if (iCandleDataSet != null && iCandleDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(candleEntry, iCandleDataSet)) {
                    ...
                    drawHighlightLines(canvas, (float) pixelForValues.f52495x, (float) pixelForValues.f52496y, iCandleDataSet);
                }
            }
        }
    }
