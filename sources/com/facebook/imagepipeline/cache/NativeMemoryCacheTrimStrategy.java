...
public class NativeMemoryCacheTrimStrategy implements CountingMemoryCache.CacheTrimStrategy {
    ...
    static /* synthetic */ class C176491 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.cache.NativeMemoryCacheTrimStrategy.C176491.<clinit>():void");
        }
    }

    public double getTrimRatio(MemoryTrimType memoryTrimType) {
        int i = C176491.$SwitchMap$com$facebook$common$memory$MemoryTrimType[memoryTrimType.ordinal()];
        if (i == 1) {
            return 0.0d;
        }
        if (i == 2 || i == 3 || i == 4) {
