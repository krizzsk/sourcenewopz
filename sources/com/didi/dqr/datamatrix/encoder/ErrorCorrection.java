...
public final class ErrorCorrection {
    ...
    public static String encodeECC200(String str, SymbolInfo symbolInfo) {
        if (str.length() == symbolInfo.getDataCapacity()) {
            ...
            if (interleavedBlockCount == 1) {
                sb.append(m13808a(str, symbolInfo.getErrorCodewords()));
            } else {
                ...
                for (int i3 = 0; i3 < interleavedBlockCount; i3++) {
                    ...
                    String a = m13808a(sb2.toString(), iArr2[i3]);
                    int i5 = i3;
                    int i6 = 0;
    ...
    /* renamed from: a */
    private static String m13808a(CharSequence charSequence, int i) {
        int i2 = 0;
        while (true) {
            int[] iArr = f18615a;
            if (i2 >= iArr.length) {
