...
public final class ObservableZip<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    final ObservableSource<? extends T>[] f59020a;

    /* renamed from: b */
    final Iterable<? extends ObservableSource<? extends T>> f59021b;

    /* renamed from: c */
    final Function<? super Object[], ? extends R> f59022c;
    ...
    public ObservableZip(ObservableSource<? extends T>[] observableSourceArr, Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i, boolean z) {
        this.f59020a = observableSourceArr;
        this.f59021b = iterable;
        this.f59022c = function;
        this.f59023d = i;
        this.f59024e = z;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        int i;
        ObservableSource<? extends T>[] observableSourceArr = this.f59020a;
        if (observableSourceArr == null) {
            observableSourceArr = new Observable[8];
            i = 0;
            for (ObservableSource<? extends T> observableSource : this.f59021b) {
        ...
        if (i == 0) {
            ...
            new ZipCoordinator(observer, this.f59022c, i, this.f59024e).subscribe(observableSourceArr, this.f59023d);
        }
    }
