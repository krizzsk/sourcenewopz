...
public final class ObservableDistinct<T, K> extends C21211a<T, T> {

    /* renamed from: a */
    final Function<? super T, K> f58789a;

    /* renamed from: b */
    final Callable<? extends Collection<? super K>> f58790b;
    ...
    public ObservableDistinct(ObservableSource<T> observableSource, Function<? super T, K> function, Callable<? extends Collection<? super K>> callable) {
        ...
        this.f58789a = function;
        this.f58790b = callable;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super T> observer) {
        try {
            this.source.subscribe(new DistinctObserver(observer, this.f58789a, (Collection) ObjectHelper.requireNonNull(this.f58790b.call(), "The collectionSupplier returned a null collection. Null values are generally not allowed in 2.x operators and sources.")));
        } catch (Throwable th) {
    ...
    static final class DistinctObserver<T, K> extends BasicFuseableObserver<T, T> {
        ...
        public T poll() throws java.lang.Exception {
            /*
                r4 = this;
            L_0x0000:
                io.reactivex.internal.fuseable.QueueDisposable r0 = r4.f58052qd
                ...
                java.lang.Object r2 = p242io.reactivex.internal.functions.ObjectHelper.requireNonNull(r2, (java.lang.String) r3)
                boolean r1 = r1.add(r2)
                if (r1 == 0) goto L_0x0000
            L_0x001c:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableDistinct.DistinctObserver.poll():java.lang.Object");
        }
