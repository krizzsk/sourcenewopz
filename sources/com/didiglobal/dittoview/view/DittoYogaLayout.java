...
public class DittoYogaLayout extends YogaLayout implements IParser, IView {
    ...
    /* renamed from: b */
    private YogaNode f49964b;

    /* renamed from: c */
    private boolean f49965c;

    /* renamed from: d */
    private Path f49966d;

    /* renamed from: e */
    private Paint f49967e;

    /* renamed from: f */
    private RectF f49968f;

    /* renamed from: g */
    private float f49969g;

    /* renamed from: h */
    private float[] f49970h;
    ...
    /* renamed from: l */
    private float f49974l;

    /* renamed from: m */
    private float f49975m;

    /* renamed from: n */
    private float f49976n;

    /* renamed from: o */
    private RectF f49977o;
    ...
    /* renamed from: t */
    private boolean f49982t;

    /* renamed from: u */
    private float f49983u;

    /* renamed from: v */
    private float f49984v;

    /* renamed from: w */
    private float f49985w;

    /* renamed from: x */
    private float f49986x;

    /* renamed from: y */
    private float f49987y;

    /* renamed from: z */
    private Paint f49988z;
    ...
    public DittoYogaLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f49970h = new float[8];
        this.f49971i = false;
        this.f49977o = new RectF();
        this.f49982t = false;
        this.f49984v = -1.0f;
        this.f49985w = -1.0f;
        this.f49986x = -1.0f;
        ...
        this.f49964b = getYogaNode();
        this.f49968f = new RectF();
        this.f49966d = new Path();
        Paint paint = new Paint();
        this.f49967e = paint;
        paint.setAntiAlias(true);
        this.f49967e.setColor(0);
        this.f49967e.setStyle(Paint.Style.STROKE);
    }
    ...
    public void parse(XmlPullParser xmlPullParser) {
        ...
        if (!TextUtils.isEmpty(attributeValue)) {
            this.f49964b.setFlexDirection(getFlexDirection(attributeValue));
        }
        if (!TextUtils.isEmpty(attributeValue2)) {
            this.f49964b.setWrap(getFlexWrap(attributeValue2));
        }
        if (!TextUtils.isEmpty(attributeValue3)) {
            this.f49964b.setJustifyContent(getJustifyContent(attributeValue3));
        }
        if (!TextUtils.isEmpty(attributeValue4)) {
            this.f49964b.setAlignItems(getAlignItems(attributeValue4));
        }
        if (!TextUtils.isEmpty(attributeValue5)) {
            this.f49964b.setAlignContent(getAlignContent(attributeValue5));
        }
    }
    ...
    public void parse(java.lang.String r2, java.lang.String r3, com.facebook.yoga.YogaNode r4) {
        ...
        L_0x008d:
            ...
            goto L_0x00c7
        L_0x0096:
            com.facebook.yoga.YogaNode r2 = r1.f49964b
    ...
    public void setBorder(DittoBorder dittoBorder) {
        ...
        this.f49969g = borderWidth;
        this.f49967e.setStrokeWidth(borderWidth);
        this.f49967e.setColor(dittoBorder.getBorderColor());
    }

    /* access modifiers changed from: protected */
    public void dispatchDraw(Canvas canvas) {
        if (this.f49971i || this.f49982t) {
            this.f49977o.left = (float) this.f49978p;
            this.f49977o.top = (float) this.f49979q;
            this.f49977o.right = (float) (getWidth() - this.f49980r);
            this.f49977o.bottom = (float) (getHeight() - this.f49981s);
            int i = (int) (this.f49977o.bottom - this.f49977o.top);
            if (this.f49984v == -1.0f && this.f49986x == -1.0f && this.f49985w == -1.0f && this.f49987y == -1.0f) {
                Path path = new Path();
                float f = this.f49983u;
                float f2 = (float) (i / 2);
                if (f > f2) {
                    path.addRoundRect(this.f49977o, f2, f2, Path.Direction.CW);
                } else {
                    path.addRoundRect(this.f49977o, f, f, Path.Direction.CW);
                }
                canvas.clipPath(path);
            } else {
                float[] cornerValue = getCornerValue(i);
                Path path2 = new Path();
                path2.addRoundRect((float) this.f49978p, (float) this.f49979q, (float) (getWidth() - this.f49980r), (float) (getHeight() - this.f49981s), cornerValue, Path.Direction.CW);
        ...
        if (this.f49965c) {
            this.f49966d.reset();
            this.f49968f.left = this.f49969g / 2.0f;
            this.f49968f.top = this.f49969g / 2.0f;
            this.f49968f.right = ((float) getMeasuredWidth()) - (this.f49969g / 2.0f);
            this.f49968f.bottom = ((float) getMeasuredHeight()) - (this.f49969g / 2.0f);
            this.f49966d.addRoundRect(this.f49968f, this.f49970h, Path.Direction.CW);
            canvas.drawPath(this.f49966d, this.f49967e);
        }
    }

    public void setCorner(DittoCorner dittoCorner) {
        float[] fArr = this.f49970h;
        float leftTopCorner = dittoCorner.getLeftTopCorner();
        fArr[1] = leftTopCorner;
        fArr[0] = leftTopCorner;
        float[] fArr2 = this.f49970h;
        float rightTopCorner = dittoCorner.getRightTopCorner();
        fArr2[3] = rightTopCorner;
        fArr2[2] = rightTopCorner;
        float[] fArr3 = this.f49970h;
        float rightBottomCorner = dittoCorner.getRightBottomCorner();
        fArr3[5] = rightBottomCorner;
        fArr3[4] = rightBottomCorner;
        float[] fArr4 = this.f49970h;
        ...
        if (!dittoCorner.isEmpty) {
            this.f49982t = true;
            this.f49983u = dittoCorner.getCornerRadius();
        }
    }
    ...
    public void setShadow(DittoShadow dittoShadow) {
        this.f49971i = true;
        this.f49973k = dittoShadow.getShadowRadius();
        this.f49972j = dittoShadow.getShadowColor();
        this.f49975m = dittoShadow.getShadowOffsetX();
        this.f49976n = dittoShadow.getShadowOffsetY();
        this.f49974l = dittoShadow.getShadowOpacity();
        float abs = Math.abs(this.f49975m);
        int i = this.f49973k;
        if (abs > ((float) i)) {
            if (this.f49975m > 0.0f) {
                this.f49975m = (float) i;
            } else {
                this.f49975m = (float) (-i);
            }
        }
        float abs2 = Math.abs(this.f49976n);
        int i2 = this.f49973k;
        if (abs2 > ((float) i2)) {
            if (this.f49976n > 0.0f) {
                this.f49976n = (float) i2;
            } else {
                this.f49976n = (float) (-i2);
            }
        }
    ...
    /* renamed from: a */
    private void m36002a() {
        Paint paint = new Paint();
        this.f49988z = paint;
        paint.setStyle(Paint.Style.FILL);
        this.f49988z.setDither(true);
        this.f49988z.setAntiAlias(true);
        this.f49988z.setAlpha((int) (this.f49974l * 255.0f));
    }

    /* renamed from: a */
    private void m36003a(int i, int i2) {
        if (this.f49971i) {
            BitmapDrawable bitmapDrawable = new BitmapDrawable(m36001a(i, i2, this.f49983u, (float) this.f49973k, this.f49975m, this.f49976n, this.f49972j, -1));
    ...
    public void setPadding() {
        if (this.f49971i) {
            int abs = this.f49973k + ((int) Math.abs(this.f49975m));
            int abs2 = this.f49973k + ((int) Math.abs(this.f49976n));
            this.f49978p = abs;
            this.f49979q = abs2;
            this.f49980r = abs;
            this.f49981s = abs2;
    ...
    /* renamed from: a */
    private Bitmap m36001a(int i, int i2, float f, float f2, float f3, float f4, int i3, int i4) {
        int i5;
        int i6;
        int i7;
        int i8;
        ...
        this.f49988z.setColor(i4);
        if (!isInEditMode()) {
            this.f49988z.setShadowLayer(f8 / 2.0f, f5, f6, i3);
        }
        if (this.f49986x == -1.0f && this.f49984v == -1.0f && this.f49985w == -1.0f && this.f49987y == -1.0f) {
            canvas.drawRoundRect(rectF, f7, f7, this.f49988z);
        } else {
            this.f49977o.left = (float) this.f49978p;
            this.f49977o.top = (float) this.f49979q;
            this.f49977o.right = (float) (getWidth() - this.f49980r);
            this.f49977o.bottom = (float) (getHeight() - this.f49981s);
            float f9 = this.f49984v;
            if (f9 == -1.0f) {
                i5 = ((int) this.f49983u) / 4;
            } else {
                i5 = ((int) f9) / 4;
            }
            float f10 = this.f49986x;
            if (f10 == -1.0f) {
                i6 = ((int) this.f49983u) / 4;
            } else {
                i6 = ((int) f10) / 4;
            }
            float f11 = this.f49985w;
            if (f11 == -1.0f) {
                i7 = ((int) this.f49983u) / 4;
            } else {
                i7 = ((int) f11) / 4;
            }
            float f12 = this.f49987y;
            if (f12 == -1.0f) {
                i8 = ((int) this.f49983u) / 4;
            } else {
                i8 = ((int) f12) / 4;
            }
            float f13 = (float) i5;
            ...
            canvas.drawPath(path, this.f49988z);
        }
        return createBitmap;
    }

    public float[] getCornerValue(int i) {
        float f = this.f49984v;
        if (f == -1.0f) {
            f = this.f49983u;
        }
        int i2 = (int) f;
        ...
        float f4 = this.f49986x;
        int i6 = f4 == -1.0f ? (int) this.f49983u : (int) f4;
        if (i6 <= i3) {
            i3 = i6;
        }
        float f5 = (float) i2;
