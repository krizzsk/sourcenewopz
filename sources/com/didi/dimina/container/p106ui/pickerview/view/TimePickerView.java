...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    /* renamed from: b */
    private static final String f17614b = "submit";

    /* renamed from: c */
    private static final String f17615c = "cancel";
    /* access modifiers changed from: private */

    /* renamed from: a */
    public WheelTime f17616a;

    public TimePickerView(PickerOptions pickerOptions) {
        super(pickerOptions.context);
        this.mPickerOptions = pickerOptions;
        m13108a(pickerOptions.context);
    }

    /* renamed from: a */
    private void m13108a(Context context) {
        ...
        m13109a(linearLayout);
    }

    /* renamed from: a */
    private void m13109a(LinearLayout linearLayout) {
        this.f17616a = new WheelTime(linearLayout, this.mPickerOptions.type, this.mPickerOptions.textGravity, this.mPickerOptions.textSizeContent);
        if (this.mPickerOptions.timeSelectChangeListener != null) {
            this.f17616a.setSelectChangeCallback(new ISelectTimeCallback() {
                public void onTimeSelectChanged() {
                    try {
                        TimePickerView.this.mPickerOptions.timeSelectChangeListener.onTimeSelectChanged(WheelTime.dateFormat.parse(TimePickerView.this.f17616a.getTime()));
        ...
        this.f17616a.setLunarMode(this.mPickerOptions.isLunarCalendar);
        ...
        m13112d();
        this.f17616a.setLabels(this.mPickerOptions.label_year, this.mPickerOptions.label_month, this.mPickerOptions.label_day, this.mPickerOptions.label_hours, this.mPickerOptions.label_minutes, this.mPickerOptions.label_seconds);
        this.f17616a.setTextXOffset(this.mPickerOptions.x_offset_year, this.mPickerOptions.x_offset_month, this.mPickerOptions.x_offset_day, this.mPickerOptions.x_offset_hours, this.mPickerOptions.x_offset_minutes, this.mPickerOptions.x_offset_seconds);
        this.f17616a.setItemsVisible(this.mPickerOptions.itemsVisibleCount);
        this.f17616a.setAlphaGradient(this.mPickerOptions.isAlphaGradient);
        setOutSideCancelable(this.mPickerOptions.cancelable);
        this.f17616a.setCyclic(this.mPickerOptions.cyclic);
        this.f17616a.setDividerColor(this.mPickerOptions.dividerColor);
        this.f17616a.setDividerType(this.mPickerOptions.dividerType);
        this.f17616a.setLineSpacingMultiplier(this.mPickerOptions.lineSpacingMultiplier);
        this.f17616a.setTextColorOut(this.mPickerOptions.textColorOut);
        this.f17616a.setTextColorCenter(this.mPickerOptions.textColorCenter);
        this.f17616a.isCenterLabel(this.mPickerOptions.isCenterLabel);
    }
    ...
    /* renamed from: a */
    private void m13107a() {
        this.f17616a.setStartYear(this.mPickerOptions.startYear);
        this.f17616a.setEndYear(this.mPickerOptions.endYear);
    }

    /* renamed from: b */
    private void m13110b() {
        this.f17616a.setRangDate(this.mPickerOptions.startDate, this.mPickerOptions.endDate);
        m13111c();
    }

    /* renamed from: c */
    private void m13111c() {
        if (this.mPickerOptions.startDate == null || this.mPickerOptions.endDate == null) {
            if (this.mPickerOptions.startDate != null) {
    ...
    private void m13112d() {
        ...
        int i8 = i2;
        int i9 = i;
        WheelTime wheelTime = this.f17616a;
    ...
    public void returnData() {
        if (this.mPickerOptions.timeSelectListener != null) {
            try {
                this.mPickerOptions.timeSelectListener.onTimeSelect(WheelTime.dateFormat.parse(this.f17616a.getTime()), this.clickView);
            } catch (ParseException e) {
                e.printStackTrace();
            }
        }
    ...
    public void setLunarCalendar(boolean z) {
        try {
            Calendar instance = Calendar.getInstance();
            instance.setTime(WheelTime.dateFormat.parse(this.f17616a.getTime()));
            ...
            this.f17616a.setLunarMode(z);
            this.f17616a.setLabels(this.mPickerOptions.label_year, this.mPickerOptions.label_month, this.mPickerOptions.label_day, this.mPickerOptions.label_hours, this.mPickerOptions.label_minutes, this.mPickerOptions.label_seconds);
            this.f17616a.setPicker(i, i2, i3, i4, i5, i6);
        } catch (ParseException e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean isLunarCalendar() {
        return this.f17616a.isLunarMode();
    }
