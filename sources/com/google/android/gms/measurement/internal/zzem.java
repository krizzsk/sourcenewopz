...
public final class zzem extends zzgo {
    ...
    public final void zzm(int i, boolean z, boolean z2, String str, Object obj, Object obj2, Object obj3) {
        if (!z && Log.isLoggable(zzn(), i)) {
            SystemUtils.log(i, zzn(), zzo(false, str, obj, obj2, obj3), (Throwable) null, "com.google.android.gms.measurement.internal.zzem", 3);
        }
        if (!z2 && i >= 5) {
            Preconditions.checkNotNull(str);
            zzfr zzj2 = this.zzs.zzj();
            if (zzj2 == null) {
                SystemUtils.log(6, zzn(), "Scheduler not set. Not logging error/warn", (Throwable) null, "com.google.android.gms.measurement.internal.zzem", 6);
            } else if (!zzj2.zzu()) {
                SystemUtils.log(6, zzn(), "Scheduler not initialized. Not logging error/warn", (Throwable) null, "com.google.android.gms.measurement.internal.zzem", 7);
            } else {
