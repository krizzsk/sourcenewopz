...
class CodePrinter {
    ...
    /* renamed from: p */
    public void mo36100p(char c) {
        this.buffer[add_area(1)] = c;
    }

    /* renamed from: p */
    public void mo36102p(String str) {
        int length = str.length();
        str.getChars(0, length, this.buffer, add_area(length));
    }

    /* renamed from: p */
    public final void mo36103p(char[] cArr) {
        mo36104p(cArr, 0, cArr.length);
    }

    /* renamed from: p */
    public void mo36104p(char[] cArr, int i, int i2) {
        int i3 = i2 - i;
        System.arraycopy(cArr, i, this.buffer, add_area(i3), i3);
    }

    /* renamed from: p */
    public void mo36101p(int i) {
        mo36102p(Integer.toString(i));
    }
