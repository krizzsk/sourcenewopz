...
public class BlockInfo {
    ...
    /* renamed from: KV */
    public static final String f48142KV = " = ";
    ...
    /* renamed from: a */
    private static final String f48143a = "BlockInfo";
    ...
    /* renamed from: b */
    private StringBuilder f48144b = new StringBuilder();

    /* renamed from: c */
    private StringBuilder f48145c = new StringBuilder();
    public boolean cpuBusy;
    public int cpuCoreNum = -1;
    public String cpuRateInfo;

    /* renamed from: d */
    private StringBuilder f48146d = new StringBuilder();

    /* renamed from: e */
    private StringBuilder f48147e = new StringBuilder();
    ...
    public static BlockInfo newInstance() {
        ...
        if (str == null || str.length() == 0) {
            try {
                ...
                SystemUtils.log(6, f48143a, "newInstance: ", th, "com.didichuxing.mas.sdk.quality.collect.lag.internal.BlockInfo", 125);
            }
        }
        ...
        blockInfo.freeMemory = String.valueOf(C15804a.m34335b());
        blockInfo.totalMemory = String.valueOf(C15804a.m34336c());
        return blockInfo;
    }
    ...
    public BlockInfo flushString() {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            StringBuilder sb19 = this.f48147e;
            sb19.append("stack");
            sb19.append(" = ");
    ...
    public String getBasicString() {
        return this.f48144b.toString();
    }

    public String getCpuString() {
        return this.f48145c.toString();
    }

    public String getTimeString() {
        return this.f48146d.toString();
    }

    public String toString() {
        return String.valueOf(this.f48144b) + this.f48146d + this.f48145c + this.f48147e;
    }
}
