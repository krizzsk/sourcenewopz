...
final class C21540xd3162e24 extends Lambda implements Function0<KotlinType> {
    final /* synthetic */ JvmBuiltInsCustomizer this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C21540xd3162e24(JvmBuiltInsCustomizer jvmBuiltInsCustomizer) {
        super(0);
        this.this$0 = jvmBuiltInsCustomizer;
    }

    public final KotlinType invoke() {
        SimpleType anyType = this.this$0.f60153b.getBuiltIns().getAnyType();
