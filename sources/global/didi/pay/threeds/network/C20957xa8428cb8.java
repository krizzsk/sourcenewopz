...
public final class C20957xa8428cb8 implements RpcService.CallbackV2<ThreedsBaseResponse<ThreedsCybsResultResponse>> {
    final /* synthetic */ ThreedsNetCallback $callback;

    public C20957xa8428cb8(ThreedsNetCallback threedsNetCallback) {
    ...
    public void onSuccess(com.didichuxing.foundation.rpc.RpcResponseProxy<global.didi.pay.threeds.network.model.ThreedsBaseResponse<global.didi.pay.threeds.network.model.ThreedsCybsResultResponse>> r6) {
        ...
        L_0x00db:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: global.didi.pay.threeds.network.C20957xa8428cb8.onSuccess(com.didichuxing.foundation.rpc.RpcResponseProxy):void");
    }
