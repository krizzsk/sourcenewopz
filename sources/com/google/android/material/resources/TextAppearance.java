...
public class TextAppearance {
    ...
    public TextAppearance(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i, C10448R.styleable.TextAppearance);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(i, C10448R.styleable.MaterialTextAppearance);
