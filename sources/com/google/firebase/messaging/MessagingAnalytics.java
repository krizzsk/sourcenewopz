...
public class MessagingAnalytics {
    ...
    static String getInstanceId(Bundle bundle) {
        String string = bundle.getString(Constants.MessagePayloadKeys.f53777TO);
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, TransportFactory transportFactory) {
        ...
        if (eventToProto != null) {
            try {
                Transport<MessagingClientEventExtension> transport = transportFactory.getTransport(Constants.FirelogAnalytics.FCM_LOG_SOURCE, MessagingClientEventExtension.class, Encoding.m37334of("proto"), MessagingAnalytics$$Lambda$0.$instance);
