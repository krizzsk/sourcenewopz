...
public class CombinedChartRenderer extends DataRenderer {
    ...
    public void createRenderers() {
        ...
        if (combinedChart != null) {
            for (CombinedChart.DrawOrder ordinal : combinedChart.getDrawOrder()) {
                int i = C178641.f52466x2dab6d3b[ordinal.ordinal()];
                if (i != 1) {
                    if (i != 2) {
                        if (i != 3) {
                            if (i != 4) {
    ...
    static /* synthetic */ class C178641 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f52466x2dab6d3b     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f52466x2dab6d3b     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f52466x2dab6d3b     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f52466x2dab6d3b     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.renderer.CombinedChartRenderer.C178641.<clinit>():void");
        }
    }
