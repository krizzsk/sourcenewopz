...
import p242io.reactivex.internal.observers.BiConsumerSingleObserver;
import p242io.reactivex.internal.observers.BlockingMultiObserver;
import p242io.reactivex.internal.observers.ConsumerSingleObserver;
import p242io.reactivex.internal.observers.FutureSingleObserver;
import p242io.reactivex.internal.operators.completable.CompletableFromSingle;
import p242io.reactivex.internal.operators.completable.CompletableToFlowable;
import p242io.reactivex.internal.operators.flowable.FlowableConcatMap;
import p242io.reactivex.internal.operators.flowable.FlowableConcatMapPublisher;
import p242io.reactivex.internal.operators.flowable.FlowableFlatMapPublisher;
import p242io.reactivex.internal.operators.flowable.FlowableSingleSingle;
import p242io.reactivex.internal.operators.maybe.MaybeFilterSingle;
import p242io.reactivex.internal.operators.maybe.MaybeFromSingle;
import p242io.reactivex.internal.operators.mixed.SingleFlatMapObservable;
...
import p242io.reactivex.internal.operators.single.SingleAmb;
import p242io.reactivex.internal.operators.single.SingleCache;
import p242io.reactivex.internal.operators.single.SingleContains;
import p242io.reactivex.internal.operators.single.SingleCreate;
import p242io.reactivex.internal.operators.single.SingleDefer;
import p242io.reactivex.internal.operators.single.SingleDelay;
import p242io.reactivex.internal.operators.single.SingleDelayWithCompletable;
import p242io.reactivex.internal.operators.single.SingleDelayWithObservable;
import p242io.reactivex.internal.operators.single.SingleDelayWithPublisher;
import p242io.reactivex.internal.operators.single.SingleDelayWithSingle;
import p242io.reactivex.internal.operators.single.SingleDematerialize;
import p242io.reactivex.internal.operators.single.SingleDetach;
import p242io.reactivex.internal.operators.single.SingleDoAfterSuccess;
import p242io.reactivex.internal.operators.single.SingleDoAfterTerminate;
import p242io.reactivex.internal.operators.single.SingleDoFinally;
import p242io.reactivex.internal.operators.single.SingleDoOnDispose;
import p242io.reactivex.internal.operators.single.SingleDoOnError;
import p242io.reactivex.internal.operators.single.SingleDoOnEvent;
import p242io.reactivex.internal.operators.single.SingleDoOnSubscribe;
import p242io.reactivex.internal.operators.single.SingleDoOnSuccess;
import p242io.reactivex.internal.operators.single.SingleEquals;
import p242io.reactivex.internal.operators.single.SingleError;
import p242io.reactivex.internal.operators.single.SingleFlatMap;
import p242io.reactivex.internal.operators.single.SingleFlatMapCompletable;
import p242io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import p242io.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import p242io.reactivex.internal.operators.single.SingleFlatMapMaybe;
import p242io.reactivex.internal.operators.single.SingleFlatMapPublisher;
import p242io.reactivex.internal.operators.single.SingleFromCallable;
import p242io.reactivex.internal.operators.single.SingleFromPublisher;
import p242io.reactivex.internal.operators.single.SingleFromUnsafeSource;
import p242io.reactivex.internal.operators.single.SingleHide;
import p242io.reactivex.internal.operators.single.SingleInternalHelper;
import p242io.reactivex.internal.operators.single.SingleJust;
import p242io.reactivex.internal.operators.single.SingleLift;
import p242io.reactivex.internal.operators.single.SingleMap;
import p242io.reactivex.internal.operators.single.SingleMaterialize;
import p242io.reactivex.internal.operators.single.SingleNever;
import p242io.reactivex.internal.operators.single.SingleObserveOn;
import p242io.reactivex.internal.operators.single.SingleOnErrorReturn;
import p242io.reactivex.internal.operators.single.SingleResumeNext;
import p242io.reactivex.internal.operators.single.SingleSubscribeOn;
import p242io.reactivex.internal.operators.single.SingleTakeUntil;
import p242io.reactivex.internal.operators.single.SingleTimeout;
import p242io.reactivex.internal.operators.single.SingleTimer;
import p242io.reactivex.internal.operators.single.SingleToFlowable;
import p242io.reactivex.internal.operators.single.SingleToObservable;
import p242io.reactivex.internal.operators.single.SingleUnsubscribeOn;
import p242io.reactivex.internal.operators.single.SingleUsing;
import p242io.reactivex.internal.operators.single.SingleZipArray;
import p242io.reactivex.internal.operators.single.SingleZipIterable;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo174022as(SingleConverter<T, ? extends R> singleConverter) {
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit) {
        return m41795a(j, timeUnit, Schedulers.computation(), (SingleSource) null);
    }

    @CheckReturnValue
    @SchedulerSupport("custom")
    public final Single<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return m41795a(j, timeUnit, scheduler, (SingleSource) null);
    }
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(singleSource, "other is null");
        return m41795a(j, timeUnit, scheduler, singleSource);
    }
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(singleSource, "other is null");
        return m41795a(j, timeUnit, Schedulers.computation(), singleSource);
    }

    /* renamed from: a */
    private Single<T> m41795a(long j, TimeUnit timeUnit, Scheduler scheduler, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo174096to(Function<? super Single<T>, R> function) {
        try {
    ...
    /* renamed from: a */
    private static <T> Single<T> m41796a(Flowable<T> flowable) {
