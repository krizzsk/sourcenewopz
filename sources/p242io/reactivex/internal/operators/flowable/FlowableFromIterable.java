...
public final class FlowableFromIterable<T> extends Flowable<T> {
    ...
    /* renamed from: a */
    final Iterable<? extends T> f58322a;

    public FlowableFromIterable(Iterable<? extends T> iterable) {
        this.f58322a = iterable;
    }

    public void subscribeActual(Subscriber<? super T> subscriber) {
        try {
            subscribe(subscriber, this.f58322a.iterator());
        } catch (Throwable th) {
    ...
    static abstract class BaseRangeSubscription<T> extends BasicQueueSubscription<T> {
        ...
        public final T poll() {
            Iterator<? extends T> it = this.f58323it;
            if (it == null) {
                return null;
            }
            if (!this.once) {
            ...
            return ObjectHelper.requireNonNull(this.f58323it.next(), "Iterator.next() returned a null value");
        }
