...
public class SAShareProvider implements ISfShareService {
    ...
    /* renamed from: a */
    private CommonTripShareManager f15412a;

    public void startSocialShare(Context context) {
        CommonTripShareManager commonTripShareManager = this.f15412a;
        ...
        if (presenter instanceof AbsSafeToolkitPresenter) {
            ...
            if (order != null) {
                if (this.f15412a == null) {
                    this.f15412a = new CommonTripShareManager();
                }
                ComponentParams componentParams = ((AbsSafeToolkitPresenter) presenter).getComponentParams();
                if (componentParams != null) {
                    this.f15412a.showShareDialog(componentParams.getActivity(), order.oid, order.productid);
                    return;
                }
