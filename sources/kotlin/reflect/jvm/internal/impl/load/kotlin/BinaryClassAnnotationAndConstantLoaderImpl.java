...
public final class BinaryClassAnnotationAndConstantLoaderImpl extends AbstractBinaryClassAnnotationAndConstantLoader<AnnotationDescriptor, ConstantValue<?>> {
    ...
    /* renamed from: a */
    private final ModuleDescriptor f60628a;

    /* renamed from: b */
    private final NotFoundClasses f60629b;

    /* renamed from: c */
    private final AnnotationDeserializer f60630c;
    ...
    public BinaryClassAnnotationAndConstantLoaderImpl(ModuleDescriptor moduleDescriptor, NotFoundClasses notFoundClasses, StorageManager storageManager, KotlinClassFinder kotlinClassFinder) {
        ...
        this.f60628a = moduleDescriptor;
        this.f60629b = notFoundClasses;
        this.f60630c = new AnnotationDeserializer(moduleDescriptor, notFoundClasses);
    }
    ...
    public AnnotationDescriptor loadTypeAnnotation(ProtoBuf.Annotation annotation, NameResolver nameResolver) {
        ...
        return this.f60630c.deserializeAnnotation(annotation, nameResolver);
    }
    ...
    public KotlinJvmBinaryClass.AnnotationArgumentVisitor loadAnnotation(ClassId classId, SourceElement sourceElement, List<AnnotationDescriptor> list) {
        ...
        return new BinaryClassAnnotationAndConstantLoaderImpl$loadAnnotation$1(this, m44731a(classId), list, sourceElement);
    }

    /* renamed from: a */
    private final ClassDescriptor m44731a(ClassId classId) {
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(this.f60628a, classId, this.f60629b);
    }
}
