...
public class GMSSPrivateKeyParameters extends GMSSKeyParameters {
    ...
    private GMSSPrivateKeyParameters(GMSSPrivateKeyParameters gMSSPrivateKeyParameters) {
        ...
        this.f6449K = gMSSPrivateKeyParameters.f6449K;
    ...
    private int getMinTreehashIndex(int i) {
        int i2 = -1;
        for (int i3 = 0; i3 < this.heightOfTrees[i] - this.f6449K[i]; i3++) {
    ...
    private void nextTree(int i) {
        if (i > 0) {
            ...
            if (!z) {
                ...
                for (int i5 = 0; i5 < this.heightOfTrees[i] - this.f6449K[i]; i5++) {
                ...
                for (int i7 = 0; i7 < this.f6449K[i] - 1; i7++) {
    ...
    private void updateKey(int i) {
        ...
        if (i > 0) {
            ...
            int floor = (int) Math.floor(((double) (getNumLeafs(i) * 2)) / ((double) (this.heightOfTrees[i3] - this.f6449K[i3])));
            int[] iArr = this.index;
            if (iArr[i] % floor == 1) {
