...
public class JCEElGamalPublicKey implements DHPublicKey, ElGamalPublicKey {
    ...
    JCEElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f6264y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    JCEElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f6264y = elGamalPublicKeyParameters.getY();
    ...
    JCEElGamalPublicKey(ElGamalPublicKey elGamalPublicKey) {
        this.f6264y = elGamalPublicKey.getY();
        this.elSpec = elGamalPublicKey.getParameters();
    }

    JCEElGamalPublicKey(ElGamalPublicKeySpec elGamalPublicKeySpec) {
        this.f6264y = elGamalPublicKeySpec.getY();
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f6264y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), (ASN1Encodable) new ASN1Integer(this.f6264y));
    }
