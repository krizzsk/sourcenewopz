...
public class FastDtoa {
    ...
    static boolean digitGen(DiyFp diyFp, DiyFp diyFp2, DiyFp diyFp3, FastDtoaBuilder fastDtoaBuilder, int i) {
        ...
        DiyFp diyFp5 = new DiyFp(diyFp.mo36282f() - 1, diyFp.mo36281e());
        DiyFp diyFp6 = new DiyFp(diyFp3.mo36282f() + 1, diyFp3.mo36281e());
        DiyFp minus = DiyFp.minus(diyFp6, diyFp5);
        DiyFp diyFp7 = new DiyFp(1 << (-diyFp2.mo36281e()), diyFp2.mo36281e());
        int f = (int) ((diyFp6.mo36282f() >>> (-diyFp7.mo36281e())) & InternalZipConstants.ZIP_64_SIZE_LIMIT);
        long f2 = diyFp6.mo36282f() & (diyFp7.mo36282f() - 1);
        long biggestPowerTen = biggestPowerTen(f, 64 - (-diyFp7.mo36281e()));
        ...
        while (i3 > 0) {
            ...
            f %= i2;
            i3--;
            long j = (((long) f) << (-diyFp7.mo36281e())) + f2;
            if (j < minus.mo36282f()) {
                fastDtoaBuilder2.point = (fastDtoaBuilder2.end - i) + i3;
                return roundWeed(fastDtoaBuilder, DiyFp.minus(diyFp6, diyFp4).mo36282f(), minus.mo36282f(), j, ((long) i2) << (-diyFp7.mo36281e()), 1);
            }
            i2 /= 10;
        }
        long j2 = 1;
        while (true) {
            long j3 = f2 * 5;
            j2 *= 5;
            minus.setF(minus.mo36282f() * 5);
            minus.setE(minus.mo36281e() + 1);
            diyFp7.setF(diyFp7.mo36282f() >>> 1);
            diyFp7.setE(diyFp7.mo36281e() + 1);
            fastDtoaBuilder2.append((char) (((int) ((j3 >>> (-diyFp7.mo36281e())) & InternalZipConstants.ZIP_64_SIZE_LIMIT)) + 48));
            f2 = j3 & (diyFp7.mo36282f() - 1);
            i3--;
            if (f2 < minus.mo36282f()) {
                fastDtoaBuilder2.point = (fastDtoaBuilder2.end - i) + i3;
                return roundWeed(fastDtoaBuilder, DiyFp.minus(diyFp6, diyFp4).mo36282f() * j2, minus.mo36282f(), f2, diyFp7.mo36282f(), j2);
            }
        }
    }
    ...
    static boolean grisu3(double d, FastDtoaBuilder fastDtoaBuilder) {
        ...
        int cachedPower = CachedPowers.getCachedPower(asNormalizedDiyFp.mo36281e() + 64, minimal_target_exponent, maximal_target_exponent, diyFp3);
