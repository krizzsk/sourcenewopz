    ...
    public static final void initialize(File file) {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                try {
                    languageInfo = MapsKt.mapOf(TuplesKt.m42317to(ViewHierarchyConstants.ENGLISH, "1"), TuplesKt.m42317to(ViewHierarchyConstants.GERMAN, "2"), TuplesKt.m42317to(ViewHierarchyConstants.SPANISH, "3"), TuplesKt.m42317to(ViewHierarchyConstants.JAPANESE, "4"));
                    eventInfo = MapsKt.mapOf(TuplesKt.m42317to(ViewHierarchyConstants.VIEW_CONTENT, "0"), TuplesKt.m42317to(ViewHierarchyConstants.SEARCH, "1"), TuplesKt.m42317to(ViewHierarchyConstants.ADD_TO_CART, "2"), TuplesKt.m42317to(ViewHierarchyConstants.ADD_TO_WISHLIST, "3"), TuplesKt.m42317to(ViewHierarchyConstants.INITIATE_CHECKOUT, "4"), TuplesKt.m42317to(ViewHierarchyConstants.ADD_PAYMENT_INFO, "5"), TuplesKt.m42317to(ViewHierarchyConstants.PURCHASE, "6"), TuplesKt.m42317to(ViewHierarchyConstants.LEAD, "7"), TuplesKt.m42317to(ViewHierarchyConstants.COMPLETE_REGISTRATION, "8"));
                    textTypeInfo = MapsKt.mapOf(TuplesKt.m42317to(ViewHierarchyConstants.BUTTON_TEXT, "1"), TuplesKt.m42317to(ViewHierarchyConstants.PAGE_TITLE, "2"), TuplesKt.m42317to(ViewHierarchyConstants.RESOLVED_DOCUMENT_LINK, "3"), TuplesKt.m42317to(ViewHierarchyConstants.BUTTON_ID, "4"));
                    initialized = true;
                } catch (Throwable th) {
                    CrashShieldHandler.handleThrowable(th, cls);
                }
