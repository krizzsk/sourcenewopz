...
public final class ProgressDialogFragment extends BaseDialogFragment {
    ...
    /* renamed from: c */
    private int f50465c = R.drawable.pay_secure_loading_progress_bar;
    ...
    public ProgressDialogFragment() {
        ...
        if (productThemeStyle.getIndeterminateDrawable() != 0) {
            ...
            this.f50465c = productThemeStyle2.getIndeterminateDrawable();
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (findViewById != null) {
            ((ProgressBar) findViewById).setIndeterminateDrawable(ResourcesCompat.getDrawable(getResources(), this.f50465c, (Resources.Theme) null));
            if (!TextUtils.isEmpty(this.f50463a)) {
                View findViewById2 = inflate.findViewById(R.id.tv_msg);
                if (findViewById2 != null) {
                    ((TextView) findViewById2).setText(this.f50463a);
                } else {
