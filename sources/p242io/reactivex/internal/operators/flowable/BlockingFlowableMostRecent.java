...
import p242io.reactivex.subscribers.DefaultSubscriber;

/* renamed from: io.reactivex.internal.operators.flowable.BlockingFlowableMostRecent */
public final class BlockingFlowableMostRecent<T> implements Iterable<T> {

    /* renamed from: a */
    final Flowable<T> f58171a;

    /* renamed from: b */
    final T f58172b;

    public BlockingFlowableMostRecent(Flowable<T> flowable, T t) {
        this.f58171a = flowable;
        this.f58172b = t;
    }

    public Iterator<T> iterator() {
        MostRecentSubscriber mostRecentSubscriber = new MostRecentSubscriber(this.f58172b);
        this.f58171a.subscribe(mostRecentSubscriber);
