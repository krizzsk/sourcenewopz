...
public final class FlowableInterval extends Flowable<Long> {
    ...
    /* renamed from: d */
    final TimeUnit f58343d;

    public FlowableInterval(long j, long j2, TimeUnit timeUnit, Scheduler scheduler) {
        this.f58341b = j;
        this.f58342c = j2;
        this.f58343d = timeUnit;
        this.f58340a = scheduler;
    }

    public void subscribeActual(Subscriber<? super Long> subscriber) {
        IntervalSubscriber intervalSubscriber = new IntervalSubscriber(subscriber);
        subscriber.onSubscribe(intervalSubscriber);
        Scheduler scheduler = this.f58340a;
        if (scheduler instanceof TrampolineScheduler) {
            Scheduler.Worker createWorker = scheduler.createWorker();
            intervalSubscriber.setResource(createWorker);
            createWorker.schedulePeriodically(intervalSubscriber, this.f58341b, this.f58342c, this.f58343d);
            return;
        }
        intervalSubscriber.setResource(scheduler.schedulePeriodicallyDirect(intervalSubscriber, this.f58341b, this.f58342c, this.f58343d));
    }
