...
final class C21615xb2505177 extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFFunction;
    final /* synthetic */ String $JLObject;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C21615xb2505177(String str, String str2) {
        super(1);
        this.$JLObject = str;
    ...
    public final void invoke(SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder functionEnhancementBuilder) {
        ...
        functionEnhancementBuilder.parameter(this.$JFFunction, PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60605b);
        functionEnhancementBuilder.returns(this.$JLObject, PredefinedEnhancementInfoKt.f60605b);
    }
}
