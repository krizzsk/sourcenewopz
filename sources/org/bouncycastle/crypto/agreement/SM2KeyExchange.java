...
public class SM2KeyExchange {
    ...
    /* renamed from: S1 */
    private byte[] m3630S1(Digest digest2, ECPoint eCPoint, byte[] bArr) {
    ...
    /* renamed from: S2 */
    private byte[] m3631S2(Digest digest2, ECPoint eCPoint, byte[] bArr) {
    ...
    private byte[] kdf(org.bouncycastle.math.p082ec.ECPoint r12, byte[] r13, byte[] r14, int r15) {
        /*
            r11 = this;
    ...
    private BigInteger reduce(BigInteger bigInteger) {
        return bigInteger.and(BigInteger.valueOf(1).shiftLeft(this.f5723w).subtract(BigInteger.valueOf(1))).setBit(this.f5723w);
    }
    ...
    public byte[][] calculateKeyWithConfirmation(int i, byte[] bArr, CipherParameters cipherParameters) {
        ...
        if (!this.initiator || bArr3 != null) {
            ...
            if (this.initiator) {
                ...
                if (Arrays.constantTimeAreEqual(m3630S1(this.digest, calculateU, calculateInnerHash), bArr3)) {
                    return new byte[][]{kdf, m3631S2(this.digest, calculateU, calculateInnerHash)};
                }
            ...
            return new byte[][]{kdf2, m3630S1(this.digest, calculateU, calculateInnerHash2), m3631S2(this.digest, calculateU, calculateInnerHash2)};
        }
    ...
    public void init(CipherParameters cipherParameters) {
        ...
        this.f5723w = (this.ecParams.getCurve().getFieldSize() / 2) - 1;
    }
}
