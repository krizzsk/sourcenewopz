...
public final class zzeoh<K, V> extends LinkedHashMap<K, V> {
    ...
    public final void zza(zzeoh<K, V> zzeoh) {
        zzbkt();
        if (!zzeoh.isEmpty()) {
            putAll(zzeoh);
        }
    ...
    public final void putAll(Map<? extends K, ? extends V> map) {
        ...
        for (Object next : map.keySet()) {
            zzenc.checkNotNull(next);
            zzenc.checkNotNull(map.get(next));
        }
        super.putAll(map);
    }
    ...
    public final boolean equals(java.lang.Object r7) {
        ...
        L_0x005d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzeoh.equals(java.lang.Object):boolean");
    }
