...
public final class ObservablePublishSelector<T, R> extends C21211a<T, R> {

    /* renamed from: a */
    final Function<? super Observable<T>, ? extends ObservableSource<R>> f58884a;
    ...
    public void subscribeActual(Observer<? super R> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.f58884a.apply(create), "The selector returned a null ObservableSource");
