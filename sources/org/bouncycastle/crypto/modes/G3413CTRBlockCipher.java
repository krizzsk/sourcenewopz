...
public class G3413CTRBlockCipher extends StreamBlockCipher {
    ...
    private byte[] generateBuf() {
        ...
        return GOST3413CipherUtil.MSB(bArr2, this.f6092s);
    }
    ...
    private void initArrays() {
        ...
        this.f6091IV = new byte[(i / 2)];
        this.CTR = new byte[i];
        this.buf = new byte[this.f6092s];
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            if (clone.length == this.blockSize / 2) {
                ...
                for (int length = this.f6091IV.length; length < this.blockSize; length++) {
                    this.CTR[length] = 0;
                }
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        processBytes(bArr, i, this.f6092s, bArr2, i2);
        return this.f6092s;
    }

    public void reset() {
        if (this.initialized) {
            byte[] bArr = this.f6091IV;
