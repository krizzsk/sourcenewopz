...
public class FlutterFragment extends Fragment implements ComponentCallbacks2, FlutterActivityAndFragmentDelegate.Host {
    ...
    /* renamed from: b */
    private static final String f57418b = "FlutterFragment";

    /* renamed from: a */
    FlutterActivityAndFragmentDelegate f57419a;

    /* renamed from: c */
    private final OnBackPressedCallback f57420c = new OnBackPressedCallback(true) {
    ...
    /* renamed from: a */
    public void mo172061a(FlutterActivityAndFragmentDelegate flutterActivityAndFragmentDelegate) {
        this.f57419a = flutterActivityAndFragmentDelegate;
    }
    ...
    public void onAttach(Context context) {
        ...
        this.f57419a = flutterActivityAndFragmentDelegate;
        flutterActivityAndFragmentDelegate.mo171956a(context);
        if (getArguments().getBoolean(ARG_SHOULD_AUTOMATICALLY_HANDLE_ON_BACK_PRESSED, false)) {
            requireActivity().getOnBackPressedDispatcher().addCallback(this, this.f57420c);
        }
    }

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        this.f57419a.mo171958a(bundle);
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return this.f57419a.mo171951a(layoutInflater, viewGroup, bundle, FLUTTER_VIEW_ID, mo172063b());
    }

    public void onStart() {
        super.onStart();
        if (m41295a("onStart")) {
            this.f57419a.mo171965g();
        }
    }
    ...
    public void onResume() {
        super.onResume();
        if (m41295a("onResume")) {
            this.f57419a.mo171966h();
        }
    }

    public void onPostResume() {
        if (m41295a("onPostResume")) {
            this.f57419a.mo171967i();
        }
    }
    ...
    public void onStop() {
        super.onStop();
        if (m41295a("onStop")) {
            this.f57419a.mo171970l();
        }
    }

    public void onDestroyView() {
        super.onDestroyView();
        if (m41295a("onDestroyView")) {
            this.f57419a.mo171971m();
        }
    }

    public void onSaveInstanceState(Bundle bundle) {
        super.onSaveInstanceState(bundle);
        if (m41295a("onSaveInstanceState")) {
            this.f57419a.mo171960b(bundle);
        }
    }

    public void detachFromFlutterEngine() {
        Log.m41142w(f57418b, "FlutterFragment " + this + " connection to the engine " + getFlutterEngine() + " evicted by another attaching activity");
        FlutterActivityAndFragmentDelegate flutterActivityAndFragmentDelegate = this.f57419a;
        if (flutterActivityAndFragmentDelegate != null) {
            flutterActivityAndFragmentDelegate.mo171971m();
            this.f57419a.mo171972n();
        }
    }
    ...
    public void onDetach() {
        ...
        FlutterActivityAndFragmentDelegate flutterActivityAndFragmentDelegate = this.f57419a;
        if (flutterActivityAndFragmentDelegate != null) {
            flutterActivityAndFragmentDelegate.mo171972n();
            this.f57419a.mo171952a();
            this.f57419a = null;
            return;
        }
        Log.m41140v(f57418b, "FlutterFragment " + this + " onDetach called after release.");
    }

    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        if (m41295a("onRequestPermissionsResult")) {
            this.f57419a.mo171955a(i, strArr, iArr);
        }
    }

    public void onNewIntent(Intent intent) {
        if (m41295a("onNewIntent")) {
            this.f57419a.mo171957a(intent);
        }
    }

    public void onBackPressed() {
        if (m41295a("onBackPressed")) {
            this.f57419a.mo171973o();
        }
    }

    public void onActivityResult(int i, int i2, Intent intent) {
        if (m41295a("onActivityResult")) {
            this.f57419a.mo171954a(i, i2, intent);
        }
    }

    public void onUserLeaveHint() {
        if (m41295a("onUserLeaveHint")) {
            this.f57419a.mo171974p();
        }
    }

    public void onTrimMemory(int i) {
        if (m41295a("onTrimMemory")) {
            this.f57419a.mo171953a(i);
        }
    }

    public void onLowMemory() {
        super.onLowMemory();
        if (m41295a("onLowMemory")) {
            this.f57419a.mo171975q();
        }
    }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public boolean mo172062a() {
        return this.f57419a.mo171961c();
    }

    public boolean shouldDestroyEngineWithHost() {
        boolean z = getArguments().getBoolean(ARG_DESTROY_ENGINE_WITH_FRAGMENT, false);
        return (getCachedEngineId() != null || this.f57419a.mo171961c()) ? z : getArguments().getBoolean(ARG_DESTROY_ENGINE_WITH_FRAGMENT, true);
    }
    ...
    public FlutterEngine provideFlutterEngine(Context context) {
        ...
        Log.m41140v(f57418b, "Deferring to attached Activity to provide a FlutterEngine.");
        return ((FlutterEngineProvider) activity).provideFlutterEngine(getContext());
    }

    public FlutterEngine getFlutterEngine() {
        return this.f57419a.mo171959b();
    }
    ...
    public boolean popSystemNavigator() {
        ...
        this.f57420c.setEnabled(false);
        activity.getOnBackPressedDispatcher().onBackPressed();
        this.f57420c.setEnabled(true);
        return true;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public boolean mo172063b() {
        return getArguments().getBoolean(ARG_SHOULD_DELAY_FIRST_ANDROID_VIEW_DRAW);
    }

    /* renamed from: a */
    private boolean m41295a(String str) {
        FlutterActivityAndFragmentDelegate flutterActivityAndFragmentDelegate = this.f57419a;
        if (flutterActivityAndFragmentDelegate == null) {
            Log.m41142w(f57418b, "FlutterFragment " + hashCode() + " " + str + " called after release.");
            return false;
        } else if (flutterActivityAndFragmentDelegate.mo171962d()) {
            return true;
        } else {
            Log.m41142w(f57418b, "FlutterFragment " + hashCode() + " " + str + " called after detach.");
            return false;
        }
    }
}
