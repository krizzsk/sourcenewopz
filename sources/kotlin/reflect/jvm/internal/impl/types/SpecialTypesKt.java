...
public final class SpecialTypesKt {
    ...
    public static final SimpleType makeSimpleTypeDefinitelyNotNullOrNotNull(SimpleType simpleType, boolean z) {
        ...
        SimpleType a = m45039a((KotlinType) simpleType);
        if (a == null) {
    ...
    public static final UnwrappedType makeDefinitelyNotNullOrNotNull(UnwrappedType unwrappedType, boolean z) {
        ...
        if (makeDefinitelyNotNull == null && (makeDefinitelyNotNull = m45039a((KotlinType) unwrappedType)) == null) {
    ...
    /* renamed from: a */
    private static final SimpleType m45039a(KotlinType kotlinType) {
        ...
        if (intersectionTypeConstructor == null || (a = m45038a(intersectionTypeConstructor)) == null) {
            return null;
        }
        return a.createType();
    }
    ...
    /* renamed from: a */
    private static final IntersectionTypeConstructor m45038a(IntersectionTypeConstructor intersectionTypeConstructor) {
