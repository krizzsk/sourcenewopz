...
import com.didi.beatles.p099im.thirty.greenrobot.dao.identityscope.IdentityScope;
import com.didi.beatles.p099im.thirty.greenrobot.dao.identityscope.IdentityScopeLong;
import com.didi.beatles.p099im.thirty.greenrobot.dao.internal.DaoConfig;
import com.didi.beatles.p099im.thirty.greenrobot.dao.internal.FastCursor;
...
public abstract class AbstractDao<T, K> {
    ...
    /* renamed from: db */
    protected final Database f9655db;
    ...
    public AbstractDao(DaoConfig daoConfig, AbstractDaoSession abstractDaoSession) {
        ...
        this.f9655db = daoConfig.f9696db;
    ...
    public T load(K k) {
        ...
        return loadUniqueAndCloseCursor(this.f9655db.rawQuery(this.statements.getSelectByKey(), new String[]{k.toString()}));
    }

    public T loadByRowId(long j) {
        return loadUniqueAndCloseCursor(this.f9655db.rawQuery(this.statements.getSelectByRowId(), new String[]{Long.toString(j)}));
    }
    ...
    public List<T> loadAll() {
        return loadAllAndCloseCursor(this.f9655db.rawQuery(this.statements.getSelectAll(), (String[]) null));
    }
    ...
    private void executeInsertInTx(DatabaseStatement databaseStatement, Iterable<T> iterable, boolean z) {
        ...
        try {
            ...
            this.f9655db.setTransactionSuccessful();
        } finally {
            this.f9655db.endTransaction();
        }
    }
    ...
    public long insertWithoutSettingPk(T t) {
        ...
        if (this.f9655db.isDbLockedByCurrentThread()) {
    ...
    public void updateKeyAfterInsertAndAttach(T t, long j, boolean z) {
        if (j != -1) {
            ...
            DaoLog.m6532w("Could not insert row (executeInsert returned -1)");
        }
    }
    ...
    public List<T> loadAllFromCursor(Cursor cursor) {
        ...
        if ((cursor instanceof CrossProcessCursor) && (window = ((CrossProcessCursor) cursor).getWindow()) != null) {
            if (window.getNumRows() == count) {
                ...
                DaoLog.m6524d("Window vs. result size: " + window.getNumRows() + "/" + count);
            }
        }
        if (cursor.moveToFirst()) {
            IdentityScope<K, T> identityScope2 = this.identityScope;
    ...
    public List<T> queryRaw(String str, String... strArr) {
        Database database = this.f9655db;
    ...
    public void refresh(T t) {
        ...
        Cursor rawQuery = this.f9655db.rawQuery(this.statements.getSelectByKey(), new String[]{keyVerified.toString()});
        try {
    ...
    public void updateInTx(Iterable<T> iterable) {
        ...
        try {
            ...
            try {
                ...
                DaoLog.m6533w("Could not end transaction (rethrowing initial exception)", e3);
                throw e2;
            }
        } catch (Throwable th) {
            try {
    ...
    public long count() {
        return DatabaseUtils.queryNumEntries((SQLiteDatabase) this.f9655db.getRawDatabase(), '\'' + this.config.tablename + '\'');
    }
