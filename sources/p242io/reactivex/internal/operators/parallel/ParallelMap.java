...
public final class ParallelMap<T, R> extends ParallelFlowable<R> {
    ...
    /* renamed from: a */
    final ParallelFlowable<T> f59057a;

    /* renamed from: b */
    final Function<? super T, ? extends R> f59058b;

    public ParallelMap(ParallelFlowable<T> parallelFlowable, Function<? super T, ? extends R> function) {
        this.f59057a = parallelFlowable;
        ...
        if (validate(subscriberArr)) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (conditionalSubscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i] = new ParallelMapConditionalSubscriber(conditionalSubscriber, this.f59058b);
                } else {
                    subscriberArr2[i] = new ParallelMapSubscriber(conditionalSubscriber, this.f59058b);
                }
            }
            this.f59057a.subscribe(subscriberArr2);
        }
    }

    public int parallelism() {
        return this.f59057a.parallelism();
    }
