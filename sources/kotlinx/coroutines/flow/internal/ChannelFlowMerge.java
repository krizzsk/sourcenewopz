...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public ChannelFlow<T> create(CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow) {
        return new ChannelFlowMerge<>(this.f61478a, this.f61479b, coroutineContext, i, bufferOverflow);
    }
    ...
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        Object collect = this.f61478a.collect(new ChannelFlowMerge$collectTo$$inlined$collect$1((Job) continuation.getContext().get(Job.Key), SemaphoreKt.Semaphore$default(this.f61479b, 0, 2, (Object) null), producerScope, new SendingCollector(producerScope)), continuation);
    ...
    public String additionalToStringProps() {
        return Intrinsics.stringPlus("concurrency=", Integer.valueOf(this.f61479b));
    }
}
