...
public class GridLayout extends ViewGroup {
    ...
    static final class Interval {
        ...
        public String toString() {
            return com.didichuxing.bigdata.p173dp.locsdk.Const.jaLeft + this.min + ", " + this.max + com.didichuxing.bigdata.p173dp.locsdk.Const.jaRight;
        }
    }
    ...
    private static Alignment createSwitchingAlignment(final Alignment alignment, final Alignment alignment2) {
        return new Alignment() {
            ...
            /* access modifiers changed from: package-private */
            public String getDebugString() {
                return "SWITCHING[L:" + alignment.getDebugString() + ", R:" + alignment2.getDebugString() + com.didichuxing.bigdata.p173dp.locsdk.Const.jaRight;
            }
        };
    }
}
