...
public final class ClassReference implements ClassBasedDeclarationContainer, KClass<Object> {
    ...
    /* renamed from: b */
    public static final Map<Class<? extends Function<?>>, Integer> f59896b;

    /* renamed from: c */
    private static final HashMap<String, String> f59897c;

    /* renamed from: d */
    private static final HashMap<String, String> f59898d;
    /* access modifiers changed from: private */

    /* renamed from: e */
    public static final HashMap<String, String> f59899e;
    /* access modifiers changed from: private */

    /* renamed from: f */
    public static final Map<String, String> f59900f;

    /* renamed from: a */
    private final Class<?> f59901a;
    ...
    @Metadata(mo175977d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0014\u0010\u000f\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u001c\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u00012\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005R&\u0010\u0003\u001a\u001a\u0012\u0010\u0012\u000e\u0012\n\b\u0001\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005\u0012\u0004\u0012\u00020\u00070\u0004X\u0004¢\u0006\u0002\n\u0000R*\u0010\b\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0004¢\u0006\u0002\n\u0000R*\u0010\f\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0004¢\u0006\u0002\n\u0000R*\u0010\r\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u000e\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0015"}, mo175978d2 = {"Lkotlin/jvm/internal/ClassReference$Companion;", "", "()V", "FUNCTION_CLASSES", "", "Ljava/lang/Class;", "Lkotlin/Function;", "", "classFqNames", "Ljava/util/HashMap;", "", "Lkotlin/collections/HashMap;", "primitiveFqNames", "primitiveWrapperFqNames", "simpleNames", "getClassQualifiedName", "jClass", "getClassSimpleName", "isInstance", "", "value", "kotlin-stdlib"}, mo175979k = 1, mo175980mv = {1, 5, 1})
    /* compiled from: ClassReference.kt */
    public static final class Companion {
        ...
        public final java.lang.String getClassSimpleName(java.lang.Class<?> r8) {
            ...
            L_0x0073:
                ...
                java.util.Map r0 = kotlin.jvm.internal.ClassReference.f59900f
                java.lang.String r8 = r8.getName()
        ...
        public final String getClassQualifiedName(Class<?> cls) {
            ...
            if (cls.isArray()) {
                ...
                if (componentType.isPrimitive() && (str = (String) ClassReference.f59899e.get(componentType.getName())) != null) {
                    str2 = str + "Array";
                }
                if (str2 != null) {
                    return str2;
            ...
            String str3 = (String) ClassReference.f59899e.get(cls.getName());
            return str3 != null ? str3 : cls.getCanonicalName();
        }

        public final boolean isInstance(Object obj, Class<?> cls) {
            Intrinsics.checkNotNullParameter(cls, "jClass");
            Map access$getFUNCTION_CLASSES$cp = ClassReference.f59896b;
    ...
    static {
        ...
        for (Object next : listOf) {
            ...
            arrayList.add(TuplesKt.m42317to((Class) next, Integer.valueOf(i)));
            i = i2;
        }
        f59896b = MapsKt.toMap((List) arrayList);
        ...
        hashMap3.putAll(f59897c);
        hashMap3.putAll(f59898d);
        Collection<String> values = f59897c.values();
        ...
        for (String str : values) {
            ...
            Pair pair = TuplesKt.m42317to(sb2, str + ".Companion");
            hashMap3.put(pair.getFirst(), pair.getSecond());
        }
        Map map = hashMap3;
        for (Map.Entry next2 : f59896b.entrySet()) {
