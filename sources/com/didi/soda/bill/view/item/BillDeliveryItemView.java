...
@Metadata(mo175977d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\b\u0010\b\u001a\u00020\tH\u0016J\u0010\u0010\n\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\fH\u0016J\u0010\u0010\r\u001a\u00020\t2\u0006\u0010\u000e\u001a\u00020\u000fH\u0002R\u000e\u0010\u0006\u001a\u00020\u0007X.¢\u0006\u0002\n\u0000¨\u0006\u0010"}, mo175978d2 = {"Lcom/didi/soda/bill/view/item/BillDeliveryItemView;", "Lcom/didi/soda/bill/view/BillItemView;", "Lcom/didi/soda/bill/view/item/logic/ItemViewCommonLogic;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "deliveryName", "Landroid/widget/TextView;", "initView", "", "setData", "componentModel", "Lcom/didi/soda/bill/model/ComponentModel;", "showOrHide", "isShow", "", "customer-aar_brazilEmbedRelease"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
/* compiled from: BillDeliveryItemView.kt */
public final class BillDeliveryItemView extends BillItemView<ItemViewCommonLogic> {

    /* renamed from: a */
    private TextView f39200a;
    ...
    public void initView() {
        ...
        this.f39200a = (TextView) findViewById;
    }

    public void setData(ComponentModel componentModel) {
        Intrinsics.checkNotNullParameter(componentModel, "componentModel");
        TextView textView = this.f39200a;
        Unit unit = null;
        if (textView == null) {
        ...
        if (deliveryModel != null) {
            ...
            setOnClickListener(new View.OnClickListener(componentModel) {
                ...
                public final void onClick(View view) {
                    BillDeliveryItemView.m27762a(DeliveryModel.this, this.f$1, view);
                }
            });
            unit = Unit.INSTANCE;
        }
    ...
    /* renamed from: a */
    public static final void m27762a(DeliveryModel deliveryModel, ComponentModel componentModel, View view) {
    ...
    /* renamed from: a */
    private final void m27763a(boolean z) {
        setVisibility(z ? 0 : 8);
    }
}
