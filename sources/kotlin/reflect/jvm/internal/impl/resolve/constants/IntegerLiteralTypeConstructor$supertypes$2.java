...
final class IntegerLiteralTypeConstructor$supertypes$2 extends Lambda implements Function0<List<SimpleType>> {
    ...
    public final List<SimpleType> invoke() {
        ...
        List<SimpleType> mutableListOf = CollectionsKt.mutableListOf(TypeSubstitutionKt.replace$default(defaultType, CollectionsKt.listOf(new TypeProjectionImpl(Variance.IN_VARIANCE, this.this$0.f60878d)), (Annotations) null, 2, (Object) null));
        if (!this.this$0.m44948a()) {
