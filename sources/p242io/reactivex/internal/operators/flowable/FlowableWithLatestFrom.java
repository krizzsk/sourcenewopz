...
public final class FlowableWithLatestFrom<T, U, R> extends C21208a<T, R> {

    /* renamed from: a */
    final BiFunction<? super T, ? super U, ? extends R> f58531a;

    /* renamed from: b */
    final Publisher<? extends U> f58532b;

    public FlowableWithLatestFrom(Flowable<T> flowable, BiFunction<? super T, ? super U, ? extends R> biFunction, Publisher<? extends U> publisher) {
        super(flowable);
        this.f58531a = biFunction;
        this.f58532b = publisher;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super R> subscriber) {
        SerializedSubscriber serializedSubscriber = new SerializedSubscriber(subscriber);
        WithLatestFromSubscriber withLatestFromSubscriber = new WithLatestFromSubscriber(serializedSubscriber, this.f58531a);
        serializedSubscriber.onSubscribe(withLatestFromSubscriber);
        this.f58532b.subscribe(new FlowableWithLatestSubscriber(withLatestFromSubscriber));
