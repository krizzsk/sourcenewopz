...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    /* renamed from: a */
    private boolean f52228a = true;

    /* renamed from: b */
    private boolean f52229b = true;

    /* renamed from: c */
    private boolean f52230c = true;

    /* renamed from: d */
    private boolean f52231d = true;

    /* renamed from: e */
    private long f52232e = 0;

    /* renamed from: f */
    private long f52233f = 0;

    /* renamed from: g */
    private RectF f52234g = new RectF();

    /* renamed from: h */
    private boolean f52235h = false;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mData != null) {
            ...
            if (this.mLogEnabled) {
                ...
                long j = this.f52232e + currentTimeMillis2;
                this.f52232e = j;
                long j2 = this.f52233f + 1;
                this.f52233f = j2;
                SystemUtils.log(4, Chart.LOG_TAG, "Drawtime: " + currentTimeMillis2 + " ms, average: " + (j / j2) + " ms, cycles: " + this.f52233f, (Throwable) null, "com.github.mikephil.charting.charts.BarLineChartBase", 292);
            }
        }
    }
    ...
    public void calculateLegendOffsets(RectF rectF) {
        ...
        if (this.mLegend != null && this.mLegend.isEnabled() && !this.mLegend.isDrawInsideEnabled()) {
            int i = C178562.f52237x9c9dbef[this.mLegend.getOrientation().ordinal()];
            if (i == 1) {
                int i2 = C178562.f52236x2787f53e[this.mLegend.getHorizontalAlignment().ordinal()];
                if (i2 == 1) {
                    ...
                    int i3 = C178562.f52238xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                    if (i3 == 1) {
                ...
                int i4 = C178562.f52238xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                if (i4 == 1) {
                    rectF.top += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
                } else if (i4 == 2) {
                    rectF.bottom += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
    ...
    static /* synthetic */ class C178562 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f52237x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r2 = f52236x2787f53e     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r2 = f52236x2787f53e     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0054:
                int[] r1 = f52238xc926f1ec     // Catch:{ NoSuchFieldError -> 0x005e }
            ...
            L_0x005e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.BarLineChartBase.C178562.<clinit>():void");
        }
    }

    public void calculateOffsets() {
        if (!this.f52235h) {
            calculateLegendOffsets(this.f52234g);
            float f = this.f52234g.left + 0.0f;
            float f2 = this.f52234g.top + 0.0f;
            float f3 = this.f52234g.right + 0.0f;
            float f4 = this.f52234g.bottom + 0.0f;
    ...
    public void zoomIn() {
        ...
        this.mViewPortHandler.zoomIn(contentCenter.f52498x, -contentCenter.f52499y, this.mZoomMatrixBuffer);
    ...
    public void zoomOut() {
        MPPointF contentCenter = this.mViewPortHandler.getContentCenter();
        this.mViewPortHandler.zoomOut(contentCenter.f52498x, -contentCenter.f52499y, this.mZoomMatrixBuffer);
        this.mViewPortHandler.refresh(this.mZoomMatrixBuffer, this, false);
        MPPointF.recycleInstance(contentCenter);
        calculateOffsets();
        postInvalidate();
    ...
    public void zoomToCenter(float f, float f2) {
        ...
        this.mViewPortHandler.zoom(f, f2, centerOffsets.f52498x, -centerOffsets.f52499y, matrix);
    ...
    public void zoomAndCenterAnimated(float f, float f2, float f3, float f4, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedZoomJob.getInstance(this.mViewPortHandler, this, getTransformer(axisDependency2), getAxis(axisDependency2), this.mXAxis.mAxisRange, f, f2, this.mViewPortHandler.getScaleX(), this.mViewPortHandler.getScaleY(), f3, f4, (float) valuesByTouchPoint.f52495x, (float) valuesByTouchPoint.f52496y, j));
    ...
    public void moveViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f, f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f52495x, (float) valuesByTouchPoint.f52496y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }
    ...
    public void centerViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f - (scaleX / 2.0f), f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f52495x, (float) valuesByTouchPoint.f52496y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }
    ...
    public boolean isDragEnabled() {
        return this.f52228a || this.f52229b;
    }
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f52495x);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f52495x);
    }
