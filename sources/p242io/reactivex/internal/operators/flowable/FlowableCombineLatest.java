...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    /* renamed from: a */
    final Publisher<? extends T>[] f58223a;

    /* renamed from: b */
    final Iterable<? extends Publisher<? extends T>> f58224b;

    /* renamed from: c */
    final Function<? super Object[], ? extends R> f58225c;

    /* renamed from: d */
    final int f58226d;

    /* renamed from: e */
    final boolean f58227e;

    public FlowableCombineLatest(Publisher<? extends T>[] publisherArr, Function<? super Object[], ? extends R> function, int i, boolean z) {
        this.f58223a = publisherArr;
        this.f58224b = null;
        this.f58225c = function;
        this.f58226d = i;
        this.f58227e = z;
    }
    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        int i;
        Publisher<? extends T>[] publisherArr = this.f58223a;
        if (publisherArr == null) {
            publisherArr = new Publisher[8];
            try {
                Iterator it = (Iterator) ObjectHelper.requireNonNull(this.f58224b.iterator(), "The iterator returned is null");
                i = 0;
                while (it.hasNext()) {
                    try {
                        try {
        ...
        if (i2 == 0) {
            ...
            CombineLatestCoordinator combineLatestCoordinator = new CombineLatestCoordinator(subscriber, this.f58225c, i2, this.f58226d, this.f58227e);
    ...
    static final class CombineLatestCoordinator<T, R> extends BasicIntQueueSubscription<R> {
        ...
        public void innerComplete(int r3) {
            ...
            L_0x001c:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.flowable.FlowableCombineLatest.CombineLatestCoordinator.innerComplete(int):void");
        }
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            return FlowableCombineLatest.this.f58225c.apply(new Object[]{t});
        }
    }
}
