...
public class HorizontalBarChartRenderer extends BarChartRenderer {
    ...
    /* renamed from: a */
    private RectF f52467a = new RectF();
    ...
    public void drawDataSet(Canvas canvas, IBarDataSet iBarDataSet, int i) {
        ...
        if (this.mChart.isDrawBarShadowEnabled()) {
            ...
            for (int i4 = 0; i4 < min; i4++) {
                ...
                this.f52467a.top = x - barWidth;
                this.f52467a.bottom = x + barWidth;
                transformer.rectValueToPixel(this.f52467a);
                if (!this.mViewPortHandler.isInBoundsTop(this.f52467a.bottom)) {
                    Canvas canvas2 = canvas;
                } else if (!this.mViewPortHandler.isInBoundsBottom(this.f52467a.top)) {
                    break;
                } else {
                    this.f52467a.left = this.mViewPortHandler.contentLeft();
                    this.f52467a.right = this.mViewPortHandler.contentRight();
                    canvas.drawRect(this.f52467a, this.mShadowPaint);
                }
            }
        }
                        ...
                        while (((float) i7) < ((float) barBuffer2.buffer.length) * this.mAnimator.getPhaseX()) {
                            ...
                            if (this.mViewPortHandler.isInBoundsX(barBuffer2.buffer[i7]) && this.mViewPortHandler.isInBoundsBottom(barBuffer2.buffer[i8])) {
                                ...
                                if (barEntry2.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                    ...
                                    Utils.drawImage(canvas, icon, (int) (f14 + f9 + mPPointF2.f52498x), (int) (f6 + mPPointF2.f52499y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                                }
                            } else {
                                i4 = i7;
                                list2 = dataSets;
                            ...
                            if (yVals != null) {
                                ...
                                while (true) {
                                    ...
                                    if (this.mViewPortHandler.isInBoundsX(f24) && this.mViewPortHandler.isInBoundsBottom(f25)) {
                                        ...
                                        if (barEntry4.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                            ...
                                            Utils.drawImage(canvas, icon2, (int) (f2 + mPPointF.f52498x), (int) (f + mPPointF.f52499y), icon2.getIntrinsicWidth(), icon2.getIntrinsicHeight());
                                        }
                                    } else {
                                        i3 = i14;
                                        fArr2 = fArr3;
                                ...
                                if (!this.mViewPortHandler.isInBoundsTop(barBuffer3.buffer[i16])) {
                                    ...
                                    if (barEntry.getIcon() != null && iBarDataSet.isDrawIconsEnabled()) {
                                        ...
                                        Utils.drawImage(canvas, icon3, (int) (f32 + f30 + mPPointF.f52498x), (int) (barBuffer3.buffer[i16] + mPPointF.f52499y), icon3.getIntrinsicWidth(), icon3.getIntrinsicHeight());
                                    }
                                }
                            }
