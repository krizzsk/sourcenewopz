...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f6360Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001"));

    /* renamed from: x */
    protected int[] f6361x;

    public SecP224R1FieldElement() {
        this.f6361x = Nat224.create();
    }

    public SecP224R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f6360Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224R1FieldElement");
        }
        this.f6361x = SecP224R1Field.fromBigInteger(bigInteger);
    }
    ...
    /* renamed from: RM */
    private static void m3731RM(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5, int[] iArr6, int[] iArr7) {
    ...
    /* renamed from: RP */
    private static void m3732RP(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            while (true) {
                ...
                m3733RS(iArr2, iArr3, iArr4, iArr5);
            }
            m3731RM(iArr, create, create2, iArr2, iArr3, iArr4, iArr5);
        }
    }

    /* renamed from: RS */
    private static void m3733RS(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
    ...
    private static boolean trySqrt(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        m3732RP(iArr, create, create2, create3, iArr3);
        int[] create4 = Nat224.create();
        int[] create5 = Nat224.create();
        for (int i = 1; i < 96; i++) {
            Nat224.copy(create, create4);
            Nat224.copy(create2, create5);
            m3733RS(create, create2, create3, iArr3);
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.add(this.f6361x, ((SecP224R1FieldElement) eCFieldElement).f6361x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224R1Field.addOne(this.f6361x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.inv(((SecP224R1FieldElement) eCFieldElement).f6361x, create);
        SecP224R1Field.multiply(create, this.f6361x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat224.m3738eq(this.f6361x, ((SecP224R1FieldElement) obj).f6361x);
    }
    ...
    public int getFieldSize() {
        return f6360Q.bitLength();
    }

    public int hashCode() {
        return f6360Q.hashCode() ^ Arrays.hashCode(this.f6361x, 0, 7);
    }

    public ECFieldElement invert() {
        int[] create = Nat224.create();
        SecP224R1Field.inv(this.f6361x, create);
        return new SecP224R1FieldElement(create);
    }

    public boolean isOne() {
        return Nat224.isOne(this.f6361x);
    }

    public boolean isZero() {
        return Nat224.isZero(this.f6361x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.multiply(this.f6361x, ((SecP224R1FieldElement) eCFieldElement).f6361x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224R1Field.negate(this.f6361x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f6361x;
        if (Nat224.isZero(iArr) || Nat224.isOne(iArr)) {
            return this;
        }
        int[] create = Nat224.create();
        SecP224R1Field.negate(iArr, create);
        int[] random = Mod.random(SecP224R1Field.f6358P);
        int[] create2 = Nat224.create();
        if (!isSquare(iArr)) {
            return null;
        }
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224R1Field.square(this.f6361x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.subtract(this.f6361x, ((SecP224R1FieldElement) eCFieldElement).f6361x, create);
        return new SecP224R1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat224.getBit(this.f6361x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f6361x);
    }
}
