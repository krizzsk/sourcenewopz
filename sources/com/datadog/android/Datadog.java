...
public final class Datadog {
    ...
    public static final void initialize(Context context, Credentials credentials, Configuration configuration, TrackingConsent trackingConsent) {
        ...
        f3377d = INSTANCE.m2282b(context);
        if (INSTANCE.m2280a(credentials.getEnvName())) {
            ...
            INSTANCE.m2279a((Map<String, ? extends Object>) configuration.getAdditionalConfig$dd_sdk_android_release());
            INSTANCE.m2276a(configuration.getLogsConfig$dd_sdk_android_release(), applicationContext);
            INSTANCE.m2278a(configuration.getTracesConfig$dd_sdk_android_release(), applicationContext);
            INSTANCE.m2277a(configuration.getRumConfig$dd_sdk_android_release(), applicationContext);
            INSTANCE.m2274a(configuration.getCrashReportConfig$dd_sdk_android_release(), applicationContext);
            INSTANCE.m2275a(configuration.getInternalLogsConfig$dd_sdk_android_release(), applicationContext);
            ...
            INSTANCE.m2273a(applicationContext);
            f3374a.set(true);
    ...
    /* renamed from: c */
    public static final void m2283c() {
        INSTANCE.m2272a();
    }
    ...
    /* renamed from: a */
    private final void m2276a(Configuration.Feature.Logs logs, Context context) {
        if (logs != null) {
    ...
    /* renamed from: a */
    private final void m2274a(Configuration.Feature.CrashReport crashReport, Context context) {
        if (crashReport != null) {
    ...
    /* renamed from: a */
    private final void m2278a(Configuration.Feature.Tracing tracing, Context context) {
        if (tracing != null) {
    ...
    /* renamed from: a */
    private final void m2277a(Configuration.Feature.RUM rum, Context context) {
        if (rum != null) {
    ...
    /* renamed from: a */
    private final void m2275a(Configuration.Feature.InternalLogs internalLogs, Context context) {
    ...
    /* renamed from: a */
    private final void m2279a(Map<String, ? extends Object> map) {
    ...
    /* renamed from: a */
    private final boolean m2280a(String str) {
    ...
    /* renamed from: a */
    private final void m2273a(Context context) {
    ...
    /* renamed from: b */
    private final boolean m2282b(Context context) {
