...
public class DeviceInfo {
    ...
    /* renamed from: a */
    private static final FileFilter f11751a = new FileFilter() {
    ...
    public static int getNumberOfCPUCores() {
        ...
        try {
            int b = m7960b("/sys/devices/system/cpu/possible");
            if (b == -1) {
                b = m7960b("/sys/devices/system/cpu/present");
            }
            return b == -1 ? m7956a() : b;
    ...
    private static int m7960b(java.lang.String r2) {
        /*
            r0 = 0
            ...
            int r2 = m7957a(r0)     // Catch:{ IOException -> 0x0022, all -> 0x001f }
        ...
        L_0x0032:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.component.common.util.DeviceInfo.m7960b(java.lang.String):int");
    }

    /* renamed from: a */
    static int m7957a(String str) {
    ...
    /* renamed from: a */
    private static int m7956a() {
        return new File("/sys/devices/system/cpu/").listFiles(f11751a).length;
    }
    ...
    public static int getCPUMaxFreqKHz() {
        ...
        L_0x006e:
            ...
            int r2 = m7958a((java.lang.String) r2, (java.io.FileInputStream) r0)     // Catch:{ all -> 0x0086 }
            int r2 = r2 * 1000
    ...
    public static long getTotalMemory(Context context) {
        ...
        try {
            ...
            j = ((long) m7958a("MemTotal", fileInputStream)) * 1024;
    ...
    /* renamed from: a */
    private static int m7958a(String str, FileInputStream fileInputStream) {
    ...
    /* renamed from: a */
    private static int m7959a(byte[] bArr, int i) {
