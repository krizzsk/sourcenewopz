...
public final class FlowableConcatArray<T> extends Flowable<T> {
    ...
    /* renamed from: a */
    final Publisher<? extends T>[] f58228a;

    /* renamed from: b */
    final boolean f58229b;

    public FlowableConcatArray(Publisher<? extends T>[] publisherArr, boolean z) {
        this.f58228a = publisherArr;
        this.f58229b = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ConcatArraySubscriber concatArraySubscriber = new ConcatArraySubscriber(this.f58228a, this.f58229b, subscriber);
