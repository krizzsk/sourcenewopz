...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    static /* synthetic */ class C193471 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.FieldInfo.C193471.<clinit>():void");
        }
    }

    public Class<?> getMessageFieldClass() {
        int i = C193471.$SwitchMap$com$google$protobuf$FieldType[this.type.ordinal()];
        if (i == 1 || i == 2) {
    ...
    public static Builder newBuilder() {
        return new Builder((C193471) null);
    }
