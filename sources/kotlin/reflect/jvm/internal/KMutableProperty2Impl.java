...
public final class KMutableProperty2Impl<D, E, V> extends KProperty2Impl<D, E, V> implements KMutableProperty2<D, E, V> {
    ...
    public Setter<D, E, V> getSetter() {
        Setter<D, E, V> invoke = this.f60034a.invoke();
