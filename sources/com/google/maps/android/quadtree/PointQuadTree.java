...
public class PointQuadTree<T extends Item> {
    ...
    public void add(T t) {
        ...
        if (this.mBounds.contains(point.f53781x, point.f53782y)) {
            insert(point.f53781x, point.f53782y, t);
        }
    }
    ...
    private void split() {
        ...
        this.mItems = null;
        for (T t : set) {
            insert(t.getPoint().f53781x, t.getPoint().f53782y, t);
        }
    }
    ...
    public boolean remove(T t) {
        ...
        return remove(point.f53781x, point.f53782y, t);
    }
