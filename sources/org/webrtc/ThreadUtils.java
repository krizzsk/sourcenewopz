...
public class ThreadUtils {
    ...
    public static <V> V invokeAtFrontUninterruptibly(Handler handler, final Callable<V> callable) {
        if (handler.getLooper().getThread() == Thread.currentThread()) {
            ...
            RuntimeException runtimeException = new RuntimeException(r1.f6711e);
            runtimeException.setStackTrace(concatStackTraces(r1.f6711e.getStackTrace(), runtimeException.getStackTrace()));
