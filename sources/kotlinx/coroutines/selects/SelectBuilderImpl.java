...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements Continuation<R>, CoroutineStackFrame, SelectBuilder<R>, SelectInstance<R> {
    ...
    /* renamed from: a */
    static final /* synthetic */ AtomicReferenceFieldUpdater f61603a;

    /* renamed from: b */
    static final /* synthetic */ AtomicReferenceFieldUpdater f61604b;
    private volatile /* synthetic */ Object _parentHandle = null;
    volatile /* synthetic */ Object _result = SelectKt.f61608c;
    volatile /* synthetic */ Object _state = SelectKt.getNOT_SELECTED();

    /* renamed from: c */
    private final Continuation<R> f61605c;

    static {
        Class<SelectBuilderImpl> cls = SelectBuilderImpl.class;
        f61603a = AtomicReferenceFieldUpdater.newUpdater(cls, Object.class, "_state");
        f61604b = AtomicReferenceFieldUpdater.newUpdater(cls, Object.class, "_result");
    }
    ...
    public SelectBuilderImpl(Continuation<? super R> continuation) {
        this.f61605c = continuation;
    }

    public CoroutineStackFrame getCallerFrame() {
        Continuation<R> continuation = this.f61605c;
    ...
    /* renamed from: a */
    private final DisposableHandle m46067a() {
        return (DisposableHandle) this._parentHandle;
    }

    /* renamed from: a */
    private final void m46069a(DisposableHandle disposableHandle) {
        this._parentHandle = disposableHandle;
    }

    public CoroutineContext getContext() {
        return this.f61605c.getContext();
    }
    ...
    /* renamed from: a */
    private final void m46068a(Function0<? extends Object> function0, Function0<Unit> function02) {
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                Object obj = this._result;
                if (obj == SelectKt.f61608c) {
                    if (f61604b.compareAndSet(this, SelectKt.f61608c, function0.invoke())) {
                        return;
                    }
                } else if (obj != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    throw new IllegalStateException("Already resumed");
                } else if (f61604b.compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.f61609d)) {
                    function02.invoke();
                    return;
                }
            }
    ...
    public final Object getResult() {
        ...
        Object obj = this._result;
        if (obj == SelectKt.f61608c) {
            if (f61604b.compareAndSet(this, SelectKt.f61608c, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
                return IntrinsicsKt.getCOROUTINE_SUSPENDED();
            }
            obj = this._result;
        }
        if (obj == SelectKt.f61609d) {
            throw new IllegalStateException("Already resumed");
    ...
    private final void m46070b() {
        ...
        if (job != null) {
            ...
            m46069a(invokeOnCompletion$default);
            if (isSelected()) {
    ...
    @Metadata(mo175977d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0013\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0002¨\u0006\u0007"}, mo175978d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$SelectOnCancelling;", "Lkotlinx/coroutines/JobCancellingNode;", "(Lkotlinx/coroutines/selects/SelectBuilderImpl;)V", "invoke", "", "cause", "", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: Select.kt */
    ...
    public final void handleBuilderException(Throwable th) {
        if (trySelect()) {
            ...
            resumeWith(Result.m47688constructorimpl(ResultKt.createFailure(th)));
    ...
    /* renamed from: c */
    public final void m46071c() {
        DisposableHandle a = m46067a();
        if (a != null) {
            a.dispose();
        }
    ...
    @Metadata(mo175977d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0014\u0010\t\u001a\u0004\u0018\u00010\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\nH\u0016R\u0018\u0010\u0005\u001a\u0006\u0012\u0002\b\u00030\u00068VX\u0004¢\u0006\u0006\u001a\u0004\b\u0007\u0010\bR\u0010\u0010\u0002\u001a\u00020\u00038\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, mo175978d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$PairSelectOp;", "Lkotlinx/coroutines/internal/OpDescriptor;", "otherOp", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;", "(Lkotlinx/coroutines/internal/LockFreeLinkedListNode$PrepareOp;)V", "atomicOp", "Lkotlinx/coroutines/internal/AtomicOp;", "getAtomicOp", "()Lkotlinx/coroutines/internal/AtomicOp;", "perform", "", "affected", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: Select.kt */
    private static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object obj) {
            if (obj != null) {
                ...
                SelectBuilderImpl.f61603a.compareAndSet(selectBuilderImpl, this, decide == null ? this.otherOp.desc : SelectKt.getNOT_SELECTED());
                return decide;
            }
    ...
    @Metadata(mo175977d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0002\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001B\u0019\u0012\n\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u001c\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u00022\b\u0010\u000f\u001a\u0004\u0018\u00010\u0002H\u0016J\u0012\u0010\u0010\u001a\u00020\r2\b\u0010\u000f\u001a\u0004\u0018\u00010\u0002H\u0002J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\u00022\b\u0010\u000e\u001a\u0004\u0018\u00010\u0002H\u0016J\n\u0010\u0012\u001a\u0004\u0018\u00010\u0002H\u0002J\b\u0010\u0013\u001a\u00020\u0014H\u0016J\b\u0010\u0015\u001a\u00020\rH\u0002R\u0010\u0010\u0005\u001a\u00020\u00068\u0006X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0003\u001a\u0006\u0012\u0002\b\u00030\u00048\u0006X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\u00020\tX\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\u0016"}, mo175978d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$AtomicSelectOp;", "Lkotlinx/coroutines/internal/AtomicOp;", "", "impl", "Lkotlinx/coroutines/selects/SelectBuilderImpl;", "desc", "Lkotlinx/coroutines/internal/AtomicDesc;", "(Lkotlinx/coroutines/selects/SelectBuilderImpl;Lkotlinx/coroutines/internal/AtomicDesc;)V", "opSequence", "", "getOpSequence", "()J", "complete", "", "affected", "failure", "completeSelect", "prepare", "prepareSelectOp", "toString", "", "undoPrepare", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: Select.kt */
    private static final class AtomicSelectOp extends AtomicOp<Object> {
        public final AtomicDesc desc;
        public final SelectBuilderImpl<?> impl;
        private final long opSequence = SelectKt.f61610e.next();
        ...
        private final Object prepareSelectOp() {
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (SelectBuilderImpl.f61603a.compareAndSet(this.impl, SelectKt.getNOT_SELECTED(), this)) {
                        return null;
                    }
                }
            }
        ...
        private final void undoPrepare() {
            SelectBuilderImpl.f61603a.compareAndSet(this.impl, this, SelectKt.getNOT_SELECTED());
        }

        private final void completeSelect(Object obj) {
            boolean z = obj == null;
            if (SelectBuilderImpl.f61603a.compareAndSet(this.impl, this, z ? null : SelectKt.getNOT_SELECTED()) && z) {
                this.impl.m46071c();
            }
        }
    ...
    @Metadata(mo175977d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0010\u0010\u0002\u001a\u00020\u00038\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo175978d2 = {"Lkotlinx/coroutines/selects/SelectBuilderImpl$DisposeNode;", "Lkotlinx/coroutines/internal/LockFreeLinkedListNode;", "handle", "Lkotlinx/coroutines/DisposableHandle;", "(Lkotlinx/coroutines/DisposableHandle;)V", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
    /* compiled from: Select.kt */
    ...
    public void resumeWith(Object obj) {
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj2 == SelectKt.f61608c) {
                    if (f61604b.compareAndSet(this, SelectKt.f61608c, CompletionStateKt.toState$default(obj, (Function1) null, 1, (Object) null))) {
                        return;
                    }
                    ...
                    if (Result.m47694isFailureimpl(obj)) {
                        Continuation<R> continuation = this.f61605c;
                        Throwable r4 = Result.m47691exceptionOrNullimpl(obj);
                        Intrinsics.checkNotNull(r4);
                        Result.Companion companion = Result.Companion;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            r4 = StackTraceRecoveryKt.m45986a(r4, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m47688constructorimpl(ResultKt.createFailure(r4)));
                        return;
                    }
                    this.f61605c.resumeWith(obj);
                    return;
                }
            }
        } else {
    ...
    public void resumeSelectWithException(Throwable th) {
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj == SelectKt.f61608c) {
                    Continuation<R> continuation = this.f61605c;
                    if (f61604b.compareAndSet(this, SelectKt.f61608c, new CompletedExceptionally((!DebugKt.getRECOVER_STACK_TRACES() || !(continuation instanceof CoroutineStackFrame)) ? th : StackTraceRecoveryKt.m45986a(th, (CoroutineStackFrame) continuation), false, 2, (DefaultConstructorMarker) null))) {
                        return;
                    }
                } else if (obj != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    throw new IllegalStateException("Already resumed");
                } else if (f61604b.compareAndSet(this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.f61609d)) {
                    Continuation<R> intercepted = IntrinsicsKt.intercepted(this.f61605c);
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m47688constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        } else {
    ...
    public Object trySelectOther(LockFreeLinkedListNode.PrepareOp prepareOp) {
        while (true) {
            ...
            if (obj == SelectKt.getNOT_SELECTED()) {
                if (prepareOp == null) {
                    if (f61603a.compareAndSet(this, SelectKt.getNOT_SELECTED(), (Object) null)) {
                        break;
                    }
                } else {
                    PairSelectOp pairSelectOp = new PairSelectOp(prepareOp);
                    if (f61603a.compareAndSet(this, SelectKt.getNOT_SELECTED(), pairSelectOp)) {
