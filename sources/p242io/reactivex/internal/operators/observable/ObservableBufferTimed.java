...
public final class ObservableBufferTimed<T, U extends Collection<? super T>> extends C21211a<T, U> {
    ...
    /* renamed from: d */
    final Scheduler f58733d;

    /* renamed from: e */
    final Callable<U> f58734e;

    /* renamed from: f */
    final int f58735f;

    /* renamed from: g */
    final boolean f58736g;
    ...
    public ObservableBufferTimed(ObservableSource<T> observableSource, long j, long j2, TimeUnit timeUnit, Scheduler scheduler, Callable<U> callable, int i, boolean z) {
        ...
        this.f58733d = scheduler;
        this.f58734e = callable;
        this.f58735f = i;
        this.f58736g = z;
    }
    ...
    public void subscribeActual(Observer<? super U> observer) {
        if (this.f58730a == this.f58731b && this.f58735f == Integer.MAX_VALUE) {
            this.source.subscribe(new BufferExactUnboundedObserver(new SerializedObserver(observer), this.f58734e, this.f58730a, this.f58732c, this.f58733d));
            return;
        }
        Scheduler.Worker createWorker = this.f58733d.createWorker();
        if (this.f58730a == this.f58731b) {
            this.source.subscribe(new BufferExactBoundedObserver(new SerializedObserver(observer), this.f58734e, this.f58730a, this.f58732c, this.f58735f, this.f58736g, createWorker));
        } else {
            this.source.subscribe(new BufferSkipBoundedObserver(new SerializedObserver(observer), this.f58734e, this.f58730a, this.f58731b, this.f58732c, createWorker));
        }
    }
    ...
    static final class BufferSkipBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Disposable, Runnable {
        ...
        /* renamed from: w */
        final Scheduler.Worker f58738w;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                try {
                    ...
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f58738w;
                    long j = this.timeskip;
                    worker.schedulePeriodically(this, j, j, this.unit);
                    this.f58738w.schedule(new RemoveFromBufferEmit(collection), this.timespan, this.unit);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    disposable.dispose();
                    EmptyDisposable.error(th, (Observer<?>) this.downstream);
                    this.f58738w.dispose();
                }
            }
        }
        ...
        public void onComplete() {
            ...
            this.done = true;
            if (enter()) {
                QueueDrainHelper.drainLoop(this.queue, this.downstream, false, this.f58738w, this);
            }
        }
            ...
            if (!this.cancelled) {
                try {
                    ...
                    synchronized (this) {
                        if (!this.cancelled) {
                            this.buffers.add(collection);
                            this.f58738w.schedule(new RemoveFromBuffer(collection), this.timespan, this.unit);
                        }
                    }
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
        ...
        final class RemoveFromBuffer implements Runnable {
            ...
            public void run() {
                synchronized (BufferSkipBoundedObserver.this) {
                    BufferSkipBoundedObserver.this.buffers.remove(this.f58739b);
                }
                BufferSkipBoundedObserver bufferSkipBoundedObserver = BufferSkipBoundedObserver.this;
                bufferSkipBoundedObserver.fastPathOrderedEmit(this.f58739b, false, bufferSkipBoundedObserver.f58738w);
            }
        }
        ...
        final class RemoveFromBufferEmit implements Runnable {
            ...
            public void run() {
                ...
                BufferSkipBoundedObserver bufferSkipBoundedObserver = BufferSkipBoundedObserver.this;
                bufferSkipBoundedObserver.fastPathOrderedEmit(this.buffer, false, bufferSkipBoundedObserver.f58738w);
            }
        }
    }
    ...
    static final class BufferExactBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Disposable, Runnable {
        ...
        /* renamed from: w */
        final Scheduler.Worker f58737w;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                try {
                    this.buffer = (Collection) ObjectHelper.requireNonNull(this.bufferSupplier.call(), "The buffer supplied is null");
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f58737w;
                    long j = this.timespan;
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
            r8 = (java.util.Collection) p242io.reactivex.internal.functions.ObjectHelper.requireNonNull(r7.bufferSupplier.call(), "The buffer supplied is null");
         */
        ...
        public void onNext(T r8) {
            ...
            L_0x0028:
                ...
                io.reactivex.Scheduler$Worker r0 = r7.f58737w
                long r4 = r7.timespan
            ...
            L_0x0066:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableBufferTimed.BufferExactBoundedObserver.onNext(java.lang.Object):void");
        }
