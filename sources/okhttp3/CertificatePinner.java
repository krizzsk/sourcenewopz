...
public final class CertificatePinner {
    ...
    /* renamed from: a */
    private final Set<Pin> f5109a;
    @Nullable

    /* renamed from: b */
    private final CertificateChainCleaner f5110b;

    CertificatePinner(Set<Pin> set, @Nullable CertificateChainCleaner certificateChainCleaner) {
        this.f5109a = set;
        this.f5110b = certificateChainCleaner;
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof CertificatePinner) {
            ...
            if (!C2434Util.equal(this.f5110b, certificatePinner.f5110b) || !this.f5109a.equals(certificatePinner.f5109a)) {
                return false;
            }
            return true;
        }
    ...
    public int hashCode() {
        CertificateChainCleaner certificateChainCleaner = this.f5110b;
        return ((certificateChainCleaner != null ? certificateChainCleaner.hashCode() : 0) * 31) + this.f5109a.hashCode();
    }

    public void check(String str, List<Certificate> list) throws SSLPeerUnverifiedException {
        List<Pin> a = mo24673a(str);
        if (!a.isEmpty()) {
            CertificateChainCleaner certificateChainCleaner = this.f5110b;
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (pin.hashAlgorithm.equals("sha256/")) {
                        if (byteString == null) {
                            byteString = m3321b(x509Certificate);
                        }
                        ...
                        if (byteString2 == null) {
                            byteString2 = m3320a(x509Certificate);
                        }
    ...
    /* renamed from: a */
    public List<Pin> mo24673a(String str) {
        List<Pin> emptyList = Collections.emptyList();
        for (Pin next : this.f5109a) {
            if (next.matches(str)) {
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public CertificatePinner mo24674a(@Nullable CertificateChainCleaner certificateChainCleaner) {
        if (C2434Util.equal(this.f5110b, certificateChainCleaner)) {
            return this;
        }
        return new CertificatePinner(this.f5109a, certificateChainCleaner);
    }

    public static String pin(Certificate certificate) {
        if (certificate instanceof X509Certificate) {
            return "sha256/" + m3321b((X509Certificate) certificate).base64();
        }
        throw new IllegalArgumentException("Certificate pinning requires X509 certificates");
    }

    /* renamed from: a */
    static ByteString m3320a(X509Certificate x509Certificate) {
        return ByteString.m3607of(x509Certificate.getPublicKey().getEncoded()).sha1();
    }

    /* renamed from: b */
    static ByteString m3321b(X509Certificate x509Certificate) {
