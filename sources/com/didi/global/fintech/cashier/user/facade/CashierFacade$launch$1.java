...
final class CashierFacade$launch$1 extends Lambda implements Function1<Boolean, Unit> {
    ...
    CashierFacade$launch$1(CashierLaunchListener cashierLaunchListener, CashierFacade cashierFacade, Activity activity, CashierParam cashierParam) {
        super(1);
    ...
    public final void invoke(boolean z) {
        ...
        if (cashierFacade != null) {
            ...
            if (access$getCashierProcessor$p != null) {
                access$getCashierProcessor$p.launch(activity, (Intent) null, (Integer) null, cashierParam);
            }
        }
    }
}
