...
public class Utils {
    ...
    /* renamed from: a */
    private static int f46122a = 0;

    /* renamed from: b */
    private static int f46123b = 1;

    /* renamed from: c */
    private static boolean f46124c = false;

    /* renamed from: d */
    private static boolean f46125d = false;

    /* renamed from: e */
    private static volatile String f46126e;

    /* renamed from: f */
    private static String[] f46127f;
    ...
    public static String[] getMccMnc(TelephonyManager telephonyManager) {
        ...
        if (!strArr2[0].equals("0") && !strArr2[1].equals("0")) {
            f46127f = strArr2;
            return strArr2;
        } else if (!strArr2[0].equals("0") || !strArr2[1].equals("0") || (strArr = f46127f) == null) {
            return strArr2;
        } else {
    ...
    static /* synthetic */ class C151681 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f46128xbd3682fa     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f46128xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f46128xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p173dp.locsdk.once.Utils.C151681.<clinit>():void");
        }
    }

    public static boolean isPermissionStrategyAllowed(Context context) {
        int i = C151681.f46128xbd3682fa[Config.sPermissionStrategy.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
    ...
    /* renamed from: a */
    static boolean m33129a(Location location) {
    ...
    public static String getChipInfo() {
        if (f46126e == null) {
            f46126e = executeShell("getprop", "ro.board.platform");
        }
        return f46126e;
    }
