package com.didi.sdk.map.common_map;

import com.taxis99.R;

/* renamed from: com.didi.sdk.map.common_map.R */
public final class C12440R {

    /* renamed from: com.didi.sdk.map.common_map.R$attr */
    public static final class attr {
        private attr() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$bool */
    public static final class bool {
        private bool() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$color */
    public static final class C12441color {
        private C12441color() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$dimen */
    public static final class dimen {
        private dimen() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$drawable */
    public static final class C12442drawable {
        private C12442drawable() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$id */
    public static final class C12443id {
        private C12443id() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$integer */
    public static final class integer {
        private integer() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$layout */
    public static final class C12444layout {
        private C12444layout() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$string */
    public static final class string {
        private string() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$style */
    public static final class C12445style {
        private C12445style() {
        }
    }

    /* renamed from: com.didi.sdk.map.common_map.R$styleable */
