...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f53598f;

        /* renamed from: g */
        private final Function<B, C> f53599g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f53599g = (Function) Preconditions.checkNotNull(function);
            this.f53598f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f53599g.apply(this.f53598f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f53598f.equals(functionComposition.f53598f) || !this.f53599g.equals(functionComposition.f53599g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f53598f.hashCode() ^ this.f53599g.hashCode();
        }

        public String toString() {
            return this.f53599g + "(" + this.f53598f + ")";
        }
    }
