...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f53835FS = '\u001c';

    /* renamed from: GS */
    private static final char f53836GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f53837NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f53838RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f53836GS + format + f53836GS + format2 + f53836GS);
            } else {
                sb.insert(0, str + f53836GS + format + f53836GS + format2 + f53836GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f53596US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f53585EM, Ascii.SUB, Ascii.ESC, Ascii.f53587FS, Ascii.f53588GS, Ascii.f53592RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f53584CR, Ascii.f53594SO, Ascii.f53593SI, 16, 17, Ascii.DC2, 7, 8, 9, 10, 11, Ascii.f53586FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f53596US, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f53585EM, Ascii.SUB})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f53587FS, Ascii.f53588GS, Ascii.f53592RS, 19, Ascii.DC4})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f53584CR, Ascii.f53594SO})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.f53593SI, 16, 17, Ascii.DC2, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, 11, Ascii.f53586FF, 1, 2}))});
    }
