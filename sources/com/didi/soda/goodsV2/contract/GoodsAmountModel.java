...
public class GoodsAmountModel {
    ...
    /* renamed from: c */
    private GoodsAmountListener f42502c;
    ...
    public boolean decreaseAmount(int i) {
        if (exceedMinAmount()) {
            GoodsAmountListener goodsAmountListener = this.f42502c;
    ...
    public boolean exceedMaxAmount() {
        return this.f42500a >= this.mMaxAmount;
    }
    ...
    public boolean exceedMinAmount() {
        return this.f42500a <= this.mMinAmount;
    }
    ...
    public boolean increaseAmount(int i) {
        if (exceedMaxAmount()) {
            ...
            return false;
        } else if (exceedMaxSaleAmount() && this.f42502c != null) {
            return false;
        } else {
            this.f42500a += i;
            return true;
    ...
    public static class Builder {
        ...
        public Builder setInitialAmount(int i) {
            ...
            int unused = this.mGoodsAmountModel.f42500a = i;
            return this;
        }
        ...
        public Builder setAllowOverAmoun(boolean z) {
            boolean unused = this.mGoodsAmountModel.f42501b = z;
            return this;
        }
    }
}
