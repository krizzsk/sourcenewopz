...
public final class Version {
    ...
    /* renamed from: a */
    private static final int[] f19024a = {31892, 34236, C13565R2.styleable.TabIndication_item_text_selected_color, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: b */
    private static final Version[] f19025b = m14214b();
    ...
    /* renamed from: e */
    private final ECBlocks[] f19028e;
    ...
    public BitMatrix mo58582a() {
        ...
        int length = this.f19027d.length;
        for (int i2 = 0; i2 < length; i2++) {
            int i3 = this.f19027d[i2] - 2;
            for (int i4 = 0; i4 < length; i4++) {
                if (!((i2 == 0 && (i4 == 0 || i4 == length - 1)) || (i2 == length - 1 && i4 == 0))) {
                    bitMatrix.setRegion(this.f19027d[i4] - 2, i3, 5, 5);
                }
            }
        }
    ...
    public String toString() {
        return String.valueOf(this.f19026c);
    }

    /* renamed from: b */
    private static Version[] m14214b() {
