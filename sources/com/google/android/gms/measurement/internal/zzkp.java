...
public final class zzkp extends zzke {
        ...
        if (zzel != null) {
            ...
            if (zzel.zza()) {
                ...
                if (zzb != null) {
                    ...
                    if (zzb.zzc()) {
                        zzH(sb, i2, TrackConst.Params.EXPRESSION, zzb.zzd());
                    }
                    if (zzb.zze()) {
    ...
    public final String zzh(zzfu zzfu) {
        ...
        for (zzfw next : zzfu.zza()) {
            if (next != null) {
                ...
                zzH(sb, 1, ServerParam.PARAM_OS_VERSION, next.zzu());
                zzH(sb, 1, ParamConst.PARAM_DEVICE_MODEL, next.zzv());
                ...
                if (zzc != null) {
                    for (zzfo next4 : zzc) {
                        if (next4 != null) {
                            ...
                            if (next4.zzi()) {
                                zzH(sb, 2, Const.PageParams.COUNT, Integer.valueOf(next4.zzj()));
                            }
                            if (next4.zzb() != 0) {
                                zzC(sb, 2, next4.zza());
                            }
    ...
    public final String zzi(zzej zzej) {
        ...
        zzH(sb, 0, TrackConst.Params.EVENT_NAME, this.zzs.zzm().zzc(zzej.zzc()));
