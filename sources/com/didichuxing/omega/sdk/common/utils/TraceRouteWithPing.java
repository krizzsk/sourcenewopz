...
public class TraceRouteWithPing {
    ...
    public static String parseIpFromPing(String str) {
        ...
        try {
            ...
            OLog.m34763e("parseIpFromPing error");
            return "*";
        }
    }
    ...
    public static float parseAvgTimeFromPing(String str) {
        try {
            ...
            OLog.m34763e("parseAllTimeFromPing error");
            return 0.0f;
        }
    }
    ...
    public static float parseErrorRatio(String str) {
        try {
            ...
            OLog.m34763e("parseErrorRatio NumberFormatException");
            return 0.0f;
        } catch (Exception unused2) {
            OLog.m34763e("parseErrorRatio error");
            return 0.0f;
        }
    }
