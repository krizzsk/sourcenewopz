...
public final class CancellableKt {
    public static final <T> void startCoroutineCancellable(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) {
        try {
            ...
            DispatchedContinuationKt.resumeCancellableWith$default(intercepted, Result.m47688constructorimpl(Unit.INSTANCE), (Function1) null, 2, (Object) null);
        } catch (Throwable th) {
            m46005a((Continuation<?>) continuation, th);
        }
    }
    ...
    public static final <R, T> void startCoroutineCancellable(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation, Function1<? super Throwable, Unit> function1) {
        try {
            ...
            Result.Companion companion = Result.Companion;
            DispatchedContinuationKt.resumeCancellableWith(intercepted, Result.m47688constructorimpl(Unit.INSTANCE), function1);
        } catch (Throwable th) {
            m46005a((Continuation<?>) continuation, th);
        }
    }
    ...
    public static final void startCoroutineCancellable(Continuation<? super Unit> continuation, Continuation<?> continuation2) {
        try {
            ...
            m46005a(continuation2, th);
        }
    }

    /* renamed from: a */
    private static final void m46006a(Continuation<?> continuation, Function0<Unit> function0) {
        try {
            function0.invoke();
        } catch (Throwable th) {
            m46005a(continuation, th);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public static final void m46005a(Continuation<?> continuation, Throwable th) {
        Result.Companion companion = Result.Companion;
