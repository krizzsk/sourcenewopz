...
public class JavaAudioDeviceModule implements AudioDeviceModule {
    ...
    public static class Builder {
        ...
        public Builder setSampleRate(int i) {
            Logging.m3800d(JavaAudioDeviceModule.TAG, "Input/Output sample rate overridden to: " + i);
        ...
        public Builder setInputSampleRate(int i) {
            Logging.m3800d(JavaAudioDeviceModule.TAG, "Input sample rate overridden to: " + i);
            this.inputSampleRate = i;
            return this;
        }

        public Builder setOutputSampleRate(int i) {
            Logging.m3800d(JavaAudioDeviceModule.TAG, "Output sample rate overridden to: " + i);
            this.outputSampleRate = i;
            return this;
        }
        ...
        public Builder setUseHardwareNoiseSuppressor(boolean z) {
            if (z && !JavaAudioDeviceModule.isBuiltInNoiseSuppressorSupported()) {
                Logging.m3801e(JavaAudioDeviceModule.TAG, "HW NS not supported");
                z = false;
            }
        ...
        public Builder setUseHardwareAcousticEchoCanceler(boolean z) {
            if (z && !JavaAudioDeviceModule.isBuiltInAcousticEchoCancelerSupported()) {
                Logging.m3801e(JavaAudioDeviceModule.TAG, "HW AEC not supported");
                z = false;
            }
        ...
        public AudioDeviceModule createAudioDeviceModule() {
            Logging.m3800d(JavaAudioDeviceModule.TAG, "createAudioDeviceModule");
            if (this.useHardwareNoiseSuppressor) {
                Logging.m3800d(JavaAudioDeviceModule.TAG, "HW NS will be used.");
            } else {
                if (JavaAudioDeviceModule.isBuiltInNoiseSuppressorSupported()) {
                    Logging.m3800d(JavaAudioDeviceModule.TAG, "Overriding default behavior; now using WebRTC NS!");
                }
                Logging.m3800d(JavaAudioDeviceModule.TAG, "HW NS will not be used.");
            }
            if (this.useHardwareAcousticEchoCanceler) {
                Logging.m3800d(JavaAudioDeviceModule.TAG, "HW AEC will be used.");
            } else {
                if (JavaAudioDeviceModule.isBuiltInAcousticEchoCancelerSupported()) {
                    Logging.m3800d(JavaAudioDeviceModule.TAG, "Overriding default behavior; now using WebRTC AEC!");
                }
                Logging.m3800d(JavaAudioDeviceModule.TAG, "HW AEC will not be used.");
            }
    ...
    public void setSpeakerMute(boolean z) {
        Logging.m3800d(TAG, "setSpeakerMute: " + z);
        this.audioOutput.setSpeakerMute(z);
    }

    public void setMicrophoneMute(boolean z) {
        Logging.m3800d(TAG, "setMicrophoneMute: " + z);
