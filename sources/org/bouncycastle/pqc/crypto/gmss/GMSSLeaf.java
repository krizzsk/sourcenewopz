...
public class GMSSLeaf {
    ...
    public GMSSLeaf(Digest digest, byte[][] bArr, int[] iArr) {
        ...
        int digestSize = this.messDigestOTS.getDigestSize();
        this.mdsize = digestSize;
        int ceil = (int) Math.ceil(((double) (digestSize << 3)) / ((double) this.f6447w));
        this.keysize = ceil + ((int) Math.ceil(((double) getLog((ceil << this.f6447w) + 1)) / ((double) this.f6447w)));
        this.two_power_w = 1 << this.f6447w;
    ...
    private GMSSLeaf(GMSSLeaf gMSSLeaf) {
        ...
        this.f6445i = gMSSLeaf.f6445i;
        this.f6446j = gMSSLeaf.f6446j;
        this.two_power_w = gMSSLeaf.two_power_w;
        this.f6447w = gMSSLeaf.f6447w;
    ...
    private void updateLeafCalc() {
        ...
        for (int i = 0; i < this.steps + 10000; i++) {
            if (this.f6445i == this.keysize && this.f6446j == this.two_power_w - 1) {
            ...
            if (this.f6445i == 0 || this.f6446j == this.two_power_w - 1) {
                this.f6445i++;
                this.f6446j = 0;
                ...
                int i2 = this.f6446j + 1;
                this.f6446j = i2;
                if (i2 == this.two_power_w - 1) {
                    byte[] bArr5 = this.privateKeyOTS;
                    byte[] bArr6 = this.concHashs;
                    int i3 = this.mdsize;
                    System.arraycopy(bArr5, 0, bArr6, (this.f6445i - 1) * i3, i3);
                }
            }
        }
        throw new IllegalStateException("unable to updateLeaf in steps: " + this.steps + " " + this.f6445i + " " + this.f6446j);
    }
    ...
    public int[] getStatInt() {
        return new int[]{this.f6445i, this.f6446j, this.steps, this.f6447w};
    }
