...
import p242io.reactivex.BackpressureOverflowStrategy;
...
public final class FlowableOnBackpressureBufferStrategy<T> extends C21208a<T, T> {

    /* renamed from: a */
    final long f58376a;

    /* renamed from: b */
    final Action f58377b;

    /* renamed from: c */
    final BackpressureOverflowStrategy f58378c;
    ...
    public FlowableOnBackpressureBufferStrategy(Flowable<T> flowable, long j, Action action, BackpressureOverflowStrategy backpressureOverflowStrategy) {
        ...
        this.f58376a = j;
        this.f58377b = action;
        this.f58378c = backpressureOverflowStrategy;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new OnBackpressureBufferStrategySubscriber(subscriber, this.f58377b, this.f58378c, this.f58376a));
    }
            ...
            if (!this.done) {
                ...
                synchronized (deque2) {
                    ...
                    if (((long) deque2.size()) == this.bufferSize) {
                        int i = C212071.$SwitchMap$io$reactivex$BackpressureOverflowStrategy[this.strategy.ordinal()];
                        if (i == 1) {
                            deque2.pollLast();
                            deque2.offer(t);
                        } else if (i == 2) {
    ...
    static /* synthetic */ class C212071 {
        ...
        static {
            /*
                io.reactivex.BackpressureOverflowStrategy[] r0 = p242io.reactivex.BackpressureOverflowStrategy.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$io$reactivex$BackpressureOverflowStrategy = r0
                io.reactivex.BackpressureOverflowStrategy r1 = p242io.reactivex.BackpressureOverflowStrategy.DROP_LATEST     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$reactivex$BackpressureOverflowStrategy     // Catch:{ NoSuchFieldError -> 0x001d }
                io.reactivex.BackpressureOverflowStrategy r1 = p242io.reactivex.BackpressureOverflowStrategy.DROP_OLDEST     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.flowable.FlowableOnBackpressureBufferStrategy.C212071.<clinit>():void");
        }
    }
}
