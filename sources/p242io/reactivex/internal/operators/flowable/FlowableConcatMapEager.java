...
import p242io.reactivex.internal.subscribers.InnerQueuedSubscriber;
import p242io.reactivex.internal.subscribers.InnerQueuedSubscriberSupport;
...
public final class FlowableConcatMapEager<T, R> extends C21208a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends Publisher<? extends R>> f58233a;
    ...
    public FlowableConcatMapEager(Flowable<T> flowable, Function<? super T, ? extends Publisher<? extends R>> function, int i, int i2, ErrorMode errorMode) {
        super(flowable);
        this.f58233a = function;
        this.f58234b = i;
        this.f58235c = i2;
        this.f58236d = errorMode;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.source.subscribe(new ConcatMapEagerDelayErrorSubscriber(subscriber, this.f58233a, this.f58234b, this.f58235c, this.f58236d));
    }
