...
public class SAPushManagerProvider implements ISfPushManagerService {
    ...
    /* renamed from: a */
    private Map<ISfPushManagerService.ISfPushListener, DPushListener> f15411a = new HashMap();
    ...
    public void registerCommonMsgPush(final ISfPushManagerService.ISfPushListener iSfPushListener) {
        ...
        this.f15411a.put(iSfPushListener, r1);
    ...
    public void unregisterCommonMsgPush(ISfPushManagerService.ISfPushListener iSfPushListener) {
        if (this.f15411a.containsKey(iSfPushListener)) {
            DPushManager.getInstance().unregisterPush(this.f15411a.remove(iSfPushListener));
        }
    }
}
