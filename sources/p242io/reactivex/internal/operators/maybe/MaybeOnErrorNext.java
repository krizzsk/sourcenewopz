...
public final class MaybeOnErrorNext<T> extends C21209a<T, T> {

    /* renamed from: a */
    final Function<? super Throwable, ? extends MaybeSource<? extends T>> f58612a;

    /* renamed from: b */
    final boolean f58613b;
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.source.subscribe(new OnErrorNextMaybeObserver(maybeObserver, this.f58612a, this.f58613b));
    }
