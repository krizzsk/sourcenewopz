...
public class HttpDetectErrCode {
    ...
    /* renamed from: a */
    private static final String f47767a = "connect";

    /* renamed from: b */
    private static final String f47768b = "read";

    /* renamed from: c */
    private static final String f47769c = "write";

    /* renamed from: d */
    private static final String f47770d = "ssl";
    ...
    public static int praseException(Throwable th) {
        ...
        if (th instanceof SocketTimeoutException) {
            ...
            if (lowerCase.contains(f47770d)) {
                return 1005;
            }
            if (lowerCase.contains(f47768b)) {
                return 1006;
            }
            if (lowerCase.contains(f47769c)) {
                return 1007;
            }
            return 1003;
