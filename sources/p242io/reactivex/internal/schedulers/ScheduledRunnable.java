...
public final class ScheduledRunnable extends AtomicReferenceArray<Object> implements Disposable, Runnable, Callable<Object> {
    ...
    public void dispose() {
        ...
        L_0x0044:
            ...
            if (r1 == 0) goto L_0x0035
            io.reactivex.internal.disposables.DisposableContainer r0 = (p242io.reactivex.internal.disposables.DisposableContainer) r0
            r0.delete(r5)
        L_0x004f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.schedulers.ScheduledRunnable.dispose():void");
    }
