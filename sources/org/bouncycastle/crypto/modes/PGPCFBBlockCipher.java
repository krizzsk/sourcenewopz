...
public class PGPCFBBlockCipher implements BlockCipher {
    ...
    /* renamed from: FR */
    private byte[] f6114FR;
    private byte[] FRE;

    /* renamed from: IV */
    private byte[] f6115IV;
    ...
    public PGPCFBBlockCipher(BlockCipher blockCipher, boolean z) {
        ...
        this.f6115IV = new byte[blockSize2];
        this.f6114FR = new byte[blockSize2];
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        ...
        if (i + i3 > bArr.length) {
            ...
            int i4 = 0;
            this.cipher.processBlock(this.f6114FR, 0, this.FRE, 0);
            ...
            if (i5 == 0) {
                ...
                while (true) {
                    ...
                    if (i8 < i9 - 2) {
                        ...
                        System.arraycopy(this.tmp, 2, this.f6114FR, 0, i9 - 2);
                        this.count += 2;
                ...
                if (i5 >= i4 + 2) {
                    ...
                    System.arraycopy(this.tmp, 0, this.f6114FR, this.blockSize - 2, 2);
                    this.cipher.processBlock(this.f6114FR, 0, this.FRE, 0);
                    int i10 = 0;
                    while (true) {
                        i3 = this.blockSize;
                    ...
                    System.arraycopy(this.tmp, 2, this.f6114FR, 0, i3 - 2);
                }
            ...
            if (i6 != 0) {
                if (i6 >= i5 + 2) {
                    if (i5 + i2 <= bArr2.length) {
                        ...
                        System.arraycopy(bArr2, i2, this.f6114FR, 0, i3);
                    } else {
                        throw new OutputLengthException("output buffer too short");
                    }
                }
                ...
                while (true) {
                    ...
                    bArr2[i2 + i8] = encryptByte(this.f6115IV[i8], i8);
                    i8++;
                }
                System.arraycopy(bArr2, i2, this.f6114FR, 0, i4);
                this.cipher.processBlock(this.f6114FR, 0, this.FRE, 0);
                int i9 = this.blockSize;
                bArr2[i2 + i9] = encryptByte(this.f6115IV[i9 - 2], 0);
                int i10 = this.blockSize;
                bArr2[i2 + i10 + 1] = encryptByte(this.f6115IV[i10 - 1], 1);
                System.arraycopy(bArr2, i2 + 2, this.f6114FR, 0, this.blockSize);
                this.cipher.processBlock(this.f6114FR, 0, this.FRE, 0);
                int i11 = 0;
                while (true) {
                    ...
                    if (i11 < i12) {
                        ...
                        System.arraycopy(bArr2, i2 + i12 + 2, this.f6114FR, 0, i12);
                        int i13 = this.count;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            byte[] bArr = this.f6115IV;
            if (length < bArr.length) {
                System.arraycopy(iv, 0, bArr, bArr.length - iv.length, iv.length);
                int i = 0;
                while (true) {
                    byte[] bArr2 = this.f6115IV;
    ...
    public void reset() {
        ...
        int i = 0;
        while (true) {
            byte[] bArr = this.f6114FR;
            if (i != bArr.length) {
                if (this.inlineIv) {
                    bArr[i] = 0;
                } else {
                    bArr[i] = this.f6115IV[i];
                }
                i++;
            } else {
                this.cipher.reset();
