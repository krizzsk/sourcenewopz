...
public final class CompletableConcat extends Completable {
    ...
    /* renamed from: a */
    final Publisher<? extends CompletableSource> f58092a;

    /* renamed from: b */
    final int f58093b;

    public CompletableConcat(Publisher<? extends CompletableSource> publisher, int i) {
        this.f58092a = publisher;
        this.f58093b = i;
    }

    public void subscribeActual(CompletableObserver completableObserver) {
        this.f58092a.subscribe(new CompletableConcatSubscriber(completableObserver, this.f58093b));
    }
