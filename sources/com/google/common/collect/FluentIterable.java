...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo149917or(this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m38363of() {
        return from(ImmutableList.m38373of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m38364of(@NullableDecl E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m38344of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m38344of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m38344of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m38344of(next);
    }
