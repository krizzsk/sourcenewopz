...
public class KitHelper {
    ...
    /* renamed from: a */
    private static DocumentBuilderFactory f51518a = DocumentBuilderFactory.newInstance();
    ...
    public static Element parseXML(byte[] bArr) {
        try {
            return f51518a.newDocumentBuilder().parse(new ByteArrayInputStream(bArr), "UTF-8").getDocumentElement();
