...
final class C21787d<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMappedMarker {
    ...
    /* renamed from: c */
    private Iterator<? extends T> f61256c;

    /* renamed from: d */
    private Continuation<? super Unit> f61257d;
    ...
    /* renamed from: a */
    public final Continuation<Unit> mo180337a() {
        return this.f61257d;
    }

    /* renamed from: a */
    public final void mo180338a(Continuation<? super Unit> continuation) {
        this.f61257d = continuation;
    }
    ...
    public boolean hasNext() {
        while (true) {
            ...
            if (i != 0) {
                if (i == 1) {
                    Iterator<? extends T> it = this.f61256c;
            ...
            this.f61254a = 5;
            Continuation<? super Unit> continuation = this.f61257d;
    ...
    /* renamed from: c */
    private final Throwable m45139c() {
        int i = this.f61254a;
        if (i == 4) {
        ...
        return new IllegalStateException("Unexpected state of the iterator: " + this.f61254a);
    }
