...
public final class CapturedTypeConstructorKt {
    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(TypeSubstitution typeSubstitution, boolean z) {
        ...
        for (Pair pair : zip) {
            arrayList.add(m44944a((TypeProjection) pair.getFirst(), (TypeParameterDescriptor) pair.getSecond()));
        }
    ...
    /* renamed from: a */
    public static final TypeProjection m44944a(TypeProjection typeProjection, TypeParameterDescriptor typeParameterDescriptor) {
