...
public final class ObservableFlatMapCompletable<T> extends C21211a<T, T> {

    /* renamed from: a */
    final Function<? super T, ? extends CompletableSource> f58817a;
    ...
    public ObservableFlatMapCompletable(ObservableSource<T> observableSource, Function<? super T, ? extends CompletableSource> function, boolean z) {
        ...
        this.f58817a = function;
        this.f58818b = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new FlatMapCompletableMainObserver(observer, this.f58817a, this.f58818b));
    }
