...
public class Imgproc {
    ...
    public static Mat getRotationMatrix2D(Point point, double d, double d2) {
        return new Mat(getRotationMatrix2D_0(point.f6684x, point.f6685y, d, d2));
    }

    public static Mat getStructuringElement(int i, Size size, Point point) {
        return new Mat(getStructuringElement_0(i, size.width, size.height, point.f6684x, point.f6685y));
    }
    ...
    public static boolean clipLine(Rect rect, Point point, Point point2) {
        ...
        double[] dArr3 = dArr;
        boolean clipLine_0 = clipLine_0(rect2.f6689x, rect2.f6690y, rect2.width, rect2.height, point3.f6684x, point3.f6685y, dArr, point4.f6684x, point4.f6685y, dArr2);
        Point point5 = point;
        if (point5 != null) {
            point5.f6684x = dArr3[0];
            point5.f6685y = dArr3[1];
        }
        if (point4 != null) {
            point4.f6684x = dArr2[0];
            point4.f6685y = dArr2[1];
        }
        return clipLine_0;
    }
    ...
    public static double pointPolygonTest(MatOfPoint2f matOfPoint2f, Point point, boolean z) {
        return pointPolygonTest_0(matOfPoint2f.nativeObj, point.f6684x, point.f6685y, z);
    }
    ...
    public static int floodFill(Mat mat, Mat mat2, Point point, Scalar scalar, Rect rect, Scalar scalar2, Scalar scalar3, int i) {
        ...
        double[] dArr3 = dArr;
        double[] dArr4 = dArr3;
        int floodFill_0 = floodFill_0(mat.nativeObj, mat2.nativeObj, point2.f6684x, point2.f6685y, scalar4.val[0], scalar4.val[1], scalar4.val[2], scalar4.val[3], dArr2, scalar5.val[0], scalar5.val[1], scalar5.val[2], scalar5.val[3], scalar6.val[0], scalar6.val[1], scalar6.val[2], scalar6.val[3], i);
        if (rect2 != null) {
            rect2.f6689x = (int) dArr4[0];
            rect2.f6690y = (int) dArr4[1];
    ...
    public static int floodFill(Mat mat, Mat mat2, Point point, Scalar scalar) {
        ...
        return floodFill_1(mat.nativeObj, mat2.nativeObj, point2.f6684x, point2.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }
    ...
    public static int rotatedRectangleIntersection(RotatedRect rotatedRect, RotatedRect rotatedRect2, Mat mat) {
        ...
        return rotatedRectangleIntersection_0(rotatedRect3.center.f6684x, rotatedRect3.center.f6685y, rotatedRect3.size.width, rotatedRect3.size.height, rotatedRect3.angle, rotatedRect4.center.f6684x, rotatedRect4.center.f6685y, rotatedRect4.size.width, rotatedRect4.size.height, rotatedRect4.angle, mat.nativeObj);
    }
    ...
    public static void arrowedLine(Mat mat, Point point, Point point2, Scalar scalar, int i, int i2, int i3, double d) {
        ...
        Point point4 = point2;
        Scalar scalar2 = scalar;
        arrowedLine_0(mat.nativeObj, point3.f6684x, point3.f6685y, point4.f6684x, point4.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i, i2, i3, d);
    }
    ...
    public static void arrowedLine(Mat mat, Point point, Point point2, Scalar scalar) {
        ...
        Point point4 = point2;
        Scalar scalar2 = scalar;
        arrowedLine_1(mat.nativeObj, point3.f6684x, point3.f6685y, point4.f6684x, point4.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }
    ...
    public static void blur(Mat mat, Mat mat2, Size size, Point point, int i) {
        Size size2 = size;
        Point point2 = point;
        blur_0(mat.nativeObj, mat2.nativeObj, size2.width, size2.height, point2.f6684x, point2.f6685y, i);
    }

    public static void blur(Mat mat, Mat mat2, Size size, Point point) {
        blur_1(mat.nativeObj, mat2.nativeObj, size.width, size.height, point.f6684x, point.f6685y);
    }
    ...
    public static void boxFilter(Mat mat, Mat mat2, int i, Size size, Point point, boolean z, int i2) {
        Size size2 = size;
        Point point2 = point;
        boxFilter_0(mat.nativeObj, mat2.nativeObj, i, size2.width, size2.height, point2.f6684x, point2.f6685y, z, i2);
    }

    public static void boxFilter(Mat mat, Mat mat2, int i, Size size, Point point, boolean z) {
        Size size2 = size;
        Point point2 = point;
        boxFilter_1(mat.nativeObj, mat2.nativeObj, i, size2.width, size2.height, point2.f6684x, point2.f6685y, z);
    }
    ...
    public static void boxPoints(RotatedRect rotatedRect, Mat mat) {
        boxPoints_0(rotatedRect.center.f6684x, rotatedRect.center.f6685y, rotatedRect.size.width, rotatedRect.size.height, rotatedRect.angle, mat.nativeObj);
    }
    ...
    public static void circle(Mat mat, Point point, int i, Scalar scalar, int i2, int i3, int i4) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        circle_0(mat.nativeObj, point2.f6684x, point2.f6685y, i, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i2, i3, i4);
    }

    public static void circle(Mat mat, Point point, int i, Scalar scalar, int i2) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        circle_1(mat.nativeObj, point2.f6684x, point2.f6685y, i, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i2);
    }

    public static void circle(Mat mat, Point point, int i, Scalar scalar) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        circle_2(mat.nativeObj, point2.f6684x, point2.f6685y, i, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }
    ...
    public static void dilate(Mat mat, Mat mat2, Mat mat3, Point point, int i, int i2, Scalar scalar) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        dilate_0(mat.nativeObj, mat2.nativeObj, mat3.nativeObj, point2.f6684x, point2.f6685y, i, i2, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }

    public static void dilate(Mat mat, Mat mat2, Mat mat3, Point point, int i) {
        dilate_1(mat.nativeObj, mat2.nativeObj, mat3.nativeObj, point.f6684x, point.f6685y, i);
    }
    ...
    public static void drawContours(Mat mat, List<MatOfPoint> list, int i, Scalar scalar, int i2, int i3, Mat mat2, int i4, Point point) {
        ...
        Scalar scalar2 = scalar;
        Point point2 = point;
        drawContours_0(mat.nativeObj, Converters.vector_vector_Point_to_Mat(list2, new ArrayList(list2 != null ? list.size() : 0)).nativeObj, i, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i2, i3, mat2.nativeObj, i4, point2.f6684x, point2.f6685y);
    }
    ...
    public static void drawMarker(Mat mat, Point point, Scalar scalar, int i, int i2, int i3, int i4) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        drawMarker_0(mat.nativeObj, point2.f6684x, point2.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i, i2, i3, i4);
    }

    public static void drawMarker(Mat mat, Point point, Scalar scalar) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        drawMarker_1(mat.nativeObj, point2.f6684x, point2.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }
    ...
    public static void ellipse(Mat mat, Point point, Size size, double d, double d2, double d3, Scalar scalar, int i, int i2, int i3) {
        ...
        Size size2 = size;
        Scalar scalar2 = scalar;
        ellipse_0(mat.nativeObj, point2.f6684x, point2.f6685y, size2.width, size2.height, d, d2, d3, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i, i2, i3);
    }
    ...
    public static void ellipse(Mat mat, Point point, Size size, double d, double d2, double d3, Scalar scalar, int i) {
        ...
        Size size2 = size;
        Scalar scalar2 = scalar;
        ellipse_1(mat.nativeObj, point2.f6684x, point2.f6685y, size2.width, size2.height, d, d2, d3, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i);
    }
    ...
    public static void ellipse(Mat mat, Point point, Size size, double d, double d2, double d3, Scalar scalar) {
        ...
        Size size2 = size;
        Scalar scalar2 = scalar;
        ellipse_2(mat.nativeObj, point2.f6684x, point2.f6685y, size2.width, size2.height, d, d2, d3, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }
    ...
    public static void ellipse(Mat mat, RotatedRect rotatedRect, Scalar scalar, int i, int i2) {
        ...
        Scalar scalar2 = scalar;
        ellipse_3(mat.nativeObj, rotatedRect2.center.f6684x, rotatedRect2.center.f6685y, rotatedRect2.size.width, rotatedRect2.size.height, rotatedRect2.angle, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i, i2);
    }

    public static void ellipse(Mat mat, RotatedRect rotatedRect, Scalar scalar, int i) {
        RotatedRect rotatedRect2 = rotatedRect;
        Scalar scalar2 = scalar;
        ellipse_4(mat.nativeObj, rotatedRect2.center.f6684x, rotatedRect2.center.f6685y, rotatedRect2.size.width, rotatedRect2.size.height, rotatedRect2.angle, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i);
    }

    public static void ellipse(Mat mat, RotatedRect rotatedRect, Scalar scalar) {
        RotatedRect rotatedRect2 = rotatedRect;
        Scalar scalar2 = scalar;
        ellipse_5(mat.nativeObj, rotatedRect2.center.f6684x, rotatedRect2.center.f6685y, rotatedRect2.size.width, rotatedRect2.size.height, rotatedRect2.angle, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }

    public static void ellipse2Poly(Point point, Size size, int i, int i2, int i3, int i4, MatOfPoint matOfPoint) {
        Point point2 = point;
        Size size2 = size;
        ellipse2Poly_0(point2.f6684x, point2.f6685y, size2.width, size2.height, i, i2, i3, i4, matOfPoint.nativeObj);
    }
    ...
    public static void erode(Mat mat, Mat mat2, Mat mat3, Point point, int i, int i2, Scalar scalar) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        erode_0(mat.nativeObj, mat2.nativeObj, mat3.nativeObj, point2.f6684x, point2.f6685y, i, i2, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }

    public static void erode(Mat mat, Mat mat2, Mat mat3, Point point, int i) {
        erode_1(mat.nativeObj, mat2.nativeObj, mat3.nativeObj, point.f6684x, point.f6685y, i);
    }
    ...
    public static void fillPoly(Mat mat, List<MatOfPoint> list, Scalar scalar, int i, int i2, Point point) {
        ...
        Scalar scalar2 = scalar;
        Point point2 = point;
        fillPoly_0(mat.nativeObj, Converters.vector_vector_Point_to_Mat(list2, new ArrayList(list2 != null ? list.size() : 0)).nativeObj, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i, i2, point2.f6684x, point2.f6685y);
    }
    ...
    public static void filter2D(Mat mat, Mat mat2, int i, Mat mat3, Point point, double d, int i2) {
        Point point2 = point;
        filter2D_0(mat.nativeObj, mat2.nativeObj, i, mat3.nativeObj, point2.f6684x, point2.f6685y, d, i2);
    }

    public static void filter2D(Mat mat, Mat mat2, int i, Mat mat3, Point point, double d) {
        Point point2 = point;
        filter2D_1(mat.nativeObj, mat2.nativeObj, i, mat3.nativeObj, point2.f6684x, point2.f6685y, d);
    }
    ...
    public static void findContours(Mat mat, List<MatOfPoint> list, Mat mat2, int i, int i2, Point point) {
        Point point2 = point;
        Mat mat3 = new Mat();
        findContours_0(mat.nativeObj, mat3.nativeObj, mat2.nativeObj, i, i2, point2.f6684x, point2.f6685y);
        List<MatOfPoint> list2 = list;
    ...
    public static void getRectSubPix(Mat mat, Size size, Point point, Mat mat2, int i) {
        Size size2 = size;
        Point point2 = point;
        getRectSubPix_0(mat.nativeObj, size2.width, size2.height, point2.f6684x, point2.f6685y, mat2.nativeObj, i);
    }

    public static void getRectSubPix(Mat mat, Size size, Point point, Mat mat2) {
        getRectSubPix_1(mat.nativeObj, size.width, size.height, point.f6684x, point.f6685y, mat2.nativeObj);
    }
    ...
    public static void grabCut(Mat mat, Mat mat2, Rect rect, Mat mat3, Mat mat4, int i, int i2) {
        Rect rect2 = rect;
        grabCut_0(mat.nativeObj, mat2.nativeObj, rect2.f6689x, rect2.f6690y, rect2.width, rect2.height, mat3.nativeObj, mat4.nativeObj, i, i2);
    }

    public static void grabCut(Mat mat, Mat mat2, Rect rect, Mat mat3, Mat mat4, int i) {
        Rect rect2 = rect;
        grabCut_1(mat.nativeObj, mat2.nativeObj, rect2.f6689x, rect2.f6690y, rect2.width, rect2.height, mat3.nativeObj, mat4.nativeObj, i);
    }
    ...
    public static void line(Mat mat, Point point, Point point2, Scalar scalar, int i, int i2, int i3) {
        ...
        Point point4 = point2;
        Scalar scalar2 = scalar;
        line_0(mat.nativeObj, point3.f6684x, point3.f6685y, point4.f6684x, point4.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i, i2, i3);
    }
    ...
    public static void line(Mat mat, Point point, Point point2, Scalar scalar, int i) {
        ...
        Point point4 = point2;
        Scalar scalar2 = scalar;
        line_1(mat.nativeObj, point3.f6684x, point3.f6685y, point4.f6684x, point4.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i);
    }
    ...
    public static void line(Mat mat, Point point, Point point2, Scalar scalar) {
        ...
        Point point4 = point2;
        Scalar scalar2 = scalar;
        line_2(mat.nativeObj, point3.f6684x, point3.f6685y, point4.f6684x, point4.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }

    public static void linearPolar(Mat mat, Mat mat2, Point point, double d, int i) {
        Point point2 = point;
        linearPolar_0(mat.nativeObj, mat2.nativeObj, point2.f6684x, point2.f6685y, d, i);
    }

    public static void logPolar(Mat mat, Mat mat2, Point point, double d, int i) {
        Point point2 = point;
        logPolar_0(mat.nativeObj, mat2.nativeObj, point2.f6684x, point2.f6685y, d, i);
    }
    ...
    public static void morphologyEx(Mat mat, Mat mat2, int i, Mat mat3, Point point, int i2, int i3, Scalar scalar) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        morphologyEx_0(mat.nativeObj, mat2.nativeObj, i, mat3.nativeObj, point2.f6684x, point2.f6685y, i2, i3, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }

    public static void morphologyEx(Mat mat, Mat mat2, int i, Mat mat3, Point point, int i2) {
        Point point2 = point;
        morphologyEx_1(mat.nativeObj, mat2.nativeObj, i, mat3.nativeObj, point2.f6684x, point2.f6685y, i2);
    }
    ...
    public static void putText(Mat mat, String str, Point point, int i, double d, Scalar scalar, int i2, int i3, boolean z) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        putText_0(mat.nativeObj, str, point2.f6684x, point2.f6685y, i, d, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i2, i3, z);
    }

    public static void putText(Mat mat, String str, Point point, int i, double d, Scalar scalar, int i2) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        putText_1(mat.nativeObj, str, point2.f6684x, point2.f6685y, i, d, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i2);
    }

    public static void putText(Mat mat, String str, Point point, int i, double d, Scalar scalar) {
        Point point2 = point;
        Scalar scalar2 = scalar;
        putText_2(mat.nativeObj, str, point2.f6684x, point2.f6685y, i, d, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }
    ...
    public static void rectangle(Mat mat, Point point, Point point2, Scalar scalar, int i, int i2, int i3) {
        ...
        Point point4 = point2;
        Scalar scalar2 = scalar;
        rectangle_0(mat.nativeObj, point3.f6684x, point3.f6685y, point4.f6684x, point4.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i, i2, i3);
    }
    ...
    public static void rectangle(Mat mat, Point point, Point point2, Scalar scalar, int i) {
        ...
        Point point4 = point2;
        Scalar scalar2 = scalar;
        rectangle_1(mat.nativeObj, point3.f6684x, point3.f6685y, point4.f6684x, point4.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], i);
    }
    ...
    public static void rectangle(Mat mat, Point point, Point point2, Scalar scalar) {
        ...
        Point point4 = point2;
        Scalar scalar2 = scalar;
        rectangle_2(mat.nativeObj, point3.f6684x, point3.f6685y, point4.f6684x, point4.f6685y, scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3]);
    }
    ...
    public static void sepFilter2D(Mat mat, Mat mat2, int i, Mat mat3, Mat mat4, Point point, double d, int i2) {
        Point point2 = point;
        sepFilter2D_0(mat.nativeObj, mat2.nativeObj, i, mat3.nativeObj, mat4.nativeObj, point2.f6684x, point2.f6685y, d, i2);
    }

    public static void sepFilter2D(Mat mat, Mat mat2, int i, Mat mat3, Mat mat4, Point point, double d) {
        Point point2 = point;
        sepFilter2D_1(mat.nativeObj, mat2.nativeObj, i, mat3.nativeObj, mat4.nativeObj, point2.f6684x, point2.f6685y, d);
    }
    ...
    public static void sqrBoxFilter(Mat mat, Mat mat2, int i, Size size, Point point, boolean z, int i2) {
        Size size2 = size;
        Point point2 = point;
        sqrBoxFilter_0(mat.nativeObj, mat2.nativeObj, i, size2.width, size2.height, point2.f6684x, point2.f6685y, z, i2);
    }

    public static void sqrBoxFilter(Mat mat, Mat mat2, int i, Size size, Point point, boolean z) {
        Size size2 = size;
        Point point2 = point;
        sqrBoxFilter_1(mat.nativeObj, mat2.nativeObj, i, size2.width, size2.height, point2.f6684x, point2.f6685y, z);
    }
