...
public abstract class ECPoint {
    ...
    /* renamed from: x */
    protected ECFieldElement f6307x;

    /* renamed from: y */
    protected ECFieldElement f6308y;

    /* renamed from: zs */
    protected ECFieldElement[] f6309zs;
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        public boolean satisfiesCurveEquation() {
            ...
            ECFieldElement eCFieldElement3 = this.f6307x;
            ECFieldElement a = curve.getA();
            ECFieldElement b = curve.getB();
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 6) {
                ECFieldElement eCFieldElement4 = this.f6309zs[0];
                boolean isOne = eCFieldElement4.isOne();
                if (eCFieldElement3.isZero()) {
                    ECFieldElement square = this.f6308y.square();
                    if (!isOne) {
                        b = b.multiply(eCFieldElement4.square());
                    }
                    return square.equals(b);
                }
                ECFieldElement eCFieldElement5 = this.f6308y;
        ...
        public AbstractF2m tau() {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement = this.f6307x;
            if (coordinateSystem != 0) {
                if (coordinateSystem != 1) {
                ...
                ECFieldElement eCFieldElement2 = this.f6308y;
                ECFieldElement eCFieldElement3 = this.f6309zs[0];
            ...
            createRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f6308y.square());
            return (AbstractF2m) createRawPoint;
        }
        ...
        public AbstractF2m tauPow(int i) {
            ...
            createRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f6308y.squarePow(i));
            return (AbstractF2m) createRawPoint;
        }
    }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement7 = this.f6307x;
            ECFieldElement eCFieldElement8 = eCPoint2.f6307x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement9 = this.f6308y;
                ECFieldElement eCFieldElement10 = eCPoint2.f6308y;
                ...
                ECFieldElement eCFieldElement11 = this.f6308y;
                ECFieldElement eCFieldElement12 = this.f6309zs[0];
                ECFieldElement eCFieldElement13 = eCPoint2.f6308y;
                ECFieldElement eCFieldElement14 = eCPoint2.f6309zs[0];
                ...
                ECFieldElement eCFieldElement15 = this.f6308y;
                ECFieldElement eCFieldElement16 = this.f6309zs[0];
                ECFieldElement eCFieldElement17 = eCPoint2.f6308y;
                ECFieldElement eCFieldElement18 = eCPoint2.f6309zs[0];
        ...
        public ECPoint negate() {
            ...
            int curveCoordinateSystem = getCurveCoordinateSystem();
            if (curveCoordinateSystem == 0) {
                return new F2m(this.curve, eCFieldElement, this.f6308y.add(eCFieldElement));
                ...
                return new F2m(this.curve, eCFieldElement, this.f6308y.addOne());
            } else if (curveCoordinateSystem == 6) {
                ECFieldElement eCFieldElement4 = this.f6308y;
                ECFieldElement eCFieldElement5 = this.f6309zs[0];
        ...
        public ECPoint twice() {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElement2 = this.f6307x;
            if (eCFieldElement2.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement add = this.f6308y.divide(eCFieldElement2).add(eCFieldElement2);
                ...
                ECFieldElement eCFieldElement3 = this.f6308y;
                ECFieldElement eCFieldElement4 = this.f6309zs[0];
                boolean isOne = eCFieldElement4.isOne();
                ...
                ECFieldElement eCFieldElement5 = this.f6308y;
                ECFieldElement eCFieldElement6 = this.f6309zs[0];
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f6307x;
            ECFieldElement eCFieldElement3 = eCPoint.f6309zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f6308y;
            ECFieldElement eCFieldElement5 = this.f6309zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f6308y;
    ...
    public static class C2749Fp extends AbstractFp {
        C2749Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            super(eCCurve, eCFieldElement, eCFieldElement2);
        }

        C2749Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            super(eCCurve, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }
        ...
        public org.bouncycastle.math.p082ec.ECPoint add(org.bouncycastle.math.p082ec.ECPoint r17) {
            /*
                r16 = this;
                r0 = r16
                r1 = r17
            ...
            L_0x0019:
                ...
                org.bouncycastle.math.ec.ECFieldElement r4 = r0.f6307x
                org.bouncycastle.math.ec.ECFieldElement r5 = r0.f6308y
                org.bouncycastle.math.ec.ECFieldElement r6 = r1.f6307x
                org.bouncycastle.math.ec.ECFieldElement r7 = r1.f6308y
            ...
            L_0x0036:
                ...
                throw r1
            L_0x003f:
                org.bouncycastle.math.ec.ECFieldElement[] r12 = r0.f6309zs
                r12 = r12[r9]
                org.bouncycastle.math.ec.ECFieldElement[] r1 = r1.f6309zs
                r1 = r1[r9]
            ...
            L_0x0127:
                ...
                r5 = 2
                org.bouncycastle.math.ec.ECFieldElement[] r5 = new org.bouncycastle.math.p082ec.ECFieldElement[r5]
                r8 = 0
                r5[r8] = r1
                r7 = 1
                r5[r7] = r3
            ...
            L_0x0137:
                r7 = 1
                r8 = 0
                org.bouncycastle.math.ec.ECFieldElement[] r5 = new org.bouncycastle.math.p082ec.ECFieldElement[r7]
                r5[r8] = r1
            L_0x013d:
            ...
            L_0x0143:
                r8 = 0
                org.bouncycastle.math.ec.ECFieldElement[] r3 = r0.f6309zs
                r3 = r3[r8]
                org.bouncycastle.math.ec.ECFieldElement[] r1 = r1.f6309zs
                r1 = r1[r8]
                boolean r8 = r3.isOne()
            ...
            L_0x01f3:
                ...
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p082ec.ECPoint.C2749Fp.add(org.bouncycastle.math.ec.ECPoint):org.bouncycastle.math.ec.ECPoint");
        }
        ...
        /* access modifiers changed from: protected */
        public ECPoint detach() {
            return new C2749Fp((ECCurve) null, getAffineXCoord(), getAffineYCoord());
        }
        ...
        public ECFieldElement getJacobianModifiedW() {
            ECFieldElement eCFieldElement = this.f6309zs[1];
            if (eCFieldElement != null) {
                return eCFieldElement;
            }
            ECFieldElement[] eCFieldElementArr = this.f6309zs;
            ECFieldElement calculateJacobianModifiedW = calculateJacobianModifiedW(this.f6309zs[0], (ECFieldElement) null);
        ...
        public ECPoint negate() {
            ...
            ECCurve curve = getCurve();
            return curve.getCoordinateSystem() != 0 ? new C2749Fp(curve, this.f6307x, this.f6308y.negate(), this.f6309zs) : new C2749Fp(curve, this.f6307x, this.f6308y.negate());
        }
        ...
        public ECPoint threeTimes() {
            ...
            ECFieldElement eCFieldElement = this.f6308y;
            if (eCFieldElement.isZero()) {
                return this;
            }
            ECCurve curve = getCurve();
            ...
            return new C2749Fp(curve, add2, eCFieldElement2.subtract(add2).multiply(subtract2).subtract(eCFieldElement));
        }
        ...
        public ECPoint timesPow2(int i) {
            ...
            if (i2 < 0) {
                ...
                ECFieldElement a = curve.getA();
                ECFieldElement eCFieldElement3 = this.f6307x;
                ECFieldElement fromBigInteger = this.f6309zs.length < 1 ? curve.fromBigInteger(ECConstants.ONE) : this.f6309zs[0];
                ...
                if (coordinateSystem == 0) {
                    ...
                    return new C2749Fp(curve, eCFieldElement3.multiply(square), eCFieldElement2.multiply(square.multiply(invert)));
                } else if (coordinateSystem == 1) {
                    return new C2749Fp(curve, eCFieldElement3.multiply(fromBigInteger), eCFieldElement2, new ECFieldElement[]{fromBigInteger.multiply(fromBigInteger.square())});
                } else if (coordinateSystem == 2) {
                    return new C2749Fp(curve, eCFieldElement3, eCFieldElement2, new ECFieldElement[]{fromBigInteger});
                } else if (coordinateSystem == 4) {
                    return new C2749Fp(curve, eCFieldElement3, eCFieldElement2, new ECFieldElement[]{fromBigInteger, a});
                } else {
                    throw new IllegalStateException("unsupported coordinate system");
                }
            }
        ...
        public ECPoint twice() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement4 = this.f6307x;
            if (coordinateSystem == 0) {
                ...
                return new C2749Fp(curve, subtract, divide.multiply(eCFieldElement4.subtract(subtract)).subtract(eCFieldElement3));
            } else if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement5 = this.f6309zs[0];
                ...
                return new C2749Fp(curve, multiply2, four.subtract(subtract2).multiply(add).subtract(two(two2.square())), new ECFieldElement[]{two(isOne ? two(two2) : two.square()).multiply(multiply)});
            } else if (coordinateSystem == 2) {
                ECFieldElement eCFieldElement6 = this.f6309zs[0];
                boolean isOne2 = eCFieldElement6.isOne();
                ECFieldElement square2 = eCFieldElement3.square();
                ...
                return new C2749Fp(curve, subtract3, subtract4, new ECFieldElement[]{two3});
            } else if (coordinateSystem == 4) {
        ...
        /* access modifiers changed from: protected */
        public C2749Fp twiceJacobianModified(boolean z) {
            ECFieldElement eCFieldElement = this.f6307x;
            ECFieldElement eCFieldElement2 = this.f6308y;
            ECFieldElement eCFieldElement3 = this.f6309zs[0];
            ...
            return new C2749Fp(getCurve(), subtract, subtract2, new ECFieldElement[]{two, two4});
        }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f6307x;
            ECFieldElement eCFieldElement3 = eCPoint.f6307x;
            ECFieldElement eCFieldElement4 = eCPoint.f6308y;
            ...
            return new C2749Fp(curve, add, eCFieldElement2.subtract(add).multiply(subtract4).subtract(eCFieldElement));
        }
    ...
    protected ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f6307x = eCFieldElement;
        this.f6308y = eCFieldElement2;
        this.f6309zs = eCFieldElementArr;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean equals(org.bouncycastle.math.p082ec.ECPoint r9) {
        /*
            r8 = this;
            r0 = 0
        ...
        L_0x0031:
            ...
            goto L_0x0051
        L_0x0038:
            boolean r2 = r1.equals((org.bouncycastle.math.p082ec.ECCurve) r2)
            if (r2 != 0) goto L_0x003f
            return r0
        L_0x003f:
            r2 = 2
            org.bouncycastle.math.ec.ECPoint[] r2 = new org.bouncycastle.math.p082ec.ECPoint[r2]
            r2[r0] = r8
        ...
        L_0x006f:
            ...
            boolean r9 = r1.equals((org.bouncycastle.math.p082ec.ECCurve) r2)
        ...
        L_0x007e:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p082ec.ECPoint.equals(org.bouncycastle.math.ec.ECPoint):boolean");
    }
    ...
    public boolean isInfinity() {
        if (!(this.f6307x == null || this.f6308y == null)) {
            ECFieldElement[] eCFieldElementArr = this.f6309zs;
    ...
    public boolean isNormalized() {
        int curveCoordinateSystem = getCurveCoordinateSystem();
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f6309zs[0].isOne();
    }
    ...
    public boolean satisfiesOrder() {
        /*
            r2 = this;
            java.math.BigInteger r0 = org.bouncycastle.math.p082ec.ECConstants.ONE
        ...
        L_0x0010:
            ...
            org.bouncycastle.math.ec.ECPoint r0 = org.bouncycastle.math.p082ec.ECAlgorithms.referenceMultiply(r2, r0)
        ...
        L_0x0024:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p082ec.ECPoint.satisfiesOrder():boolean");
    }
    ...
    public String toString() {
        ...
        for (ECFieldElement append : this.f6309zs) {
            stringBuffer.append(',');
