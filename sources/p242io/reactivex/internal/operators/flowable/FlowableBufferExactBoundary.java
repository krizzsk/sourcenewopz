...
public final class FlowableBufferExactBoundary<T, U extends Collection<? super T>, B> extends C21208a<T, U> {

    /* renamed from: a */
    final Publisher<B> f58194a;

    /* renamed from: b */
    final Callable<U> f58195b;

    public FlowableBufferExactBoundary(Flowable<T> flowable, Publisher<B> publisher, Callable<U> callable) {
        super(flowable);
        this.f58194a = publisher;
        this.f58195b = callable;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super U> subscriber) {
        this.source.subscribe(new BufferExactBoundarySubscriber(new SerializedSubscriber(subscriber), this.f58195b, this.f58194a));
    }
    ...
    static final class BufferExactBoundarySubscriber<T, U extends Collection<? super T>, B> extends QueueDrainSubscriber<T, U, U> implements FlowableSubscriber<T>, Disposable, Subscription {
        ...
        public void onComplete() {
            ...
            L_0x0022:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.flowable.FlowableBufferExactBoundary.BufferExactBoundarySubscriber.onComplete():void");
        }
