...
import org.bouncycastle.math.p082ec.endo.ECEndomorphism;
import org.bouncycastle.math.p082ec.endo.GLVEndomorphism;
...
public abstract class ECCurve {
    ...
    /* renamed from: a */
    protected ECFieldElement f6292a;

    /* renamed from: b */
    protected ECFieldElement f6293b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        /* renamed from: si */
        private BigInteger[] f6294si = null;
        ...
        public synchronized BigInteger[] getSi() {
            if (this.f6294si == null) {
                this.f6294si = Tnaf.getSi(this);
            }
            return this.f6294si;
        }

        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f6293b.isOne() && (this.f6292a.isZero() || this.f6292a.isOne());
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        public ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement fromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement sqrt = fromBigInteger.square().add(this.f6292a).multiply(fromBigInteger).add(this.f6293b).sqrt();
            if (sqrt != null) {
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f6292a = fromBigInteger(bigInteger);
            this.f6293b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        protected F2m(int i, int i2, int i3, int i4, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, (ECFieldElement) null, (ECFieldElement) null);
            this.f6292a = eCFieldElement;
            this.f6293b = eCFieldElement2;
            this.coord = 6;
        }
        ...
        public ECCurve cloneCurve() {
            return new F2m(this.f6298m, this.f6295k1, this.f6296k2, this.f6297k3, this.f6292a, this.f6293b, this.order, this.cofactor);
        }

        public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, int i2) {
            final int i3 = (this.f6298m + 63) >>> 6;
            final int[] iArr = isTrinomial() ? new int[]{this.f6295k1} : new int[]{this.f6295k1, this.f6296k2, this.f6297k3};
            final long[] jArr = new long[(i2 * i3 * 2)];
            int i4 = 0;
            for (int i5 = 0; i5 < i2; i5++) {
                ECPoint eCPoint = eCPointArr[i + i5];
                ((ECFieldElement.F2m) eCPoint.getRawXCoord()).f6303x.copyTo(jArr, i4);
                int i6 = i4 + i3;
                ((ECFieldElement.F2m) eCPoint.getRawYCoord()).f6303x.copyTo(jArr, i6);
                i4 = i6 + i3;
            }
            final int i7 = i2;
            return new AbstractECLookupTable() {
                private ECPoint createPoint(long[] jArr, long[] jArr2) {
                    return F2m.this.createRawPoint(new ECFieldElement.F2m(F2m.this.f6298m, iArr, new LongArray(jArr)), new ECFieldElement.F2m(F2m.this.f6298m, iArr, new LongArray(jArr2)));
                }
        ...
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.F2m(this.f6298m, this.f6295k1, this.f6296k2, this.f6297k3, bigInteger);
        }
        ...
        public boolean isTrinomial() {
            return this.f6296k2 == 0 && this.f6297k3 == 0;
        }
    ...
    public static class C2746Fp extends AbstractFp {
        private static final int FP_DEFAULT_COORDS = 4;
        ECPoint.C2749Fp infinity;
        ...
        public C2746Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            this(bigInteger, bigInteger2, bigInteger3, (BigInteger) null, (BigInteger) null);
        }

        public C2746Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            super(bigInteger);
            this.f6299q = bigInteger;
            this.f6300r = ECFieldElement.C2747Fp.calculateResidue(bigInteger);
            this.infinity = new ECPoint.C2749Fp(this, (ECFieldElement) null, (ECFieldElement) null);
            this.f6292a = fromBigInteger(bigInteger2);
            this.f6293b = fromBigInteger(bigInteger3);
            this.order = bigInteger4;
            this.cofactor = bigInteger5;
            this.coord = 4;
        }

        protected C2746Fp(BigInteger bigInteger, BigInteger bigInteger2, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger3, BigInteger bigInteger4) {
            super(bigInteger);
            this.f6299q = bigInteger;
            this.f6300r = bigInteger2;
            this.infinity = new ECPoint.C2749Fp(this, (ECFieldElement) null, (ECFieldElement) null);
            this.f6292a = eCFieldElement;
            this.f6293b = eCFieldElement2;
            this.order = bigInteger3;
        ...
        /* access modifiers changed from: protected */
        public ECCurve cloneCurve() {
            return new C2746Fp(this.f6299q, this.f6300r, this.f6292a, this.f6293b, this.order, this.cofactor);
        }

        /* access modifiers changed from: protected */
        public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            return new ECPoint.C2749Fp(this, eCFieldElement, eCFieldElement2);
        }

        /* access modifiers changed from: protected */
        public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            return new ECPoint.C2749Fp(this, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }

        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.C2747Fp(this.f6299q, this.f6300r, bigInteger);
        }

        public int getFieldSize() {
            return this.f6299q.bitLength();
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            ...
            return new ECPoint.C2749Fp(this, fromBigInteger(eCPoint.f6307x.toBigInteger()), fromBigInteger(eCPoint.f6308y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.f6309zs[0].toBigInteger())});
        }
