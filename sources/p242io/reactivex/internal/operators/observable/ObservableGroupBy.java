...
public final class ObservableGroupBy<T, K, V> extends C21211a<T, GroupedObservable<K, V>> {

    /* renamed from: a */
    final Function<? super T, ? extends K> f58839a;

    /* renamed from: b */
    final Function<? super T, ? extends V> f58840b;

    /* renamed from: c */
    final int f58841c;

    /* renamed from: d */
    final boolean f58842d;
    ...
    public ObservableGroupBy(ObservableSource<T> observableSource, Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, int i, boolean z) {
        ...
        this.f58840b = function2;
        this.f58841c = i;
        this.f58842d = z;
    }

    public void subscribeActual(Observer<? super GroupedObservable<K, V>> observer) {
        this.source.subscribe(new GroupByObserver(observer, this.f58839a, this.f58840b, this.f58841c, this.f58842d));
    }
