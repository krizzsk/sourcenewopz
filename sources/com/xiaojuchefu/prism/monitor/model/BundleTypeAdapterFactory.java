...
public class BundleTypeAdapterFactory implements TypeAdapterFactory {
    public <T> TypeAdapter<T> create(final Gson gson, TypeToken<T> typeToken) {
        ...
        return new TypeAdapter<Bundle>() {
            ...
            public Bundle read(JsonReader jsonReader) throws IOException {
                int i = C206792.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()];
                if (i == 1) {
                    jsonReader.nextNull();
                    return null;
                } else if (i == 2) {
    ...
    static /* synthetic */ class C206792 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.xiaojuchefu.prism.monitor.model.BundleTypeAdapterFactory.C206792.<clinit>():void");
        }
    }
}
