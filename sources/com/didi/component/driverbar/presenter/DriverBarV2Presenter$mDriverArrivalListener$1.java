...
@Metadata(mo175977d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u000b\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n \u0004*\u0004\u0018\u00010\u00030\u00032\u000e\u0010\u0005\u001a\n \u0004*\u0004\u0018\u00010\u00060\u0006H\n"}, mo175978d2 = {"<anonymous>", "", "s", "", "kotlin.jvm.PlatformType", "aBoolean", ""}, mo175979k = 3, mo175980mv = {1, 5, 1}, mo175982xi = 48)
...
final class DriverBarV2Presenter$mDriverArrivalListener$1<T> implements BaseEventPublisher.OnEventListener {
    ...
    public final void onEvent(String str, Boolean bool) {
        if (this.this$0.m8817b() && !this.this$0.f13002a) {
            ((IDriverBarView) this.this$0.mView).nearPickupShow(this.this$0.f13003b);
            this.this$0.f13002a = true;
        }
    }
}
