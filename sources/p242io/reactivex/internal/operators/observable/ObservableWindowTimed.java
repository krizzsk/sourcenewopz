...
public final class ObservableWindowTimed<T> extends C21211a<T, Observable<T>> {
    ...
    public void subscribeActual(Observer<? super Observable<T>> observer) {
        ...
        if (this.f59006a != this.f59007b) {
            this.source.subscribe(new WindowSkipObserver(serializedObserver, this.f59006a, this.f59007b, this.f59008c, this.f59009d.createWorker(), this.f59011f));
        } else if (this.f59010e == Long.MAX_VALUE) {
            this.source.subscribe(new WindowExactUnboundedObserver(serializedObserver, this.f59006a, this.f59008c, this.f59009d, this.f59011f));
        } else {
            this.source.subscribe(new WindowExactBoundedObserver(serializedObserver, this.f59006a, this.f59008c, this.f59009d, this.f59011f, this.f59010e, this.f59012g));
        }
    }
    ...
    static final class WindowSkipObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable, Runnable {
        ...
        public void drainLoop() {
            ...
            while (!this.terminated) {
                ...
                if (z && (z2 || z3)) {
                    ...
                    if (!subjectWork.open) {
                        list.remove(subjectWork.f59014w);
                        subjectWork.f59014w.onComplete();
        ...
        static final class SubjectWork<T> {
            ...
            /* renamed from: w */
            final UnicastSubject<T> f59014w;

            SubjectWork(UnicastSubject<T> unicastSubject, boolean z) {
                this.f59014w = unicastSubject;
                this.open = z;
            }
        }
        ...
        final class CompletionTask implements Runnable {
            ...
            /* renamed from: w */
            private final UnicastSubject<T> f59013w;

            CompletionTask(UnicastSubject<T> unicastSubject) {
                this.f59013w = unicastSubject;
            }

            public void run() {
                WindowSkipObserver.this.complete(this.f59013w);
            }
        }
    }
}
