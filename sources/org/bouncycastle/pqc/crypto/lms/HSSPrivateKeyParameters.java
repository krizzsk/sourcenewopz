...
public class HSSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    public static org.bouncycastle.pqc.crypto.lms.HSSPrivateKeyParameters getInstance(java.lang.Object r11) throws java.io.IOException {
        ...
        L_0x007e:
            ...
            byte[] r11 = org.bouncycastle.util.p084io.Streams.readAll(r11)
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f6457l == hSSPrivateKeyParameters.f6457l && this.isShard == hSSPrivateKeyParameters.isShard && this.indexLimit == hSSPrivateKeyParameters.indexLimit && this.index == hSSPrivateKeyParameters.index && this.keys.equals(hSSPrivateKeyParameters.keys)) {
    ...
    public HSSPrivateKeyParameters extractKeyShard(int i) {
        ...
        synchronized (this) {
            ...
            if (getUsagesRemaining() >= j) {
                ...
                long j3 = this.index;
                this.index += j;
                makeCopy = makeCopy(new HSSPrivateKeyParameters(this.f6457l, new ArrayList(getKeys()), new ArrayList(getSig()), j3, j2, true));
                resetKeyToIndex();
            } else {
    ...
    public synchronized byte[] getEncoded() throws IOException {
        Composer bool;
        bool = Composer.compose().u32str(0).u32str(this.f6457l).u64str(this.index).u64str(this.indexLimit).bool(this.isShard);
    ...
    public synchronized HSSPublicKeyParameters getPublicKey() {
        return new HSSPublicKeyParameters(this.f6457l, getRootKey().getPublicKey());
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.index;
        return (((((((((this.f6457l * 31) + (this.isShard ? 1 : 0)) * 31) + this.keys.hashCode()) * 31) + this.sig.hashCode()) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + ((int) (j2 ^ (j2 >>> 32)));
    }
