...
public class SecP128R1Field {
    ...
    /* renamed from: M */
    private static final long f6324M = 4294967295L;

    /* renamed from: P */
    static final int[] f6325P = {-1, -1, -1, -3};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat128.add(iArr, iArr2, iArr3) != 0 || ((iArr3[3] >>> 1) >= 2147483646 && Nat128.gte(iArr3, f6325P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(4, iArr, iArr2) != 0 || ((iArr2[3] >>> 1) >= 2147483646 && Nat128.gte(iArr2, f6325P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if ((fromBigInteger[3] >>> 1) >= 2147483646 && Nat128.gte(fromBigInteger, f6325P)) {
            Nat128.subFrom(f6325P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(4, iArr2, Nat128.add(iArr, f6325P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f6325P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(4, iArr, f6325P) == 0);
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if ((iArr[3] >>> 1) >= 2147483646 && Nat128.gte(iArr, f6325P)) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(4, iArr, 0, iArr2) != 0 || ((iArr2[3] >>> 1) >= 2147483646 && Nat128.gte(iArr2, f6325P))) {
            addPInvTo(iArr2);
        }
    }
}
