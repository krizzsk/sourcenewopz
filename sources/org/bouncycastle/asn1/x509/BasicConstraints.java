...
public class BasicConstraints extends ASN1Object {
    ...
    public BasicConstraints(int i) {
        this.f5690cA = ASN1Boolean.getInstance(false);
        this.pathLenConstraint = null;
        this.f5690cA = ASN1Boolean.getInstance(true);
    ...
    private BasicConstraints(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Boolean) {
            this.f5690cA = ASN1Boolean.getInstance((Object) aSN1Sequence.getObjectAt(0));
        } else {
            this.f5690cA = null;
    ...
    public boolean isCA() {
        ASN1Boolean aSN1Boolean = this.f5690cA;
