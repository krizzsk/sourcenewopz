...
public class StatusBroadcastManager {
    ...
    /* renamed from: a */
    private LocalBroadcastManager f45902a;

    /* renamed from: b */
    private Context f45903b;

    public void unRegisterStatusReceiver(BroadcastReceiver broadcastReceiver) {
        LocalBroadcastManager localBroadcastManager = this.f45902a;
    ...
    public void broadcastStatus(String str, int i) {
        if (this.f45902a != null) {
            ...
            this.f45902a.sendBroadcast(intent);
        }
    }
    ...
    public void init(Context context) {
        if (this.f45903b == null || this.f45902a == null) {
            this.f45903b = context;
            this.f45902a = LocalBroadcastManager.getInstance(context);
        }
    }
    ...
    public void registerStatusReceiver(BroadcastReceiver broadcastReceiver) {
        if (this.f45902a != null) {
            ...
            this.f45902a.registerReceiver(broadcastReceiver, intentFilter);
        }
    }
}
