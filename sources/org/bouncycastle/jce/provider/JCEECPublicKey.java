...
import org.bouncycastle.asn1.p075x9.X962Parameters;
...
public class JCEECPublicKey implements ECPublicKey, ECPointEncoder, org.bouncycastle.jce.interfaces.ECPublicKey {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f6262q = EC5Util.convertPoint(params, eCPublicKeySpec.getW());
    }

    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f6262q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f6262q = jCEECPublicKey.f6262q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.algorithm = str;
        this.f6262q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f6262q.getCurve() == null) {
                this.f6262q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f6262q.getAffineXCoord().toBigInteger(), this.f6262q.getAffineYCoord().toBigInteger());
            }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f6262q = EC5Util.convertPoint(params, eCPublicKey.getW());
    }
    ...
    private void populateFromPubKeyInfo(org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r15) {
        ...
        L_0x013c:
            ...
            r1.<init>()
            int r1 = r1.getByteLength((org.bouncycastle.math.p082ec.ECCurve) r6)
            int r4 = r15.length
            int r4 = r4 - r3
        ...
        L_0x0157:
            ...
            r15.<init>((org.bouncycastle.math.p082ec.ECCurve) r6, (org.bouncycastle.asn1.ASN1OctetString) r0)
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f6262q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f6262q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f6262q.getDetachedPoint() : this.f6262q;
    }

    public java.security.spec.ECPoint getW() {
        return EC5Util.convertPoint(this.f6262q);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f6262q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f6262q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(lineSeparator);
