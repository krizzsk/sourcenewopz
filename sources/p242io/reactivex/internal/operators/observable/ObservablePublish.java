...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
    ...
    /* renamed from: a */
    final ObservableSource<T> f58881a;

    /* renamed from: b */
    final AtomicReference<PublishObserver<T>> f58882b;

    /* renamed from: c */
    final ObservableSource<T> f58883c;
    ...
    private ObservablePublish(ObservableSource<T> observableSource, ObservableSource<T> observableSource2, AtomicReference<PublishObserver<T>> atomicReference) {
        this.f58883c = observableSource;
        this.f58881a = observableSource2;
        this.f58882b = atomicReference;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        this.f58883c.subscribe(observer);
    }
    ...
    public void connect(p242io.reactivex.functions.Consumer<? super p242io.reactivex.disposables.Disposable> r5) {
        /*
            r4 = this;
        L_0x0000:
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver<T>> r0 = r4.f58882b
            java.lang.Object r0 = r0.get()
            io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver r0 = (p242io.reactivex.internal.operators.observable.ObservablePublish.PublishObserver) r0
        ...
        L_0x0010:
            ...
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver<T>> r2 = r4.f58882b
            r1.<init>(r2)
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver<T>> r2 = r4.f58882b
        ...
        L_0x0035:
            ...
            io.reactivex.ObservableSource<T> r5 = r4.f58881a
            r5.subscribe(r0)
        L_0x003f:
            return
        L_0x0040:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservablePublish.connect(io.reactivex.functions.Consumer):void");
    }
