...
public abstract class AbstractDaoSessionTest<T extends AbstractDaoMaster, S extends AbstractDaoSession> extends DbTest {
    ...
    public void setUp() throws Exception {
        super.setUp();
        try {
            this.daoMaster = (AbstractDaoMaster) this.daoMasterClass.getConstructor(new Class[]{Database.class}).newInstance(new Object[]{this.f6576db});
            this.daoMasterClass.getMethod("createAllTables", new Class[]{Database.class, Boolean.TYPE}).invoke((Object) null, new Object[]{this.f6576db, false});
