...
public class TransactionStateUtil {
    ...
    /* renamed from: a */
    private static final AgentLog f47972a = AgentLogManager.getAgentLog();

    /* renamed from: b */
    private static final String f47973b = "Content-Length";

    /* renamed from: c */
    private static final String f47974c = "Content-Type";
    ...
    public static void inspectAndInstrumentResponse(TransactionState transactionState, HttpURLConnection httpURLConnection) {
        ...
        try {
            ...
            AgentLog agentLog2 = f47972a;
            agentLog2.debug("Failed to retrieve response code due to an I/O exception: " + e2.getMessage());
        } catch (NullPointerException e3) {
            f47972a.error("Failed to retrieve response code due to underlying (Harmony?) NPE", e3);
        }
    }
    ...
    public static HttpRequest inspectAndInstrument(TransactionState transactionState, HttpHost httpHost, HttpRequest httpRequest) {
        ...
        if (transactionState.getUrl() == null || transactionState.getHttpMethod() == null) {
            ...
            m34243a(transactionState, httpRequest);
            return httpRequest;
        }
    }
    ...
    public static HttpUriRequest inspectAndInstrument(TransactionState transactionState, HttpUriRequest httpUriRequest) {
        ...
        m34243a(transactionState, (HttpRequest) httpUriRequest);
    ...
    /* renamed from: a */
    private static void m34243a(TransactionState transactionState, HttpRequest httpRequest) {
        ...
        if (statusLine != null) {
            ...
            if (headers != null && headers.length > 0) {
                try {
                    ...
                    m34244a(transactionState, httpResponse);
                } catch (NumberFormatException e) {
                    f47972a.warning("Failed to parse content length: " + e.toString());
                }
                ...
                m34244a(transactionState, (HttpResponse) null);
            }
        }
        return httpResponse;
    }
    ...
    /* renamed from: a */
    private static void m34244a(TransactionState transactionState, HttpResponse httpResponse) {
                ...
                try {
                    if (httpResponse.getEntity() != null) {
                        ...
                        if (content instanceof CountingInputStream) {
                            ...
                            f47972a.error("Unable to wrap content stream for entity");
                        }
                    } else {
                        f47972a.debug("null response entity. response-body will be reported empty");
                    }
                } catch (IllegalStateException e) {
                    f47972a.error(e.toString());
                } catch (IOException e2) {
                    f47972a.error(e2.toString());
                }
