...
public class PartialDiskCacheProducer implements Producer<EncodedImage> {
    ...
    static Map<String, String> getExtraMap(ProducerListener producerListener, String str, boolean z, int i) {
        ...
        if (z) {
            return ImmutableMap.m37071of("cached_value_found", String.valueOf(z), "encodedImageSize", String.valueOf(i));
        }
        return ImmutableMap.m37070of("cached_value_found", String.valueOf(z));
    }
    ...
    private static class PartialDiskCacheConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
            ...
            if (!isNotLast(i)) {
                if (this.mPartialEncodedImageFromCache != null && encodedImage.getBytesRange() != null) {
                    try {
                        ...
                        FLog.m37099e(PartialDiskCacheProducer.PRODUCER_NAME, "Error while merging image data", (Throwable) e);
        ...
        private void sendFinalResultToConsumer(PooledByteBufferOutputStream pooledByteBufferOutputStream) {
            ...
            Throwable th;
            CloseableReference of = CloseableReference.m37162of(pooledByteBufferOutputStream.toByteBuffer());
            try {
