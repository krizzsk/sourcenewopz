            ...
            if (onceActionArr != null) {
                if (onceActionArr.length > 0) {
                    for (OnceAction onceAction : onceActionArr) {
                        ...
                        LogUtil.m29104i(com.didi.soda.blocks.action.ActionPool.TAG, "ActionName = " + onceAction.mActionName + ", hasDone = " + contains);
                        if (!contains) {
                            onceAction.run();
