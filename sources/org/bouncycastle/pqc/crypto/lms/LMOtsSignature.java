...
class LMOtsSignature implements Encodable {
    ...
    /* renamed from: C */
    private final byte[] f6468C;
    private final LMOtsParameters type;

    /* renamed from: y */
    private final byte[] f6469y;
    ...
    public boolean equals(Object obj) {
        ...
        if (!Arrays.equals(this.f6468C, lMOtsSignature.f6468C)) {
            return false;
        }
        return Arrays.equals(this.f6469y, lMOtsSignature.f6469y);
    }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.type.getType()).bytes(this.f6468C).bytes(this.f6469y).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return ((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.f6468C)) * 31) + Arrays.hashCode(this.f6469y);
    }
}
