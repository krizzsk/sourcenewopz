...
public final class OperatorChecks extends AbstractModifierChecks {
    ...
    /* renamed from: a */
    private static final List<Checks> f61186a;
    ...
    static {
        ...
        Check[] checkArr3 = {MemberKindCheck.MemberOrExtension.INSTANCE, C21778b.f61192a, new ValueParameterCountCheck.AtLeast(2), C21777a.f61190a};
        Name name4 = OperatorNameConventions.SET_VALUE;
        Check[] checkArr4 = {MemberKindCheck.MemberOrExtension.INSTANCE, C21778b.f61192a, new ValueParameterCountCheck.AtLeast(3), C21777a.f61190a};
        Name name5 = OperatorNameConventions.PROVIDE_DELEGATE;
        Check[] checkArr5 = {MemberKindCheck.MemberOrExtension.INSTANCE, C21778b.f61192a, new ValueParameterCountCheck.Equals(2), C21777a.f61190a};
        ...
        Check[] checkArr7 = {MemberKindCheck.MemberOrExtension.INSTANCE, ValueParameterCountCheck.SingleValueParameter.INSTANCE, C21778b.f61192a, ReturnsCheck.ReturnsBoolean.INSTANCE};
        ...
        Check[] checkArr11 = {MemberKindCheck.MemberOrExtension.INSTANCE, ValueParameterCountCheck.SingleValueParameter.INSTANCE, C21778b.f61192a};
        ...
        Check[] checkArr13 = {MemberKindCheck.MemberOrExtension.INSTANCE, ReturnsCheck.ReturnsInt.INSTANCE, ValueParameterCountCheck.SingleValueParameter.INSTANCE, C21778b.f61192a};
        Check[] checkArr14 = {MemberKindCheck.MemberOrExtension.INSTANCE, ValueParameterCountCheck.SingleValueParameter.INSTANCE, C21778b.f61192a};
