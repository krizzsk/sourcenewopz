...
public final class zzc {
    ...
    private static final List<String> zzc = Arrays.asList(new String[]{DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "app", "am"});
    private static final List<String> zzd = Arrays.asList(new String[]{RavenEvent.DefaultEvent.REQUEST, "_dbg"});
