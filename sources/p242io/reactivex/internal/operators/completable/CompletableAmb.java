...
public final class CompletableAmb extends Completable {
    ...
    /* renamed from: a */
    private final CompletableSource[] f58084a;

    /* renamed from: b */
    private final Iterable<? extends CompletableSource> f58085b;

    public CompletableAmb(CompletableSource[] completableSourceArr, Iterable<? extends CompletableSource> iterable) {
        this.f58084a = completableSourceArr;
        this.f58085b = iterable;
    }

    public void subscribeActual(CompletableObserver completableObserver) {
        int i;
        CompletableSource[] completableSourceArr = this.f58084a;
        if (completableSourceArr == null) {
            completableSourceArr = new CompletableSource[8];
            try {
                i = 0;
                for (CompletableSource completableSource : this.f58085b) {
