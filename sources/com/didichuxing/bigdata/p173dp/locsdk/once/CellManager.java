...
public class CellManager implements ICellManager {
    ...
    /* renamed from: m */
    private static final int f46050m = Integer.MAX_VALUE;

    /* renamed from: a */
    private Context f46051a;

    /* renamed from: b */
    private boolean f46052b;
    ...
    /* renamed from: d */
    private volatile List<Cgi> f46054d;

    /* renamed from: e */
    private volatile Cgi f46055e;

    /* renamed from: f */
    private int f46056f;

    /* renamed from: g */
    private TelephonyManager f46057g;

    /* renamed from: h */
    private Object f46058h;

    /* renamed from: i */
    private long f46059i;

    /* renamed from: j */
    private PhoneStateListener f46060j;
    /* access modifiers changed from: private */

    /* renamed from: k */
    public CellLocation f46061k;
    ...
    private CellManager() {
        this.f46052b = false;
        this.f46053c = 0;
        this.f46054d = new ArrayList();
        this.f46055e = null;
        this.f46056f = Const.iDefCgiSig;
        this.f46059i = 0;
        this.f46062l = "CellManager-->nlp";
    }
    ...
    public synchronized void init(Context context) {
        if (!this.f46052b) {
            ...
            this.f46057g = telephonyManager;
            try {
                this.f46053c = Utils.getCellLocT(telephonyManager.getCellLocation(), this.f46051a);
                m33084f();
    ...
    public List<Cgi> getDetectedCgiList() {
        return this.f46054d != null ? new ArrayList(this.f46054d) : new ArrayList();
    }
    ...
    public CellLocation getCellLocation() {
        TelephonyManager telephonyManager = this.f46057g;
        CellLocation cellLocation = null;
        if (telephonyManager != null) {
            try {
                cellLocation = telephonyManager.getCellLocation();
                if (cgiUseful(cellLocation)) {
                    this.f46061k = cellLocation;
                }
            } catch (Exception unused) {
            }
        }
    ...
    public synchronized void destroy() {
        if (this.f46052b) {
            if (!(this.f46057g == null || this.f46060j == null)) {
                try {
                    DLog.m32737d("cell unregister listener");
                    this.f46057g.listen(this.f46060j, 0);
                } catch (Exception e) {
    ...
    public void refineCellT() {
        int i = this.f46053c;
        if (i != 1) {
            if (i == 2 && this.f46054d != null && this.f46054d.isEmpty()) {
                DLog.m32737d("refine cell cdma2def");
                this.f46053c = 0;
            }
        } else if (this.f46054d != null && this.f46054d.isEmpty()) {
    ...
    public boolean cgiNeedUpdate(boolean z) {
        if (z || this.f46059i == 0 || Utils.getTimeBoot() - this.f46059i < 10000) {
            return false;
        }
        return true;
    }
    ...
    public boolean isCellValid() {
        CellLocation cellLocation = this.f46061k;
        return cellLocation != null && cgiUseful(cellLocation) && Utils.getTimeBoot() - this.f46059i <= 10000;
    }
    ...
    public boolean cgiUseful(android.telephony.CellLocation r6) {
        /*
            ...
            return r0
        L_0x0004:
            android.content.Context r1 = r5.f46051a
            int r1 = com.didichuxing.bigdata.p173dp.locsdk.once.Utils.getCellLocT(r6, r1)
            r2 = 1
        ...
        L_0x002f:
            ...
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r6, r1)
            java.lang.StringBuilder r1 = new java.lang.StringBuilder
            r1.<init>()
            java.lang.String r3 = r5.f46062l
            r1.append(r3)
        ...
        L_0x00a3:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p173dp.locsdk.once.CellManager.cgiUseful(android.telephony.CellLocation):boolean");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized void m33067a() {
        /*
            r5 = this;
            monitor-enter(r5)
            android.content.Context r0 = r5.f46051a     // Catch:{ all -> 0x00d5 }
            boolean r0 = com.didichuxing.bigdata.p173dp.locsdk.once.Utils.airPlaneModeOn(r0)     // Catch:{ all -> 0x00d5 }
            if (r0 != 0) goto L_0x00d3
            android.telephony.TelephonyManager r0 = r5.f46057g     // Catch:{ all -> 0x00d5 }
            if (r0 == 0) goto L_0x00d3
            r0 = 0
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f46054d     // Catch:{ all -> 0x00d5 }
            r2 = 0
            if (r1 == 0) goto L_0x0023
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f46054d     // Catch:{ all -> 0x00d5 }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x00d5 }
            if (r1 != 0) goto L_0x0023
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r0 = r5.f46054d     // Catch:{ all -> 0x00d5 }
        ...
        L_0x0023:
            java.util.List r1 = r5.m33073b()     // Catch:{ all -> 0x00d5 }
            r5.f46054d = r1     // Catch:{ all -> 0x00d5 }
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f46054d     // Catch:{ all -> 0x00d5 }
        ...
        L_0x0035:
            ...
            java.util.List r1 = r5.m33077c()     // Catch:{ all -> 0x00d5 }
            r5.f46054d = r1     // Catch:{ all -> 0x00d5 }
        L_0x0040:
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f46054d     // Catch:{ all -> 0x00d5 }
        ...
        L_0x004c:
            ...
            com.didichuxing.bigdata.p173dp.locsdk.DLog.m32737d(r1)     // Catch:{ all -> 0x00d5 }
        L_0x0051:
            android.telephony.CellLocation r1 = r5.f46061k     // Catch:{ all -> 0x00d5 }
        ...
        L_0x006b:
            android.telephony.CellLocation r1 = r5.f46061k     // Catch:{ all -> 0x00d5 }
            android.content.Context r3 = r5.f46051a     // Catch:{ all -> 0x00d5 }
            int r1 = com.didichuxing.bigdata.p173dp.locsdk.once.Utils.getCellLocT(r1, r3)     // Catch:{ all -> 0x00d5 }
            r3 = 1
        ...
        L_0x008e:
            android.telephony.CellLocation r1 = r5.f46061k     // Catch:{ all -> 0x00d5 }
            r5.m33074b((android.telephony.CellLocation) r1)     // Catch:{ all -> 0x00d5 }
            goto L_0x00a1
        L_0x0094:
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f46054d     // Catch:{ all -> 0x00d5 }
            int r1 = r1.size()     // Catch:{ all -> 0x00d5 }
            ...
            android.telephony.CellLocation r1 = r5.f46061k     // Catch:{ all -> 0x00d5 }
            r5.m33069a((android.telephony.CellLocation) r1)     // Catch:{ all -> 0x00d5 }
        L_0x00a1:
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f46054d     // Catch:{ all -> 0x00d5 }
            int r1 = r1.size()     // Catch:{ all -> 0x00d5 }
            ...
            r5.f46053c = r1     // Catch:{ all -> 0x00d5 }
        L_0x00b5:
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f46054d     // Catch:{ all -> 0x00d5 }
            ...
            if (r1 != 0) goto L_0x00d3
            r5.f46055e = r0     // Catch:{ all -> 0x00d5 }
        L_0x00d3:
            monitor-exit(r5)
            return
        L_0x00d5:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p173dp.locsdk.once.CellManager.m33067a():void");
    }

    /* renamed from: a */
    private void m33069a(CellLocation cellLocation) {
        Cgi a;
        if (cellLocation != null && this.f46057g != null && cgiUseful(cellLocation)) {
            if (this.f46054d != null) {
                this.f46054d.add(0, m33063a(cellLocation, 5));
            }
            if (this.f46054d != null && this.f46054d.size() == 1) {
                List<NeighboringCellInfo> list = null;
                try {
                    list = this.f46057g.getNeighboringCellInfo();
                ...
                for (NeighboringCellInfo neighboringCellInfo : list) {
                    if (cgiUseful(neighboringCellInfo) && (a = m33064a(neighboringCellInfo)) != null && !this.f46054d.contains(a)) {
                        this.f46054d.add(a);
                    }
                }
            }
    ...
    /* renamed from: b */
    private void m33074b(CellLocation cellLocation) {
        Cgi a;
        if (cellLocation != null) {
            ...
            try {
                if (this.f46058h != null) {
                    ...
                    try {
                        ...
                        if (gsmCellLocation != null && cgiUseful((CellLocation) gsmCellLocation)) {
                            ...
                            this.f46061k = gsmCellLocation;
                            if (this.f46054d != null && this.f46054d.size() > 0) {
                                this.f46054d.remove(0);
                            }
                            m33069a((CellLocation) gsmCellLocation);
                            z = true;
                        }
                    } catch (Exception unused) {
                ...
                if (cgiUseful(cellLocation) && (a = m33065a((Object) cellLocation, 2)) != null && this.f46054d.size() == 0) {
                    this.f46054d.add(a);
                }
            } catch (Exception e) {
                DLog.m32737d(e.toString());
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.didichuxing.bigdata.p173dp.locsdk.Cgi m33065a(java.lang.Object r7, int r8) {
        /*
            r6 = this;
            android.telephony.TelephonyManager r0 = r6.f46057g
            java.lang.String[] r0 = com.didichuxing.bigdata.p173dp.locsdk.once.Utils.getMccMnc(r0)
            ...
            int r0 = r6.f46056f     // Catch:{ Exception -> 0x0090 }
        ...
        L_0x0090:
            ...
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r7, r8)
            r1 = 0
        L_0x0097:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p173dp.locsdk.once.CellManager.m33065a(java.lang.Object, int):com.didichuxing.bigdata.dp.locsdk.Cgi");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.List<com.didichuxing.bigdata.p173dp.locsdk.Cgi> m33073b() {
        /*
            r11 = this;
            ...
            android.telephony.TelephonyManager r4 = r11.f46057g
            r5 = 0
            if (r4 != 0) goto L_0x000e
            return r5
        L_0x000e:
            android.content.Context r6 = r11.f46051a     // Catch:{ Exception -> 0x0041 }
            boolean r6 = com.didichuxing.bigdata.p173dp.locsdk.once.Utils.isLocationPermissionGranted(r6)     // Catch:{ Exception -> 0x0041 }
            ...
            java.lang.String r8 = r11.f46062l     // Catch:{ Exception -> 0x0041 }
            ...
            com.didichuxing.bigdata.p173dp.locsdk.DLog.m32737d(r7)     // Catch:{ Exception -> 0x0041 }
            java.lang.Throwable r7 = new java.lang.Throwable     // Catch:{ Exception -> 0x0041 }
            r7.<init>(r1)     // Catch:{ Exception -> 0x0041 }
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r7, r3)     // Catch:{ Exception -> 0x0041 }
        L_0x003c:
            java.util.List r1 = r11.m33066a((java.util.List<?>) r6)     // Catch:{ Exception -> 0x0041 }
            goto L_0x004d
        L_0x0041:
            r1 = move-exception
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r1, r3)
        ...
        L_0x004d:
            ...
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackGetSimCgi(r7, r6, r0)
            return r1
        L_0x0063:
        ...
        L_0x006e:
            ...
            if (r8 == 0) goto L_0x0084
            r11.f46061k = r5
            r11.m33070a((android.telephony.CellLocation) r5, (java.util.List<com.didichuxing.bigdata.p173dp.locsdk.Cgi>) r1)
        ...
        L_0x0084:
            ...
            java.lang.Object r9 = com.didichuxing.bigdata.p173dp.locsdk.Reflect.invokeMethod(r4, r2, r9)     // Catch:{ NoSuchMethodException -> 0x0099, Exception -> 0x0097 }
        ...
        L_0x0099:
            ...
            goto L_0x00a6
        L_0x009b:
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r9, r3)
        ...
        L_0x00ae:
            ...
            r11.f46061k = r5
            r11.m33070a((android.telephony.CellLocation) r5, (java.util.List<com.didichuxing.bigdata.p173dp.locsdk.Cgi>) r1)
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackGetSimCgi(r7, r6, r2)
            return r1
        L_0x00c2:
            ...
            java.lang.Object r2 = com.didichuxing.bigdata.p173dp.locsdk.Reflect.invokeMethod(r4, r0, r2)     // Catch:{ NoSuchMethodException -> 0x00d6, Exception -> 0x00d4 }
        ...
        L_0x00d6:
            ...
            goto L_0x00e3
        L_0x00d8:
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r2, r3)
        ...
        L_0x00ff:
            ...
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackGetSimCgi(r8, r6, r0)     // Catch:{ Exception -> 0x010a }
        L_0x010a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p173dp.locsdk.once.CellManager.m33073b():java.util.List");
    }

    /* renamed from: a */
    private void m33070a(CellLocation cellLocation, List<Cgi> list) {
        Cgi a;
        int cellLocT = Utils.getCellLocT(cellLocation, this.f46051a);
        if (cellLocT == 1) {
            list.add(m33063a(cellLocation, 5));
        } else if (cellLocT == 2 && (a = m33065a((Object) cellLocation, cellLocT)) != null) {
            list.add(a);
        }
    }
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.List<com.didichuxing.bigdata.p173dp.locsdk.Cgi> m33077c() {
        /*
            r12 = this;
            java.lang.String r0 = "sim2 NoSuchMethodException: getCellLocationGemini"
            java.lang.String r1 = "getSim2Cgis"
            java.lang.Object r2 = r12.f46058h
            java.lang.String r3 = "sim2"
            r4 = 0
            r5 = 0
            if (r2 != 0) goto L_0x0012
            java.lang.String r0 = "tm2==null"
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackGetSimCgi(r5, r3, r0)
            return r4
        L_0x0012:
            java.lang.Class r6 = r12.m33080d()     // Catch:{ Exception -> 0x010d }
        ...
        L_0x002b:
            r6 = move-exception
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r6, r1)     // Catch:{ Exception -> 0x010d }
        ...
        L_0x004f:
            r6 = r4
        L_0x0050:
            java.util.List r6 = r12.m33066a((java.util.List<?>) r6)     // Catch:{ Exception -> 0x010d }
        ...
        L_0x006b:
            r8 = move-exception
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r8, r1)     // Catch:{ Exception -> 0x010a }
        ...
        L_0x00a1:
            r9 = move-exception
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r9, r1)     // Catch:{ Exception -> 0x010a }
        ...
        L_0x00d8:
            r0 = move-exception
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r0, r1)     // Catch:{ Exception -> 0x010a }
        ...
        L_0x00f5:
            r2 = move-exception
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r2, r1)     // Catch:{ Exception -> 0x010a }
            com.didichuxing.bigdata.p173dp.locsdk.DLog.m32737d(r0)     // Catch:{ Exception -> 0x010a }
        L_0x00fc:
            if (r4 == 0) goto L_0x0108
            android.telephony.CellLocation r4 = (android.telephony.CellLocation) r4     // Catch:{ Exception -> 0x010a }
            r12.f46061k = r4     // Catch:{ Exception -> 0x010a }
            r12.m33070a((android.telephony.CellLocation) r4, (java.util.List<com.didichuxing.bigdata.p173dp.locsdk.Cgi>) r6)     // Catch:{ Exception -> 0x010a }
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackGetSimCgi(r8, r3, r7)     // Catch:{ Exception -> 0x010a }
        L_0x0108:
            r4 = r6
            goto L_0x0115
        L_0x010a:
        ...
        L_0x0122:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p173dp.locsdk.once.CellManager.m33077c():java.util.List");
    }

    /* renamed from: d */
    private Class<?> m33080d() {
    ...
    /* renamed from: a */
    private List<Cgi> m33066a(List<?> list) {
        int i;
                    ...
                    if (!(i == 0 || cellSignalStrength == null)) {
                        ...
                        if (i == 2) {
                            if (cgiUseful((CellLocation) cdmaCellLocation)) {
                                if (arrayList.size() == 0) {
                                    this.f46061k = cdmaCellLocation;
                                }
                                Cgi a = m33065a((Object) cdmaCellLocation, i);
                                if (dbm > -113 && dbm < 0) {
                                    a.sig = dbm;
                                }
                                if (a != null) {
                                    DLog.m32737d(this.f46062l + "cdma" + a.toString());
                                    arrayList.add(a);
                                }
                            }
                        } else if (cgiUseful((CellLocation) gsmCellLocation2)) {
                            if (arrayList.size() == 0) {
                                this.f46061k = gsmCellLocation2;
                            }
                            Cgi a2 = m33063a((CellLocation) gsmCellLocation2, i);
                            if (a2 != null) {
                                if (dbm > -113 && dbm < 0) {
                                    try {
                                        a2.sig = dbm;
                                ...
                                DLog.m32737d(this.f46062l + "other" + a2.toString());
                                arrayList.add(a2);
                            }
                        }
                    }
    ...
    /* renamed from: a */
    private Cgi m33063a(CellLocation cellLocation, int i) {
        GsmCellLocation gsmCellLocation = (GsmCellLocation) cellLocation;
        Cgi cgi = new Cgi();
        String[] mccMnc = Utils.getMccMnc(this.f46057g);
        cgi.mcc = mccMnc[0];
        cgi.mnc_sid = mccMnc[1];
        cgi.lac_nid = gsmCellLocation.getLac();
        cgi.cid_bid = gsmCellLocation.getCid();
        cgi.sig = this.f46056f;
        cgi.type = i;
    ...
    /* renamed from: a */
    private Cgi m33064a(NeighboringCellInfo neighboringCellInfo) {
        if (Utils.getSdk() < 5) {
    ...
    public void m33081e() {
        ...
        this.f46059i = Utils.getTimeBoot();
    }
    ...
    private void m33084f() {
        ...
        L_0x0019:
            r0 = move-exception
            com.didichuxing.bigdata.p173dp.locsdk.once.util.OmegaUtils.trackReflectError(r0, r1)
            java.lang.String r0 = r0.toString()
            com.didichuxing.bigdata.p173dp.locsdk.DLog.m32737d(r0)
            goto L_0x0037
        L_0x0025:
        ...
        L_0x0038:
            ...
            android.telephony.TelephonyManager r0 = r4.f46057g
            android.telephony.PhoneStateListener r2 = r4.f46060j
            r0.listen(r2, r1)
            goto L_0x0055
        L_0x0044:
            android.telephony.TelephonyManager r2 = r4.f46057g     // Catch:{ Exception -> 0x004d }
            android.telephony.PhoneStateListener r3 = r4.f46060j     // Catch:{ Exception -> 0x004d }
            r0 = r0 | r1
        ...
        L_0x0055:
            ...
            goto L_0x0089
        L_0x0064:
            android.content.Context r0 = r4.f46051a     // Catch:{ all -> 0x0081 }
            java.lang.Object r0 = com.didichuxing.bigdata.p173dp.locsdk.once.Utils.getServ(r0, r1)     // Catch:{ all -> 0x0081 }
            r4.f46058h = r0     // Catch:{ all -> 0x0081 }
            goto L_0x0089
        L_0x006d:
            android.content.Context r0 = r4.f46051a     // Catch:{ all -> 0x0081 }
        ...
        L_0x00b1:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p173dp.locsdk.once.CellManager.m33084f():void");
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public void m33068a(int i) {
        if (i == -113) {
            this.f46056f = Const.iDefCgiSig;
            return;
        }
        this.f46056f = i;
        int i2 = this.f46053c;
        if ((i2 == 1 || i2 == 2 || i2 == 3 || i2 == 4) && this.f46054d != null && !this.f46054d.isEmpty()) {
            try {
                this.f46054d.get(0).sig = this.f46056f;
            } catch (Exception e) {
                DLog.m32737d(e.toString());
            }
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public int m33059a(SignalStrength signalStrength) {
        if (signalStrength.isGsm()) {
            int c = m33076c(signalStrength);
            if (c != Integer.MAX_VALUE) {
                return c;
            }
            if (!m33082e(signalStrength)) {
                return m33083f(signalStrength);
            }
            if (m33072b(signalStrength) == Integer.MAX_VALUE) {
                return m33079d(signalStrength);
            }
            return m33072b(signalStrength);
        }
    ...
    /* renamed from: d */
    private int m33079d(SignalStrength signalStrength) {
    ...
    /* renamed from: e */
    private boolean m33082e(SignalStrength signalStrength) {
        int f = m33083f(signalStrength);
        return f == Integer.MAX_VALUE || f > -25 || f < -110;
    }

    /* renamed from: f */
    private int m33083f(SignalStrength signalStrength) {
