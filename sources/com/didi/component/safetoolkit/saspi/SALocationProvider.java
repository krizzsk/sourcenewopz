...
public class SALocationProvider implements ISfLocationService {
                ...
                if (presenter == null || !(presenter instanceof AbsSafeToolkitPresenter) || (componentParams = ((AbsSafeToolkitPresenter) presenter).getComponentParams()) != null) {
                    ...
                    instance.requestLocationUpdateOnce(context, new LocationController.OneCarLocationListener() {
                        ...
                        public void onLocationChanged(DIDILocation dIDILocation) {
                            SfLocation a = SALocationProvider.this.m11100a(dIDILocation);
                            ComponentParams componentParams = componentParams;
                            if (componentParams != null) {
                                SALocationProvider.this.m11101a(context, a, dIDILocation, componentParams, sfCallback);
                            }
                        }
    ...
    /* renamed from: a */
    public void m11101a(Context context, final SfLocation sfLocation, DIDILocation dIDILocation, ComponentParams componentParams, final ISfLocationService.SfCallback sfCallback) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public SfLocation m11100a(DIDILocation dIDILocation) {
