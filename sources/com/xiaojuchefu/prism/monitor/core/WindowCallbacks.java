...
public class WindowCallbacks implements Window.Callback {
    ...
    /* renamed from: a */
    private Window.Callback f56097a;
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        if (keyEvent.getKeyCode() != 4 || keyEvent.getAction() != 1) {
            Window.Callback callback = this.f56097a;
            ...
            Window.Callback callback2 = this.f56097a;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        return this.f56097a != null && (touchEvent(motionEvent) || this.f56097a.dispatchTouchEvent(motionEvent));
    }
