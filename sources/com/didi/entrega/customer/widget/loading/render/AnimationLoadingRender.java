...
public abstract class AnimationLoadingRender extends BaseLoadingRender implements Animator.AnimatorListener {
    ...
    public View onCreateView(Context context, Bundle bundle) {
        ...
        this.f20556b = ofFloat;
        ofFloat.setRepeatCount(-1);
        this.f20556b.setRepeatMode(1);
        this.f20556b.setDuration(bundle.getLong("Loading::Duration", 1200));
        this.f20556b.setInterpolator(AnimationUtils.loadInterpolator(context, bundle.getInt("Loading::Interpolator::Id", 17563659)));
        this.f20556b.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                AnimationLoadingRender.this.computeRender(((Float) valueAnimator.getAnimatedValue()).floatValue());
                AnimationLoadingRender.this.m15044a();
            }
        });
        this.f20556b.addListener(this);
    ...
    /* renamed from: a */
    public void m15044a() {
        for (ILoadingRender.Callback invalidateDrawable : this.f20557a) {
    ...
    class LoadingDrawable extends Drawable implements Animatable {
        ...
        LoadingDrawable(ILoadingRender iLoadingRender) {
            C81661 r1 = new ILoadingRender.SimpleCallback() {
