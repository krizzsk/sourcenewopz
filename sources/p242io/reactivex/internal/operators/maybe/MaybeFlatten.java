...
public final class MaybeFlatten<T, R> extends C21209a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends MaybeSource<? extends R>> f58594a;

    public MaybeFlatten(MaybeSource<T> maybeSource, Function<? super T, ? extends MaybeSource<? extends R>> function) {
        super(maybeSource);
        this.f58594a = function;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        this.source.subscribe(new FlatMapMaybeObserver(maybeObserver, this.f58594a));
    }
