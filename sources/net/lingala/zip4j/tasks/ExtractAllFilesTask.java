...
public class ExtractAllFilesTask extends AbstractExtractFileTask<ExtractAllFilesTaskParameters> {
    ...
    /* renamed from: b */
    private SplitInputStream f5037b;
    ...
    public void executeTask(net.lingala.zip4j.tasks.ExtractAllFilesTask.ExtractAllFilesTaskParameters r10, net.lingala.zip4j.progress.ProgressMonitor r11) throws java.io.IOException {
        /*
            ...
            net.lingala.zip4j.io.inputstream.ZipInputStream r0 = r9.m3221a((net.lingala.zip4j.model.Zip4jConfig) r0)     // Catch:{ all -> 0x006e }
        ...
        L_0x0016:
            ...
            goto L_0x0016
        L_0x0037:
            net.lingala.zip4j.io.inputstream.SplitInputStream r1 = r9.f5037b     // Catch:{ all -> 0x0060 }
        ...
        L_0x0058:
            net.lingala.zip4j.io.inputstream.SplitInputStream r10 = r9.f5037b
        ...
        L_0x006e:
            r10 = move-exception
            net.lingala.zip4j.io.inputstream.SplitInputStream r11 = r9.f5037b
    ...
    /* renamed from: a */
    private ZipInputStream m3221a(Zip4jConfig zip4jConfig) throws IOException {
        this.f5037b = UnzipUtil.createSplitInputStream(getZipModel());
        FileHeader a = m3222a(getZipModel());
        if (a != null) {
            this.f5037b.prepareExtractionForFileHeader(a);
        }
        return new ZipInputStream((InputStream) this.f5037b, this.f5036a, zip4jConfig);
    }

    /* renamed from: a */
    private FileHeader m3222a(ZipModel zipModel) {
