...
public class QBadgeView extends View implements Badge {
    ...
    /* renamed from: a */
    private static final double f17828a = 6.283185307179586d;
    ...
    /* renamed from: a */
    private double m13318a(double d) {
        return (d / f17828a) * 360.0d;
    }

    /* renamed from: a */
    private double m13319a(double d, int i) {
        if (d < 0.0d) {
    ...
    private void m13322a() {
        ...
        this.mBadgeTextSize = (float) m13321a(getContext(), 11.0f);
        this.mBadgePadding = (float) m13321a(getContext(), 5.0f);
        this.mBadgeNumber = 0;
        this.mBadgeGravity = BadgeDrawable.TOP_END;
        this.mGravityOffsetX = (float) m13321a(getContext(), 1.0f);
        this.mGravityOffsetY = (float) m13321a(getContext(), 1.0f);
        this.mFinalDragDistance = (float) m13321a(getContext(), 90.0f);
    ...
    public void onAttachedToWindow() {
        ...
        if (this.mActivityRoot == null) {
            m13328a(this.mTargetView);
        }
    }

    /* renamed from: a */
    private void m13328a(View view) {
    ...
    /* renamed from: b */
    private void m13333b(View view) {
        if (view.getParent() != null && (view.getParent() instanceof View)) {
            m13333b((View) view.getParent());
    ...
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        L_0x0045:
            ...
            int r0 = r5.m13321a((android.content.Context) r0, (float) r3)
            float r0 = (float) r0
        ...
        L_0x00b9:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.dimina.container.p106ui.tabbar.BadgeView.QBadgeView.onTouchEvent(android.view.MotionEvent):boolean");
    }

    /* renamed from: b */
    private void m13332b() {
    ...
    public Bitmap createBadgeBitmap() {
        Bitmap createBitmap = Bitmap.createBitmap(((int) this.mBadgeBackgroundRect.width()) + m13321a(getContext(), 3.0f), ((int) this.mBadgeBackgroundRect.height()) + m13321a(getContext(), 3.0f), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        m13326a(canvas, new PointF(((float) canvas.getWidth()) / 2.0f, ((float) canvas.getHeight()) / 2.0f), getBadgeCircleRadius());
        return createBitmap;
    }
    ...
    /* renamed from: a */
    private void m13329a(boolean z) {
        int a = m13321a(getContext(), 1.0f);
        int a2 = m13321a(getContext(), 1.5f);
        int i = this.mDragQuadrant;
        if (i == 1) {
            a = m13321a(getContext(), 1.0f);
            a2 = m13321a(getContext(), -1.5f);
        } else if (i == 2) {
            a = m13321a(getContext(), -1.0f);
            a2 = m13321a(getContext(), -1.5f);
        } else if (i == 3) {
        ...
        this.mBadgeBackgroundPaint.setShadowLayer(z ? (float) m13321a(getContext(), 2.0f) : 0.0f, (float) a, (float) a2, 855638016);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (badgeAnimator != null && badgeAnimator.isRunning()) {
            ...
            float a = this.mDefalutRadius * (1.0f - (m13320a(this.mRowBadgeCenter, this.mDragCenter) / this.mFinalDragDistance));
            if (!this.mDraggable || !this.mDragging) {
                m13336e();
                m13326a(canvas, this.mBadgeCenter, badgeCircleRadius);
                return;
            }
            this.mDragQuadrant = m13331b(this.mDragCenter, this.mRowBadgeCenter);
            m13329a(this.mShowShadow);
            boolean z = a < ((float) m13321a(getContext(), 1.5f));
            this.mDragOutOfRange = z;
            if (z) {
                m13323a(3);
                m13326a(canvas, this.mDragCenter, badgeCircleRadius);
                return;
            }
            m13323a(2);
            m13325a(canvas, a, badgeCircleRadius);
            m13326a(canvas, this.mDragCenter, badgeCircleRadius);
        }
    }

    /* renamed from: c */
    private void m13334c() {
        m13329a(this.mShowShadow);
    ...
    /* renamed from: a */
    private void m13325a(Canvas canvas, float f, float f2) {
        float f3;
        float f4;
        float f5;
        ...
        if (f7 != 0.0f) {
            ...
            m13327a(this.mDragCenter, f2, Double.valueOf(d), this.mInnertangentPoints);
            m13327a(this.mRowBadgeCenter, f, Double.valueOf(d), this.mInnertangentPoints);
        } else {
            m13327a(this.mDragCenter, f2, Double.valueOf(0.0d), this.mInnertangentPoints);
            m13327a(this.mRowBadgeCenter, f, Double.valueOf(0.0d), this.mInnertangentPoints);
        }
        ...
        if (this.mColorBackgroundBorder != 0 && this.mBackgroundBorderWidth > 0.0f) {
            ...
            float a = 360.0f - ((float) m13318a(m13319a(atan, i3 + -1 == 0 ? 4 : i3 - 1)));
            if (Build.VERSION.SDK_INT >= 21) {
    ...
    /* renamed from: a */
    private void m13326a(Canvas canvas, PointF pointF, float f) {
    ...
    /* renamed from: a */
    private void m13324a(Canvas canvas) {
    ...
    public float getBadgeTextSize(boolean z) {
        return z ? (float) m13330b(getContext(), this.mBadgeTextSize) : this.mBadgeTextSize;
    }
    ...
    public float getBadgePadding(boolean z) {
        return z ? (float) m13330b(getContext(), this.mBadgePadding) : this.mBadgePadding;
    }
    ...
    public Badge setGravityOffset(float f, float f2, boolean z) {
        ...
        if (z) {
            f2 = (float) m13321a(getContext(), f2);
        }
    ...
    public float getGravityOffsetX(boolean z) {
        return z ? (float) m13330b(getContext(), this.mGravityOffsetX) : this.mGravityOffsetX;
    }

    public float getGravityOffsetY(boolean z) {
        return z ? (float) m13330b(getContext(), this.mGravityOffsetY) : this.mGravityOffsetY;
    }

    /* renamed from: a */
    private void m13323a(int i) {
    ...
    /* renamed from: a */
    private int m13321a(Context context, float f) {
        return (int) ((f * context.getResources().getDisplayMetrics().density) + 0.5f);
    }

    /* renamed from: b */
    private int m13330b(Context context, float f) {
        return (int) ((f / context.getResources().getDisplayMetrics().density) + 0.5f);
    }

    /* renamed from: a */
    private float m13320a(PointF pointF, PointF pointF2) {
        return (float) Math.sqrt(Math.pow((double) (pointF.x - pointF2.x), 2.0d) + Math.pow((double) (pointF.y - pointF2.y), 2.0d));
    }

    /* renamed from: b */
    private int m13331b(PointF pointF, PointF pointF2) {
    ...
    /* renamed from: a */
    private void m13327a(PointF pointF, float f, Double d, List<PointF> list) {
        float f2;
        if (d != null) {
