...
public class MemberComparator implements Comparator<DeclarationDescriptor> {
    ...
    /* renamed from: a */
    static final /* synthetic */ boolean f60851a = (!MemberComparator.class.desiredAssertionStatus());

    /* renamed from: b */
    private static final DescriptorRenderer f60852b = DescriptorRenderer.Companion.withOptions(new Function1<DescriptorRendererOptions, Unit>() {
    ...
    public int compare(DeclarationDescriptor declarationDescriptor, DeclarationDescriptor declarationDescriptor2) {
        ...
        if (!(declarationDescriptor instanceof TypeAliasDescriptor) || !(declarationDescriptor2 instanceof TypeAliasDescriptor)) {
            ...
            if ((declarationDescriptor instanceof CallableDescriptor) && (declarationDescriptor2 instanceof CallableDescriptor)) {
                ...
                if (extensionReceiverParameter != null && (compareTo = f60852b.renderType(extensionReceiverParameter.getType()).compareTo(f60852b.renderType(extensionReceiverParameter2.getType()))) != 0) {
                    return compareTo;
                }
                ...
                for (int i = 0; i < Math.min(valueParameters.size(), valueParameters2.size()); i++) {
                    int compareTo2 = f60852b.renderType(valueParameters.get(i).getType()).compareTo(f60852b.renderType(valueParameters2.get(i).getType()));
                    if (compareTo2 != 0) {
                        return compareTo2;
                    }
                }
                ...
                for (int i2 = 0; i2 < Math.min(typeParameters.size(), typeParameters2.size()); i2++) {
                    ...
                    for (int i3 = 0; i3 < upperBounds.size(); i3++) {
                        int compareTo3 = f60852b.renderType(upperBounds.get(i3)).compareTo(f60852b.renderType(upperBounds2.get(i3)));
                        if (compareTo3 != 0) {
                            return compareTo3;
                        }
                    }
            ...
            int compareTo4 = f60852b.renderType(((TypeAliasDescriptor) declarationDescriptor).getUnderlyingType()).compareTo(f60852b.renderType(((TypeAliasDescriptor) declarationDescriptor2).getUnderlyingType()));
            if (compareTo4 != 0) {
                return compareTo4;
            }
        }
        int compareTo5 = f60852b.render(declarationDescriptor).compareTo(f60852b.render(declarationDescriptor2));
        if (compareTo5 != 0) {
            return compareTo5;
        }
