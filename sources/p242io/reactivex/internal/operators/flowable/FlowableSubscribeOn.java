...
public final class FlowableSubscribeOn<T> extends C21208a<T, T> {

    /* renamed from: a */
    final Scheduler f58463a;

    /* renamed from: b */
    final boolean f58464b;

    public FlowableSubscribeOn(Flowable<T> flowable, Scheduler scheduler, boolean z) {
        super(flowable);
        this.f58463a = scheduler;
        this.f58464b = z;
    }

    public void subscribeActual(Subscriber<? super T> subscriber) {
        Scheduler.Worker createWorker = this.f58463a.createWorker();
        SubscribeOnSubscriber subscribeOnSubscriber = new SubscribeOnSubscriber(subscriber, createWorker, this.source, this.f58464b);
    ...
    static final class SubscribeOnSubscriber<T> extends AtomicReference<Thread> implements FlowableSubscriber<T>, Runnable, Subscription {
        ...
        static final class Request implements Runnable {
            ...
            public void run() {
                this.upstream.request(this.f58465n);
            }
        }
    }
}
