...
@Metadata(mo175977d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001\"\u0004\b\u0000\u0010\u0003*\u00020\u0004H@"}, mo175978d2 = {"<anonymous>", "Lkotlinx/coroutines/channels/ChannelResult;", "", "E", "Lkotlinx/coroutines/CoroutineScope;"}, mo175979k = 3, mo175980mv = {1, 5, 1}, mo175982xi = 48)
@DebugMetadata(mo176686c = "kotlinx.coroutines.channels.ChannelsKt__ChannelsKt$trySendBlocking$2", mo176687f = "Channels.kt", mo176688i = {}, mo176689l = {92}, mo176690m = "invokeSuspend", mo176691n = {}, mo176692s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m47688constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m47688constructorimpl(Unit.INSTANCE);
        if (Result.m47695isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m48269successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m48267closedJP2dKIU(Result.m47691exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m48254boximpl(obj3);
    }
}
