...
class AndroidVideoDecoder implements VideoDecoder, VideoSink {
    ...
    AndroidVideoDecoder(MediaCodecWrapperFactory mediaCodecWrapperFactory2, String str, VideoCodecType videoCodecType, int i, EglBase.Context context) {
        if (isSupportedColorFormat(i)) {
            Logging.m3800d(TAG, "ctor name: " + str + " type: " + videoCodecType + " color format: " + i + " context: " + context);
    ...
    private VideoCodecStatus initDecodeInternal(int i, int i2) {
        ...
        Logging.m3800d(TAG, "initDecodeInternal name: " + this.codecName + " type: " + this.codecType + " width: " + i + " height: " + i2);
        if (this.outputThread != null) {
            Logging.m3801e(TAG, "initDecodeInternal called while the codec is already running");
        ...
        try {
            ...
            try {
                ...
                Logging.m3800d(TAG, "initDecodeInternal done");
                return VideoCodecStatus.f6712OK;
            ...
            Logging.m3801e(TAG, "Cannot create media decoder " + this.codecName);
            return VideoCodecStatus.FALLBACK_SOFTWARE;
        }
    }
    ...
    public VideoCodecStatus decode(EncodedImage encodedImage, VideoDecoder.DecodeInfo decodeInfo) {
        ...
        if (this.codec == null || this.callback == null) {
            ...
            Logging.m3801e(TAG, "decode() - no input data");
            return VideoCodecStatus.ERR_PARAMETER;
        } else {
            int remaining = encodedImage.buffer.remaining();
            if (remaining == 0) {
                Logging.m3801e(TAG, "decode() - input buffer empty");
                return VideoCodecStatus.ERR_PARAMETER;
            }
            ...
            if (encodedImage.encodedWidth * encodedImage.encodedHeight > 0 && ((encodedImage.encodedWidth != i || encodedImage.encodedHeight != i2) && (reinitDecode = reinitDecode(encodedImage.encodedWidth, encodedImage.encodedHeight)) != VideoCodecStatus.f6712OK)) {
                return reinitDecode;
            }
            if (this.keyFrameRequired) {
                if (encodedImage.frameType != EncodedImage.FrameType.VideoFrameKey) {
                    Logging.m3801e(TAG, "decode() - key frame required first");
                    return VideoCodecStatus.NO_OUTPUT;
                } else if (!encodedImage.completeFrame) {
                    Logging.m3801e(TAG, "decode() - complete frame required first");
                    return VideoCodecStatus.NO_OUTPUT;
                }
            }
            try {
                ...
                if (dequeueInputBuffer < 0) {
                    Logging.m3801e(TAG, "decode() - no HW buffers available; decoder falling behind");
                    return VideoCodecStatus.ERROR;
                }
                try {
                    ByteBuffer byteBuffer = this.codec.getInputBuffers()[dequeueInputBuffer];
                    if (byteBuffer.capacity() < remaining) {
                        Logging.m3801e(TAG, "decode() - HW buffer too small");
                        return VideoCodecStatus.ERROR;
                    }
                    ...
                    try {
                        ...
                        Logging.m3802e(TAG, "queueInputBuffer failed", e);
                        this.frameInfos.pollLast();
                        return VideoCodecStatus.ERROR;
                    }
                } catch (IllegalStateException e2) {
                    Logging.m3802e(TAG, "getInputBuffers failed", e2);
                    return VideoCodecStatus.ERROR;
                }
            } catch (IllegalStateException e3) {
                Logging.m3802e(TAG, "dequeueInputBuffer failed", e3);
                return VideoCodecStatus.ERROR;
            }
        }
    }
    ...
    private VideoCodecStatus releaseInternal() {
        if (!this.running) {
            Logging.m3800d(TAG, "release: Decoder is not running.");
            return VideoCodecStatus.f6712OK;
        }
        try {
            this.running = false;
            if (!ThreadUtils.joinUninterruptibly(this.outputThread, 5000)) {
                Logging.m3802e(TAG, "Media decoder release timeout", new RuntimeException());
                return VideoCodecStatus.TIMEOUT;
            } else if (this.shutdownException != null) {
                Logging.m3802e(TAG, "Media decoder release error", new RuntimeException(this.shutdownException));
    ...
    private VideoCodecStatus reinitDecode(int i, int i2) {
        this.decoderThreadChecker.checkIsOnValidThread();
        VideoCodecStatus releaseInternal = releaseInternal();
        if (releaseInternal != VideoCodecStatus.f6712OK) {
            return releaseInternal;
        }
    ...
    public void deliverDecodedFrame() {
        ...
        try {
            ...
            if (dequeueOutputBuffer == -2) {
                ...
                Logging.m3803v(TAG, "dequeueOutputBuffer returned " + dequeueOutputBuffer);
            } else {
            ...
            Logging.m3802e(TAG, "deliverDecodedFrame failed", e);
        }
    }
    ...
    private void deliverByteFrame(int i, MediaCodec.BufferInfo bufferInfo, int i2, Integer num) {
        ...
        if (bufferInfo.size < ((i3 * i4) * 3) / 2) {
            Logging.m3801e(TAG, "Insufficient output buffer size: " + bufferInfo.size);
            return;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00c1, code lost:
        ...
        org.webrtc.Logging.m3800d(TAG, "Color: 0x" + java.lang.Integer.toHexString(r5.colorFormat));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x012c, code lost:
        org.webrtc.Logging.m3800d(TAG, "Frame stride and slice height: " + r5.stride + " x " + r5.sliceHeight);
    ...
    private void reformat(android.media.MediaFormat r6) {
        /*
            ...
            org.webrtc.Logging.m3800d(r0, r1)
        ...
        L_0x012c:
            ...
            org.webrtc.Logging.m3800d(r6, r1)     // Catch:{ all -> 0x0164 }
    ...
    public void releaseCodecOnOutputThread() {
        this.outputThreadChecker.checkIsOnValidThread();
        Logging.m3800d(TAG, "Releasing MediaCodec on output thread");
        try {
            this.codec.stop();
        } catch (Exception e) {
            Logging.m3802e(TAG, "Media decoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            Logging.m3802e(TAG, "Media decoder release failed", e2);
            this.shutdownException = e2;
        }
        Logging.m3800d(TAG, "Release on output thread done");
    }
