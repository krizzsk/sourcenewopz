...
public final class LazyJavaPackageScope extends LazyJavaStaticScope {
    ...
    /* renamed from: b */
    private final JavaPackage f60556b;

    /* renamed from: c */
    private final LazyJavaPackageFragment f60557c;

    /* renamed from: d */
    private final NullableLazyValue<Set<String>> f60558d;

    /* renamed from: e */
    private final MemoizedFunctionToNullable<FindClassRequest, ClassDescriptor> f60559e;
    ...
    public LazyJavaPackageScope(LazyJavaResolverContext lazyJavaResolverContext, JavaPackage javaPackage, LazyJavaPackageFragment lazyJavaPackageFragment) {
        ...
        this.f60556b = javaPackage;
        this.f60557c = lazyJavaPackageFragment;
        this.f60558d = lazyJavaResolverContext.getStorageManager().createNullableLazyValue(new LazyJavaPackageScope$knownClassNamesInPackage$1(lazyJavaResolverContext, this));
        this.f60559e = lazyJavaResolverContext.getStorageManager().createMemoizedFunctionWithNullableValues(new LazyJavaPackageScope$classes$1(this, lazyJavaResolverContext));
    }
    ...
    /* renamed from: a */
    public final KotlinClassLookupResult m44651a(KotlinJvmBinaryClass kotlinJvmBinaryClass) {
    ...
    public ClassDescriptor getContributedClassifier(Name name, LookupLocation lookupLocation) {
        ...
        return m44650a(name, (JavaClass) null);
    }

    /* renamed from: a */
    private final ClassDescriptor m44650a(Name name, JavaClass javaClass) {
        if (!SpecialNames.isSafeIdentifier(name)) {
            return null;
        }
        Set set = (Set) this.f60558d.invoke();
        if (javaClass != null || set == null || set.contains(name.asString())) {
            return this.f60559e.invoke(new FindClassRequest(name, javaClass));
        }
        return null;
    }
    ...
    public final ClassDescriptor findClassifierByJavaClass$descriptors_jvm(JavaClass javaClass) {
        ...
        return m44650a(javaClass.getName(), javaClass);
    }
    ...
    public Set<Name> computeClassNames(DescriptorKindFilter descriptorKindFilter, Function1<? super Name, Boolean> function1) {
        ...
        Set<String> set = (Set) this.f60558d.invoke();
        if (set != null) {
        ...
        JavaPackage javaPackage = this.f60556b;
        if (function1 == null) {
