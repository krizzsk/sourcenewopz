...
public class Transformer {
    ...
    /* renamed from: a */
    float[] f52507a = new float[2];

    /* renamed from: b */
    private Matrix f52508b = new Matrix();

    /* renamed from: c */
    private Matrix f52509c = new Matrix();
    ...
    public void getValuesByTouchPoint(float f, float f2, MPPointD mPPointD) {
        float[] fArr = this.f52507a;
        fArr[0] = f;
        fArr[1] = f2;
        pixelsToValue(fArr);
        mPPointD.f52495x = (double) this.f52507a[0];
        mPPointD.f52496y = (double) this.f52507a[1];
    }
    ...
    public Matrix getValueToPixelMatrix() {
        this.f52508b.set(this.mMatrixValueToPx);
        this.f52508b.postConcat(this.mViewPortHandler.mMatrixTouch);
        this.f52508b.postConcat(this.mMatrixOffset);
        return this.f52508b;
    }

    public Matrix getPixelToValueMatrix() {
        getValueToPixelMatrix().invert(this.f52509c);
        return this.f52509c;
    }
}
