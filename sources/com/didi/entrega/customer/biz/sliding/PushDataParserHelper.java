...
import com.didi.entrega.customer.biz.sliding.p111pb.Coordinate;
import com.didi.entrega.customer.biz.sliding.p111pb.DriverLocationInfo;
import com.didi.entrega.customer.biz.sliding.p111pb.GulfstreamPassengerDriverLocReq;
import com.didi.entrega.customer.biz.sliding.p111pb.LocPoint;
    ...
    public static NearDriversEntity parseNearDriver(byte[] bArr) {
        ...
        while (it.hasNext()) {
            ...
            for (Coordinate coordinate : (List) Wire.get(driverLocationInfo.coords, DriverLocationInfo.DEFAULT_COORDS)) {
                ...
                VectorCoordinate vectorCoordinate2 = new VectorCoordinate(((Double) Wire.get(coordinate.f19846x, Coordinate.DEFAULT_X)).doubleValue(), ((Double) Wire.get(coordinate.f19847y, Coordinate.DEFAULT_Y)).doubleValue(), (float) ((double) ((Integer) Wire.get(coordinate.angle, Coordinate.DEFAULT_ANGLE)).intValue()), (long) ((Integer) Wire.get(coordinate.timestamp, Coordinate.DEFAULT_TIMESTAMP)).intValue());
