...
public final class FlowableAnySingle<T> extends Single<Boolean> implements FuseToFlowable<Boolean> {
    ...
    /* renamed from: a */
    final Flowable<T> f58180a;

    /* renamed from: b */
    final Predicate<? super T> f58181b;

    public FlowableAnySingle(Flowable<T> flowable, Predicate<? super T> predicate) {
        this.f58180a = flowable;
        this.f58181b = predicate;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(SingleObserver<? super Boolean> singleObserver) {
        this.f58180a.subscribe(new AnySubscriber(singleObserver, this.f58181b));
    }

    public Flowable<Boolean> fuseToFlowable() {
        return RxJavaPlugins.onAssembly(new FlowableAny(this.f58180a, this.f58181b));
    }
