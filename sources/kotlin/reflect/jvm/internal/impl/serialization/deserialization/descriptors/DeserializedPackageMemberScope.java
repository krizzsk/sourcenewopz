...
public class DeserializedPackageMemberScope extends DeserializedMemberScope {
    ...
    /* renamed from: a */
    private final PackageFragmentDescriptor f61044a;

    /* renamed from: b */
    private final String f61045b;

    /* renamed from: c */
    private final FqName f61046c;
    ...
    public List<DeclarationDescriptor> getContributedDescriptors(DescriptorKindFilter descriptorKindFilter, Function1<? super Name, Boolean> function1) {
        ...
        for (ClassDescriptorFactory allContributedClassesIfPossible : fictitiousClassDescriptorFactories) {
            CollectionsKt.addAll(arrayList, allContributedClassesIfPossible.getAllContributedClassesIfPossible(this.f61046c));
        }
    ...
    public boolean hasClass(kotlin.reflect.jvm.internal.impl.name.Name r6) {
        ...
        L_0x002c:
            ...
            kotlin.reflect.jvm.internal.impl.name.FqName r4 = r5.f61046c
    ...
    public ClassId createClassId(Name name) {
        ...
        return new ClassId(this.f61046c, name);
    }
    ...
    public void recordLookup(Name name, LookupLocation lookupLocation) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(lookupLocation, "location");
        UtilsKt.record(getC().getComponents().getLookupTracker(), lookupLocation, this.f61044a, name);
    }
