...
public class DESExample {
    ...
    /* renamed from: in */
    private BufferedInputStream f6024in;
    private byte[] key;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x00e0, code lost:
        r8.append(r10);
        r8.append(r9);
        r8.append(com.didichuxing.bigdata.p173dp.locsdk.Const.jaRight);
    ...
    public DESExample(java.lang.String r7, java.lang.String r8, java.lang.String r9, boolean r10) {
        /*
            ...
            r6.f6024in = r3     // Catch:{ FileNotFoundException -> 0x0020 }
            goto L_0x003c
        L_0x0020:
    ...
    private void performDecrypt(byte[] bArr) {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(this.f6024in));
        byte[] bArr2 = null;
        while (true) {
            try {
    ...
    private void performEncrypt(byte[] bArr) {
        ...
        while (true) {
            try {
                int read = this.f6024in.read(bArr2, 0, 47);
                if (read > 0) {
