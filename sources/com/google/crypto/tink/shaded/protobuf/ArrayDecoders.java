...
final class ArrayDecoders {
    ...
    static int decodeVarint32(int i, byte[] bArr, int i2, Registers registers) {
        ...
        byte b2 = bArr[i4];
        if (b2 >= 0) {
            registers.int1 = i5 | (b2 << Ascii.f53594SO);
            return i6;
        }
        ...
        byte b4 = bArr[i8];
        if (b4 >= 0) {
            registers.int1 = i9 | (b4 << Ascii.f53587FS);
            return i10;
        }
    ...
    static int decodeExtension(int r7, byte[] r8, int r9, int r10, com.google.crypto.tink.shaded.protobuf.GeneratedMessageLite.ExtendableMessage<?, ?> r11, com.google.crypto.tink.shaded.protobuf.GeneratedMessageLite.GeneratedExtension<?, ?> r12, com.google.crypto.tink.shaded.protobuf.UnknownFieldSchema<com.google.crypto.tink.shaded.protobuf.UnknownFieldSetLite, com.google.crypto.tink.shaded.protobuf.UnknownFieldSetLite> r13, com.google.crypto.tink.shaded.protobuf.ArrayDecoders.Registers r14) throws java.io.IOException {
        /*
            ...
            if (r1 == 0) goto L_0x00fb
            int[] r10 = com.google.crypto.tink.shaded.protobuf.ArrayDecoders.C193361.$SwitchMap$com$google$protobuf$WireFormat$FieldType
        ...
        L_0x0129:
            ...
            goto L_0x0201
        L_0x0131:
            int[] r11 = com.google.crypto.tink.shaded.protobuf.ArrayDecoders.C193361.$SwitchMap$com$google$protobuf$WireFormat$FieldType
        ...
        L_0x0201:
            ...
            goto L_0x0233
        L_0x020d:
            int[] r7 = com.google.crypto.tink.shaded.protobuf.ArrayDecoders.C193361.$SwitchMap$com$google$protobuf$WireFormat$FieldType
    ...
    static /* synthetic */ class C193361 {
        ...
        static {
            ...
            L_0x00d8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.ArrayDecoders.C193361.<clinit>():void");
        }
    }
