...
public final class CodedOutputStream {
    ...
    /* renamed from: d */
    private int f60764d = 0;

    /* renamed from: e */
    private final OutputStream f60765e;

    /* renamed from: a */
    static int m44786a(int i) {
        if (i > 4096) {
            return 4096;
        }
        return i;
    ...
    private CodedOutputStream(OutputStream outputStream, byte[] bArr) {
        this.f60765e = outputStream;
        this.f60761a = bArr;
        this.f60763c = 0;
        this.f60762b = bArr.length;
    }
    ...
    /* renamed from: a */
    private void m44787a() throws IOException {
        OutputStream outputStream = this.f60765e;
        if (outputStream != null) {
            outputStream.write(this.f60761a, 0, this.f60763c);
            this.f60763c = 0;
            return;
        }
    ...
    public void writeRawByte(byte b) throws IOException {
        if (this.f60763c == this.f60762b) {
            m44787a();
        }
        byte[] bArr = this.f60761a;
        int i = this.f60763c;
        this.f60763c = i + 1;
        bArr[i] = b;
        this.f60764d++;
    ...
    public void writeRawBytes(byte[] bArr, int i, int i2) throws IOException {
        ...
        int i4 = this.f60763c;
        if (i3 - i4 >= i2) {
            System.arraycopy(bArr, i, this.f60761a, i4, i2);
            this.f60763c += i2;
            this.f60764d += i2;
            return;
        }
        int i5 = i3 - i4;
        System.arraycopy(bArr, i, this.f60761a, i4, i5);
        int i6 = i + i5;
        int i7 = i2 - i5;
        this.f60763c = this.f60762b;
        this.f60764d += i5;
        m44787a();
        if (i7 <= this.f60762b) {
            System.arraycopy(bArr, i6, this.f60761a, 0, i7);
            this.f60763c = i7;
        } else {
            this.f60765e.write(bArr, i6, i7);
        }
        this.f60764d += i7;
    }
    ...
    public void writeRawBytes(ByteString byteString, int i, int i2) throws IOException {
        ...
        int i4 = this.f60763c;
        if (i3 - i4 >= i2) {
            byteString.copyTo(this.f60761a, i, i4, i2);
            this.f60763c += i2;
            this.f60764d += i2;
            return;
        }
        int i5 = i3 - i4;
        byteString.copyTo(this.f60761a, i, i4, i5);
        int i6 = i + i5;
        int i7 = i2 - i5;
        this.f60763c = this.f60762b;
        this.f60764d += i5;
        m44787a();
        if (i7 <= this.f60762b) {
            byteString.copyTo(this.f60761a, i6, 0, i7);
            this.f60763c = i7;
        } else {
            byteString.mo179136a(this.f60765e, i6, i7);
        }
        this.f60764d += i7;
    }

    public void writeTag(int i, int i2) throws IOException {
        writeRawVarint32(WireFormat.m44830a(i, i2));
    }

    public static int computeTagSize(int i) {
        return computeRawVarint32Size(WireFormat.m44830a(i, 0));
    }
