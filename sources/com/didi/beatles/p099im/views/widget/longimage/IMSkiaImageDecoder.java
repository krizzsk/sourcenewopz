...
public class IMSkiaImageDecoder implements ImageDecoder {
    ...
    /* renamed from: a */
    private static final String f10527a = "file://";

    /* renamed from: b */
    private static final String f10528b = "file:///android_asset/";

    /* renamed from: c */
    private static final String f10529c = "android.resource://";
    ...
    public android.graphics.Bitmap decode(android.content.Context r9, android.net.Uri r10) throws java.lang.Exception {
        ...
        L_0x00cb:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.beatles.p099im.views.widget.longimage.IMSkiaImageDecoder.decode(android.content.Context, android.net.Uri):android.graphics.Bitmap");
    }
}
