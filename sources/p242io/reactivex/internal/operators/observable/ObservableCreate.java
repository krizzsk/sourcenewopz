...
import p242io.reactivex.ObservableEmitter;
import p242io.reactivex.ObservableOnSubscribe;
...
public final class ObservableCreate<T> extends Observable<T> {
    ...
    /* renamed from: a */
    final ObservableOnSubscribe<T> f58774a;

    public ObservableCreate(ObservableOnSubscribe<T> observableOnSubscribe) {
        this.f58774a = observableOnSubscribe;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            this.f58774a.subscribe(createEmitter);
        } catch (Throwable th) {
