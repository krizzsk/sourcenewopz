...
class C21487b {
    ...
    /* renamed from: a */
    private static final InputStreamReader m44176a(Path path, Charset charset, OpenOption... openOptionArr) throws IOException {
        return new InputStreamReader(Files.newInputStream(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset);
    }

    /* renamed from: a */
    static /* synthetic */ BufferedReader m44174a(Path path, Charset charset, int i, OpenOption[] openOptionArr, int i2, Object obj) throws IOException {
        if ((i2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i2 & 2) != 0) {
    ...
    /* renamed from: a */
    private static final BufferedReader m44173a(Path path, Charset charset, int i, OpenOption... openOptionArr) throws IOException {
        return new BufferedReader(new InputStreamReader(Files.newInputStream(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset), i);
    }

    /* renamed from: b */
    static /* synthetic */ OutputStreamWriter m44197b(Path path, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: b */
    private static final OutputStreamWriter m44196b(Path path, Charset charset, OpenOption... openOptionArr) throws IOException {
        return new OutputStreamWriter(Files.newOutputStream(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset);
    }

    /* renamed from: b */
    static /* synthetic */ BufferedWriter m44194b(Path path, Charset charset, int i, OpenOption[] openOptionArr, int i2, Object obj) throws IOException {
        if ((i2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i2 & 2) != 0) {
    ...
    /* renamed from: b */
    private static final BufferedWriter m44193b(Path path, Charset charset, int i, OpenOption... openOptionArr) throws IOException {
        return new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset), i);
    }

    /* renamed from: a */
    private static final byte[] m44192a(Path path) throws IOException {
    ...
    /* renamed from: a */
    private static final void m44191a(Path path, byte[] bArr, OpenOption... openOptionArr) throws IOException {
        Files.write(path, bArr, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length));
    }

    /* renamed from: a */
    private static final void m44190a(Path path, byte[] bArr) throws IOException {
    ...
    public static final java.lang.String readText(java.nio.file.Path r3, java.nio.charset.Charset r4) throws java.io.IOException {
        /*
            ...
            java.lang.String r4 = kotlin.p245io.TextStreamsKt.readText(r4)     // Catch:{ all -> 0x002e }
            kotlin.p245io.CloseableKt.closeFinally(r2, r3)
            return r4
        L_0x002e:
            r3 = move-exception
        ...
        L_0x0030:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21487b.readText(java.nio.file.Path, java.nio.charset.Charset):java.lang.String");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x003b, code lost:
        kotlin.p245io.CloseableKt.closeFinally(r4, r1);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void writeText(java.nio.file.Path r1, java.lang.CharSequence r2, java.nio.charset.Charset r3, java.nio.file.OpenOption... r4) throws java.io.IOException {
        ...
        L_0x003a:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21487b.writeText(java.nio.file.Path, java.lang.CharSequence, java.nio.charset.Charset, java.nio.file.OpenOption[]):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0039, code lost:
        kotlin.p245io.CloseableKt.closeFinally(r0, r3);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void appendText(java.nio.file.Path r3, java.lang.CharSequence r4, java.nio.charset.Charset r5) throws java.io.IOException {
        ...
        L_0x0038:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21487b.appendText(java.nio.file.Path, java.lang.CharSequence, java.nio.charset.Charset):void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ void m44189a(java.nio.file.Path r2, java.nio.charset.Charset r3, kotlin.jvm.functions.Function1 r4, int r5, java.lang.Object r6) throws java.io.IOException {
        /*
            r6 = 1
            r5 = r5 & r6
        ...
        L_0x0020:
            ...
            kotlin.sequences.Sequence r0 = kotlin.p245io.TextStreamsKt.lineSequence(r0)     // Catch:{ all -> 0x0055 }
        ...
        L_0x0068:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21487b.m44189a(java.nio.file.Path, java.nio.charset.Charset, kotlin.jvm.functions.Function1, int, java.lang.Object):void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final void m44188a(java.nio.file.Path r4, java.nio.charset.Charset r5, kotlin.jvm.functions.Function1<? super java.lang.String, kotlin.Unit> r6) throws java.io.IOException {
        /*
        ...
        L_0x001a:
            ...
            kotlin.sequences.Sequence r2 = kotlin.p245io.TextStreamsKt.lineSequence(r2)     // Catch:{ all -> 0x0050 }
        ...
        L_0x0063:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21487b.m44188a(java.nio.file.Path, java.nio.charset.Charset, kotlin.jvm.functions.Function1):void");
    }

    /* renamed from: a */
    private static final InputStream m44175a(Path path, OpenOption... openOptionArr) throws IOException {
    ...
    /* renamed from: b */
    private static final OutputStream m44195b(Path path, OpenOption... openOptionArr) throws IOException {
    ...
    /* renamed from: a */
    static /* synthetic */ List m44187a(Path path, Charset charset, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final List<String> m44186a(Path path, Charset charset) throws IOException {
        List<String> readAllLines = Files.readAllLines(path, charset);
        Intrinsics.checkNotNullExpressionValue(readAllLines, "Files.readAllLines(this, charset)");
        return readAllLines;
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ java.lang.Object m44199b(java.nio.file.Path r2, java.nio.charset.Charset r3, kotlin.jvm.functions.Function1 r4, int r5, java.lang.Object r6) throws java.io.IOException {
        /*
            r6 = 1
            r5 = r5 & r6
            if (r5 == 0) goto L_0x0006
        ...
        L_0x0006:
            ...
            kotlin.sequences.Sequence r0 = kotlin.p245io.TextStreamsKt.lineSequence(r0)     // Catch:{ all -> 0x0037 }
        ...
        L_0x004c:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21487b.m44199b(java.nio.file.Path, java.nio.charset.Charset, kotlin.jvm.functions.Function1, int, java.lang.Object):java.lang.Object");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final <T> T m44198b(java.nio.file.Path r4, java.nio.charset.Charset r5, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r6) throws java.io.IOException {
        /*
            java.io.BufferedReader r4 = java.nio.file.Files.newBufferedReader(r4, r5)
            java.io.Closeable r4 = (java.io.Closeable) r4
            r5 = 0
            ...
            kotlin.sequences.Sequence r2 = kotlin.p245io.TextStreamsKt.lineSequence(r2)     // Catch:{ all -> 0x0032 }
        ...
        L_0x0047:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21487b.m44198b(java.nio.file.Path, java.nio.charset.Charset, kotlin.jvm.functions.Function1):java.lang.Object");
    }

    /* renamed from: a */
    static /* synthetic */ Path m44181a(Path path, Iterable iterable, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final Path m44180a(Path path, Iterable<? extends CharSequence> iterable, Charset charset, OpenOption... openOptionArr) throws IOException {
        Path write = Files.write(path, iterable, charset, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(write, "Files.write(this, lines, charset, *options)");
        return write;
    }
    ...
    /* renamed from: a */
    static /* synthetic */ Path m44185a(Path path, Sequence sequence, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final Path m44184a(Path path, Sequence<? extends CharSequence> sequence, Charset charset, OpenOption... openOptionArr) throws IOException {
        Path write = Files.write(path, SequencesKt.asIterable(sequence), charset, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(write, "Files.write(this, lines.…ble(), charset, *options)");
        return write;
    }
    ...
    /* renamed from: a */
    static /* synthetic */ Path m44179a(Path path, Iterable iterable, Charset charset, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final Path m44178a(Path path, Iterable<? extends CharSequence> iterable, Charset charset) throws IOException {
        Path write = Files.write(path, iterable, charset, new OpenOption[]{StandardOpenOption.APPEND});
        Intrinsics.checkNotNullExpressionValue(write, "Files.write(this, lines,…tandardOpenOption.APPEND)");
        return write;
    }
    ...
    /* renamed from: a */
    static /* synthetic */ Path m44183a(Path path, Sequence sequence, Charset charset, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final Path m44182a(Path path, Sequence<? extends CharSequence> sequence, Charset charset) throws IOException {
        Path write = Files.write(path, SequencesKt.asIterable(sequence), charset, new OpenOption[]{StandardOpenOption.APPEND});
        Intrinsics.checkNotNullExpressionValue(write, "Files.write(this, lines.…tandardOpenOption.APPEND)");
        return write;
    }
