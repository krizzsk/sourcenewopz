...
public final class DataMatrixWriter implements Writer {
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) {
        ...
        if (str.isEmpty()) {
            ...
            return m13761a(defaultPlacement, lookup, i, i2);
        }
    }

    /* renamed from: a */
    private static BitMatrix m13761a(DefaultPlacement defaultPlacement, SymbolInfo symbolInfo, int i, int i2) {
        ...
        return m13762a(byteMatrix, i, i2);
    }

    /* renamed from: a */
    private static BitMatrix m13762a(ByteMatrix byteMatrix, int i, int i2) {
        BitMatrix bitMatrix;
