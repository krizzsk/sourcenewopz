...
public class SmoothLinearLayoutManager extends LinearLayoutManager {
    ...
    /* renamed from: a */
    private RecyclerView.SmoothScroller f20609a;
    ...
    public void setSmoothScroller(RecyclerView.SmoothScroller smoothScroller) {
        this.f20609a = smoothScroller;
    }

    public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
        RecyclerView.SmoothScroller smoothScroller = this.f20609a;
        if (smoothScroller == null) {
            super.smoothScrollToPosition(recyclerView, state, i);
            return;
        }
        smoothScroller.setTargetPosition(i);
        startSmoothScroll(this.f20609a);
    }
}
