...
public final class ChooseKeyTypeVM$pollPixKeyStatus$1 extends WNetCallback<PollStatusResp> {
    ...
    public void onSuccess(PollStatusResp pollStatusResp) {
        ...
        } else if (this.this$0.f30868g <= 5) {
            this.this$0.f30867f.schedule(new Runnable(this.$keyType, this.$keyVal) {
                ...
                public final void run() {
                    ChooseKeyTypeVM$pollPixKeyStatus$1.m46579onSuccess$lambda0(ChooseKeyTypeVM.this, this.f$1, this.f$2);
                }
            }, 1, TimeUnit.SECONDS);
        } else {
            this.this$0.isLoading().setValue(false);
    ...
    public static final void m46579onSuccess$lambda0(ChooseKeyTypeVM chooseKeyTypeVM, int i, String str) {
