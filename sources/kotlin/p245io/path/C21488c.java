...
class C21488c extends C21487b {
    ...
    public static final java.lang.String getNameWithoutExtension(java.nio.file.Path r3) {
        ...
        L_0x001e:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21488c.getNameWithoutExtension(java.nio.file.Path):java.lang.String");
    }
    ...
    public static final java.lang.String getExtension(java.nio.file.Path r2) {
        ...
        L_0x001c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21488c.getExtension(java.nio.file.Path):java.lang.String");
    }

    /* renamed from: a */
    private static final String m44203a(Path path) {
    ...
    /* renamed from: b */
    private static final String m44223b(Path path) {
        return PathsKt.getInvariantSeparatorsPathString(path);
    }

    /* renamed from: c */
    private static final Path m44233c(Path path) {
    ...
    /* renamed from: d */
    private static final String m44237d(Path path) {
    ...
    public static final Path relativeTo(Path path, Path path2) {
        ...
        try {
            return C21486a.f59890a.mo176745a(path, path2);
    ...
    /* renamed from: a */
    private static final Path m44213a(Path path, Path path2, boolean z) throws IOException {
    ...
    /* renamed from: a */
    static /* synthetic */ Path m44214a(Path path, Path path2, boolean z, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            z = false;
        }
        CopyOption[] copyOptionArr = z ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
    ...
    /* renamed from: a */
    private static final Path m44215a(Path path, Path path2, CopyOption... copyOptionArr) throws IOException {
        Path copy = Files.copy(path, path2, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(copy, "Files.copy(this, target, *options)");
        return copy;
    }
    ...
    /* renamed from: a */
    private static final boolean m44222a(Path path, LinkOption... linkOptionArr) {
        return Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: b */
    private static final boolean m44232b(Path path, LinkOption... linkOptionArr) {
        return Files.notExists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: c */
    private static final boolean m44236c(Path path, LinkOption... linkOptionArr) {
        return Files.isRegularFile(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: d */
    private static final boolean m44238d(Path path, LinkOption... linkOptionArr) {
        return Files.isDirectory(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: e */
    private static final boolean m44240e(Path path) {
        return Files.isSymbolicLink(path);
    }

    /* renamed from: f */
    private static final boolean m44242f(Path path) {
        return Files.isExecutable(path);
    }

    /* renamed from: g */
    private static final boolean m44244g(Path path) throws IOException {
        return Files.isHidden(path);
    }

    /* renamed from: h */
    private static final boolean m44246h(Path path) {
        return Files.isReadable(path);
    }

    /* renamed from: i */
    private static final boolean m44248i(Path path) {
        return Files.isWritable(path);
    }

    /* renamed from: a */
    private static final boolean m44221a(Path path, Path path2) throws IOException {
    ...
    public static final java.util.List<java.nio.file.Path> listDirectoryEntries(java.nio.file.Path r2, java.lang.String r3) throws java.io.IOException {
        ...
        L_0x0027:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21488c.listDirectoryEntries(java.nio.file.Path, java.lang.String):java.util.List");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0046, code lost:
        kotlin.p245io.CloseableKt.closeFinally(r4, r5);
     */
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final <T> T m44200a(java.nio.file.Path r4, java.lang.String r5, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<? extends java.nio.file.Path>, ? extends T> r6) throws java.io.IOException {
        /*
        ...
        L_0x0049:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21488c.m44200a(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1):java.lang.Object");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ java.lang.Object m44201a(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1 r4, int r5, java.lang.Object r6) throws java.io.IOException {
        /*
            r6 = 1
            r5 = r5 & r6
        ...
        L_0x004e:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21488c.m44201a(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1, int, java.lang.Object):java.lang.Object");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final void m44230b(java.nio.file.Path r4, java.lang.String r5, kotlin.jvm.functions.Function1<? super java.nio.file.Path, kotlin.Unit> r6) throws java.io.IOException {
        /*
            java.nio.file.DirectoryStream r4 = java.nio.file.Files.newDirectoryStream(r4, r5)
            java.io.Closeable r4 = (java.io.Closeable) r4
            r5 = 0
        ...
        L_0x0055:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21488c.m44230b(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1):void");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ void m44231b(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1 r4, int r5, java.lang.Object r6) throws java.io.IOException {
        /*
            r6 = 1
            r5 = r5 & r6
            if (r5 == 0) goto L_0x0006
        ...
        L_0x005a:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.path.C21488c.m44231b(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1, int, java.lang.Object):void");
    }

    /* renamed from: j */
    private static final long m44249j(Path path) throws IOException {
        return Files.size(path);
    }

    /* renamed from: k */
    private static final void m44251k(Path path) throws IOException {
        Files.delete(path);
    }

    /* renamed from: l */
    private static final boolean m44252l(Path path) throws IOException {
        return Files.deleteIfExists(path);
    }

    /* renamed from: a */
    private static final Path m44220a(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
    ...
    /* renamed from: b */
    private static final Path m44228b(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
    ...
    /* renamed from: b */
    private static final Path m44227b(Path path, Path path2, CopyOption... copyOptionArr) throws IOException {
    ...
    /* renamed from: b */
    private static final Path m44225b(Path path, Path path2, boolean z) throws IOException {
        CopyOption[] copyOptionArr = z ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
        Path move = Files.move(path, path2, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(move, "Files.move(this, target, *options)");
        return move;
    ...
    /* renamed from: b */
    static /* synthetic */ Path m44226b(Path path, Path path2, boolean z, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            z = false;
        }
        CopyOption[] copyOptionArr = z ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
    ...
    /* renamed from: m */
    private static final FileStore m44253m(Path path) throws IOException {
    ...
    /* renamed from: a */
    private static final Object m44202a(Path path, String str, LinkOption... linkOptionArr) throws IOException {
        return Files.getAttribute(path, str, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: a */
    private static final Path m44212a(Path path, String str, Object obj, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: f */
    private static final /* synthetic */ <V extends FileAttributeView> V m44241f(Path path, LinkOption... linkOptionArr) {
    ...
    /* renamed from: g */
    private static final /* synthetic */ <A extends BasicFileAttributes> A m44243g(Path path, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: b */
    private static final Map<String, Object> m44229b(Path path, String str, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: h */
    private static final FileTime m44245h(Path path, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: a */
    private static final Path m44217a(Path path, FileTime fileTime) throws IOException {
    ...
    /* renamed from: i */
    private static final UserPrincipal m44247i(Path path, LinkOption... linkOptionArr) throws IOException {
        return Files.getOwner(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: a */
    private static final Path m44218a(Path path, UserPrincipal userPrincipal) throws IOException {
    ...
    /* renamed from: j */
    private static final Set<PosixFilePermission> m44250j(Path path, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: a */
    private static final Path m44219a(Path path, Set<? extends PosixFilePermission> set) throws IOException {
    ...
    /* renamed from: b */
    private static final Path m44224b(Path path, Path path2) throws IOException {
    ...
    /* renamed from: a */
    private static final Path m44216a(Path path, Path path2, FileAttribute<?>... fileAttributeArr) throws IOException {
    ...
    /* renamed from: n */
    private static final Path m44254n(Path path) throws IOException {
    ...
    /* renamed from: c */
    private static final Path m44235c(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
    ...
    /* renamed from: a */
    static /* synthetic */ Path m44206a(String str, String str2, FileAttribute[] fileAttributeArr, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            str = null;
        }
        if ((i & 2) != 0) {
    ...
    /* renamed from: a */
    private static final Path m44205a(String str, String str2, FileAttribute<?>... fileAttributeArr) throws IOException {
        Path createTempFile = Files.createTempFile(str, str2, (FileAttribute[]) Arrays.copyOf(fileAttributeArr, fileAttributeArr.length));
        Intrinsics.checkNotNullExpressionValue(createTempFile, "Files.createTempFile(prefix, suffix, *attributes)");
        return createTempFile;
    }
    ...
    /* renamed from: a */
    static /* synthetic */ Path m44209a(String str, FileAttribute[] fileAttributeArr, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            str = null;
        }
    ...
    /* renamed from: a */
    private static final Path m44208a(String str, FileAttribute<?>... fileAttributeArr) throws IOException {
        Path createTempDirectory = Files.createTempDirectory(str, (FileAttribute[]) Arrays.copyOf(fileAttributeArr, fileAttributeArr.length));
        Intrinsics.checkNotNullExpressionValue(createTempDirectory, "Files.createTempDirectory(prefix, *attributes)");
        return createTempDirectory;
    }
    ...
    /* renamed from: c */
    private static final Path m44234c(Path path, Path path2) {
    ...
    /* renamed from: a */
    private static final Path m44211a(Path path, String str) {
        Intrinsics.checkNotNullParameter(path, "$this$div");
    ...
    /* renamed from: a */
    private static final Path m44204a(String str) {
    ...
    /* renamed from: a */
    private static final Path m44207a(String str, String... strArr) {
    ...
    /* renamed from: a */
    private static final Path m44210a(URI uri) {
