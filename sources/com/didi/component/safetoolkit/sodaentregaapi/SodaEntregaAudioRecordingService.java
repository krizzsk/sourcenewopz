...
public class SodaEntregaAudioRecordingService implements ISFTripRecordingService {
    ...
    /* renamed from: a */
    public GlobalDialog f15413a = new GlobalDialog();
    ...
    public void showDialog(final FragmentActivity fragmentActivity, String str, String str2, String str3, String str4, final View.OnClickListener onClickListener) {
        if (this.f15413a.isPendingDismiss() || !this.f15413a.isVisible()) {
            this.f15413a.build().title(str2).actions(new GlobalDialog.IButtonAction[]{new GlobalDialog.PositiveButtonAction() {
                ...
                public Runnable getAction() {
                    return new Runnable() {
                        public void run() {
                            ...
                            SodaEntregaAudioRecordingService.this.f15413a.dismiss();
                        }
                    };
                }
