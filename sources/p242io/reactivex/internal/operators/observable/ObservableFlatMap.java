...
public final class ObservableFlatMap<T, U> extends C21211a<T, U> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<? extends U>> f58812a;
    ...
    public void subscribeActual(Observer<? super U> observer) {
        if (!ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f58812a)) {
            this.source.subscribe(new MergeObserver(observer, this.f58812a, this.f58813b, this.f58814c, this.f58815d));
        }
    }
            ...
            while (!checkTerminate()) {
                ...
                if (!z || !((simplePlainQueue2 == null || simplePlainQueue2.isEmpty()) && length == 0 && i == 0)) {
                    if (length != 0) {
                        ...
                        if (length <= i5 || innerObserverArr[i5].f58816id != j) {
                            if (length <= i5) {
                                i5 = 0;
                            }
                            for (int i6 = 0; i6 < length && innerObserverArr[i5].f58816id != j; i6++) {
                                i5++;
                                if (i5 == length) {
                                    i5 = 0;
                                }
                            ...
                            this.lastIndex = i5;
                            this.lastId = innerObserverArr[i5].f58816id;
                        }
                        int i7 = 0;
                        int i8 = 0;
                        while (i7 < length) {
