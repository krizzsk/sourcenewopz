...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(((float) pixelForValues.f52495x) - 1.0f, this.mViewPortHandler.contentTop());
        path.lineTo(((float) pixelForValues.f52495x) - 1.0f, this.mViewPortHandler.contentBottom());
