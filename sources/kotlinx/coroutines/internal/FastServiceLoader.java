...
@Metadata(mo175977d1 = {"\u0000N\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÀ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J!\u0010\u0005\u001a\u0004\u0018\u00010\u00062\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00060\b2\u0006\u0010\t\u001a\u00020\u0004H\bJ1\u0010\n\u001a\u0002H\u000b\"\u0004\b\u0000\u0010\u000b2\u0006\u0010\f\u001a\u00020\u00042\u0006\u0010\r\u001a\u00020\u000e2\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u0002H\u000b0\bH\u0002¢\u0006\u0002\u0010\u0010J*\u0010\u0011\u001a\b\u0012\u0004\u0012\u0002H\u000b0\u0012\"\u0004\b\u0000\u0010\u000b2\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u0002H\u000b0\b2\u0006\u0010\r\u001a\u00020\u000eH\u0002J\u0013\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00060\u0012H\u0000¢\u0006\u0002\b\u0014J/\u0010\u0015\u001a\b\u0012\u0004\u0012\u0002H\u000b0\u0012\"\u0004\b\u0000\u0010\u000b2\f\u0010\u000f\u001a\b\u0012\u0004\u0012\u0002H\u000b0\b2\u0006\u0010\r\u001a\u00020\u000eH\u0000¢\u0006\u0002\b\u0016J\u0016\u0010\u0017\u001a\b\u0012\u0004\u0012\u00020\u00040\u00122\u0006\u0010\u0018\u001a\u00020\u0019H\u0002J\u0016\u0010\u001a\u001a\b\u0012\u0004\u0012\u00020\u00040\u00122\u0006\u0010\u001b\u001a\u00020\u001cH\u0002J,\u0010\u001d\u001a\u0002H\u001e\"\u0004\b\u0000\u0010\u001e*\u00020\u001f2\u0012\u0010 \u001a\u000e\u0012\u0004\u0012\u00020\u001f\u0012\u0004\u0012\u0002H\u001e0!H\b¢\u0006\u0002\u0010\"R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006#"}, mo175978d2 = {"Lkotlinx/coroutines/internal/FastServiceLoader;", "", "()V", "PREFIX", "", "createInstanceOf", "Lkotlinx/coroutines/internal/MainDispatcherFactory;", "baseClass", "Ljava/lang/Class;", "serviceClass", "getProviderInstance", "S", "name", "loader", "Ljava/lang/ClassLoader;", "service", "(Ljava/lang/String;Ljava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Object;", "load", "", "loadMainDispatcherFactory", "loadMainDispatcherFactory$kotlinx_coroutines_core", "loadProviders", "loadProviders$kotlinx_coroutines_core", "parse", "url", "Ljava/net/URL;", "parseFile", "r", "Ljava/io/BufferedReader;", "use", "R", "Ljava/util/jar/JarFile;", "block", "Lkotlin/Function1;", "(Ljava/util/jar/JarFile;Lkotlin/jvm/functions/Function1;)Ljava/lang/Object;", "kotlinx-coroutines-core"}, mo175979k = 1, mo175980mv = {1, 5, 1}, mo175982xi = 48)
/* compiled from: FastServiceLoader.kt */
public final class FastServiceLoader {
    public static final FastServiceLoader INSTANCE = new FastServiceLoader();

    /* renamed from: a */
    private static final String f61523a = "META-INF/services/";
    ...
    public final List<MainDispatcherFactory> loadMainDispatcherFactory$kotlinx_coroutines_core() {
        ...
        if (!FastServiceLoaderKt.getANDROID_DETECTED()) {
            return m45969a(cls, cls.getClassLoader());
        }
        try {
    ...
    /* renamed from: a */
    private final MainDispatcherFactory m45971a(Class<MainDispatcherFactory> cls, String str) {
        try {
    ...
    /* renamed from: a */
    private final <S> List<S> m45969a(Class<S> cls, ClassLoader classLoader) {
        try {
    ...
    public final <S> List<S> loadProviders$kotlinx_coroutines_core(Class<S> cls, ClassLoader classLoader) {
        ArrayList<T> list = Collections.list(classLoader.getResources(Intrinsics.stringPlus(f61523a, cls.getName())));
        Intrinsics.checkNotNullExpressionValue(list, "java.util.Collections.list(this)");
        Collection arrayList = new ArrayList();
        for (T a : list) {
            CollectionsKt.addAll(arrayList, INSTANCE.m45970a((URL) a));
        }
        ...
        if (!set.isEmpty()) {
            ...
            for (String a2 : iterable) {
                arrayList2.add(INSTANCE.m45966a(a2, classLoader, cls));
            }
    ...
    /* renamed from: a */
    private final <S> S m45966a(String str, ClassLoader classLoader, Class<S> cls) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
        kotlin.p245io.CloseableKt.closeFinally(r6, r0);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x008a, code lost:
        kotlin.p245io.CloseableKt.closeFinally(r0, r6);
     */
    ...
    private final java.util.List<java.lang.String> m45970a(java.net.URL r6) {
        /*
            r5 = this;
            ...
            java.util.List r0 = r2.m45968a((java.io.BufferedReader) r0)     // Catch:{ all -> 0x0053 }
            kotlin.p245io.CloseableKt.closeFinally(r6, r4)     // Catch:{ all -> 0x005a }
        ...
        L_0x0055:
            r2 = move-exception
            kotlin.p245io.CloseableKt.closeFinally(r6, r0)     // Catch:{ all -> 0x005a }
        ...
        L_0x0066:
            ...
            java.util.List r6 = r1.m45968a((java.io.BufferedReader) r6)     // Catch:{ all -> 0x0087 }
            kotlin.p245io.CloseableKt.closeFinally(r0, r4)
            return r6
        L_0x0087:
            r6 = move-exception
        ...
        L_0x0089:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.internal.FastServiceLoader.m45970a(java.net.URL):java.util.List");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final <R> R m45967a(java.util.jar.JarFile r3, kotlin.jvm.functions.Function1<? super java.util.jar.JarFile, ? extends R> r4) {
        /*
            r2 = this;
            r0 = 1
        ...
        L_0x001e:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.internal.FastServiceLoader.m45967a(java.util.jar.JarFile, kotlin.jvm.functions.Function1):java.lang.Object");
    }

    /* renamed from: a */
    private final List<String> m45968a(BufferedReader bufferedReader) {
        boolean z;
