...
final class LoadingController$loadingView$2 extends Lambda implements Function0<View> {
    ...
    public final View invoke() {
        if (this.this$0.f29991b.getLoadingLayoutId() == 0) {
            return this.this$0.f29991b.getLoadingLayoutView();
        }
        return View.inflate(this.this$0.f29990a.getContext(), this.this$0.f29991b.getLoadingLayoutId(), (ViewGroup) null);
    }
}
