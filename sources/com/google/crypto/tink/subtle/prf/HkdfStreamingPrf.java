...
public class HkdfStreamingPrf implements StreamingPrf {
    ...
    static /* synthetic */ class C194071 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.subtle.prf.HkdfStreamingPrf.C194071.<clinit>():void");
        }
    }

    /* access modifiers changed from: private */
    public static String getJavaxHmacName(Enums.HashType hashType2) throws GeneralSecurityException {
        int i = C194071.$SwitchMap$com$google$crypto$tink$subtle$Enums$HashType[hashType2.ordinal()];
        if (i == 1) {
            return "HmacSha1";
        }
        if (i == 2) {
