...
public final class ObservableDoFinally<T> extends C21211a<T, T> {

    /* renamed from: a */
    final Action f58794a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new DoFinallyObserver(observer, this.f58794a));
    }
    ...
    static final class DoFinallyObserver<T> extends BasicIntQueueDisposable<T> implements Observer<T> {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                if (disposable instanceof QueueDisposable) {
                    this.f58795qd = (QueueDisposable) disposable;
                }
        ...
        public int requestFusion(int i) {
            QueueDisposable<T> queueDisposable = this.f58795qd;
            boolean z = false;
        ...
        public boolean isEmpty() {
            return this.f58795qd.isEmpty();
        }

        public T poll() throws Exception {
            T poll = this.f58795qd.poll();
