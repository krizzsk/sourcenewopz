...
public final class VersionRequirement {
    ...
    /* renamed from: a */
    private final Version f60695a;

    /* renamed from: b */
    private final ProtoBuf.VersionRequirement.VersionKind f60696b;

    /* renamed from: c */
    private final DeprecationLevel f60697c;

    /* renamed from: d */
    private final Integer f60698d;

    /* renamed from: e */
    private final String f60699e;
    ...
    public VersionRequirement(Version version, ProtoBuf.VersionRequirement.VersionKind versionKind, DeprecationLevel deprecationLevel, Integer num, String str) {
        ...
        this.f60695a = version;
        this.f60696b = versionKind;
        this.f60697c = deprecationLevel;
        this.f60698d = num;
        this.f60699e = str;
    }
    ...
    public String toString() {
        ...
        sb.append("since ");
        sb.append(this.f60695a);
        sb.append(' ');
        sb.append(this.f60697c);
        Integer num = this.f60698d;
        String str = "";
        sb.append(num != null ? Intrinsics.stringPlus(" error ", num) : str);
        String str2 = this.f60699e;
        if (str2 != null) {
