    ...
    public static class DESPBEKeyFactory extends BaseSecretKeyFactory {
        ...
        public SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
            if (keySpec instanceof PBEKeySpec) {
                ...
                CipherParameters makePBEParameters = this.forCipher ? PBE.C2737Util.makePBEParameters(pBEKeySpec, this.scheme, this.digest, this.keySize, this.ivSize) : PBE.C2737Util.makePBEMacParameters(pBEKeySpec, this.scheme, this.digest, this.keySize);
