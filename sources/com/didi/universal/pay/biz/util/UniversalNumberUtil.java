...
public class UniversalNumberUtil extends SpannableStringBuilder {
    ...
    /* renamed from: a */
    private static final String f45107a = "(([0-9]*\\.?[0-9]+)*,?[0-9]*)";

    /* renamed from: b */
    private static final String f45108b = "&#10;";

    /* renamed from: c */
    private CharSequence f45109c;
    ...
    public SpannableStringBuilder spanNumSize(float f) {
        Matcher matcher = Pattern.compile(f45107a).matcher(this.f45109c);
        while (matcher.find()) {
            m32383a(f, matcher.start(), matcher.end());
        }
        return this;
    }

    /* renamed from: a */
    private void m32383a(float f, int i, int i2) {
