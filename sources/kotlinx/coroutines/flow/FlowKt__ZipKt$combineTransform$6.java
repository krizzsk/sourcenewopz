...
@DebugMetadata(mo176686c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo176687f = "Zip.kt", mo176688i = {}, mo176689l = {251}, mo176690m = "invokeSuspend", mo176691n = {}, mo176692s = {})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo176686c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo176687f = "Zip.kt", mo176688i = {}, mo176689l = {251}, mo176690m = "invokeSuspend", mo176691n = {}, mo176692s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C219222 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C219222 r0 = new C219222(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C219222((Continuation<? super C219222>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C219222((Continuation<? super C219222>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
