...
public final class AnnotationConstructorCaller implements Caller {
    ...
    @Metadata(mo175977d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, mo175978d2 = {"Lkotlin/reflect/jvm/internal/calls/AnnotationConstructorCaller$Origin;", "", "(Ljava/lang/String;I)V", "JAVA", "KOTLIN", "kotlin-reflection"}, mo175979k = 1, mo175980mv = {1, 5, 1})
    /* compiled from: AnnotationConstructorCaller.kt */
    public enum Origin {
        JAVA,
        KOTLIN
    ...
    public AnnotationConstructorCaller(Class<?> cls, List<String> list, CallMode callMode, Origin origin, List<Method> list2) {
        ...
        this.f60074a = (List) arrayList;
        Iterable<Method> iterable2 = this.f60080g;
        ...
        this.f60075b = (List) arrayList2;
        Iterable<Method> iterable3 = this.f60080g;
        ...
        this.f60076c = (List) arrayList3;
        if (this.f60079f == CallMode.POSITIONAL_CALL && origin == Origin.JAVA && (!CollectionsKt.minus(this.f60078e, "value").isEmpty())) {
    ...
    public Object call(Object[] objArr) {
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (obj2 == null && this.f60079f == CallMode.CALL_BY_NAME) {
                obj = this.f60076c.get(i2);
            } else {
                obj = AnnotationConstructorCallerKt.m44470a(obj2, this.f60075b.get(i2));
            }
            if (obj != null) {
                arrayList.add(obj);
                i++;
                ...
                Void unused = AnnotationConstructorCallerKt.m44471a(i2, this.f60078e.get(i2), this.f60075b.get(i2));
                throw null;
            }
        }
        return AnnotationConstructorCallerKt.createAnnotationInstance(this.f60077d, MapsKt.toMap(CollectionsKt.zip(this.f60078e, (List) arrayList)), this.f60080g);
    }
}
