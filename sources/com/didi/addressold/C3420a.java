...
class C3420a implements IDidiAddressApi {

    /* renamed from: a */
    private GlobalSugFragment f7741a;
    ...
    public void selectAddress(Activity activity, int i, SugParams sugParams, GlobalSugCallback globalSugCallback) throws AddressException {
        m4925a(activity != null ? activity.getFragmentManager() : null, i, sugParams, globalSugCallback);
    }
    ...
    public void selectAddress(Fragment fragment, int i, SugParams sugParams, GlobalSugCallback globalSugCallback) throws AddressException {
        ...
        m4925a(fragmentManager, i, sugParams, globalSugCallback);
    }
    ...
    private void m4925a(android.app.FragmentManager r7, int r8, com.didi.address.model.SugParams r9, com.didi.address.GlobalSugCallback r10) {
        /*
            r6 = this;
            ...
            r6.f7741a = r9
            r9.mo39506a((com.didi.address.GlobalSugCallback) r10)
            r6.m4923a(r7)
            java.lang.Class<com.didi.address.IDidiAddressApi> r9 = com.didi.address.IDidiAddressApi.class
            monitor-enter(r9)
            r6.m4924a(r7, r8)     // Catch:{ Exception -> 0x001c }
            goto L_0x006f
        L_0x001a:
            r7 = move-exception
            goto L_0x0071
        L_0x001c:
            r6.m4924a(r7, r8)     // Catch:{ Exception -> 0x0020 }
            goto L_0x006f
        L_0x0020:
        ...
        L_0x0066:
            ...
            goto L_0x0044
        L_0x006c:
            r6.m4924a(r7, r8)     // Catch:{ all -> 0x001a }
        L_0x006f:
        ...
        L_0x0071:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.addressold.C3420a.m4925a(android.app.FragmentManager, int, com.didi.address.model.SugParams, com.didi.address.GlobalSugCallback):void");
    }

    /* renamed from: a */
    private void m4924a(FragmentManager fragmentManager, int i) {
        if (fragmentManager != null) {
            FragmentTransaction beginTransaction = fragmentManager.beginTransaction();
            beginTransaction.add(i, this.f7741a);
    ...
    /* renamed from: a */
    private void m4923a(FragmentManager fragmentManager) {
        if (fragmentManager != null) {
    ...
    public void setSugControlCallback(ISugControlCallback iSugControlCallback) {
        GlobalSugFragment globalSugFragment = this.f7741a;
    ...
    public boolean onBackPressed() {
        ...
        synchronized (IDidiAddressApi.class) {
            z = this.f7741a != null && this.f7741a.onBackPressed();
        }
        return z;
    }
