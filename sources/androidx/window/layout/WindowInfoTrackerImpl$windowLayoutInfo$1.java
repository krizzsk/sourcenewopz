...
@Metadata(mo175977d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H@"}, mo175978d2 = {"<anonymous>", "", "Lkotlinx/coroutines/flow/FlowCollector;", "Landroidx/window/layout/WindowLayoutInfo;"}, mo175979k = 3, mo175980mv = {1, 5, 1}, mo175982xi = 48)
@DebugMetadata(mo176686c = "androidx.window.layout.WindowInfoTrackerImpl$windowLayoutInfo$1", mo176687f = "WindowInfoTrackerImpl.kt", mo176688i = {0, 0, 1, 1}, mo176689l = {54, 55}, mo176690m = "invokeSuspend", mo176691n = {"$this$flow", "listener", "$this$flow", "listener"}, mo176692s = {"L$0", "L$1", "L$0", "L$1"})
...
final class WindowInfoTrackerImpl$windowLayoutInfo$1 extends SuspendLambda implements Function2<FlowCollector<? super WindowLayoutInfo>, Continuation<? super Unit>, Object> {
    ...
    public static final void m46119invokeSuspend$lambda0(Channel channel, WindowLayoutInfo windowLayoutInfo) {
        Intrinsics.checkNotNullExpressionValue(windowLayoutInfo, "info");
        channel.m48275trySendJP2dKIU(windowLayoutInfo);
    }
}
