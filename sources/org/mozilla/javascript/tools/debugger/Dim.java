...
public class Dim {
    ...
    /* renamed from: GO */
    public static final int f6660GO = 3;
    ...
    public Object getObjectProperty(Object obj, Object obj2) {
        ...
        Object unused = dimIProxy.object = obj;
        Object unused2 = dimIProxy.f6661id = obj2;
        dimIProxy.withContext();
    ...
    private static class DimIProxy implements ContextAction, ContextFactory.Listener, Debugger {
        ...
        public Object run(Context context) {
            switch (this.type) {
                ...
                case 6:
                    this.objectResult = this.dim.getObjectPropertyImpl(context, this.object, this.f6661id);
                    break;
                case 7:
