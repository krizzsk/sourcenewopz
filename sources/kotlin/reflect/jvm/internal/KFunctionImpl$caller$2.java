...
@Metadata(mo175977d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u0012\u0012\u0002\b\u0003 \u0002*\b\u0012\u0002\b\u0003\u0018\u00010\u00010\u0001H\n¢\u0006\u0002\b\u0003"}, mo175978d2 = {"<anonymous>", "Lkotlin/reflect/jvm/internal/calls/Caller;", "kotlin.jvm.PlatformType", "invoke"}, mo175979k = 3, mo175980mv = {1, 5, 1})
...
final class KFunctionImpl$caller$2 extends Lambda implements Function0<Caller<? extends Member>> {
    ...
    public final Caller<Member> invoke() {
        ...
        if (member instanceof Constructor) {
            ...
            callerImpl = kFunctionImpl.m44442a((Constructor) member, kFunctionImpl.getDescriptor());
        } else if (member instanceof Method) {
            Method method3 = (Method) member;
            if (!Modifier.isStatic(method3.getModifiers())) {
                method = this.this$0.m44444c(method3);
            } else if (this.this$0.getDescriptor().getAnnotations().findAnnotation(UtilKt.getJVM_STATIC()) != null) {
                method = this.this$0.m44443b(method3);
            } else {
                method = this.this$0.m44441a(method3);
            }
            callerImpl = method;
        } else {
