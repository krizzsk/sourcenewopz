...
public final class Descriptors {
        ...
        private FileDescriptor(DescriptorProtos.FileDescriptorProto fileDescriptorProto, FileDescriptor[] fileDescriptorArr, DescriptorPool descriptorPool, boolean z) throws DescriptorValidationException {
            ...
            for (int i = 0; i < fileDescriptorProto.getPublicDependencyCount(); i++) {
                ...
                if (publicDependency < 0 || publicDependency >= fileDescriptorProto.getDependencyCount()) {
                    throw new DescriptorValidationException(this, "Invalid public dependency index.", (C196301) null);
                }
                ...
                if (fileDescriptor2 != null) {
                    ...
                    throw new DescriptorValidationException(this, "Invalid public dependency: " + dependency, (C196301) null);
                }
            }
            ...
            for (int i2 = 0; i2 < fileDescriptorProto.getMessageTypeCount(); i2++) {
                this.messageTypes[i2] = new Descriptor(fileDescriptorProto.getMessageType(i2), this, (Descriptor) null, i2, (C196301) null);
            }
            this.enumTypes = new EnumDescriptor[fileDescriptorProto.getEnumTypeCount()];
            for (int i3 = 0; i3 < fileDescriptorProto.getEnumTypeCount(); i3++) {
                this.enumTypes[i3] = new EnumDescriptor(fileDescriptorProto.getEnumType(i3), this, (Descriptor) null, i3, (C196301) null);
            }
            this.services = new ServiceDescriptor[fileDescriptorProto.getServiceCount()];
            for (int i4 = 0; i4 < fileDescriptorProto.getServiceCount(); i4++) {
                this.services[i4] = new ServiceDescriptor(fileDescriptorProto.getService(i4), this, i4, (C196301) null);
            }
            this.extensions = new FieldDescriptor[fileDescriptorProto.getExtensionCount()];
            for (int i5 = 0; i5 < fileDescriptorProto.getExtensionCount(); i5++) {
                this.extensions[i5] = new FieldDescriptor(fileDescriptorProto.getExtension(i5), this, (Descriptor) null, i5, true, (C196301) null);
            }
        }
    ...
    public static final class Descriptor extends GenericDescriptor {
        ...
        /* synthetic */ Descriptor(DescriptorProtos.DescriptorProto descriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i, C196301 r5) throws DescriptorValidationException {
        ...
        private Descriptor(DescriptorProtos.DescriptorProto descriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i) throws DescriptorValidationException {
            ...
            for (int i2 = 0; i2 < descriptorProto.getOneofDeclCount(); i2++) {
                this.oneofs[i2] = new OneofDescriptor(descriptorProto.getOneofDecl(i2), fileDescriptor, this, i2, (C196301) null);
            }
            ...
            for (int i4 = 0; i4 < descriptorProto.getEnumTypeCount(); i4++) {
                this.enumTypes[i4] = new EnumDescriptor(descriptorProto.getEnumType(i4), fileDescriptor, this, i4, (C196301) null);
            }
            this.fields = new FieldDescriptor[descriptorProto.getFieldCount()];
            for (int i5 = 0; i5 < descriptorProto.getFieldCount(); i5++) {
                this.fields[i5] = new FieldDescriptor(descriptorProto.getField(i5), fileDescriptor, this, i5, false, (C196301) null);
            }
            this.extensions = new FieldDescriptor[descriptorProto.getExtensionCount()];
            for (int i6 = 0; i6 < descriptorProto.getExtensionCount(); i6++) {
                this.extensions[i6] = new FieldDescriptor(descriptorProto.getExtension(i6), fileDescriptor, this, i6, true, (C196301) null);
            }
    ...
    public static final class FieldDescriptor extends GenericDescriptor implements FieldSet.FieldDescriptorLite<FieldDescriptor>, Comparable<FieldDescriptor> {
        ...
        /* synthetic */ FieldDescriptor(DescriptorProtos.FieldDescriptorProto fieldDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i, boolean z, C196301 r6) throws DescriptorValidationException {
                ...
                if (z) {
                    if (fieldDescriptorProto.hasExtendee()) {
                        ...
                        if (!fieldDescriptorProto.hasOneofIndex()) {
                            ...
                            throw new DescriptorValidationException((GenericDescriptor) this, "FieldDescriptorProto.oneof_index set for extension field.", (C196301) null);
                        }
                    } else {
                        throw new DescriptorValidationException((GenericDescriptor) this, "FieldDescriptorProto.extendee not set for extension field.", (C196301) null);
                    }
                    ...
                    if (!fieldDescriptorProto.hasOneofIndex()) {
                        ...
                        throw new DescriptorValidationException((GenericDescriptor) this, "FieldDescriptorProto.oneof_index is out of range for type " + descriptor.getName(), (C196301) null);
                    } else {
                    ...
                    throw new DescriptorValidationException((GenericDescriptor) this, "FieldDescriptorProto.extendee set for non-extension field.", (C196301) null);
                }
                fileDescriptor.pool.addSymbol(this);
                return;
            }
            throw new DescriptorValidationException((GenericDescriptor) this, "Field numbers must be positive integers.", (C196301) null);
        }
            ...
            if (this.proto.hasExtendee()) {
                ...
                if (lookupSymbol instanceof Descriptor) {
                    ...
                    if (!getContainingType().isExtensionNumber(getNumber())) {
                        throw new DescriptorValidationException((GenericDescriptor) this, Typography.quote + getContainingType().getFullName() + "\" does not declare " + getNumber() + " as an extension number.", (C196301) null);
                    }
                } else {
                    throw new DescriptorValidationException((GenericDescriptor) this, Typography.quote + this.proto.getExtendee() + "\" is not a message type.", (C196301) null);
                }
            }
            if (this.proto.hasTypeName()) {
                ...
                if (!this.proto.hasType()) {
                    if (lookupSymbol2 instanceof Descriptor) {
                        ...
                        throw new DescriptorValidationException((GenericDescriptor) this, Typography.quote + this.proto.getTypeName() + "\" is not a type.", (C196301) null);
                    }
                }
                if (getJavaType() == JavaType.MESSAGE) {
                    if (lookupSymbol2 instanceof Descriptor) {
                        ...
                        if (this.proto.hasDefaultValue()) {
                            throw new DescriptorValidationException((GenericDescriptor) this, "Messages can't have default values.", (C196301) null);
                        }
                    } else {
                        throw new DescriptorValidationException((GenericDescriptor) this, Typography.quote + this.proto.getTypeName() + "\" is not a message type.", (C196301) null);
                    }
                } else if (getJavaType() != JavaType.ENUM) {
                    throw new DescriptorValidationException((GenericDescriptor) this, "Field with primitive type has type_name.", (C196301) null);
                } else if (lookupSymbol2 instanceof EnumDescriptor) {
                    this.enumType = (EnumDescriptor) lookupSymbol2;
                } else {
                    throw new DescriptorValidationException((GenericDescriptor) this, Typography.quote + this.proto.getTypeName() + "\" is not an enum type.", (C196301) null);
                }
            } else if (getJavaType() == JavaType.MESSAGE || getJavaType() == JavaType.ENUM) {
                throw new DescriptorValidationException((GenericDescriptor) this, "Field with message or enum type missing type_name.", (C196301) null);
            }
            if (!this.proto.getOptions().getPacked() || isPackable()) {
                if (this.proto.hasDefaultValue()) {
                    if (!isRepeated()) {
                        try {
                            switch (C196301.$SwitchMap$com$google$protobuf$Descriptors$FieldDescriptor$Type[getType().ordinal()]) {
                                case 1:
                                case 2:
                                case 3:
                                ...
                                case 16:
                                    ...
                                    if (findValueByName != null) {
                                        ...
                                        throw new DescriptorValidationException((GenericDescriptor) this, "Unknown enum default value: \"" + this.proto.getDefaultValue() + Typography.quote, (C196301) null);
                                    }
                                case 17:
                                case 18:
                                    throw new DescriptorValidationException((GenericDescriptor) this, "Message type had default value.", (C196301) null);
                            }
                        } catch (TextFormat.InvalidEscapeSequenceException e) {
                            throw new DescriptorValidationException(this, "Couldn't parse default value: " + e.getMessage(), e, (C196301) null);
                        } catch (NumberFormatException e2) {
                            throw new DescriptorValidationException(this, "Could not parse default value: \"" + this.proto.getDefaultValue() + Typography.quote, e2, (C196301) null);
                        }
                    } else {
                        throw new DescriptorValidationException((GenericDescriptor) this, "Repeated fields cannot have default values.", (C196301) null);
                    }
                } else if (isRepeated()) {
                    this.defaultValue = Collections.emptyList();
                } else {
                    int i = C196301.f53810xdde82548[getJavaType().ordinal()];
                    if (i == 1) {
                ...
                if (descriptor != null && descriptor.getOptions().getMessageSetWireFormat()) {
                    if (!isExtension()) {
                        throw new DescriptorValidationException((GenericDescriptor) this, "MessageSets cannot have fields, only extensions.", (C196301) null);
                    } else if (!isOptional() || getType() != Type.MESSAGE) {
                        throw new DescriptorValidationException((GenericDescriptor) this, "Extensions of MessageSets must be optional messages.", (C196301) null);
                    }
                }
            } else {
                throw new DescriptorValidationException((GenericDescriptor) this, "[packed = true] can only be specified for repeated primitive fields.", (C196301) null);
            }
        }
    ...
    static /* synthetic */ class C196301 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f53810xdde82548     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x00f3:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.Descriptors.C196301.<clinit>():void");
        }
    }
    ...
    public static final class EnumDescriptor extends GenericDescriptor implements Internal.EnumLiteMap<EnumValueDescriptor> {
        ...
        /* synthetic */ EnumDescriptor(DescriptorProtos.EnumDescriptorProto enumDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i, C196301 r5) throws DescriptorValidationException {
        ...
        public com.google.protobuf.Descriptors.EnumValueDescriptor findValueByNumberCreatingIfUnknown(int r4) {
            ...
            L_0x001e:
                ...
                r2 = 0
                r0.<init>((com.google.protobuf.Descriptors.FileDescriptor) r4, (com.google.protobuf.Descriptors.EnumDescriptor) r3, (java.lang.Integer) r1, (com.google.protobuf.Descriptors.C196301) r2)     // Catch:{ all -> 0x0034 }
                java.util.WeakHashMap<java.lang.Integer, java.lang.ref.WeakReference<com.google.protobuf.Descriptors$EnumValueDescriptor>> r4 = r3.unknownValues     // Catch:{ all -> 0x0034 }
        ...
        private EnumDescriptor(DescriptorProtos.EnumDescriptorProto enumDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i) throws DescriptorValidationException {
            ...
            if (enumDescriptorProto.getValueCount() != 0) {
                ...
                for (int i2 = 0; i2 < enumDescriptorProto.getValueCount(); i2++) {
                    this.values[i2] = new EnumValueDescriptor(enumDescriptorProto.getValue(i2), fileDescriptor, this, i2, (C196301) null);
                }
                fileDescriptor.pool.addSymbol(this);
                return;
            }
            throw new DescriptorValidationException((GenericDescriptor) this, "Enums must contain at least one value.", (C196301) null);
        }
    ...
    public static final class EnumValueDescriptor extends GenericDescriptor implements Internal.EnumLite {
        ...
        /* synthetic */ EnumValueDescriptor(DescriptorProtos.EnumValueDescriptorProto enumValueDescriptorProto, FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, int i, C196301 r5) throws DescriptorValidationException {
            this(enumValueDescriptorProto, fileDescriptor, enumDescriptor, i);
        }

        /* synthetic */ EnumValueDescriptor(FileDescriptor fileDescriptor, EnumDescriptor enumDescriptor, Integer num, C196301 r4) {
    ...
    public static final class ServiceDescriptor extends GenericDescriptor {
        ...
        /* synthetic */ ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto, FileDescriptor fileDescriptor, int i, C196301 r4) throws DescriptorValidationException {
        ...
        private ServiceDescriptor(DescriptorProtos.ServiceDescriptorProto serviceDescriptorProto, FileDescriptor fileDescriptor, int i) throws DescriptorValidationException {
            ...
            for (int i2 = 0; i2 < serviceDescriptorProto.getMethodCount(); i2++) {
                this.methods[i2] = new MethodDescriptor(serviceDescriptorProto.getMethod(i2), fileDescriptor, this, i2, (C196301) null);
            }
            fileDescriptor.pool.addSymbol(this);
        }
    ...
    public static final class MethodDescriptor extends GenericDescriptor {
        ...
        /* synthetic */ MethodDescriptor(DescriptorProtos.MethodDescriptorProto methodDescriptorProto, FileDescriptor fileDescriptor, ServiceDescriptor serviceDescriptor, int i, C196301 r5) throws DescriptorValidationException {
        ...
        public void crossLink() throws DescriptorValidationException {
            ...
            if (lookupSymbol instanceof Descriptor) {
                ...
                throw new DescriptorValidationException((GenericDescriptor) this, Typography.quote + this.proto.getOutputType() + "\" is not a message type.", (C196301) null);
            }
            throw new DescriptorValidationException((GenericDescriptor) this, Typography.quote + this.proto.getInputType() + "\" is not a message type.", (C196301) null);
        }
    ...
    public static class DescriptorValidationException extends Exception {
        ...
        /* synthetic */ DescriptorValidationException(FileDescriptor fileDescriptor, String str, C196301 r3) {
            this(fileDescriptor, str);
        }

        /* synthetic */ DescriptorValidationException(GenericDescriptor genericDescriptor, String str, C196301 r3) {
            this(genericDescriptor, str);
        }

        /* synthetic */ DescriptorValidationException(GenericDescriptor genericDescriptor, String str, Throwable th, C196301 r4) {
    ...
    private static final class DescriptorPool {
        ...
        public GenericDescriptor lookupSymbol(String str, GenericDescriptor genericDescriptor, SearchFilter searchFilter) throws DescriptorValidationException {
            ...
            if (!this.allowUnknownDependencies || searchFilter != SearchFilter.TYPES_ONLY) {
                throw new DescriptorValidationException(genericDescriptor, Typography.quote + str + "\" is not defined.", (C196301) null);
            }
            Logger access$100 = Descriptors.logger;
        ...
        public void addSymbol(GenericDescriptor genericDescriptor) throws DescriptorValidationException {
            ...
            if (put != null) {
                ...
                if (genericDescriptor.getFile() != put.getFile()) {
                    throw new DescriptorValidationException(genericDescriptor, Typography.quote + fullName + "\" is already defined in file \"" + put.getFile().getName() + "\".", (C196301) null);
                } else if (lastIndexOf == -1) {
                    throw new DescriptorValidationException(genericDescriptor, Typography.quote + fullName + "\" is already defined.", (C196301) null);
                } else {
                    throw new DescriptorValidationException(genericDescriptor, Typography.quote + fullName.substring(lastIndexOf + 1) + "\" is already defined in \"" + fullName.substring(0, lastIndexOf) + "\".", (C196301) null);
                }
            }
        }
        ...
        public void addPackage(String str, FileDescriptor fileDescriptor) throws DescriptorValidationException {
            ...
            if (put != null) {
                ...
                if (!(put instanceof PackageDescriptor)) {
                    throw new DescriptorValidationException(fileDescriptor, Typography.quote + str2 + "\" is already defined (as something other than a " + "package) in file \"" + put.getFile().getName() + "\".", (C196301) null);
                }
            }
        }
        ...
        public void addFieldByNumber(FieldDescriptor fieldDescriptor) throws DescriptorValidationException {
            ...
            if (put != null) {
                ...
                throw new DescriptorValidationException((GenericDescriptor) fieldDescriptor, "Field number " + fieldDescriptor.getNumber() + " has already been used in \"" + fieldDescriptor.getContainingType().getFullName() + "\" by field \"" + put.getName() + "\".", (C196301) null);
            }
        }
        ...
        static void validateSymbolName(GenericDescriptor genericDescriptor) throws DescriptorValidationException {
            ...
            if (name.length() != 0) {
                ...
                if (!z) {
                    throw new DescriptorValidationException(genericDescriptor, Typography.quote + name + "\" is not a valid identifier.", (C196301) null);
                }
                return;
            }
            throw new DescriptorValidationException(genericDescriptor, "Missing name.", (C196301) null);
        }
    }
    ...
    public static final class OneofDescriptor {
        ...
        /* synthetic */ OneofDescriptor(DescriptorProtos.OneofDescriptorProto oneofDescriptorProto, FileDescriptor fileDescriptor, Descriptor descriptor, int i, C196301 r5) throws DescriptorValidationException {
