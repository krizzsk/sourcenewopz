...
public class LocationProvider implements ISfLocationService {
                ...
                if (presenter == null || !(presenter instanceof AbsSafeToolkitPresenter) || (componentParams = ((AbsSafeToolkitPresenter) presenter).getComponentParams()) != null) {
                    ...
                    instance.requestLocationUpdateOnce(context, new LocationController.OneCarLocationListener() {
                        ...
                        public void onLocationChanged(DIDILocation dIDILocation) {
                            SfLocation a = LocationProvider.this.m11110a(dIDILocation);
                            ComponentParams componentParams = componentParams;
                            if (componentParams != null) {
                                LocationProvider.this.m11111a(context, a, dIDILocation, componentParams, sfCallback);
                            }
                        }
    ...
    /* renamed from: a */
    public void m11111a(Context context, final SfLocation sfLocation, DIDILocation dIDILocation, ComponentParams componentParams, final ISfLocationService.SfCallback sfCallback) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public SfLocation m11110a(DIDILocation dIDILocation) {
