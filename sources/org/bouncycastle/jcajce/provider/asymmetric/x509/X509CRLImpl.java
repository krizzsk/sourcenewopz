...
abstract class X509CRLImpl extends X509CRL {
    ...
    /* renamed from: c */
    protected CertificateList f6241c;
    ...
    private void checkSignature(PublicKey publicKey, Signature signature, ASN1Encodable aSN1Encodable, byte[] bArr) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CRLException {
        ...
        try {
            ...
            this.f6241c.getTBSCertList().encodeTo(bufferedOutputStream, ASN1Encoding.DER);
    ...
    private void doVerify(PublicKey publicKey, SignatureCreator signatureCreator) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException {
        ...
        if (this.f6241c.getSignatureAlgorithm().equals(this.f6241c.getTBSCertList().getSignature())) {
            int i = 0;
            if ((publicKey instanceof CompositePublicKey) && X509SignatureUtil.isCompositeAlgorithm(this.f6241c.getSignatureAlgorithm())) {
                List<PublicKey> publicKeys = ((CompositePublicKey) publicKey).getPublicKeys();
                ASN1Sequence instance = ASN1Sequence.getInstance(this.f6241c.getSignatureAlgorithm().getParameters());
                ASN1Sequence instance2 = ASN1Sequence.getInstance(DERBitString.getInstance(this.f6241c.getSignature()).getBytes());
                boolean z = false;
            ...
            } else if (X509SignatureUtil.isCompositeAlgorithm(this.f6241c.getSignatureAlgorithm())) {
                ASN1Sequence instance4 = ASN1Sequence.getInstance(this.f6241c.getSignatureAlgorithm().getParameters());
                ASN1Sequence instance5 = ASN1Sequence.getInstance(DERBitString.getInstance(this.f6241c.getSignature()).getBytes());
                boolean z2 = false;
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f6241c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f6241c.getRevokedCertificateEnumeration();
    ...
    public byte[] getExtensionValue(String str) {
        ASN1OctetString extensionValue = getExtensionValue(this.f6241c, str);
        if (extensionValue == null) {
            return null;
        }
        try {
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f6241c.getIssuer().toASN1Primitive()));
    }

    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f6241c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        Time nextUpdate = this.f6241c.getNextUpdate();
        if (nextUpdate == null) {
            return null;
        }
    ...
    public String getSigAlgOID() {
        return this.f6241c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f6241c.getSignature().getOctets();
    }

    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f6241c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f6241c.getThisUpdate().getDate();
    }

    public int getVersion() {
        return this.f6241c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f6241c.getRevokedCertificateEnumeration();
            X500Name issuer = this.f6241c.getIssuer();
    ...
    public String toString() {
        ...
        Extensions extensions = this.f6241c.getTBSCertList().getExtensions();
        if (extensions != null) {
            Enumeration oids = extensions.oids();
