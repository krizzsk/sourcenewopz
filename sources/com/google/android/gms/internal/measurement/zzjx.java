        ...
        try {
            ...
            while (it.hasNext()) {
                try {
                    ...
                    logger.logp(level, "com.google.protobuf.GeneratedExtensionRegistryLoader", HotpatchStateConst.LOAD, valueOf.length() != 0 ? "Unable to load ".concat(valueOf) : new String("Unable to load "), serviceConfigurationError);
                }
            }
            if (arrayList.size() == 1) {
