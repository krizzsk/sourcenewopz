...
public final class ObservableGenerate<T, S> extends Observable<T> {
    ...
    /* renamed from: a */
    final Callable<S> f58836a;

    /* renamed from: b */
    final BiFunction<S, Emitter<T>, S> f58837b;

    /* renamed from: c */
    final Consumer<? super S> f58838c;

    public ObservableGenerate(Callable<S> callable, BiFunction<S, Emitter<T>, S> biFunction, Consumer<? super S> consumer) {
        this.f58836a = callable;
        this.f58837b = biFunction;
        this.f58838c = consumer;
    }

    public void subscribeActual(Observer<? super T> observer) {
        try {
            GeneratorDisposable generatorDisposable = new GeneratorDisposable(observer, this.f58837b, this.f58838c, this.f58836a.call());
