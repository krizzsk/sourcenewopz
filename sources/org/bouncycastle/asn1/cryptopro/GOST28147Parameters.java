...
public class GOST28147Parameters extends ASN1Object {
    ...
    public GOST28147Parameters(byte[] bArr, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        this.f5648iv = new DEROctetString(bArr);
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f5648iv.getOctets());
    }

    public ASN1Primitive toASN1Primitive() {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(2);
        aSN1EncodableVector.add(this.f5648iv);
