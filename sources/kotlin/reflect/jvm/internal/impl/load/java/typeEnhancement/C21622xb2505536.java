...
final class C21622xb2505536 extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFConsumer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C21622xb2505536(String str) {
        super(1);
        this.$JFConsumer = str;
    }
    ...
    public final void invoke(SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder functionEnhancementBuilder) {
        ...
        functionEnhancementBuilder.parameter(this.$JFConsumer, PredefinedEnhancementInfoKt.f60605b, PredefinedEnhancementInfoKt.f60606c);
    }
}
