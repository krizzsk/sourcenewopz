...
import net.lingala.zip4j.p067io.inputstream.NumberedSplitInputStream;
import net.lingala.zip4j.p067io.inputstream.SplitInputStream;
import net.lingala.zip4j.p067io.inputstream.ZipStandardSplitInputStream;

public class UnzipUtil {
    /* JADX WARNING: Removed duplicated region for block: B:12:0x0021  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static net.lingala.zip4j.p067io.inputstream.ZipInputStream createZipInputStream(net.lingala.zip4j.model.ZipModel r1, net.lingala.zip4j.model.FileHeader r2, char[] r3) throws java.io.IOException {
        /*
