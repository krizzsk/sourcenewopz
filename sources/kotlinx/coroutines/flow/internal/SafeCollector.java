...
public final class SafeCollector<T> extends ContinuationImpl implements CoroutineStackFrame, FlowCollector<T> {
    ...
    public SafeCollector(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext) {
        super(C21952c.f61487a, EmptyCoroutineContext.INSTANCE);
    ...
    private final Object emit(Continuation<? super Unit> continuation, T t) {
        ...
        return SafeCollectorKt.f61485a.invoke(this.collector, t, this);
    }
    ...
    private final void exceptionTransparencyViolated(DownstreamExceptionElement downstreamExceptionElement, Object obj) {
        throw new IllegalStateException(StringsKt.trimIndent("\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + downstreamExceptionElement.f61484e + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ").toString());
    }
}
