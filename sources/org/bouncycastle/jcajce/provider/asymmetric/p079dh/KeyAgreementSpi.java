...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public byte[] bigIntToBytes(BigInteger bigInteger) {
        int bitLength = (this.f6226p.bitLength() + 7) / 8;
    ...
    public Key engineDoPhase(Key key, boolean z) throws InvalidKeyException, IllegalStateException {
        if (this.f6227x == null) {
            ...
            if (!dHPublicKey.getParams().getG().equals(this.f6225g) || !dHPublicKey.getParams().getP().equals(this.f6226p)) {
                throw new InvalidKeyException("DHPublicKey not for this KeyAgreement!");
            }
            BigInteger y = dHPublicKey.getY();
            if (y == null || y.compareTo(TWO) < 0 || y.compareTo(this.f6226p.subtract(ONE)) >= 0) {
                ...
                BigInteger modPow = y.modPow(this.f6227x, this.f6226p);
    ...
    public void engineInit(Key key, SecureRandom secureRandom) throws InvalidKeyException {
        if (key instanceof DHPrivateKey) {
            ...
            this.f6226p = dHPrivateKey.getParams().getP();
            this.f6225g = dHPrivateKey.getParams().getG();
    ...
    public void engineInit(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (key instanceof DHPrivateKey) {
            ...
            if (algorithmParameterSpec == null) {
                ...
                this.f6226p = dHParameterSpec.getP();
                this.f6225g = dHParameterSpec.getG();
