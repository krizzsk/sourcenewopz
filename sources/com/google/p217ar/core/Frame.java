...
public class Frame {
    ...
    public <T extends Trackable> Collection<T> getUpdatedTrackables(Class<T> cls) {
        Session.C18634c a = Session.C18634c.m38270a(cls);
        if (a == Session.C18634c.UNKNOWN_TO_JAVA) {
            return Collections.emptyList();
        }
        return this.session.convertNativeTrackablesToCollection(cls, nativeAcquireUpdatedTrackables(this.session.nativeWrapperHandle, this.nativeHandle, a.f53493b));
    }
