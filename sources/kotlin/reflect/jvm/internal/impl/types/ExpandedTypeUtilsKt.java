...
public final class ExpandedTypeUtilsKt {
    public static final KotlinTypeMarker computeExpandedTypeForInlineClass(TypeSystemCommonBackendContext typeSystemCommonBackendContext, KotlinTypeMarker kotlinTypeMarker) {
        ...
        return m45034a(typeSystemCommonBackendContext, kotlinTypeMarker, new HashSet());
    }

    /* renamed from: a */
    private static final KotlinTypeMarker m45034a(TypeSystemCommonBackendContext typeSystemCommonBackendContext, KotlinTypeMarker kotlinTypeMarker, HashSet<TypeConstructorMarker> hashSet) {
        ...
        if (typeParameterClassifier != null) {
            kotlinTypeMarker2 = m45034a(typeSystemCommonBackendContext, typeSystemCommonBackendContext.getRepresentativeUpperBound(typeParameterClassifier), hashSet);
            ...
            if (substitutedUnderlyingType == null || (kotlinTypeMarker2 = m45034a(typeSystemCommonBackendContext, substitutedUnderlyingType, hashSet)) == null) {
                return null;
            }
