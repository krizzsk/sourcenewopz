...
public final class ObservableConcatMapMaybe<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    final Observable<T> f58683a;

    /* renamed from: b */
    final Function<? super T, ? extends MaybeSource<? extends R>> f58684b;

    /* renamed from: c */
    final ErrorMode f58685c;
    ...
    public ObservableConcatMapMaybe(Observable<T> observable, Function<? super T, ? extends MaybeSource<? extends R>> function, ErrorMode errorMode, int i) {
        this.f58683a = observable;
        this.f58684b = function;
        this.f58685c = errorMode;
        this.f58686d = i;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        if (!C21210a.m41820a((Object) this.f58683a, this.f58684b, observer)) {
            this.f58683a.subscribe(new ConcatMapMaybeMainObserver(observer, this.f58684b, this.f58686d, this.f58685c));
        }
    }
