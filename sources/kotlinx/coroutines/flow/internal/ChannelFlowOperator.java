...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    /* renamed from: a */
    public final Object m45777a(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext, Continuation<? super Unit> continuation) {
        Object withContextUndispatched$default = ChannelFlowKt.withContextUndispatched$default(coroutineContext, ChannelFlowKt.m45776a(flowCollector, continuation.getContext()), (Object) null, new ChannelFlowOperator$collectWithContextUndispatched$2(this, (Continuation<? super ChannelFlowOperator$collectWithContextUndispatched$2>) null), continuation, 4, (Object) null);
        return withContextUndispatched$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? withContextUndispatched$default : Unit.INSTANCE;
    }

    /* renamed from: a */
    static /* synthetic */ Object m45778a(ChannelFlowOperator channelFlowOperator, ProducerScope producerScope, Continuation continuation) {
    ...
    /* renamed from: a */
    static /* synthetic */ Object m45779a(ChannelFlowOperator channelFlowOperator, FlowCollector flowCollector, Continuation continuation) {
        if (channelFlowOperator.capacity == -3) {
            ...
            if (Intrinsics.areEqual((Object) plus, (Object) context)) {
                ...
                Object a = channelFlowOperator.m45777a(flowCollector, plus, (Continuation<? super Unit>) continuation);
