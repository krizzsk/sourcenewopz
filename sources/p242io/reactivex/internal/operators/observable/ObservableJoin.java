...
public final class ObservableJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends C21211a<TLeft, R> {

    /* renamed from: a */
    final ObservableSource<? extends TRight> f58859a;

    /* renamed from: b */
    final Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> f58860b;

    /* renamed from: c */
    final Function<? super TRight, ? extends ObservableSource<TRightEnd>> f58861c;

    /* renamed from: d */
    final BiFunction<? super TLeft, ? super TRight, ? extends R> f58862d;

    public ObservableJoin(ObservableSource<TLeft> observableSource, ObservableSource<? extends TRight> observableSource2, Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> function, Function<? super TRight, ? extends ObservableSource<TRightEnd>> function2, BiFunction<? super TLeft, ? super TRight, ? extends R> biFunction) {
        super(observableSource);
        this.f58859a = observableSource2;
        this.f58860b = function;
        this.f58861c = function2;
        this.f58862d = biFunction;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        JoinDisposable joinDisposable = new JoinDisposable(observer, this.f58860b, this.f58861c, this.f58862d);
        ...
        this.f58859a.subscribe(leftRightObserver2);
    }
