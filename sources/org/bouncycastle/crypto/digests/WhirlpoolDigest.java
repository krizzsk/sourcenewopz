...
public final class WhirlpoolDigest implements ExtendedDigest, Memoable {
    ...
    /* renamed from: C0 */
    private static final long[] f5895C0 = new long[256];

    /* renamed from: C1 */
    private static final long[] f5896C1 = new long[256];

    /* renamed from: C2 */
    private static final long[] f5897C2 = new long[256];

    /* renamed from: C3 */
    private static final long[] f5898C3 = new long[256];

    /* renamed from: C4 */
    private static final long[] f5899C4 = new long[256];

    /* renamed from: C5 */
    private static final long[] f5900C5 = new long[256];

    /* renamed from: C6 */
    private static final long[] f5901C6 = new long[256];

    /* renamed from: C7 */
    private static final long[] f5902C7 = new long[256];
    ...
    /* renamed from: _K */
    private long[] f5903_K = new long[8];

    /* renamed from: _L */
    private long[] f5904_L = new long[8];
    ...
    public WhirlpoolDigest() {
        for (int i = 0; i < 256; i++) {
            ...
            int i5 = i2;
            f5895C0[i] = packIntoLong(i2, i5, maskWithReductionPolynomial2, i2, maskWithReductionPolynomial3, i3, maskWithReductionPolynomial, i4);
            int i6 = i2;
            f5896C1[i] = packIntoLong(i4, i5, i6, maskWithReductionPolynomial2, i2, maskWithReductionPolynomial3, i3, maskWithReductionPolynomial);
            int i7 = i2;
            f5897C2[i] = packIntoLong(maskWithReductionPolynomial, i4, i6, i7, maskWithReductionPolynomial2, i2, maskWithReductionPolynomial3, i3);
            int i8 = i2;
            f5898C3[i] = packIntoLong(i3, maskWithReductionPolynomial, i4, i7, i8, maskWithReductionPolynomial2, i2, maskWithReductionPolynomial3);
            int i9 = i2;
            f5899C4[i] = packIntoLong(maskWithReductionPolynomial3, i3, maskWithReductionPolynomial, i4, i8, i9, maskWithReductionPolynomial2, i2);
            int i10 = i2;
            f5900C5[i] = packIntoLong(i2, maskWithReductionPolynomial3, i3, maskWithReductionPolynomial, i4, i9, i10, maskWithReductionPolynomial2);
            int i11 = i2;
            f5901C6[i] = packIntoLong(maskWithReductionPolynomial2, i2, maskWithReductionPolynomial3, i3, maskWithReductionPolynomial, i4, i10, i11);
            f5902C7[i] = packIntoLong(i2, maskWithReductionPolynomial2, i2, maskWithReductionPolynomial3, i3, maskWithReductionPolynomial, i4, i11);
        }
        this._rc[0] = 0;
        for (int i12 = 1; i12 <= 10; i12++) {
            int i13 = (i12 - 1) * 8;
            this._rc[i12] = (((((((f5895C0[i13] & -72057594037927936L) ^ (f5896C1[i13 + 1] & 71776119061217280L)) ^ (f5897C2[i13 + 2] & 280375465082880L)) ^ (f5898C3[i13 + 3] & 1095216660480L)) ^ (f5899C4[i13 + 4] & 4278190080L)) ^ (f5900C5[i13 + 5] & 16711680)) ^ (f5901C6[i13 + 6] & 65280)) ^ (f5902C7[i13 + 7] & 255);
        }
    }
    ...
    public void processBlock() {
        ...
        while (i2 <= 10) {
            int i3 = 0;
            while (i3 < 8) {
                long[] jArr4 = this.f5904_L;
                jArr4[i3] = 0;
                long j3 = jArr4[i3];
                long[] jArr5 = f5895C0;
                long[] jArr6 = this.f5903_K;
                jArr4[i3] = jArr5[((int) (jArr6[(i3 + 0) & 7] >>> 56)) & 255] ^ j3;
                jArr4[i3] = jArr4[i3] ^ f5896C1[((int) (jArr6[(i3 - 1) & 7] >>> 48)) & 255];
                jArr4[i3] = jArr4[i3] ^ f5897C2[((int) (jArr6[(i3 - 2) & 7] >>> 40)) & 255];
                jArr4[i3] = jArr4[i3] ^ f5898C3[((int) (jArr6[(i3 - 3) & 7] >>> 32)) & 255];
                jArr4[i3] = jArr4[i3] ^ f5899C4[((int) (jArr6[(i3 - 4) & 7] >>> 24)) & 255];
                jArr4[i3] = jArr4[i3] ^ f5900C5[((int) (jArr6[(i3 - 5) & 7] >>> 16)) & 255];
                jArr4[i3] = jArr4[i3] ^ f5901C6[((int) (jArr6[(i3 - 6) & 7] >>> 8)) & 255];
                jArr4[i3] = jArr4[i3] ^ f5902C7[((int) jArr6[(i3 - 7) & 7]) & 255];
                i3++;
                i2 = i2;
            }
            int i4 = i2;
            long[] jArr7 = this.f5904_L;
            long[] jArr8 = this.f5903_K;
            System.arraycopy(jArr7, 0, jArr8, 0, jArr8.length);
            long[] jArr9 = this.f5903_K;
            ...
            while (true) {
                ...
                jArr[i5] = this.f5903_K[i5];
                long j4 = jArr[i5];
                long[] jArr10 = f5895C0;
                long[] jArr11 = this._state;
                jArr[i5] = j4 ^ jArr10[((int) (jArr11[(i5 + 0) & 7] >>> 56)) & 255];
                jArr[i5] = jArr[i5] ^ f5896C1[((int) (jArr11[(i5 - 1) & 7] >>> 48)) & 255];
                jArr[i5] = jArr[i5] ^ f5897C2[((int) (jArr11[(i5 - 2) & 7] >>> 40)) & 255];
                jArr[i5] = jArr[i5] ^ f5898C3[((int) (jArr11[(i5 - 3) & 7] >>> 32)) & 255];
                jArr[i5] = jArr[i5] ^ f5899C4[((int) (jArr11[(i5 - 4) & 7] >>> 24)) & 255];
                jArr[i5] = jArr[i5] ^ f5900C5[((int) (jArr11[(i5 - 5) & 7] >>> 16)) & 255];
                jArr[i5] = jArr[i5] ^ f5901C6[((int) (jArr11[(i5 - 6) & 7] >>> 8)) & 255];
                jArr[i5] = jArr[i5] ^ f5902C7[((int) jArr11[(i5 - 7) & 7]) & 255];
                i5++;
            }
    ...
    public void reset() {
        ...
        Arrays.fill(this.f5903_K, 0);
        Arrays.fill(this.f5904_L, 0);
    ...
    public void reset(Memoable memoable) {
        ...
        long[] jArr5 = whirlpoolDigest.f5903_K;
        long[] jArr6 = this.f5903_K;
        System.arraycopy(jArr5, 0, jArr6, 0, jArr6.length);
        long[] jArr7 = whirlpoolDigest.f5904_L;
        long[] jArr8 = this.f5904_L;
        System.arraycopy(jArr7, 0, jArr8, 0, jArr8.length);
