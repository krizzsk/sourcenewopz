...
public class BundleInfoDao {
    ...
    /* renamed from: a */
    private final FusionDbHelper f18351a;

    public BundleInfoDao(Context context) {
        this.f18351a = new FusionDbHelper(context);
    }

    public List<OfflineBundleInfo> loadAllBundleInfos() {
        ArrayList arrayList = new ArrayList();
        Cursor query = this.f18351a.getReadableDatabase().query(FusionContract.OfflineBundle.TABLE_NAME, new String[]{ShareDBHelper.ID_NAME, "bundle_name", FusionContract.OfflineBundle.COLUMN_NAME_ORIGIN_URL, "download_url", "version", "md5", "state", "download_mode"}, (String) null, (String[]) null, (String) null, (String) null, (String) null);
        if (query != null) {
            try {
                if (query.getCount() > 0) {
    ...
    public void addBundleInfo(OfflineBundleInfo offlineBundleInfo) {
        if (offlineBundleInfo != null) {
            SQLiteDatabase writableDatabase = this.f18351a.getWritableDatabase();
    ...
    public void deleteBundleInfo(OfflineBundleInfo offlineBundleInfo) {
        this.f18351a.getWritableDatabase().delete(FusionContract.OfflineBundle.TABLE_NAME, "bundle_name= ?", new String[]{offlineBundleInfo.getBundleName()});
    }
