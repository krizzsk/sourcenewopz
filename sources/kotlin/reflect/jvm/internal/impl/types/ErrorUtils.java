...
public class ErrorUtils {
    ...
    /* renamed from: a */
    private static final ModuleDescriptor f61102a = new ModuleDescriptor() {
    ...
    /* renamed from: b */
    private static final ErrorClassDescriptor f61103b = new ErrorClassDescriptor(Name.special("<ERROR CLASS>"));

    /* renamed from: c */
    private static final KotlinType f61104c = createErrorType("<ERROR PROPERTY TYPE>");

    /* renamed from: d */
    private static final PropertyDescriptor f61105d;
    /* access modifiers changed from: private */

    /* renamed from: e */
    public static final Set<PropertyDescriptor> f61106e;

    /* renamed from: a */
    private static /* synthetic */ void m45029a(int i) {
    ...
    static {
        PropertyDescriptorImpl b = m45032b();
        f61105d = b;
        f61106e = Collections.singleton(b);
    }
    ...
    public static class ErrorScope implements MemberScope {
        ...
        public Set<? extends PropertyDescriptor> getContributedVariables(Name name, LookupLocation lookupLocation) {
            ...
            Set<? extends PropertyDescriptor> a = ErrorUtils.f61106e;
            if (a == null) {
                $$$reportNull$$$0(7);
            }
            return a;
        ...
        public Set<? extends SimpleFunctionDescriptor> getContributedFunctions(Name name, LookupLocation lookupLocation) {
            ...
            Set<? extends SimpleFunctionDescriptor> singleton = Collections.singleton(ErrorUtils.m45031b(this));
            if (singleton == null) {
                $$$reportNull$$$0(10);
            }
            return singleton;
    ...
    private static class ErrorClassDescriptor extends ClassDescriptorImpl {
        ...
        public ErrorClassDescriptor(Name name) {
            ...
            create.setReturnType(new ErrorType(ErrorUtils.m45033b("<ERROR>", this), createErrorScope));
    ...
    /* renamed from: b */
    private static PropertyDescriptorImpl m45032b() {
        PropertyDescriptorImpl create = PropertyDescriptorImpl.create(f61103b, Annotations.Companion.getEMPTY(), Modality.OPEN, DescriptorVisibilities.PUBLIC, true, Name.special("<ERROR PROPERTY>"), CallableMemberDescriptor.Kind.DECLARATION, SourceElement.NO_SOURCE, false, false, false, false, false, false);
        create.setType(f61104c, Collections.emptyList(), (ReceiverParameterDescriptor) null, (ReceiverParameterDescriptor) null);
        if (create == null) {
            m45029a(4);
        }
        return create;
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public static SimpleFunctionDescriptor m45031b(ErrorScope errorScope) {
        if (errorScope == null) {
            m45029a(5);
        }
        ErrorSimpleFunctionDescriptorImpl errorSimpleFunctionDescriptorImpl = new ErrorSimpleFunctionDescriptorImpl(f61103b, errorScope);
    ...
    public static TypeConstructor createErrorTypeConstructor(String str) {
        ...
        return m45033b("[ERROR : " + str + Const.jaRight, f61103b);
    }
    ...
    public static TypeConstructor createErrorTypeConstructorWithCustomDebugName(String str) {
        ...
        return m45033b(str, f61103b);
    }

    /* access modifiers changed from: private */
    /* renamed from: b */
    public static TypeConstructor m45033b(final String str, final ErrorClassDescriptor errorClassDescriptor) {
        if (str == null) {
            m45029a(17);
        }
    ...
    public static boolean isError(DeclarationDescriptor declarationDescriptor) {
        ...
        return m45030a(declarationDescriptor) || m45030a(declarationDescriptor.getContainingDeclaration()) || declarationDescriptor == f61102a;
    }

    /* renamed from: a */
    private static boolean m45030a(DeclarationDescriptor declarationDescriptor) {
        return declarationDescriptor instanceof ErrorClassDescriptor;
    }

    public static ModuleDescriptor getErrorModule() {
        ModuleDescriptor moduleDescriptor = f61102a;
        if (moduleDescriptor == null) {
            m45029a(19);
        }
