...
public class PersistentInfoCollector {
    ...
    private static java.lang.String getSharedOmegaId() {
        ...
        L_0x0033:
            ...
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m34424w(r2)     // Catch:{ all -> 0x0057 }
        L_0x004b:
    ...
    public static Long getRecordSeq(String str) {
        ...
        try {
            ...
            OLog.m34418e("get record seq failed. " + e.getMessage());
        } catch (Throwable unused) {
        }
        return l;
    }
