...
public final class ThreadManager {
    ...
    /* renamed from: a */
    private static final String[] f25302a;

    /* renamed from: b */
    private static final Handler[] f25303b;
    /* access modifiers changed from: private */

    /* renamed from: c */
    public static final ConcurrentLinkedQueue<Runnable> f25304c = new ConcurrentLinkedQueue<>();

    /* renamed from: d */
    private static final MessageQueue.IdleHandler f25305d = new MessageQueue.IdleHandler() {
        public boolean queueIdle() {
            while (!ThreadManager.f25304c.isEmpty()) {
                Runnable runnable = (Runnable) ThreadManager.f25304c.poll();
                if (runnable != null) {
                    try {
                        runnable.run();
    ...
    static {
        ...
        f25302a = strArr;
        f25303b = new Handler[strArr.length];
    }
    ...
    /* renamed from: a */
    static void m18110a() {
        synchronized (f25303b) {
            f25303b[0] = new Handler(Looper.getMainLooper());
        }
    }
    ...
    public static void removeCallbacks(int i, Runnable runnable) {
        if (runnable != null && i < f25302a.length) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0023, code lost:
        r0 = new android.os.HandlerThread(f25302a[r3]);
        r0.setPriority(10);
        r0.start();
    ...
    public static android.os.Handler getHandler(int r3) {
        /*
            ...
            java.lang.String[] r0 = f25302a
            int r0 = r0.length
            if (r3 >= r0) goto L_0x0051
            android.os.Handler[] r0 = f25303b
            monitor-enter(r0)
            android.os.Handler[] r1 = f25303b     // Catch:{ all -> 0x004e }
        ...
        L_0x0023:
            ...
            r0 = r1
        L_0x003e:
            android.os.Handler[] r1 = f25303b
            monitor-enter(r1)
            android.os.Handler[] r2 = f25303b     // Catch:{ all -> 0x004b }
            r2[r3] = r0     // Catch:{ all -> 0x004b }
            android.os.Handler[] r0 = f25303b     // Catch:{ all -> 0x004b }
