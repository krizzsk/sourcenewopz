...
class ConfigurableNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    ConfigurableNetwork(NetworkBuilder<? super N, ? super E> networkBuilder) {
        this(networkBuilder, networkBuilder.nodeOrder.createMap(((Integer) networkBuilder.expectedNodeCount.mo149917or(10)).intValue()), networkBuilder.edgeOrder.createMap(networkBuilder.expectedEdgeCount.mo149917or(20).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E e) {
        ...
        return EndpointPair.m38473of((Network<?, ?>) this, checkedReferenceNode, this.nodeConnections.get(checkedReferenceNode).adjacentNode(e));
    }
