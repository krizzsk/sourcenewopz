...
public class FlutterShellArgs {
    ...
    public FlutterShellArgs(String[] strArr) {
        this.f57600a = new HashSet(Arrays.asList(strArr));
    }

    public FlutterShellArgs(List<String> list) {
        this.f57600a = new HashSet(list);
    }

    public FlutterShellArgs(Set<String> set) {
        this.f57600a = new HashSet(set);
    }

    public void add(String str) {
        this.f57600a.add(str);
    }

    public void remove(String str) {
        this.f57600a.remove(str);
    }

    public String[] toArray() {
        return (String[]) this.f57600a.toArray(new String[this.f57600a.size()]);
    }
}
