...
public class CustomerEditTextCompat extends EditTextCompat {
    public CustomerEditTextCompat(Context context) {
        ...
        m15070a(context, (AttributeSet) null);
    }
    ...
    /* renamed from: a */
    private void m15070a(Context context, AttributeSet attributeSet) {
        int i = -1;
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C10448R.styleable.EntregaAppCompatTextView);
