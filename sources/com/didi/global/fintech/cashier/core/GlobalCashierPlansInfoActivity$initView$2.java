...
final class GlobalCashierPlansInfoActivity$initView$2 extends Lambda implements Function1<View, Unit> {
    ...
    public final void invoke(View view) {
        ...
        globalCashierPlansInfoActivity.m15721a(4, globalCashierPlansInfoActivity.f21418g);
        ...
        intent.putExtra(GlobalCashierPlansInfoActivity.PARAM_INSTALLMENT_NUMBER, globalCashierPlansInfoActivity3.f21418g);
        intent.putExtra("card_index", globalCashierPlansInfoActivity3.f21419h);
