...
public final class ObservableCombineLatest<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    final ObservableSource<? extends T>[] f58758a;

    /* renamed from: b */
    final Iterable<? extends ObservableSource<? extends T>> f58759b;

    /* renamed from: c */
    final Function<? super Object[], ? extends R> f58760c;

    /* renamed from: d */
    final int f58761d;

    /* renamed from: e */
    final boolean f58762e;

    public ObservableCombineLatest(ObservableSource<? extends T>[] observableSourceArr, Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i, boolean z) {
        this.f58758a = observableSourceArr;
        this.f58759b = iterable;
        this.f58760c = function;
        this.f58761d = i;
        this.f58762e = z;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        int i;
        ObservableSource<? extends T>[] observableSourceArr = this.f58758a;
        if (observableSourceArr == null) {
            observableSourceArr = new Observable[8];
            i = 0;
            for (ObservableSource<? extends T> observableSource : this.f58759b) {
        ...
        new LatestCoordinator(observer, this.f58760c, i2, this.f58761d, this.f58762e).subscribe(observableSourceArr);
    }
    ...
    static final class LatestCoordinator<T, R> extends AtomicInteger implements Disposable {
        ...
        public void innerNext(int r4, T r5) {
            ...
            L_0x0029:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableCombineLatest.LatestCoordinator.innerNext(int, java.lang.Object):void");
        }
        ...
        public void innerError(int r3, java.lang.Throwable r4) {
            ...
            L_0x0032:
                ...
                goto L_0x0039
            L_0x0036:
                p242io.reactivex.plugins.RxJavaPlugins.onError(r4)
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableCombineLatest.LatestCoordinator.innerError(int, java.lang.Throwable):void");
        }
        ...
        public void innerComplete(int r4) {
            ...
            L_0x0025:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.observable.ObservableCombineLatest.LatestCoordinator.innerComplete(int):void");
        }
    }
