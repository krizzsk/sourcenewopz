...
public class FusionAsynDispatcher {
    ...
    /* renamed from: a */
    private final ScheduledExecutorService f18318a = Executors.newScheduledThreadPool(6, new DispatcherThreadFactory());

    public void asynRunTask(Runnable runnable) {
        this.f18318a.execute(runnable);
    }

    public void asynRunTask(Runnable runnable, long j, TimeUnit timeUnit) {
        this.f18318a.schedule(runnable, j, timeUnit);
    }
