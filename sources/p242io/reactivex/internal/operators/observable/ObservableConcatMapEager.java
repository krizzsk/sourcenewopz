...
import p242io.reactivex.internal.observers.InnerQueuedObserver;
import p242io.reactivex.internal.observers.InnerQueuedObserverSupport;
...
public final class ObservableConcatMapEager<T, R> extends C21211a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<? extends R>> f58766a;

    /* renamed from: b */
    final ErrorMode f58767b;
    ...
    public ObservableConcatMapEager(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<? extends R>> function, ErrorMode errorMode, int i, int i2) {
        ...
        this.f58766a = function;
        this.f58767b = errorMode;
        this.f58768c = i;
        this.f58769d = i2;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new ConcatMapEagerMainObserver(observer, this.f58766a, this.f58768c, this.f58769d, this.f58767b));
    }
