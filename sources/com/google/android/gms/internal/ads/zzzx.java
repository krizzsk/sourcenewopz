...
public final class zzzx extends ContentProvider {
                            ...
                            if (str == null || str.matches("^/\\d+~.+$")) {
                                if (bool == null || !bool.booleanValue()) {
                                    if (!TextUtils.isEmpty(str2)) {
                                        ...
                                        zzbao.zzdz(valueOf.length() != 0 ? "The Google Mobile Ads SDK is integrated by ".concat(valueOf) : new String("The Google Mobile Ads SDK is integrated by "));
                                    } else {
                                ...
                                zzbao.zzdz(valueOf2.length() != 0 ? "Publisher provided Google AdMob App ID in manifest: ".concat(valueOf2) : new String("Publisher provided Google AdMob App ID in manifest: "));
    ...
    private static Bundle getMetadata(Context context) {
        try {
            ...
            zzbao.zzc("Failed to load metadata: Null pointer exception.", e);
            return null;
