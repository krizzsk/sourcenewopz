package org.bouncycastle.jcajce.provider.asymmetric.p079dh;
...
import org.bouncycastle.asn1.p075x9.DomainParameters;
import org.bouncycastle.asn1.p075x9.ValidationParams;
...
public class BCDHPublicKey implements DHPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f6224y;

    BCDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f6224y = bigInteger;
    ...
    BCDHPublicKey(DHPublicKey dHPublicKey) {
        this.f6224y = dHPublicKey.getY();
        DHParameterSpec params = dHPublicKey.getParams();
        this.dhSpec = params;
        this.dhPublicKey = params instanceof DHDomainParameterSpec ? new DHPublicKeyParameters(this.f6224y, ((DHDomainParameterSpec) params).getDomainParameters()) : new DHPublicKeyParameters(this.f6224y, new DHParameters(params.getP(), this.dhSpec.getG()));
    }

    BCDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f6224y = dHPublicKeySpec.getY();
        ...
        if (dHParameterSpec instanceof DHDomainParameterSpec) {
            this.dhPublicKey = new DHPublicKeyParameters(this.f6224y, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters());
        } else {
            this.dhPublicKey = new DHPublicKeyParameters(this.f6224y, new DHParameters(dHPublicKeySpec.getP(), dHPublicKeySpec.getG()));
        }
    }
    ...
    public BCDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f6224y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
            ...
            if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement) || isPKCSParam(instance)) {
                ...
                if (instance2.getL() != null) {
                    ...
                    this.dhSpec = dHParameterSpec;
                    dHPublicKeyParameters = new DHPublicKeyParameters(this.f6224y, new DHParameters(dHParameterSpec.getP(), this.dhSpec.getG(), (BigInteger) null, this.dhSpec.getL()));
                } else {
                    DHParameterSpec dHParameterSpec2 = new DHParameterSpec(instance2.getP(), instance2.getG());
                    this.dhSpec = dHParameterSpec2;
                    dHPublicKeyParameters = new DHPublicKeyParameters(this.f6224y, new DHParameters(dHParameterSpec2.getP(), this.dhSpec.getG()));
                }
                ...
                if (validationParams != null) {
                    this.dhPublicKey = new DHPublicKeyParameters(this.f6224y, new DHParameters(instance3.getP(), instance3.getG(), instance3.getQ(), instance3.getJ(), new DHValidationParameters(validationParams.getSeed(), validationParams.getPgenCounter().intValue())));
                } else {
                    this.dhPublicKey = new DHPublicKeyParameters(this.f6224y, new DHParameters(instance3.getP(), instance3.getG(), instance3.getQ(), instance3.getJ(), (DHValidationParameters) null));
                }
    ...
    BCDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f6224y = dHPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        ...
        if (!(dHParameterSpec instanceof DHDomainParameterSpec) || ((DHDomainParameterSpec) dHParameterSpec).getQ() == null) {
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).toASN1Primitive()), (ASN1Encodable) new ASN1Integer(this.f6224y));
        }
        ...
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.dhpublicnumber, new DomainParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), validationParams).toASN1Primitive()), (ASN1Encodable) new ASN1Integer(this.f6224y));
    }
    ...
    public String toString() {
        return DHUtil.publicKeyToString("DH", this.f6224y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }
}
