...
public class EditFirstNameComponent extends AbsComponent<EditNameComponetView> {
    ...
    /* renamed from: b */
    public EditNameComponetView f37201b;
    ...
    public EditFirstNameComponent(BaseBusinessContext baseBusinessContext, SidebarItem sidebarItem, String str) {
        ...
        this.f37200a = baseBusinessContext.getContext();
    ...
    public EditNameComponetView createComponentView() {
        if (this.f37201b == null) {
            this.f37201b = new EditNameComponetView(this.businessContext.getContext());
        }
        return this.f37201b;
    }
    ...
    public void initData(EditNameComponetView editNameComponetView) {
        ...
        editNameComponetView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            public void onFocusChange(View view, boolean z) {
                if (!z) {
                    if (TextUtils.isEmpty(EditFirstNameComponent.this.f37201b.getName())) {
                        ...
                        if (userInfo != null && !TextUtils.isEmpty(userInfo.getFirst_name())) {
                            EditFirstNameComponent.this.f37201b.setName(userInfo.getFirst_name());
                            return;
                        }
                        return;
                    }
                    EditFirstNameComponent.this.m26378a();
                }
            }
        });
    }
    ...
    public void m26378a() {
        ...
        if (NationTypeUtil.getNationComponentData().getLoginInfo().isLoginNow()) {
            ...
            userSettingInfo.firstName = this.f37201b.getName();
            if (!TextUtils.isEmpty(userSettingInfo.firstName)) {
                ...
                AccountStore.getInstance().modifyAll((FragmentActivity) this.f37200a, userSettingInfo, false);
            }
        }
    }

    public String getName() {
        return this.f37201b.getName();
    }

    @EventReceiver
    public void onReceive(DefaultEvent defaultEvent) {
        if (!this.f37202c && defaultEvent != null) {
        ...
        public void onReceive(Message message) {
            ...
            if (userInfo != null) {
                ...
                if (i == 2 || i == 3) {
                    ...
                    EditNameComponetView a = EditFirstNameComponent.this.f37201b;
                    if (userInfo != null) {
                    ...
                    EditNameComponetView a2 = EditFirstNameComponent.this.f37201b;
                    if (userInfo != null) {
                        str = userInfo.getFirst_name();
                    }
                    a2.setName(str);
