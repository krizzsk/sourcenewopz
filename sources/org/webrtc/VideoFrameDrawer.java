...
public class VideoFrameDrawer {
    ...
    private final YuvUploader yuvUploader = new YuvUploader((C30031) null);
    ...
    public static void drawTexture(RendererCommon.GlDrawer glDrawer, VideoFrame.TextureBuffer textureBuffer, Matrix matrix, int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        int i7 = C30031.$SwitchMap$org$webrtc$VideoFrame$TextureBuffer$Type[textureBuffer.getType().ordinal()];
        if (i7 == 1) {
    ...
    static /* synthetic */ class C30031 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.webrtc.VideoFrameDrawer.C30031.<clinit>():void");
        }
    }
    ...
    private static class YuvUploader {
        ...
        /* synthetic */ YuvUploader(C30031 r1) {
            this();
        }
    ...
    public void drawFrame(VideoFrame videoFrame, RendererCommon.GlDrawer glDrawer, Matrix matrix, int i, int i2, int i3, int i4) {
        ...
        if (this.renderWidth <= 0 || this.renderHeight <= 0) {
            Logging.m3804w(TAG, "Illegal frame size: " + this.renderWidth + "x" + this.renderHeight);
            return;
        }
