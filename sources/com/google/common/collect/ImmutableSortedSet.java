...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements SortedIterable<E>, NavigableSet<E> {
    ...
    static <E> RegularImmutableSortedSet<E> emptySet(Comparator<? super E> comparator2) {
        ...
        return new RegularImmutableSortedSet<>(ImmutableList.m38373of(), comparator2);
    }

    /* renamed from: of */
    public static <E> ImmutableSortedSet<E> m38453of() {
        return RegularImmutableSortedSet.NATURAL_EMPTY_SET;
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m38454of(E e) {
        return new RegularImmutableSortedSet(ImmutableList.m38374of(e), Ordering.natural());
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m38455of(E e, E e2) {
        return construct(Ordering.natural(), 2, e, e2);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m38456of(E e, E e2, E e3) {
        return construct(Ordering.natural(), 3, e, e2, e3);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m38457of(E e, E e2, E e3, E e4) {
        return construct(Ordering.natural(), 4, e, e2, e3, e4);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m38458of(E e, E e2, E e3, E e4, E e5) {
        return construct(Ordering.natural(), 5, e, e2, e3, e4, e5);
    }

    /* renamed from: of */
    public static <E extends Comparable<? super E>> ImmutableSortedSet<E> m38459of(E e, E e2, E e3, E e4, E e5, E e6, E... eArr) {
