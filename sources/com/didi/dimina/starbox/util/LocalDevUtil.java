...
public class LocalDevUtil {
    ...
    public static java.util.List<java.io.File> unzipFileByKeyword(java.io.File r11, java.io.File r12, java.lang.String r13) throws java.io.IOException {
        /*
            ...
            boolean r2 = m13554a((java.lang.String) r13)     // Catch:{ all -> 0x00a6 }
        ...
        L_0x0024:
            ...
            com.didi.dimina.container.util.LogUtil.m13410e(r5, r13)     // Catch:{ all -> 0x00a6 }
            goto L_0x0024
        L_0x0054:
            boolean r13 = m13553a(r12, r0, r1, r13, r2)     // Catch:{ all -> 0x00a6 }
        ...
        L_0x0062:
            ...
            com.didi.dimina.container.util.LogUtil.m13410e(r5, r2)     // Catch:{ all -> 0x00a6 }
            goto L_0x0062
        L_0x0092:
            boolean r10 = r9.contains(r13)     // Catch:{ all -> 0x00a6 }
            if (r10 == 0) goto L_0x0062
            boolean r2 = m13553a(r12, r0, r1, r2, r9)     // Catch:{ all -> 0x00a6 }
            if (r2 != 0) goto L_0x0062
            r1.close()
            return r0
        L_0x00a2:
    ...
    /* renamed from: a */
    private static boolean m13552a(File file) {
        if (file != null) {
    ...
    /* renamed from: b */
    private static boolean m13555b(File file) {
        if (file == null) {
            return false;
        }
        if (file.exists()) {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static boolean m13553a(java.io.File r1, java.util.List<java.io.File> r2, java.util.zip.ZipFile r3, java.util.zip.ZipEntry r4, java.lang.String r5) throws java.io.IOException {
        /*
            ...
            boolean r1 = m13552a((java.io.File) r0)
            return r1
        L_0x0013:
            boolean r1 = m13555b(r0)
            r2 = 0
        ...
        L_0x0059:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.dimina.starbox.util.LocalDevUtil.m13553a(java.io.File, java.util.List, java.util.zip.ZipFile, java.util.zip.ZipEntry, java.lang.String):boolean");
    }

    /* renamed from: a */
    private static boolean m13554a(String str) {
        if (str == null) {
            return true;
        }
    ...
    public static File getInternalFilesDirectory(Context context, String str) {
        ...
        if (!file.exists() && !file.mkdirs()) {
            LogUtil.m13410e("FileUtils", "getInternalDirectory fail ,the reason is make directory fail !");
        }
        return file;
    }
    ...
    public static void copyAssetsFiles(Context context, String str, String str2) {
        ...
        try {
            ...
            LogUtil.m13410e("FileUtils", "Failed to get asset file list.\n" + Log.getStackTraceString(e));
        }
        ArrayList arrayList = new ArrayList();
        if (strArr != null) {
            for (String str3 : strArr) {
                arrayList.add(m13550a(context, str + "/" + str3, str2));
            }
        }
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.io.File m13550a(android.content.Context r6, java.lang.String r7, java.lang.String r8) {
        /*
        ...
        L_0x0008:
            ...
            m13551a(r6, r8)     // Catch:{ IOException -> 0x002f }
        ...
        L_0x0047:
            ...
            com.didi.dimina.container.util.LogUtil.m13410e(r2, r7)     // Catch:{ all -> 0x0074 }
        ...
        L_0x0082:
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.dimina.starbox.util.LocalDevUtil.m13550a(android.content.Context, java.lang.String, java.lang.String):java.io.File");
    }

    /* renamed from: a */
    private static void m13551a(InputStream inputStream, OutputStream outputStream) throws IOException {
