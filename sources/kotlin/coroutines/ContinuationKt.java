...
public final class ContinuationKt {
    ...
    /* renamed from: a */
    private static final <T> void m43963a(Continuation<? super T> continuation, T t) {
        Result.Companion companion = Result.Companion;
        continuation.resumeWith(Result.m47688constructorimpl(t));
    }

    /* renamed from: a */
    private static final <T> void m43964a(Continuation<? super T> continuation, Throwable th) {
        Result.Companion companion = Result.Companion;
        continuation.resumeWith(Result.m47688constructorimpl(ResultKt.createFailure(th)));
    }

    /* renamed from: a */
    private static final <T> Continuation<T> m43961a(CoroutineContext coroutineContext, Function1<? super Result<? extends T>, Unit> function1) {
    ...
    public static final <T> void startCoroutine(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) {
        ...
        Result.Companion companion = Result.Companion;
        intercepted.resumeWith(Result.m47688constructorimpl(unit));
    }
    ...
    /* renamed from: a */
    private static final <T> Object m43960a(Function1<? super Continuation<? super T>, Unit> function1, Continuation<? super T> continuation) {
        InlineMarker.mark(0);
    ...
    /* renamed from: a */
    private static final CoroutineContext m43962a() {
