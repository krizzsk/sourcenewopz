...
public final class MaybeTimeoutMaybe<T, U> extends C21209a<T, T> {

    /* renamed from: a */
    final MaybeSource<U> f58627a;

    /* renamed from: b */
    final MaybeSource<? extends T> f58628b;

    public MaybeTimeoutMaybe(MaybeSource<T> maybeSource, MaybeSource<U> maybeSource2, MaybeSource<? extends T> maybeSource3) {
        super(maybeSource);
        this.f58627a = maybeSource2;
        this.f58628b = maybeSource3;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        TimeoutMainMaybeObserver timeoutMainMaybeObserver = new TimeoutMainMaybeObserver(maybeObserver, this.f58628b);
        maybeObserver.onSubscribe(timeoutMainMaybeObserver);
        this.f58627a.subscribe(timeoutMainMaybeObserver.other);
