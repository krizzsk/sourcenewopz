...
public class ApkLibraryInstaller implements ReLinker.LibraryInstaller {
    ...
    /* renamed from: a */
    private static final int f52216a = 5;

    /* renamed from: b */
    private static final int f52217b = 4096;

    /* renamed from: a */
    private String[] m37253a(Context context) {
    ...
    /* renamed from: a */
    private ZipFileInZipEntry m37251a(Context context, String[] strArr, String str, ReLinkerInstance reLinkerInstance) {
        int i;
        String[] strArr2 = strArr;
        String[] a = m37253a(context);
        int length = a.length;
        char c = 0;
    ...
    public void installLibrary(android.content.Context r11, java.lang.String[] r12, java.lang.String r13, java.io.File r14, com.getkeepsafe.relinker.ReLinkerInstance r15) {
        /*
            r10 = this;
            r0 = 0
            com.getkeepsafe.relinker.ApkLibraryInstaller$ZipFileInZipEntry r11 = r10.m37251a(r11, r12, r13, r15)     // Catch:{ all -> 0x00a3 }
        ...
        L_0x0026:
            ...
            long r5 = r10.m37250a(r1, r4)     // Catch:{ FileNotFoundException -> 0x0083, IOException -> 0x007d, all -> 0x0068 }
            ...
            r10.m37252a((java.io.Closeable) r1)     // Catch:{ all -> 0x00a0 }
        L_0x0049:
            r10.m37252a((java.io.Closeable) r4)     // Catch:{ all -> 0x00a0 }
            goto L_0x0087
        L_0x004d:
            r10.m37252a((java.io.Closeable) r1)     // Catch:{ all -> 0x00a0 }
            r10.m37252a((java.io.Closeable) r4)     // Catch:{ all -> 0x00a0 }
        ...
        L_0x0072:
            ...
            r4 = r0
        L_0x0074:
            r10.m37252a((java.io.Closeable) r0)     // Catch:{ all -> 0x00a0 }
            r10.m37252a((java.io.Closeable) r4)     // Catch:{ all -> 0x00a0 }
    ...
    /* renamed from: a */
    private long m37250a(InputStream inputStream, OutputStream outputStream) throws IOException {
    ...
    /* renamed from: a */
    private void m37252a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (IOException unused) {
