...
public class Utils {
    ...
    /* renamed from: a */
    private static int f45734a = 0;

    /* renamed from: b */
    private static int f45735b = 1;

    /* renamed from: c */
    private static boolean f45736c = false;

    /* renamed from: d */
    private static boolean f45737d = false;

    /* renamed from: e */
    private static volatile String f45738e;

    /* renamed from: f */
    private static String[] f45739f;
    ...
    public static String[] getMccMnc(TelephonyManager telephonyManager) {
        ...
        if (!strArr2[0].equals("0") && !strArr2[1].equals("0")) {
            f45739f = strArr2;
            return strArr2;
        } else if (!strArr2[0].equals("0") || !strArr2[1].equals("0") || (strArr = f45739f) == null) {
            return strArr2;
        } else {
    ...
    static /* synthetic */ class C150881 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f45740xbd3682fa     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f45740xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f45740xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p173dp.locsdk.Utils.C150881.<clinit>():void");
        }
    }

    public static boolean isPermissionStrategyAllowed(Context context) {
        int i = C150881.f45740xbd3682fa[Config.sPermissionStrategy.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
    ...
    /* renamed from: a */
    static boolean m32751a(Location location) {
    ...
    public static String getChipInfo() {
        if (f45738e == null) {
            f45738e = executeShell("getprop", "ro.board.platform");
        }
        return f45738e;
    }
