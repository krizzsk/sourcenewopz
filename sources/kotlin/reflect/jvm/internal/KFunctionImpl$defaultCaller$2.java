...
@Metadata(mo175977d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\b\u0012\u0002\b\u0003\u0018\u00010\u0001H\n¢\u0006\u0002\b\u0002"}, mo175978d2 = {"<anonymous>", "Lkotlin/reflect/jvm/internal/calls/Caller;", "invoke"}, mo175979k = 3, mo175980mv = {1, 5, 1})
        ...
        if (member instanceof Constructor) {
            ...
            if (this.this$0.getDescriptor().getAnnotations().findAnnotation(UtilKt.getJVM_STATIC()) != null) {
                ...
                if (containingDeclaration == null) {
                    ...
                    method = this.this$0.m44443b((Method) member);
                    callerImpl = method;
                }
            }
            method = this.this$0.m44441a((Method) member);
            callerImpl = method;
        } else {
            callerImpl = null;
        }
