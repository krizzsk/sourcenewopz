...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    /* renamed from: b */
    private static final String f17611b = "submit";

    /* renamed from: c */
    private static final String f17612c = "cancel";

    /* renamed from: a */
    private WheelOptions<T> f17613a;

    public OptionsPickerView(PickerOptions pickerOptions) {
        super(pickerOptions.context);
        this.mPickerOptions = pickerOptions;
        m13105a(pickerOptions.context);
    }

    /* renamed from: a */
    private void m13105a(Context context) {
        ...
        this.f17613a = new WheelOptions<>(linearLayout, this.mPickerOptions.isRestoreItem);
        if (this.mPickerOptions.optionsSelectChangeListener != null) {
            this.f17613a.setOptionsSelectChangeListener(this.mPickerOptions.optionsSelectChangeListener);
        }
        this.f17613a.setTextContentSize(this.mPickerOptions.textSizeContent);
        this.f17613a.setItemsVisible(this.mPickerOptions.itemsVisibleCount);
        this.f17613a.setAlphaGradient(this.mPickerOptions.isAlphaGradient);
        this.f17613a.setLabels(this.mPickerOptions.label1, this.mPickerOptions.label2, this.mPickerOptions.label3);
        this.f17613a.setTextXOffset(this.mPickerOptions.x_offset_one, this.mPickerOptions.x_offset_two, this.mPickerOptions.x_offset_three);
        this.f17613a.setCyclic(this.mPickerOptions.cyclic1, this.mPickerOptions.cyclic2, this.mPickerOptions.cyclic3);
        this.f17613a.setTypeface(this.mPickerOptions.font);
        setOutSideCancelable(this.mPickerOptions.cancelable);
        this.f17613a.setDividerColor(this.mPickerOptions.dividerColor);
        this.f17613a.setDividerType(this.mPickerOptions.dividerType);
        this.f17613a.setLineSpacingMultiplier(this.mPickerOptions.lineSpacingMultiplier);
        this.f17613a.setTextColorOut(this.mPickerOptions.textColorOut);
        this.f17613a.setTextColorCenter(this.mPickerOptions.textColorCenter);
        this.f17613a.isCenterLabel(this.mPickerOptions.isCenterLabel);
    }
    ...
    /* renamed from: a */
    private void m13104a() {
        WheelOptions<T> wheelOptions = this.f17613a;
    ...
    public void setPicker(List<T> list, List<List<T>> list2, List<List<List<T>>> list3) {
        this.f17613a.setPicker(list, list2, list3);
        m13104a();
    }

    public void setNPicker(List<T> list, List<T> list2, List<T> list3) {
        this.f17613a.setLinkage(false);
        this.f17613a.setNPicker(list, list2, list3);
        m13104a();
    }
    ...
    public void returnData() {
        if (this.mPickerOptions.optionsSelectListener != null) {
            int[] currentItems = this.f17613a.getCurrentItems();
