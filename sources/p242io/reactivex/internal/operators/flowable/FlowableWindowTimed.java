...
public final class FlowableWindowTimed<T> extends C21208a<T, Flowable<T>> {
    ...
    /* renamed from: c */
    final TimeUnit f58525c;

    /* renamed from: d */
    final Scheduler f58526d;
    ...
    /* renamed from: g */
    final boolean f58529g;

    public FlowableWindowTimed(Flowable<T> flowable, long j, long j2, TimeUnit timeUnit, Scheduler scheduler, long j3, int i, boolean z) {
        super(flowable);
        this.f58523a = j;
        this.f58524b = j2;
        this.f58525c = timeUnit;
        this.f58526d = scheduler;
        this.f58527e = j3;
        this.f58528f = i;
        this.f58529g = z;
    }
    ...
    public void subscribeActual(Subscriber<? super Flowable<T>> subscriber) {
        ...
        if (this.f58523a != this.f58524b) {
            this.source.subscribe(new WindowSkipSubscriber(serializedSubscriber, this.f58523a, this.f58524b, this.f58525c, this.f58526d.createWorker(), this.f58528f));
        } else if (this.f58527e == Long.MAX_VALUE) {
            this.source.subscribe(new WindowExactUnboundedSubscriber(serializedSubscriber, this.f58523a, this.f58525c, this.f58526d, this.f58528f));
        } else {
            this.source.subscribe(new WindowExactBoundedSubscriber(serializedSubscriber, this.f58523a, this.f58525c, this.f58526d, this.f58528f, this.f58527e, this.f58529g));
        }
    }
    ...
    static final class WindowSkipSubscriber<T> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Runnable, Subscription {
        ...
        public void drainLoop() {
            ...
            while (!this.terminated) {
                ...
                if (z && (z2 || z3)) {
                    ...
                    if (!subjectWork.open) {
                        list.remove(subjectWork.f58530w);
                        subjectWork.f58530w.onComplete();
        ...
        static final class SubjectWork<T> {
            ...
            /* renamed from: w */
            final UnicastProcessor<T> f58530w;

            SubjectWork(UnicastProcessor<T> unicastProcessor, boolean z) {
                this.f58530w = unicastProcessor;
                this.open = z;
            }
        }
