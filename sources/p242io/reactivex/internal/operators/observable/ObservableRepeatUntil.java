...
public final class ObservableRepeatUntil<T> extends C21211a<T, T> {

    /* renamed from: a */
    final BooleanSupplier f58905a;

    public ObservableRepeatUntil(Observable<T> observable, BooleanSupplier booleanSupplier) {
        super(observable);
        this.f58905a = booleanSupplier;
    }

    public void subscribeActual(Observer<? super T> observer) {
        SequentialDisposable sequentialDisposable = new SequentialDisposable();
        observer.onSubscribe(sequentialDisposable);
        new RepeatUntilObserver(observer, this.f58905a, sequentialDisposable, this.source).subscribeNext();
    }
