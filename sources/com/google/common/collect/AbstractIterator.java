...
public abstract class AbstractIterator<T> extends UnmodifiableIterator<T> {
    ...
    static /* synthetic */ class C187771 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.AbstractIterator.C187771.<clinit>():void");
        }
    }

    public final boolean hasNext() {
        Preconditions.checkState(this.state != State.FAILED);
        int i = C187771.$SwitchMap$com$google$common$collect$AbstractIterator$State[this.state.ordinal()];
        if (i == 1) {
            return false;
        }
        if (i != 2) {
