...
@Metadata(mo175977d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\n"}, mo175978d2 = {"<anonymous>", "", "requestParam", "Lcom/didi/soda/cart/model/SetItemAmountParams;", "mergeModel", "Lcom/didi/soda/cart/manager/task/CartMergeModel;"}, mo175979k = 3, mo175980mv = {1, 5, 1}, mo175982xi = 48)
...
final class CartRequestManager$requestSetAmountItem$1 extends Lambda implements Function2<SetItemAmountParams, CartMergeModel, Unit> {
    ...
    public final void invoke(SetItemAmountParams setItemAmountParams, CartMergeModel cartMergeModel) {
        ...
        CartRequestManagerKt.m28519a(Intrinsics.stringPlus("requestSetItem : end merge = ", setItemAmountParams));
        this.this$0.f40012e.requestSetAmount(CartRequest.Companion.createCardSetAmount(new CartRequestManager$requestSetAmountItem$1$runRequest$1(cartMergeModel, this.this$0, this.$rpcService, setItemAmountParams)));
    }
}
