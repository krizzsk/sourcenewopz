...
public class RC2WrapEngine implements Wrapper {
    ...
    /* renamed from: iv */
    private byte[] f5982iv;
    private CipherParameters param;
    private ParametersWithIV paramPlusIV;
    Digest sha1 = DigestFactory.createSHA1();

    /* renamed from: sr */
    private SecureRandom f5983sr;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithRandom) {
            ...
            this.f5983sr = parametersWithRandom.getRandom();
            cipherParameters = parametersWithRandom.getParameters();
        } else {
            this.f5983sr = CryptoServicesRegistrar.getSecureRandom();
        }
        if (cipherParameters instanceof ParametersWithIV) {
            ParametersWithIV parametersWithIV = (ParametersWithIV) cipherParameters;
            this.paramPlusIV = parametersWithIV;
            this.f5982iv = parametersWithIV.getIV();
            this.param = this.paramPlusIV.getParameters();
            if (this.forWrapping) {
                byte[] bArr = this.f5982iv;
        ...
        if (this.forWrapping) {
            byte[] bArr2 = new byte[8];
            this.f5982iv = bArr2;
            this.f5983sr.nextBytes(bArr2);
            this.paramPlusIV = new ParametersWithIV(this.param, this.f5982iv);
        }
    }
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        if (this.forWrapping) {
            ...
            ParametersWithIV parametersWithIV = new ParametersWithIV(this.param, this.f5982iv);
            this.paramPlusIV = parametersWithIV;
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        if (this.forWrapping) {
            ...
            if (length % this.engine.getBlockSize() == 0) {
                ...
                byte[] bArr6 = this.f5982iv;
                int length2 = bArr6.length + length;
                byte[] bArr7 = new byte[length2];
                System.arraycopy(bArr6, 0, bArr7, 0, bArr6.length);
                System.arraycopy(bArr5, 0, bArr7, this.f5982iv.length, length);
