...
class C21482c extends C21481b {
    ...
    /* renamed from: a */
    private static final InputStreamReader m44159a(File file, Charset charset) {
        return new InputStreamReader(new FileInputStream(file), charset);
    }

    /* renamed from: a */
    static /* synthetic */ BufferedReader m44157a(File file, Charset charset, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i2 & 2) != 0) {
    ...
    /* renamed from: a */
    private static final BufferedReader m44156a(File file, Charset charset, int i) {
        Reader inputStreamReader = new InputStreamReader(new FileInputStream(file), charset);
        return inputStreamReader instanceof BufferedReader ? (BufferedReader) inputStreamReader : new BufferedReader(inputStreamReader, i);
    }

    /* renamed from: b */
    static /* synthetic */ OutputStreamWriter m44165b(File file, Charset charset, int i, Object obj) {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: b */
    private static final OutputStreamWriter m44164b(File file, Charset charset) {
        return new OutputStreamWriter(new FileOutputStream(file), charset);
    }

    /* renamed from: b */
    static /* synthetic */ BufferedWriter m44162b(File file, Charset charset, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i2 & 2) != 0) {
    ...
    /* renamed from: b */
    private static final BufferedWriter m44161b(File file, Charset charset, int i) {
        Writer outputStreamWriter = new OutputStreamWriter(new FileOutputStream(file), charset);
        return outputStreamWriter instanceof BufferedWriter ? (BufferedWriter) outputStreamWriter : new BufferedWriter(outputStreamWriter, i);
    }

    /* renamed from: c */
    static /* synthetic */ PrintWriter m44167c(File file, Charset charset, int i, Object obj) {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        Writer outputStreamWriter = new OutputStreamWriter(new FileOutputStream(file), charset);
    ...
    /* renamed from: c */
    private static final PrintWriter m44166c(File file, Charset charset) {
        Writer outputStreamWriter = new OutputStreamWriter(new FileOutputStream(file), charset);
        return new PrintWriter(outputStreamWriter instanceof BufferedWriter ? (BufferedWriter) outputStreamWriter : new BufferedWriter(outputStreamWriter, 8192));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x00bb, code lost:
        kotlin.p245io.CloseableKt.closeFinally(r0, r12);
     */
    ...
    public static final byte[] readBytes(java.io.File r12) {
        ...
        L_0x0047:
            ...
            r11 = 2
            kotlin.p245io.ByteStreamsKt.copyTo$default(r3, r7, r6, r11, r1)     // Catch:{ all -> 0x00b8 }
            int r1 = r9.size()     // Catch:{ all -> 0x00b8 }
            int r1 = r1 + r5
            if (r1 < 0) goto L_0x0078
            byte[] r12 = r9.mo176744a()     // Catch:{ all -> 0x00b8 }
        ...
        L_0x0074:
            kotlin.p245io.CloseableKt.closeFinally(r0, r2)
            return r4
        L_0x0078:
        ...
        L_0x00ba:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.C21482c.readBytes(java.io.File):byte[]");
    }
    ...
    public static final void writeBytes(java.io.File r2, byte[] r3) {
        ...
        L_0x0022:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.C21482c.writeBytes(java.io.File, byte[]):void");
    }
    ...
    public static final void appendBytes(java.io.File r2, byte[] r3) {
        ...
        L_0x0023:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.C21482c.appendBytes(java.io.File, byte[]):void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x002b, code lost:
        kotlin.p245io.CloseableKt.closeFinally(r1, r2);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final java.lang.String readText(java.io.File r1, java.nio.charset.Charset r2) {
        /*
            ...
            java.lang.String r0 = kotlin.p245io.TextStreamsKt.readText(r0)     // Catch:{ all -> 0x0028 }
            kotlin.p245io.CloseableKt.closeFinally(r1, r2)
            return r0
        L_0x0028:
            r2 = move-exception
        ...
        L_0x002a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.C21482c.readText(java.io.File, java.nio.charset.Charset):java.lang.String");
    }
    ...
    public static final void forEachBlock(java.io.File r3, int r4, kotlin.jvm.functions.Function2<? super byte[], ? super java.lang.Integer, kotlin.Unit> r5) {
        ...
        L_0x0035:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.C21482c.forEachBlock(java.io.File, int, kotlin.jvm.functions.Function2):void");
    }
    ...
    /* renamed from: a */
    private static final FileInputStream m44158a(File file) {
        return new FileInputStream(file);
    }

    /* renamed from: b */
    private static final FileOutputStream m44163b(File file) {
    ...
    public static /* synthetic */ java.lang.Object useLines$default(java.io.File r1, java.nio.charset.Charset r2, kotlin.jvm.functions.Function1 r3, int r4, java.lang.Object r5) {
        ...
        L_0x0032:
            ...
            kotlin.sequences.Sequence r0 = kotlin.p245io.TextStreamsKt.lineSequence(r0)     // Catch:{ all -> 0x0057 }
        ...
        L_0x006a:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.C21482c.useLines$default(java.io.File, java.nio.charset.Charset, kotlin.jvm.functions.Function1, int, java.lang.Object):java.lang.Object");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0062, code lost:
        kotlin.p245io.CloseableKt.closeFinally(r3, r4);
     */
    ...
    public static final <T> T useLines(java.io.File r3, java.nio.charset.Charset r4, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r5) {
        ...
        L_0x002c:
            ...
            kotlin.sequences.Sequence r2 = kotlin.p245io.TextStreamsKt.lineSequence(r2)     // Catch:{ all -> 0x0052 }
        ...
        L_0x0065:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p245io.C21482c.useLines(java.io.File, java.nio.charset.Charset, kotlin.jvm.functions.Function1):java.lang.Object");
    }
}
