...
public final class DoubleMath {
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        if (DoubleUtils.isFinite(d)) {
            switch (C190821.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C190821 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.DoubleMath.C190821.<clinit>():void");
        }
    }
