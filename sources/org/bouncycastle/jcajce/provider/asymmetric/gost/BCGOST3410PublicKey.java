...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f6238y = new BigInteger(1, bArr);
    ...
    public boolean equals(Object obj) {
        ...
        return this.f6238y.equals(bCGOST3410PublicKey.f6238y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec);
    }
    ...
    public int hashCode() {
        return this.f6238y.hashCode() ^ this.gost3410Spec.hashCode();
    }

    public String toString() {
        try {
            return GOSTUtil.publicKeyToString("GOST3410", this.f6238y, ((GOST3410PublicKeyParameters) GOST3410Util.generatePublicKeyParameter(this)).getParameters());
