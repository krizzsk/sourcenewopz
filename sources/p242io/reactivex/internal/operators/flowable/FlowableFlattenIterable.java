...
public final class FlowableFlattenIterable<T, R> extends C21208a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends Iterable<? extends R>> f58315a;
    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        if (this.source instanceof Callable) {
            try {
                ...
                try {
                    FlowableFromIterable.subscribe(subscriber, ((Iterable) this.f58315a.apply(call)).iterator());
                } catch (Throwable th) {
            ...
            this.source.subscribe(new FlattenIterableSubscriber(subscriber, this.f58315a, this.f58316b));
        }
    }
    ...
    static final class FlattenIterableSubscriber<T, R> extends BasicIntQueueSubscription<R> implements FlowableSubscriber<T> {
        ...
        public void drain() {
            ...
            L_0x004a:
                ...
                p242io.reactivex.internal.util.ExceptionHelper.addThrowable(r3, r0)
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                java.lang.Throwable r0 = p242io.reactivex.internal.util.ExceptionHelper.terminate(r0)
                r2.onError(r0)
                return
            L_0x0062:
                r0 = move-exception
                ...
                r0.cancel()
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                p242io.reactivex.internal.util.ExceptionHelper.addThrowable(r0, r4)
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                java.lang.Throwable r0 = p242io.reactivex.internal.util.ExceptionHelper.terminate(r0)
                r1.current = r7
                r3.clear()
            ...
            L_0x0098:
                ...
                java.lang.Object r5 = p242io.reactivex.internal.functions.ObjectHelper.requireNonNull(r15, (java.lang.String) r5)     // Catch:{ all -> 0x00dc }
                r2.onNext(r5)
                boolean r5 = r1.done
            ...
            L_0x00c1:
                r0 = move-exception
                r3 = r0
                p242io.reactivex.exceptions.Exceptions.throwIfFatal(r3)
                r1.current = r7
                org.reactivestreams.Subscription r0 = r1.upstream
                r0.cancel()
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                p242io.reactivex.internal.util.ExceptionHelper.addThrowable(r0, r3)
                java.util.concurrent.atomic.AtomicReference<java.lang.Throwable> r0 = r1.error
                java.lang.Throwable r0 = p242io.reactivex.internal.util.ExceptionHelper.terminate(r0)
                r2.onError(r0)
                return
            ...
            L_0x012c:
                ...
                goto L_0x001a
            */
            throw new UnsupportedOperationException("Method not decompiled: p242io.reactivex.internal.operators.flowable.FlowableFlattenIterable.FlattenIterableSubscriber.drain():void");
        }
