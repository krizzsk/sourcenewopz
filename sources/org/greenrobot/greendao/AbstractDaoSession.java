...
import org.greenrobot.greendao.p085rx.RxTransaction;
...
public class AbstractDaoSession {
    ...
    /* renamed from: db */
    private final Database f6571db;
    ...
    public void runInTx(Runnable runnable) {
        this.f6571db.beginTransaction();
        try {
            runnable.run();
            this.f6571db.setTransactionSuccessful();
        } finally {
            this.f6571db.endTransaction();
        }
    }
