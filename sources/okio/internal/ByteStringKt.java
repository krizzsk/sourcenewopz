...
public final class ByteStringKt {
    ...
    public static final String commonHex(ByteString byteString) {
        ...
        for (byte b : byteString.getData$okio()) {
            ...
            i = i2 + 1;
            cArr[i2] = getHEX_DIGIT_CHARS()[b & Ascii.f53593SI];
        }
